import{d as r,E as u,o as d,c as g,w as n,J as l,C as t,Z as i,f as o,N as s,as as m,aD as p}from"./index-66214709-97e5bbe8.js";import{_ as h}from"./UiPage.vue_vue_type_style_index_0_lang-424f635c.js";const v={class:"section-content"},_={class:"section-content"},f={class:"trigger"},T={class:"section-content"},b={class:"trigger"},$={class:"section-content"},y={class:"trigger"},k={class:"section-content"},z={class:"trigger"},B={class:"section-content"},C={class:"trigger"},N={class:"section-content"},w={class:"trigger"},I=r({__name:"Index",setup(D){return(e,E)=>{const c=u("router-link"),a=u("SshPre");return d(),g(h,{title:e.$t("ui.tooltip.title"),class:"demo"},{toolbar:n(()=>[l(c,{to:{name:"ui"},class:"back"},{default:n(()=>[t(i(e.$t("common.back")),1)]),_:1})]),default:n(()=>[t(),o("section",null,[o("h2",null,i(e.$t("ui.tooltip.usage.basic")),1),t(),o("div",v,[l(a,{language:"html-vue"},{default:n(()=>[t(`
          <template>
            <Tooltip>
              <ButtonElement
                :label="Tooltip"
        ...
        `)]),_:1}),t(),l(s(p),{position:"right"},{content:n(()=>[t(i(e.$t("ui.tooltip.content")),1)]),default:n(()=>[o("div",z,i(e.$t("ui.tooltip.usage.right")),1),t()]),_:1})])]),t(),o("section",null,[o("h2",null,i(e.$t("ui.tooltip.usage.clickable")),1),t(),o("div",B,[l(a,{language:"html-vue"},{default:n(()=>[t(`
          ...
          import { Tooltip } from "@dzangolab/vue3-ui";
          <\/script>
        `)]),_:1}),t(),l(s(p),{clickable:""},{content:n(()=>[t(i(e.$t("ui.tooltip.content")),1)]),default:n(()=>[o("div",C,i(e.$t("ui.tooltip.label.button")),1),t()]),_:1})])]),t(),o("section",null,[o("h2",null,i(e.$t("ui.tooltip.usage.delay")),1),t(),o("div",N,[l(a,{language:"html-vue"},{default:n(()=>[t(`
          <template>
            <Tooltip :delay="1000">
              <div class="trigger">
                Delay
          ...
          import { Tooltip } from "@dzangolab/vue3-ui";
          <\/script>
        `)]),_:1}),t(),l(s(p),{delay:1e3},{content:n(()=>[t(i(e.$t("ui.tooltip.content")),1)]),default:n(()=>[o("div",w,i(e.$t("ui.tooltip.label.delay")),1),t()]),_:1})])])]),_:1},8,["title"])}}});export{I as default};
