import{f as p,k as f}from"./PrefabsTechVue3Form.es-CWVSQqDX.js";import{d as $,L as y,N as E,M as D,o as M,e as O,f as s,h as o,t as d,z as n,a as r,u as t,O as F,r as b}from"./index-BVhQRVzP.js";import{_ as z}from"./ComponentDocumentation.vue_vue_type_script_setup_true_lang-YXOdHqLe.js";import{_ as S}from"./FormPage.vue_vue_type_style_index_0_lang-DgEJS3fs.js";import"./PrefabsTechVue3TanstackTable.es-1-o3W2Ma.js";const w={class:"section-content"},q={class:"section-content"},U={class:"section-content"},P={class:"section-content"},h={class:"section-content"},k={class:"section-content"},B={class:"section-content"},L={name:"NumberInputField"},G=$({...L,setup(T){const{t:i}=y(),g=[{description:i("form.documentation.eventDescription.input.modelValue"),name:"update:modelValue",payload:"number | undefined"}],I=E.coerce.number({invalid_type_error:i("form.errors.number.invalid")}).gte(1,i("form.errors.number.invalid")).lte(100,i("form.errors.number.invalid")),V=[{default:"false",description:i("form.documentation.propsDescription.input.disabled"),prop:"disabled",type:"Boolean"},{default:'{ required: "The field is required", invalid: "Please provide a valid integer field" }',description:i("form.documentation.propsDescription.input.errorMessages"),prop:"errorMessages",type:"NumberErrorMessages"},{default:"-",description:i("form.documentation.propsDescription.input.label"),prop:"label",type:"String"},{default:"undefined",description:i("form.documentation.propsDescription.input.modelValue"),prop:"modelValue",type:"number | null | undefined"},{default:'"number"',description:i("form.documentation.propsDescription.input.name"),prop:"name",type:"String"},{default:"-",description:i("form.documentation.propsDescription.input.options"),prop:"options",type:"IsIntOptions"},{default:"-",description:i("form.documentation.propsDescription.input.placeholder"),prop:"placeholder",type:"String"},{default:"-",description:i("form.documentation.propsDescription.input.schema"),prop:"schema",type:"z.ZodType<string | number>"}],N={invalid:i("form.errors.number.invalid"),required:i("form.errors.number.required")},v={min:1,max:100,allow_leading_zeroes:!1};let a=F({customValidationInput:b(),disabled:b(100),i18nInput:b(),input:b(),inputWithValidation:b(),noLabelInput:b(),textInput:b()});return(l,e)=>{const m=D("SshPre");return M(),O(S,{subtitle:t(i)("form.subtitle.number"),title:l.$t("form.label.number"),class:"demo"},{default:s(()=>[o("section",null,[o("h2",null,d(l.$t("form.label.basicInput")),1),e[9]||(e[9]=n()),o("div",w,[r(t(p),{modelValue:t(a).noLabelInput,"onUpdate:modelValue":e[0]||(e[0]=u=>t(a).noLabelInput=u),placeholder:l.$t("form.placeholder.number")},null,8,["modelValue","placeholder"]),e[8]||(e[8]=n()),r(m,{language:"html-vue"},{default:s(()=>[...e[7]||(e[7]=[n(`
          <template>
            <NumberInput 
              v-model="input"
        ...
        `,-1)])]),_:1})])]),e[34]||(e[34]=n()),o("section",null,[o("h2",null,d(l.$t("form.label.customValidationInput")),1),e[27]||(e[27]=n()),o("div",B,[r(t(f),null,{default:s(()=>[r(t(p),{modelValue:t(a).customValidationInput,"onUpdate:modelValue":e[6]||(e[6]=u=>t(a).customValidationInput=u),label:l.$t("form.label.number"),placeholder:l.$t("form.placeholder.number"),schema:t(I),name:"custom-input"},null,8,["modelValue","label","placeholder","schema"])]),_:1}),e[26]||(e[26]=n()),r(m,{language:"html-vue"},{default:s(()=>[...e[25]||(e[25]=[n(`
          ...
          <\/script>
        `,-1)])]),_:1})])]),e[35]||(e[35]=n()),r(z,{"events-data":g,"props-data":V,"props-table-title":l.$t("common.properties",{value:"NumberInputProperties"})},null,8,["props-table-title"]),e[36]||(e[36]=n()),r(m,{language:"html-vue"},{default:s(()=>[...e[28]||(e[28]=[n(`
