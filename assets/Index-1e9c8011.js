import{g as b,o as y}from"./DzangolabVue3Form.es-6efba6c5.js";import{d as S,Z as V,p as B,j as c,K as h,o as C,c as _,w as n,L as o,C as e,M as i,f as l,E as p,aD as d}from"./index-137faed7-cbf069b7.js";import{_ as D}from"./UiPage.vue_vue_type_style_index_0_lang-5337d4d6.js";import"./index-5ec4bc37.js";const k={class:"section-content"},I={class:"section-content"},w={class:"section-content"},F=S({__name:"Index",setup(N){const f=V(),a=B({name:null,phone:null,price:"$50"}),v=c({iconRight:"pi pi-chevron-right",label:"Next",severity:"primary",variant:"filled"}),g=c({iconLeft:"pi pi-chevron-left",label:"Back",severity:"secondary",variant:"filled"}),u=c([{content:"Please enter personal details",label:"Personal",step:1},{content:"Please enter contact details",label:"Contact",step:2},{content:"Please enter payment details",label:"Payment",step:3},{content:"Do you wish to continue?",label:"Confirmation",step:4}]),P=()=>{f.push("/ui")};return(t,s)=>{const $=h("router-link"),m=h("SshPre");return C(),_(D,{title:t.$t("ui.stepper.title"),class:"demo"},{toolbar:n(()=>[o($,{to:{name:"ui"},class:"back"},{default:n(()=>[e(i(t.$t("common.back")),1)]),_:1})]),default:n(()=>[e(),l("section",null,[l("h2",null,i(t.$t("ui.stepper.usage.basic")),1),e(),l("div",k,[o(m,{language:"html-vue"},{default:n(()=>[e(`
          <template>
