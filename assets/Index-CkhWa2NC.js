import{d,K as p,f as m,o as f,i as s,E as n,g as e,t as l,h as i,u as a,O as u,x as g}from"./index-F6jRwq9R.js";import{_ as C}from"./UiPage.vue_vue_type_style_index_0_lang-LFqxGm7B.js";const v={class:"section-content"},$={class:"content"},b={class:"section-content"},z={class:"content"},k={class:"section-content"},I={class:"content"},w={class:"section-content"},B={class:"title"},N={class:"content"},S={class:"footer"},P=d({__name:"Index",setup(V){return(o,t)=>{const r=p("SshPre");return f(),m(C,{title:o.$t("ui.card.title"),class:"demo"},{toolbar:s(()=>[i(a(g),{label:o.$t("common.back"),"icon-left":"pi pi-chevron-left",size:"medium",variant:"textOnly",onClick:t[0]||(t[0]=y=>o.$router.push("/ui"))},null,8,["label"])]),default:s(()=>[t[15]||(t[15]=n()),e("section",null,[e("h2",null,l(o.$t("ui.card.usage.basic")),1),t[3]||(t[3]=n()),e("div",v,[i(a(u),null,{default:s(()=>[e("p",$,l(o.$t("ui.card.content")),1)]),_:1}),t[2]||(t[2]=n()),i(r,{language:"html-vue"},{default:s(()=>t[1]||(t[1]=[n(`
          <template>
            <Card>
              <p>
                ...
