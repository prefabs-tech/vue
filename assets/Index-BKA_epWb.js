import{H as d,q as I}from"./DzangolabVue3Form.es-BMWt6Uf1.js";import{d as k,L as z,M as $,N as O,r as m,K as R,f as S,o as B,i as s,D as e,g as t,t as b,h as a,u as l,v as g}from"./index-BQkQtk9A.js";import{_ as q}from"./FormPage.vue_vue_type_style_index_0_lang-SxbpXc1K.js";const C={class:"section-content"},F={class:"section-content"},N={class:"section-content"},U={class:"section-content"},W={name:"RadioInput"},w=k({...W,setup(D){const{t:u}=z(),V=$.string({required_error:u("form.errors.radio.required")});let i=O({disabled:m("car"),i18nInput:m(),input:m(),inputWithValidation:m(),noLabelInput:m()});const f=[{label:u("form.label.male"),value:"male"},{label:u("form.label.female"),value:"female"}],v=[{label:u("form.label.bike"),value:"bike"},{label:u("form.label.car"),value:"car"},{label:u("form.label.truck"),value:"truck"}];return(o,n)=>{const p=R("SshPre");return B(),S(q,{title:o.$t("form.label.radio"),class:"demo"},{toolbar:s(()=>[a(l(g),{label:o.$t("common.back"),"icon-left":"pi pi-chevron-left",size:"medium",variant:"textOnly",onClick:n[0]||(n[0]=r=>o.$router.push("/form"))},null,8,["label"])]),default:s(()=>[n[18]||(n[18]=e()),t("section",null,[t("h2",null,b(o.$t("form.label.basicInput")),1),n[7]||(n[7]=e()),t("div",C,[a(l(d),{modelValue:l(i).input,"onUpdate:modelValue":n[1]||(n[1]=r=>l(i).input=r),label:o.$t("form.label.gender"),options:f,direction:"horizontal",name:"label-input"},null,8,["modelValue","label"]),n[6]||(n[6]=e()),a(p,{language:"html-vue"},{default:s(()=>n[5]||(n[5]=[e(`
          <template>
            <RadioInput
              v-model="input"
