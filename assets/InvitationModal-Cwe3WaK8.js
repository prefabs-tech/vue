import{d as S,x as E,r as m,s as z,j as D,o as k,w as i,A as n,e as o,t as v,g as t,u as a,B as u,T as p,L as P}from"./index-j9ugvOHR.js";import{_ as B}from"./UserPage.vue_vue_type_style_index_0_lang-Cju8LVAy.js";const A={class:"section-content"},R={class:"section-content"},U={class:"section-content"},C={class:"section-content"},N={class:"section-content"},O={class:"section-content"},T={class:"section-content"},j=S({__name:"InvitationModal",setup(F){const{t:y}=E(),f=m(!1),b=m(!1),w=m(!1),h=m(!1),M=m(!1),c=m(!1),g=m(!1),I=[{id:1,name:"ADMIN"},{id:2,name:"SUPERADMIN"},{id:3,name:"USER"}],$=[{id:1,name:"Admin",origin:"admin-origin",supportedRoles:[{id:1,name:"ADMIN"},{id:2,name:"SUPERADMIN"}]},{id:2,name:"User",origin:"user-origin",supportedRoles:[{id:3,name:"USER"}]}],r=l=>{P({text:y("user.message.invitation.success",{user:l.email}),type:"success"}),f.value=!1,b.value=!1,w.value=!1,h.value=!1,M.value=!1,c.value=!1,g.value=!1};return(l,e)=>{const d=z("SshPre");return k(),D(B,{title:l.$t("user.label.invitationModal"),class:"demo-invitation-modal"},{toolbar:i(()=>[t(a(u),{label:l.$t("common.back"),"icon-left":"pi pi-chevron-left",size:"medium",variant:"textOnly",onClick:e[0]||(e[0]=s=>l.$router.push("/user"))},null,8,["label"])]),default:i(()=>[n(),o("section",null,[o("h2",null,v(l.$t("user.label.basic")),1),n(),o("div",A,[t(a(u),{label:l.$t("user.label.invite"),onClick:e[1]||(e[1]=s=>M.value=!0)},null,8,["label"]),n(),t(a(p),{show:M.value,"onOn:close":e[2]||(e[2]=s=>M.value=!1),onSubmit:r},null,8,["show"]),n(),t(d,{language:"html-vue"},{default:i(()=>[n(`
          <template>
            <ButtonElement
              label="Invite"
          ...
          <\/script>
        `)]),_:1}),n()])]),n(),o("section",null,[o("h2",null,v(l.$t("user.label.withTitle")),1),n(),o("div",R,[t(a(u),{label:l.$t("user.label.send"),onClick:e[3]||(e[3]=s=>g.value=!0)},null,8,["label"]),n(),t(a(p),{show:g.value,title:l.$t("user.label.invite"),"onOn:close":e[4]||(e[4]=s=>g.value=!1),onSubmit:r},null,8,["show","title"]),n(),t(d,{language:"html-vue"},{default:i(()=>[n(`
          <template>
            <ButtonElement
              label="Send"
              @click="showModal = true"
        ...
        `)]),_:1}),n()])]),n(),o("section",null,[o("h2",null,v(l.$t("user.label.withAppField")),1),n(),o("div",C,[t(a(u),{label:l.$t("user.label.invite"),onClick:e[7]||(e[7]=s=>f.value=!0)},null,8,["label"]),n(),t(a(p),{apps:$,show:f.value,title:l.$t("user.label.inviteToApp"),"onOn:close":e[8]||(e[8]=s=>f.value=!1),onSubmit:r},null,8,["show","title"]),n(),t(d,{language:"html-vue"},{default:i(()=>[n(`
          ...
          <\/script>
        `)]),_:1}),n()])]),n(),o("section",null,[o("h2",null,v(l.$t("user.label.withRoleField")),1),n(),o("div",N,[t(a(u),{label:l.$t("user.label.sendInvitation"),onClick:e[9]||(e[9]=s=>c.value=!0)},null,8,["label"]),n(),t(a(p),{roles:I,show:c.value,title:l.$t("user.label.inviteWithRole"),"onOn:close":e[10]||(e[10]=s=>c.value=!1),onSubmit:r},null,8,["show","title"]),n(),t(d,{language:"html-vue"},{default:i(()=>[n(`
          <template>
            <ButtonElement
