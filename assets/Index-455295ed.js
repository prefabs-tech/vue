import{m as I,J as d,Z as i}from"./DzangolabVue3Form.es-613b07ef.js";import{d as V,u as _,b as y,e as c,r as f,o as $,c as F,w as a,f as n,g as e,t as m,a as o,h as l}from"./index-577793d9.js";const w={class:"section-content"},z={class:"section-content"},U={class:"section-content"},S={class:"section-content"},k={class:"section-content"},E={class:"section-content"},P={class:"section-content"},T={name:"InputField"},C=V({...T,setup(W){const{t:b}=_(),h=I.string().min(3,{message:b("form.errors.input.min",{length:3})});let u=y({disabled:c("monorepo@gmail.com"),input:c(),inputWithValidation:c(),noLabelInput:c(),numberInput:c(),passwordInput:c()});return(t,r)=>{const g=f("router-link"),p=f("SshPre"),v=f("Page");return $(),F(v,{title:t.$t("form.label.input"),class:"demo"},{toolbar:a(()=>[n(g,{to:{name:"form"},class:"back"},{default:a(()=>[e(m(t.$t("common.back")),1)]),_:1})]),default:a(()=>[e(),o("section",null,[o("h2",null,m(t.$t("form.label.basicInput")),1),e(),o("div",w,[n(p,{language:"html-vue"},{default:a(()=>[e(`
          <Form>
            <Input 
              v-model="username"
