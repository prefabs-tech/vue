import{d as h,s as w,j as y,o as C,w as a,C as e,e as n,t as r,g as i,u as t,X as d,D as b}from"./index-CVjUtB44.js";import{_ as A}from"./UiPage.vue_vue_type_style_index_0_lang-Sn8JrzpY.js";const B={class:"section-content"},z={class:"section-content"},F={class:"section-content"},D={class:"section-content"},I=h({__name:"Index",setup(P){const p={severity:"warning",size:"medium",variant:"outlined"},c={severity:"danger",size:"medium",variant:"outlined"},m={severity:"primary",size:"medium",variant:"outlined"},l={description:"This is a file",downloadCount:0,id:1,lastDownloadedAt:Date.now(),originalFileName:"file.png",size:4,uploadedBy:{givenName:"Test",lastName:"user"},uploadedAt:Date.now()},f={archiveAction:"Archive file",archiveConfirmationHeader:"Confirm archive?",archiveConfirmationMessage:"Are you sure to archive this file?",deleteAction:"Delete file",deleteConfirmationHeader:"Confirm delete?",deleteConfirmationMessage:"Are you sure to delete this file?",downloadAction:"Download file",downloadCountHeader:"Download count:",lastDownloadedAtHeader:"Last downloaded date:",shareAction:"Share file",uploadedAtHeader:"Uploaded date:",uploadedByHeader:"Uploaded by:",viewAction:"View file"},v={severity:"alternate",size:"medium",variant:"outlined"},g={severity:"secondary",size:"medium",variant:"outlined"};return(o,u)=>{const s=w("SshPre");return C(),y(A,{title:o.$t("ui.fileCard.title"),class:"demo"},{toolbar:a(()=>[i(t(b),{label:o.$t("common.back"),"icon-left":"pi pi-chevron-left",size:"medium",variant:"textOnly",onClick:u[0]||(u[0]=_=>o.$router.push("/ui"))},null,8,["label"])]),default:a(()=>[e(),n("section",null,[n("h2",null,r(o.$t("ui.fileCard.usage.basic")),1),e(),n("div",B,[i(t(d),{file:t(l)},null,8,["file"]),e(),i(s,{language:"html-vue"},{default:a(()=>[e(`
          <template>
            <FileCard :file="file" />
          </template>
          ...
          <\/script>
        `)]),_:1}),e()])]),e(),n("section",null,[n("h2",null,r(o.$t("ui.fileCard.usage.messages")),1),e(),n("div",z,[i(t(d),{file:t(l),messages:t(f)},null,8,["file","messages"]),e(),i(s,{language:"html-vue"},{default:a(()=>[e(`
          <template>
          ...
          <\/script>
        `)]),_:1}),e()])]),e(),n("section",null,[n("h2",null,r(o.$t("ui.fileCard.usage.buttonProps")),1),e(),n("div",F,[i(t(d),{"archive-button-props":p,"delete-button-props":c,"download-button-props":m,file:t(l),"share-button-props":v,"view-button-props":g},null,8,["file"]),e(),i(s,{language:"html-vue"},{default:a(()=>[e(`
          <template>
            <FileCard
