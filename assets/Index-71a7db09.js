import{d as c,G as u,o as d,c as g,w as n,K as l,C as t,Z as i,f as o,D as s,ar as m,aC as p}from"./index-708e0d96-63bf851d.js";import{_ as h}from"./UiPage.vue_vue_type_style_index_0_lang-576df06c.js";const v={class:"section-content"},_={class:"section-content"},f={class:"trigger"},T={class:"section-content"},b={class:"trigger"},$={class:"section-content"},y={class:"trigger"},k={class:"section-content"},z={class:"trigger"},B={class:"section-content"},C={class:"trigger"},w={class:"section-content"},D={class:"trigger"},I=c({__name:"Index",setup(N){return(e,S)=>{const r=u("router-link"),a=u("SshPre");return d(),g(h,{title:e.$t("ui.tooltip.title"),class:"demo"},{toolbar:n(()=>[l(r,{to:{name:"ui"},class:"back"},{default:n(()=>[t(i(e.$t("common.back")),1)]),_:1})]),default:n(()=>[t(),o("section",null,[o("h2",null,i(e.$t("ui.tooltip.usage.basic")),1),t(),o("div",v,[l(a,{language:"html-vue"},{default:n(()=>[t(`
          <template>
            <Tooltip>
              <ButtonElement
                :label="Tooltip"
        ...
        `)]),_:1}),t(),l(s(p),{clickable:""},{content:n(()=>[t(i(e.$t("ui.tooltip.content")),1)]),default:n(()=>[o("div",C,i(e.$t("ui.tooltip.label.button")),1),t()]),_:1})])]),t(),o("section",null,[o("h2",null,i(e.$t("ui.tooltip.usage.delay")),1),t(),o("div",w,[l(a,{language:"html-vue"},{default:n(()=>[t(`
          ...
          import { Tooltip } from "@dzangolab/vue3-ui";
          <\/script>
        `)]),_:1}),t(),l(s(p),{delay:1e3},{content:n(()=>[t(i(e.$t("ui.tooltip.content")),1)]),default:n(()=>[o("div",D,i(e.$t("ui.tooltip.label.delay")),1),t()]),_:1})])])]),_:1},8,["title"])}}});export{I as default};
