import{I as i,O as f}from"./PrefabsTechVue3Form.es-DIvE5Ag5.js";import{d as V,I as $,L as T,M as h,r as d,J as F,e as O,o as x,j as r,C as n,f as o,t as m,h as u,u as e,v as U}from"./index-xh0NLvNE.js";import{_ as q}from"./FormPage.vue_vue_type_style_index_0_lang-Ns-87GET.js";const z={class:"section-content"},E={class:"section-content"},S={class:"section-content"},w={class:"section-content"},C={class:"section-content"},M={class:"section-content"},k={class:"section-content"},y={name:"TextInputField"},N=V({...y,setup(L){const{t:b}=$(),v=T.string().length(5,{message:b("form.errors.input.length",{length:5})}),g={required:b("form.errors.input.required")},I={ignore_whitespace:!0,required:!0};let s=h({customValidationInput:d(),disabled:d("dzangolab"),input:d(),inputWithValidation:d(),noLabelInput:d(),textInput:d()});return(l,t)=>{const a=F("SshPre");return x(),O(q,{title:l.$t("form.label.textInput"),class:"demo"},{toolbar:r(()=>[u(e(U),{label:l.$t("common.back"),"icon-left":"pi pi-chevron-left",size:"medium",variant:"textOnly",onClick:t[0]||(t[0]=p=>l.$router.push("/form"))},null,8,["label"])]),default:r(()=>[t[29]||(t[29]=n()),o("section",null,[o("h2",null,m(l.$t("form.label.basicInput")),1),t[10]||(t[10]=n()),o("div",z,[u(e(i),{modelValue:e(s).noLabelInput,"onUpdate:modelValue":t[1]||(t[1]=p=>e(s).noLabelInput=p),placeholder:l.$t("form.placeholder.input")},null,8,["modelValue","placeholder"]),t[9]||(t[9]=n()),u(a,{language:"html-vue"},{default:r(()=>t[8]||(t[8]=[n(`
          <template>
            <TextInput 
              v-model="input"
          ...
          <\/script>
        `)])),_:1})])]),t[30]||(t[30]=n()),o("section",null,[o("h2",null,m(l.$t("form.label.labelInput")),1),t[13]||(t[13]=n()),o("div",E,[u(e(i),{modelValue:e(s).input,"onUpdate:modelValue":t[2]||(t[2]=p=>e(s).input=p),label:l.$t("form.label.textInput"),placeholder:l.$t("form.placeholder.textInput")},null,8,["modelValue","label","placeholder"]),t[12]||(t[12]=n()),u(a,{language:"html-vue"},{default:r(()=>t[11]||(t[11]=[n(`
          <template>
            <TextInput 
              v-model="input"
              label="Input"
