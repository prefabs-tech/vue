import{m as P,U as p,z as u}from"./DzangolabVue3Form.es-9d25bab5.js";import{d as V,u as _,b as $,e as f,o as I,c as y,w as a,a as o,t as m,f as n,g as l,h as e,r as b}from"./index-c6272d68.js";const F={class:"section-content"},z={class:"section-content"},S={class:"section-content"},U={class:"section-content"},E={class:"section-content"},L={class:"section-content"},O={class:"section-content"},q={class:"section-content"},M={name:"PasswordInputField"},C=V({...M,setup(W){const{t:c}=_(),g=P.string({invalid_type_error:c("form.errors.password.invalid"),required_error:c("form.errors.input.required")}).min(8,{message:c("form.errors.password.min",{length:8})}).regex(/^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)(?=.*[\W_]).+$/,c("form.errors.password.invalid")),h={required:c("form.errors.input.required"),weak:c("form.errors.password.invalid")},w={minLength:10,minLowercase:1,minUppercase:1,minSymbols:1};let t=$({customStyleInput:f(),customValidationInput:f(),disabled:f("P@ssw0rd"),input:f(),inputWithValidation:f(),noLabelInput:f(),passwordInput:f()});return(s,r)=>{const i=b("SshPre"),v=b("Page");return I(),y(v,{title:s.$t("form.label.password"),class:"demo"},{default:a(()=>[o("section",null,[o("h2",null,m(s.$t("form.label.basicInput")),1),n(),o("div",F,[l(i,{language:"html-vue"},{default:a(()=>[n(`
          ...
          <\/script>
        `)]),_:1}),n(),l(e(u),null,{default:a(()=>[l(e(p),{modelValue:e(t).noLabelInput,"onUpdate:modelValue":r[0]||(r[0]=d=>e(t).noLabelInput=d),placeholder:s.$t("form.placeholder.password")},null,8,["modelValue","placeholder"])]),_:1})])]),n(),o("section",null,[o("h2",null,m(s.$t("form.label.labelInput")),1),n(),o("div",z,[l(i,{language:"html-vue"},{default:a(()=>[n(`
          <Form>
            <Password 
              v-model="input"
              label="Password"
