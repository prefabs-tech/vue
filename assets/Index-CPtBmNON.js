import{n as b,b as P}from"./DzangolabVue3Form.es-6_UQ-oQJ.js";import{d as h,K as $,B as y,y as B,l as C,o as S,p as o,C as t,e as s,t as i,g as l,u as p,L as d,D as V}from"./index-btaM6fHL.js";import{_ as D}from"./UiPage.vue_vue_type_style_index_0_lang-TDF0kXS0.js";const I={class:"section-content"},k={class:"section-content"},N={class:"section-content"},T=h({__name:"Index",setup(w){const c=$(),a=y({name:null,phone:null,price:"$50"}),f={iconRight:"pi pi-chevron-right",label:"Next",severity:"primary",variant:"filled"},v={iconLeft:"pi pi-chevron-left",label:"Back",severity:"secondary",variant:"filled"},u=[{content:"Please enter personal details",label:"Personal",step:1},{content:"Please enter contact details",label:"Contact",step:2},{content:"Please enter payment details",label:"Payment",step:3},{content:"Do you wish to continue?",label:"Confirmation",step:4}],g=()=>{c.push("/ui")};return(n,e)=>{const m=B("SshPre");return S(),C(D,{title:n.$t("ui.stepper.title"),class:"demo"},{toolbar:o(()=>[l(p(V),{label:n.$t("common.back"),"icon-left":"pi pi-chevron-left",size:"medium",variant:"textOnly",onClick:e[0]||(e[0]=r=>n.$router.push("/ui"))},null,8,["label"])]),default:o(()=>[e[16]||(e[16]=t()),s("section",null,[s("h2",null,i(n.$t("ui.stepper.usage.basic")),1),e[6]||(e[6]=t()),s("div",I,[l(p(d),{steps:u,onComplete:g}),e[5]||(e[5]=t()),l(m,{language:"html-vue"},{default:o(()=>e[4]||(e[4]=[t(`
          <template>
          ...
          <\/script>
        `)])),_:1})])]),e[17]||(e[17]=t()),s("section",null,[s("h2",null,i(n.$t("ui.stepper.usage.buttonProperties")),1),e[9]||(e[9]=t()),s("div",k,[l(p(d),{"next-button-properties":f,"previous-button-properties":v,steps:u}),e[8]||(e[8]=t()),l(m,{language:"html-vue"},{default:o(()=>e[7]||(e[7]=[t(`
          <template>
            <Stepper
