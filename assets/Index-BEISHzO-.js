import{d,s as c,j as p,o as m,w as a,A as t,e,t as s,g as o,u as l,E as r,B as h}from"./index-j9ugvOHR.js";import{_ as f}from"./UiPage.vue_vue_type_style_index_0_lang-BeVgrYUm.js";const _={class:"section-content"},g={class:"content"},C={class:"section-content"},v={class:"content"},$={class:"section-content"},b={class:"content"},z={class:"section-content"},k={class:"title"},w={class:"content"},B={class:"footer"},y=d({__name:"Index",setup(I){return(n,u)=>{const i=c("SshPre");return m(),p(f,{title:n.$t("ui.card.title"),class:"demo"},{toolbar:a(()=>[o(l(h),{label:n.$t("common.back"),"icon-left":"pi pi-chevron-left",size:"medium",variant:"textOnly",onClick:u[0]||(u[0]=N=>n.$router.push("/ui"))},null,8,["label"])]),default:a(()=>[t(),e("section",null,[e("h2",null,s(n.$t("ui.card.usage.basic")),1),t(),e("div",_,[o(l(r),null,{default:a(()=>[e("p",g,s(n.$t("ui.card.content")),1)]),_:1}),t(),o(i,{language:"html-vue"},{default:a(()=>[t(`
          <template>
            <Card>
              <p>
                ...
