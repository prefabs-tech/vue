import{T as m,P as f}from"./PrefabsTechVue3Form.es-seLFyOMU.js";import{d as $,G as y,I as E,L as D,r as d,H as O,e as F,o as M,j as a,B as n,f as o,h as r,t as b,u as t,v as z}from"./index-DACAZjT2.js";import{_ as S}from"./ComponentDocumentation.vue_vue_type_script_setup_true_lang-DLliI7It.js";import{_ as P}from"./FormPage.vue_vue_type_style_index_0_lang-BU-G6ifo.js";import"./PrefabsTechVue3TanstackTable.es-xbUjmz2n.js";const q={class:"section-content"},w={class:"section-content"},U={class:"section-content"},T={class:"section-content"},B={class:"section-content"},h={class:"section-content"},k={class:"section-content"},C={name:"NumberInputField"},A=$({...C,setup(L){const{t:i}=y(),g=[{description:i("form.documentation.eventDescription.input.modelValue"),name:"update:modelValue",payload:"number | undefined"}],I=E.coerce.number({invalid_type_error:i("form.errors.number.invalid")}).gte(1,i("form.errors.number.invalid")).lte(100,i("form.errors.number.invalid")),V=[{default:"false",description:i("form.documentation.propsDescription.input.disabled"),prop:"disabled",type:"Boolean"},{default:'{ required: "The field is required", invalid: "Please provide a valid integer field" }',description:i("form.documentation.propsDescription.input.errorMessages"),prop:"errorMessages",type:"NumberErrorMessages"},{default:"-",description:i("form.documentation.propsDescription.input.label"),prop:"label",type:"String"},{default:"undefined",description:i("form.documentation.propsDescription.input.modelValue"),prop:"modelValue",type:"number | null | undefined"},{default:'"number"',description:i("form.documentation.propsDescription.input.name"),prop:"name",type:"String"},{default:"-",description:i("form.documentation.propsDescription.input.options"),prop:"options",type:"IsIntOptions"},{default:"-",description:i("form.documentation.propsDescription.input.placeholder"),prop:"placeholder",type:"String"},{default:"-",description:i("form.documentation.propsDescription.input.schema"),prop:"schema",type:"z.ZodType<string | number>"}],N={invalid:i("form.errors.number.invalid"),required:i("form.errors.number.required")},v={min:1,max:100,allow_leading_zeroes:!1};let u=D({customValidationInput:d(),disabled:d(100),i18nInput:d(),input:d(),inputWithValidation:d(),noLabelInput:d(),textInput:d()});return(l,e)=>{const p=O("SshPre");return M(),F(P,{subtitle:t(i)("form.subtitle.number"),title:l.$t("form.label.number"),class:"demo"},{toolbar:a(()=>[r(t(z),{label:l.$t("common.back"),"icon-left":"pi pi-chevron-left",size:"medium",variant:"textOnly",onClick:e[0]||(e[0]=s=>l.$router.push("/form"))},null,8,["label"])]),default:a(()=>[e[30]||(e[30]=n()),o("section",null,[o("h2",null,b(l.$t("form.label.basicInput")),1),e[10]||(e[10]=n()),o("div",q,[r(t(m),{modelValue:t(u).noLabelInput,"onUpdate:modelValue":e[1]||(e[1]=s=>t(u).noLabelInput=s),placeholder:l.$t("form.placeholder.number")},null,8,["modelValue","placeholder"]),e[9]||(e[9]=n()),r(p,{language:"html-vue"},{default:a(()=>e[8]||(e[8]=[n(`
          <template>
            <NumberInput 
              v-model="input"
