import{d as E,r as d,z,e as m,o as f,w as a,D as e,f as o,t as r,b,i as s,u as i,j as u,S as p}from"./index-BptziAgc.js";import{_ as L}from"./UiPage.vue_vue_type_style_index_0_lang-DMttkvIH.js";const D={class:"section-content"},O={class:"container"},I={class:"section-content"},T={class:"container"},N={class:"section-content"},S={class:"container"},V={class:"section-content"},U={class:"container"},H={class:"section-content"},P={class:"container"},j={class:"section-content"},q={class:"container"},J=E({__name:"Index",setup(A){const k=d(void 0),w=d(!1),M=d(!1),$=d(!1),y=d(!1),C=d(!1),g=d(!1),B=()=>{k.value=new Date,g.value=!1};return(l,n)=>{const v=z("SshPre");return f(),m(L,{title:l.$t("ui.confirmationModal.title"),class:"demo"},{toolbar:a(()=>[s(i(u),{label:l.$t("common.back"),"icon-left":"pi pi-chevron-left",size:"medium",variant:"textOnly",onClick:n[0]||(n[0]=t=>l.$router.push("/ui"))},null,8,["label"])]),default:a(()=>[n[53]||(n[53]=e()),o("section",null,[o("h2",null,r(l.$t("ui.confirmationModal.usage.basic")),1),n[25]||(n[25]=e()),o("div",D,[o("div",O,[s(i(u),{label:l.$t("ui.confirmationModal.buttonLabel.confirm"),severity:"success",onClick:n[1]||(n[1]=t=>g.value=!0)},null,8,["label"]),n[21]||(n[21]=e()),o("span",null,r(k.value),1)]),n[23]||(n[23]=e()),g.value?(f(),m(i(p),{key:0,"onOn:close":n[2]||(n[2]=t=>g.value=!1),"onOn:confirm":n[3]||(n[3]=t=>B())})):b("",!0),n[24]||(n[24]=e()),s(v,{language:"html-vue"},{default:a(()=>n[22]||(n[22]=[e(`
          <template>
            <ButtonElement
              label="Confirm"
              severity="success"
        ...
        `)])),_:1})])]),n[54]||(n[54]=e()),o("section",null,[o("h2",null,r(l.$t("ui.confirmationModal.usage.withDivider")),1),n[29]||(n[29]=e()),o("div",I,[o("div",T,[s(i(u),{label:l.$t("ui.confirmationModal.buttonLabel.confirm"),severity:"success",onClick:n[4]||(n[4]=t=>w.value=!0)},null,8,["label"])]),n[27]||(n[27]=e()),w.value?(f(),m(i(p),{key:0,divider:"","onOn:close":n[5]||(n[5]=t=>w.value=!1),"onOn:confirm":n[6]||(n[6]=t=>w.value=!1)})):b("",!0),n[28]||(n[28]=e()),s(v,{language:"html-vue"},{default:a(()=>n[26]||(n[26]=[e(`
          ...
          <script setup lang="ts">
            ...
            const showModal = ref(false);
          <\/script>
        `)])),_:1})])]),n[55]||(n[55]=e()),o("section",null,[o("h2",null,r(l.$t("ui.confirmationModal.usage.disableHeader")),1),n[33]||(n[33]=e()),o("div",N,[o("div",S,[s(i(u),{label:l.$t("ui.confirmationModal.buttonLabel.confirm"),severity:"success",onClick:n[7]||(n[7]=t=>y.value=!0)},null,8,["label"])]),n[31]||(n[31]=e()),y.value?(f(),m(i(p),{key:0,"disable-header":"","onOn:close":n[8]||(n[8]=t=>y.value=!1),"onOn:confirm":n[9]||(n[9]=t=>y.value=!1)})):b("",!0),n[32]||(n[32]=e()),s(v,{language:"html-vue"},{default:a(()=>n[30]||(n[30]=[e(`
          <template>
            <ButtonElement
              label="Confirm"
              severity="success"
          ...
          <script setup lang="ts">
            ...
            const showModal = ref(false);
          <\/script>
        `)])),_:1})])]),n[56]||(n[56]=e()),o("section",null,[o("h2",null,r(l.$t("ui.confirmationModal.usage.disableBody")),1),n[37]||(n[37]=e()),o("div",V,[o("div",U,[s(i(u),{label:l.$t("ui.confirmationModal.buttonLabel.confirm"),severity:"success",onClick:n[10]||(n[10]=t=>$.value=!0)},null,8,["label"])]),n[35]||(n[35]=e()),$.value?(f(),m(i(p),{key:0,"disable-body":"","onOn:close":n[11]||(n[11]=t=>$.value=!1),"onOn:confirm":n[12]||(n[12]=t=>$.value=!1)})):b("",!0),n[36]||(n[36]=e()),s(v,{language:"html-vue"},{default:a(()=>n[34]||(n[34]=[e(`
          <template>
            <ButtonElement
              label="Confirm"
              severity="success"
