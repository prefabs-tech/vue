import{D as e,E as t,On as n,St as r,_ as i,b as a,gn as o,k as s,mt as c,qt as l,tr as u,v as d,vn as f,y as p}from"./runtime-core.esm-bundler-BKdLzFmX.js";import{u as m}from"./vee-validate-Dcr5wvVn.js";import{T as h}from"./PrefabsTechVue3Layout.es-DjWCbXPc.js";import{t as g}from"./FormPage-Ca1LZeR4.js";import{c as _,m as v}from"./PrefabsTechVue3TanstackTable.es-Dqv6JrPc.js";import{t as y}from"./ComponentDocumentation-CFBF3GmY.js";var b={class:`section-content`},x={key:0,class:`result-date`},S={class:`section-content`},C={key:0,class:`result-date`},w={class:`section-content`},T={key:0,class:`result-date`},E={class:`section-content`},D={key:0,class:`result-date`},O=s({name:`DaysInputDemo`,setup(s){let{t:O}=h(),k=m.number({invalid_type_error:O(`form.errors.number.required`)}).min(1,{message:O(`form.errors.daysInput.invalid`)}).max(365,{message:O(`form.errors.daysInput.invalid`)}),A=[{description:O(`form.documentation.eventDescription.daysInput.date`),name:`update:date`,payload:`date: string`},{description:O(`form.documentation.eventDescription.input.modelValue`),name:`update:modelValue`,payload:`value: number`}],j=[{default:`false`,description:O(`form.documentation.propsDescription.input.disabled`),prop:`disabled`,type:`Boolean`},{default:`-`,description:O(`form.documentation.propsDescription.input.label`),prop:`label`,type:`String`},{default:`-`,description:O(`form.documentation.propsDescription.input.modelValue`),prop:`modelValue`,type:`Number | Null | Undefined`},{default:`"days-input"`,description:O(`form.documentation.propsDescription.input.name`),prop:`name`,type:`String`},{default:`-`,description:O(`form.documentation.propsDescription.input.placeholder`),prop:`placeholder`,type:`String`},{default:`z.coerce.number().optional()`,description:O(`form.documentation.propsDescription.input.schema`),prop:`schema`,type:`z.ZodType<string | number>`}],M=o({basic:f(),disabled:f(),label:f(),validationInput:f()}),N=o({basic:f(),disabled:f(30),label:f(),validationInput:f()});return(o,s)=>{let f=r(`SshPre`);return c(),d(g,{subtitle:o.$t(`form.subtitle.daysInput`),title:o.$t(`form.label.daysInput`),class:`demo`},{default:l(()=>[i(`section`,null,[i(`h2`,null,u(o.$t(`form.label.basicInput`)),1),s[11]||=t(),i(`div`,b,[e(n(v),{modelValue:n(N).basic,"onUpdate:modelValue":s[0]||=e=>n(N).basic=e,placeholder:o.$t(`form.placeholder.days`),"onUpdate:date":s[1]||=e=>M.basic=e},null,8,[`modelValue`,`placeholder`]),s[9]||=t(),M.basic?(c(),a(`div`,x,u(M.basic),1)):p(``,!0),s[10]||=t(),e(f,{language:`html-vue`},{default:l(()=>[...s[8]||=[t(`
          <template>
            <DaysInput
              v-model="input"
