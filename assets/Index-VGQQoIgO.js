import{d as v,z as b,s as g,j as f,o as I,w as a,B as n,e as t,t as r,g as e,u as i,K as m,C as y,L as h}from"./index-Cc4iPlXT.js";import{_ as S}from"./UserPage.vue_vue_type_style_index_0_lang-snUWfa_I.js";const _={class:"section-content"},D={class:"section-content"},P={class:"section-content"},F={class:"section-content"},R={class:"section-content"},U=v({__name:"Index",setup(z){const{t:p}=b(),u=[{id:1,name:"ADMIN"},{id:2,name:"SUPERADMIN"},{id:3,name:"USER"}],c=[{id:1,name:"Admin",origin:"admin-origin",supportedRoles:[{id:1,name:"ADMIN"},{id:2,name:"SUPERADMIN"}]},{id:2,name:"User",origin:"user-origin",supportedRoles:[{id:3,name:"USER"}]}],s=o=>{h({text:p("user.message.invitation.success",{user:o.email}),type:"success"})};return(o,d)=>{const l=g("SshPre");return I(),f(S,{title:o.$t("user.label.invitationForm"),class:"demo-invitation-form"},{toolbar:a(()=>[e(i(y),{label:o.$t("common.back"),"icon-left":"pi pi-chevron-left",size:"medium",variant:"textOnly",onClick:d[0]||(d[0]=A=>o.$router.push("/user"))},null,8,["label"])]),default:a(()=>[n(),t("section",null,[t("h2",null,r(o.$t("user.label.basic")),1),n(),t("div",_,[e(i(m),{onSubmit:s}),n(),e(l,{language:"html-vue"},{default:a(()=>[n(`
          <template>
