import{d as L,e as d,r as B,o as O,c as z,w as r,a as o,t as i,f as e,g as l,h as s,a5 as u,Y as f,Z as v,a7 as c}from"./index-d32261a6.js";const D={class:"section-content"},I={class:"container"},S={class:"section-content"},P={class:"container"},T={class:"section-content"},N={class:"container"},U={class:"section-content"},V={class:"container"},F={class:"section-content"},H={class:"container"},A={class:"section-content"},G={class:"container"},Y={class:"section-content"},Z={class:"container"},j={class:"section-content"},q={class:"container"},Q=L({__name:"Index",setup(J){const b=d(void 0),p=d(!1),M=d(!1),w=d(!1),h=d(!1),g=d(!1),C=d(!1),$=d(!1),y=d(!1);function k(){b.value=new Date,y.value=!1}return(t,n)=>{const m=B("SshPre"),E=B("Page");return O(),z(E,{title:t.$t("ui.confirmationModal.title"),class:"demo"},{default:r(()=>[o("section",null,[o("h2",null,i(t.$t("ui.confirmationModal.usage.basic")),1),e(),o("div",D,[l(m,{language:"html-vue"},{default:r(()=>[e(`
          <template>
            <div>
              <ButtonElement
                label="Confirm"
        ...
        `)]),_:1}),e(),o("div",G,[l(s(u),{label:t.$t("ui.confirmationModal.buttonLabel.confirm"),severity:"success",onClick:n[15]||(n[15]=a=>M.value=!0)},null,8,["label"]),e(),o("span",null,i(b.value),1)]),e(),f(l(s(c),{"onOn:close":n[16]||(n[16]=a=>M.value=!1),"onOn:confirm":n[17]||(n[17]=a=>M.value=!1)},{header:r(()=>[o("span",null,i(t.$t("ui.confirmationModal.headerContent.deleteUser")),1)]),body:r(()=>[o("p",null,i(t.$t("ui.confirmationModal.bodyContent.confirmDelete")),1)]),footer:r(()=>[l(s(u),{size:"small",label:t.$t("ui.confirmationModal.buttonLabel.cancel"),severity:"secondary"},null,8,["label"]),e(),l(s(u),{size:"small",label:t.$t("ui.confirmationModal.buttonLabel.delete"),severity:"danger"},null,8,["label"])]),_:1},512),[[v,M.value]])])]),e(),o("section",null,[o("h2",null,i(t.$t("ui.confirmationModal.usage.withI18n")),1),e(),o("div",Y,[l(m,{language:"html-vue"},{default:r(()=>[e(`
          ...
          <script setup lang="ts">
            ...
            const { t } = useI18n();
          <\/script>
        `)]),_:1}),e(),o("div",Z,[l(s(u),{label:t.$t("ui.confirmationModal.buttonLabel.confirm"),severity:"success",onClick:n[18]||(n[18]=a=>$.value=!0)},null,8,["label"]),e(),o("span",null,i(b.value),1)]),e(),f(l(s(c),{"onOn:close":n[19]||(n[19]=a=>$.value=!1),"onOn:confirm":n[20]||(n[20]=a=>$.value=!1)},{header:r(()=>[o("span",null,i(t.$t("ui.confirmationModal.headerContent.deleteUser")),1)]),body:r(()=>[o("p",null,i(t.$t("ui.confirmationModal.bodyContent.confirmDelete")),1)]),footer:r(()=>[l(s(u),{size:"small",label:t.$t("ui.confirmationModal.buttonLabel.cancel"),severity:"secondary"},null,8,["label"]),e(),l(s(u),{size:"small",label:t.$t("ui.confirmationModal.buttonLabel.delete"),severity:"danger"},null,8,["label"])]),_:1},512),[[v,$.value]])])]),e(),o("section",null,[o("h2",null,i(t.$t("ui.confirmationModal.usage.customStyle")),1),e(),o("div",j,[l(m,{language:"html-vue"},{default:r(()=>[e(`
          <template>
            <div>
              <ButtonElement
                label="Confirm"
        ...
        `)]),_:1}),e(),o("div",q,[l(s(u),{label:t.$t("ui.confirmationModal.buttonLabel.confirm"),severity:"success",onClick:n[21]||(n[21]=a=>w.value=!0)},null,8,["label"])]),e(),f(l(s(c),{class:"custom-modal","onOn:close":n[22]||(n[22]=a=>w.value=!1),"onOn:confirm":n[23]||(n[23]=a=>w.value=!1)},null,512),[[v,w.value]])])])]),_:1},8,["title"])}}});export{Q as default};
