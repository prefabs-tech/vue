import{d as g,e as h,o as y,c as f,w as u,a as t,t as o,f as e,g as n,h as i,a5 as a,r as p,a0 as _,a1 as B,_ as E}from"./index-8250d14f.js";const c=r=>(_("data-v-c6ad00d1"),r=r(),B(),r),$={class:"section-content"},z={class:"container"},O={class:"section-content"},k={class:"container"},C={class:"section-content"},S={class:"container"},w={class:"section-content"},D={class:"container"},I={class:"section-content"},N={class:"container"},T={class:"section-content"},P={className:"container"},R={class:"section-content"},W={className:"container"},L=c(()=>t("i",{class:"pi pi-user"},null,-1)),M=c(()=>t("i",{class:"pi pi-user"},null,-1)),V=c(()=>t("i",{class:"pi pi-user"},null,-1)),A={class:"section-content"},F={class:"container"},j={class:"container"},q={class:"section-content"},G={class:"container"},H=g({__name:"Index",setup(r){const d=h(void 0);function b(){d.value=new Date}return(l,m)=>{const s=p("SshPre"),v=p("Page");return y(),f(v,{title:l.$t("ui.button.title"),class:"demo-button"},{default:u(()=>[t("section",null,[t("h2",null,o(l.$t("ui.button.usage.basic")),1),e(),t("div",$,[n(s,{language:"html-vue"},{default:u(()=>[e(`
          <template> 
          ...
          <\/script>
        `)]),_:1}),e(),t("div",z,[n(i(a),{label:l.$t("ui.button.label.clickMe"),onClick:m[0]||(m[0]=J=>b())},null,8,["label"]),e(),t("span",null,o(d.value),1)])])]),e(),t("section",null,[t("h2",null,o(l.$t("ui.button.usage.buttonWithChild")),1),e(),t("div",O,[n(s,{language:"html-vue"},{default:u(()=>[e(`
          <template> 
        ...
        `)]),_:1}),e(),t("div",W,[n(i(a),{variant:"textOnly",severity:"secondary","icon-left":"true",rounded:""},{iconLeft:u(()=>[L]),_:1}),e(),n(i(a),{severity:"secondary",variant:"outlined","icon-right":"true",rounded:""},{iconRight:u(()=>[M]),_:1}),e(),n(i(a),{"icon-right":"true",variant:"filled",rounded:""},{iconRight:u(()=>[V]),_:1})])])]),e(),t("section",null,[t("h2",null,o(l.$t("ui.button.usage.icons.iconWithText")),1),e(),t("div",A,[n(s,{language:"html-vue"},{default:u(()=>[e(`
          ...
          <script setup lang="ts"> 
            import { ButtonElement } from "@dzangolab/vue3-ui"; 
          <\/script>
        `)]),_:1}),e(),t("div",F,[n(i(a),{label:l.$t("ui.button.label.textOnly"),"icon-left":"pi pi-user",variant:"textOnly"},null,8,["label"]),e(),n(i(a),{label:l.$t("ui.button.label.outlined"),"icon-left":"pi pi-user",variant:"outlined"},null,8,["label"]),e(),n(i(a),{label:l.$t("ui.button.label.default"),"icon-left":"pi pi-user",variant:"filled"},null,8,["label"])]),e(),t("div",j,[n(i(a),{label:l.$t("ui.button.label.textOnly"),"icon-right":"pi pi-user",rounded:"",variant:"textOnly"},null,8,["label"]),e(),n(i(a),{label:l.$t("ui.button.label.outlined"),"icon-right":"pi pi-user",rounded:"",variant:"outlined"},null,8,["label"]),e(),n(i(a),{label:l.$t("ui.button.label.default"),"icon-right":"pi pi-user",rounded:"",variant:"filled"},null,8,["label"])])])]),e(),t("section",null,[t("h2",null,o(l.$t("ui.button.usage.redirect")),1),e(),t("div",q,[n(s,{language:"html-vue"},{default:u(()=>[e(`
          <template> 
          ...
          <script setup lang="ts"> 
            import { ButtonElement } from "@dzangolab/vue3-ui"; 
          <\/script>
        `)]),_:1}),e(),t("div",G,[n(i(a),{label:l.$t("ui.button.label.home"),to:"/"},null,8,["label"]),e(),n(i(a),{label:l.$t("ui.button.label.back"),severity:"secondary",to:"/vue/#/ui"},null,8,["label"])])])])]),_:1},8,["title"])}}});const Q=E(H,[["__scopeId","data-v-c6ad00d1"]]);export{Q as default};
