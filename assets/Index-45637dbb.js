import{d as p,u as f,e as i,r,o as l,c as _,w as u,a,t as n,f as s,g as c,h as b,ac as h,D as L,E as k}from"./index-3fcf3b87.js";const y={class:"section-content"},S={key:0,class:"most-favourite"},C=p({__name:"Index",setup(D){const{t:e}=f(),d=i([{id:1,data:e("ui.sortableList.games.basketball")},{id:2,data:e("ui.sortableList.games.cricket")},{id:3,data:e("ui.sortableList.games.football")},{id:4,data:e("ui.sortableList.games.hockey")},{id:5,data:e("ui.sortableList.games.volleyball")}]),o=i(),m=t=>{o.value=t[0].data};return(t,B)=>{const v=r("SshPre"),g=r("Page");return l(),_(g,{title:t.$t("ui.sortableList.title"),class:"demo-sortable-list"},{default:u(()=>[a("section",null,[a("h2",null,n(t.$t("ui.sortableList.usage.basic")),1),s(),a("div",y,[c(v,{language:"html-vue"},{default:u(()=>[s(`
          <template>
