import{d as E,j as d,K as h,o as m,c as f,w as i,L as a,C as e,M as r,f as o,E as s,as as u,av as v,g as b}from"./index-6962cf42-46e4151e.js";import{_ as L}from"./UiPage.vue_vue_type_style_index_0_lang-081924df.js";const z={class:"section-content"},D={class:"container"},O={class:"section-content"},I={class:"container"},T={class:"section-content"},N={class:"container"},V={class:"section-content"},S={class:"container"},U={class:"section-content"},H={class:"container"},P={class:"section-content"},j={class:"container"},q=E({__name:"Index",setup(A){const g=d(void 0),C=d(!1),p=d(!1),w=d(!1),y=d(!1),M=d(!1),$=d(!1),k=()=>{g.value=new Date,$.value=!1};return(l,n)=>{const B=h("router-link"),c=h("SshPre");return m(),f(L,{title:l.$t("ui.confirmationModal.title"),class:"demo"},{toolbar:i(()=>[a(B,{to:{name:"ui"},class:"back"},{default:i(()=>[e(r(l.$t("common.back")),1)]),_:1})]),default:i(()=>[e(),o("section",null,[o("h2",null,r(l.$t("ui.confirmationModal.usage.basic")),1),e(),o("div",z,[o("div",D,[a(s(u),{label:l.$t("ui.confirmationModal.buttonLabel.confirm"),severity:"success",onClick:n[0]||(n[0]=t=>$.value=!0)},null,8,["label"]),e(),o("span",null,r(g.value),1)]),e(),$.value?(m(),f(s(v),{key:0,"onOn:close":n[1]||(n[1]=t=>$.value=!1),"onOn:confirm":n[2]||(n[2]=t=>k())})):b("",!0),e(),a(c,{language:"html-vue"},{default:i(()=>[e(`
          <template>
            <ButtonElement
              label="Confirm"
              severity="success"
