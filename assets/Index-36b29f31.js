import{d as r,r as u,o as d,c as g,w as e,a as n,t as i,f as t,g as l,h as s,a5 as m,af as p}from"./index-01daf0cc.js";const h={class:"section-content"},v={class:"section-content"},_={class:"trigger"},f={class:"section-content"},T={class:"trigger"},b={class:"section-content"},$={class:"trigger"},y={class:"section-content"},z={class:"trigger"},B={class:"section-content"},k={class:"trigger"},C={class:"section-content"},P={class:"trigger"},V=r({__name:"Index",setup(w){return(o,N)=>{const a=u("SshPre"),c=u("Page");return d(),g(c,{title:o.$t("ui.tooltip.title"),class:"demo"},{default:e(()=>[n("section",null,[n("h2",null,i(o.$t("ui.tooltip.usage.basic")),1),t(),n("div",h,[l(a,{language:"html-vue"},{default:e(()=>[t(`
          <template>
            <Tooltip>
              <ButtonElement
                :label="Tooltip"
        ...
        `)]),_:1}),t(),l(s(p),{position:"left"},{content:e(()=>[t(i(o.$t("ui.tooltip.content")),1)]),default:e(()=>[n("div",$,i(o.$t("ui.tooltip.usage.left")),1),t()]),_:1})])]),t(),n("section",null,[n("h2",null,i(o.$t("ui.tooltip.usage.right")),1),t(),n("div",y,[l(a,{language:"html-vue"},{default:e(()=>[t(`
          ...
          import { Tooltip } from "@dzangolab/vue3-ui";
          <\/script>
        `)]),_:1}),t(),l(s(p),{position:"right"},{content:e(()=>[t(i(o.$t("ui.tooltip.content")),1)]),default:e(()=>[n("div",z,i(o.$t("ui.tooltip.usage.right")),1),t()]),_:1})])]),t(),n("section",null,[n("h2",null,i(o.$t("ui.tooltip.usage.clickable")),1),t(),n("div",B,[l(a,{language:"html-vue"},{default:e(()=>[t(`
          <template>
            <Tooltip clickable>
              <div class="trigger">
                Clickable
          ...
          import { Tooltip } from "@dzangolab/vue3-ui";
          <\/script>
        `)]),_:1}),t(),l(s(p),{clickable:""},{content:e(()=>[t(i(o.$t("ui.tooltip.content")),1)]),default:e(()=>[n("div",k,i(o.$t("ui.tooltip.label.button")),1),t()]),_:1})])]),t(),n("section",null,[n("h2",null,i(o.$t("ui.tooltip.usage.delay")),1),t(),n("div",C,[l(a,{language:"html-vue"},{default:e(()=>[t(`
          <template>
            <Tooltip :delay="1000">
              <div class="trigger">
                Delay
