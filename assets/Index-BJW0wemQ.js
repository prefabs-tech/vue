import{F as p,o as b}from"./DzangolabVue3Form.es-Cf29nzIN.js";import{d as h,x as g,y as v,z as I,r as d,s as V,j as $,o as w,w as m,A as e,e as t,t as i,g as o,u as l,B as y}from"./index-j9ugvOHR.js";import{_ as z}from"./FormPage.vue_vue_type_style_index_0_lang-CciDNi3U.js";const U={class:"section-content"},F={class:"section-content"},S={class:"section-content"},E={class:"section-content"},T={class:"section-content"},W={class:"section-content"},k={name:"InputField"},P=h({...k,setup(B){const{t:f}=g(),c=v.string().min(3,{message:f("form.errors.input.min",{length:3})});let s=I({disabled:d("monorepo@gmail.com"),input:d(),inputWithValidation:d(),noLabelInput:d(),passwordInput:d()});return(n,a)=>{const u=V("SshPre");return w(),$(z,{title:n.$t("form.label.input"),class:"demo"},{toolbar:m(()=>[o(l(y),{label:n.$t("common.back"),"icon-left":"pi pi-chevron-left",size:"medium",variant:"textOnly",onClick:a[0]||(a[0]=r=>n.$router.push("/form"))},null,8,["label"])]),default:m(()=>[e(),t("section",null,[t("h2",null,i(n.$t("form.label.basicInput")),1),e(),t("div",U,[o(l(p),{modelValue:l(s).noLabelInput,"onUpdate:modelValue":a[1]||(a[1]=r=>l(s).noLabelInput=r),placeholder:n.$t("form.placeholder.username"),type:"text"},null,8,["modelValue","placeholder"]),e(),o(u,{language:"html-vue"},{default:m(()=>[e(`
          <template>
            <Input 
              v-model="username"
        ...
        `)]),_:1}),e()])]),e(),t("section",null,[t("h2",null,i(n.$t("form.label.withI18n")),1),e(),t("div",T,[o(l(p),{modelValue:l(s).input,"onUpdate:modelValue":a[5]||(a[5]=r=>l(s).input=r),label:n.$t("form.label.username"),placeholder:n.$t("form.placeholder.username")},null,8,["modelValue","label","placeholder"]),e(),o(u,{language:"html-vue"},{default:m(()=>[e(`
          ...
          const { t } = useI18n();
          <\/script>
        `)]),_:1}),e()])]),e(),t("section",null,[t("h2",null,i(n.$t("form.label.inputWithValidation")),1),e(),t("div",W,[o(l(b),null,{default:m(()=>[o(l(p),{modelValue:l(s).inputWithValidation,"onUpdate:modelValue":a[6]||(a[6]=r=>l(s).inputWithValidation=r),label:n.$t("form.label.title"),placeholder:n.$t("form.placeholder.title"),schema:l(c),name:"title",type:"text"},null,8,["modelValue","label","placeholder","schema"])]),_:1}),e(),o(u,{language:"html-vue"},{default:m(()=>[e(`
          <Form>
            <Input 
              v-model="courseTitle"
              :schema="inputSchema"
