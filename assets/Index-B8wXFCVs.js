import{d as p,K as r,f as g,o as b,i as a,E as n,g as l,t as u,h as o,u as i,a1 as s,x as m,_ as v}from"./index-CKc01FpU.js";import{_ as f}from"./UiPage.vue_vue_type_style_index_0_lang-BW3EjCsZ.js";const C={class:"section-content"},B={class:"section-content"},y={class:"section-content"},$={class:"section-content"},k={class:"container"},z={class:"section-content"},w={class:"container"},I={class:"section-content"},L={class:"container"},S={class:"section-content"},P={class:"container"},N={class:"section-content"},R={class:"container"},V=p({__name:"Index",setup(A){return(t,e)=>{const d=r("SshPre");return b(),g(f,{title:t.$t("ui.badge.title"),class:"demo-badge"},{toolbar:a(()=>[o(i(m),{label:t.$t("common.back"),"icon-left":"pi pi-chevron-left",size:"medium",variant:"textOnly",onClick:e[0]||(e[0]=D=>t.$router.push("/ui"))},null,8,["label"])]),default:a(()=>[e[36]||(e[36]=n()),l("section",null,[l("h2",null,u(t.$t("ui.badge.usage.basic")),1),e[3]||(e[3]=n()),l("div",C,[o(i(s),{label:t.$t("ui.badge.label.basic")},null,8,["label"]),e[2]||(e[2]=n()),o(d,{language:"html-vue"},{default:a(()=>e[1]||(e[1]=[n(`
          <template>
