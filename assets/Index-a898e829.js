import{d as g,u as I,b as V,e as r,o as v,c as y,w as u,a as s,t as d,f as e,g as t,h as n,r as f}from"./index-3bb8d7f9.js";import{m as $,j as i,z as _}from"./DzangolabVue3Form.es-ceb02955.js";const w={class:"demo-section"},z={class:"demo-section"},S={class:"demo-section"},U={class:"demo-section"},W={class:"demo-section"},E={class:"demo-section"},P={name:"InputField"},C=g({...P,setup(F){const{t:c}=I(),b=$.string().min(3,{message:c("form.errors.input.min",{length:3})});let a=V({disabled:r("monorepo@gmail.com"),input:r(),inputWithValidation:r(),noLabelInput:r(),numberInput:r(),passwordInput:r()});return(l,o)=>{const m=f("SshPre"),h=f("Page");return v(),y(h,{title:l.$t("form.label.input")},{default:u(()=>[s("section",w,[s("h3",null,d(l.$t("form.label.basicInput")),1),e(),t(m,{language:"html-vue"},{default:u(()=>[e(`
        <template>
          <Input 
            v-model="input"
