import{R as b,M as B}from"./PrefabsTechVue3Form.es-kbbaSG9O.js";import{d as D,G as S,S as V,L as C,H as I,e as R,o as N,j as s,B as t,f as p,h as o,t as m,u as l,T as c,v as k}from"./index-CVH4OLxf.js";import{_ as w}from"./ComponentDocumentation.vue_vue_type_script_setup_true_lang-C_Qa-nj1.js";import{_ as T}from"./UiPage.vue_vue_type_style_index_0_lang-DZzGP3QU.js";import"./PrefabsTechVue3TanstackTable.es-CcclW_bq.js";const x={class:"section-content"},A={class:"section-content"},L={class:"section-content"},H=D({__name:"Index",setup(F){const{t:a}=S(),f=V(),r=C({name:null,phone:null,price:"$50"}),v=[{description:a("ui.stepper.documentation.eventDescription.complete"),name:"complete",payload:"-"}],P={iconRight:"pi pi-chevron-right",label:"Next",severity:"primary",variant:"filled"},g={iconLeft:"pi pi-chevron-left",label:"Back",severity:"secondary",variant:"filled"},h=[{default:"-",description:a("ui.stepper.documentation.propsDescription.nextButton"),prop:"nextButtonProperties",type:"ActionButtonProperties"},{default:"-",description:a("ui.stepper.documentation.propsDescription.previousButton"),prop:"previousButtonProperties",type:"ActionButtonProperties"},{default:"-",description:a("ui.stepper.documentation.propsDescription.steps"),prop:"steps",type:"Array<StepProperties>"}],y=[{description:a("ui.stepper.documentation.slotDescription.step"),name:"{step}"}],d=[{content:"Please enter personal details",label:"Personal",step:1},{content:"Please enter contact details",label:"Contact",step:2},{content:"Please enter payment details",label:"Payment",step:3},{content:"Do you wish to continue?",label:"Confirmation",step:4}],$=()=>{f.push("/ui")};return(n,e)=>{const u=I("SshPre");return N(),R(T,{"sub-title":n.$t("ui.stepper.subtitle"),title:n.$t("ui.stepper.title"),class:"demo-stepper"},{toolbar:s(()=>[o(l(k),{label:n.$t("common.back"),"icon-left":"pi pi-chevron-left",size:"medium",variant:"textOnly",onClick:e[0]||(e[0]=i=>n.$router.push("/ui"))},null,8,["label"])]),default:s(()=>[e[17]||(e[17]=t()),p("section",null,[p("h2",null,m(n.$t("ui.stepper.usage.basic")),1),e[6]||(e[6]=t()),p("div",x,[o(l(c),{steps:d,onComplete:$}),e[5]||(e[5]=t()),o(u,{language:"html-vue"},{default:s(()=>e[4]||(e[4]=[t(`
          <template>
