import{d as c,J as r,o as d,c as b,w as n,K as l,D as i,ao as g,X as e,f as a,aC as o,L as u,at as m}from"./index-729398ab-f7824fe4.js";import{_ as h}from"./UiPage.vue_vue_type_style_index_0_lang-a00b0a2a.js";const P={class:"section-content"},f={class:"section-content"},v={class:"section-content"},$={class:"section-content"},_={class:"section-content"},B={class:"section-content"},z={class:"section-content"},C={class:"section-content"},S=c({__name:"Index",setup(y){return(t,p)=>{const s=r("SshPre");return d(),b(h,{title:t.$t("ui.page.title"),class:"demo"},{toolbar:n(()=>[l(i(g),{label:t.$t("common.back"),"icon-left":"pi pi-chevron-left",size:"medium",variant:"textOnly",onClick:p[0]||(p[0]=E=>t.$router.push("/ui"))},null,8,["label"])]),default:n(()=>[e(),a("section",null,[a("div",P,[l(i(o),{title:t.$t("ui.page.usage.basic"),"title-element":"h2"},{default:n(()=>[e(u(t.$t("ui.page.label.content")),1)]),_:1},8,["title"]),e(),l(s,{language:"html-vue"},{default:n(()=>[e(`
          <template>
