import{I as p}from"./PrefabsTechVue3Form.es-ChpbHXTo.js";import{_ as d}from"./FormPage.vue_vue_type_style_index_0_lang-BZP5fH04.js";import{d as f,J as g,e as b,o as z,i,f as n,B as t,t as r,h as s,u as m}from"./index-DEvHE8uG.js";const v={class:"section-content"},F={class:"section-content"},S={class:"section-content"},I={class:"section-content"},$={class:"section-content"},B={class:"section-content"},y={class:"section-content"},x={name:"FileInputDemo"},P=f({...x,setup(w){const a={accept:["image/jpeg","image/png"],maxFiles:2,minSize:10240,maxSize:1048576},u=o=>{const e=o/1024;return e>=1024?`${e/1024} MB`:`${e} KB`};return(o,e)=>{const l=g("SshPre");return z(),b(d,{title:o.$t("form.label.fileInput"),class:"demo"},{default:i(()=>[n("section",null,[n("h2",null,r(o.$t("form.label.basicInput")),1),e[2]||(e[2]=t()),n("div",v,[s(m(p)),e[1]||(e[1]=t()),s(l,{language:"html-vue"},{default:i(()=>e[0]||(e[0]=[t(`
          <template>
            <FileInput />
          </template>
        ...
        `)])),_:1})])]),e[22]||(e[22]=t()),n("section",null,[n("h2",null,r(o.$t("form.label.dropzone")),1),e[8]||(e[8]=t()),n("div",S,[s(m(p),{"input-method":"dropzone"}),e[7]||(e[7]=t()),s(l,{language:"html-vue"},{default:i(()=>e[6]||(e[6]=[t(`
          ...
          import { FileInput } from "@prefabs.tech/vue3-form";
          <\/script>
        `)])),_:1})])]),e[23]||(e[23]=t()),n("section",null,[n("h2",null,r(o.$t("form.label.dropzoneOptions")),1),e[11]||(e[11]=t()),n("div",I,[s(m(p),{"dropzone-options":{accept:["image/jpeg","image/png"],maxSize:1e6,minSize:1e3},"enable-description":"","input-method":"dropzone",name:"images","show-error-message":""}),e[10]||(e[10]=t()),s(l,{language:"html-vue"},{default:i(()=>e[9]||(e[9]=[t(`
          <template>
            <FileInput
              :dropzone-options="{
          ...
          import { FileInput } from "@prefabs.tech/vue3-form";
          <\/script>
        `)])),_:1})])]),e[24]||(e[24]=t()),n("section",null,[n("h2",null,r(o.$t("form.label.multiple")),1),e[14]||(e[14]=t()),n("div",$,[s(m(p),{"dropzone-options":{accept:["image/jpeg","image/png"],maxFiles:5},"enable-description":"","input-method":"dropzone",multiple:"",name:"files","show-error-message":""}),e[13]||(e[13]=t()),s(l,{language:"html-vue"},{default:i(()=>e[12]||(e[12]=[t(`
          <template>
            <FileInput
              :dropzone-options="{
                accept: ['image/jpeg', 'image/png'],
