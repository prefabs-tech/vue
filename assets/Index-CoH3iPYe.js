import{O as r}from"./PrefabsTechVue3Form.es-CvBW0pAr.js";import{d,L as f,e as g,o as b,j as i,C as n,f as t,t as m,h as s,u as l,v as z}from"./index-Bs8kt_YR.js";import{_ as v}from"./FormPage.vue_vue_type_style_index_0_lang-BTBPoM6O.js";const F={class:"section-content"},$={class:"section-content"},S={class:"section-content"},I={class:"section-content"},B={class:"section-content"},y={class:"section-content"},x={class:"section-content"},w={name:"FileInputDemo"},M=d({...w,setup(j){const a={accept:["image/jpeg","image/png"],maxFiles:2,minSize:10240,maxSize:1048576},u=o=>{const e=o/1024;return e>=1024?`${e/1024} MB`:`${e} KB`};return(o,e)=>{const p=f("SshPre");return b(),g(v,{title:o.$t("form.label.fileInput"),class:"demo"},{toolbar:i(()=>[s(l(z),{label:o.$t("common.back"),"icon-left":"pi pi-chevron-left",size:"medium",variant:"textOnly",onClick:e[0]||(e[0]=k=>o.$router.push("/form"))},null,8,["label"])]),default:i(()=>[e[22]||(e[22]=n()),t("section",null,[t("h2",null,m(o.$t("form.label.basicInput")),1),e[3]||(e[3]=n()),t("div",F,[s(l(r)),e[2]||(e[2]=n()),s(p,{language:"html-vue"},{default:i(()=>e[1]||(e[1]=[n(`
          <template>
            <FileInput />
          </template>
