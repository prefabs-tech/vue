import{d as A,I as F,r as P,k as p,a3 as K,v as f,J as V,e as O,o as y,i as r,C as t,f as a,t as u,g as i,u as l,a as E,b as R,X as q}from"./index-DzMrXnDW.js";import{j as m}from"./PrefabsTechVue3TanstackTable.es-3gCIUIE2.js";import{c as h,d as b,f as v}from"./data-gOxi8Wva.js";import{_ as B}from"./TablePage.vue_vue_type_style_index_0_lang-9dwIusGX.js";import"./PrefabsTechVue3Form.es-CexM7XFj.js";const M={class:"section-content"},N={class:"section-content"},z={class:"section-content"},j={class:"section-content"},L={class:"section-content"},J={class:"section-content"},U={class:"section-content"},I={class:"section-content"},Q={class:"section-content"},Y={class:"section-content"},W={class:"section-content"},X={class:"section-content"},H={key:0},G={class:"section-content"},Z={class:"section-content"},x={class:"section-content"},_={class:"section-content"},ee={class:"section-content"},te={class:"section-content"},ae={class:"section-content"},ne={name:"SortableTable"},ue=A({...ne,setup(le){const{t:o}=F(),T=[{accessorKey:"email",align:"left",enableColumnFilter:!0,enableSorting:!0,filterPlaceholder:o("table.placeholder.search"),header:"Email"},{accessorKey:"name",enableColumnFilter:!0,enableSorting:!0,filterPlaceholder:o("table.placeholder.search"),header:"Full name"},{accessorKey:"age",align:"right",enableColumnFilter:!0,enableSorting:!0,filterPlaceholder:`${o("table.placeholder.min")},${o("table.placeholder.max")}`,header:"Age",meta:{filterVariant:"range"}},{accessorKey:"city",align:"center",enableColumnFilter:!0,enableSorting:!0,filterPlaceholder:o("table.placeholder.city"),header:"City",meta:{filterVariant:"multiselect",filterOptions:h}}],c=[{accessorKey:"email",enableColumnFilter:!0,enableSorting:!0,filterPlaceholder:o("table.placeholder.search"),header:"Email"},{accessorKey:"name",enableColumnFilter:!0,enableSorting:!0,filterPlaceholder:o("table.placeholder.search"),header:"Full name"},{align:"right",accessorKey:"age",enableColumnFilter:!0,enableSorting:!0,filterPlaceholder:`${o("table.placeholder.min")},${o("table.placeholder.max")}`,header:"Age",meta:{filterVariant:"range"}},{accessorKey:"city",enableColumnFilter:!0,enableSorting:!0,filterPlaceholder:o("table.placeholder.city"),header:"City",meta:{filterVariant:"multiselect",filterOptions:h}}],g=P(!1),C=c.map(n=>({...n,enableSorting:!0})),D=["right","top","bottom","left"],$=[...c,{accessorKey:"disabled",align:"center",cell:({row:n})=>{var e,s;return p(K,{label:(e=n.original)!=null&&e.disabled?o("table.label.disabled"):o("table.label.enabled"),severity:(s=n.original)!=null&&s.disabled?"danger":"success"})},enableColumnFilter:!0,enableSorting:!0,filterPlaceholder:o("table.placeholder.status"),header:"Status",meta:{filterVariant:"select",filterOptions:[{label:o("table.label.enabled"),value:!1},{label:o("table.label.disabled"),value:!0}]}}],w=c.map((n,e)=>({...n,tooltip:!0,tooltipOptions:{position:D[e]}})),S=[{accessorKey:"description",enableColumnFilter:!0,enableSorting:!0,filterPlaceholder:o("table.placeholder.search"),header:"Description"},{accessorKey:"quantity",dataType:"number",enableColumnFilter:!0,enableSorting:!0,filterPlaceholder:`${o("table.placeholder.min")},${o("table.placeholder.max")}`,header:()=>"Quantity",meta:{filterVariant:"range"}},{accessorKey:"amount",dataType:"currency",enableColumnFilter:!0,enableSorting:!0,filterPlaceholder:`${o("table.placeholder.min")},${o("table.placeholder.max")}`,header:"Amount",meta:{filterVariant:"range"}},{accessorKey:"date",dataType:"date",enableColumnFilter:!0,enableSorting:!0,filterPlaceholder:o("table.placeholder.dateRange"),header:"Date",meta:{filterVariant:"dateRange"}},{id:"action",cell:()=>p(f,{iconLeft:"pi pi-eye",variant:"textOnly",rounded:!0}),dataType:"other",header:()=>p("i",{class:"pi pi-cog"})}],k=[{accessorKey:"description",enableColumnFilter:!0,enableSorting:!0,filterPlaceholder:o("table.placeholder.search"),header:"Description"},{accessorKey:"quantity",dataType:"number",enableColumnFilter:!0,enableSorting:!0,filterPlaceholder:`${o("table.placeholder.min")},${o("table.placeholder.max")}`,header:()=>"Quantity",meta:{filterVariant:"range"},numberOptions:{locale:"en-IN"}},{accessorKey:"amount",dataType:"currency",enableColumnFilter:!0,enableSorting:!0,filterPlaceholder:`${o("table.placeholder.min")},${o("table.placeholder.max")}`,header:"Amount",meta:{filterVariant:"range"},numberOptions:{formatOptions:{currency:"EUR"},locale:"en-US"}},{accessorKey:"date",dataType:"date",enableColumnFilter:!0,enableSorting:!0,filterPlaceholder:o("table.placeholder.dateRange"),header:"Date",meta:{filterVariant:"dateRange"}},{accessorKey:"datetime",enableColumnFilter:!0,enableSorting:!0,filterPlaceholder:o("table.placeholder.dateRange"),header:"Datetime",dataType:"datetime",meta:{filterVariant:"dateRange"}},{id:"action",cell:()=>p(f,{iconLeft:"pi pi-eye",variant:"textOnly",rounded:!0}),dataType:"other",header:()=>p("i",{class:"pi pi-cog"})}];return(n,e)=>{const s=V("SshPre");return y(),O(B,{title:n.$t("table.title"),class:"demo data-table"},{toolbar:r(()=>[i(l(f),{label:n.$t("common.back"),"icon-left":"pi pi-chevron-left",size:"medium",variant:"textOnly",onClick:e[0]||(e[0]=d=>n.$router.push("/table"))},null,8,["label"])]),default:r(()=>[e[64]||(e[64]=t()),a("section",null,[a("h2",null,u(n.$t("table.usage.basic")),1),e[8]||(e[8]=t()),a("div",M,[i(l(m),{"columns-data":c,data:l(b).slice(0,15),paginated:!1},null,8,["data"]),e[7]||(e[7]=t()),i(s,{language:"html-vue"},{default:r(()=>e[6]||(e[6]=[t(`
        ...
        `)])),_:1})])]),e[66]||(e[66]=t()),a("section",null,[a("h2",null,u(n.$t("table.usage.sortable")),1),e[14]||(e[14]=t()),a("div",z,[i(l(m),{"columns-data":l(C),data:l(b),"initial-sorting":[{id:"email",desc:!1}],"show-reset-button":""},null,8,["columns-data","data"]),e[13]||(e[13]=t()),i(s,{language:"html-vue"},{default:r(()=>e[12]||(e[12]=[t(`
          ...
          <\/script>
        `)])),_:1})])]),e[67]||(e[67]=t()),a("section",null,[a("h2",null,u(n.$t("table.usage.rowSelection")),1),e[17]||(e[17]=t()),a("div",j,[i(l(m),{"columns-data":c,data:l(b).slice(0,5),"initial-sorting":[{id:"email",desc:!1}],"enable-row-selection":""},null,8,["data"]),e[16]||(e[16]=t()),i(s,{language:"html-vue"},{default:r(()=>e[15]||(e[15]=[t(`
          <template>
            <Table
              :columns-data="columns"
              :data="data"
        ...
        `)])),_:1})])]),e[68]||(e[68]=t()),a("section",null,[a("h2",null,u(n.$t("table.usage.tooltip")),1),e[20]||(e[20]=t()),a("div",L,[i(l(m),{"columns-data":l(w),data:l(b).slice(0,5),"initial-sorting":[{id:"email",desc:!1}],"enable-row-selection":""},null,8,["columns-data","data"]),e[19]||(e[19]=t()),i(s,{language:"html-vue"},{default:r(()=>e[18]||(e[18]=[t(`
          ...
          <\/script>
        `)])),_:1})])]),e[70]||(e[70]=t()),a("section",null,[a("h2",null,u(n.$t("table.usage.columnAction")),1),e[26]||(e[26]=t()),a("div",U,[i(l(m),{"columns-data":c,data:l(b).slice(0,5),"initial-sorting":[{id:"email",desc:!1}],"show-column-action":""},null,8,["data"]),e[25]||(e[25]=t()),i(s,{language:"html-vue"},{default:r(()=>e[24]||(e[24]=[t(`
          <template>
            <Table
              :columns-data="columns"
              :data="data"
          ...
          <\/script>
        `)])),_:1})])]),e[71]||(e[71]=t()),a("section",null,[a("h2",null,u(n.$t("table.usage.title")),1),e[29]||(e[29]=t()),a("div",I,[i(l(m),{"columns-data":c,data:l(b).slice(0,5),"title-info":{text:n.$t("table.label.users"),align:"left"}},null,8,["data","title-info"]),e[28]||(e[28]=t()),i(s,{language:"html-vue"},{default:r(()=>e[27]||(e[27]=[t(`
          <template>
            <Table 
              :columns-data="columns"
              :data="data"
          ...
          <\/script>
        `)])),_:1})])]),e[72]||(e[72]=t()),a("section",null,[a("h2",null,u(n.$t("table.usage.footer")),1),e[32]||(e[32]=t()),a("div",Q,[i(l(m),{"columns-data":c,data:l(b)},{footer:r(()=>[a("tr",null,[a("td",null,u(`${n.$t("table.label.totalRecords")}: ${l(b).length??"0"}`),1)])]),_:1},8,["data"]),e[31]||(e[31]=t()),i(s,{language:"html-vue"},{default:r(()=>e[30]||(e[30]=[t(`
          <template>
            <Table :columns-data="columns" :data="data">
              <template #footer>
                <tr>
