import{v as b,W as D}from"./PrefabsTechVue3TanstackTable.es-D738rBfg.js";import{d as k,u as O,j as u,r as C,o as I,h as E,w as p,a as n,t as d,b as l,e as r,f as o,c as U,F as G,A as L,J as M,i as w,m as g,s as K}from"./index-B97-Idj8.js";import{_ as T}from"./ComponentDocumentation.vue_vue_type_script_setup_true_lang-C12yRNST.js";import{a as B}from"./data-uYwV_J55.js";import{_ as W}from"./FormPage.vue_vue_type_style_index_0_lang-w64d2TfL.js";const H={class:"section-content"},j={class:"section-content"},z={class:"section-content"},A={class:"section-content"},q={class:"section-content"},J={class:"section-content"},Z={class:"section-content"},Q={class:"section-content"},X={class:"section-content"},Y={class:"section-content"},x={class:"section-content"},_={class:"section-content"},ee={class:"section-content"},le={class:"section-content"},te={class:"section-content"},ne={class:"section-content"},oe={class:"section-content"},ae={class:"section-content"},se={class:"selected-labels"},re={class:"section-content"},ie={class:"section-content"},pe={name:"SelectInputDemo"},ve=k({...pe,setup(ue){const{t:s}=O();let i=w({customLabelSelect:u(),customSelectedLabelSelect:u([]),disabled:u("NP"),disabledMultiselect:u(["FR","NP"]),disabledSortInput:u(),disableSearchInput:u(),groupingSelect:u(),i18nSelect:u(),input:u(),inputWithMinMax:u([]),inputWithValidation:u([]),labelValueKeyInput:u(),multiselect:u(),multiselectExtensive:u([]),multiselectGrouping:u([]),multiselectKeysInput:u([]),noLabelInput:u(),roleSelect:u(),selectExtensive:u(),tooltipMultiselect:u([])});const y=u(!1),V=u([]),f=u([{label:s("form.label.france"),value:"FR"},{label:s("form.label.germany"),value:"DE"},{disabled:!0,label:s("form.label.belgium"),value:"BE"},{label:s("form.label.nepal"),value:"NP"},{label:s("form.label.india"),value:"IN"}]),$=u([{code:"FR",country:s("form.label.france")},{code:"DE",country:s("form.label.germany")},{code:"BE",country:s("form.label.belgium"),disabled:!0},{code:"NP",country:s("form.label.nepal")},{code:"IN",country:s("form.label.india")}]),S=u([{label:s("form.label.europe"),options:[{label:s("form.label.germany"),value:"DE"},{label:s("form.label.france"),value:"FR"},{disabled:!0,label:s("form.label.belgium"),value:"BE"}]},{label:s("form.label.asia"),options:[{label:s("form.label.nepal"),value:"NP"},{label:s("form.label.india"),value:"IN"}]}]),F=g(()=>[{description:s("form.documentation.eventDescription.input.modelValue"),name:"update:modelValue",payload:"string | number | (string | number)[] | null | undefined"},{description:s("form.documentation.eventDescription.select.searchInput"),name:"update:searchInput",payload:"string"}]),R=g(()=>K({invalid_type_error:s("form.errors.multiselect.invalid")}).array().min(1,{message:s("form.errors.multiselect.invalid")})),P=g(()=>[{default:"-",description:s("form.documentation.propsDescription.select.customSearchHelperText"),prop:"customSearchHelperText",type:"String"},{default:"false",description:s("form.documentation.propsDescription.input.disabled"),prop:"disabled",type:"Boolean"},{default:"false",description:s("form.documentation.propsDescription.select.disableSearch"),prop:"disableSearch",type:"Boolean"},{default:"false",description:s("form.documentation.propsDescription.select.enableCustomSearch"),prop:"enableCustomSearch",type:"Boolean"},{default:"true",description:s("form.documentation.propsDescription.select.enableTooltip"),prop:"enableTooltip",type:"Boolean"},{default:"true",description:s("form.documentation.propsDescription.select.hasSortedOptions"),prop:"hasSortedOptions",type:"Boolean"},{default:"-",description:s("form.documentation.propsDescription.input.label"),prop:"label",type:"String"},{default:"-",description:s("form.documentation.propsDescription.select.labelKey"),prop:"labelKey",type:"String"},{default:"false",description:s("form.documentation.propsDescription.select.loading"),prop:"loading",type:"Boolean"},{default:"-",description:s("form.documentation.propsDescription.select.maxSelection"),prop:"maxSelection",type:"Number"},{default:"-",description:s("form.documentation.propsDescription.select.minSelection"),prop:"minSelection",type:"Number"},{default:"-",description:s("form.documentation.propsDescription.input.modelValue"),prop:"modelValue",type:"boolean | number | string | (number | string)[] | null"},{default:"false",description:s("form.documentation.propsDescription.select.multiple"),prop:"multiple",type:"Boolean"},{default:'"select"',description:s("form.documentation.propsDescription.input.name"),prop:"name",type:"String"},{default:"-",description:s("form.documentation.propsDescription.select.noOptionsMessage"),prop:"noOptionsMessage",type:"String"},{default:"-",description:s("form.documentation.propsDescription.select.options",{required:!0}),prop:"options",type:"SelectOption[] | GroupedOption[]"},{default:"-",description:s("form.documentation.propsDescription.input.placeholder"),prop:"placeholder",type:"String"},{default:"-",description:s("form.documentation.propsDescription.input.schema"),prop:"schema",type:"z.ZodType<string | number | string[] | number[]>"},{default:"true",description:s("form.documentation.propsDescription.select.showRemoveSelection"),prop:"showRemoveSelection",type:"Boolean"},{default:"-",description:s("form.documentation.propsDescription.select.tooltipOptions"),prop:"tooltipOptions",type:"Object"},{default:"-",description:s("form.documentation.propsDescription.select.valueKey"),prop:"valueKey",type:"String"}]),h=g(()=>[{description:s("form.documentation.slotDescription.select.group"),name:"group",props:"{ label: string, selected: boolean }"},{description:s("form.documentation.slotDescription.select.option"),name:"option",props:"{ multiple: boolean, option: SelectOption, selected: boolean }"},{description:s("form.documentation.slotDescription.select.selection"),name:"selection",props:"{ selectedLabels: string[] }"}]),N=async t=>{const e={filters:{OR:[]}};t?.trim()&&e.filters.OR.push({key:"name",operator:"ct",value:t}),i?.roleSelect&&e.filters.OR.push({key:"id",operator:"in",value:i?.roleSelect}),y.value=!0;const m=[{id:"1",name:"Superadmin"},{id:"2",name:"Admin"},{disabled:!0,id:"3",name:"Guest"},{id:"4",name:"Maintainer"},{id:"5",name:"User"}];await new Promise(v=>setTimeout(v,1e3));const a=m.filter(v=>e.filters.OR.some(c=>c.key==="name"&&c.operator==="ct"?String(v.name).toLowerCase().includes(String(c.value).toLowerCase()):c.key==="id"&&c.operator==="in"?c.value.includes(v.id):!1));V.value=a,y.value=!1};return N(),(t,e)=>{const m=C("SshPre");return I(),E(W,{subtitle:t.$t("form.subtitle.select"),title:t.$t("form.label.select"),class:"demo"},{default:p(()=>[n("section",null,[n("h2",null,d(t.$t("form.label.basicInput")),1),e[22]||(e[22]=l()),n("div",H,[r(o(b),{modelValue:o(i).noLabelInput,"onUpdate:modelValue":e[0]||(e[0]=a=>o(i).noLabelInput=a),options:f.value,placeholder:t.$t("form.placeholder.country")},null,8,["modelValue","options","placeholder"]),e[21]||(e[21]=l()),r(m,{language:"html-vue"},{default:p(()=>[...e[20]||(e[20]=[l(`
          <template>
            <SelectInput
              v-model="input"
              :options="options"
          ...
          <\/script>
        `,-1)])]),_:1})])]),e[84]||(e[84]=l()),n("section",null,[n("h2",null,d(t.$t("form.label.labelInput")),1),e[25]||(e[25]=l()),n("div",j,[r(o(b),{modelValue:o(i).input,"onUpdate:modelValue":e[1]||(e[1]=a=>o(i).input=a),label:t.$t("form.label.country"),options:f.value,placeholder:t.$t("form.placeholder.country"),name:"select-input"},null,8,["modelValue","label","options","placeholder"]),e[24]||(e[24]=l()),r(m,{language:"html-vue"},{default:p(()=>[...e[23]||(e[23]=[l(`
          <template>
            <SelectInput 
              v-model="input"
              :options="options"
          ...
          <\/script>
        `,-1)])]),_:1})])]),e[85]||(e[85]=l()),n("section",null,[n("h2",null,d(t.$t("form.label.disabled")),1),e[28]||(e[28]=l()),n("div",z,[r(o(b),{modelValue:o(i).disabled,"onUpdate:modelValue":e[2]||(e[2]=a=>o(i).disabled=a),label:t.$t("form.label.country"),options:f.value,placeholder:t.$t("form.placeholder.country"),disabled:"",name:"disabled-select"},null,8,["modelValue","label","options","placeholder"]),e[27]||(e[27]=l()),r(m,{language:"html-vue"},{default:p(()=>[...e[26]||(e[26]=[l(`
          <template>
            <SelectInput 
              v-model="disabled"
              :options="options"
        ...
        `,-1)])]),_:1})])]),e[86]||(e[86]=l()),n("section",null,[n("h2",null,d(t.$t("form.label.disableSort")),1),e[31]||(e[31]=l()),n("div",A,[r(o(b),{modelValue:o(i).disabledSortInput,"onUpdate:modelValue":e[3]||(e[3]=a=>o(i).disabledSortInput=a),"has-sorted-options":!1,label:t.$t("form.label.country"),options:f.value,placeholder:t.$t("form.placeholder.country"),name:"country"},null,8,["modelValue","label","options","placeholder"]),e[30]||(e[30]=l()),r(m,{language:"html-vue"},{default:p(()=>[...e[29]||(e[29]=[l(`
          ...
          <\/script>
        `,-1)])]),_:1})])]),e[87]||(e[87]=l()),n("section",null,[n("h2",null,d(t.$t("form.label.disableSearch")),1),e[34]||(e[34]=l()),n("div",q,[r(o(b),{modelValue:o(i).disableSearchInput,"onUpdate:modelValue":e[4]||(e[4]=a=>o(i).disableSearchInput=a),options:f.value,placeholder:t.$t("form.placeholder.country"),"disable-search":"",name:"search-disabled-select"},null,8,["modelValue","options","placeholder"]),e[33]||(e[33]=l()),r(m,{language:"html-vue"},{default:p(()=>[...e[32]||(e[32]=[l(`
          <template>
            <SelectInput
              v-model="input"
              :options="options"
          ...
          <\/script>
        `,-1)])]),_:1})])]),e[88]||(e[88]=l()),n("section",null,[n("h2",null,d(t.$t("form.label.withLabelValueKeys")),1),e[37]||(e[37]=l()),n("div",J,[r(o(b),{modelValue:o(i).labelValueKeyInput,"onUpdate:modelValue":e[5]||(e[5]=a=>o(i).labelValueKeyInput=a),label:t.$t("form.label.country"),options:$.value,placeholder:t.$t("form.placeholder.country"),"label-key":"country",name:"country-select","value-key":"code"},null,8,["modelValue","label","options","placeholder"]),e[36]||(e[36]=l()),r(m,{language:"html-vue"},{default:p(()=>[...e[35]||(e[35]=[l(`
          <template>
            <SelectInput 
              v-model="input"
              :options="options"
          ...
          <\/script>
        `,-1)])]),_:1})])]),e[89]||(e[89]=l()),n("section",null,[n("h2",null,d(t.$t("form.label.withI18n")),1),e[40]||(e[40]=l()),n("div",Z,[r(o(b),{modelValue:o(i).i18nSelect,"onUpdate:modelValue":e[6]||(e[6]=a=>o(i).i18nSelect=a),label:t.$t("form.label.country"),options:f.value,placeholder:t.$t("form.placeholder.country"),name:"i18n-select"},null,8,["modelValue","label","options","placeholder"]),e[39]||(e[39]=l()),r(m,{language:"html-vue"},{default:p(()=>[...e[38]||(e[38]=[l(`
          <template>
            <SelectInput 
              v-model="input"
              :options="options"
    ...
    `,-1)])]),_:1})]),_:1},8,["subtitle","title"])}}});export{ve as default};
