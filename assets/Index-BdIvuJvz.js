import{d as m,s as r,j as d,o as b,w as n,C as t,e as o,t as l,g as p,u as s,H as a,D as u}from"./index-B_oNSRZ1.js";import{_ as g}from"./UiPage.vue_vue_type_style_index_0_lang-DP8OldWZ.js";const h={class:"section-content"},v={class:"popup-title"},f={class:"popup-body"},$={class:"section-content"},P={class:"section-content"},_={class:"section-content"},y={class:"section-content"},B={class:"section-content"},k=m({__name:"Index",setup(E){return(e,c)=>{const i=r("SshPre");return b(),d(g,{title:e.$t("ui.popup.title"),class:"demo"},{toolbar:n(()=>[p(s(u),{label:e.$t("common.back"),"icon-left":"pi pi-chevron-left",size:"medium",variant:"textOnly",onClick:c[0]||(c[0]=z=>e.$router.push("/ui"))},null,8,["label"])]),default:n(()=>[t(),o("section",null,[o("h2",null,l(e.$t("ui.popup.usage.basic")),1),t(),o("div",h,[p(s(a),null,{content:n(()=>[o("h3",v,l(e.$t("ui.popup.title")),1),t(),o("div",f,l(e.$t("ui.popup.content")),1)]),default:n(()=>[p(s(u),{label:e.$t("ui.popup.label.button"),severity:"success"},null,8,["label"]),t()]),_:1}),t(),p(i,{language:"html-vue"},{default:n(()=>[t(`
          <template>
            <Popup>
              <ButtonElement
                :label="Click me"
