import{d as r,D as d,e as b,o as g,h as o,B as n,f as p,t as u,g as l,u as s,x as m,q as i}from"./index-DfLKm71s.js";import{_ as v}from"./UiPage.vue_vue_type_style_index_0_lang-Dui4P9Ue.js";const f={class:"section-content"},$={class:"popup-title"},P={class:"popup-body"},B={class:"section-content"},y={class:"section-content"},E={class:"section-content"},z={class:"section-content"},T={class:"section-content"},S=r({__name:"Index",setup(k){return(e,t)=>{const a=d("SshPre");return g(),b(v,{title:e.$t("ui.popup.title"),class:"demo"},{toolbar:o(()=>[l(s(i),{label:e.$t("common.back"),"icon-left":"pi pi-chevron-left",size:"medium",variant:"textOnly",onClick:t[0]||(t[0]=C=>e.$router.push("/ui"))},null,8,["label"])]),default:o(()=>[t[26]||(t[26]=n()),p("section",null,[p("h2",null,u(e.$t("ui.popup.usage.basic")),1),t[5]||(t[5]=n()),p("div",f,[l(s(m),null,{content:o(()=>[p("h3",$,u(e.$t("ui.popup.title")),1),t[1]||(t[1]=n()),p("div",P,u(e.$t("ui.popup.content")),1)]),default:o(()=>[l(s(i),{label:e.$t("ui.popup.label.button"),severity:"success"},null,8,["label"]),t[2]||(t[2]=n())]),_:1}),t[4]||(t[4]=n()),l(a,{language:"html-vue"},{default:o(()=>t[3]||(t[3]=[n(`
          <template>
            <Popup>
              <ButtonElement
                :label="Click me"
