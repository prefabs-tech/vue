import{A as c,x as v}from"./DzangolabVue3Form.es-579aa137.js";import{d as V,a7 as D,p as I,j as m,K as g,o as p,c as F,w as d,L as o,C as e,M as i,f as r,E as n,a as b,g as y}from"./index-8e1c3ab6-8617714e.js";import{m as k}from"./index-eb14ec17.js";import{_ as U}from"./FormPage.vue_vue_type_style_index_0_lang-cebf9516.js";const z={class:"section-content"},E={key:0,class:"result-date"},S={class:"section-content"},A={key:0,class:"result-date"},C={class:"section-content"},w={key:0,class:"result-date"},B={class:"section-content"},N={key:0,class:"result-date"},P={name:"DaysInput"},M=V({...P,setup(q){const{t:h}=D(),_=k.coerce.number({invalid_type_error:h("form.errors.number.required")}).min(1,{message:h("form.errors.daysInput.invalid")}).max(365,{message:h("form.errors.daysInput.invalid")}),s=I({basic:m(),disabled:m(),label:m(),validationInput:m()});let u=I({basic:m(),disabled:m(30),label:m(),validationInput:m()});return(a,t)=>{const $=g("router-link"),f=g("SshPre");return p(),F(U,{title:a.$t("form.label.daysInput"),class:"demo"},{toolbar:d(()=>[o($,{to:{name:"form"},class:"back"},{default:d(()=>[e(i(a.$t("common.back")),1)]),_:1})]),default:d(()=>[e(),r("section",null,[r("h2",null,i(a.$t("form.label.basicInput")),1),e(),r("div",z,[o(f,{language:"html-vue"},{default:d(()=>[e(`
          <Form>
            <DaysInput
              v-model="input"
