import{d as z,B as D,r as m,A as P,e as k,o as B,w as a,E as l,f as e,t as v,i as o,u as s,j as u,P as p,N as R}from"./index-Bt1mySq5.js";import{_ as A}from"./UserPage.vue_vue_type_style_index_0_lang-DTPr2p2R.js";const U={class:"section-content"},N={class:"section-content"},C={class:"section-content"},O={class:"section-content"},F={class:"section-content"},T={class:"section-content"},V={class:"section-content"},G=z({__name:"InvitationModal",setup(W){const{t:E}=D(),f=m(!1),b=m(!1),w=m(!1),M=m(!1),g=m(!1),I=m(!1),y=m(!1),$=[{id:1,name:"ADMIN"},{id:2,name:"SUPERADMIN"},{id:3,name:"USER"}],S=[{id:1,name:"Admin",origin:"admin-origin",supportedRoles:[{id:1,name:"ADMIN"},{id:2,name:"SUPERADMIN"}]},{id:2,name:"User",origin:"user-origin",supportedRoles:[{id:3,name:"USER"}]}],r=t=>{R({text:E("user.message.invitation.success",{user:t.email}),type:"success"}),f.value=!1,b.value=!1,w.value=!1,M.value=!1,g.value=!1,I.value=!1,y.value=!1};return(t,n)=>{const d=P("SshPre");return B(),k(A,{title:t.$t("user.label.invitationModal"),class:"demo-invitation-modal"},{toolbar:a(()=>[o(s(u),{label:t.$t("common.back"),"icon-left":"pi pi-chevron-left",size:"medium",variant:"textOnly",onClick:n[0]||(n[0]=i=>t.$router.push("/user"))},null,8,["label"])]),default:a(()=>[n[43]||(n[43]=l()),e("section",null,[e("h2",null,v(t.$t("user.label.basic")),1),n[18]||(n[18]=l()),e("div",U,[o(s(u),{label:t.$t("user.label.invite"),onClick:n[1]||(n[1]=i=>g.value=!0)},null,8,["label"]),n[16]||(n[16]=l()),o(s(p),{show:g.value,"onOn:close":n[2]||(n[2]=i=>g.value=!1),onSubmit:r},null,8,["show"]),n[17]||(n[17]=l()),o(d,{language:"html-vue"},{default:a(()=>n[15]||(n[15]=[l(`
          <template>
            <ButtonElement
              label="Invite"
        ...
        `)])),_:1})])]),n[44]||(n[44]=l()),e("section",null,[e("h2",null,v(t.$t("user.label.withTitle")),1),n[22]||(n[22]=l()),e("div",N,[o(s(u),{label:t.$t("user.label.send"),onClick:n[3]||(n[3]=i=>y.value=!0)},null,8,["label"]),n[20]||(n[20]=l()),o(s(p),{show:y.value,title:t.$t("user.label.invite"),"onOn:close":n[4]||(n[4]=i=>y.value=!1),onSubmit:r},null,8,["show","title"]),n[21]||(n[21]=l()),o(d,{language:"html-vue"},{default:a(()=>n[19]||(n[19]=[l(`
          ...
          <\/script>
        `)])),_:1})])]),n[45]||(n[45]=l()),e("section",null,[e("h2",null,v(t.$t("user.label.disableDismiss")),1),n[26]||(n[26]=l()),e("div",C,[o(s(u),{label:t.$t("user.label.inviteUser"),onClick:n[5]||(n[5]=i=>b.value=!0)},null,8,["label"]),n[24]||(n[24]=l()),o(s(p),{"dismiss-on-click-out":!1,show:b.value,title:t.$t("user.label.inviteUser"),"onOn:close":n[6]||(n[6]=i=>b.value=!1),onSubmit:r},null,8,["show","title"]),n[25]||(n[25]=l()),o(d,{language:"html-vue"},{default:a(()=>n[23]||(n[23]=[l(`
          <template>
            <ButtonElement
              label="Invite user"
              @click="showModal = true"
