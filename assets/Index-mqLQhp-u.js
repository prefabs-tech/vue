import{I as b,F as k}from"./DzangolabVue3Form.es-BjYrQu0V.js";import{d as h,A as g,B as C,C as I,r as p,z as y,e as V,o as x,w as u,D as e,f as o,t as d,h as i,u as n,p as $}from"./index-Bq7LBzNw.js";import{_ as z}from"./FormPage.vue_vue_type_style_index_0_lang-Blw15sAT.js";const S={class:"section-content"},O={class:"section-content"},B={class:"section-content"},F={class:"section-content"},L={name:"CheckboxInput"},D=h({...L,setup(w){const{t}=g(),v=C.string().array().min(6,{message:t("form.errors.checkbox.min",{min:6})});let r=I({disabled:p(["car"]),inputWithValidation:p(),multiCheckbox:p([]),noLabelInput:p()});const c=[{label:t("form.label.title"),value:1},{label:t("form.label.solutions"),value:2},{label:t("form.label.deliverableList"),value:3},{label:t("form.label.workInProgress"),value:4},{label:t("form.label.summary"),value:5},{label:t("form.label.next"),value:6},{label:t("form.label.assumptions"),value:7},{label:t("form.label.generalQuestions"),value:8},{label:t("form.label.consequences"),value:9},{label:t("form.label.other"),value:10}],f=[{label:t("form.label.bike"),value:"bike"},{label:t("form.label.car"),value:"car"},{label:t("form.label.truck"),value:"truck"}];return(a,l)=>{const m=y("SshPre");return x(),V(z,{title:a.$t("form.label.checkbox"),class:"demo"},{toolbar:u(()=>[i(n($),{label:a.$t("common.back"),"icon-left":"pi pi-chevron-left",size:"medium",variant:"textOnly",onClick:l[0]||(l[0]=s=>a.$router.push("/form"))},null,8,["label"])]),default:u(()=>[l[17]||(l[17]=e()),o("section",null,[o("h2",null,d(a.$t("form.label.basicInput")),1),l[7]||(l[7]=e()),o("div",S,[i(n(b),{checked:n(r).noLabelInput,"onUpdate:checked":l[1]||(l[1]=s=>n(r).noLabelInput=s),"input-label":a.$t("form.label.accept"),name:"basic"},null,8,["checked","input-label"]),l[6]||(l[6]=e()),i(m,{language:"html-vue"},{default:u(()=>l[5]||(l[5]=[e(`
        ...
        `)])),_:1})])]),l[19]||(l[19]=e()),o("section",null,[o("h2",null,d(a.$t("form.label.disabled")),1),l[13]||(l[13]=e()),o("div",B,[i(n(b),{modelValue:n(r).disabled,"onUpdate:modelValue":l[3]||(l[3]=s=>n(r).disabled=s),label:a.$t("form.label.vehicle"),options:f,direction:"horizontal",disabled:"",name:"disabled-checkbox"},null,8,["modelValue","label"]),l[12]||(l[12]=e()),i(m,{language:"html-vue"},{default:u(()=>l[11]||(l[11]=[e(`
          ...
          <\/script>
        `)])),_:1})])]),l[20]||(l[20]=e()),o("section",null,[o("h2",null,d(a.$t("form.label.inputWithValidation")),1),l[16]||(l[16]=e()),o("div",F,[i(n(k),null,{default:u(()=>[i(n(b),{modelValue:n(r).inputWithValidation,"onUpdate:modelValue":l[4]||(l[4]=s=>n(r).inputWithValidation=s),label:a.$t("form.label.dailySynchro"),options:c,schema:n(v),name:"daily-synchro"},null,8,["modelValue","label","schema"])]),_:1}),l[15]||(l[15]=e()),i(m,{language:"html-vue"},{default:u(()=>l[14]||(l[14]=[e(`
          <template>
            <Form>
              <CheckboxInput
                v-model="input"
