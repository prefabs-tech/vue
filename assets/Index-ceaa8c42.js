import{w as i,J as f}from"./DzangolabVue3Form.es-81449376.js";import{d as g,a5 as I,p as V,j as d,J as N,o as $,c as z,w as m,K as t,D as n,ao as E,W as e,f as o,L as p}from"./index-729398ab-97e0bd19.js";import{m as _}from"./index-4c2549d2.js";import{_ as w}from"./FormPage.vue_vue_type_style_index_0_lang-ebb70898.js";const F={class:"section-content"},O={class:"section-content"},U={class:"section-content"},y={class:"section-content"},M={class:"section-content"},S={class:"section-content"},W={class:"section-content"},k={name:"NumberInputField"},D=g({...k,setup(q){const{t:b}=I(),v=_.coerce.number({invalid_type_error:b("form.errors.number.invalid")}).gte(1,b("form.errors.number.invalid")).lte(100,b("form.errors.number.invalid")),h={invalid:b("form.errors.number.invalid"),required:b("form.errors.number.required")},c={min:1,max:100,allow_leading_zeroes:!1};let r=V({customValidationInput:d(),disabled:d(100),input:d(),inputWithValidation:d(),noLabelInput:d(),textInput:d()});return(l,a)=>{const s=N("SshPre");return $(),z(w,{title:l.$t("form.label.number"),class:"demo"},{toolbar:m(()=>[t(n(E),{label:l.$t("common.back"),"icon-left":"pi pi-chevron-left",size:"medium",variant:"textOnly",onClick:a[0]||(a[0]=u=>l.$router.push("/form"))},null,8,["label"])]),default:m(()=>[e(),o("section",null,[o("h2",null,p(l.$t("form.label.basicInput")),1),e(),o("div",F,[t(n(i),{modelValue:n(r).noLabelInput,"onUpdate:modelValue":a[1]||(a[1]=u=>n(r).noLabelInput=u),placeholder:l.$t("form.placeholder.number")},null,8,["modelValue","placeholder"]),e(),t(s,{language:"html-vue"},{default:m(()=>[e(`
          <template>
            <NumberInput 
              v-model="input"
