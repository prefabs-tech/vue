import{m as N,e as d,Z as p}from"./DzangolabVue3Form.es-613b07ef.js";import{d as _,u as $,b as F,e as b,r as f,o as y,c as z,w as a,f as l,g as n,t as s,a as t,h as e}from"./index-577793d9.js";const E={class:"section-content"},S={class:"section-content"},w={class:"section-content"},O={class:"section-content"},U={class:"section-content"},k={class:"section-content"},M={class:"section-content"},P={class:"section-content"},q={name:"NumberInputField"},L=_({...q,setup(W){const{t:c}=$(),g=N.coerce.number({invalid_type_error:c("form.errors.number.invalid")}).gte(1,c("form.errors.number.invalid")).lte(100,c("form.errors.number.invalid")),h={invalid:c("form.errors.number.invalid"),required:c("form.errors.number.required")},v={min:1,max:100,allow_leading_zeroes:!1};let r=F({customStyleInput:b(),customValidationInput:b(),disabled:b(100),input:b(),inputWithValidation:b(),noLabelInput:b(),textInput:b()});return(o,u)=>{const I=f("router-link"),i=f("SshPre"),V=f("Page");return y(),z(V,{title:o.$t("form.label.number"),class:"demo"},{toolbar:a(()=>[l(I,{to:{name:"form"},class:"back"},{default:a(()=>[n(s(o.$t("common.back")),1)]),_:1})]),default:a(()=>[n(),t("section",null,[t("h2",null,s(o.$t("form.label.basicInput")),1),n(),t("div",E,[l(i,{language:"html-vue"},{default:a(()=>[n(`
          <Form>
            <NumberInput 
              v-model="input"
