import{d as O,I as E,r as d,J as H,e as T,o as m,i as r,D as i,f as t,g as a,t as b,u as s,a9 as p,v as k,a as M,F as U,z as F,b as I,H as R}from"./index-BLLu7sZz.js";import{_ as J}from"./ComponentDocumentation.vue_vue_type_script_setup_true_lang-BHGsT5Km.js";import{_ as j}from"./UiPage.vue_vue_type_style_index_0_lang-CTdadv5J.js";import"./DzangolabVue3TanstackTable.es-By0FH77m.js";import"./DzangolabVue3Form.es-Q4CvOA23.js";const q={class:"section-content"},G={class:"section-content"},Q={class:"section-content"},W={class:"section-content"},X={class:"section-content"},Y={class:"section-content"},Z={class:"tab-button-group"},x={class:"section-content"},_={class:"section-content"},ee={class:"section-content"},ie={class:"section-content"},te={class:"section-content"},be=O({__name:"Index",setup(ne){const{t:l}=E(),w=d("1"),V=d(),D=d(),f=d("1"),S=d(),y=d(!1),g=d(!1),v=d(["1"]),P=[{description:l("ui.tabView.documentation.eventDescription.beforeTabChange"),name:"beforeTabChange",payload:"key"},{description:l("ui.tabView.documentation.eventDescription.beforeTabClose"),name:"beforeTabClose",payload:"key"},{description:l("ui.tabView.documentation.eventDescription.updateActiveKey"),name:"update:activeKey",payload:"key"},{description:l("ui.tabView.documentation.eventDescription.updateVisibleTabs"),name:"update:visibleTabs",payload:"key[]"}],$=[{children:"Description",key:"tab1",label:"Description"},{children:"Reviews",key:"tab2",label:"Reviews"},{children:"Specifications",key:"tab3",label:"Specifications"},{children:"Pricing",key:"tab4",label:"Pricing"},{children:"Installation Instructions",key:"tab5",label:"Installation"},{children:"Certifications",key:"tab6",label:"Certifications"}],K=[{default:"-",description:l("ui.tabView.documentation.propsDescription.activeKey"),prop:"activeKey",type:"string"},{default:"false",description:l("ui.tabView.documentation.propsDescription.enableHashRouting"),prop:"enableHashRouting",type:"boolean"},{default:"-",description:l("ui.tabView.documentation.propsDescription.id"),prop:"id",type:"string"},{default:"false",description:l("ui.tabView.documentation.propsDescription.interceptTabChange"),prop:"interceptTabChange",type:"boolean"},{default:"false",description:l("ui.tabView.documentation.propsDescription.interceptTabClose"),prop:"interceptTabClose",type:"boolean"},{default:"true",description:l("ui.tabView.documentation.propsDescription.lazy"),prop:"lazy",type:"boolean"},{default:"true",description:l("ui.tabView.documentation.propsDescription.persistState"),prop:"persistState",type:"boolean"},{default:"localStorage",description:l("ui.tabView.documentation.propsDescription.persistStateStorage"),prop:"persistStateStorage",type:'"localStorage" | "sessionStorage"'},{default:"top",description:l("ui.tabView.documentation.propsDescription.position"),prop:"position",type:'"top" | "left" | "bottom" | "right"'},{default:"-",description:l("ui.tabView.documentation.propsDescription.tabs"),prop:"tabs",type:"Tab[]"},{default:"-",description:l("ui.tabView.documentation.propsDescription.visibleTabs"),prop:"visibleTabs",type:"string[]"}],z=[{description:l("ui.tabView.documentation.slotDescription.default"),name:"default"}],h=[{key:"description",label:"Description"},{key:"review",label:"Reviews"},{key:"specifications",label:"Specifications"},{key:"pricing",label:"Pricing"},{key:"installation",label:"Installation"},{key:"certifications",label:"Certifications"}],c=[{children:"Description",key:"1",label:"Description"},{children:"Reviews",closable:!0,key:"2",label:"Reviews"},{children:"Specifications",closable:!0,key:"3",label:"Specifications"},{children:"Pricing",closable:!0,key:"4",label:"Pricing"},{children:"Installation Instructions",key:"5",label:"Installation"},{children:"Certifications",key:"6",label:"Certifications"}],C=n=>{v.value.includes(n)||(v.value=[...v.value,n]),w.value=n},B=n=>{g.value=!0,S.value=n},A=n=>{y.value=!0,V.value=n},L=()=>{f.value=S.value||f.value,g.value=!1},N=()=>{var n;(n=D.value)==null||n.closeTab(V.value),y.value=!1};return(n,e)=>{const u=H("SshPre");return m(),T(j,{"sub-title":n.$t("ui.tabView.subtitle"),title:n.$t("ui.tabView.title"),class:"tab-view"},{toolbar:r(()=>[a(s(k),{label:n.$t("common.back"),"icon-left":"pi pi-chevron-left",size:"medium",variant:"textOnly",onClick:e[0]||(e[0]=o=>n.$router.push("/ui"))},null,8,["label"])]),default:r(()=>[e[47]||(e[47]=i()),t("section",null,[t("h2",null,b(n.$t("ui.tabView.usage.basic")),1),e[11]||(e[11]=i()),t("div",q,[a(s(p),{id:"tab-view",tabs:c,"active-key":"1"}),e[10]||(e[10]=i()),a(u,{language:"html-vue"},{default:r(()=>e[9]||(e[9]=[i(`
          ...
          <\/script>
        `)])),_:1})])]),e[48]||(e[48]=i()),t("section",null,[t("h2",null,b(n.$t("ui.tabView.usage.disableTabState.title")),1),e[15]||(e[15]=i()),t("div",G,[t("p",null,b(n.$t("ui.tabView.usage.disableTabState.subtitle")),1),e[13]||(e[13]=i()),a(s(p),{"persist-state":!1,tabs:c,"visible-tabs":["1","5","6"],"active-key":"1"}),e[14]||(e[14]=i()),a(u,{language:"html-vue"},{default:r(()=>e[12]||(e[12]=[i(`
          <template>
            <TabView
              :persist-state="false"
              :tabs="tabs"    
          ...
          <\/script>
        `)])),_:1})])]),e[49]||(e[49]=i()),t("section",null,[t("h2",null,b(n.$t("ui.tabView.usage.positionBottom")),1),e[18]||(e[18]=i()),t("div",Q,[a(s(p),{id:"tab-view-bottom",tabs:c,"visible-tabs":["1","5","6"],"active-key":"1",position:"bottom"}),e[17]||(e[17]=i()),a(u,{language:"html-vue"},{default:r(()=>e[16]||(e[16]=[i(`
          <template>
            <TabView
              id="tab-view-bottom"
              :tabs="tabs"    
          ...
          <\/script>
        `)])),_:1})])]),e[50]||(e[50]=i()),t("section",null,[t("h2",null,b(n.$t("ui.tabView.usage.positionLeft")),1),e[21]||(e[21]=i()),t("div",W,[a(s(p),{id:"tab-view-left",tabs:c,"visible-tabs":["1","5","6"],"active-key":"1",position:"left"}),e[20]||(e[20]=i()),a(u,{language:"html-vue"},{default:r(()=>e[19]||(e[19]=[i(`
          <template>
            <TabView
              id="tab-view-left"
              :tabs="tabs"    
          ...
          <\/script>
        `)])),_:1})])]),e[51]||(e[51]=i()),t("section",null,[t("h2",null,b(n.$t("ui.tabView.usage.positionRight")),1),e[24]||(e[24]=i()),t("div",X,[a(s(p),{id:"tab-view-right",tabs:c,"visible-tabs":["1","5","6"],"active-key":"1",position:"right"}),e[23]||(e[23]=i()),a(u,{language:"html-vue"},{default:r(()=>e[22]||(e[22]=[i(`
          <template>
            <TabView
              id="tab-view-right"
              :tabs="tabs"    
        ...
        `)])),_:1})])]),e[52]||(e[52]=i()),t("section",null,[t("h2",null,b(n.$t("ui.tabView.usage.closableTab")),1),e[30]||(e[30]=i()),t("div",Y,[t("div",Z,[a(s(k),{label:"Add specifications tab",onClick:e[1]||(e[1]=o=>C("3"))}),e[25]||(e[25]=i()),a(s(k),{label:"Add reviews tab",onClick:e[2]||(e[2]=o=>C("2"))}),e[26]||(e[26]=i()),a(s(k),{label:"Add pricing tab",onClick:e[3]||(e[3]=o=>C("4"))})]),e[28]||(e[28]=i()),a(s(p),{id:"tab-view-closable","active-key":w.value,"onUpdate:activeKey":e[4]||(e[4]=o=>w.value=o),"visible-tabs":v.value,"onUpdate:visibleTabs":e[5]||(e[5]=o=>v.value=o),tabs:c},null,8,["active-key","visible-tabs"]),e[29]||(e[29]=i()),a(u,{language:"html-vue"},{default:r(()=>e[27]||(e[27]=[i(`
          ...
          <\/script>
        `)])),_:1})])]),e[53]||(e[53]=i()),t("section",null,[t("h2",null,b(n.$t("ui.tabView.usage.withSlot")),1),e[33]||(e[33]=i()),t("div",x,[a(s(p),{id:"tab-view-slot",tabs:h,"visible-tabs":["description","installation","certifications"],"active-key":"description"},{default:r(()=>[(m(),M(U,null,F(h,o=>t("p",{key:o.key},b(o.label),1)),64))]),_:1}),e[32]||(e[32]=i()),a(u,{language:"html-vue"},{default:r(()=>e[31]||(e[31]=[i(`
          <template>
            <TabView
              id="tab-view-slot"
              :tabs="tabList"    
          ...
          <\/script>
        `)])),_:1})])]),e[54]||(e[54]=i()),t("section",null,[t("h2",null,b(n.$t("ui.tabView.usage.interceptTabChange")),1),e[37]||(e[37]=i()),t("div",_,[a(s(p),{id:"tab-view-interception","active-key":f.value,"onUpdate:activeKey":e[6]||(e[6]=o=>f.value=o),tabs:c,"visible-tabs":["1","5","6"],"intercept-tab-change":"",onBeforeTabChange:B},null,8,["active-key"]),e[35]||(e[35]=i()),g.value?(m(),T(s(R),{key:0,"onOn:close":e[7]||(e[7]=o=>g.value=!1),"onOn:confirm":L})):I("",!0),e[36]||(e[36]=i()),a(u,{language:"html-vue"},{default:r(()=>e[34]||(e[34]=[i(`
          <template>
            <TabView
          ...
          <\/script>
        `)])),_:1})])]),e[55]||(e[55]=i()),t("section",null,[t("h2",null,b(n.$t("ui.tabView.usage.interceptTabClose")),1),e[41]||(e[41]=i()),t("div",ee,[a(s(p),{id:"tab-view-interception-close",ref_key:"dzangolabVueTabView",ref:D,tabs:c,"active-key":"1","intercept-tab-close":"",onBeforeTabClose:A},null,512),e[39]||(e[39]=i()),y.value?(m(),T(s(R),{key:0,"onOn:close":e[8]||(e[8]=o=>y.value=!1),"onOn:confirm":N})):I("",!0),e[40]||(e[40]=i()),a(u,{language:"html-vue"},{default:r(()=>e[38]||(e[38]=[i(`
          <template>
            <TabView
          ...
          <\/script>
        `)])),_:1})])]),e[56]||(e[56]=i()),t("section",null,[t("h2",null,b(n.$t("ui.tabView.usage.withHashRouting")),1),e[44]||(e[44]=i()),t("div",ie,[a(s(p),{id:"tab-view-hash-routing",tabs:$,"active-key":"tab1","enable-hash-routing":""}),e[43]||(e[43]=i()),a(u,{language:"html-vue"},{default:r(()=>e[42]||(e[42]=[i(`
          <template>
          ...
          <\/script>
        `)])),_:1})])]),e[57]||(e[57]=i()),a(J,{"events-data":P,"props-data":K,"props-table-title":n.$t("common.properties",{value:"TabViewProperties"}),"slots-data":z},null,8,["props-table-title"]),e[58]||(e[58]=i()),t("section",null,[t("h2",null,b(n.$t("common.type")),1),e[46]||(e[46]=i()),t("div",te,[a(u,{language:"html-vue"},{default:r(()=>e[45]||(e[45]=[i(`
            type Tab = {
