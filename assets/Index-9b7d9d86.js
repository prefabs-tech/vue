import{d as r,K as c,o as d,c as b,w as n,L as p,C as t,M as l,f as o,E as s,az as a,au as i}from"./index-66214709-ea91fece.js";import{_ as g}from"./UiPage.vue_vue_type_style_index_0_lang-a2f0c891.js";const h={class:"section-content"},v={class:"popup-title"},f={class:"popup-body"},_={class:"section-content"},$={class:"section-content"},P={class:"section-content"},B={class:"section-content"},y={class:"section-content"},C=r({__name:"Index",setup(E){return(e,z)=>{const m=c("router-link"),u=c("SshPre");return d(),b(g,{title:e.$t("ui.popup.title"),class:"demo"},{toolbar:n(()=>[p(m,{to:{name:"ui"},class:"back"},{default:n(()=>[t(l(e.$t("common.back")),1)]),_:1})]),default:n(()=>[t(),o("section",null,[o("h2",null,l(e.$t("ui.popup.usage.basic")),1),t(),o("div",h,[p(u,{language:"html-vue"},{default:n(()=>[t(`
          <template>
            <Popup>
              <ButtonElement
                :label="Click me"
