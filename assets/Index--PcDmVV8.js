import{E as m,$ as v}from"./PrefabsTechVue3Form.es-Bt4TCb5D.js";import{d as w,E as V,I,L as g,r as d,H as S,e as $,o as h,j as u,B as t,f as o,t as p,h as s,u as e,v as L}from"./index-Bv0414Gs.js";import{_ as F}from"./FormPage.vue_vue_type_style_index_0_lang-CKGhBJSI.js";const y={class:"section-content"},O={class:"section-content"},U={class:"section-content"},k={class:"section-content"},B={class:"section-content"},C={class:"section-content"},N={name:"SwitchInput"},P=w({...N,setup(W){const{t:f}=V(),b=I.coerce.boolean().refine(n=>n===!0,{message:f("form.errors.switch.invalid")});let i=g({disabled:d(!0),input:d(),inputWithValidation:d(!1),noLabelInput:d(),onOffLabel:d()});return(n,l)=>{const r=S("SshPre");return h(),$(F,{title:n.$t("form.label.switch"),class:"demo"},{toolbar:u(()=>[s(e(L),{label:n.$t("common.back"),"icon-left":"pi pi-chevron-left",size:"medium",variant:"textOnly",onClick:l[0]||(l[0]=a=>n.$router.push("/form"))},null,8,["label"])]),default:u(()=>[l[25]||(l[25]=t()),o("section",null,[o("h2",null,p(n.$t("form.label.basicInput")),1),l[9]||(l[9]=t()),o("div",y,[s(e(m),{modelValue:e(i).noLabelInput,"onUpdate:modelValue":l[1]||(l[1]=a=>e(i).noLabelInput=a)},null,8,["modelValue"]),l[8]||(l[8]=t()),s(r,{language:"html-vue"},{default:u(()=>l[7]||(l[7]=[t(`
          <template>
