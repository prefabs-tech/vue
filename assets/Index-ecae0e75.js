import{d as b,o as p,c as m,w as i,a as l,t as d,f as e,g as n,h as t,a4 as s,r as c,a0 as h,a1 as v,_}from"./index-4f12a9e4.js";const g=u=>(h("data-v-17a427e8"),u=u(),v(),u),f={class:"section-content"},B={class:"section-content"},y={class:"section-content"},$={class:"section-content"},k={class:"section-content"},w={class:"container"},I={class:"section-content"},z={class:"container"},S={class:"section-content"},W={class:"container"},C={class:"section-content"},P={class:"container"},L=g(()=>l("i",{class:"pi pi-check"},null,-1)),N=g(()=>l("i",{class:"pi pi-times"},null,-1)),R={class:"section-content"},V=b({__name:"Index",setup(u){return(a,D)=>{const o=c("SshPre"),r=c("Page");return p(),m(r,{title:a.$t("ui.badge.title"),class:"demo-badge"},{default:i(()=>[l("section",null,[l("h2",null,d(a.$t("ui.badge.usage.basic")),1),e(),l("div",f,[n(o,{language:"html-vue"},{default:i(()=>[e(`
          <template>
            <Badge label="Basic" /> 
          </template>
