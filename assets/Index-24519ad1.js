import{Z as d,r as m}from"./DzangolabVue3Form.es-6b1a2eb4.js";import{d as V,a6 as $,p as F,j as c,K as h,o as _,c as T,w as a,L as t,C as e,N as i,f as o,E as n}from"./index-66214709-32602281.js";import{m as z}from"./index-1ad428ae.js";import{_ as x}from"./FormPage.vue_vue_type_style_index_0_lang-65f96724.js";const E={class:"section-content"},U={class:"section-content"},k={class:"section-content"},q={class:"section-content"},w={class:"section-content"},S={class:"section-content"},O={class:"section-content"},C={name:"TextInputField"},B=V({...C,setup(L){const{t:f}=$(),g=z.string().length(5,{message:f("form.errors.input.length",{length:5})}),I={required:f("form.errors.input.required")},b={ignore_whitespace:!0,required:!0};let u=F({customValidationInput:c(),disabled:c("dzangolab"),input:c(),inputWithValidation:c(),noLabelInput:c(),textInput:c()});return(l,r)=>{const v=h("router-link"),p=h("SshPre");return _(),T(x,{title:l.$t("form.label.textInput"),class:"demo"},{toolbar:a(()=>[t(v,{to:{name:"form"},class:"back"},{default:a(()=>[e(i(l.$t("common.back")),1)]),_:1})]),default:a(()=>[e(),o("section",null,[o("h2",null,i(l.$t("form.label.basicInput")),1),e(),o("div",E,[t(p,{language:"html-vue"},{default:a(()=>[e(`
          <Form>
            <TextInput 
              v-model="input"
