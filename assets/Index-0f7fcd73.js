import{d as f,e as v,r as g,o as r,c as p,w as a,a as s,t as l,f as e,g as t,h as i,a9 as u,E as _}from"./index-305334af.js";const h={class:"section-content"},b={class:"section-content"},M={class:"section-content"},y=s("i",{class:"pi pi-bell"},null,-1),$={class:"section-content"},C={class:"section-content"},k={class:"section-content"},S=f({__name:"Index",setup(N){const c=v(!0);return(n,m)=>{const o=g("SshPre"),d=g("Page");return r(),p(d,{title:n.$t("ui.message.title"),class:"demo-message"},{default:a(()=>[s("section",null,[s("h2",null,l(n.$t("ui.message.usage.basic")),1),e(),s("div",h,[t(o,{language:"html-vue"},{default:a(()=>[e(`
          ...
          <\/script>
        `)]),_:1}),e(),t(i(u),{message:n.$t("ui.message.contents.content1")},null,8,["message"])])]),e(),s("section",null,[s("h2",null,l(n.$t("ui.message.usage.icons.iconName")),1),e(),s("div",b,[t(o,{language:"html-vue"},{default:a(()=>[e(`
          <template>
            <Message
          ...
          <script setup lang="ts">
            import { Message } from "@dzangolab/vue3-ui";
          <\/script>
        `)]),_:1}),e(),t(i(u),{message:n.$t("ui.message.contents.content2"),icon:"pi pi-android"},null,8,["message"])])]),e(),s("section",null,[s("h2",null,l(n.$t("ui.message.usage.icons.iconElement")),1),e(),s("div",M,[t(o,{language:"html-vue"},{default:a(()=>[e(`
          <template>
            <Message
        ...
        `)]),_:1}),e(),t(i(u),{message:n.$t("ui.message.contents.content3"),icon:"true"},{icon:a(()=>[y]),_:1},8,["message"])])]),e(),s("section",null,[s("h2",null,l(n.$t("ui.message.usage.enableClose")),1),e(),s("div",$,[t(o,{language:"html-vue"},{default:a(()=>[e(`
          ...
          <\/script>
        `)]),_:1}),e(),c.value?(r(),p(i(u),{key:0,message:n.$t("ui.message.contents.content4"),icon:"pi pi-comments",enableClose:"",onClose:m[0]||(m[0]=w=>c.value=!1)},null,8,["message"])):_("",!0)])]),e(),s("section",null,[s("h2",null,l(n.$t("ui.message.usage.withI18n")),1),e(),s("div",C,[t(o,{language:"html-vue"},{default:a(()=>[e(`
          <template>
