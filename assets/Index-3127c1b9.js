import{m as _,l as p,Z as m}from"./DzangolabVue3Form.es-66293d03.js";import{d as $,u as T,b as x,e as c,r as f,o as F,c as w,w as o,f as t,g as e,t as i,a,h as n}from"./index-d455476b.js";const z={class:"section-content"},U={class:"section-content"},C={class:"section-content"},E={class:"section-content"},k={class:"section-content"},q={class:"section-content"},y={class:"section-content"},S={class:"section-content"},O={name:"TextareaInputField"},R=$({...O,setup(D){const{t:b}=T(),g=_.string().min(15,{message:b("form.errors.input.min",{length:15})}),v={required:b("form.errors.input.required")},h={ignore_whitespace:!0,required:!0};let r=x({customRowsColsInput:c(),customValidationInput:c(),disabled:c("Disabled textarea input"),input:c(),inputWithValidation:c(),noLabelInput:c(),textInput:c()});return(l,u)=>{const I=f("router-link"),d=f("SshPre"),V=f("Page");return F(),w(V,{title:l.$t("form.label.textarea"),class:"demo"},{toolbar:o(()=>[t(I,{to:{name:"form"},class:"back"},{default:o(()=>[e(i(l.$t("common.back")),1)]),_:1})]),default:o(()=>[e(),a("section",null,[a("h2",null,i(l.$t("form.label.basicInput")),1),e(),a("div",z,[t(d,{language:"html-vue"},{default:o(()=>[e(`
          <Form>
            <TextareaInput 
              v-model="input"
