import{Z as d,n as p}from"./DzangolabVue3Form.es-6b1a2eb4.js";import{d as g,a6 as w,p as V,j as c,K as f,o as I,c as S,w as a,L as e,C as n,N as r,f as t,E as l}from"./index-66214709-32602281.js";import{m as _}from"./index-1ad428ae.js";import{_ as $}from"./FormPage.vue_vue_type_style_index_0_lang-65f96724.js";const F={class:"section-content"},z={class:"section-content"},k={class:"section-content"},U={class:"section-content"},C={class:"section-content"},L={name:"SwitchInput"},Z=g({...L,setup(N){const{t:b}=w(),h=_.coerce.boolean().refine(o=>o===!0,{message:b("form.errors.switch.invalid")});let s=V({disabled:c(!0),input:c(),inputWithValidation:c(!1),noLabelInput:c()});return(o,i)=>{const v=f("router-link"),m=f("SshPre");return I(),S($,{title:o.$t("form.label.switch"),class:"demo"},{toolbar:a(()=>[e(v,{to:{name:"form"},class:"back"},{default:a(()=>[n(r(o.$t("common.back")),1)]),_:1})]),default:a(()=>[n(),t("section",null,[t("h2",null,r(o.$t("form.label.basicInput")),1),n(),t("div",F,[e(m,{language:"html-vue"},{default:a(()=>[n(`
          <Form>
            <SwitchInput
              v-model="input"
            />
