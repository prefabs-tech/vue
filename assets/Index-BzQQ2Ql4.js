import{S as m,w as S}from"./PrefabsTechVue3Form.es-BtPwf_9M.js";import{d as g,L as I,M as $,o as h,e as y,f as u,h as o,t as d,z as e,a as i,u as l,O as D,r as f,i as b,N as L}from"./index-Dyhkj2vJ.js";import{_ as c}from"./ComponentDocumentation.vue_vue_type_script_setup_true_lang-DeajRu91.js";import{_ as F}from"./FormPage.vue_vue_type_style_index_0_lang-CiaY08G6.js";import"./PrefabsTechVue3TanstackTable.es-DH-WyQBz.js";const O={class:"section-content"},U={class:"section-content"},B={class:"section-content"},N={class:"section-content"},z={class:"section-content"},W={class:"section-content"},k={name:"SwitchInput"},j=g({...k,setup(C){const{t:p}=I();let s=D({disabled:f(!0),input:f(),inputWithValidation:f(!1),noLabelInput:f(),onOffLabel:f()});const v=b(()=>[{description:p("form.documentation.eventDescription.input.modelValue"),name:"update:modelValue",payload:"value: boolean"}]),w=b(()=>L.coerce.boolean().refine(n=>n===!0,{message:p("form.errors.switch.invalid")})),V=b(()=>[{default:"false",description:p("form.documentation.propsDescription.input.disabled"),prop:"disabled",type:"Boolean"},{default:"-",description:p("form.documentation.propsDescription.input.label"),prop:"label",type:"String"},{default:"false",description:p("form.documentation.propsDescription.input.modelValue"),prop:"modelValue",type:"Boolean"},{default:'"switch"',description:p("form.documentation.propsDescription.input.name"),prop:"name",type:"String"},{default:"-",description:p("form.documentation.propsDescription.switch.offLabel"),prop:"offLabel",type:"String"},{default:"-",description:p("form.documentation.propsDescription.switch.onLabel"),prop:"onLabel",type:"String"},{default:"-",description:p("form.documentation.propsDescription.input.schema"),prop:"schema",type:"z.ZodType<string | number | boolean>"}]);return(n,t)=>{const r=$("SshPre");return h(),y(F,{subtitle:n.$t("form.subtitle.switch"),title:n.$t("form.label.switch"),class:"demo"},{default:u(()=>[o("section",null,[o("h2",null,d(n.$t("form.label.basicInput")),1),t[8]||(t[8]=e()),o("div",O,[i(l(m),{modelValue:l(s).noLabelInput,"onUpdate:modelValue":t[0]||(t[0]=a=>l(s).noLabelInput=a)},null,8,["modelValue"]),t[7]||(t[7]=e()),i(r,{language:"html-vue"},{default:u(()=>[...t[6]||(t[6]=[e(`
          <template>
