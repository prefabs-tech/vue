import{d as p,K as u,o as b,c as m,w as s,L as n,C as e,N as o,f as l,E as t,as as i,ap as v,aq as h}from"./index-66214709-32602281.js";import{_}from"./UiPage.vue_vue_type_style_index_0_lang-512e67bc.js";import{_ as f}from"./index-1ad428ae.js";const r=c=>(v("data-v-7cc76d96"),c=c(),h(),c),B={class:"section-content"},y={class:"section-content"},$={class:"section-content"},k={class:"section-content"},I={class:"container"},w={class:"section-content"},z={class:"container"},L={class:"section-content"},S={class:"container"},C={class:"section-content"},N={class:"container"},P={class:"section-content"},R={class:"container"},V=r(()=>l("i",{class:"pi pi-check"},null,-1)),A=r(()=>l("i",{class:"pi pi-times"},null,-1)),D=p({__name:"Index",setup(c){return(a,E)=>{const g=u("router-link"),d=u("SshPre");return b(),m(_,{title:a.$t("ui.badge.title"),class:"demo-badge"},{toolbar:s(()=>[n(g,{to:{name:"ui"},class:"back"},{default:s(()=>[e(o(a.$t("common.back")),1)]),_:1})]),default:s(()=>[e(),l("section",null,[l("h2",null,o(a.$t("ui.badge.usage.basic")),1),e(),l("div",B,[n(d,{language:"html-vue"},{default:s(()=>[e(`
          <template>
            <Badge label="Basic" /> 
          </template>
