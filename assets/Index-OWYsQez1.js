import{u as y,K as R}from"./PrefabsTechVue3Form.es-BoUjIuSx.js";import{d as F,L as A,a6 as z,M as E,o as L,e as T,f as r,h as n,t as p,z as t,a as s,u as i,a7 as v,l as f,a3 as U,r as x,O as K}from"./index-taFQezeg.js";import{_ as M}from"./ComponentDocumentation.vue_vue_type_script_setup_true_lang-t26bDrn_.js";import{_ as O}from"./UiPage.vue_vue_type_style_index_0_lang-DRycCKdV.js";import"./PrefabsTechVue3TanstackTable.es-gIvQX_Uf.js";const W={class:"section-content"},j={class:"section-content"},q={class:"section-content"},G={class:"section-content"},H={class:"demo-stepper-content-wrapper"},J={class:"demo-stepper-buttons-wrapper"},Q={class:"section-content"},X={class:"demo-stepper-wrapper"},Y={class:"demo-stepper-content-actions"},Z={class:"demo-stepper-content-wrapper"},_={class:"demo-stepper-buttons-wrapper"},ee={name:"StepperDemo"},le=F({...ee,setup(te){const{t:l}=A(),I=z(),a=x(0),u=x(0),d=K({name:null,phone:null,price:"$50"}),C=[{description:l("ui.stepper.documentation.eventDescription.complete"),name:"complete",payload:"-"},{description:l("ui.stepper.documentation.eventDescription.updateActiveIndex"),name:"update:activeIndex",payload:"activeIndex: number"}],P=[{label:"Personal"},{label:"Children"},{label:"Payment"},{label:"Confirmation"}],h={iconRight:"pi pi-chevron-right",label:"Next",severity:"primary",variant:"filled"},S={iconLeft:"pi pi-chevron-left",label:"Back",severity:"secondary",variant:"filled"},$=[{default:"-",description:l("ui.stepper.documentation.propsDescription.activeIndex"),prop:"activeIndex",type:"Number"},{default:"start",description:l("ui.stepper.documentation.propsDescription.start"),prop:"align",type:"start | center | end"},{default:"horizontal",description:l("ui.stepper.documentation.propsDescription.direction"),prop:"direction",type:"horizontal | vertical"},{default:"false",description:l("ui.stepper.documentation.propsDescription.hideButtons"),prop:"hideButtons",type:"Boolean"},{default:"-",description:l("ui.stepper.documentation.propsDescription.nextButton"),prop:"nextButtonProperties",type:"ActionButtonProperties"},{default:"-",description:l("ui.stepper.documentation.propsDescription.previousButton"),prop:"previousButtonProperties",type:"ActionButtonProperties"},{default:"-",description:l("ui.stepper.documentation.propsDescription.steps"),prop:"steps",type:"Array<StepProperties>"}],B=[{description:l("ui.stepper.documentation.slotDescription.step"),name:"{step}"}],b=[{content:"Please enter your personal details",label:"Personal",step:1,subtitle:"Personal information"},{content:"Please enter your contact details",label:"Contact",step:2,subtitle:"Contact information"},{content:"Please enter your payment details",label:"Payment",step:3,subtitle:"Payment information"},{content:"Confirm your details",label:"Confirmation",step:4,subtitle:"Confirm your details"}],D=()=>{I.push({name:"ui"})},N=()=>{a.value<P.length-1&&a.value++},w=()=>{a.value>0&&a.value--},V=()=>{u.value<P.length-1&&u.value++},k=()=>{u.value>0&&u.value--},g=o=>{switch(o){case 0:return"Personal details";case 1:return"Family details";case 2:return"Payment details";case 3:return"Confirm submit"}};return(o,e)=>{const m=E("SshPre");return L(),T(O,{subtitle:o.$t("ui.stepper.subtitle"),title:o.$t("ui.stepper.title"),class:"demo-stepper"},{default:r(()=>[n("section",null,[n("h2",null,p(o.$t("ui.stepper.usage.basic")),1),e[5]||(e[5]=t()),n("div",W,[s(i(v),{steps:b,onComplete:D}),e[4]||(e[4]=t()),s(m,{language:"html-vue"},{default:r(()=>[...e[3]||(e[3]=[t(`
          <template>
        ...
        `,-1)])]),_:1})])]),e[31]||(e[31]=t()),n("section",null,[n("h2",null,p(o.$t("ui.stepper.usage.controlled")),1),e[20]||(e[20]=t()),n("div",G,[s(i(v),{"active-index":a.value,steps:P,"hide-buttons":""},null,8,["active-index"]),e[17]||(e[17]=t()),n("div",H,p(g(a.value)),1),e[18]||(e[18]=t()),n("div",J,[s(i(f),{disabled:a.value===0,label:o.$t("ui.stepper.label.previous"),variant:"outlined",onClick:w},null,8,["disabled","label"]),e[15]||(e[15]=t()),s(i(f),{label:o.$t("ui.stepper.label.next"),onClick:N},null,8,["label"])]),e[19]||(e[19]=t()),s(m,{language:"html-vue"},{default:r(()=>[...e[16]||(e[16]=[t(`
          ...
          <\/script>
        `,-1)])]),_:1})])]),e[32]||(e[32]=t()),n("section",null,[n("h2",null,p(o.$t("ui.stepper.usage.verticalControlled")),1),e[27]||(e[27]=t()),n("div",Q,[n("div",X,[s(i(v),{"active-index":u.value,steps:b,direction:"vertical","hide-buttons":""},null,8,["active-index"]),e[23]||(e[23]=t()),s(i(U),{orientation:"vertical"}),e[24]||(e[24]=t()),n("div",Y,[n("div",Z,[n("h3",null,p(g(u.value)),1)]),e[22]||(e[22]=t()),n("div",_,[s(i(f),{disabled:u.value===0,label:o.$t("ui.stepper.label.previous"),variant:"outlined",onClick:k},null,8,["disabled","label"]),e[21]||(e[21]=t()),s(i(f),{label:o.$t("ui.stepper.label.next"),onClick:V},null,8,["label"])])])]),e[26]||(e[26]=t()),s(m,{language:"html-vue"},{default:r(()=>[...e[25]||(e[25]=[t(`
          <template>
            <Stepper
              :active-index="activeIndex"
              :steps="steps"
          ...
          <\/script>
        `,-1)])]),_:1})])]),e[33]||(e[33]=t()),s(M,{"events-data":C,"props-data":$,"props-table-title":o.$t("common.properties",{value:"StepperProperties"}),"slots-data":B},null,8,["props-table-title"]),e[34]||(e[34]=t()),s(m,{language:"html-vue"},{default:r(()=>[...e[28]||(e[28]=[t(`
