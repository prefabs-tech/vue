import{m as N,e as d,Z as p}from"./DzangolabVue3Form.es-264401b9.js";import{d as _,u as $,b as F,e as b,r as c,o as z,c as E,w as a,f as l,g as n,t as s,a as t,h as e}from"./index-a50c4f8e.js";const O={class:"section-content"},w={class:"section-content"},U={class:"section-content"},k={class:"section-content"},M={class:"section-content"},P={class:"section-content"},S={class:"section-content"},y={name:"NumberInputField"},C=_({...y,setup(q){const{t:f}=$(),g=N.coerce.number({invalid_type_error:f("form.errors.number.invalid")}).gte(1,f("form.errors.number.invalid")).lte(100,f("form.errors.number.invalid")),h={invalid:f("form.errors.number.invalid"),required:f("form.errors.number.required")},v={min:1,max:100,allow_leading_zeroes:!1};let r=F({customValidationInput:b(),disabled:b(100),input:b(),inputWithValidation:b(),noLabelInput:b(),textInput:b()});return(o,u)=>{const I=c("router-link"),i=c("SshPre"),V=c("Page");return z(),E(V,{title:o.$t("form.label.number"),class:"demo"},{toolbar:a(()=>[l(I,{to:{name:"form"},class:"back"},{default:a(()=>[n(s(o.$t("common.back")),1)]),_:1})]),default:a(()=>[n(),t("section",null,[t("h2",null,s(o.$t("form.label.basicInput")),1),n(),t("div",O,[l(i,{language:"html-vue"},{default:a(()=>[n(`
          <Form>
            <NumberInput 
              v-model="input"
