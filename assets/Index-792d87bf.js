import{d as V,u as $,f as x,g as p,o as _,c as T,w as u,a as s,t as d,e,b as l,h as t,r as h}from"./index-e93be07b.js";import{m as y,$ as m,b as f}from"./DzangolabVue3Form.es-021bcb61.js";const w={class:"demo-section"},z={class:"demo-section"},F={class:"demo-section"},S={class:"demo-section"},E={class:"demo-section"},U={class:"demo-section"},C={class:"demo-section"},q={class:"demo-section"},O={name:"InputField"},R=V({...O,setup(D){const{t:c}=$(),g=y.string().min(15,{message:c("form.errors.input.min",{length:15})}),I={required:c("form.errors.input.required")},b={ignore_whitespace:!0,required:!0};let a=x({customRowsColsInput:p(),customStyleInput:p(),customValidationInput:p(),disabled:p("Disabled textarea input"),input:p(),inputWithValidation:p(),noLabelInput:p(),textInput:p()});return(n,o)=>{const i=h("SshPre"),v=h("Page");return _(),T(v,{title:n.$t("form.label.textarea")},{default:u(()=>[s("section",w,[s("h3",null,d(n.$t("form.label.basicInput")),1),e(),l(i,{language:"html-vue"},{default:u(()=>[e(`
        <template>
          <TextareaInput 
            v-model="input"
