import{S as v,$ as g}from"./DzangolabVue3Form.es-CXnkTqqN.js";import{d as D,z,A as k,B as $,r as i,y as F,l as S,o as p,p as u,C as l,e as o,t as m,g as r,a as b,b as y,u as n,D as U}from"./index-BlV1QXMi.js";import{_ as C}from"./FormPage.vue_vue_type_style_index_0_lang-DXEIRNpj.js";const E={class:"section-content"},B={key:0,class:"result-date"},A={class:"section-content"},N={key:0,class:"result-date"},P={class:"section-content"},w={key:0,class:"result-date"},q={class:"section-content"},T={key:0,class:"result-date"},O={name:"DaysInput"},K=D({...O,setup(j){const{t:I}=z(),V=k.coerce.number({invalid_type_error:I("form.errors.number.required")}).min(1,{message:I("form.errors.daysInput.invalid")}).max(365,{message:I("form.errors.daysInput.invalid")}),s=$({basic:i(),disabled:i(),label:i(),validationInput:i()});let d=$({basic:i(),disabled:i(30),label:i(),validationInput:i()});return(a,e)=>{const f=F("SshPre");return p(),S(C,{title:a.$t("form.label.daysInput"),class:"demo"},{toolbar:u(()=>[r(n(U),{label:a.$t("common.back"),"icon-left":"pi pi-chevron-left",size:"medium",variant:"textOnly",onClick:e[0]||(e[0]=t=>a.$router.push("/form"))},null,8,["label"])]),default:u(()=>[e[25]||(e[25]=l()),o("section",null,[o("h2",null,m(a.$t("form.label.basicInput")),1),e[12]||(e[12]=l()),o("div",E,[r(n(v),{modelValue:n(d).basic,"onUpdate:modelValue":e[1]||(e[1]=t=>n(d).basic=t),placeholder:a.$t("form.placeholder.days"),"onUpdate:date":e[2]||(e[2]=t=>s.basic=t)},null,8,["modelValue","placeholder"]),e[10]||(e[10]=l()),s.basic?(p(),b("div",B,m(s.basic),1)):y("",!0),e[11]||(e[11]=l()),r(f,{language:"html-vue"},{default:u(()=>e[9]||(e[9]=[l(`
          <template>
            <DaysInput
              v-model="input"
