import{N as v,F as g}from"./DzangolabVue3Form.es-W8oNrDMf.js";import{d as D,z as F,A as z,B as $,r as i,y as k,l as U,o as p,p as u,C as l,e as o,t as m,g as r,a as b,b as y,u as n,D as C}from"./index-DjJ-FZ_G.js";import{_ as E}from"./FormPage.vue_vue_type_style_index_0_lang-D1J0UkCG.js";const N={class:"section-content"},S={key:0,class:"result-date"},B={class:"section-content"},A={key:0,class:"result-date"},P={class:"section-content"},w={key:0,class:"result-date"},q={class:"section-content"},T={key:0,class:"result-date"},O={name:"DaysInput"},K=D({...O,setup(j){const{t:I}=F(),V=z.coerce.number({invalid_type_error:I("form.errors.number.required")}).min(1,{message:I("form.errors.daysInput.invalid")}).max(365,{message:I("form.errors.daysInput.invalid")}),s=$({basic:i(),disabled:i(),label:i(),validationInput:i()});let d=$({basic:i(),disabled:i(30),label:i(),validationInput:i()});return(a,e)=>{const f=k("SshPre");return p(),U(E,{title:a.$t("form.label.daysInput"),class:"demo"},{toolbar:u(()=>[r(n(C),{label:a.$t("common.back"),"icon-left":"pi pi-chevron-left",size:"medium",variant:"textOnly",onClick:e[0]||(e[0]=t=>a.$router.push("/form"))},null,8,["label"])]),default:u(()=>[e[25]||(e[25]=l()),o("section",null,[o("h2",null,m(a.$t("form.label.basicInput")),1),e[12]||(e[12]=l()),o("div",N,[r(n(v),{modelValue:n(d).basic,"onUpdate:modelValue":e[1]||(e[1]=t=>n(d).basic=t),placeholder:a.$t("form.placeholder.days"),"onUpdate:date":e[2]||(e[2]=t=>s.basic=t)},null,8,["modelValue","placeholder"]),e[10]||(e[10]=l()),s.basic?(p(),b("div",S,m(s.basic),1)):y("",!0),e[11]||(e[11]=l()),r(f,{language:"html-vue"},{default:u(()=>e[9]||(e[9]=[l(`
          <template>
            <DaysInput
              v-model="input"
          ...
          const result = ref();
          <\/script>
        `)])),_:1})])]),e[26]||(e[26]=l()),o("section",null,[o("h2",null,m(a.$t("form.label.labelInput")),1),e[16]||(e[16]=l()),o("div",B,[r(n(g),null,{default:u(()=>[r(n(v),{modelValue:n(d).label,"onUpdate:modelValue":e[3]||(e[3]=t=>n(d).label=t),label:a.$t("form.label.arrivalDate"),placeholder:a.$t("form.placeholder.days"),"onUpdate:date":e[4]||(e[4]=t=>s.label=t)},null,8,["modelValue","label","placeholder"])]),_:1}),e[14]||(e[14]=l()),s.label?(p(),b("div",A,m(s.label),1)):y("",!0),e[15]||(e[15]=l()),r(f,{language:"html-vue"},{default:u(()=>e[13]||(e[13]=[l(`
          <Form>
            <DaysInput
              v-model="input"
              label="Arrival date"
