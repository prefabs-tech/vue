import{d,j as f,G as r,o as g,c as _,w as a,K as t,C as e,Z as o,f as s,D as i,aw as u,a as h,g as v}from"./index-708e0d96-63bf851d.js";import{_ as b}from"./UiPage.vue_vue_type_style_index_0_lang-576df06c.js";const $={class:"section-content"},k={class:"section-content"},w={class:"section-content"},C=s("i",{class:"fa-regular fa-bell"},null,-1),M={key:0},S={class:"section-content"},N={class:"section-content"},B=d({__name:"Index",setup(y){const c=f(!0);return(n,m)=>{const p=r("router-link"),l=r("SshPre");return g(),_(b,{title:n.$t("ui.message.title"),class:"demo-message"},{toolbar:a(()=>[t(p,{to:{name:"ui"},class:"back"},{default:a(()=>[e(o(n.$t("common.back")),1)]),_:1})]),default:a(()=>[e(),s("section",null,[s("h2",null,o(n.$t("ui.message.usage.basic")),1),e(),s("div",$,[t(l,{language:"html-vue"},{default:a(()=>[e(`
        ...
        `)]),_:1}),e(),t(i(u),{message:n.$t("ui.message.contents.content2"),icon:"pi pi-android"},null,8,["message"])])]),e(),s("section",null,[s("h2",null,o(n.$t("ui.message.usage.icons.iconSlot")),1),e(),s("div",w,[t(l,{language:"html-vue"},{default:a(()=>[e(`
          ...
          <script setup lang="ts">
            import { Message } from "@dzangolab/vue3-ui";
          <\/script>
        `)]),_:1}),e(),t(i(u),{message:n.$t("ui.message.contents.content3")},{icon:a(()=>[C]),_:1},8,["message"])])]),e(),c.value?(g(),h("section",M,[s("h2",null,o(n.$t("ui.message.usage.enableClose")),1),e(),s("div",S,[t(l,{language:"html-vue"},{default:a(()=>[e(`
