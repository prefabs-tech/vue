import{d as y,e as p,o as B,c as E,w as o,a as e,t as u,f as t,g as n,h as i,a5 as a,r as v,a0 as $,a1 as z,_ as O}from"./index-9392f0ee.js";const d=r=>($("data-v-ca1bdabf"),r=r(),z(),r),C={class:"section-content"},k={class:"container"},S={class:"section-content"},I={class:"container"},w={class:"section-content"},D={class:"container"},T={class:"section-content"},N={class:"container"},L={class:"section-content"},P={class:"container"},R={class:"section-content"},W={class:"container"},M={class:"section-content"},V={class:"container"},A={class:"section-content"},j={className:"container"},q={class:"section-content"},F={className:"container"},G=d(()=>e("i",{class:"pi pi-user"},null,-1)),H=d(()=>e("i",{class:"pi pi-user"},null,-1)),J=d(()=>e("i",{class:"pi pi-user"},null,-1)),K={class:"section-content"},Q={class:"container"},U={class:"container"},X={class:"section-content"},Y={class:"container"},Z=d(()=>e("h2",null,"Custom style",-1)),x={class:"section-content"},tt={class:"container"},et=y({__name:"Index",setup(r){const b=p(void 0),m=p(!1),g=()=>{b.value=new Date},h=()=>{m.value=!0,setTimeout(()=>{m.value=!1},5e3)};return(l,c)=>{const s=v("SshPre"),f=v("Page");return B(),E(f,{title:l.$t("ui.button.title"),class:"demo-button"},{default:o(()=>[e("section",null,[e("h2",null,u(l.$t("ui.button.usage.basic")),1),t(),e("div",C,[n(s,{language:"html-vue"},{default:o(()=>[t(`
          <template> 
        ...
        `)]),_:1}),t(),e("div",V,[n(i(a),{size:"medium",label:l.$t("ui.button.label.textOnly"),variant:"textOnly"},null,8,["label"]),t(),n(i(a),{size:"medium",label:l.$t("ui.button.label.outlined"),variant:"outlined"},null,8,["label"]),t(),n(i(a),{size:"medium",label:l.$t("ui.button.label.default")},null,8,["label"])])])]),t(),e("section",null,[e("h2",null,u(l.$t("ui.button.usage.icons.iconName")),1),t(),e("div",A,[n(s,{language:"html-vue"},{default:o(()=>[t(`
          ...
          <script setup lang="ts"> 
            import { ButtonElement } from "@dzangolab/vue3-ui"; 
          <\/script>
        `)]),_:1}),t(),e("div",j,[n(i(a),{variant:"textOnly",severity:"secondary","icon-left":"pi pi-user"}),t(),n(i(a),{variant:"outlined",severity:"secondary","icon-left":"pi pi-user"}),t(),n(i(a),{variant:"filled","icon-left":"pi pi-user"})])])]),t(),e("section",null,[e("h2",null,u(l.$t("ui.button.usage.icons.iconElement")),1),t(),e("div",q,[n(s,{language:"html-vue"},{default:o(()=>[t(`
          <template> 
          ...
          <script setup lang="ts"> 
            import { ButtonElement } from "@dzangolab/vue3-ui"; 
          <\/script>
        `)]),_:1}),t(),e("div",F,[n(i(a),{variant:"textOnly",severity:"secondary","icon-left":"true",rounded:""},{iconLeft:o(()=>[G]),_:1}),t(),n(i(a),{severity:"secondary",variant:"outlined","icon-right":"true",rounded:""},{iconRight:o(()=>[H]),_:1}),t(),n(i(a),{"icon-right":"true",variant:"filled",rounded:""},{iconRight:o(()=>[J]),_:1})])])]),t(),e("section",null,[e("h2",null,u(l.$t("ui.button.usage.icons.iconWithText")),1),t(),e("div",K,[n(s,{language:"html-vue"},{default:o(()=>[t(`
          <template> 
