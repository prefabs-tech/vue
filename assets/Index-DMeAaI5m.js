import{d as g,r as p,s as d,j as f,o as h,w as a,A as e,e as s,t as i,g as t,u as o,Y as u,B as v}from"./index-j9ugvOHR.js";import{_ as b}from"./UiPage.vue_vue_type_style_index_0_lang-BeVgrYUm.js";const $={class:"section-content"},_={class:"section-content"},M={class:"section-content"},w=s("i",{class:"fa-regular fa-bell"},null,-1),C={class:"section-content"},S={class:"section-content"},y=g({__name:"Index",setup(k){const c=p(!0);return(n,m)=>{const l=d("SshPre");return h(),f(b,{title:n.$t("ui.message.title"),class:"demo-message"},{toolbar:a(()=>[t(o(v),{label:n.$t("common.back"),"icon-left":"pi pi-chevron-left",size:"medium",variant:"textOnly",onClick:m[0]||(m[0]=r=>n.$router.push("/ui"))},null,8,["label"])]),default:a(()=>[e(),s("section",null,[s("h2",null,i(n.$t("ui.message.usage.basic")),1),e(),s("div",$,[t(o(u),{message:n.$t("ui.message.contents.content1")},null,8,["message"]),e(),t(l,{language:"html-vue"},{default:a(()=>[e(`
          <template>
        ...
        `)]),_:1}),e()])]),e(),s("section",null,[s("h2",null,i(n.$t("ui.message.usage.icons.iconSlot")),1),e(),s("div",M,[t(o(u),{message:n.$t("ui.message.contents.content3")},{icon:a(()=>[w]),_:1},8,["message"]),e(),t(l,{language:"html-vue"},{default:a(()=>[e(`
          ...
          <script setup lang="ts">
            import { Message } from "@dzangolab/vue3-ui";
          <\/script>
        `)]),_:1}),e()])]),e(),s("section",null,[s("h2",null,i(n.$t("ui.message.usage.enableClose")),1),e(),s("div",C,[t(o(u),{message:n.$t("ui.message.contents.content4"),icon:"pi pi-comments","enable-close":"",onClose:m[1]||(m[1]=r=>c.value=!1)},null,8,["message"]),e(),t(l,{language:"html-vue"},{default:a(()=>[e(`
          <template>
            <Message
              icon="pi pi-comments"
