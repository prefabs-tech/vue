import{A as b,_ as g}from"./DzangolabVue3Form.es-ByH_DYOt.js";import{d as h,P as $,M as y,I as S,e as V,o as B,i as o,E as t,f as s,t as i,g as l,u as p,R as d,x as C}from"./index-pg879in7.js";import{_ as D}from"./UiPage.vue_vue_type_style_index_0_lang-Bw3iDYo_.js";const I={class:"section-content"},N={class:"section-content"},k={class:"section-content"},T=h({__name:"Index",setup(w){const c=$(),a=y({name:null,phone:null,price:"$50"}),v={iconRight:"pi pi-chevron-right",label:"Next",severity:"primary",variant:"filled"},f={iconLeft:"pi pi-chevron-left",label:"Back",severity:"secondary",variant:"filled"},u=[{content:"Please enter personal details",label:"Personal",step:1},{content:"Please enter contact details",label:"Contact",step:2},{content:"Please enter payment details",label:"Payment",step:3},{content:"Do you wish to continue?",label:"Confirmation",step:4}],P=()=>{c.push("/ui")};return(n,e)=>{const m=S("SshPre");return B(),V(D,{title:n.$t("ui.stepper.title"),class:"demo"},{toolbar:o(()=>[l(p(C),{label:n.$t("common.back"),"icon-left":"pi pi-chevron-left",size:"medium",variant:"textOnly",onClick:e[0]||(e[0]=r=>n.$router.push("/ui"))},null,8,["label"])]),default:o(()=>[e[16]||(e[16]=t()),s("section",null,[s("h2",null,i(n.$t("ui.stepper.usage.basic")),1),e[6]||(e[6]=t()),s("div",I,[l(p(d),{steps:u,onComplete:P}),e[5]||(e[5]=t()),l(m,{language:"html-vue"},{default:o(()=>e[4]||(e[4]=[t(`
          <template>
