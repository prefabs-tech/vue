import{K as i}from"./DzangolabVue3Form.es-51baa5bd.js";import{_ as u}from"./FormPage.vue_vue_type_style_index_0_lang-328842f1.js";import{d as c,K as r,o as d,c as f,w as o,L as n,C as e,M as s,f as t,E as p}from"./index-4dbfb8c7-0110dc13.js";import"./index-f3c29e5f.js";const g={class:"section-content"},h={class:"section-content"},b={class:"section-content"},_={class:"section-content"},z={class:"section-content"},v={class:"section-content"},F={name:"FileInputDemo"},j=c({...F,setup(I){return(l,w)=>{const m=r("router-link"),a=r("SshPre");return d(),f(u,{title:l.$t("form.label.fileInput"),class:"demo"},{toolbar:o(()=>[n(m,{to:{name:"form"},class:"back"},{default:o(()=>[e(s(l.$t("common.back")),1)]),_:1})]),default:o(()=>[e(),t("section",null,[t("h2",null,s(l.$t("form.label.basicInput")),1),e(),t("div",g,[n(p(i)),e(),n(a,{language:"html-vue"},{default:o(()=>[e(`
          <template>
            <FileInput />
          </template>
