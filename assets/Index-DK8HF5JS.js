import{P as d,E as g}from"./PrefabsTechVue3Form.es-JJOMbn2S.js";import{d as k,I as y,L as V,M as P,r as u,J as $,e as M,o as w,i,B as t,f as l,t as p,h as o,u as n,q as B}from"./index-DLHnW3Hk.js";import{_ as U}from"./FormPage.vue_vue_type_style_index_0_lang-At3nlgdF.js";const O={class:"section-content"},I={class:"section-content"},A={class:"section-content"},R={class:"section-content"},Y={class:"section-content"},F={class:"section-content"},S={class:"section-content"},j={class:"section-content"},z={class:"section-content"},C={class:"section-content"},H={class:"section-content"},L={class:"section-content"},T={class:"section-content"},N={class:"section-content"},E={name:"DatePickerInput"},K=k({...E,setup(J){const{t:b}=y(),v=V.date({invalid_type_error:b("form.errors.datePicker.invalid")}).max(new Date,{message:b("form.errors.datePicker.invalid")}),f=new Date,D=f;let r=P({appointmentDate:u(f),arrivalDate:u(),availableDatetime:u([f,new Date(D.setDate(D.getDate()+7))]),dateOfBirth:u(f),dateRange:u([f,new Date(D.setDate(D.getDate()+7))]),joinedDate:u(),month:u(),monthAndYear:u(),noLabelInput:u(),presentationDate:u(f),reportDate:u([f,new Date(D.setDate(D.getDate()+7))]),time:u(),year:u(f.getFullYear())});return(a,e)=>{const s=$("SshPre");return w(),M(U,{title:a.$t("form.label.datePicker"),class:"demo"},{toolbar:i(()=>[o(n(B),{label:a.$t("common.back"),"icon-left":"pi pi-chevron-left",size:"medium",variant:"textOnly",onClick:e[0]||(e[0]=m=>a.$router.push("/form"))},null,8,["label"])]),default:i(()=>[e[57]||(e[57]=t()),l("section",null,[l("h2",null,p(a.$t("form.label.basicInput")),1),e[17]||(e[17]=t()),l("div",O,[o(n(d),{modelValue:n(r).noLabelInput,"onUpdate:modelValue":e[1]||(e[1]=m=>n(r).noLabelInput=m),placeholder:"MM/dd/yyyy"},null,8,["modelValue"]),e[16]||(e[16]=t()),o(s,{language:"html-vue"},{default:i(()=>e[15]||(e[15]=[t(`
        ...
        `)])),_:1})])]),e[61]||(e[61]=t()),l("section",null,[l("h2",null,p(a.$t("form.label.disableWeekDays")),1),e[29]||(e[29]=t()),l("div",Y,[o(n(d),{modelValue:n(r).presentationDate,"onUpdate:modelValue":e[5]||(e[5]=m=>n(r).presentationDate=m),"disabled-week-days":[6,0],label:a.$t("form.label.presentationDate")},null,8,["modelValue","label"]),e[28]||(e[28]=t()),o(s,{language:"html-vue"},{default:i(()=>e[27]||(e[27]=[t(`
          ...
          <\/script>
        `)])),_:1})])]),e[62]||(e[62]=t()),l("section",null,[l("h2",null,p(a.$t("form.label.customFormat")),1),e[32]||(e[32]=t()),l("div",F,[o(n(d),{modelValue:n(r).dateOfBirth,"onUpdate:modelValue":e[6]||(e[6]=m=>n(r).dateOfBirth=m),format:"yyyy/MM/dd",label:a.$t("form.label.dateOfBirth")},null,8,["modelValue","label"]),e[31]||(e[31]=t()),o(s,{language:"html-vue"},{default:i(()=>e[30]||(e[30]=[t(`
          <template>
            <DatePicker 
              v-model="dateOfBirth"
              format="yyyy/MM/dd"
          ...
          const dateOfBirth = ref(new Date());
          <\/script>
        `)])),_:1})])]),e[63]||(e[63]=t()),l("section",null,[l("h2",null,p(a.$t("form.label.dateRange")),1),e[35]||(e[35]=t()),l("div",S,[o(n(d),{modelValue:n(r).dateRange,"onUpdate:modelValue":e[7]||(e[7]=m=>n(r).dateRange=m),label:a.$t("form.label.dateRange"),range:""},null,8,["modelValue","label"]),e[34]||(e[34]=t()),o(s,{language:"html-vue"},{default:i(()=>e[33]||(e[33]=[t(`
          <template>
            <DatePicker 
              v-model="dateRange"
              label="Date range"
