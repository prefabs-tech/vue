import{F as d,$ as c}from"./DzangolabVue3Form.es-0950df2a.js";import{d as V,a7 as $,p as T,j as m,K as h,o as _,c as z,w as r,L as o,C as e,M as p,f as l,E as n}from"./index-8e1c3ab6-475a9ed5.js";import{m as F}from"./index-00a59c05.js";import{_ as x}from"./FormPage.vue_vue_type_style_index_0_lang-01c0d475.js";const E={class:"section-content"},U={class:"section-content"},k={class:"section-content"},q={class:"section-content"},w={class:"section-content"},S={class:"section-content"},M={class:"section-content"},O={name:"TextInputField"},D=V({...O,setup(C){const{t:f}=$(),g=F.string().length(5,{message:f("form.errors.input.length",{length:5})}),I={required:f("form.errors.input.required")},b={ignore_whitespace:!0,required:!0};let a=T({customValidationInput:m(),disabled:m("dzangolab"),input:m(),inputWithValidation:m(),noLabelInput:m(),textInput:m()});return(t,u)=>{const v=h("router-link"),i=h("SshPre");return _(),z(x,{title:t.$t("form.label.textInput"),class:"demo"},{toolbar:r(()=>[o(v,{to:{name:"form"},class:"back"},{default:r(()=>[e(p(t.$t("common.back")),1)]),_:1})]),default:r(()=>[e(),l("section",null,[l("h2",null,p(t.$t("form.label.basicInput")),1),e(),l("div",E,[o(n(d),{modelValue:n(a).noLabelInput,"onUpdate:modelValue":u[0]||(u[0]=s=>n(a).noLabelInput=s),placeholder:t.$t("form.placeholder.input")},null,8,["modelValue","placeholder"]),e(),o(i,{language:"html-vue"},{default:r(()=>[e(`
          <template>
            <TextInput 
              v-model="input"
