import{o as r,t as c}from"./DzangolabVue3Form.es-5cddabd8.js";import{d as h,a5 as v,p as w,j as p,J as g,o as V,c as I,w as u,K as a,D as e,ao as S,X as l,f as n,L as d}from"./index-729398ab-f7824fe4.js";import{m as $}from"./index-9966f943.js";import{_ as z}from"./FormPage.vue_vue_type_style_index_0_lang-2120d4bb.js";const L={class:"section-content"},F={class:"section-content"},y={class:"section-content"},O={class:"section-content"},U={class:"section-content"},_={class:"section-content"},k={name:"SwitchInput"},P=h({...k,setup(C){const{t:f}=v(),b=$.coerce.boolean().refine(t=>t===!0,{message:f("form.errors.switch.invalid")});let i=w({disabled:p(!0),input:p(),inputWithValidation:p(!1),noLabelInput:p(),onOffLabel:p()});return(t,o)=>{const m=g("SshPre");return V(),I(z,{title:t.$t("form.label.switch"),class:"demo"},{toolbar:u(()=>[a(e(S),{label:t.$t("common.back"),"icon-left":"pi pi-chevron-left",size:"medium",variant:"textOnly",onClick:o[0]||(o[0]=s=>t.$router.push("/form"))},null,8,["label"])]),default:u(()=>[l(),n("section",null,[n("h2",null,d(t.$t("form.label.basicInput")),1),l(),n("div",L,[a(e(r),{modelValue:e(i).noLabelInput,"onUpdate:modelValue":o[1]||(o[1]=s=>e(i).noLabelInput=s)},null,8,["modelValue"]),l(),a(m,{language:"html-vue"},{default:u(()=>[l(`
          <template>
