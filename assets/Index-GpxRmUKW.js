import{d as r,p as d,e as b,o as P,w as l,C as e,f as i,h as a,u as s,Y as u,t as g,q as p,V as m}from"./index-C44VGcWd.js";import{_ as f}from"./UiPage.vue_vue_type_style_index_0_lang-vohbFOoL.js";const v={class:"section-content"},$={class:"section-content"},B={class:"section-content"},z={class:"section-content"},C={class:"section-content"},E={class:"section-content"},T={class:"section-content"},W={class:"section-content"},w=r({__name:"Index",setup(y){return(n,t)=>{const o=d("SshPre");return P(),b(f,{title:n.$t("ui.page.title"),class:"demo"},{toolbar:l(()=>[a(s(p),{label:n.$t("common.back"),"icon-left":"pi pi-chevron-left",size:"medium",variant:"textOnly",onClick:t[0]||(t[0]=S=>n.$router.push("/ui"))},null,8,["label"])]),default:l(()=>[t[17]||(t[17]=e()),i("section",null,[i("div",v,[a(s(u),{title:n.$t("ui.page.usage.basic"),"title-element":"h2"},{default:l(()=>[e(g(n.$t("ui.page.label.content")),1)]),_:1},8,["title"]),t[2]||(t[2]=e()),a(o,{language:"html-vue"},{default:l(()=>t[1]||(t[1]=[e(`
          <template>
