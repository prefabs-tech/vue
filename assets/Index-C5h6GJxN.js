import{C as p,O as w}from"./DzangolabVue3Form.es-CQgBzZxD.js";import{d as P,J as V,L as $,M as I,r as f,I as z,e as y,o as S,i as d,D as l,f as s,t as m,g as t,u as n,A as O,v as U}from"./index-BfHf9_CU.js";import{_ as F}from"./FormPage.vue_vue_type_style_index_0_lang-D12AkYw2.js";const L={class:"section-content"},E={class:"section-content"},q={class:"section-content"},C={class:"section-content"},M={class:"section-content"},k={class:"section-content"},W={class:"section-content"},h={class:"section-content"},A={name:"PasswordInputField"},Z=P({...A,setup(B){const{t:u}=V(),g=$.string({invalid_type_error:u("form.errors.password.invalid"),required_error:u("form.errors.input.required")}).min(8,{message:u("form.errors.password.min",{length:8})}).regex(/^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)(?=.*[\W_]).+$/,u("form.errors.password.invalid")),v={required:u("form.errors.input.required"),weak:u("form.errors.password.invalid")},b={minLength:10,minLowercase:1,minUppercase:1,minSymbols:1};let a=I({customValidationInput:f(),disabled:f("P@ssw0rd"),input:f(),inputWithValidation:f(),noLabelInput:f(),passwordInput:f()});return(e,o)=>{const i=z("SshPre");return S(),y(F,{title:e.$t("form.label.password"),class:"demo"},{toolbar:d(()=>[t(n(U),{label:e.$t("common.back"),"icon-left":"pi pi-chevron-left",size:"medium",variant:"textOnly",onClick:o[0]||(o[0]=r=>e.$router.push("/form"))},null,8,["label"])]),default:d(()=>[o[33]||(o[33]=l()),s("section",null,[s("h2",null,m(e.$t("form.label.basicInput")),1),o[11]||(o[11]=l()),s("div",L,[t(n(p),{modelValue:n(a).noLabelInput,"onUpdate:modelValue":o[1]||(o[1]=r=>n(a).noLabelInput=r),placeholder:e.$t("form.placeholder.password")},null,8,["modelValue","placeholder"]),o[10]||(o[10]=l()),t(i,{language:"html-vue"},{default:d(()=>o[9]||(o[9]=[l(`
          <template>
            <Password 
              v-model="input"
        ...
        `)])),_:1})])]),o[36]||(o[36]=l()),s("section",null,[s("h2",null,m(e.$t("form.label.withI18n")),1),o[20]||(o[20]=l()),s("div",C,[t(n(p),{modelValue:n(a).input,"onUpdate:modelValue":o[4]||(o[4]=r=>n(a).input=r),label:e.$t("form.label.password"),placeholder:e.$t("form.placeholder.password")},null,8,["modelValue","label","placeholder"]),o[19]||(o[19]=l()),t(i,{language:"html-vue"},{default:d(()=>o[18]||(o[18]=[l(`
          ...
          const { t } = useI18n();
          <\/script>
        `)])),_:1})])]),o[37]||(o[37]=l()),s("section",null,[s("h2",null,m(e.$t("form.label.iconSlot")),1),o[23]||(o[23]=l()),s("div",M,[t(n(p),{modelValue:n(a).input,"onUpdate:modelValue":o[5]||(o[5]=r=>n(a).input=r),label:e.$t("form.label.password"),placeholder:e.$t("form.placeholder.password")},{icon:d(({showPassword:r})=>[s("i",{class:O(`pi ${r?"pi-eye":"pi-eye-slash"}`)},null,2)]),_:1},8,["modelValue","label","placeholder"]),o[22]||(o[22]=l()),t(i,{language:"html-vue"},{default:d(()=>o[21]||(o[21]=[l(`
          <template>
            <Password 
              v-model="input"
              :label="t('form.label.password')"
