import{l as d,o as f}from"./DzangolabVue3Form.es-Cf29nzIN.js";import{d as v,x as E,y as V,z,r as p,s as _,j as $,o as I,w as s,A as l,e as a,t as u,g as o,u as e,B as F}from"./index-j9ugvOHR.js";import{_ as w}from"./FormPage.vue_vue_type_style_index_0_lang-CciDNi3U.js";const y={class:"section-content"},O={class:"section-content"},U={class:"section-content"},W={class:"section-content"},q={class:"section-content"},M={class:"section-content"},S={class:"section-content"},k={class:"section-content"},B={name:"EmailInputField"},D=v({...B,setup(C){const{t:c}=E(),g=V.string().email({message:c("form.errors.email.invalid")}),h={required:c("form.errors.input.required"),invalid:c("form.errors.email.invalid",{list:"(dzangolab.com, dzango.com, gmail.com)"})},b={allow_display_name:!1,allow_utf8_local_part:!0,host_whitelist:["dzangolab.com","dzango.com","gmail.com"],require_display_name:!1};let i=z({customValidationInput:p(),disabled:p("monorepo@dzangolab.com"),input:p(),inputWithValidation:p(),noLabelInput:p(),textInput:p()});return(n,t)=>{const r=_("SshPre");return I(),$(w,{title:n.$t("form.label.email"),class:"demo"},{toolbar:s(()=>[o(e(F),{label:n.$t("common.back"),"icon-left":"pi pi-chevron-left",size:"medium",variant:"textOnly",onClick:t[0]||(t[0]=m=>n.$router.push("/form"))},null,8,["label"])]),default:s(()=>[l(),a("section",null,[a("h2",null,u(n.$t("form.label.basicInput")),1),l(),a("div",y,[o(e(d),{modelValue:e(i).noLabelInput,"onUpdate:modelValue":t[1]||(t[1]=m=>e(i).noLabelInput=m),placeholder:n.$t("form.placeholder.email")},null,8,["modelValue","placeholder"]),l(),o(r,{language:"html-vue"},{default:s(()=>[l(`
          <template>
            <Email 
              v-model="input"
        ...
        `)]),_:1}),l()])]),l(),a("section",null,[a("h2",null,u(n.$t("form.label.customValidationInput")),1),l(),a("div",k,[o(e(f),null,{default:s(()=>[o(e(d),{modelValue:e(i).customValidationInput,"onUpdate:modelValue":t[8]||(t[8]=m=>e(i).customValidationInput=m),label:n.$t("form.label.email"),placeholder:n.$t("form.placeholder.email"),schema:e(g),name:"custom_input"},null,8,["modelValue","label","placeholder","schema"])]),_:1}),l(),o(r,{language:"html-vue"},{default:s(()=>[l(`
          ...
          <\/script>
        `)]),_:1}),l()])])]),_:1},8,["title"])}}});export{D as default};
