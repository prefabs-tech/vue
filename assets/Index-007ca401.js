import{m as V,e as d,Z as p}from"./DzangolabVue3Form.es-4febcfcc.js";import{d as N,a3 as _,l as $,j as b,E as v,o as F,c as z,w as r,J as l,C as n,Z as s,f as t,N as e}from"./index-66214709-683f8f7e.js";import{_ as E}from"./FormPage.vue_vue_type_style_index_0_lang-a24a8f86.js";import"./index-dd0a7bd8.js";const O={class:"section-content"},w={class:"section-content"},U={class:"section-content"},k={class:"section-content"},M={class:"section-content"},S={class:"section-content"},y={class:"section-content"},q={name:"NumberInputField"},Z=N({...q,setup(C){const{t:f}=_(),h=V.coerce.number({invalid_type_error:f("form.errors.number.invalid")}).gte(1,f("form.errors.number.invalid")).lte(100,f("form.errors.number.invalid")),g={invalid:f("form.errors.number.invalid"),required:f("form.errors.number.required")},c={min:1,max:100,allow_leading_zeroes:!1};let a=$({customValidationInput:b(),disabled:b(100),input:b(),inputWithValidation:b(),noLabelInput:b(),textInput:b()});return(o,u)=>{const I=v("router-link"),i=v("SshPre");return F(),z(E,{title:o.$t("form.label.number"),class:"demo"},{toolbar:r(()=>[l(I,{to:{name:"form"},class:"back"},{default:r(()=>[n(s(o.$t("common.back")),1)]),_:1})]),default:r(()=>[n(),t("section",null,[t("h2",null,s(o.$t("form.label.basicInput")),1),n(),t("div",O,[l(i,{language:"html-vue"},{default:r(()=>[n(`
          <Form>
            <NumberInput 
              v-model="input"
