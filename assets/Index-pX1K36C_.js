import{d as v,r as b,I as $,e as S,o as M,i as l,E as s,f as t,g as o,t as u,u as i,a5 as r,x as c}from"./index-_J_htfkm.js";import{_ as w}from"./ComponentDocumentation.vue_vue_type_script_setup_true_lang-BOfXhcwf.js";import{_ as y}from"./UiPage.vue_vue_type_style_index_0_lang-B_XgebBS.js";import"./DzangolabVue3TanstackTable.es-Ivvz5Lww.js";import"./DzangolabVue3Form.es-D0sA9VA1.js";const C={class:"section-content"},k={class:"section-content"},z={class:"section-content"},I={class:"section-content"},N={class:"section-content"},T=v({__name:"Index",setup(D){const m=b(!0),p=[{description:"Emitted when the close icon is clicked.",name:"close",payload:"-"}],g=[{default:"false",description:"Displays a close icon if true, allowing the message to be dismissed.",prop:"enableClose",type:"Boolean"},{default:"-",description:"Icon to display alongside the message.",prop:"icon",type:"String"},{default:"-",description:"The message text to display in the component.",prop:"message",type:"String"}],d=[{description:"Slot for message. Overrides the message content.",name:"default"},{description:"Slot for custom icon. Overrides the `icon` prop if provided.",name:"icon"}];return(n,e)=>{const a=$("SshPre");return M(),S(y,{"sub-title":n.$t("ui.message.subtitle"),title:n.$t("ui.message.title"),class:"demo-message"},{toolbar:l(()=>[o(i(c),{label:n.$t("common.back"),"icon-left":"pi pi-chevron-left",size:"medium",variant:"textOnly",onClick:e[0]||(e[0]=f=>n.$router.push("/ui"))},null,8,["label"])]),default:l(()=>[e[18]||(e[18]=s()),t("section",null,[t("h2",null,u(n.$t("ui.message.usage.basic")),1),e[4]||(e[4]=s()),t("div",C,[o(i(r),{message:n.$t("ui.message.contents.content1")},null,8,["message"]),e[3]||(e[3]=s()),o(a,{language:"html-vue"},{default:l(()=>e[2]||(e[2]=[s(`
          <template>
