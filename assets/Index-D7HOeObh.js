import{d as r,K as g,f as b,o as p,i as o,D as l,g as n,t as u,h as i,u as s,a1 as a,v as m,_ as v}from"./index-C-aoaGfb.js";import{_ as f}from"./UiPage.vue_vue_type_style_index_0_lang-DosQbPLl.js";const B={class:"section-content"},y={class:"section-content"},$={class:"section-content"},k={class:"section-content"},z={class:"container"},w={class:"section-content"},I={class:"container"},L={class:"section-content"},C={class:"container"},S={class:"section-content"},P={class:"container"},D={class:"section-content"},N={class:"container"},R=r({__name:"Index",setup(V){return(t,e)=>{const d=g("SshPre");return p(),b(f,{title:t.$t("ui.badge.title"),class:"demo-badge"},{toolbar:o(()=>[i(s(m),{label:t.$t("common.back"),"icon-left":"pi pi-chevron-left",size:"medium",variant:"textOnly",onClick:e[0]||(e[0]=A=>t.$router.push("/ui"))},null,8,["label"])]),default:o(()=>[e[36]||(e[36]=l()),n("section",null,[n("h2",null,u(t.$t("ui.badge.usage.basic")),1),e[3]||(e[3]=l()),n("div",B,[i(s(a),{label:t.$t("ui.badge.label.basic")},null,8,["label"]),e[2]||(e[2]=l()),i(d,{language:"html-vue"},{default:o(()=>e[1]||(e[1]=[l(`
          <template>
            <Badge label="Basic" /> 
          </template>
