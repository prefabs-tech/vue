import{d as m,J as f,e as v,o as C,i as s,f as e,B as n,h as i,t as r,u as l,O as d}from"./index-BPTdnMQV.js";import{_ as g}from"./ComponentDocumentation.vue_vue_type_script_setup_true_lang-DtuMFFjT.js";import{_ as c}from"./UiPage.vue_vue_type_style_index_0_lang-CmL74Pur.js";import"./PrefabsTechVue3TanstackTable.es-CmAD8rqL.js";import"./PrefabsTechVue3Form.es-DZTCjbbV.js";const $={class:"section-content"},b={class:"content"},h={class:"section-content"},S={class:"content"},I={class:"section-content"},y={class:"content"},B={class:"section-content"},D={class:"title"},w={class:"content"},N={class:"footer"},O=m({__name:"Index",setup(P){const p=[{default:"-",description:"Title text displayed in the card header. Ignored if header slot is provided.",prop:"title",type:"String"}],u=[{description:"Default slot for the main body content of the card.",name:"default"},{description:"Slot for custom footer content, rendered at the bottom of the card.",name:"footer"},{description:"Slot for custom header content, replaces the default title if provided.",name:"header"}];return(o,t)=>{const a=f("SshPre");return C(),v(c,{subtitle:o.$t("ui.card.subtitle"),title:o.$t("ui.card.title"),class:"demo"},{default:s(()=>[e("section",null,[e("h2",null,r(o.$t("ui.card.usage.basic")),1),t[2]||(t[2]=n()),e("div",$,[i(l(d),null,{default:s(()=>[e("p",b,r(o.$t("ui.card.content")),1)]),_:1}),t[1]||(t[1]=n()),i(a,{language:"html-vue"},{default:s(()=>t[0]||(t[0]=[n(`
          <template>
            <Card>
              <p>
                ...
