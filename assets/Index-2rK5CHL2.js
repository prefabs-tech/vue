import{x as b}from"./DzangolabVue3Form.es-BMjfRIel.js";import{d as f,r as v,K as g,f as k,o as C,i as n,D as e,g as s,t as r,h as o,u as a,a0 as y,v as p,O as $}from"./index-C-aoaGfb.js";import{_ as c}from"./LayoutPage.vue_vue_type_style_index_0_lang-C0IqkA9Z.js";const z={class:"section-content"},F={class:"section-content"},S={name:"StickyCollapsibleFooter"},E=f({...S,setup(B){const u=v(),m=t=>{t&&alert(t)};return(t,l)=>{const d=g("SshPre");return C(),k(c,{title:t.$t("layout.label.stickyCollapsibleFooter"),class:"demo sticky-collapsible-footer"},{toolbar:n(()=>[o(a(p),{label:t.$t("common.back"),"icon-left":"pi pi-chevron-left",size:"medium",variant:"textOnly",onClick:l[0]||(l[0]=i=>t.$router.push("/layout"))},null,8,["label"])]),default:n(()=>[l[12]||(l[12]=e()),s("section",null,[s("h2",null,r(t.$t("layout.label.footerFixed")),1),l[8]||(l[8]=e()),s("div",z,[o(a(y),null,{default:n(()=>[o(a(b),{modelValue:u.value,"onUpdate:modelValue":l[1]||(l[1]=i=>u.value=i),placeholder:t.$t("layout.placeholder.input")},null,8,["modelValue","placeholder"]),l[4]||(l[4]=e()),o(a(p),{label:t.$t("layout.label.submit"),size:"small",onClick:l[2]||(l[2]=i=>m(u.value))},null,8,["label"]),l[5]||(l[5]=e()),o(a(p),{label:t.$t("layout.label.cancel"),severity:"secondary",size:"small",variant:"outlined",onClick:l[3]||(l[3]=i=>m(t.$t("layout.label.cancelled")))},null,8,["label"])]),_:1}),l[7]||(l[7]=e()),o(d,{language:"html-vue"},{default:n(()=>l[6]||(l[6]=[e(`
          <template>
