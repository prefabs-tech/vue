import{b as p,O as f}from"./PrefabsTechVue3Form.es-Dm1vBmAc.js";import{d as V,I as $,L as T,M as x,r as m,J as w,e as F,o as C,j as u,C as t,f as o,t as d,h as a,u as l,v as h}from"./index-DcjgAK9n.js";import{_ as O}from"./FormPage.vue_vue_type_style_index_0_lang-zp3Zqcj0.js";const U={class:"section-content"},E={class:"section-content"},q={class:"section-content"},S={class:"section-content"},y={class:"section-content"},z={class:"section-content"},M={class:"section-content"},k={class:"section-content"},D={name:"TextareaInputField"},N=V({...D,setup(L){const{t:b}=$(),I=T.string().min(15,{message:b("form.errors.input.min",{length:15})}),g={required:b("form.errors.input.required")},v={ignore_whitespace:!0,required:!0};let r=x({customRowsColsInput:m(),customValidationInput:m(),disabled:m("Disabled textarea input"),i18nInput:m(),input:m(),inputWithValidation:m(),noLabelInput:m(),textInput:m()});return(n,e)=>{const i=w("SshPre");return C(),F(O,{title:n.$t("form.label.textarea"),class:"demo"},{toolbar:u(()=>[a(l(h),{label:n.$t("common.back"),"icon-left":"pi pi-chevron-left",size:"medium",variant:"textOnly",onClick:e[0]||(e[0]=s=>n.$router.push("/form"))},null,8,["label"])]),default:u(()=>[e[33]||(e[33]=t()),o("section",null,[o("h2",null,d(n.$t("form.label.basicInput")),1),e[11]||(e[11]=t()),o("div",U,[a(l(p),{modelValue:l(r).noLabelInput,"onUpdate:modelValue":e[1]||(e[1]=s=>l(r).noLabelInput=s),placeholder:n.$t("form.placeholder.input")},null,8,["modelValue","placeholder"]),e[10]||(e[10]=t()),a(i,{language:"html-vue"},{default:u(()=>e[9]||(e[9]=[t(`
          <template>
            <TextareaInput 
              v-model="input"
