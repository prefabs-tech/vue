import{s as p,o as c}from"./DzangolabVue3Form.es-CpaDvokg.js";import{d as g,z as v,A as P,B as V,r as f,s as $,j as z,o as I,w as d,C as e,e as n,t as m,g as s,u as o,i as y,D as S}from"./index-CVjUtB44.js";import{_ as U}from"./FormPage.vue_vue_type_style_index_0_lang-DaPY-vu5.js";const F={class:"section-content"},O={class:"section-content"},_={class:"section-content"},L={class:"section-content"},E={class:"section-content"},q={class:"section-content"},k={class:"section-content"},C={class:"section-content"},M={name:"PasswordInputField"},N=g({...M,setup(W){const{t:u}=v(),b=P.string({invalid_type_error:u("form.errors.password.invalid"),required_error:u("form.errors.input.required")}).min(8,{message:u("form.errors.password.min",{length:8})}).regex(/^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)(?=.*[\W_]).+$/,u("form.errors.password.invalid")),h={required:u("form.errors.input.required"),weak:u("form.errors.password.invalid")},w={minLength:10,minLowercase:1,minUppercase:1,minSymbols:1};let r=V({customValidationInput:f(),disabled:f("P@ssw0rd"),input:f(),inputWithValidation:f(),noLabelInput:f(),passwordInput:f()});return(l,a)=>{const i=$("SshPre");return I(),z(U,{title:l.$t("form.label.password"),class:"demo"},{toolbar:d(()=>[s(o(S),{label:l.$t("common.back"),"icon-left":"pi pi-chevron-left",size:"medium",variant:"textOnly",onClick:a[0]||(a[0]=t=>l.$router.push("/form"))},null,8,["label"])]),default:d(()=>[e(),n("section",null,[n("h2",null,m(l.$t("form.label.basicInput")),1),e(),n("div",F,[s(o(p),{modelValue:o(r).noLabelInput,"onUpdate:modelValue":a[1]||(a[1]=t=>o(r).noLabelInput=t),placeholder:l.$t("form.placeholder.password")},null,8,["modelValue","placeholder"]),e(),s(i,{language:"html-vue"},{default:d(()=>[e(`
          <template>
            <Password 
              v-model="input"
