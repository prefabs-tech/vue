import{v as p}from"./PrefabsTechVue3Form.es-brkzzdHc.js";import{_ as d}from"./FormPage.vue_vue_type_style_index_0_lang-Bgaub6wG.js";import{d as f,J as g,e as b,o as z,i,f as n,B as t,t as r,h as s,u as m}from"./index-BeDuccrR.js";const v={class:"section-content"},F={class:"section-content"},S={class:"section-content"},$={class:"section-content"},I={class:"section-content"},B={class:"section-content"},y={class:"section-content"},x={name:"FileInputDemo"},P=f({...x,setup(w){const a={accept:["image/jpeg","image/png"],maxFiles:2,minSize:10240,maxSize:1048576},u=o=>{const e=o/1024;return e>=1024?`${e/1024} MB`:`${e} KB`};return(o,e)=>{const l=g("SshPre");return z(),b(d,{title:o.$t("form.label.fileInput"),class:"demo"},{default:i(()=>[n("section",null,[n("h2",null,r(o.$t("form.label.basicInput")),1),e[2]||(e[2]=t()),n("div",v,[s(m(p)),e[1]||(e[1]=t()),s(l,{language:"html-vue"},{default:i(()=>e[0]||(e[0]=[t(`
          <template>
            <FileInput />
          </template>
