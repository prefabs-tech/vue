import{E as y,$ as S,N as V,c as A}from"./PrefabsTechVue3Form.es-B2BaFGU7.js";import{d as F,I as N,N as I,r as d,L as h,e as T,o as E,j as i,C as o,f as n,h as t,t as u,u as a,v as m,a5 as p,a as U,F as j,z as R}from"./index-CA3Jbfm5.js";import{_ as q}from"./ComponentDocumentation.vue_vue_type_script_setup_true_lang-Dz3LdPj4.js";import{_ as G}from"./UiPage.vue_vue_type_style_index_0_lang-yn-BXnXl.js";import"./PrefabsTechVue3TanstackTable.es-DGkGOXT5.js";const H={class:"section-content"},J={class:"container"},K={class:"section-content"},Q={class:"container"},W={class:"label"},X={class:"value"},Y={class:"section-content"},Z={class:"container"},c={class:"section-content"},x={class:"container"},_={class:"section-content"},ll={class:"container"},ol={role:"heading"},ul=F({__name:"Index",setup(el){const{t:r}=N(),B=[{description:r("ui.modal.documentation.eventDescription.close"),name:"on:close",payload:"-"}],C=[{label:"Name",value:"Acer Nitro 5"},{label:"Category",value:"Laptop"},{label:"Color",value:"Black"}],L=[{default:"false",description:r("ui.modal.documentation.propsDescription.dismissOnClickOut"),prop:"dismissOnClickOut",type:"Boolean"},{default:"false",description:r("ui.modal.documentation.propsDescription.show"),prop:"show",type:"Boolean"},{default:"medium",description:r("ui.modal.documentation.propsDescription.size"),prop:"size",type:'"medium" | "large" | "auto"'},{default:"-",description:r("ui.modal.documentation.propsDescription.title"),prop:"title",type:"String"}],z=[{description:r("ui.modal.documentation.slotDescription.default"),name:"default"},{description:r("ui.modal.documentation.slotDescription.footer"),name:"footer"},{description:r("ui.modal.documentation.slotDescription.header"),name:"header"}],v=I({email:d(),password:d()}),b=d(!1),M=d(!1),$=d(!1),g=d(!1),k=d(!1),w=d(!1),D=d(!1);return(e,l)=>{const f=h("SshPre"),O=h("router-link");return E(),T(G,{"sub-title":e.$t("ui.modal.subtitle"),title:e.$t("ui.modal.title"),class:"demo-modal"},{toolbar:i(()=>[t(a(m),{label:e.$t("common.back"),"icon-left":"pi pi-chevron-left",size:"medium",variant:"textOnly",onClick:l[0]||(l[0]=s=>e.$router.push("/ui"))},null,8,["label"])]),default:i(()=>[l[47]||(l[47]=o()),n("section",null,[n("h2",null,u(e.$t("ui.modal.usage.basic")),1),l[21]||(l[21]=o()),n("div",H,[n("div",J,[t(a(m),{label:e.$t("ui.modal.label.show"),onClick:l[1]||(l[1]=s=>D.value=!0)},null,8,["label"])]),l[19]||(l[19]=o()),t(a(p),{show:D.value,title:e.$t("ui.modal.header.productDetail"),"onOn:close":l[2]||(l[2]=s=>D.value=!1)},{default:i(()=>[o(u(e.$t("ui.modal.content")),1)]),_:1},8,["show","title"]),l[20]||(l[20]=o()),t(f,{language:"html-vue"},{default:i(()=>l[18]||(l[18]=[o(`
          <template>
            <ButtonElement
              label="Show"
