import{d as E,j as d,G as g,o as m,c as f,w as i,K as a,C as e,S as r,f as o,D as s,ao as u,aq as c,g as p}from"./index-9834d213-2ba3e299.js";import{_ as L}from"./UiPage.vue_vue_type_style_index_0_lang-4829f838.js";const D={class:"section-content"},O={class:"container"},z={class:"section-content"},I={class:"container"},N={class:"section-content"},S={class:"container"},T={class:"section-content"},V={class:"container"},U={class:"section-content"},H={class:"container"},P={class:"section-content"},j={class:"container"},K=E({__name:"Index",setup(q){const b=d(void 0),M=d(!1),y=d(!1),w=d(!1),C=d(!1),$=d(!1),h=d(!1),k=()=>{b.value=new Date,h.value=!1};return(l,n)=>{const B=g("router-link"),v=g("SshPre");return m(),f(L,{title:l.$t("ui.confirmationModal.title"),class:"demo"},{toolbar:i(()=>[a(B,{to:{name:"ui"},class:"back"},{default:i(()=>[e(r(l.$t("common.back")),1)]),_:1})]),default:i(()=>[e(),o("section",null,[o("h2",null,r(l.$t("ui.confirmationModal.usage.basic")),1),e(),o("div",D,[a(v,{language:"html-vue"},{default:i(()=>[e(`
          <template>
            <div>
              <ButtonElement
                label="Confirm"
          ...
          <\/script>
        `,1)]),_:1}),e(),o("div",O,[a(s(u),{label:l.$t("ui.confirmationModal.buttonLabel.confirm"),severity:"success",onClick:n[0]||(n[0]=t=>h.value=!0)},null,8,["label"]),e(),o("span",null,r(b.value),1)]),e(),h.value?(m(),f(s(c),{key:0,"onOn:close":n[1]||(n[1]=t=>h.value=!1),"onOn:confirm":n[2]||(n[2]=t=>k())})):p("",!0)])]),e(),o("section",null,[o("h2",null,r(l.$t("ui.confirmationModal.usage.withDivider")),1),e(),o("div",z,[a(v,{language:"html-vue"},{default:i(()=>[e(`
          <template>
            <div>
              <ButtonElement
                label="Confirm"
        ...
        `)]),_:1}),e(),o("div",I,[a(s(u),{label:l.$t("ui.confirmationModal.buttonLabel.confirm"),severity:"success",onClick:n[3]||(n[3]=t=>M.value=!0)},null,8,["label"])]),e(),M.value?(m(),f(s(c),{key:0,divider:"","onOn:close":n[4]||(n[4]=t=>M.value=!1),"onOn:confirm":n[5]||(n[5]=t=>M.value=!1)})):p("",!0)])]),e(),o("section",null,[o("h2",null,r(l.$t("ui.confirmationModal.usage.disableHeader")),1),e(),o("div",N,[a(v,{language:"html-vue"},{default:i(()=>[e(`
          ...
          <script setup lang="ts">
            ...
            const showModal = ref(false);
          <\/script>
        `)]),_:1}),e(),o("div",S,[a(s(u),{label:l.$t("ui.confirmationModal.buttonLabel.confirm"),severity:"success",onClick:n[6]||(n[6]=t=>C.value=!0)},null,8,["label"])]),e(),C.value?(m(),f(s(c),{key:0,"disable-header":"","onOn:close":n[7]||(n[7]=t=>C.value=!1),"onOn:confirm":n[8]||(n[8]=t=>C.value=!1)})):p("",!0)])]),e(),o("section",null,[o("h2",null,r(l.$t("ui.confirmationModal.usage.disableBody")),1),e(),o("div",T,[a(v,{language:"html-vue"},{default:i(()=>[e(`
          <template>
            <div>
              <ButtonElement
                label="Confirm"
