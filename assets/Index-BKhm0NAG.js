import{d as r,s as d,j as g,o as m,w as o,C as t,e as n,t as i,g as l,u as s,a3 as p,D as c}from"./index-CVjUtB44.js";import{_ as v}from"./UiPage.vue_vue_type_style_index_0_lang-Sn8JrzpY.js";const h={class:"section-content"},f={class:"section-content"},T={class:"trigger"},b={class:"section-content"},_={class:"trigger"},$={class:"section-content"},y={class:"trigger"},k={class:"section-content"},z={class:"trigger"},B={class:"section-content"},C={class:"trigger"},w={class:"section-content"},D={class:"trigger"},P=r({__name:"Index",setup(N){return(e,u)=>{const a=d("SshPre");return m(),g(v,{title:e.$t("ui.tooltip.title"),class:"demo"},{toolbar:o(()=>[l(s(c),{label:e.$t("common.back"),"icon-left":"pi pi-chevron-left",size:"medium",variant:"textOnly",onClick:u[0]||(u[0]=S=>e.$router.push("/ui"))},null,8,["label"])]),default:o(()=>[t(),n("section",null,[n("h2",null,i(e.$t("ui.tooltip.usage.basic")),1),t(),n("div",h,[l(s(p),null,{content:o(()=>[t(i(e.$t("ui.tooltip.content")),1)]),default:o(()=>[l(s(c),{label:e.$t("ui.tooltip.label.button"),severity:"success"},null,8,["label"]),t()]),_:1}),t(),l(a,{language:"html-vue"},{default:o(()=>[t(`
          <template>
            <Tooltip>
              <ButtonElement
                :label="Tooltip"
