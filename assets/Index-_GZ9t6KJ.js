import{k as d,h as b}from"./PrefabsTechVue3Form.es-B7qvGqkM.js";import{d as T,I as h,L as D,M as y,r as f,J as x,e as F,o as S,i as u,f as o,B as e,h as p,t as m,u as n}from"./index-DaYJGkw_.js";import{_ as q}from"./ComponentDocumentation.vue_vue_type_script_setup_true_lang-CyCu9kMA.js";import{_ as M}from"./FormPage.vue_vue_type_style_index_0_lang-CHkJVneL.js";import"./PrefabsTechVue3TanstackTable.es-2_xllr28.js";const E={class:"section-content"},w={class:"section-content"},U={class:"section-content"},z={class:"section-content"},O={class:"section-content"},B={class:"section-content"},k={class:"section-content"},L={name:"TextInputField"},Z=T({...L,setup(P){const{t:s}=h(),v=[{description:s("form.documentation.eventDescription.input.modelValue"),name:"update:modelValue",payload:"string | null | undefined"}],I=D.string().length(5,{message:s("form.errors.input.length",{length:5})}),V=[{default:"false",description:s("form.documentation.propsDescription.input.disabled"),prop:"disabled",type:"Boolean"},{default:'{ invalid: "Please provide a valid input data", required: "The field is required", }',description:s("form.documentation.propsDescription.input.errorMessages"),prop:"errorMessages",type:"TextErrorMessages"},{default:"-",description:s("form.documentation.propsDescription.input.label"),prop:"label",type:"String"},{default:"-",description:s("form.documentation.propsDescription.input.modelValue"),prop:"modelValue",type:"String | null | undefined"},{default:'"text_input"',description:s("form.documentation.propsDescription.input.name"),prop:"name",type:"String"},{default:"-",description:s("form.documentation.propsDescription.input.options"),prop:"options",type:"Object"},{default:"-",description:s("form.documentation.propsDescription.input.placeholder"),prop:"placeholder",type:"String"},{default:"-",description:s("form.documentation.propsDescription.input.schema"),prop:"schema",type:"z.ZodType<string | number | object>"}],$={required:s("form.errors.input.required")},g={ignore_whitespace:!0,required:!0};let i=y({customValidationInput:f(),disabled:f("dzangolab"),input:f(),inputWithValidation:f(),noLabelInput:f(),textInput:f()});return(l,t)=>{const a=x("SshPre");return S(),F(M,{subtitle:n(s)("form.subtitle.text"),title:l.$t("form.label.textInput"),class:"demo"},{default:u(()=>[o("section",null,[o("h2",null,m(l.$t("form.label.basicInput")),1),t[9]||(t[9]=e()),o("div",E,[p(n(d),{modelValue:n(i).noLabelInput,"onUpdate:modelValue":t[0]||(t[0]=r=>n(i).noLabelInput=r),placeholder:l.$t("form.placeholder.input")},null,8,["modelValue","placeholder"]),t[8]||(t[8]=e()),p(a,{language:"html-vue"},{default:u(()=>t[7]||(t[7]=[e(`
          ...
          <\/script>
        `)])),_:1})])]),t[29]||(t[29]=e()),o("section",null,[o("h2",null,m(l.$t("form.label.labelInput")),1),t[12]||(t[12]=e()),o("div",w,[p(n(d),{modelValue:n(i).input,"onUpdate:modelValue":t[1]||(t[1]=r=>n(i).input=r),label:l.$t("form.label.textInput"),placeholder:l.$t("form.placeholder.textInput")},null,8,["modelValue","label","placeholder"]),t[11]||(t[11]=e()),p(a,{language:"html-vue"},{default:u(()=>t[10]||(t[10]=[e(`
          <template>
            <TextInput 
              v-model="input"
              label="Input"
