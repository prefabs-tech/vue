import{P as r}from"./DzangolabVue3Form.es-wFi6zzsC.js";import{d as a,y as u,l as d,o as g,p as s,C as t,e as n,t as m,g as o,u as i,D as f}from"./index-C0L6_lhn.js";import{_ as b}from"./FormPage.vue_vue_type_style_index_0_lang-vsJ3lGt1.js";const z={class:"section-content"},v={class:"section-content"},F={class:"section-content"},I={class:"section-content"},$={class:"section-content"},w={class:"section-content"},C={name:"FileInputDemo"},B=a({...C,setup(S){return(l,e)=>{const p=u("SshPre");return g(),d(b,{title:l.$t("form.label.fileInput"),class:"demo"},{toolbar:s(()=>[o(i(f),{label:l.$t("common.back"),"icon-left":"pi pi-chevron-left",size:"medium",variant:"textOnly",onClick:e[0]||(e[0]=y=>l.$router.push("/form"))},null,8,["label"])]),default:s(()=>[e[19]||(e[19]=t()),n("section",null,[n("h2",null,m(l.$t("form.label.basicInput")),1),e[3]||(e[3]=t()),n("div",z,[o(i(r)),e[2]||(e[2]=t()),o(p,{language:"html-vue"},{default:s(()=>e[1]||(e[1]=[t(`
          <template>
            <FileInput />
          </template>
