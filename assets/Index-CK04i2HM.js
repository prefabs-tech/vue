import{_ as p,F as g}from"./DzangolabVue3Form.es-BEwcchFt.js";import{d as v,A as I,B as V,C as $,r as d,z as w,e as z,o as y,w as m,D as e,f as o,t as i,i as a,u as n,j as U}from"./index-BptziAgc.js";import{_ as F}from"./FormPage.vue_vue_type_style_index_0_lang-zjPpPf3A.js";const S={class:"section-content"},C={class:"section-content"},E={class:"section-content"},T={class:"section-content"},W={class:"section-content"},k={class:"section-content"},B={name:"InputField"},j=v({...B,setup(D){const{t:f}=I(),b=V.string().min(3,{message:f("form.errors.input.min",{length:3})});let s=$({disabled:d("monorepo@gmail.com"),input:d(),inputWithValidation:d(),noLabelInput:d(),passwordInput:d()});return(t,l)=>{const u=w("SshPre");return y(),z(F,{title:t.$t("form.label.input"),class:"demo"},{toolbar:m(()=>[a(n(U),{label:t.$t("common.back"),"icon-left":"pi pi-chevron-left",size:"medium",variant:"textOnly",onClick:l[0]||(l[0]=r=>t.$router.push("/form"))},null,8,["label"])]),default:m(()=>[l[25]||(l[25]=e()),o("section",null,[o("h2",null,i(t.$t("form.label.basicInput")),1),l[9]||(l[9]=e()),o("div",S,[a(n(p),{modelValue:n(s).noLabelInput,"onUpdate:modelValue":l[1]||(l[1]=r=>n(s).noLabelInput=r),placeholder:t.$t("form.placeholder.username"),type:"text"},null,8,["modelValue","placeholder"]),l[8]||(l[8]=e()),a(u,{language:"html-vue"},{default:m(()=>l[7]||(l[7]=[e(`
          <template>
            <Input 
              v-model="username"
