import{m as E,G as u,Z as p}from"./DzangolabVue3Form.es-0701fb76.js";import{d as V,a4 as z,l as I,j as c,G as g,o as $,c as F,w as t,K as a,C as e,S as r,f as n,D as l}from"./index-c6712957-bca2c2d1.js";import{_ as w}from"./FormPage.vue_vue_type_style_index_0_lang-00be1a58.js";import"./index-df8ece6b.js";const y={class:"section-content"},O={class:"section-content"},S={class:"section-content"},U={class:"section-content"},k={class:"section-content"},q={class:"section-content"},M={class:"section-content"},C={name:"EmailInputField"},L=V({...C,setup(P){const{t:f}=z(),h=E.string().email({message:f("form.errors.email.invalid")}),v={required:f("form.errors.input.required"),invalid:f("form.errors.email.invalid",{list:"(dzangolab.com, dzango.com, gmail.com)"})},b={allow_display_name:!1,allow_utf8_local_part:!0,host_whitelist:["dzangolab.com","dzango.com","gmail.com"],require_display_name:!1};let i=I({customValidationInput:c(),disabled:c("monorepo@dzangolab.com"),input:c(),inputWithValidation:c(),noLabelInput:c(),textInput:c()});return(o,m)=>{const _=g("router-link"),d=g("SshPre");return $(),F(w,{title:o.$t("form.label.email"),class:"demo"},{toolbar:t(()=>[a(_,{to:{name:"form"},class:"back"},{default:t(()=>[e(r(o.$t("common.back")),1)]),_:1})]),default:t(()=>[e(),n("section",null,[n("h2",null,r(o.$t("form.label.basicInput")),1),e(),n("div",y,[a(d,{language:"html-vue"},{default:t(()=>[e(`
          <Form>
            <Email 
              v-model="input"
        ...
        `)]),_:1}),e(),a(l(p),null,{default:t(()=>[a(l(u),{modelValue:l(i).noLabelInput,"onUpdate:modelValue":m[0]||(m[0]=s=>l(i).noLabelInput=s),placeholder:o.$t("form.placeholder.email")},null,8,["modelValue","placeholder"])]),_:1})])]),e(),n("section",null,[n("h2",null,r(o.$t("form.label.labelInput")),1),e(),n("div",O,[a(d,{language:"html-vue"},{default:t(()=>[e(`
          ...
          import { Email } from "@dzangolab/vue3-form";
          <\/script>
        `)]),_:1}),e(),a(l(p),null,{default:t(()=>[a(l(u),{modelValue:l(i).input,"onUpdate:modelValue":m[1]||(m[1]=s=>l(i).input=s),label:o.$t("form.label.email"),placeholder:o.$t("form.placeholder.email")},null,8,["modelValue","label","placeholder"])]),_:1})])]),e(),n("section",null,[n("h2",null,r(o.$t("form.label.disabled")),1),e(),n("div",S,[a(d,{language:"html-vue"},{default:t(()=>[e(`
          <Form>
            <Email 
              v-model="input"
              label="Email"
          ...
          <\/script>
        `)]),_:1}),e(),a(l(p),null,{default:t(()=>[a(l(u),{modelValue:l(i).disabled,"onUpdate:modelValue":m[2]||(m[2]=s=>l(i).disabled=s),label:o.$t("form.label.email"),disabled:""},null,8,["modelValue","label"])]),_:1})])]),e(),n("section",null,[n("h2",null,r(o.$t("form.label.withI18n")),1),e(),n("div",U,[a(d,{language:"html-vue"},{default:t(()=>[e(`
          <Form>
            <Email 
              v-model="input"
