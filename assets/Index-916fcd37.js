import{d as p,j as d,J as m,o as f,c as _,w as a,K as t,W as e,L as o,f as s,D as i,aB as u}from"./index-35228b09-5de2cbe6.js";import{_ as h}from"./UiPage.vue_vue_type_style_index_0_lang-06678aad.js";const v={class:"section-content"},b={class:"section-content"},$={class:"section-content"},M=s("i",{class:"fa-regular fa-bell"},null,-1),k={class:"section-content"},w={class:"section-content"},y=p({__name:"Index",setup(C){const g=d(!0);return(n,c)=>{const r=m("router-link"),l=m("SshPre");return f(),_(h,{title:n.$t("ui.message.title"),class:"demo-message"},{toolbar:a(()=>[t(r,{to:{name:"ui"},class:"back"},{default:a(()=>[e(o(n.$t("common.back")),1)]),_:1})]),default:a(()=>[e(),s("section",null,[s("h2",null,o(n.$t("ui.message.usage.basic")),1),e(),s("div",v,[t(i(u),{message:n.$t("ui.message.contents.content1")},null,8,["message"]),e(),t(l,{language:"html-vue"},{default:a(()=>[e(`
          <template>
        ...
        `)]),_:1}),e()])]),e(),s("section",null,[s("h2",null,o(n.$t("ui.message.usage.icons.iconSlot")),1),e(),s("div",$,[t(i(u),{message:n.$t("ui.message.contents.content3")},{icon:a(()=>[M]),_:1},8,["message"]),e(),t(l,{language:"html-vue"},{default:a(()=>[e(`
          ...
          <script setup lang="ts">
            import { Message } from "@dzangolab/vue3-ui";
          <\/script>
        `)]),_:1}),e()])]),e(),s("section",null,[s("h2",null,o(n.$t("ui.message.usage.enableClose")),1),e(),s("div",k,[t(i(u),{message:n.$t("ui.message.contents.content4"),icon:"pi pi-comments","enable-close":"",onClose:c[0]||(c[0]=S=>g.value=!1)},null,8,["message"]),e(),t(l,{language:"html-vue"},{default:a(()=>[e(`
          <template>
            <Message
              icon="pi pi-comments"
