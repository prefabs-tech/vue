import{w as y,a as R}from"./PrefabsTechVue3Form.es-brkzzdHc.js";import{d as F,I as A,a7 as E,r as x,M as T,J as z,e as L,o as U,i as r,f as n,B as t,h as s,t as p,u as i,a8 as v,q as f,a4 as q}from"./index-BeDuccrR.js";import{_ as J}from"./ComponentDocumentation.vue_vue_type_script_setup_true_lang-D7pOSX5C.js";import{_ as M}from"./UiPage.vue_vue_type_style_index_0_lang-Bz8AnNmI.js";import"./PrefabsTechVue3TanstackTable.es-CHCWj_8W.js";const j={class:"section-content"},G={class:"section-content"},H={class:"section-content"},K={class:"section-content"},O={class:"demo-stepper-content-wrapper"},Q={class:"demo-stepper-buttons-wrapper"},W={class:"section-content"},X={class:"demo-stepper-wrapper"},Y={class:"demo-stepper-content-actions"},Z={class:"demo-stepper-content-wrapper"},_={class:"demo-stepper-buttons-wrapper"},re=F({__name:"Index",setup(ee){const{t:l}=A(),I=E(),a=x(0),u=x(0),d=T({name:null,phone:null,price:"$50"}),C=[{description:l("ui.stepper.documentation.eventDescription.complete"),name:"complete",payload:"-"},{description:l("ui.stepper.documentation.eventDescription.updateActiveIndex"),name:"update:activeIndex",payload:"activeIndex: number"}],P=[{label:"Personal"},{label:"Children"},{label:"Payment"},{label:"Confirmation"}],h={iconRight:"pi pi-chevron-right",label:"Next",severity:"primary",variant:"filled"},S={iconLeft:"pi pi-chevron-left",label:"Back",severity:"secondary",variant:"filled"},$=[{default:"-",description:l("ui.stepper.documentation.propsDescription.activeIndex"),prop:"activeIndex",type:"Number"},{default:"start",description:l("ui.stepper.documentation.propsDescription.start"),prop:"align",type:"start | center | end"},{default:"horizontal",description:l("ui.stepper.documentation.propsDescription.direction"),prop:"direction",type:"horizontal | vertical"},{default:"false",description:l("ui.stepper.documentation.propsDescription.hideButtons"),prop:"hideButtons",type:"Boolean"},{default:"-",description:l("ui.stepper.documentation.propsDescription.nextButton"),prop:"nextButtonProperties",type:"ActionButtonProperties"},{default:"-",description:l("ui.stepper.documentation.propsDescription.previousButton"),prop:"previousButtonProperties",type:"ActionButtonProperties"},{default:"-",description:l("ui.stepper.documentation.propsDescription.steps"),prop:"steps",type:"Array<StepProperties>"}],B=[{description:l("ui.stepper.documentation.slotDescription.step"),name:"{step}"}],b=[{content:"Please enter your personal details",label:"Personal",step:1,subtitle:"Personal information"},{content:"Please enter your contact details",label:"Contact",step:2,subtitle:"Contact information"},{content:"Please enter your payment details",label:"Payment",step:3,subtitle:"Payment information"},{content:"Confirm your details",label:"Confirmation",step:4,subtitle:"Confirm your details"}],D=()=>{I.push({name:"ui"})},w=()=>{a.value<P.length-1&&a.value++},N=()=>{a.value>0&&a.value--},V=()=>{u.value<P.length-1&&u.value++},k=()=>{u.value>0&&u.value--},g=o=>{switch(o){case 0:return"Personal details";case 1:return"Family details";case 2:return"Payment details";case 3:return"Confirm submit"}};return(o,e)=>{const m=z("SshPre");return U(),L(M,{subtitle:o.$t("ui.stepper.subtitle"),title:o.$t("ui.stepper.title"),class:"demo-stepper"},{default:r(()=>[n("section",null,[n("h2",null,p(o.$t("ui.stepper.usage.basic")),1),e[5]||(e[5]=t()),n("div",j,[s(i(v),{steps:b,onComplete:D}),e[4]||(e[4]=t()),s(m,{language:"html-vue"},{default:r(()=>e[3]||(e[3]=[t(`
          <template>
