import{d as u,r as d,o as p,c as m,w as a,a as t,t as s,f as e,g as o,h as i,a6 as r}from"./index-0cbafccc.js";const h={class:"section-content"},_={class:"content"},f={class:"section-content"},g={class:"content"},v={class:"section-content"},C={class:"content"},$={class:"section-content"},b={class:"title"},y={class:"content"},z={class:"footer"},I={class:"section-content"},w={class:"title"},P={class:"content"},S={class:"footer"},V=u({__name:"Index",setup(B){return(n,L)=>{const l=d("SshPre"),c=d("Page");return p(),m(c,{title:n.$t("ui.card.title"),class:"demo"},{default:a(()=>[t("section",null,[t("h2",null,s(n.$t("ui.card.usage.basic")),1),e(),t("div",h,[o(l,{language:"html-vue"},{default:a(()=>[e(`
          <template>
            <Card>
              <p>
                ...
