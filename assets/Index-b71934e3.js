import{d as _,a7 as p,j as l,K as u,o as c,c as b,w as a,L as r,C as t,M as o,f as n,E as g,aE as L,a as h,g as k}from"./index-4dbfb8c7-0110dc13.js";import{_ as y}from"./UiPage.vue_vue_type_style_index_0_lang-c2c19b74.js";const S={class:"section-content"},$={key:0,class:"most-favourite"},N=_({__name:"Index",setup(B){const{t:s}=p(),m=l([{id:1,data:s("ui.sortableList.games.basketball")},{id:2,data:s("ui.sortableList.games.cricket")},{id:3,data:s("ui.sortableList.games.football")},{id:4,data:s("ui.sortableList.games.hockey")},{id:5,data:s("ui.sortableList.games.volleyball")}]),i=l(),d=e=>{i.value=e[0].data};return(e,C)=>{const v=u("router-link"),f=u("SshPre");return c(),b(y,{title:e.$t("ui.sortableList.title"),class:"demo-sortable-list"},{toolbar:a(()=>[r(v,{to:{name:"ui"},class:"back"},{default:a(()=>[t(o(e.$t("common.back")),1)]),_:1})]),default:a(()=>[t(),n("section",null,[n("h2",null,o(e.$t("ui.sortableList.usage.basic")),1),t(),n("div",S,[n("h3",null,o(e.$t("ui.sortableList.usage.sortSport")),1),t(),r(g(L),{list:m.value,onOnDrag:d},null,8,["list"]),t(),i.value?(c(),h("div",$,o(e.$t("ui.sortableList.games.favourite",{sport:i.value})),1)):k("",!0),t(),r(f,{language:"html-vue"},{default:a(()=>[t(`
          <template>
