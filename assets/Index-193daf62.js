import{d as r,G as u,o as d,c as g,w as n,K as l,C as t,S as i,f as o,D as s,ao as m,az as p}from"./index-d658739c-0fec2303.js";import{_ as h}from"./UiPage.vue_vue_type_style_index_0_lang-fbdc470f.js";const v={class:"section-content"},_={class:"section-content"},f={class:"trigger"},T={class:"section-content"},b={class:"trigger"},$={class:"section-content"},y={class:"trigger"},k={class:"section-content"},z={class:"trigger"},B={class:"section-content"},C={class:"trigger"},S={class:"section-content"},w={class:"trigger"},I=r({__name:"Index",setup(D){return(e,N)=>{const c=u("router-link"),a=u("SshPre");return d(),g(h,{title:e.$t("ui.tooltip.title"),class:"demo"},{toolbar:n(()=>[l(c,{to:{name:"ui"},class:"back"},{default:n(()=>[t(i(e.$t("common.back")),1)]),_:1})]),default:n(()=>[t(),o("section",null,[o("h2",null,i(e.$t("ui.tooltip.usage.basic")),1),t(),o("div",v,[l(a,{language:"html-vue"},{default:n(()=>[t(`
          <template>
            <Tooltip>
              <ButtonElement
                :label="Tooltip"
