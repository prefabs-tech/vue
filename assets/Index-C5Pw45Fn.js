import{w as d,b as V}from"./PrefabsTechVue3Form.es-BveMBhI2.js";import{d as I,M as k,O as h,N as O,o as c,e as $,f as u,h as t,t as b,A as n,a as o,u as l,l as R,P as S,r as m}from"./index-B9ZmqYta.js";import{_ as w}from"./FormPage.vue_vue_type_style_index_0_lang-vSBkflfy.js";const z={class:"section-content"},B={class:"section-content"},F={class:"section-content"},P={class:"section-content"},q={name:"RadioInput"},W=I({...q,setup(y){const{t:i}=k(),g=h.string({required_error:i("form.errors.radio.required")}).nonempty({message:i("form.errors.radio.required")});let r=S({disabled:m("car"),i18nInput:m(),input:m(),inputWithValidation:m(),noLabelInput:m()});const f=[{label:i("form.label.male"),value:"male"},{label:i("form.label.female"),value:"female"}],v=[{label:i("form.label.bike"),value:"bike"},{label:i("form.label.car"),value:"car"},{label:i("form.label.truck"),value:"truck"}];return(a,e)=>{const p=O("SshPre");return c(),$(w,{title:a.$t("form.label.radio"),class:"demo"},{default:u(()=>[t("section",null,[t("h2",null,b(a.$t("form.label.basicInput")),1),e[6]||(e[6]=n()),t("div",z,[o(l(d),{modelValue:l(r).input,"onUpdate:modelValue":e[0]||(e[0]=s=>l(r).input=s),label:a.$t("form.label.gender"),options:f,direction:"horizontal",name:"label-input"},null,8,["modelValue","label"]),e[5]||(e[5]=n()),o(p,{language:"html-vue"},{default:u(()=>[...e[4]||(e[4]=[n(`
        ...
        `,-1)])]),_:1})])]),e[18]||(e[18]=n()),t("section",null,[t("h2",null,b(a.$t("form.label.withI18n")),1),e[12]||(e[12]=n()),t("div",F,[o(l(d),{modelValue:l(r).i18nInput,"onUpdate:modelValue":e[2]||(e[2]=s=>l(r).i18nInput=s),label:a.$t("form.label.vehicle"),options:v,direction:"horizontal",name:"i18n-input"},null,8,["modelValue","label"]),e[11]||(e[11]=n()),o(p,{language:"html-vue"},{default:u(()=>[...e[10]||(e[10]=[n(`
          ...
          <\/script>
        `,-1)])]),_:1})])]),e[19]||(e[19]=n()),t("section",null,[t("h2",null,b(a.$t("form.label.inputWithValidation")),1),e[16]||(e[16]=n()),t("div",P,[o(l(V),null,{default:u(()=>[o(l(d),{modelValue:l(r).inputWithValidation,"onUpdate:modelValue":e[3]||(e[3]=s=>l(r).inputWithValidation=s),label:a.$t("form.label.gender"),options:f,schema:l(g),name:"gender"},null,8,["modelValue","label","schema"]),e[13]||(e[13]=n()),o(l(R),{label:l(i)("form.label.submit")},null,8,["label"])]),_:1}),e[15]||(e[15]=n()),o(p,{language:"html-vue"},{default:u(()=>[...e[14]||(e[14]=[n(`
          <template>
            <Form>
              <RadioInput 
                v-model="input"
