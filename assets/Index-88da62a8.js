import{d as _,e as p,r as s,o as l,c as i,w as r,a as e,t as f,f as t,g as c,h as u,a5 as v,a9 as b,E as h}from"./index-fdd64217.js";const k={class:"section-content"},C={class:"container"},x=_({__name:"Index",setup(L){const n=p(!1),d=()=>{n.value=!0,setTimeout(()=>{n.value=!1},5e3)};return(a,o)=>{const g=s("SshPre"),m=s("Page");return l(),i(m,{title:a.$t("ui.loading.title"),class:"demo-loading"},{default:r(()=>[e("section",null,[e("h2",null,f(a.$t("ui.loading.usage.basic")),1),t(),e("div",k,[c(g,{language:"html-vue"},{default:r(()=>[t(`
          <template>
