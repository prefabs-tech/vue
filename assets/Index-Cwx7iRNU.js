import{d as g,J as f,e as v,o as b,i as e,C as o,f as n,g as s,t as l,u as p,D as u,v as a}from"./index-DzMrXnDW.js";import{_ as T}from"./ComponentDocumentation.vue_vue_type_script_setup_true_lang-BXLRfTno.js";import{_ as $}from"./UiPage.vue_vue_type_style_index_0_lang-kf6Qk5nk.js";import"./PrefabsTechVue3TanstackTable.es-3gCIUIE2.js";import"./PrefabsTechVue3Form.es-CexM7XFj.js";const y={class:"section-content"},k={class:"section-content"},B={class:"trigger"},C={class:"section-content"},D={class:"trigger"},S={class:"section-content"},N={class:"trigger"},P={class:"section-content"},w={class:"trigger"},V={class:"section-content"},E={class:"trigger"},L={class:"section-content"},z={class:"trigger"},F=g({__name:"Index",setup(I){const d=[{default:'"tooltip"',description:"The accessible label for the tooltip container.",prop:"ariaLabel",type:"String"},{default:"false",description:"Toggle the tooltip visibility on click.",prop:"clickable",type:"Boolean"},{default:"100",description:"Delay in milliseconds before the tooltip appears on hover.",prop:"delay",type:"Number"},{default:"10",description:"The spacing in pixels between the trigger and the tooltip.",prop:"offset",type:"Number"},{default:"-",description:"Supported position of the tooltip relative to the trigger.",prop:"position",type:'"top" | "bottom" | "left" | "right"'}],m=[{description:"The default slot used as the tooltip trigger element.",name:"default"},{description:"Slot used for the tooltip content that is displayed on hover or click.",name:"content"}];return(i,t)=>{const r=f("SshPre");return b(),v($,{"sub-title":i.$t("ui.tooltip.subtitle"),title:i.$t("ui.tooltip.title"),class:"demo"},{toolbar:e(()=>[s(p(a),{label:i.$t("common.back"),"icon-left":"pi pi-chevron-left",size:"medium",variant:"textOnly",onClick:t[0]||(t[0]=J=>i.$router.push("/ui"))},null,8,["label"])]),default:e(()=>[t[29]||(t[29]=o()),n("section",null,[n("h2",null,l(i.$t("ui.tooltip.usage.basic")),1),t[4]||(t[4]=o()),n("div",y,[s(p(u),null,{content:e(()=>[o(l(i.$t("ui.tooltip.content")),1)]),default:e(()=>[s(p(a),{label:i.$t("ui.tooltip.label.button"),severity:"success"},null,8,["label"]),t[1]||(t[1]=o())]),_:1}),t[3]||(t[3]=o()),s(r,{language:"html-vue"},{default:e(()=>t[2]||(t[2]=[o(`
          <template>
            <Tooltip>
              <ButtonElement
                :label="Tooltip"
        ...
        `)])),_:1})])]),t[34]||(t[34]=o()),n("section",null,[n("h2",null,l(i.$t("ui.tooltip.usage.clickable")),1),t[24]||(t[24]=o()),n("div",V,[s(p(u),{clickable:""},{content:e(()=>[o(l(i.$t("ui.tooltip.content")),1)]),default:e(()=>[n("div",E,l(i.$t("ui.tooltip.label.button")),1),t[21]||(t[21]=o())]),_:1}),t[23]||(t[23]=o()),s(r,{language:"html-vue"},{default:e(()=>t[22]||(t[22]=[o(`
          ...
          import { Tooltip } from "@prefabs.tech/vue3-ui";
          <\/script>
        `)])),_:1})])]),t[35]||(t[35]=o()),n("section",null,[n("h2",null,l(i.$t("ui.tooltip.usage.delay")),1),t[28]||(t[28]=o()),n("div",L,[s(p(u),{delay:1e3},{content:e(()=>[o(l(i.$t("ui.tooltip.content")),1)]),default:e(()=>[n("div",z,l(i.$t("ui.tooltip.label.delay")),1),t[25]||(t[25]=o())]),_:1}),t[27]||(t[27]=o()),s(r,{language:"html-vue"},{default:e(()=>t[26]||(t[26]=[o(`
          <template>
            <Tooltip :delay="1000">
              <div class="trigger">
                Delay
