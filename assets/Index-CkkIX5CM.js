import{d as f,r as p,s as y,j as B,o as E,w as o,A as e,e as t,t as u,g as n,u as a,B as i,O as _,P as $,_ as z}from"./index-j9ugvOHR.js";import{_ as O}from"./UiPage.vue_vue_type_style_index_0_lang-BeVgrYUm.js";const m=r=>(_("data-v-6abf8185"),r=r(),$(),r),k={class:"section-content"},C={class:"container"},S={class:"section-content"},I={class:"container"},w={class:"section-content"},D={class:"container"},L={class:"section-content"},T={class:"container"},N={class:"section-content"},P={class:"container"},R={class:"section-content"},A={class:"container"},M={class:"section-content"},V={class:"container"},H={class:"section-content"},W={className:"container"},j={class:"section-content"},q={className:"container"},F=m(()=>t("i",{class:"pi pi-user"},null,-1)),G=m(()=>t("i",{class:"pi pi-user"},null,-1)),J=m(()=>t("i",{class:"pi pi-user"},null,-1)),K={class:"section-content"},Q={class:"container"},U={class:"section-content"},X={class:"container"},Y={class:"container"},Z={class:"section-content"},x={class:"container"},ee=f({__name:"Index",setup(r){const b=p(void 0),d=p(!1),v=()=>{b.value=new Date},g=()=>{d.value=!0,setTimeout(()=>{d.value=!1},5e3)};return(l,c)=>{const s=y("SshPre");return E(),B(O,{title:l.$t("ui.button.title"),class:"demo-button"},{toolbar:o(()=>[n(a(i),{label:l.$t("common.back"),"icon-left":"pi pi-chevron-left",size:"medium",variant:"textOnly",onClick:c[0]||(c[0]=h=>l.$router.push("/ui"))},null,8,["label"])]),default:o(()=>[e(),t("section",null,[t("h2",null,u(l.$t("ui.button.usage.basic")),1),e(),t("div",k,[t("div",C,[n(a(i),{label:l.$t("ui.button.label.clickMe"),onClick:c[1]||(c[1]=h=>v())},null,8,["label"]),e(),t("span",null,u(b.value),1)]),e(),n(s,{language:"html-vue"},{default:o(()=>[e(`
          <template> 
      ...
      `)]),_:1}),e()]),e(),t("section",null,[t("h2",null,u(l.$t("ui.button.usage.loading")),1),e(),t("div",w,[t("div",D,[n(a(i),{label:l.$t("ui.button.label.submit"),loading:d.value,onClick:g},null,8,["label","loading"])]),e(),n(s,{language:"html-vue"},{default:o(()=>[e(`
        ...
        `)]),_:1}),e()])]),e(),t("section",null,[t("h2",null,u(l.$t("ui.button.usage.severity")),1),e(),t("div",N,[t("div",P,[n(a(i),{severity:"primary",label:l.$t("ui.button.label.primary")},null,8,["label"]),e(),n(a(i),{severity:"secondary",label:l.$t("ui.button.label.secondary")},null,8,["label"]),e(),n(a(i),{severity:"alternate",label:l.$t("ui.button.label.alternate")},null,8,["label"]),e(),n(a(i),{severity:"success",label:l.$t("ui.button.label.success")},null,8,["label"]),e(),n(a(i),{severity:"danger",label:l.$t("ui.button.label.danger")},null,8,["label"]),e(),n(a(i),{severity:"warning",label:l.$t("ui.button.label.warning")},null,8,["label"])]),e(),n(s,{language:"html-vue"},{default:o(()=>[e(`
          ...
          <script setup lang="ts"> 
            import { ButtonElement } from "@dzangolab/vue3-ui"; 
          <\/script>
        `)]),_:1}),e()])]),e(),t("section",null,[t("h2",null,u(l.$t("ui.button.usage.size")),1),e(),t("div",R,[t("div",A,[n(a(i),{size:"small",label:l.$t("ui.button.label.small")},null,8,["label"]),e(),n(a(i),{size:"medium",label:l.$t("ui.button.label.medium")},null,8,["label"]),e(),n(a(i),{size:"large",label:l.$t("ui.button.label.large")},null,8,["label"])]),e(),n(s,{language:"html-vue"},{default:o(()=>[e(`
          <template> 
          ...
          <script setup lang="ts"> 
            import { ButtonElement } from "@dzangolab/vue3-ui"; 
          <\/script>
        `)]),_:1}),e()])]),e(),t("section",null,[t("h2",null,u(l.$t("ui.button.usage.variant")),1),e(),t("div",M,[t("div",V,[n(a(i),{size:"medium",label:l.$t("ui.button.label.textOnly"),variant:"textOnly"},null,8,["label"]),e(),n(a(i),{size:"medium",label:l.$t("ui.button.label.outlined"),variant:"outlined"},null,8,["label"]),e(),n(a(i),{size:"medium",label:l.$t("ui.button.label.default")},null,8,["label"])]),e(),n(s,{language:"html-vue"},{default:o(()=>[e(`
          <template> 
