import{U as f,F as w}from"./DzangolabVue3Form.es-W8oNrDMf.js";import{d as h,z as y,A as v,B as A,r as g,y as c,l as D,o as L,p as s,C as l,e as o,t as p,g as t,u as n,D as T}from"./index-DjJ-FZ_G.js";import{_ as I}from"./FormPage.vue_vue_type_style_index_0_lang-D1J0UkCG.js";const V={class:"section-content"},$={class:"section-content"},S={class:"section-content"},C={class:"section-content"},k={class:"section-content"},P={class:"section-content"},O={name:"InputField"},z=h({...O,setup(q){const{t:m}=y(),b=v.string().min(3,{message:m("form.errors.input.min",{length:3})}),u=[{value:"Roslabel",label:"Roslabel - A fragrant flower often associated with romance"},{value:"Tulip",label:"Tulip - A bright, cup-shaped flower popular in spring"},{value:"Daisy",label:"Daisy - A simple, white flower with a yellow center"},{value:"Sunflower",label:"Sunflower - A tall plant with a large, yellow flower head"},{value:"Lily",label:"Lily - An elegant flower often used in bouquets"},{value:"Orchid",label:"Orchid - An exotic flower with a unique shape"},{value:"Marigold",label:"Marigold - A vibrant, orange or yellow flower"},{value:"Lavender",label:"Lavender - A fragrant flower known for its calming scent"},{value:"Peony",label:"Peony - A lush, full flower often used in weddings"},{value:"Chrysanthemum",label:"Chrysanthemum - A hardy flower with a variety of colors"},{value:"Daffodil",label:"Daffodil - A bright, yellow flower that blooms in spring"},{value:"Hydrangea",label:"Hydrangea - A large, cluster-like flower that changes color"}];let r=A({disabled:g("Lily"),input:g(),inputWithValidation:g(),noLabelInput:g()});return(a,e)=>{const d=c("SshPre");return L(),D(I,{title:a.$t("form.label.typeahead"),class:"demo"},{toolbar:s(()=>[t(n(T),{label:a.$t("common.back"),"icon-left":"pi pi-chevron-left",size:"medium",variant:"textOnly",onClick:e[0]||(e[0]=i=>a.$router.push("/form"))},null,8,["label"])]),default:s(()=>[e[25]||(e[25]=l()),o("section",null,[o("h2",null,p(a.$t("form.label.basicInput")),1),e[9]||(e[9]=l()),o("div",V,[t(n(f),{modelValue:n(r).noLabelInput,"onUpdate:modelValue":e[1]||(e[1]=i=>n(r).noLabelInput=i),placeholder:a.$t("form.placeholder.input"),suggestions:u},null,8,["modelValue","placeholder"]),e[8]||(e[8]=l()),t(d,{language:"html-vue"},{default:s(()=>e[7]||(e[7]=[l(`
          <template>
            <Typeahead
              v-model="input"
