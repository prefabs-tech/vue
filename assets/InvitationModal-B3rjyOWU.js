import{d as D,I as h,r as v,L as k,e as P,o as B,j as a,C as t,f as o,t as d,h as l,u as s,v as r,Z as p,Y as R}from"./index-Bs8kt_YR.js";import{_ as A}from"./UserPage.vue_vue_type_style_index_0_lang-CKFvvlGq.js";const C={class:"section-content"},U={class:"section-content"},N={class:"section-content"},O={class:"section-content"},F={class:"section-content"},T={class:"section-content"},V={class:"section-content"},L=D({__name:"InvitationModal",setup(W){const{t:S}=h(),f=v(!1),b=v(!1),w=v(!1),M=v(!1),I=v(!1),y=v(!1),$=v(!1),g=[{id:1,name:"ADMIN"},{id:2,name:"SUPERADMIN"},{id:3,name:"USER"}],E=[{id:1,name:"Admin",origin:"admin-origin",supportedRoles:[{id:1,name:"ADMIN"},{id:2,name:"SUPERADMIN"}]},{id:2,name:"User",origin:"user-origin",supportedRoles:[{id:3,name:"USER"}]}],u=e=>{R(S("user.message.invitation.success",{user:e.email}),{type:"success"}),f.value=!1,b.value=!1,w.value=!1,M.value=!1,I.value=!1,y.value=!1,$.value=!1};return(e,n)=>{const m=k("SshPre");return B(),P(A,{title:e.$t("user.label.invitationModal"),class:"demo-invitation-modal"},{toolbar:a(()=>[l(s(r),{label:e.$t("common.back"),"icon-left":"pi pi-chevron-left",size:"medium",variant:"textOnly",onClick:n[0]||(n[0]=i=>e.$router.push("/user"))},null,8,["label"])]),default:a(()=>[n[43]||(n[43]=t()),o("section",null,[o("h2",null,d(e.$t("user.label.basic")),1),n[18]||(n[18]=t()),o("div",C,[l(s(r),{label:e.$t("user.label.invite"),onClick:n[1]||(n[1]=i=>I.value=!0)},null,8,["label"]),n[16]||(n[16]=t()),l(s(p),{show:I.value,"onOn:close":n[2]||(n[2]=i=>I.value=!1),onSubmit:u},null,8,["show"]),n[17]||(n[17]=t()),l(m,{language:"html-vue"},{default:a(()=>n[15]||(n[15]=[t(`
          <template>
            <ButtonElement
              label="Invite"
        ...
        `)])),_:1})])]),n[44]||(n[44]=t()),o("section",null,[o("h2",null,d(e.$t("user.label.withTitle")),1),n[22]||(n[22]=t()),o("div",U,[l(s(r),{label:e.$t("user.label.send"),onClick:n[3]||(n[3]=i=>$.value=!0)},null,8,["label"]),n[20]||(n[20]=t()),l(s(p),{show:$.value,title:e.$t("user.label.invite"),"onOn:close":n[4]||(n[4]=i=>$.value=!1),onSubmit:u},null,8,["show","title"]),n[21]||(n[21]=t()),l(m,{language:"html-vue"},{default:a(()=>n[19]||(n[19]=[t(`
          ...
          <\/script>
        `)])),_:1})])]),n[45]||(n[45]=t()),o("section",null,[o("h2",null,d(e.$t("user.label.enableDismiss")),1),n[26]||(n[26]=t()),o("div",N,[l(s(r),{label:e.$t("user.label.inviteUser"),onClick:n[5]||(n[5]=i=>b.value=!0)},null,8,["label"]),n[24]||(n[24]=t()),l(s(p),{show:b.value,title:e.$t("user.label.inviteUser"),"dismiss-on-click-out":"","onOn:close":n[6]||(n[6]=i=>b.value=!1),onSubmit:u},null,8,["show","title"]),n[25]||(n[25]=t()),l(m,{language:"html-vue"},{default:a(()=>n[23]||(n[23]=[t(`
          <template>
            <ButtonElement
              label="Invite user"
              @click="showModal = true"
