import{b as d,D as p}from"./DzangolabVue3Form.es-8f62871e.js";import{d as g,a7 as w,p as V,j as c,K as f,o as I,c as S,w as a,L as n,C as l,M as r,f as t,E as e}from"./index-137faed7-96801d87.js";import{m as _}from"./index-bb522753.js";import{_ as $}from"./FormPage.vue_vue_type_style_index_0_lang-fe2434c6.js";const F={class:"section-content"},z={class:"section-content"},k={class:"section-content"},D={class:"section-content"},U={class:"section-content"},C={name:"SwitchInput"},j=g({...C,setup(L){const{t:b}=w(),h=_.coerce.boolean().refine(o=>o===!0,{message:b("form.errors.switch.invalid")});let s=V({disabled:c(!0),input:c(),inputWithValidation:c(!1),noLabelInput:c()});return(o,i)=>{const v=f("router-link"),m=f("SshPre");return I(),S($,{title:o.$t("form.label.switch"),class:"demo"},{toolbar:a(()=>[n(v,{to:{name:"form"},class:"back"},{default:a(()=>[l(r(o.$t("common.back")),1)]),_:1})]),default:a(()=>[l(),t("section",null,[t("h2",null,r(o.$t("form.label.basicInput")),1),l(),t("div",F,[n(m,{language:"html-vue"},{default:a(()=>[l(`
          <Form>
            <SwitchInput
              v-model="input"
            />
