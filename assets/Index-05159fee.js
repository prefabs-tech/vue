import{d as y,e as p,r as v,o as _,c as B,w as o,a as t,t as u,f as e,g as n,h as a,a5 as i,a0 as E,a1 as $,_ as z}from"./index-0cbafccc.js";const d=r=>(E("data-v-acb29bc5"),r=r(),$(),r),O={class:"section-content"},k={class:"container"},S={class:"section-content"},C={class:"container"},I={class:"section-content"},w={class:"container"},D={class:"section-content"},L={class:"container"},T={class:"section-content"},P={class:"container"},N={class:"section-content"},R={class:"container"},M={class:"section-content"},V={class:"container"},A={class:"section-content"},H={className:"container"},W={class:"section-content"},j={className:"container"},q=d(()=>t("i",{class:"pi pi-user"},null,-1)),F=d(()=>t("i",{class:"pi pi-user"},null,-1)),G=d(()=>t("i",{class:"pi pi-user"},null,-1)),J={class:"section-content"},K={class:"container"},Q={class:"section-content"},U={class:"container"},X={class:"container"},Y={class:"section-content"},Z={class:"container"},x=y({__name:"Index",setup(r){const m=p(void 0),c=p(!1),g=()=>{m.value=new Date},h=()=>{c.value=!0,setTimeout(()=>{c.value=!1},5e3)};return(l,b)=>{const s=v("SshPre"),f=v("Page");return _(),B(f,{title:l.$t("ui.button.title"),class:"demo-button"},{default:o(()=>[t("section",null,[t("h2",null,u(l.$t("ui.button.usage.basic")),1),e(),t("div",O,[n(s,{language:"html-vue"},{default:o(()=>[e(`
          <template> 
        ...
        `)]),_:1}),e(),t("div",H,[n(a(i),{variant:"textOnly",severity:"secondary","icon-left":"pi pi-user"}),e(),n(a(i),{variant:"outlined",severity:"secondary","icon-left":"pi pi-user"}),e(),n(a(i),{variant:"filled","icon-left":"pi pi-user"})])])]),e(),t("section",null,[t("h2",null,u(l.$t("ui.button.usage.icons.iconElement")),1),e(),t("div",W,[n(s,{language:"html-vue"},{default:o(()=>[e(`
          ...
          <script setup lang="ts"> 
            import { ButtonElement } from "@dzangolab/vue3-ui"; 
          <\/script>
        `)]),_:1}),e(),t("div",j,[n(a(i),{variant:"textOnly",severity:"secondary","icon-left":"true",rounded:""},{iconLeft:o(()=>[q]),_:1}),e(),n(a(i),{severity:"secondary",variant:"outlined","icon-right":"true",rounded:""},{iconRight:o(()=>[F]),_:1}),e(),n(a(i),{"icon-right":"true",variant:"filled",rounded:""},{iconRight:o(()=>[G]),_:1})])])]),e(),t("section",null,[t("h2",null,u(l.$t("ui.button.usage.icons.iconPackage")),1),e(),t("div",J,[n(s,{language:"html-vue"},{default:o(()=>[e(`
          <template> 
            <ButtonElement
              label="Home"
        ...
        `)]),_:1}),e(),t("div",U,[n(a(i),{label:l.$t("ui.button.label.textOnly"),"icon-left":"pi pi-user",variant:"textOnly"},null,8,["label"]),e(),n(a(i),{label:l.$t("ui.button.label.outlined"),"icon-left":"pi pi-user",variant:"outlined"},null,8,["label"]),e(),n(a(i),{label:l.$t("ui.button.label.default"),"icon-left":"pi pi-user",variant:"filled"},null,8,["label"])]),e(),t("div",X,[n(a(i),{label:l.$t("ui.button.label.textOnly"),"icon-right":"pi pi-user",rounded:"",variant:"textOnly"},null,8,["label"]),e(),n(a(i),{label:l.$t("ui.button.label.outlined"),"icon-right":"pi pi-user",rounded:"",variant:"outlined"},null,8,["label"]),e(),n(a(i),{label:l.$t("ui.button.label.default"),"icon-right":"pi pi-user",rounded:"",variant:"filled"},null,8,["label"])])])]),e(),t("section",null,[t("h2",null,u(l.$t("ui.button.usage.redirect")),1),e(),t("div",Y,[n(s,{language:"html-vue"},{default:o(()=>[e(`
          ...
          <script setup lang="ts"> 
            import { ButtonElement } from "@dzangolab/vue3-ui"; 
          <\/script>
        `)]),_:1}),e(),t("div",Z,[n(a(i),{label:l.$t("ui.button.label.home"),to:"/"},null,8,["label"]),e(),n(a(i),{label:l.$t("ui.button.label.back"),severity:"secondary",to:"/vue/#/ui"},null,8,["label"])])])])]),_:1},8,["title"])}}});const ne=z(x,[["__scopeId","data-v-acb29bc5"]]);export{ne as default};
