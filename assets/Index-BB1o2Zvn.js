import{a as c,o as h}from"./DzangolabVue3Form.es-CmcHs4Xu.js";import{d as $,x as V,y as D,z as I,r as i,s as _,j as k,o as p,w as u,A as e,e as s,t as m,g as r,a as v,b,u as n,B as z}from"./index-hG40rBrG.js";import{_ as F}from"./FormPage.vue_vue_type_style_index_0_lang-DzjKvpBT.js";const U={class:"section-content"},E={key:0,class:"result-date"},S={class:"section-content"},B={key:0,class:"result-date"},C={class:"section-content"},w={key:0,class:"result-date"},A={class:"section-content"},N={key:0,class:"result-date"},P={name:"DaysInput"},G=$({...P,setup(q){const{t:y}=V(),g=D.coerce.number({invalid_type_error:y("form.errors.number.required")}).min(1,{message:y("form.errors.daysInput.invalid")}).max(365,{message:y("form.errors.daysInput.invalid")}),o=I({basic:i(),disabled:i(),label:i(),validationInput:i()});let d=I({basic:i(),disabled:i(30),label:i(),validationInput:i()});return(a,l)=>{const f=_("SshPre");return p(),k(F,{title:a.$t("form.label.daysInput"),class:"demo"},{toolbar:u(()=>[r(n(z),{label:a.$t("common.back"),"icon-left":"pi pi-chevron-left",size:"medium",variant:"textOnly",onClick:l[0]||(l[0]=t=>a.$router.push("/form"))},null,8,["label"])]),default:u(()=>[e(),s("section",null,[s("h2",null,m(a.$t("form.label.basicInput")),1),e(),s("div",U,[r(n(c),{modelValue:n(d).basic,"onUpdate:modelValue":l[1]||(l[1]=t=>n(d).basic=t),placeholder:a.$t("form.placeholder.days"),"onUpdate:date":l[2]||(l[2]=t=>o.basic=t)},null,8,["modelValue","placeholder"]),e(),o.basic?(p(),v("div",E,m(o.basic),1)):b("",!0),e(),r(f,{language:"html-vue"},{default:u(()=>[e(`
          <template>
            <DaysInput
              v-model="input"
