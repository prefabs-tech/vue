import{b as i,B as f}from"./DzangolabVue3Form.es-K5HWpUCT.js";import{d as V,E as N,G as $,H as z,r as p,D as E,e as F,o as O,h as m,B as e,f as t,t as d,g as r,u as l,q as w}from"./index-BfblxuFH.js";import{_ as U}from"./FormPage.vue_vue_type_style_index_0_lang-B1ZW4joJ.js";const y={class:"section-content"},B={class:"section-content"},M={class:"section-content"},S={class:"section-content"},q={class:"section-content"},k={class:"section-content"},C={class:"section-content"},P={name:"NumberInputField"},G=V({...P,setup(W){const{t:b}=N(),g=$.coerce.number({invalid_type_error:b("form.errors.number.invalid")}).gte(1,b("form.errors.number.invalid")).lte(100,b("form.errors.number.invalid")),I={invalid:b("form.errors.number.invalid"),required:b("form.errors.number.required")},v={min:1,max:100,allow_leading_zeroes:!1};let a=z({customValidationInput:p(),disabled:p(100),input:p(),inputWithValidation:p(),noLabelInput:p(),textInput:p()});return(o,n)=>{const s=E("SshPre");return O(),F(U,{title:o.$t("form.label.number"),class:"demo"},{toolbar:m(()=>[r(l(w),{label:o.$t("common.back"),"icon-left":"pi pi-chevron-left",size:"medium",variant:"textOnly",onClick:n[0]||(n[0]=u=>o.$router.push("/form"))},null,8,["label"])]),default:m(()=>[n[29]||(n[29]=e()),t("section",null,[t("h2",null,d(o.$t("form.label.basicInput")),1),n[10]||(n[10]=e()),t("div",y,[r(l(i),{modelValue:l(a).noLabelInput,"onUpdate:modelValue":n[1]||(n[1]=u=>l(a).noLabelInput=u),placeholder:o.$t("form.placeholder.number")},null,8,["modelValue","placeholder"]),n[9]||(n[9]=e()),r(s,{language:"html-vue"},{default:m(()=>n[8]||(n[8]=[e(`
          <template>
            <NumberInput 
              v-model="input"
