import{v as p,b as y}from"./PrefabsTechVue3Form.es-Ql6BW1dZ.js";import{d as P,M as V,O as M,P as $,r as f,N as w,o as B,e as O,f as s,h as l,t as d,A as t,a as o,u as n}from"./index-CAiRitWL.js";import{_ as U}from"./ComponentDocumentation.vue_vue_type_script_setup_true_lang-QrQ6mn2y.js";import{_ as A}from"./FormPage.vue_vue_type_style_index_0_lang-CcgRMzse.js";import"./PrefabsTechVue3TanstackTable.es-CCTu_o5f.js";const S={class:"section-content"},I={class:"section-content"},R={class:"section-content"},Y={class:"section-content"},T={class:"section-content"},j={class:"section-content"},F={class:"section-content"},z={class:"section-content"},C={class:"section-content"},H={class:"section-content"},N={class:"section-content"},L={class:"section-content"},W={class:"section-content"},J={class:"section-content"},Z={name:"DatePickerInput"},h=P({...Z,setup(q){const{t:u}=V(),v=M.date({invalid_type_error:u("form.errors.datePicker.invalid")}).max(new Date,{message:u("form.errors.datePicker.invalid")}),D=new Date,b=D,g=[{description:u("form.documentation.eventDescription.input.modelValue"),name:"update:modelValue",payload:"date: string | string[] | number | number[] | Date | Date[] | MonthPickerValue"}],k=[{default:"true",description:u("form.documentation.propsDescription.datePicker.autoApply"),prop:"autoApply",type:"Boolean"},{default:"false",description:u("form.documentation.propsDescription.input.disabled"),prop:"disabled",type:"Boolean"},{default:"false",description:u("form.documentation.propsDescription.datePicker.enableTimePicker"),prop:"enableTimePicker",type:"Boolean"},{default:"-",description:u("form.documentation.propsDescription.datePicker.format"),prop:"format",type:"String"},{default:"-",description:u("form.documentation.propsDescription.input.label"),prop:"label",type:"String"},{default:"-",description:u("form.documentation.propsDescription.input.modelValue"),prop:"modelValue",type:"Date | Date[] | MonthPickerValue | number | number[] | string | string[] | null"},{default:'"date"',description:u("form.documentation.propsDescription.input.name"),prop:"name",type:"String"},{default:"-",description:u("form.documentation.propsDescription.input.placeholder"),prop:"placeholder",type:"String"},{default:"-",description:u("form.documentation.propsDescription.input.schema"),prop:"schema",type:"Object (z.ZodType)"},{default:"-",description:u("form.documentation.propsDescription.datePicker.teleport"),prop:"teleport",type:"Boolean | String"}];let r=$({appointmentDate:f(D),arrivalDate:f(),availableDatetime:f([D,new Date(b.setDate(b.getDate()+7))]),dateOfBirth:f(D),dateRange:f([D,new Date(b.setDate(b.getDate()+7))]),joinedDate:f(),month:f(),monthAndYear:f(),noLabelInput:f(),presentationDate:f(D),reportDate:f([D,new Date(b.setDate(b.getDate()+7))]),time:f(),year:f(D.getFullYear())});return(a,e)=>{const m=w("SshPre");return B(),O(A,{subtitle:a.$t("form.subtitle.datePicker"),title:a.$t("form.label.datePicker"),class:"demo"},{default:s(()=>[l("section",null,[l("h2",null,d(a.$t("form.label.basicInput")),1),e[16]||(e[16]=t()),l("div",S,[o(n(p),{modelValue:n(r).noLabelInput,"onUpdate:modelValue":e[0]||(e[0]=i=>n(r).noLabelInput=i),placeholder:"MM/dd/yyyy"},null,8,["modelValue"]),e[15]||(e[15]=t()),o(m,{language:"html-vue"},{default:s(()=>[...e[14]||(e[14]=[t(`
          <template>
          ...
          <\/script>
        `,-1)])]),_:1})])]),e[56]||(e[56]=t()),l("section",null,[l("h2",null,d(a.$t("form.label.labelInput")),1),e[19]||(e[19]=t()),l("div",I,[o(n(p),{modelValue:n(r).arrivalDate,"onUpdate:modelValue":e[1]||(e[1]=i=>n(r).arrivalDate=i),label:a.$t("form.label.arrivalDate"),placeholder:"MM/dd/yyyy"},null,8,["modelValue","label"]),e[18]||(e[18]=t()),o(m,{language:"html-vue"},{default:s(()=>[...e[17]||(e[17]=[t(`
          <template>
            <DatePicker 
              v-model="arrivalDate"
              label="Arrival date"
        ...
        `,-1)])]),_:1})])]),e[64]||(e[64]=t()),l("section",null,[l("h2",null,d(a.$t("form.label.monthPicker")),1),e[43]||(e[43]=t()),l("div",H,[o(n(p),{modelValue:n(r).month,"onUpdate:modelValue":e[9]||(e[9]=i=>n(r).month=i),label:a.$t("form.label.month"),format:"MMM","month-picker":"",placeholder:"MMM"},null,8,["modelValue","label"]),e[42]||(e[42]=t()),o(m,{language:"html-vue"},{default:s(()=>[...e[41]||(e[41]=[t(`
          ...
          const month = ref();
          <\/script>
        `,-1)])]),_:1})])]),e[65]||(e[65]=t()),l("section",null,[l("h2",null,d(a.$t("form.label.monthAndYearPicker")),1),e[46]||(e[46]=t()),l("div",N,[o(n(p),{modelValue:n(r).month,"onUpdate:modelValue":e[10]||(e[10]=i=>n(r).month=i),label:a.$t("form.label.monthAndYear"),"month-picker":""},null,8,["modelValue","label"]),e[45]||(e[45]=t()),o(m,{language:"html-vue"},{default:s(()=>[...e[44]||(e[44]=[t(`
          <template>
            <DatePicker 
          ...
          <\/script>
        `,-1)])]),_:1})])]),e[66]||(e[66]=t()),l("section",null,[l("h2",null,d(a.$t("form.label.yearPicker")),1),e[49]||(e[49]=t()),l("div",L,[o(n(p),{modelValue:n(r).year,"onUpdate:modelValue":e[11]||(e[11]=i=>n(r).year=i),label:a.$t("form.label.year"),"year-picker":""},null,8,["modelValue","label"]),e[48]||(e[48]=t()),o(m,{language:"html-vue"},{default:s(()=>[...e[47]||(e[47]=[t(`
          <template>
            <DatePicker 
              v-model="year"
              label="Year"
          ...
          <\/script>
        `,-1)])]),_:1})])]),e[67]||(e[67]=t()),l("section",null,[l("h2",null,d(a.$t("form.label.timePicker")),1),e[52]||(e[52]=t()),l("div",W,[o(n(p),{modelValue:n(r).time,"onUpdate:modelValue":e[12]||(e[12]=i=>n(r).time=i),label:a.$t("form.label.appointmentTime"),placeholder:"HH:mm","time-picker":""},null,8,["modelValue","label"]),e[51]||(e[51]=t()),o(m,{language:"html-vue"},{default:s(()=>[...e[50]||(e[50]=[t(`
          <template>
            <DatePicker 
          ...
          import { DatePicker } from "@prefabs.tech/vue3-form";
          <\/script>
        `,-1)])]),_:1})])]),e[68]||(e[68]=t()),l("section",null,[l("h2",null,d(a.$t("form.label.inputWithValidation")),1),e[55]||(e[55]=t()),l("div",J,[o(n(y),null,{default:s(()=>[o(n(p),{modelValue:n(r).joinedDate,"onUpdate:modelValue":e[13]||(e[13]=i=>n(r).joinedDate=i),label:a.$t("form.label.joinedDate"),schema:n(v),placeholder:"MM/dd/yyyy"},null,8,["modelValue","label","schema"])]),_:1}),e[54]||(e[54]=t()),o(m,{language:"html-vue"},{default:s(()=>[...e[53]||(e[53]=[t(`
          <Form>
            <DatePicker 
              v-model="joinedDate"
              :schema="inputSchema"
