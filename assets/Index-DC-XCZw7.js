import{C as A,P as y,E as S,A as V}from"./PrefabsTechVue3Form.es-BQ47NCAz.js";import{d as F,I,N,r as d,L as h,e as T,o as E,j as i,C as o,f as n,h as t,t as u,u as a,v as m,a5 as p,a as U,F as j,z as q}from"./index-CmpcxswC.js";import{_ as G}from"./ComponentDocumentation.vue_vue_type_script_setup_true_lang-Cd7TcIJw.js";import{_ as H}from"./UiPage.vue_vue_type_style_index_0_lang-CqR1Amj6.js";import"./PrefabsTechVue3TanstackTable.es-CTvHU8kQ.js";const J={class:"section-content"},K={class:"container"},Q={class:"section-content"},R={class:"container"},W={class:"label"},X={class:"value"},Y={class:"section-content"},Z={class:"container"},c={class:"section-content"},x={class:"container"},_={class:"section-content"},ll={class:"container"},ol={role:"heading"},ul=F({__name:"Index",setup(el){const{t:r}=I(),B=[{description:r("ui.modal.documentation.eventDescription.close"),name:"on:close",payload:"-"}],C=[{label:"Name",value:"Acer Nitro 5"},{label:"Category",value:"Laptop"},{label:"Color",value:"Black"}],L=[{default:"false",description:r("ui.modal.documentation.propsDescription.dismissOnClickOut"),prop:"dismissOnClickOut",type:"Boolean"},{default:"false",description:r("ui.modal.documentation.propsDescription.show"),prop:"show",type:"Boolean"},{default:"medium",description:r("ui.modal.documentation.propsDescription.size"),prop:"size",type:'"medium" | "large" | "auto"'},{default:"-",description:r("ui.modal.documentation.propsDescription.title"),prop:"title",type:"String"}],z=[{description:r("ui.modal.documentation.slotDescription.default"),name:"default"},{description:r("ui.modal.documentation.slotDescription.footer"),name:"footer"},{description:r("ui.modal.documentation.slotDescription.header"),name:"header"}],v=N({email:d(),password:d()}),b=d(!1),M=d(!1),$=d(!1),g=d(!1),k=d(!1),w=d(!1),D=d(!1);return(e,l)=>{const f=h("SshPre"),P=h("router-link");return E(),T(H,{"sub-title":e.$t("ui.modal.subtitle"),title:e.$t("ui.modal.title"),class:"demo-modal"},{toolbar:i(()=>[t(a(m),{label:e.$t("common.back"),"icon-left":"pi pi-chevron-left",size:"medium",variant:"textOnly",onClick:l[0]||(l[0]=s=>e.$router.push("/ui"))},null,8,["label"])]),default:i(()=>[l[47]||(l[47]=o()),n("section",null,[n("h2",null,u(e.$t("ui.modal.usage.basic")),1),l[21]||(l[21]=o()),n("div",J,[n("div",K,[t(a(m),{label:e.$t("ui.modal.label.show"),onClick:l[1]||(l[1]=s=>D.value=!0)},null,8,["label"])]),l[19]||(l[19]=o()),t(a(p),{show:D.value,title:e.$t("ui.modal.header.productDetail"),"onOn:close":l[2]||(l[2]=s=>D.value=!1)},{default:i(()=>[o(u(e.$t("ui.modal.content")),1)]),_:1},8,["show","title"]),l[20]||(l[20]=o()),t(f,{language:"html-vue"},{default:i(()=>l[18]||(l[18]=[o(`
          <template>
            <ButtonElement
              label="Show"
        ...
        `)])),_:1})])]),l[50]||(l[50]=o()),n("section",null,[n("h2",null,u(e.$t("ui.confirmationModal.usage.withI18n")),1),l[38]||(l[38]=o()),n("div",c,[n("div",x,[t(a(m),{label:e.$t("ui.modal.label.show"),onClick:l[11]||(l[11]=s=>$.value=!0)},null,8,["label"])]),l[36]||(l[36]=o()),t(a(p),{show:$.value,title:e.$t("ui.modal.header.productDetail"),"onOn:close":l[12]||(l[12]=s=>$.value=!1)},{default:i(()=>[o(u(e.$t("ui.modal.content")),1)]),_:1},8,["show","title"]),l[37]||(l[37]=o()),t(f,{language:"html-vue"},{default:i(()=>l[35]||(l[35]=[o(`
          ...
          const showModal = ref(false);
          <\/script>
        `)])),_:1})])]),l[51]||(l[51]=o()),n("section",null,[n("h2",null,u(e.$t("ui.confirmationModal.usage.slots")),1),l[46]||(l[46]=o()),n("div",_,[n("div",ll,[t(a(m),{label:e.$t("ui.modal.label.login"),"icon-left":"pi pi-user",onClick:l[13]||(l[13]=s=>w.value=!0)},null,8,["label"])]),l[44]||(l[44]=o()),t(a(p),{show:w.value,"onOn:close":l[17]||(l[17]=s=>w.value=!1)},{header:i(()=>[n("span",ol,u(e.$t("ui.modal.label.login")),1)]),footer:i(()=>[t(P,{to:"/form/password-input"},{default:i(()=>[o(u(e.$t("ui.modal.label.forgotPassword")),1)]),_:1})]),default:i(()=>[l[41]||(l[41]=o()),t(a(A),{class:"login-form"},{default:i(()=>[t(a(y),{modelValue:v.email,"onUpdate:modelValue":l[14]||(l[14]=s=>v.email=s),label:e.$t("form.label.email"),placeholder:e.$t("form.placeholder.email")},null,8,["modelValue","label","placeholder"]),l[39]||(l[39]=o()),t(a(S),{modelValue:v.password,"onUpdate:modelValue":l[15]||(l[15]=s=>v.password=s),label:e.$t("form.label.password"),placeholder:e.$t("form.placeholder.password")},null,8,["modelValue","label","placeholder"]),l[40]||(l[40]=o()),t(a(V),{"submit-label":e.$t("ui.modal.label.login"),alignment:"filled",class:"login-actions",onCancel:l[16]||(l[16]=s=>w.value=!1)},null,8,["submit-label"])]),_:1}),l[42]||(l[42]=o())]),_:1},8,["show"]),l[45]||(l[45]=o()),t(f,{language:"html-vue"},{default:i(()=>l[43]||(l[43]=[o(`
          <template>
            <ButtonElement
          ...
          const showModal = ref(false);
          <\/script>
        `)])),_:1})])]),l[52]||(l[52]=o()),t(G,{"events-data":B,"props-data":L,"props-table-title":e.$t("common.properties",{value:"ModalProperties"}),"slots-data":z},null,8,["props-table-title"])]),_:1},8,["sub-title","title"])}}});export{ul as default};
