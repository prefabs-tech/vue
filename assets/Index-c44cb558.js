import{d as b,a7 as g,K as d,o as f,c as I,w as a,L as e,C as n,M as i,f as t,E as l}from"./index-8e1c3ab6-475a9ed5.js";import{j as m,A as _}from"./index-f29306f7.js";import{_ as y}from"./UserPage.vue_vue_type_style_index_0_lang-7429d64f.js";const h={class:"section-content"},S={class:"section-content"},D={class:"section-content"},P={class:"section-content"},F={class:"section-content"},U=b({__name:"Index",setup(R){const{t:p}=g(),u=[{id:1,name:"ADMIN"},{id:2,name:"SUPERADMIN"},{id:3,name:"USER"}],c=[{id:1,name:"Admin",origin:"admin-origin",supportedRoles:[{id:1,name:"ADMIN"},{id:2,name:"SUPERADMIN"}]},{id:2,name:"User",origin:"user-origin",supportedRoles:[{id:3,name:"USER"}]}],s=o=>{_({text:p("user.message.invitation.success",{user:o.email}),type:"success"})};return(o,A)=>{const v=d("router-link"),r=d("SshPre");return f(),I(y,{title:o.$t("user.label.invitationForm"),class:"demo-invitation-form"},{toolbar:a(()=>[e(v,{to:{name:"user"},class:"back"},{default:a(()=>[n(i(o.$t("common.back")),1)]),_:1})]),default:a(()=>[n(),t("section",null,[t("h2",null,i(o.$t("user.label.basic")),1),n(),t("div",h,[e(l(m),{onSubmit:s}),n(),e(r,{language:"html-vue"},{default:a(()=>[n(`
          <template>
