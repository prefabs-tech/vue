import{d as b,r as u,o as m,c as v,w as i,f as a,g as e,t as o,a as l,h as t,a4 as s,a0 as h,a1 as _,_ as f}from"./index-282387c5.js";const r=c=>(h("data-v-ca6c209d"),c=c(),_(),c),B={class:"section-content"},y={class:"section-content"},$={class:"section-content"},k={class:"section-content"},I={class:"container"},w={class:"section-content"},z={class:"container"},S={class:"section-content"},L={class:"container"},P={class:"section-content"},C={class:"container"},N={class:"section-content"},R={class:"container"},V=r(()=>l("i",{class:"pi pi-check"},null,-1)),A=r(()=>l("i",{class:"pi pi-times"},null,-1)),D=b({__name:"Index",setup(c){return(n,U)=>{const g=u("router-link"),d=u("SshPre"),p=u("Page");return m(),v(p,{title:n.$t("ui.badge.title"),class:"demo-badge"},{toolbar:i(()=>[a(g,{to:{name:"ui"},class:"back"},{default:i(()=>[e(o(n.$t("common.back")),1)]),_:1})]),default:i(()=>[e(),l("section",null,[l("h2",null,o(n.$t("ui.badge.usage.basic")),1),e(),l("div",B,[a(d,{language:"html-vue"},{default:i(()=>[e(`
          <template>
            <Badge label="Basic" /> 
          </template>
