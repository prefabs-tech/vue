import{G as r,U as v}from"./DzangolabVue3Form.es-Dat2oXdq.js";import{d as g,L as w,M as V,N as I,r as p,K as S,f as $,o as z,i as u,E as t,g as o,t as d,h as i,u as n,x as L}from"./index-DZOt7f2Z.js";import{_ as U}from"./FormPage.vue_vue_type_style_index_0_lang-_nFbxOGC.js";const F={class:"section-content"},y={class:"section-content"},O={class:"section-content"},k={class:"section-content"},N={class:"section-content"},C={class:"section-content"},W={name:"SwitchInput"},P=g({...W,setup(h){const{t:f}=w(),b=V.coerce.boolean().refine(e=>e===!0,{message:f("form.errors.switch.invalid")});let s=I({disabled:p(!0),input:p(),inputWithValidation:p(!1),noLabelInput:p(),onOffLabel:p()});return(e,l)=>{const m=S("SshPre");return z(),$(U,{title:e.$t("form.label.switch"),class:"demo"},{toolbar:u(()=>[i(n(L),{label:e.$t("common.back"),"icon-left":"pi pi-chevron-left",size:"medium",variant:"textOnly",onClick:l[0]||(l[0]=a=>e.$router.push("/form"))},null,8,["label"])]),default:u(()=>[l[25]||(l[25]=t()),o("section",null,[o("h2",null,d(e.$t("form.label.basicInput")),1),l[9]||(l[9]=t()),o("div",F,[i(n(r),{modelValue:n(s).noLabelInput,"onUpdate:modelValue":l[1]||(l[1]=a=>n(s).noLabelInput=a)},null,8,["modelValue"]),l[8]||(l[8]=t()),i(m,{language:"html-vue"},{default:u(()=>l[7]||(l[7]=[t(`
          <template>
