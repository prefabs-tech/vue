import{z as f,W as k}from"./PrefabsTechVue3TanstackTable.es-4Bbo1BmD.js";import{d as y,u as D,r as $,o as h,h as O,w as s,a as o,t as b,b as n,e as a,f as l,v as S,i as R,j as m,m as d,s as z}from"./index-CS8lVMEF.js";import{_ as B}from"./ComponentDocumentation.vue_vue_type_script_setup_true_lang-CodqleA_.js";import{_ as T}from"./FormPage.vue_vue_type_style_index_0_lang-CHIuJwhc.js";const W={class:"section-content"},F={class:"section-content"},P={class:"section-content"},q={class:"section-content"},C={name:"RadioInputDemo"},M=y({...C,setup(N){const{t}=D();let r=R({disabled:m("car"),i18nInput:m(),input:m(),inputWithValidation:m(),noLabelInput:m()});const c=d(()=>[{description:t("form.documentation.eventDescription.input.modelValue"),name:"update:modelValue",payload:"value: string"}]),v=d(()=>[{label:t("form.label.male"),value:"male"},{label:t("form.label.female"),value:"female"}]),V=d(()=>z({required_error:t("form.errors.radio.required")}).nonempty({message:t("form.errors.radio.required")})),I=d(()=>[{default:"-",description:t("form.documentation.propsDescription.radio.direction"),prop:"direction",type:'"vertical" | "horizontal"'},{default:"false",description:t("form.documentation.propsDescription.input.disabled"),prop:"disabled",type:"Boolean"},{default:"-",description:t("form.documentation.propsDescription.input.helperText"),prop:"helperText",type:"String"},{default:"-",description:t("form.documentation.propsDescription.input.label"),prop:"label",type:"String"},{default:'""',description:t("form.documentation.propsDescription.input.modelValue"),prop:"modelValue",type:"String | Number"},{default:'"radio"',description:t("form.documentation.propsDescription.input.name"),prop:"name",type:"String"},{default:"-",description:t("form.documentation.propsDescription.radio.options"),prop:"options",type:"InputOption[]"},{default:"-",description:t("form.documentation.propsDescription.input.schema"),prop:"schema",type:"z.ZodType<string | number | boolean>"}]),g=d(()=>[{label:t("form.label.bike"),value:"bike"},{label:t("form.label.car"),value:"car"},{label:t("form.label.truck"),value:"truck"}]);return(i,e)=>{const u=$("SshPre");return h(),O(T,{subtitle:i.$t("form.subtitle.radio"),title:i.$t("form.label.radio"),class:"demo"},{default:s(()=>[o("section",null,[o("h2",null,b(i.$t("form.label.basicInput")),1),e[6]||(e[6]=n()),o("div",W,[a(l(f),{modelValue:l(r).input,"onUpdate:modelValue":e[0]||(e[0]=p=>l(r).input=p),label:i.$t("form.label.gender"),options:v.value,direction:"horizontal",name:"label-input"},null,8,["modelValue","label","options"]),e[5]||(e[5]=n()),a(u,{language:"html-vue"},{default:s(()=>[...e[4]||(e[4]=[n(`
          <template>
            <RadioInput
              v-model="input"
