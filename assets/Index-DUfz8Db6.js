import{D as e,E as t,On as n,St as r,_ as i,g as a,gn as o,k as s,mt as c,qt as l,tr as u,v as d,vn as f}from"./runtime-core.esm-bundler-BKdLzFmX.js";import{o as p}from"./PrefabsTechVue3UI.es-EJDYzbRH.js";import{p as m}from"./vee-validate-Dcr5wvVn.js";import{T as h}from"./PrefabsTechVue3Layout.es-DjWCbXPc.js";import{t as g}from"./FormPage-Ca1LZeR4.js";import{c as _,d as v}from"./PrefabsTechVue3TanstackTable.es-Dqv6JrPc.js";import{t as y}from"./ComponentDocumentation-CFBF3GmY.js";var b={class:`section-content`},x={class:`section-content`},S={class:`section-content`},C={class:`section-content`},w=s({name:`RadioInputDemo`,setup(s){let{t:w}=h(),T=o({disabled:f(`car`),i18nInput:f(),input:f(),inputWithValidation:f(),noLabelInput:f()}),E=a(()=>[{description:w(`form.documentation.eventDescription.input.modelValue`),name:`update:modelValue`,payload:`value: string`}]),D=a(()=>[{label:w(`form.label.male`),value:`male`},{label:w(`form.label.female`),value:`female`}]),O=a(()=>m({required_error:w(`form.errors.radio.required`)}).nonempty({message:w(`form.errors.radio.required`)})),k=a(()=>[{default:`-`,description:w(`form.documentation.propsDescription.radio.direction`),prop:`direction`,type:`"vertical" | "horizontal"`},{default:`false`,description:w(`form.documentation.propsDescription.input.disabled`),prop:`disabled`,type:`Boolean`},{default:`-`,description:w(`form.documentation.propsDescription.input.helperText`),prop:`helperText`,type:`String`},{default:`-`,description:w(`form.documentation.propsDescription.input.label`),prop:`label`,type:`String`},{default:`""`,description:w(`form.documentation.propsDescription.input.modelValue`),prop:`modelValue`,type:`String | Number`},{default:`"radio"`,description:w(`form.documentation.propsDescription.input.name`),prop:`name`,type:`String`},{default:`-`,description:w(`form.documentation.propsDescription.radio.options`),prop:`options`,type:`InputOption[]`},{default:`-`,description:w(`form.documentation.propsDescription.input.schema`),prop:`schema`,type:`z.ZodType<string | number | boolean>`}]),A=a(()=>[{label:w(`form.label.bike`),value:`bike`},{label:w(`form.label.car`),value:`car`},{label:w(`form.label.truck`),value:`truck`}]);return(a,o)=>{let s=r(`SshPre`);return c(),d(g,{subtitle:a.$t(`form.subtitle.radio`),title:a.$t(`form.label.radio`),class:`demo`},{default:l(()=>[i(`section`,null,[i(`h2`,null,u(a.$t(`form.label.basicInput`)),1),o[6]||=t(),i(`div`,b,[e(n(v),{modelValue:n(T).input,"onUpdate:modelValue":o[0]||=e=>n(T).input=e,label:a.$t(`form.label.gender`),options:D.value,direction:`horizontal`,name:`label-input`},null,8,[`modelValue`,`label`,`options`]),o[5]||=t(),e(s,{language:`html-vue`},{default:l(()=>[...o[4]||=[t(`
          <template>
            <RadioInput
              v-model="input"
