import{d as b,o as v}from"./DzangolabVue3Form.es-k-Xjvcvt.js";import{d as h,z as g,A as S,r as p,s as V,j as I,o as $,w as s,B as e,e as a,t as d,g as u,u as l,D as z,h as L,C as F}from"./index-CqimUq5D.js";import{z as D}from"./index-mSkvzYyn.js";import{_ as N}from"./FormPage.vue_vue_type_style_index_0_lang-g4uxL8pa.js";const U={class:"section-content"},G={class:"section-content"},H={class:"section-content"},W={class:"section-content"},y={class:"section-content"},C={class:"section-content"},k={class:"section-content"},w={class:"section-content"},B={class:"section-content"},M={class:"section-content"},P=a("i",{class:"pi pi-user"},null,-1),j={class:"section-content"},A={name:"SelectInputField"},Q=h({...A,setup(O){const{t:c}=g(),f=D.string({invalid_type_error:c("form.errors.multiselect.invalid")}).array().min(1,{message:c("form.errors.multiselect.invalid")});let i=S({customLabelSelect:p(),disabled:p("de"),disabledMultiselect:p(["be","de"]),disabledSortInput:p(),i18nSelect:p(),input:p(),inputWithValidation:p([]),multiselect:p(),multiselectSearch:p(),noLabelInput:p(),selectWithSearch:p()});const r=p([{label:c("form.label.french"),value:"fr"},{label:c("form.label.german"),value:"de"},{disabled:!0,label:c("form.label.dutch"),value:"be"},{label:c("form.label.nepali"),value:"np"},{label:c("form.label.hindi"),value:"hi"}]);return(n,o)=>{const m=V("SshPre");return $(),I(N,{title:n.$t("form.label.select"),class:"demo"},{toolbar:s(()=>[u(l(F),{label:n.$t("common.back"),"icon-left":"pi pi-chevron-left",size:"medium",variant:"textOnly",onClick:o[0]||(o[0]=t=>n.$router.push("/form"))},null,8,["label"])]),default:s(()=>[e(),a("section",null,[a("h2",null,d(n.$t("form.label.basicInput")),1),e(),a("div",U,[u(l(b),{modelValue:l(i).noLabelInput,"onUpdate:modelValue":o[1]||(o[1]=t=>l(i).noLabelInput=t),options:r.value,placeholder:n.$t("form.placeholder.language")},null,8,["modelValue","options","placeholder"]),e(),u(m,{language:"html-vue"},{default:s(()=>[e(`
          <template>
            <SelectInput
              v-model="input"
              :options="options"
