import{b as i,B as f}from"./DzangolabVue3Form.es-B2kG3w3x.js";import{d as V,E as N,G as $,H as z,r as p,D as E,e as F,o as O,h as m,B as e,f as t,t as d,g as r,u as l,q as w}from"./index-DfLKm71s.js";import{_ as U}from"./FormPage.vue_vue_type_style_index_0_lang-CbIBHqlL.js";const y={class:"section-content"},B={class:"section-content"},M={class:"section-content"},S={class:"section-content"},q={class:"section-content"},k={class:"section-content"},C={class:"section-content"},P={name:"NumberInputField"},G=V({...P,setup(W){const{t:b}=N(),g=$.coerce.number({invalid_type_error:b("form.errors.number.invalid")}).gte(1,b("form.errors.number.invalid")).lte(100,b("form.errors.number.invalid")),I={invalid:b("form.errors.number.invalid"),required:b("form.errors.number.required")},v={min:1,max:100,allow_leading_zeroes:!1};let a=z({customValidationInput:p(),disabled:p(100),input:p(),inputWithValidation:p(),noLabelInput:p(),textInput:p()});return(o,n)=>{const s=E("SshPre");return O(),F(U,{title:o.$t("form.label.number"),class:"demo"},{toolbar:m(()=>[r(l(w),{label:o.$t("common.back"),"icon-left":"pi pi-chevron-left",size:"medium",variant:"textOnly",onClick:n[0]||(n[0]=u=>o.$router.push("/form"))},null,8,["label"])]),default:m(()=>[n[29]||(n[29]=e()),t("section",null,[t("h2",null,d(o.$t("form.label.basicInput")),1),n[10]||(n[10]=e()),t("div",y,[r(l(i),{modelValue:l(a).noLabelInput,"onUpdate:modelValue":n[1]||(n[1]=u=>l(a).noLabelInput=u),placeholder:o.$t("form.placeholder.number")},null,8,["modelValue","placeholder"]),n[9]||(n[9]=e()),r(s,{language:"html-vue"},{default:m(()=>n[8]||(n[8]=[e(`
          <template>
            <NumberInput 
              v-model="input"
          ...
          <\/script>
        `)])),_:1})])]),n[30]||(n[30]=e()),t("section",null,[t("h2",null,d(o.$t("form.label.labelInput")),1),n[13]||(n[13]=e()),t("div",B,[r(l(i),{modelValue:l(a).input,"onUpdate:modelValue":n[2]||(n[2]=u=>l(a).input=u),label:o.$t("form.label.number"),placeholder:o.$t("form.placeholder.number")},null,8,["modelValue","label","placeholder"]),n[12]||(n[12]=e()),r(s,{language:"html-vue"},{default:m(()=>n[11]||(n[11]=[e(`
          <template>
            <NumberInput 
              v-model="input"
              label="Number"
          ...
          import { NumberInput } from "@dzangolab/vue3-form";
          <\/script>
        `)])),_:1})])]),n[31]||(n[31]=e()),t("section",null,[t("h2",null,d(o.$t("form.label.disabled")),1),n[16]||(n[16]=e()),t("div",M,[r(l(i),{modelValue:l(a).disabled,"onUpdate:modelValue":n[3]||(n[3]=u=>l(a).disabled=u),label:o.$t("form.label.number"),disabled:""},null,8,["modelValue","label"]),n[15]||(n[15]=e()),r(s,{language:"html-vue"},{default:m(()=>n[14]||(n[14]=[e(`
          <template>
            <NumberInput 
              v-model="input"
              label="Number"
