import{D as e,E as t,On as n,St as r,_ as i,g as a,gn as o,k as s,mt as c,qt as l,tr as u,v as d,vn as f}from"./runtime-core.esm-bundler-CIxmKYxc.js";import{u as p}from"./vee-validate-D3u_EqLN.js";import{E as m}from"./PrefabsTechVue3Layout.es-ByeEwOwS.js";import{t as h}from"./FormPage-qAqvgJ-r.js";import{i as g,l as _}from"./PrefabsTechVue3TanstackTable.es-CqNazKU2.js";import{t as v}from"./ComponentDocumentation-BPcopVAa.js";var y={class:`section-content`},b={class:`section-content`},x={class:`section-content`},S={class:`section-content`},C={class:`section-content`},w={class:`section-content`},T=s({name:`SwitchInputDemo`,setup(s){let{t:T}=m(),E=o({disabled:f(!0),input:f(),inputWithValidation:f(!1),noLabelInput:f(),onOffLabel:f()}),D=a(()=>[{description:T(`form.documentation.eventDescription.input.modelValue`),name:`update:modelValue`,payload:`value: boolean`}]),O=a(()=>p.boolean().refine(e=>e===!0,{message:T(`form.errors.switch.invalid`)})),k=a(()=>[{default:`false`,description:T(`form.documentation.propsDescription.input.disabled`),prop:`disabled`,type:`Boolean`},{default:`-`,description:T(`form.documentation.propsDescription.input.label`),prop:`label`,type:`String`},{default:`false`,description:T(`form.documentation.propsDescription.input.modelValue`),prop:`modelValue`,type:`Boolean`},{default:`"switch"`,description:T(`form.documentation.propsDescription.input.name`),prop:`name`,type:`String`},{default:`-`,description:T(`form.documentation.propsDescription.switch.offLabel`),prop:`offLabel`,type:`String`},{default:`-`,description:T(`form.documentation.propsDescription.switch.onLabel`),prop:`onLabel`,type:`String`},{default:`-`,description:T(`form.documentation.propsDescription.input.schema`),prop:`schema`,type:`z.ZodType<string | number | boolean>`}]);return(a,o)=>{let s=r(`SshPre`);return c(),d(h,{subtitle:a.$t(`form.subtitle.switch`),title:a.$t(`form.label.switch`),class:`demo`},{default:l(()=>[i(`section`,null,[i(`h2`,null,u(a.$t(`form.label.basicInput`)),1),o[8]||=t(),i(`div`,y,[e(n(_),{modelValue:n(E).noLabelInput,"onUpdate:modelValue":o[0]||=e=>n(E).noLabelInput=e},null,8,[`modelValue`]),o[7]||=t(),e(s,{language:`html-vue`},{default:l(()=>[...o[6]||=[t(`
          <template>
