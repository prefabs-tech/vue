import{W as b,L as g}from"./DzangolabVue3Form.es-CE9A9srf.js";import{d as S,E as h,G as V,H as I,r as p,D as $,e as c,o as L,w as s,B as e,f as t,t as d,i as u,u as n,q as z,y as F,p as D}from"./index-wNQK_6m0.js";import{_ as N}from"./FormPage.vue_vue_type_style_index_0_lang-4RDqni7V.js";const G={class:"section-content"},H={class:"section-content"},U={class:"section-content"},W={class:"section-content"},y={class:"section-content"},k={class:"section-content"},w={class:"section-content"},B={class:"section-content"},C={class:"section-content"},M={class:"section-content"},P={class:"section-content"},q={name:"SelectInputField"},J=S({...q,setup(E){const{t:f}=h(),v=V.string({invalid_type_error:f("form.errors.multiselect.invalid")}).array().min(1,{message:f("form.errors.multiselect.invalid")});let i=I({customLabelSelect:p(),disabled:p("de"),disabledMultiselect:p(["be","de"]),disabledSortInput:p(),i18nSelect:p(),input:p(),inputWithValidation:p([]),multiselect:p(),multiselectSearch:p(),noLabelInput:p(),selectWithSearch:p()});const r=p([{label:f("form.label.french"),value:"fr"},{label:f("form.label.german"),value:"de"},{disabled:!0,label:f("form.label.dutch"),value:"be"},{label:f("form.label.nepali"),value:"np"},{label:f("form.label.hindi"),value:"hi"}]);return(a,l)=>{const m=$("SshPre");return L(),c(N,{title:a.$t("form.label.select"),class:"demo"},{toolbar:s(()=>[u(n(D),{label:a.$t("common.back"),"icon-left":"pi pi-chevron-left",size:"medium",variant:"textOnly",onClick:l[0]||(l[0]=o=>a.$router.push("/form"))},null,8,["label"])]),default:s(()=>[l[46]||(l[46]=e()),t("section",null,[t("h2",null,d(a.$t("form.label.basicInput")),1),l[14]||(l[14]=e()),t("div",G,[u(n(b),{modelValue:n(i).noLabelInput,"onUpdate:modelValue":l[1]||(l[1]=o=>n(i).noLabelInput=o),options:r.value,placeholder:a.$t("form.placeholder.language")},null,8,["modelValue","options","placeholder"]),l[13]||(l[13]=e()),u(m,{language:"html-vue"},{default:s(()=>l[12]||(l[12]=[e(`
          <template>
            <SelectInput
              v-model="input"
              :options="options"
        ...
        `)])),_:1})])]),l[49]||(l[49]=e()),t("section",null,[t("h2",null,d(a.$t("form.label.withSearch")),1),l[23]||(l[23]=e()),t("div",W,[u(n(b),{modelValue:n(i).selectWithSearch,"onUpdate:modelValue":l[4]||(l[4]=o=>n(i).selectWithSearch=o),label:a.$t("form.label.language"),options:r.value,placeholder:a.$t("form.placeholder.language"),"search-placeholder":a.$t("form.placeholder.search"),"enable-search":""},null,8,["modelValue","label","options","placeholder","search-placeholder"]),l[22]||(l[22]=e()),u(m,{language:"html-vue"},{default:s(()=>l[21]||(l[21]=[e(`
          ...
          <\/script>
        `)])),_:1})])]),l[50]||(l[50]=e()),t("section",null,[t("h2",null,d(a.$t("form.label.disableSort")),1),l[26]||(l[26]=e()),t("div",y,[u(n(b),{modelValue:n(i).disabledSortInput,"onUpdate:modelValue":l[5]||(l[5]=o=>n(i).disabledSortInput=o),"has-sorted-options":!1,label:a.$t("form.label.language"),options:r.value,placeholder:a.$t("form.placeholder.language")},null,8,["modelValue","label","options","placeholder"]),l[25]||(l[25]=e()),u(m,{language:"html-vue"},{default:s(()=>l[24]||(l[24]=[e(`
          <template>
            <SelectInput 
              v-model="input"
