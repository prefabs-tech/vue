import{m as d,v as i}from"./DzangolabVue3Form.es-9736d79f.js";import{d as v,a7 as I,p as V,j as f,K as c,o as $,c as F,w as a,L as n,C as e,M as u,f as o,E as l}from"./index-137faed7-cbf069b7.js";import{m as _}from"./index-52211739.js";import{_ as w}from"./FormPage.vue_vue_type_style_index_0_lang-f0817500.js";const y={class:"section-content"},z={class:"section-content"},U={class:"section-content"},k={class:"section-content"},E={class:"section-content"},S={class:"section-content"},T={name:"InputField"},P=v({...T,setup(W){const{t:b}=I(),h=_.string().min(3,{message:b("form.errors.input.min",{length:3})});let r=V({disabled:f("monorepo@gmail.com"),input:f(),inputWithValidation:f(),noLabelInput:f(),passwordInput:f()});return(t,s)=>{const g=c("router-link"),p=c("SshPre");return $(),F(w,{title:t.$t("form.label.input"),class:"demo"},{toolbar:a(()=>[n(g,{to:{name:"form"},class:"back"},{default:a(()=>[e(u(t.$t("common.back")),1)]),_:1})]),default:a(()=>[e(),o("section",null,[o("h2",null,u(t.$t("form.label.basicInput")),1),e(),o("div",y,[n(p,{language:"html-vue"},{default:a(()=>[e(`
          <Form>
            <Input 
              v-model="username"
