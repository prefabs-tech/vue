import{d as r,r as c,o as d,c as g,w as o,a as n,t as l,f as t,g as p,h as s,a5 as a,ab as i}from"./index-3fcf3b87.js";const b={class:"section-content"},h={class:"popup-title"},v={class:"popup-body"},f={class:"section-content"},P={class:"section-content"},_={class:"section-content"},$={class:"section-content"},B={class:"section-content"},T=r({__name:"Index",setup(y){return(e,E)=>{const u=c("SshPre"),m=c("Page");return d(),g(m,{title:e.$t("ui.popup.title"),class:"demo"},{default:o(()=>[n("section",null,[n("h2",null,l(e.$t("ui.popup.usage.basic")),1),t(),n("div",b,[p(u,{language:"html-vue"},{default:o(()=>[t(`
          <template>
            <Popup>
              <ButtonElement
                :label="Click me"
