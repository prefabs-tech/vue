import{W as d,J as c}from"./DzangolabVue3Form.es-b51db7e8.js";import{d as V,a5 as $,p as T,j as m,J as h,o as x,c as _,w as u,K as a,W as e,L as i,f as l,D as t}from"./index-729398ab-c88618b2.js";import{m as w}from"./index-7eca6f7f.js";import{_ as z}from"./FormPage.vue_vue_type_style_index_0_lang-61bbebf7.js";const F={class:"section-content"},U={class:"section-content"},C={class:"section-content"},E={class:"section-content"},W={class:"section-content"},k={class:"section-content"},q={class:"section-content"},y={class:"section-content"},S={name:"TextareaInputField"},B=V({...S,setup(D){const{t:f}=$(),g=w.string().min(15,{message:f("form.errors.input.min",{length:15})}),v={required:f("form.errors.input.required")},b={ignore_whitespace:!0,required:!0};let o=T({customRowsColsInput:m(),customValidationInput:m(),disabled:m("Disabled textarea input"),input:m(),inputWithValidation:m(),noLabelInput:m(),textInput:m()});return(n,r)=>{const I=h("router-link"),p=h("SshPre");return x(),_(z,{title:n.$t("form.label.textarea"),class:"demo"},{toolbar:u(()=>[a(I,{to:{name:"form"},class:"back"},{default:u(()=>[e(i(n.$t("common.back")),1)]),_:1})]),default:u(()=>[e(),l("section",null,[l("h2",null,i(n.$t("form.label.basicInput")),1),e(),l("div",F,[a(t(d),{modelValue:t(o).noLabelInput,"onUpdate:modelValue":r[0]||(r[0]=s=>t(o).noLabelInput=s),placeholder:n.$t("form.placeholder.input")},null,8,["modelValue","placeholder"]),e(),a(p,{language:"html-vue"},{default:u(()=>[e(`
          <template>
            <TextareaInput 
              v-model="input"
