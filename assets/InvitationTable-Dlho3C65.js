import{d as m,I as p,e as d,o as v,i as s,C as e,f as n,t as u,g as o,u as a,a0 as b,v as f}from"./index-DX2jmBYK.js";import{a as c}from"./data-CPcWa_8W.js";import{_ as g}from"./UserPage.vue_vue_type_style_index_0_lang-D9R9aFPO.js";import{i as y}from"./data-gOxi8Wva.js";const C={class:"section-content"},k=m({__name:"InvitationTable",setup(B){const l=["email","appId","role","invitedBy","expiresAt","status"];return(i,t)=>{const r=p("SshPre");return v(),d(g,{title:i.$t("user.label.invitationTable"),class:"demo-invitation-table"},{toolbar:s(()=>[o(a(f),{label:i.$t("common.back"),"icon-left":"pi pi-chevron-left",size:"medium",variant:"textOnly",onClick:t[0]||(t[0]=I=>i.$router.push("/user"))},null,8,["label"])]),default:s(()=>[t[4]||(t[4]=e()),n("section",null,[n("h2",null,u(i.$t("user.label.basic")),1),t[3]||(t[3]=e()),n("div",C,[o(a(b),{id:"invitation-table",apps:a(c),"columns-data":[{accessorKey:"invitedBy",maxWidth:"20rem",minWidth:"20rem",width:"20rem"}],"initial-sorting":[{id:"email",desc:!1}],"invitation-modal-title":i.$t("user.label.inviteUser"),invitations:a(y),"visible-columns":l,"persist-state":""},null,8,["apps","invitation-modal-title","invitations"]),t[2]||(t[2]=e()),o(r,{language:"html-vue"},{default:s(()=>t[1]||(t[1]=[e(`
          <template>
            <InvitationTable
              id="invitation-table"
              :apps="apps"
