import{E as i,$ as g}from"./DzangolabVue3Form.es-4259c31d.js";import{d as v,a7 as I,p as V,j as d,K as c,o as $,c as w,w as m,L as a,C as e,M as u,f as t,E as l}from"./index-8e1c3ab6-d459558c.js";import{m as y}from"./index-882509c2.js";import{_ as z}from"./FormPage.vue_vue_type_style_index_0_lang-b92c84d7.js";const _={class:"section-content"},E={class:"section-content"},U={class:"section-content"},k={class:"section-content"},S={class:"section-content"},T={class:"section-content"},W={name:"InputField"},P=v({...W,setup(C){const{t:f}=I(),b=y.string().min(3,{message:f("form.errors.input.min",{length:3})});let o=V({disabled:d("monorepo@gmail.com"),input:d(),inputWithValidation:d(),noLabelInput:d(),passwordInput:d()});return(n,s)=>{const h=c("router-link"),p=c("SshPre");return $(),w(z,{title:n.$t("form.label.input"),class:"demo"},{toolbar:m(()=>[a(h,{to:{name:"form"},class:"back"},{default:m(()=>[e(u(n.$t("common.back")),1)]),_:1})]),default:m(()=>[e(),t("section",null,[t("h2",null,u(n.$t("form.label.basicInput")),1),e(),t("div",_,[a(l(i),{modelValue:l(o).noLabelInput,"onUpdate:modelValue":s[0]||(s[0]=r=>l(o).noLabelInput=r),placeholder:n.$t("form.placeholder.username"),type:"text"},null,8,["modelValue","placeholder"]),e(),a(p,{language:"html-vue"},{default:m(()=>[e(`
          <template>
            <Input 
              v-model="username"
