import{j as d,$ as S}from"./DzangolabVue3Form.es-0950df2a.js";import{d as g,a7 as I,p as V,j as c,K as v,o as D,c as $,w as s,L as a,C as e,M as p,f as n,E as l}from"./index-8e1c3ab6-475a9ed5.js";import{m as E}from"./index-00a59c05.js";import{_ as F}from"./FormPage.vue_vue_type_style_index_0_lang-01c0d475.js";const N={class:"section-content"},H={class:"section-content"},B={class:"section-content"},P={class:"section-content"},z={class:"section-content"},_={class:"section-content"},G={class:"section-content"},R={class:"section-content"},U={name:"SelectInputField"},W=g({...U,setup(k){const{t:b}=I(),f=E.string({invalid_type_error:b("form.errors.multiSelect.invalid")}).array().min(1,{message:b("form.errors.multiSelect.invalid")});let o=V({disabled:c("DE"),disabledMultiSelect:c(["BE","DE"]),input:c(),inputWithValidation:c(),multiSelect:c(),noLabelInput:c()});const r=c([{value:"FR",label:"French"},{value:"DE",label:"German"},{value:"BE",label:"Dutch"},{value:"NP",label:"Nepali"},{value:"HI",label:"Hindi"}]);return(t,i)=>{const h=v("router-link"),m=v("SshPre");return D(),$(F,{title:t.$t("form.label.select"),class:"demo"},{toolbar:s(()=>[a(h,{to:{name:"form"},class:"back"},{default:s(()=>[e(p(t.$t("common.back")),1)]),_:1})]),default:s(()=>[e(),n("section",null,[n("h2",null,p(t.$t("form.label.basicInput")),1),e(),n("div",N,[a(l(d),{modelValue:l(o).noLabelInput,"onUpdate:modelValue":i[0]||(i[0]=u=>l(o).noLabelInput=u),options:r.value,placeholder:t.$t("form.placeholder.select")},null,8,["modelValue","options","placeholder"]),e(),a(m,{language:"html-vue"},{default:s(()=>[e(`
          <template>
            <SelectInput
              v-model="input"
              :options="options"
