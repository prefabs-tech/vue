import{d as p,r as u,o as b,c as m,w as i,a as l,t as d,f as e,g as n,h as t,a4 as s,a0 as v,a1 as h,_}from"./index-18749d74.js";const g=c=>(v("data-v-7444cb8f"),c=c(),h(),c),f={class:"section-content"},B={class:"section-content"},y={class:"section-content"},$={class:"section-content"},k={class:"container"},I={class:"section-content"},w={class:"container"},z={class:"section-content"},S={class:"container"},L={class:"section-content"},P={class:"container"},C={class:"section-content"},N={class:"container"},R=g(()=>l("i",{class:"pi pi-check"},null,-1)),V=g(()=>l("i",{class:"pi pi-times"},null,-1)),A=p({__name:"Index",setup(c){return(a,D)=>{const o=u("SshPre"),r=u("Page");return b(),m(r,{title:a.$t("ui.badge.title"),class:"demo-badge"},{default:i(()=>[l("section",null,[l("h2",null,d(a.$t("ui.badge.usage.basic")),1),e(),l("div",f,[n(o,{language:"html-vue"},{default:i(()=>[e(`
          <template>
            <Badge label="Basic" /> 
          </template>
