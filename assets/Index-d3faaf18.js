import{m as v,t as d,U as m}from"./DzangolabVue3Form.es-8aea225f.js";import{d as w,u as _,b as I,e as p,o as V,c as S,w as a,a as t,t as c,f as e,g as l,h as n,r as f}from"./index-0cbaa980.js";const y={class:"section-content"},F={class:"section-content"},$={class:"section-content"},z={class:"section-content"},U={class:"section-content"},k={class:"section-content"},P={name:"SwitchInput"},D=w({...P,setup(W){const{t:b}=_(),h=v.coerce.boolean().refine(o=>o===!0,{message:b("form.errors.switch.invalid")});let s=I({customStyleInput:p(),disabled:p(!0),input:p(),inputWithValidation:p(!1),noLabelInput:p()});return(o,u)=>{const r=f("SshPre"),g=f("Page");return V(),S(g,{title:o.$t("form.label.switch"),class:"demo"},{default:a(()=>[t("section",null,[t("h2",null,c(o.$t("form.label.basicInput")),1),e(),t("div",y,[l(r,{language:"html-vue"},{default:a(()=>[e(`
          <Form>
            <SwitchInput
              v-model="input"
            />
