import{A as u,M as p}from"./DzangolabVue3Form.es-579aa137.js";import{d as k,a7 as V,p as P,j as f,K as b,o as F,c as $,w as l,L as n,C as e,M as s,f as a,E as t}from"./index-8e1c3ab6-8617714e.js";import{m as w}from"./index-eb14ec17.js";import{_ as y}from"./FormPage.vue_vue_type_style_index_0_lang-cebf9516.js";const _={class:"section-content"},z={class:"section-content"},B={class:"section-content"},M={class:"section-content"},U={class:"section-content"},O={class:"section-content"},A={class:"section-content"},I={class:"section-content"},R={class:"section-content"},Y={class:"section-content"},j={class:"section-content"},S={class:"section-content"},C={class:"section-content"},L={class:"section-content"},T={name:"DatePickerInput"},q=k({...T,setup(N){const{t:v}=V(),g=w.coerce.date().max(new Date,{message:v("form.errors.datePicker.invalid")}),c=new Date,D=c;let r=P({appointmentDate:f(c),arrivalDate:f(),availableDatetime:f([c,new Date(D.setDate(D.getDate()+7))]),dateOfBirth:f(c),dateRange:f([c,new Date(D.setDate(D.getDate()+7))]),joinedDate:f(),month:f(),monthAndYear:f(),noLabelInput:f(),presentationDate:f(c),reportDate:f([c,new Date(D.setDate(D.getDate()+7))]),time:f(),year:f(c.getFullYear())});return(o,m)=>{const h=b("router-link"),d=b("SshPre");return F(),$(y,{title:o.$t("form.label.datePicker"),class:"demo"},{toolbar:l(()=>[n(h,{to:{name:"form"},class:"back"},{default:l(()=>[e(s(o.$t("common.back")),1)]),_:1})]),default:l(()=>[e(),a("section",null,[a("h2",null,s(o.$t("form.label.basicInput")),1),e(),a("div",_,[n(d,{language:"html-vue"},{default:l(()=>[e(`
          <Form>
            <DatePicker 
              v-model="input"
            />
        ...
        `)]),_:1}),e(),n(t(u),null,{default:l(()=>[n(t(p),{modelValue:t(r).arrivalDate,"onUpdate:modelValue":m[1]||(m[1]=i=>t(r).arrivalDate=i),label:o.$t("form.label.arrivalDate")},null,8,["modelValue","label"])]),_:1})])]),e(),a("section",null,[a("h2",null,s(o.$t("form.label.withI18n")),1),e(),a("div",B,[n(d,{language:"html-vue"},{default:l(()=>[e(`
          ...
          const { t } = useI18n();
          <\/script>
        `)]),_:1}),e(),n(t(u),null,{default:l(()=>[n(t(p),{modelValue:t(r).dateOfBirth,"onUpdate:modelValue":m[2]||(m[2]=i=>t(r).dateOfBirth=i),label:o.$t("form.label.dateOfBirth")},null,8,["modelValue","label"])]),_:1})])]),e(),a("section",null,[a("h2",null,s(o.$t("form.label.disabled")),1),e(),a("div",M,[n(d,{language:"html-vue"},{default:l(()=>[e(`
          <Form>
            <DatePicker 
              v-model="appointDate"
          ...
          <\/script>
        `)]),_:1}),e(),n(t(u),null,{default:l(()=>[n(t(p),{modelValue:t(r).appointmentDate,"onUpdate:modelValue":m[3]||(m[3]=i=>t(r).appointmentDate=i),label:o.$t("form.label.appointmentDate"),disabled:""},null,8,["modelValue","label"])]),_:1})])]),e(),a("section",null,[a("h2",null,s(o.$t("form.label.disableWeekDays")),1),e(),a("div",U,[n(d,{language:"html-vue"},{default:l(()=>[e(`
          <Form>
            <DatePicker 
        ...
        `)]),_:1}),e(),n(t(u),null,{default:l(()=>[n(t(p),{modelValue:t(r).presentationDate,"onUpdate:modelValue":m[4]||(m[4]=i=>t(r).presentationDate=i),"disabled-week-days":[6,0],label:o.$t("form.label.presentationDate")},null,8,["modelValue","label"])]),_:1})])]),e(),a("section",null,[a("h2",null,s(o.$t("form.label.customFormat")),1),e(),a("div",O,[n(d,{language:"html-vue"},{default:l(()=>[e(`
          ...
          const dateOfBirth = ref(new Date());
          <\/script>
        `)]),_:1}),e(),n(t(u),null,{default:l(()=>[n(t(p),{modelValue:t(r).dateOfBirth,"onUpdate:modelValue":m[5]||(m[5]=i=>t(r).dateOfBirth=i),format:"yyyy/MM/dd",label:o.$t("form.label.dateOfBirth")},null,8,["modelValue","label"])]),_:1})])]),e(),a("section",null,[a("h2",null,s(o.$t("form.label.dateRange")),1),e(),a("div",A,[n(d,{language:"html-vue"},{default:l(()=>[e(`
          <Form>
            <DatePicker 
              v-model="dateRange"
              label="Date range"
          ...
          <\/script>
        `)]),_:1}),e(),n(t(u),null,{default:l(()=>[n(t(p),{modelValue:t(r).dateRange,"onUpdate:modelValue":m[6]||(m[6]=i=>t(r).dateRange=i),label:o.$t("form.label.dateRange"),range:""},null,8,["modelValue","label"])]),_:1})])]),e(),a("section",null,[a("h2",null,s(o.$t("form.label.multiCalendars")),1),e(),a("div",I,[n(d,{language:"html-vue"},{default:l(()=>[e(`
          <Form>
            <DatePicker 
              v-model="reportDate"
              label="Report date"
