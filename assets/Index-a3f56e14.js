import{X as b,t as h}from"./DzangolabVue3Form.es-5cddabd8.js";import{d as k,a5 as g,p as C,j as c,J as y,o as I,c as V,w as u,K as i,D as l,ao as x,X as e,f as a,L as p}from"./index-729398ab-f7824fe4.js";import{m as $}from"./index-9966f943.js";import{_ as S}from"./FormPage.vue_vue_type_style_index_0_lang-2120d4bb.js";const z={class:"section-content"},O={class:"section-content"},_={class:"section-content"},L={class:"section-content"},B={name:"CheckboxInput"},F=k({...B,setup(w){const{t:n}=g(),f=$.string().array().min(6,{message:n("form.errors.checkbox.min",{min:6})});let r=C({disabled:c(["car"]),inputWithValidation:c(),multiCheckbox:c([]),noLabelInput:c()});const v=[{label:n("form.label.title"),value:1},{label:n("form.label.solutions"),value:2},{label:n("form.label.deliverableList"),value:3},{label:n("form.label.workInProgress"),value:4},{label:n("form.label.summary"),value:5},{label:n("form.label.next"),value:6},{label:n("form.label.assumptions"),value:7},{label:n("form.label.generalQuestions"),value:8},{label:n("form.label.consequences"),value:9},{label:n("form.label.other"),value:10}],d=[{label:n("form.label.bike"),value:"bike"},{label:n("form.label.car"),value:"car"},{label:n("form.label.truck"),value:"truck"}];return(t,o)=>{const m=y("SshPre");return I(),V(S,{title:t.$t("form.label.checkbox"),class:"demo"},{toolbar:u(()=>[i(l(x),{label:t.$t("common.back"),"icon-left":"pi pi-chevron-left",size:"medium",variant:"textOnly",onClick:o[0]||(o[0]=s=>t.$router.push("/form"))},null,8,["label"])]),default:u(()=>[e(),a("section",null,[a("h2",null,p(t.$t("form.label.basicInput")),1),e(),a("div",z,[i(l(b),{checked:l(r).noLabelInput,"onUpdate:checked":o[1]||(o[1]=s=>l(r).noLabelInput=s),"input-label":t.$t("form.label.accept"),name:"basic"},null,8,["checked","input-label"]),e(),i(m,{language:"html-vue"},{default:u(()=>[e(`
          <template>
            <CheckboxInput
        ...
        `)]),_:1}),e()])]),e(),a("section",null,[a("h2",null,p(t.$t("form.label.disabled")),1),e(),a("div",_,[i(l(b),{modelValue:l(r).disabled,"onUpdate:modelValue":o[3]||(o[3]=s=>l(r).disabled=s),label:t.$t("form.label.vehicle"),options:d,direction:"horizontal",disabled:"",name:"disabled-checkbox"},null,8,["modelValue","label"]),e(),i(m,{language:"html-vue"},{default:u(()=>[e(`
          ...
          <\/script>
        `)]),_:1}),e()])]),e(),a("section",null,[a("h2",null,p(t.$t("form.label.inputWithValidation")),1),e(),a("div",L,[i(l(h),null,{default:u(()=>[i(l(b),{modelValue:l(r).inputWithValidation,"onUpdate:modelValue":o[4]||(o[4]=s=>l(r).inputWithValidation=s),label:t.$t("form.label.dailySynchro"),options:v,schema:l(f),name:"daily-synchro"},null,8,["modelValue","label","schema"])]),_:1}),e(),i(m,{language:"html-vue"},{default:u(()=>[e(`
          <template>
            <Form>
              <CheckboxInput
                v-model="input"
