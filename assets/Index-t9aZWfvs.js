import{W as r,F as f}from"./DzangolabVue3Form.es-BjYrQu0V.js";import{d as V,A as $,B as z,C as T,r as m,z as F,e as x,o as U,w as i,D as t,f as o,t as d,h as u,u as l,p as q}from"./index-Bq7LBzNw.js";import{_ as w}from"./FormPage.vue_vue_type_style_index_0_lang-Blw15sAT.js";const E={class:"section-content"},O={class:"section-content"},S={class:"section-content"},W={class:"section-content"},C={class:"section-content"},k={class:"section-content"},y={class:"section-content"},B={name:"TextInputField"},h=V({...B,setup(D){const{t:b}=$(),I=z.string().length(5,{message:b("form.errors.input.length",{length:5})}),v={required:b("form.errors.input.required")},g={ignore_whitespace:!0,required:!0};let a=T({customValidationInput:m(),disabled:m("dzangolab"),input:m(),inputWithValidation:m(),noLabelInput:m(),textInput:m()});return(e,n)=>{const s=F("SshPre");return U(),x(w,{title:e.$t("form.label.textInput"),class:"demo"},{toolbar:i(()=>[u(l(q),{label:e.$t("common.back"),"icon-left":"pi pi-chevron-left",size:"medium",variant:"textOnly",onClick:n[0]||(n[0]=p=>e.$router.push("/form"))},null,8,["label"])]),default:i(()=>[n[29]||(n[29]=t()),o("section",null,[o("h2",null,d(e.$t("form.label.basicInput")),1),n[10]||(n[10]=t()),o("div",E,[u(l(r),{modelValue:l(a).noLabelInput,"onUpdate:modelValue":n[1]||(n[1]=p=>l(a).noLabelInput=p),placeholder:e.$t("form.placeholder.input")},null,8,["modelValue","placeholder"]),n[9]||(n[9]=t()),u(s,{language:"html-vue"},{default:i(()=>n[8]||(n[8]=[t(`
          <template>
            <TextInput 
              v-model="input"
