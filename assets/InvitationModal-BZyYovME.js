import{d as h,L as D,M as P,o as k,e as B,f as a,h as l,t as m,z as t,a as o,u as s,l as d,Z as v,r as p,Y as R}from"./index-He64vdhC.js";import{_ as A}from"./UserPage.vue_vue_type_style_index_0_lang-DGl006Pv.js";const U={class:"section-content"},N={class:"section-content"},C={class:"section-content"},O={class:"section-content"},F={class:"section-content"},T={class:"section-content"},V={class:"section-content"},L=h({__name:"InvitationModal",setup(W){const{t:S}=D(),f=p(!1),b=p(!1),w=p(!1),M=p(!1),I=p(!1),y=p(!1),$=p(!1),g=[{id:1,name:"ADMIN"},{id:2,name:"SUPERADMIN"},{id:3,name:"USER"}],E=[{id:1,name:"Admin",origin:"admin-origin",supportedRoles:[{id:1,name:"ADMIN"},{id:2,name:"SUPERADMIN"}]},{id:2,name:"User",origin:"user-origin",supportedRoles:[{id:3,name:"USER"}]}],r=e=>{R(S("user.message.invitation.success",{user:e.email}),{type:"success"}),f.value=!1,b.value=!1,w.value=!1,M.value=!1,I.value=!1,y.value=!1,$.value=!1};return(e,n)=>{const u=P("SshPre");return k(),B(A,{title:e.$t("user.label.invitationModal"),class:"demo-invitation-modal"},{default:a(()=>[l("section",null,[l("h2",null,m(e.$t("user.label.basic")),1),n[17]||(n[17]=t()),l("div",U,[o(s(d),{label:e.$t("user.label.invite"),onClick:n[0]||(n[0]=i=>I.value=!0)},null,8,["label"]),n[15]||(n[15]=t()),o(s(v),{show:I.value,"onOn:close":n[1]||(n[1]=i=>I.value=!1),onSubmit:r},null,8,["show"]),n[16]||(n[16]=t()),o(u,{language:"html-vue"},{default:a(()=>[...n[14]||(n[14]=[t(`
          <template>
            <ButtonElement
              label="Invite"
