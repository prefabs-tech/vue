import{d as m,H as f,e as v,o as C,j as s,B as e,f as n,h as r,t as i,u as l,N as d,v as $}from"./index-CVH4OLxf.js";import{_ as g}from"./ComponentDocumentation.vue_vue_type_script_setup_true_lang-C_Qa-nj1.js";import{_ as b}from"./UiPage.vue_vue_type_style_index_0_lang-DZzGP3QU.js";import"./PrefabsTechVue3TanstackTable.es-CcclW_bq.js";import"./PrefabsTechVue3Form.es-kbbaSG9O.js";const c={class:"section-content"},h={class:"content"},S={class:"section-content"},y={class:"content"},I={class:"section-content"},k={class:"content"},B={class:"section-content"},D={class:"title"},N={class:"content"},w={class:"footer"},O=m({__name:"Index",setup(P){const p=[{default:"-",description:"Title text displayed in the card header. Ignored if header slot is provided.",prop:"title",type:"String"}],u=[{description:"Default slot for the main body content of the card.",name:"default"},{description:"Slot for custom footer content, rendered at the bottom of the card.",name:"footer"},{description:"Slot for custom header content, replaces the default title if provided.",name:"header"}];return(o,t)=>{const a=f("SshPre");return C(),v(b,{"sub-title":o.$t("ui.card.subtitle"),title:o.$t("ui.card.title"),class:"demo"},{toolbar:s(()=>[r(l($),{label:o.$t("common.back"),"icon-left":"pi pi-chevron-left",size:"medium",variant:"textOnly",onClick:t[0]||(t[0]=T=>o.$router.push("/ui"))},null,8,["label"])]),default:s(()=>[t[15]||(t[15]=e()),n("section",null,[n("h2",null,i(o.$t("ui.card.usage.basic")),1),t[3]||(t[3]=e()),n("div",c,[r(l(d),null,{default:s(()=>[n("p",h,i(o.$t("ui.card.content")),1)]),_:1}),t[2]||(t[2]=e()),r(a,{language:"html-vue"},{default:s(()=>t[1]||(t[1]=[e(`
        ...
        `)])),_:1})])]),t[17]||(t[17]=e()),n("section",null,[n("h2",null,i(o.$t("ui.card.usage.withI18n")),1),t[9]||(t[9]=e()),n("div",I,[r(l(d),{title:o.$t("ui.card.headerContent")},{default:s(()=>[n("p",k,i(o.$t("ui.card.content")),1)]),_:1},8,["title"]),t[8]||(t[8]=e()),r(a,{language:"html-vue"},{default:s(()=>t[7]||(t[7]=[e(`
          ...
          const { t } = useI18n();
          <\/script>
        `)])),_:1})])]),t[18]||(t[18]=e()),n("section",null,[n("h2",null,i(o.$t("ui.card.usage.slots")),1),t[14]||(t[14]=e()),n("div",B,[r(l(d),null,{header:s(()=>[n("h3",D,i(o.$t("ui.card.headerContent")),1)]),footer:s(()=>[n("div",w,i(o.$t("ui.card.footerContent")),1)]),default:s(()=>[t[10]||(t[10]=e()),n("p",N,i(o.$t("ui.card.content")),1),t[11]||(t[11]=e())]),_:1}),t[13]||(t[13]=e()),r(a,{language:"html-vue"},{default:s(()=>t[12]||(t[12]=[e(`
          <template>
            <Card>
              <template #header>
                <h3>Lorem ipsum</h3>
          ...
          import { Card } from "@prefabs.tech/vue3-ui";
          <\/script>
        `)])),_:1})])]),t[19]||(t[19]=e()),r(g,{"props-data":p,"props-table-title":o.$t("common.properties",{value:"CardProperties"}),"slots-data":u},null,8,["props-table-title"])]),_:1},8,["sub-title","title"])}}});export{O as default};
