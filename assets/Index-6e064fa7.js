import{d as r,r as u,o as d,c as g,w as e,a as o,t as l,f as t,g as i,h as s,a5 as m,af as p}from"./index-66a9a14b.js";const v={class:"section-content"},h={class:"section-content"},_={class:"trigger"},f={class:"section-content"},T={class:"trigger"},b={class:"section-content"},$={class:"trigger"},y={class:"section-content"},z={class:"trigger"},k={class:"section-content"},B={class:"trigger"},C={class:"section-content"},P={class:"trigger"},S={class:"section-content"},V={class:"trigger"},E=r({__name:"Index",setup(w){return(n,N)=>{const a=u("SshPre"),c=u("Page");return d(),g(c,{title:n.$t("ui.tooltip.title"),class:"demo"},{default:e(()=>[o("section",null,[o("h2",null,l(n.$t("ui.tooltip.usage.basic")),1),t(),o("div",v,[i(a,{language:"html-vue"},{default:e(()=>[t(`
          <template>
            <Tooltip>
              <ButtonElement
                :label="Tooltip"
        ...
        `)]),_:1}),t(),i(s(p),{clickable:""},{content:e(()=>[t(l(n.$t("ui.tooltip.content")),1)]),default:e(()=>[o("div",B,l(n.$t("ui.tooltip.usage.clickable")),1),t()]),_:1})])]),t(),o("section",null,[o("h2",null,l(n.$t("ui.tooltip.usage.delay")),1),t(),o("div",C,[i(a,{language:"html-vue"},{default:e(()=>[t(`
          ...
          import { Tooltip } from "@dzangolab/vue3-ui";
          <\/script>
        `)]),_:1}),t(),i(s(p),{delay:1e3},{content:e(()=>[t(l(n.$t("ui.tooltip.content")),1)]),default:e(()=>[o("div",P,l(n.$t("ui.tooltip.label.delay")),1),t()]),_:1})])]),t(),o("section",null,[o("h2",null,l(n.$t("ui.tooltip.usage.customStyle")),1),t(),o("div",S,[i(a,{language:"html-vue"},{default:e(()=>[t(`
          <template>
        ...
        `)]),_:1}),t(),i(s(p),{class:"custom-style-tooltip"},{content:e(()=>[t(l(n.$t("ui.tooltip.content")),1)]),default:e(()=>[o("div",V,l(n.$t("ui.tooltip.label.custom")),1),t()]),_:1})])])]),_:1},8,["title"])}}});export{E as default};
