import{m as V,e as p,Q as d}from"./DzangolabVue3Form.es-890891a3.js";import{d as x,u as _,b as $,e as c,r as h,o as T,c as F,w as o,a as t,t as m,f as n,g as l,h as e}from"./index-fd38b0f1.js";const y={class:"section-content"},w={class:"section-content"},z={class:"section-content"},S={class:"section-content"},U={class:"section-content"},E={class:"section-content"},C={class:"section-content"},q={class:"section-content"},O={class:"section-content"},D={name:"TextareaInputField"},W=x({...D,setup(M){const{t:f}=_(),g=V.string().min(15,{message:f("form.errors.input.min",{length:15})}),v={required:f("form.errors.input.required")},b={ignore_whitespace:!0,required:!0};let u=$({customRowsColsInput:c(),customStyleInput:c(),customValidationInput:c(),disabled:c("Disabled textarea input"),input:c(),inputWithValidation:c(),noLabelInput:c(),textInput:c()});return(a,r)=>{const i=h("SshPre"),I=h("Page");return T(),F(I,{title:a.$t("form.label.textarea"),class:"demo"},{default:o(()=>[t("section",null,[t("h2",null,m(a.$t("form.label.basicInput")),1),n(),t("div",y,[l(i,{language:"html-vue"},{default:o(()=>[n(`
          <Form>
            <TextareaInput 
              v-model="input"
