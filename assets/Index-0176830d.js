import{m as v,J as d,Z as i}from"./DzangolabVue3Form.es-e605564e.js";import{d as I,a4 as V,l as $,j as f,G as c,o as F,c as _,w as o,K as n,C as e,S as m,f as a,D as l}from"./index-9834d213-45de56a4.js";import{_ as w}from"./FormPage.vue_vue_type_style_index_0_lang-ab5ae344.js";import"./index-3d10c2c3.js";const y={class:"section-content"},z={class:"section-content"},S={class:"section-content"},U={class:"section-content"},k={class:"section-content"},E={class:"section-content"},T={name:"InputField"},N=I({...T,setup(W){const{t:b}=V(),h=v.string().min(3,{message:b("form.errors.input.min",{length:3})});let r=$({disabled:f("monorepo@gmail.com"),input:f(),inputWithValidation:f(),noLabelInput:f(),passwordInput:f()});return(t,s)=>{const g=c("router-link"),p=c("SshPre");return F(),_(w,{title:t.$t("form.label.input"),class:"demo"},{toolbar:o(()=>[n(g,{to:{name:"form"},class:"back"},{default:o(()=>[e(m(t.$t("common.back")),1)]),_:1})]),default:o(()=>[e(),a("section",null,[a("h2",null,m(t.$t("form.label.basicInput")),1),e(),a("div",y,[n(p,{language:"html-vue"},{default:o(()=>[e(`
          <Form>
            <Input 
              v-model="username"
        ...
        `)]),_:1}),e(),n(l(i),null,{default:o(()=>[n(l(d),{modelValue:l(r).passwordInput,"onUpdate:modelValue":s[2]||(s[2]=u=>l(r).passwordInput=u),label:t.$t("form.label.password"),placeholder:t.$t("form.placeholder.password"),type:"password"},null,8,["modelValue","label","placeholder"])]),_:1})])]),e(),a("section",null,[a("h2",null,m(t.$t("form.label.disabled")),1),e(),a("div",U,[n(p,{language:"html-vue"},{default:o(()=>[e(`
          ...
          import { Input } from "@dzangolab/vue3-form";
          <\/script>
        `)]),_:1}),e(),n(l(i),null,{default:o(()=>[n(l(d),{modelValue:l(r).disabled,"onUpdate:modelValue":s[3]||(s[3]=u=>l(r).disabled=u),label:t.$t("form.label.email"),type:"email",disabled:""},null,8,["modelValue","label"])]),_:1})])]),e(),a("section",null,[a("h2",null,m(t.$t("form.label.withI18n")),1),e(),a("div",k,[n(p,{language:"html-vue"},{default:o(()=>[e(`
          <Form>
            <Input 
              v-model="username"
        ...
        `)]),_:1}),e(),n(l(i),null,{default:o(()=>[n(l(d),{modelValue:l(r).input,"onUpdate:modelValue":s[4]||(s[4]=u=>l(r).input=u),label:t.$t("form.label.username"),placeholder:t.$t("form.placeholder.username")},null,8,["modelValue","label","placeholder"])]),_:1})])]),e(),a("section",null,[a("h2",null,m(t.$t("form.label.inputWithValidation")),1),e(),a("div",E,[n(p,{language:"html-vue"},{default:o(()=>[e(`
          ...
          <\/script>
        `)]),_:1}),e(),n(l(i),null,{default:o(()=>[n(l(d),{modelValue:l(r).inputWithValidation,"onUpdate:modelValue":s[5]||(s[5]=u=>l(r).inputWithValidation=u),label:t.$t("form.label.title"),placeholder:t.$t("form.placeholder.title"),schema:l(h),name:"title",type:"text"},null,8,["modelValue","label","placeholder","schema"])]),_:1})])])]),_:1},8,["title"])}}});export{N as default};
