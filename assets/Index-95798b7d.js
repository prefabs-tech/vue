import{$ as d,V as p}from"./DzangolabVue3Form.es-509b5a30.js";import{d as g,a7 as V,p as w,j as c,K as f,o as I,c as S,w as a,L as n,C as l,M as r,f as t,E as e}from"./index-8e1c3ab6-8617714e.js";import{m as _}from"./index-2cd4e8f8.js";import{_ as $}from"./FormPage.vue_vue_type_style_index_0_lang-0602a146.js";const F={class:"section-content"},z={class:"section-content"},k={class:"section-content"},U={class:"section-content"},C={class:"section-content"},L={name:"SwitchInput"},j=g({...L,setup(W){const{t:b}=V(),h=_.coerce.boolean().refine(o=>o===!0,{message:b("form.errors.switch.invalid")});let s=w({disabled:c(!0),input:c(),inputWithValidation:c(!1),noLabelInput:c()});return(o,i)=>{const v=f("router-link"),m=f("SshPre");return I(),S($,{title:o.$t("form.label.switch"),class:"demo"},{toolbar:a(()=>[n(v,{to:{name:"form"},class:"back"},{default:a(()=>[l(r(o.$t("common.back")),1)]),_:1})]),default:a(()=>[l(),t("section",null,[t("h2",null,r(o.$t("form.label.basicInput")),1),l(),t("div",F,[n(m,{language:"html-vue"},{default:a(()=>[l(`
          <Form>
            <SwitchInput
              v-model="input"
            />
