import{s as b,l as v}from"./DzangolabVue3Form.es-db631682.js";import{d as h,a5 as g,p as S,j as p,J as V,o as I,c as $,w as s,K as u,D as l,ao as L,W as e,f as a,L as d,O as z,b as F}from"./index-729398ab-b294403d.js";import{m as D}from"./index-6bf42b23.js";import{_ as N}from"./FormPage.vue_vue_type_style_index_0_lang-c07c697e.js";const U={class:"section-content"},G={class:"section-content"},H={class:"section-content"},W={class:"section-content"},y={class:"section-content"},k={class:"section-content"},w={class:"section-content"},C={class:"section-content"},M={class:"section-content"},P={class:"section-content"},B=a("i",{class:"pi pi-user"},null,-1),O={class:"section-content"},j={name:"SelectInputField"},Q=h({...j,setup(J){const{t:c}=g(),f=D.string({invalid_type_error:c("form.errors.multiselect.invalid")}).array().min(1,{message:c("form.errors.multiselect.invalid")});let i=S({customLabelSelect:p(),disabled:p("de"),disabledMultiselect:p(["be","de"]),disabledSortInput:p(),i18nSelect:p(),input:p(),inputWithValidation:p([]),multiselect:p(),multiselectSearch:p(),noLabelInput:p(),selectWithSearch:p()});const r=p([{label:c("form.label.french"),value:"fr"},{label:c("form.label.german"),value:"de"},{disabled:!0,label:c("form.label.dutch"),value:"be"},{label:c("form.label.nepali"),value:"np"},{label:c("form.label.hindi"),value:"hi"}]);return(n,o)=>{const m=V("SshPre");return I(),$(N,{title:n.$t("form.label.select"),class:"demo"},{toolbar:s(()=>[u(l(L),{label:n.$t("common.back"),"icon-left":"pi pi-chevron-left",size:"medium",variant:"textOnly",onClick:o[0]||(o[0]=t=>n.$router.push("/form"))},null,8,["label"])]),default:s(()=>[e(),a("section",null,[a("h2",null,d(n.$t("form.label.basicInput")),1),e(),a("div",U,[u(l(b),{modelValue:l(i).noLabelInput,"onUpdate:modelValue":o[1]||(o[1]=t=>l(i).noLabelInput=t),options:r.value,placeholder:n.$t("form.placeholder.language")},null,8,["modelValue","options","placeholder"]),e(),u(m,{language:"html-vue"},{default:s(()=>[e(`
          <template>
            <SelectInput
              v-model="input"
              :options="options"
        ...
        `)]),_:1}),e()])]),e(),a("section",null,[a("h2",null,d(n.$t("form.label.customLabel")),1),e(),a("div",P,[u(l(b),{modelValue:l(i).customLabelSelect,"onUpdate:modelValue":o[10]||(o[10]=t=>l(i).customLabelSelect=t),label:n.$t("form.label.language"),options:r.value,placeholder:n.$t("form.placeholder.language"),multiple:""},z({_:2},[F(r.value,(t,K)=>({name:t.value,fn:s(()=>[a("span",null,[B,e(" "+d(t.label),1)])])}))]),1032,["modelValue","label","options","placeholder"]),e(),u(m,{language:"html-vue"},{default:s(()=>[e(`
          ...
          <\/script>
        `)]),_:1}),e()])]),e(),a("section",null,[a("h2",null,d(n.$t("form.label.inputWithValidation")),1),e(),a("div",O,[u(l(v),null,{default:s(()=>[u(l(b),{modelValue:l(i).inputWithValidation,"onUpdate:modelValue":o[11]||(o[11]=t=>l(i).inputWithValidation=t),label:n.$t("form.label.language"),options:r.value,placeholder:n.$t("form.placeholder.languages"),schema:l(f),multiple:""},null,8,["modelValue","label","options","placeholder","schema"])]),_:1}),e(),u(m,{language:"html-vue"},{default:s(()=>[e(`
          <Form>
            <SelectInput 
              v-model="input"
              :options="options"
