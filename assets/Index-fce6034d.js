import{d as _,j as p,J as v,o as y,c as B,w as o,K as n,W as e,L as u,f as t,D as a,aq as i,ao as E,ap as $}from"./index-35228b09-5de2cbe6.js";import{_ as z}from"./UiPage.vue_vue_type_style_index_0_lang-e3d60a97.js";import{_ as k}from"./index-e4278714.js";const d=r=>(E("data-v-dc56084d"),r=r(),$(),r),O={class:"section-content"},S={class:"container"},C={class:"section-content"},I={class:"container"},w={class:"section-content"},D={class:"container"},L={class:"section-content"},T={class:"container"},N={class:"section-content"},P={class:"container"},R={class:"section-content"},M={class:"container"},V={class:"section-content"},W={class:"container"},A={class:"section-content"},H={className:"container"},j={class:"section-content"},q={className:"container"},J=d(()=>t("i",{class:"pi pi-user"},null,-1)),K=d(()=>t("i",{class:"pi pi-user"},null,-1)),F=d(()=>t("i",{class:"pi pi-user"},null,-1)),G={class:"section-content"},Q={class:"container"},U={class:"section-content"},X={class:"container"},Y={class:"container"},Z={class:"section-content"},x={class:"container"},ee=_({__name:"Index",setup(r){const m=p(void 0),c=p(!1),g=()=>{m.value=new Date},h=()=>{c.value=!0,setTimeout(()=>{c.value=!1},5e3)};return(l,b)=>{const f=v("router-link"),s=v("SshPre");return y(),B(z,{title:l.$t("ui.button.title"),class:"demo-button"},{toolbar:o(()=>[n(f,{to:{name:"ui"},class:"back"},{default:o(()=>[e(u(l.$t("common.back")),1)]),_:1})]),default:o(()=>[e(),t("section",null,[t("h2",null,u(l.$t("ui.button.usage.basic")),1),e(),t("div",O,[t("div",S,[n(a(i),{label:l.$t("ui.button.label.clickMe"),onClick:b[0]||(b[0]=te=>g())},null,8,["label"]),e(),t("span",null,u(m.value),1)]),e(),n(s,{language:"html-vue"},{default:o(()=>[e(`
          <template> 
          ...
          <\/script>
        `)]),_:1}),e()])]),e(),t("section",null,[t("h2",null,u(l.$t("ui.button.usage.withI18n")),1),e(),t("div",C,[t("div",I,[n(a(i),{label:l.$t("ui.button.label.next")},null,8,["label"])])]),e(),n(s,{language:"html-vue"},{default:o(()=>[e(`
        <template> 
        ...
        <script setup lang="ts"> 
          ...
          const { t } = useI18n();
        <\/script>
      `)]),_:1}),e()]),e(),t("section",null,[t("h2",null,u(l.$t("ui.button.usage.loading")),1),e(),t("div",w,[t("div",D,[n(a(i),{label:l.$t("ui.button.label.submit"),loading:c.value,onClick:h},null,8,["label","loading"])]),e(),n(s,{language:"html-vue"},{default:o(()=>[e(`
          <template>
            <ButtonElement
              :loading="loading"
              label="Submit"
