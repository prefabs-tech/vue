import{D as m,C as V}from"./PrefabsTechVue3Form.es-DchXesOb.js";import{d as I,H as $,J as y,L as D,r as f,I as w,e as S,o as h,j as i,C as t,f as o,h as p,t as d,u as l,v as C}from"./index-BU6iKU0F.js";import{_ as U}from"./ComponentDocumentation.vue_vue_type_script_setup_true_lang-CVfcli2c.js";import{_ as z}from"./FormPage.vue_vue_type_style_index_0_lang-1YuQwfrR.js";import"./PrefabsTechVue3TanstackTable.es-aLEdQvle.js";const T={class:"section-content"},E={class:"section-content"},W={class:"section-content"},k={class:"section-content"},B={class:"section-content"},F={class:"section-content"},L={name:"InputField"},Z=I({...L,setup(P){const{t:s}=$(),b=[{description:s("form.documentation.eventDescription.input.modelValue"),name:"update:modelValue",payload:"string | null | undefined"}],v=y.string().min(3,{message:s("form.errors.input.min",{length:3})}),g=[{default:"false",description:s("form.documentation.propsDescription.input.disabled"),prop:"disabled",type:"Boolean"},{default:"-",description:s("form.documentation.propsDescription.input.label"),prop:"label",type:"String"},{default:"-",description:s("form.documentation.propsDescription.input.modelValue"),prop:"modelValue",type:"String | null | undefined"},{default:'"input"',description:s("form.documentation.propsDescription.input.name"),prop:"name",type:"String"},{default:"-",description:s("form.documentation.propsDescription.input.placeholder"),prop:"placeholder",type:"String"},{default:"-",description:s("form.documentation.propsDescription.input.schema"),prop:"schema",type:"z.ZodType<string | number | object>"},{default:'"text"',description:s("form.documentation.propsDescription.input.type"),prop:"type",type:"String"}];let r=D({disabled:f("monorepo@gmail.com"),input:f(),inputWithValidation:f(),noLabelInput:f(),passwordInput:f()});return(n,e)=>{const u=w("SshPre");return h(),S(z,{subtitle:l(s)("form.subtitle.input"),title:n.$t("form.label.input"),class:"demo"},{toolbar:i(()=>[p(l(C),{label:n.$t("common.back"),"icon-left":"pi pi-chevron-left",size:"medium",variant:"textOnly",onClick:e[0]||(e[0]=a=>n.$router.push("/form"))},null,8,["label"])]),default:i(()=>[e[25]||(e[25]=t()),o("section",null,[o("h2",null,d(n.$t("form.label.basicInput")),1),e[9]||(e[9]=t()),o("div",T,[p(l(m),{modelValue:l(r).noLabelInput,"onUpdate:modelValue":e[1]||(e[1]=a=>l(r).noLabelInput=a),placeholder:n.$t("form.placeholder.username"),name:"basic",type:"text"},null,8,["modelValue","placeholder"]),e[8]||(e[8]=t()),p(u,{language:"html-vue"},{default:i(()=>e[7]||(e[7]=[t(`
        ...
        `)])),_:1})])]),e[30]||(e[30]=t()),o("section",null,[o("h2",null,d(n.$t("form.label.inputWithValidation")),1),e[24]||(e[24]=t()),o("div",F,[p(l(V),null,{default:i(()=>[p(l(m),{modelValue:l(r).inputWithValidation,"onUpdate:modelValue":e[6]||(e[6]=a=>l(r).inputWithValidation=a),label:n.$t("form.label.title"),placeholder:n.$t("form.placeholder.title"),schema:l(v),name:"title",type:"text"},null,8,["modelValue","label","placeholder","schema"])]),_:1}),e[23]||(e[23]=t()),p(u,{language:"html-vue"},{default:i(()=>e[22]||(e[22]=[t(`
          ...
          <\/script>
        `)])),_:1})])]),e[31]||(e[31]=t()),p(U,{"events-data":b,"props-data":g,"props-table-title":n.$t("common.properties",{value:"InputProperties"})},null,8,["props-table-title"])]),_:1},8,["subtitle","title"])}}});export{Z as default};
