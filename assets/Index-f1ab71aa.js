import{d as r,J as d,o as g,c as m,w as o,K as l,D as s,ao as c,W as t,f as n,L as i,aI as p}from"./index-729398ab-b294403d.js";import{_ as v}from"./UiPage.vue_vue_type_style_index_0_lang-ae0d4afa.js";const h={class:"section-content"},f={class:"section-content"},_={class:"trigger"},T={class:"section-content"},b={class:"trigger"},$={class:"section-content"},y={class:"trigger"},k={class:"section-content"},z={class:"trigger"},B={class:"section-content"},C={class:"trigger"},w={class:"section-content"},D={class:"trigger"},E=r({__name:"Index",setup(I){return(e,u)=>{const a=d("SshPre");return g(),m(v,{title:e.$t("ui.tooltip.title"),class:"demo"},{toolbar:o(()=>[l(s(c),{label:e.$t("common.back"),"icon-left":"pi pi-chevron-left",size:"medium",variant:"textOnly",onClick:u[0]||(u[0]=N=>e.$router.push("/ui"))},null,8,["label"])]),default:o(()=>[t(),n("section",null,[n("h2",null,i(e.$t("ui.tooltip.usage.basic")),1),t(),n("div",h,[l(s(p),null,{content:o(()=>[t(i(e.$t("ui.tooltip.content")),1)]),default:o(()=>[l(s(c),{label:e.$t("ui.tooltip.label.button"),severity:"success"},null,8,["label"]),t()]),_:1}),t(),l(a,{language:"html-vue"},{default:o(()=>[t(`
          <template>
            <Tooltip>
              <ButtonElement
                :label="Tooltip"
