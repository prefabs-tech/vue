import{n as d,J as h}from"./DzangolabVue3Form.es-51baa5bd.js";import{d as S,a7 as V,p as I,j as c,K as f,o as $,c as F,w as s,L as t,C as e,M as r,f as n,E as l}from"./index-4dbfb8c7-0110dc13.js";import{m as z}from"./index-f3c29e5f.js";import{_ as L}from"./FormPage.vue_vue_type_style_index_0_lang-328842f1.js";const N={class:"section-content"},_={class:"section-content"},D={class:"section-content"},U={class:"section-content"},G={class:"section-content"},H={class:"section-content"},k={class:"section-content"},y={class:"section-content"},M={name:"SelectInputField"},J=S({...M,setup(C){const{t:b}=V(),v=z.string({invalid_type_error:b("form.errors.multiSelect.invalid")}).array().min(1,{message:b("form.errors.multiSelect.invalid")});let o=I({disabled:c("de"),disabledMultiSelect:c(["be","de"]),input:c(),inputWithValidation:c(),multiSelect:c(),noLabelInput:c()});const p=c([{value:"fr",label:b("form.label.french")},{value:"de",label:b("form.label.german")},{value:"be",label:b("form.label.dutch")},{value:"np",label:b("form.label.nepali")},{value:"hi",label:b("form.label.hindi")}]);return(a,u)=>{const g=f("router-link"),m=f("SshPre");return $(),F(L,{title:a.$t("form.label.select"),class:"demo"},{toolbar:s(()=>[t(g,{to:{name:"form"},class:"back"},{default:s(()=>[e(r(a.$t("common.back")),1)]),_:1})]),default:s(()=>[e(),n("section",null,[n("h2",null,r(a.$t("form.label.basicInput")),1),e(),n("div",N,[t(l(d),{modelValue:l(o).noLabelInput,"onUpdate:modelValue":u[0]||(u[0]=i=>l(o).noLabelInput=i),options:p.value,placeholder:a.$t("form.placeholder.language")},null,8,["modelValue","options","placeholder"]),e(),t(m,{language:"html-vue"},{default:s(()=>[e(`
          <template>
            <SelectInput
              v-model="input"
              :options="options"
          ...
          <\/script>
        `)]),_:1}),e()])]),e(),n("section",null,[n("h2",null,r(a.$t("form.label.labelInput")),1),e(),n("div",_,[t(l(d),{modelValue:l(o).input,"onUpdate:modelValue":u[1]||(u[1]=i=>l(o).input=i),label:a.$t("form.label.language"),options:p.value,placeholder:a.$t("form.placeholder.language")},null,8,["modelValue","label","options","placeholder"]),e(),t(m,{language:"html-vue"},{default:s(()=>[e(`
          <template>
            <SelectInput 
              v-model="input"
              :options="options"
          ...
          <\/script>
        `)]),_:1}),e()])]),e(),n("section",null,[n("h2",null,r(a.$t("form.label.disabled")),1),e(),n("div",D,[t(l(d),{modelValue:l(o).disabled,"onUpdate:modelValue":u[2]||(u[2]=i=>l(o).disabled=i),label:a.$t("form.label.language"),options:p.value,disabled:""},null,8,["modelValue","label","options"]),e(),t(m,{language:"html-vue"},{default:s(()=>[e(`
          <template>
            <SelectInput 
              v-model="disabled"
              :options="options"
