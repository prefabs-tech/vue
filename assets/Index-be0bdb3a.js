import{d as g,u as w,b as v,e as d,o as S,c as V,w as u,a as s,t as r,f as e,g as l,h as t,r as c}from"./index-3bb8d7f9.js";import{m as _,K as p,z as I}from"./DzangolabVue3Form.es-ceb02955.js";const y={class:"demo-section"},z={class:"demo-section"},$={class:"demo-section"},k={class:"demo-section"},U={class:"demo-section"},P={name:"SwitchInput"},D=g({...P,setup(W){const{t:f}=w(),h=_.coerce.boolean().refine(n=>n===!0,{message:f("form.errors.switch.invalid")});let a=v({customStyleInput:d(),disabled:d(!0),input:d(),inputWithValidation:d(!1),noLabelInput:d()});return(n,o)=>{const m=c("SshPre"),b=c("Page");return S(),V(b,{title:n.$t("form.label.switch")},{default:u(()=>[s("section",y,[s("h3",null,r(n.$t("form.label.basicInput")),1),e(),l(m,{language:"html-vue"},{default:u(()=>[e(`
        <template>
          <SwitchInput
            v-model="input"
          />
