import{D as p,L as g}from"./DzangolabVue3Form.es-CE9A9srf.js";import{d as v,E as I,G as V,H as $,r as d,D as w,e as z,o as y,w as m,B as e,f as o,t as i,i as a,u as n,p as U}from"./index-wNQK_6m0.js";import{_ as E}from"./FormPage.vue_vue_type_style_index_0_lang-4RDqni7V.js";const S={class:"section-content"},D={class:"section-content"},L={class:"section-content"},T={class:"section-content"},W={class:"section-content"},k={class:"section-content"},B={name:"InputField"},G=v({...B,setup(C){const{t:f}=I(),b=V.string().min(3,{message:f("form.errors.input.min",{length:3})});let s=$({disabled:d("monorepo@gmail.com"),input:d(),inputWithValidation:d(),noLabelInput:d(),passwordInput:d()});return(t,l)=>{const u=w("SshPre");return y(),z(E,{title:t.$t("form.label.input"),class:"demo"},{toolbar:m(()=>[a(n(U),{label:t.$t("common.back"),"icon-left":"pi pi-chevron-left",size:"medium",variant:"textOnly",onClick:l[0]||(l[0]=r=>t.$router.push("/form"))},null,8,["label"])]),default:m(()=>[l[25]||(l[25]=e()),o("section",null,[o("h2",null,i(t.$t("form.label.basicInput")),1),l[9]||(l[9]=e()),o("div",S,[a(n(p),{modelValue:n(s).noLabelInput,"onUpdate:modelValue":l[1]||(l[1]=r=>n(s).noLabelInput=r),placeholder:t.$t("form.placeholder.username"),type:"text"},null,8,["modelValue","placeholder"]),l[8]||(l[8]=e()),a(u,{language:"html-vue"},{default:m(()=>l[7]||(l[7]=[e(`
          <template>
            <Input 
              v-model="username"
          ...
          <\/script>
        `)])),_:1})])]),l[26]||(l[26]=e()),o("section",null,[o("h2",null,i(t.$t("form.label.labelInput")),1),l[12]||(l[12]=e()),o("div",D,[a(n(p),{modelValue:n(s).input,"onUpdate:modelValue":l[2]||(l[2]=r=>n(s).input=r),label:t.$t("form.label.username"),placeholder:t.$t("form.placeholder.username")},null,8,["modelValue","label","placeholder"]),l[11]||(l[11]=e()),a(u,{language:"html-vue"},{default:m(()=>l[10]||(l[10]=[e(`
          <template>
            <Input 
              v-model="username"
              label="Username"
          ...
          <\/script>
        `)])),_:1})])]),l[27]||(l[27]=e()),o("section",null,[o("h2",null,i(t.$t("form.label.inputWithType")),1),l[15]||(l[15]=e()),o("div",L,[a(n(p),{modelValue:n(s).passwordInput,"onUpdate:modelValue":l[3]||(l[3]=r=>n(s).passwordInput=r),label:t.$t("form.label.password"),placeholder:t.$t("form.placeholder.password"),type:"password"},null,8,["modelValue","label","placeholder"]),l[14]||(l[14]=e()),a(u,{language:"html-vue"},{default:m(()=>l[13]||(l[13]=[e(`
          <template>
            <Input 
              v-model="password"
              label="Password"
