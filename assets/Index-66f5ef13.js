import{G as d,t as v}from"./DzangolabVue3Form.es-5cddabd8.js";import{d as g,a5 as h,p as k,j as p,J as V,o as P,c as $,w as i,K as o,D as t,ao as y,X as e,f as n,L as u}from"./index-729398ab-f7824fe4.js";import{m as w}from"./index-9966f943.js";import{_ as z}from"./FormPage.vue_vue_type_style_index_0_lang-2120d4bb.js";const B={class:"section-content"},U={class:"section-content"},O={class:"section-content"},M={class:"section-content"},I={class:"section-content"},A={class:"section-content"},R={class:"section-content"},Y={class:"section-content"},j={class:"section-content"},F={class:"section-content"},S={class:"section-content"},C={class:"section-content"},L={class:"section-content"},T={class:"section-content"},N={name:"DatePickerInput"},X=g({...N,setup(_){const{t:c}=h(),b=w.date({invalid_type_error:c("form.errors.datePicker.invalid")}).max(new Date,{message:c("form.errors.datePicker.invalid")}),f=new Date,D=f;let r=k({appointmentDate:p(f),arrivalDate:p(),availableDatetime:p([f,new Date(D.setDate(D.getDate()+7))]),dateOfBirth:p(f),dateRange:p([f,new Date(D.setDate(D.getDate()+7))]),joinedDate:p(),month:p(),monthAndYear:p(),noLabelInput:p(),presentationDate:p(f),reportDate:p([f,new Date(D.setDate(D.getDate()+7))]),time:p(),year:p(f.getFullYear())});return(a,l)=>{const s=V("SshPre");return P(),$(z,{title:a.$t("form.label.datePicker"),class:"demo"},{toolbar:i(()=>[o(t(y),{label:a.$t("common.back"),"icon-left":"pi pi-chevron-left",size:"medium",variant:"textOnly",onClick:l[0]||(l[0]=m=>a.$router.push("/form"))},null,8,["label"])]),default:i(()=>[e(),n("section",null,[n("h2",null,u(a.$t("form.label.basicInput")),1),e(),n("div",B,[o(t(d),{modelValue:t(r).noLabelInput,"onUpdate:modelValue":l[1]||(l[1]=m=>t(r).noLabelInput=m)},null,8,["modelValue"]),e(),o(s,{language:"html-vue"},{default:i(()=>[e(`
        ...
        `)]),_:1}),e()])]),e(),n("section",null,[n("h2",null,u(a.$t("form.label.yearPicker")),1),e(),n("div",C,[o(t(d),{modelValue:t(r).year,"onUpdate:modelValue":l[12]||(l[12]=m=>t(r).year=m),label:a.$t("form.label.year"),"year-picker":""},null,8,["modelValue","label"]),e(),o(s,{language:"html-vue"},{default:i(()=>[e(`
          ...
          <\/script>
        `)]),_:1}),e()])]),e(),n("section",null,[n("h2",null,u(a.$t("form.label.timePicker")),1),e(),n("div",L,[o(t(d),{modelValue:t(r).time,"onUpdate:modelValue":l[13]||(l[13]=m=>t(r).time=m),label:a.$t("form.label.appointmentTime"),"time-picker":""},null,8,["modelValue","label"]),e(),o(s,{language:"html-vue"},{default:i(()=>[e(`
          <template>
            <DatePicker 
          ...
          import { DatePicker } from "@dzangolab/vue3-form";
          <\/script>
        `)]),_:1}),e()])]),e(),n("section",null,[n("h2",null,u(a.$t("form.label.inputWithValidation")),1),e(),n("div",T,[o(t(v),null,{default:i(()=>[o(t(d),{modelValue:t(r).joinedDate,"onUpdate:modelValue":l[14]||(l[14]=m=>t(r).joinedDate=m),label:a.$t("form.label.joinedDate"),schema:t(b)},null,8,["modelValue","label","schema"])]),_:1}),e(),o(s,{language:"html-vue"},{default:i(()=>[e(`
          <Form>
            <DatePicker 
              v-model="joinedDate"
              :schema="inputSchema"
