import{w as m,P as V}from"./PrefabsTechVue3Form.es-C3-yZ6Wf.js";import{d as I,I as $,L as y,M as w,r as f,J as D,e as S,o as h,j as i,C as t,f as o,h as p,t as d,u as l,v as U}from"./index-DO1TBNbP.js";import{_ as z}from"./ComponentDocumentation.vue_vue_type_script_setup_true_lang-CqQcwUQC.js";import{_ as P}from"./FormPage.vue_vue_type_style_index_0_lang-xMw1OhOp.js";import"./PrefabsTechVue3TanstackTable.es-B2DwPya4.js";const T={class:"section-content"},C={class:"section-content"},E={class:"section-content"},W={class:"section-content"},k={class:"section-content"},B={class:"section-content"},F={name:"InputField"},Z=I({...F,setup(L){const{t:s}=$(),b=[{description:s("form.documentation.eventDescription.input.modelValue"),name:"update:modelValue",payload:"string | null | undefined"}],v=y.string().min(3,{message:s("form.errors.input.min",{length:3})}),g=[{default:"false",description:s("form.documentation.propsDescription.input.disabled"),prop:"disabled",type:"Boolean"},{default:"-",description:s("form.documentation.propsDescription.input.label"),prop:"label",type:"String"},{default:"-",description:s("form.documentation.propsDescription.input.modelValue"),prop:"modelValue",type:"String | null | undefined"},{default:'"input"',description:s("form.documentation.propsDescription.input.name"),prop:"name",type:"String"},{default:"-",description:s("form.documentation.propsDescription.input.placeholder"),prop:"placeholder",type:"String"},{default:"-",description:s("form.documentation.propsDescription.input.schema"),prop:"schema",type:"z.ZodType<string | number | object>"},{default:'"text"',description:s("form.documentation.propsDescription.input.type"),prop:"type",type:"String"}];let r=w({disabled:f("monorepo@gmail.com"),input:f(),inputWithValidation:f(),noLabelInput:f(),passwordInput:f()});return(n,e)=>{const u=D("SshPre");return h(),S(P,{subtitle:l(s)("form.subtitle.input"),title:n.$t("form.label.input"),class:"demo"},{toolbar:i(()=>[p(l(U),{label:n.$t("common.back"),"icon-left":"pi pi-chevron-left",size:"medium",variant:"textOnly",onClick:e[0]||(e[0]=a=>n.$router.push("/form"))},null,8,["label"])]),default:i(()=>[e[25]||(e[25]=t()),o("section",null,[o("h2",null,d(n.$t("form.label.basicInput")),1),e[9]||(e[9]=t()),o("div",T,[p(l(m),{modelValue:l(r).noLabelInput,"onUpdate:modelValue":e[1]||(e[1]=a=>l(r).noLabelInput=a),placeholder:n.$t("form.placeholder.username"),name:"basic",type:"text"},null,8,["modelValue","placeholder"]),e[8]||(e[8]=t()),p(u,{language:"html-vue"},{default:i(()=>e[7]||(e[7]=[t(`
          <template>
            <Input 
              v-model="username"
