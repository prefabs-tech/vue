import{d as _,j as p,E as v,o as y,c as B,w as o,J as n,C as t,Z as u,f as e,N as a,at as i,ap as E,aq as $}from"./index-66214709-683f8f7e.js";import{_ as z}from"./UiPage.vue_vue_type_style_index_0_lang-97b9785e.js";import{_ as k}from"./index-dd0a7bd8.js";const d=r=>(E("data-v-69273c80"),r=r(),$(),r),O={class:"section-content"},C={class:"container"},S={class:"section-content"},I={class:"container"},w={class:"section-content"},D={class:"container"},L={class:"section-content"},T={class:"container"},N={class:"section-content"},P={class:"container"},R={class:"section-content"},M={class:"container"},V={class:"section-content"},A={class:"container"},H={class:"section-content"},W={className:"container"},j={class:"section-content"},q={className:"container"},J=d(()=>e("i",{class:"pi pi-user"},null,-1)),Z=d(()=>e("i",{class:"pi pi-user"},null,-1)),F=d(()=>e("i",{class:"pi pi-user"},null,-1)),G={class:"section-content"},K={class:"container"},Q={class:"section-content"},U={class:"container"},X={class:"container"},Y={class:"section-content"},x={class:"container"},tt=_({__name:"Index",setup(r){const m=p(void 0),c=p(!1),g=()=>{m.value=new Date},h=()=>{c.value=!0,setTimeout(()=>{c.value=!1},5e3)};return(l,b)=>{const f=v("router-link"),s=v("SshPre");return y(),B(z,{title:l.$t("ui.button.title"),class:"demo-button"},{toolbar:o(()=>[n(f,{to:{name:"ui"},class:"back"},{default:o(()=>[t(u(l.$t("common.back")),1)]),_:1})]),default:o(()=>[t(),e("section",null,[e("h2",null,u(l.$t("ui.button.usage.basic")),1),t(),e("div",O,[n(s,{language:"html-vue"},{default:o(()=>[t(`
          <template> 
          ...
          <\/script>
        `)]),_:1}),t(),e("div",C,[n(a(i),{label:l.$t("ui.button.label.clickMe"),onClick:b[0]||(b[0]=et=>g())},null,8,["label"]),t(),e("span",null,u(m.value),1)])])]),t(),e("section",null,[e("h2",null,u(l.$t("ui.button.usage.withI18n")),1),t(),e("div",S,[n(s,{language:"html-vue"},{default:o(()=>[t(`
          <template> 
        ...
        `)]),_:1}),t(),e("div",W,[n(a(i),{variant:"textOnly",severity:"secondary","icon-left":"pi pi-user"}),t(),n(a(i),{variant:"outlined",severity:"secondary","icon-left":"pi pi-user"}),t(),n(a(i),{variant:"filled","icon-left":"pi pi-user"})])])]),t(),e("section",null,[e("h2",null,u(l.$t("ui.button.usage.icons.iconElement")),1),t(),e("div",j,[n(s,{language:"html-vue"},{default:o(()=>[t(`
          ...
          <script setup lang="ts"> 
            import { ButtonElement } from "@dzangolab/vue3-ui"; 
          <\/script>
        `)]),_:1}),t(),e("div",q,[n(a(i),{rounded:"",variant:"textOnly",severity:"secondary"},{iconLeft:o(()=>[J]),_:1}),t(),n(a(i),{rounded:"",severity:"secondary",variant:"outlined"},{iconRight:o(()=>[Z]),_:1}),t(),n(a(i),{rounded:"",variant:"filled"},{iconRight:o(()=>[F]),_:1})])])]),t(),e("section",null,[e("h2",null,u(l.$t("ui.button.usage.icons.iconPackage")),1),t(),e("div",G,[n(s,{language:"html-vue"},{default:o(()=>[t(`
          <template> 
            <ButtonElement
              label="Home"
          ...
          <script setup lang="ts"> 
            import { ButtonElement } from "@dzangolab/vue3-ui"; 
          <\/script>
        `)]),_:1}),t(),e("div",K,[n(a(i),{label:l.$t("ui.button.label.home"),"icon-left":"pi pi-home",variant:"outlined"},null,8,["label"]),t(),n(a(i),{label:l.$t("ui.button.label.home"),"icon-left":"fa-solid fa-house",variant:"outlined"},null,8,["label"])])])]),t(),e("section",null,[e("h2",null,u(l.$t("ui.button.usage.icons.iconAndLabel")),1),t(),e("div",Q,[n(s,{language:"html-vue"},{default:o(()=>[t(`
          <template> 
          ...
          <script setup lang="ts"> 
            import { ButtonElement } from "@dzangolab/vue3-ui"; 
          <\/script>
        `)]),_:1}),t(),e("div",U,[n(a(i),{label:l.$t("ui.button.label.textOnly"),"icon-left":"pi pi-user",variant:"textOnly"},null,8,["label"]),t(),n(a(i),{label:l.$t("ui.button.label.outlined"),"icon-left":"pi pi-user",variant:"outlined"},null,8,["label"]),t(),n(a(i),{label:l.$t("ui.button.label.default"),"icon-left":"pi pi-user",variant:"filled"},null,8,["label"])]),t(),e("div",X,[n(a(i),{label:l.$t("ui.button.label.textOnly"),"icon-right":"pi pi-user",rounded:"",variant:"textOnly"},null,8,["label"]),t(),n(a(i),{label:l.$t("ui.button.label.outlined"),"icon-right":"pi pi-user",rounded:"",variant:"outlined"},null,8,["label"]),t(),n(a(i),{label:l.$t("ui.button.label.default"),"icon-right":"pi pi-user",rounded:"",variant:"filled"},null,8,["label"])])])]),t(),e("section",null,[e("h2",null,u(l.$t("ui.button.usage.redirect")),1),t(),e("div",Y,[n(s,{language:"html-vue"},{default:o(()=>[t(`
          <template> 
