import{d,j as f,K as r,o as g,c as _,w as a,L as t,C as e,M as o,f as s,E as i,ay as u,a as h,g as v}from"./index-137faed7-55cf5996.js";import{_ as b}from"./UiPage.vue_vue_type_style_index_0_lang-34e8fabd.js";const $={class:"section-content"},k={class:"section-content"},C={class:"section-content"},M=s("i",{class:"fa-regular fa-bell"},null,-1),w={key:0},S={class:"section-content"},y={class:"section-content"},B=d({__name:"Index",setup(N){const c=f(!0);return(n,m)=>{const p=r("router-link"),l=r("SshPre");return g(),_(b,{title:n.$t("ui.message.title"),class:"demo-message"},{toolbar:a(()=>[t(p,{to:{name:"ui"},class:"back"},{default:a(()=>[e(o(n.$t("common.back")),1)]),_:1})]),default:a(()=>[e(),s("section",null,[s("h2",null,o(n.$t("ui.message.usage.basic")),1),e(),s("div",$,[t(l,{language:"html-vue"},{default:a(()=>[e(`
          <template>
        ...
        `)]),_:1}),e(),t(i(u),{message:n.$t("ui.message.contents.content3")},{icon:a(()=>[M]),_:1},8,["message"])])]),e(),c.value?(g(),h("section",w,[s("h2",null,o(n.$t("ui.message.usage.enableClose")),1),e(),s("div",S,[t(l,{language:"html-vue"},{default:a(()=>[e(`
          ...
          <\/script>
        `)]),_:1}),e(),t(i(u),{message:n.$t("ui.message.contents.content4"),icon:"pi pi-comments","enable-close":"",onClose:m[0]||(m[0]=z=>c.value=!1)},null,8,["message"])])])):v("",!0),e(),s("section",null,[s("h2",null,o(n.$t("ui.message.usage.withI18n")),1),e(),s("div",y,[t(l,{language:"html-vue"},{default:a(()=>[e(`
          <template>
