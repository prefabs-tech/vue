import{d as V,u as x,b as _,e as p,o as $,c as T,w as u,a as s,t as d,f as e,g as l,h as t,r as b}from"./index-4f538d53.js";import{m as y,X as m,z as f}from"./DzangolabVue3Form.es-700da16e.js";const w={class:"demo-section"},z={class:"demo-section"},F={class:"demo-section"},S={class:"demo-section"},E={class:"demo-section"},U={class:"demo-section"},C={class:"demo-section"},q={class:"demo-section"},O={name:"TextareaInputField"},R=V({...O,setup(D){const{t:c}=x(),g=y.string().min(15,{message:c("form.errors.input.min",{length:15})}),I={required:c("form.errors.input.required")},h={ignore_whitespace:!0,required:!0};let a=_({customRowsColsInput:p(),customStyleInput:p(),customValidationInput:p(),disabled:p("Disabled textarea input"),input:p(),inputWithValidation:p(),noLabelInput:p(),textInput:p()});return(n,o)=>{const i=b("SshPre"),v=b("Page");return $(),T(v,{title:n.$t("form.label.textarea")},{default:u(()=>[s("section",w,[s("h3",null,d(n.$t("form.label.basicInput")),1),e(),l(i,{language:"html-vue"},{default:u(()=>[e(`
        <template>
          <TextareaInput 
            v-model="input"
