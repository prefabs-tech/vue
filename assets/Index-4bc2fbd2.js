import{A as d,N as p}from"./DzangolabVue3Form.es-579aa137.js";import{d as g,a7 as w,p as V,j as c,K as f,o as I,c as S,w as a,L as n,C as l,M as r,f as t,E as e}from"./index-8e1c3ab6-8617714e.js";import{m as _}from"./index-eb14ec17.js";import{_ as $}from"./FormPage.vue_vue_type_style_index_0_lang-cebf9516.js";const F={class:"section-content"},z={class:"section-content"},k={class:"section-content"},N={class:"section-content"},U={class:"section-content"},C={name:"SwitchInput"},P=g({...C,setup(L){const{t:b}=w(),h=_.coerce.boolean().refine(o=>o===!0,{message:b("form.errors.switch.invalid")});let s=V({disabled:c(!0),input:c(),inputWithValidation:c(!1),noLabelInput:c()});return(o,i)=>{const v=f("router-link"),m=f("SshPre");return I(),S($,{title:o.$t("form.label.switch"),class:"demo"},{toolbar:a(()=>[n(v,{to:{name:"form"},class:"back"},{default:a(()=>[l(r(o.$t("common.back")),1)]),_:1})]),default:a(()=>[l(),t("section",null,[t("h2",null,r(o.$t("form.label.basicInput")),1),l(),t("div",F,[n(m,{language:"html-vue"},{default:a(()=>[l(`
          <Form>
            <SwitchInput
              v-model="input"
            />
        ...
        `)]),_:1}),l(),n(e(d),null,{default:a(()=>[n(e(p),{modelValue:e(s).input,"onUpdate:modelValue":i[1]||(i[1]=u=>e(s).input=u),label:o.$t("form.label.switch")},null,8,["modelValue","label"])]),_:1})])]),l(),t("section",null,[t("h2",null,r(o.$t("form.label.disabled")),1),l(),t("div",k,[n(m,{language:"html-vue"},{default:a(()=>[l(`
          ...
          <\/script>
        `)]),_:1}),l(),n(e(d),null,{default:a(()=>[n(e(p),{modelValue:e(s).disabled,"onUpdate:modelValue":i[2]||(i[2]=u=>e(s).disabled=u),label:o.$t("form.label.disabled"),disabled:""},null,8,["modelValue","label"])]),_:1})])]),l(),t("section",null,[t("h2",null,r(o.$t("form.label.withI18n")),1),l(),t("div",N,[n(m,{language:"html-vue"},{default:a(()=>[l(`
          <Form>
            <SwitchInput 
              v-model="input"
