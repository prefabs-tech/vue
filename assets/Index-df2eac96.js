import{e as V,u as _,f as $,g as r,o as y,c as T,w as p,a as u,t as m,d as e,b as l,h as n,r as h}from"./index-90527b34.js";import{m as z,_ as d,b as c}from"./DzangolabVue3Form.es-0779da48.js";const F={class:"demo-section"},S={class:"demo-section"},w={class:"demo-section"},E={class:"demo-section"},U={class:"demo-section"},q={class:"demo-section"},x={class:"demo-section"},O={name:"InputField"},B=V({...O,setup(M){const{t:f}=_(),g=z.string().length(5,{message:f("form.errors.input.length",{length:5})}),I={required:f("form.errors.input.required")},b={ignore_whitespace:!0,required:!0};let o=$({customStyleInput:r(),customValidationInput:r(),disabled:r("dzangolab"),input:r(),inputWithValidation:r(),noLabelInput:r(),textInput:r()});return(t,a)=>{const i=h("SshPre"),v=h("Page");return y(),T(v,{title:t.$t("form.label.textInput")},{default:p(()=>[u("section",F,[u("h3",null,m(t.$t("form.label.basicInput")),1),e(),l(i,{language:"html-vue"},{default:p(()=>[e(`
        <template>
          <TextInput 
            v-model="input"
