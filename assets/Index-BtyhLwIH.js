import{d as p,r as d,z as f,e as v,o as b,w as l,D as s,f as n,t as u,i as o,u as a,W as m,j as $}from"./index-C-Eehmak.js";import{_ as M}from"./UiPage.vue_vue_type_style_index_0_lang-CkHNdcXy.js";const w={class:"section-content"},C={class:"section-content"},S={class:"section-content"},k={class:"section-content"},z={class:"section-content"},I=p({__name:"Index",setup(N){const r=d(!0);return(t,e)=>{const i=f("SshPre");return b(),v(M,{title:t.$t("ui.message.title"),class:"demo-message"},{toolbar:l(()=>[o(a($),{label:t.$t("common.back"),"icon-left":"pi pi-chevron-left",size:"medium",variant:"textOnly",onClick:e[0]||(e[0]=g=>t.$router.push("/ui"))},null,8,["label"])]),default:l(()=>[e[18]||(e[18]=s()),n("section",null,[n("h2",null,u(t.$t("ui.message.usage.basic")),1),e[4]||(e[4]=s()),n("div",w,[o(a(m),{message:t.$t("ui.message.contents.content1")},null,8,["message"]),e[3]||(e[3]=s()),o(i,{language:"html-vue"},{default:l(()=>e[2]||(e[2]=[s(`
          <template>
