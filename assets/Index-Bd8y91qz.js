import{H as s,U as f}from"./DzangolabVue3Form.es-BDbnqT8M.js";import{d as V,L as N,M as $,N as z,r as d,K as E,f as F,o as O,i as m,E as e,g as o,t as p,h as r,u as l,x as U}from"./index-ozhbLx6f.js";import{_ as w}from"./FormPage.vue_vue_type_style_index_0_lang-DO0RO7Uh.js";const M={class:"section-content"},y={class:"section-content"},S={class:"section-content"},k={class:"section-content"},q={class:"section-content"},C={class:"section-content"},L={class:"section-content"},P={name:"NumberInputField"},T=V({...P,setup(W){const{t:b}=N(),g=$.coerce.number({invalid_type_error:b("form.errors.number.invalid")}).gte(1,b("form.errors.number.invalid")).lte(100,b("form.errors.number.invalid")),I={invalid:b("form.errors.number.invalid"),required:b("form.errors.number.required")},v={min:1,max:100,allow_leading_zeroes:!1};let a=z({customValidationInput:d(),disabled:d(100),i18nInput:d(),input:d(),inputWithValidation:d(),noLabelInput:d(),textInput:d()});return(t,n)=>{const i=E("SshPre");return O(),F(w,{title:t.$t("form.label.number"),class:"demo"},{toolbar:m(()=>[r(l(U),{label:t.$t("common.back"),"icon-left":"pi pi-chevron-left",size:"medium",variant:"textOnly",onClick:n[0]||(n[0]=u=>t.$router.push("/form"))},null,8,["label"])]),default:m(()=>[n[29]||(n[29]=e()),o("section",null,[o("h2",null,p(t.$t("form.label.basicInput")),1),n[10]||(n[10]=e()),o("div",M,[r(l(s),{modelValue:l(a).noLabelInput,"onUpdate:modelValue":n[1]||(n[1]=u=>l(a).noLabelInput=u),placeholder:t.$t("form.placeholder.number")},null,8,["modelValue","placeholder"]),n[9]||(n[9]=e()),r(i,{language:"html-vue"},{default:m(()=>n[8]||(n[8]=[e(`
          <template>
            <NumberInput 
              v-model="input"
