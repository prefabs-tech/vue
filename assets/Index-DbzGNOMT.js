import{a as p,B as f}from"./DzangolabVue3Form.es-CAxlRzL1.js";import{d as V,I as $,L as T,M as x,r as m,H as z,e as w,o as F,h as u,B as t,f as o,t as d,g as a,u as l,q as C}from"./index-v8URLa41.js";import{_ as U}from"./FormPage.vue_vue_type_style_index_0_lang-BAlsSTeb.js";const q={class:"section-content"},E={class:"section-content"},B={class:"section-content"},O={class:"section-content"},S={class:"section-content"},y={class:"section-content"},M={class:"section-content"},R={class:"section-content"},k={name:"TextareaInputField"},P=V({...k,setup(D){const{t:b}=$(),v=T.string().min(15,{message:b("form.errors.input.min",{length:15})}),I={required:b("form.errors.input.required")},g={ignore_whitespace:!0,required:!0};let r=x({customRowsColsInput:m(),customValidationInput:m(),disabled:m("Disabled textarea input"),input:m(),inputWithValidation:m(),noLabelInput:m(),textInput:m()});return(n,e)=>{const i=z("SshPre");return F(),w(U,{title:n.$t("form.label.textarea"),class:"demo"},{toolbar:u(()=>[a(l(C),{label:n.$t("common.back"),"icon-left":"pi pi-chevron-left",size:"medium",variant:"textOnly",onClick:e[0]||(e[0]=s=>n.$router.push("/form"))},null,8,["label"])]),default:u(()=>[e[33]||(e[33]=t()),o("section",null,[o("h2",null,d(n.$t("form.label.basicInput")),1),e[11]||(e[11]=t()),o("div",q,[a(l(p),{modelValue:l(r).noLabelInput,"onUpdate:modelValue":e[1]||(e[1]=s=>l(r).noLabelInput=s),placeholder:n.$t("form.placeholder.input")},null,8,["modelValue","placeholder"]),e[10]||(e[10]=t()),a(i,{language:"html-vue"},{default:u(()=>e[9]||(e[9]=[t(`
          <template>
            <TextareaInput 
              v-model="input"
        ...
        `)])),_:1})])]),e[34]||(e[34]=t()),o("section",null,[o("h2",null,d(n.$t("form.label.labelInput")),1),e[14]||(e[14]=t()),o("div",E,[a(l(p),{modelValue:l(r).input,"onUpdate:modelValue":e[2]||(e[2]=s=>l(r).input=s),label:n.$t("form.label.textarea"),placeholder:n.$t("form.placeholder.textarea")},null,8,["modelValue","label","placeholder"]),e[13]||(e[13]=t()),a(i,{language:"html-vue"},{default:u(()=>e[12]||(e[12]=[t(`
          ...
          import { TextareaInput } from "@dzangolab/vue3-form";
          <\/script>
        `)])),_:1})])]),e[35]||(e[35]=t()),o("section",null,[o("h2",null,d(n.$t("form.label.disabled")),1),e[17]||(e[17]=t()),o("div",B,[a(l(p),{modelValue:l(r).disabled,"onUpdate:modelValue":e[3]||(e[3]=s=>l(r).disabled=s),label:n.$t("form.label.disabled"),disabled:""},null,8,["modelValue","label"]),e[16]||(e[16]=t()),a(i,{language:"html-vue"},{default:u(()=>e[15]||(e[15]=[t(`
          <template>
            <TextareaInput 
              v-model="input"
              label="Disabled"
