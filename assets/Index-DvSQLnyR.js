import{H as b,g as P}from"./DzangolabVue3Form.es-CE9A9srf.js";import{d as h,L as $,H as y,D as B,e as S,o as V,w as o,B as t,f as s,t as i,i as l,u as p,N as d,p as C}from"./index-wNQK_6m0.js";import{_ as D}from"./UiPage.vue_vue_type_style_index_0_lang-hJ6pxVNu.js";const I={class:"section-content"},N={class:"section-content"},w={class:"section-content"},F=h({__name:"Index",setup(k){const c=$(),a=y({name:null,phone:null,price:"$50"}),f={iconRight:"pi pi-chevron-right",label:"Next",severity:"primary",variant:"filled"},v={iconLeft:"pi pi-chevron-left",label:"Back",severity:"secondary",variant:"filled"},u=[{content:"Please enter personal details",label:"Personal",step:1},{content:"Please enter contact details",label:"Contact",step:2},{content:"Please enter payment details",label:"Payment",step:3},{content:"Do you wish to continue?",label:"Confirmation",step:4}],g=()=>{c.push("/ui")};return(n,e)=>{const m=B("SshPre");return V(),S(D,{title:n.$t("ui.stepper.title"),class:"demo"},{toolbar:o(()=>[l(p(C),{label:n.$t("common.back"),"icon-left":"pi pi-chevron-left",size:"medium",variant:"textOnly",onClick:e[0]||(e[0]=r=>n.$router.push("/ui"))},null,8,["label"])]),default:o(()=>[e[16]||(e[16]=t()),s("section",null,[s("h2",null,i(n.$t("ui.stepper.usage.basic")),1),e[6]||(e[6]=t()),s("div",I,[l(p(d),{steps:u,onComplete:g}),e[5]||(e[5]=t()),l(m,{language:"html-vue"},{default:o(()=>e[4]||(e[4]=[t(`
          <template>
