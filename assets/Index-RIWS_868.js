import{r as i}from"./DzangolabVue3Form.es-Cf29nzIN.js";import{d as m,s as u,j as c,o as d,w as l,A as e,e as t,t as p,g as n,u as s,B as g}from"./index-j9ugvOHR.js";import{_ as f}from"./FormPage.vue_vue_type_style_index_0_lang-CciDNi3U.js";const h={class:"section-content"},b={class:"section-content"},z={class:"section-content"},v={class:"section-content"},_={class:"section-content"},F={class:"section-content"},I={name:"FileInputDemo"},k=m({...I,setup($){return(o,r)=>{const a=u("SshPre");return d(),c(f,{title:o.$t("form.label.fileInput"),class:"demo"},{toolbar:l(()=>[n(s(g),{label:o.$t("common.back"),"icon-left":"pi pi-chevron-left",size:"medium",variant:"textOnly",onClick:r[0]||(r[0]=w=>o.$router.push("/form"))},null,8,["label"])]),default:l(()=>[e(),t("section",null,[t("h2",null,p(o.$t("form.label.basicInput")),1),e(),t("div",h,[n(s(i)),e(),n(a,{language:"html-vue"},{default:l(()=>[e(`
          <template>
            <FileInput />
          </template>
