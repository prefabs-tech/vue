import{d as r,A as g,e as b,o as p,w as o,E as l,f as n,t as u,i,u as s,R as a,j as m,_ as v}from"./index-DUEpciHi.js";import{_ as f}from"./UiPage.vue_vue_type_style_index_0_lang-Dj52F6XV.js";const B={class:"section-content"},y={class:"section-content"},$={class:"section-content"},k={class:"section-content"},z={class:"container"},w={class:"section-content"},I={class:"container"},L={class:"section-content"},C={class:"container"},S={class:"section-content"},P={class:"container"},R={class:"section-content"},A={class:"container"},N=r({__name:"Index",setup(V){return(t,e)=>{const d=g("SshPre");return p(),b(f,{title:t.$t("ui.badge.title"),class:"demo-badge"},{toolbar:o(()=>[i(s(m),{label:t.$t("common.back"),"icon-left":"pi pi-chevron-left",size:"medium",variant:"textOnly",onClick:e[0]||(e[0]=D=>t.$router.push("/ui"))},null,8,["label"])]),default:o(()=>[e[36]||(e[36]=l()),n("section",null,[n("h2",null,u(t.$t("ui.badge.usage.basic")),1),e[3]||(e[3]=l()),n("div",B,[i(s(a),{label:t.$t("ui.badge.label.basic")},null,8,["label"]),e[2]||(e[2]=l()),i(d,{language:"html-vue"},{default:o(()=>e[1]||(e[1]=[l(`
          <template>
            <Badge label="Basic" /> 
          </template>
        ...
        `)])),_:1})])]),e[43]||(e[43]=l()),n("section",null,[n("h2",null,u(t.$t("ui.badge.usage.iconElement")),1),e[35]||(e[35]=l()),n("div",R,[n("div",A,[i(s(a),{label:t.$t("ui.badge.label.correct")},{iconLeft:o(()=>e[30]||(e[30]=[n("i",{class:"pi pi-check"},null,-1)])),_:1},8,["label"]),e[32]||(e[32]=l()),i(s(a),{label:t.$t("ui.badge.label.wrong"),severity:"danger"},{iconRight:o(()=>e[31]||(e[31]=[n("i",{class:"pi pi-times"},null,-1)])),_:1},8,["label"])]),e[34]||(e[34]=l()),i(d,{language:"html-vue"},{default:o(()=>e[33]||(e[33]=[l(`
          ...
          <script setup lang="ts">
            import { Badge } from "@dzangolab/vue3-ui";
          <\/script>
        `)])),_:1})])])]),_:1},8,["title"])}}}),W=v(N,[["__scopeId","data-v-6f4cd0b3"]]);export{W as default};
