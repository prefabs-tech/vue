import{b as d,O as b}from"./PrefabsTechVue3Form.es-kbbaSG9O.js";import{d as $,G as x,I as y,L as D,r as m,H as w,e as F,o as h,j as s,B as t,f as o,h as r,t as f,u as n,v as q}from"./index-CVH4OLxf.js";import{_ as E}from"./ComponentDocumentation.vue_vue_type_script_setup_true_lang-C_Qa-nj1.js";import{_ as O}from"./FormPage.vue_vue_type_style_index_0_lang-B32fpg8g.js";import"./PrefabsTechVue3TanstackTable.es-CcclW_bq.js";const S={class:"section-content"},C={class:"section-content"},M={class:"section-content"},U={class:"section-content"},z={class:"section-content"},B={class:"section-content"},k={class:"section-content"},L={class:"section-content"},P={name:"TextareaInputField"},H=$({...P,setup(R){const{t:p}=x(),g=[{description:p("form.documentation.eventDescription.input.modelValue"),name:"update:modelValue",payload:"string | number | string[] | undefined"}],I=y.string().min(15,{message:p("form.errors.input.min",{length:15})}),V=[{default:"-",description:p("form.documentation.propsDescription.textarea.cols"),prop:"cols",type:"number | undefined"},{default:"false",description:p("form.documentation.propsDescription.input.disabled"),prop:"disabled",type:"Boolean"},{default:'{ required: "The field is required", invalid: "Please provide a valid input data" }',description:p("form.documentation.propsDescription.input.errorMessages"),prop:"errorMessages",type:"TextErrorMessages"},{default:"-",description:p("form.documentation.propsDescription.input.label"),prop:"label",type:"String"},{default:"-",description:p("form.documentation.propsDescription.input.modelValue"),prop:"modelValue",type:"string | number | string[] | undefined"},{default:'"text"',description:p("form.documentation.propsDescription.input.name"),prop:"name",type:"String"},{default:"-",description:p("form.documentation.propsDescription.input.options"),prop:"options",type:"IsTextOptions"},{default:"-",description:p("form.documentation.propsDescription.input.placeholder"),prop:"placeholder",type:"String"},{default:"-",description:p("form.documentation.propsDescription.textarea.rows"),prop:"rows",type:"number | undefined"},{default:"-",description:p("form.documentation.propsDescription.input.schema"),prop:"schema",type:"z.ZodType<string | number>"}],T={required:p("form.errors.input.required")},v={ignore_whitespace:!0,required:!0};let a=D({customRowsColsInput:m(),customValidationInput:m(),disabled:m("Disabled textarea input"),i18nInput:m(),input:m(),inputWithValidation:m(),noLabelInput:m(),textInput:m()});return(l,e)=>{const u=w("SshPre");return h(),F(O,{subtitle:n(p)("form.subtitle.textarea"),title:l.$t("form.label.textarea"),class:"demo"},{toolbar:s(()=>[r(n(q),{label:l.$t("common.back"),"icon-left":"pi pi-chevron-left",size:"medium",variant:"textOnly",onClick:e[0]||(e[0]=i=>l.$router.push("/form"))},null,8,["label"])]),default:s(()=>[e[34]||(e[34]=t()),o("section",null,[o("h2",null,f(l.$t("form.label.basicInput")),1),e[11]||(e[11]=t()),o("div",S,[r(n(d),{modelValue:n(a).noLabelInput,"onUpdate:modelValue":e[1]||(e[1]=i=>n(a).noLabelInput=i),placeholder:l.$t("form.placeholder.input")},null,8,["modelValue","placeholder"]),e[10]||(e[10]=t()),r(u,{language:"html-vue"},{default:s(()=>e[9]||(e[9]=[t(`
        ...
        `)])),_:1})])]),e[38]||(e[38]=t()),o("section",null,[o("h2",null,f(l.$t("form.label.inputWithValidation")),1),e[23]||(e[23]=t()),o("div",z,[r(n(b),null,{default:s(()=>[r(n(d),{modelValue:n(a).inputWithValidation,"onUpdate:modelValue":e[5]||(e[5]=i=>n(a).inputWithValidation=i),label:l.$t("form.label.textarea"),options:v,placeholder:l.$t("form.placeholder.input")},null,8,["modelValue","label","placeholder"])]),_:1}),e[22]||(e[22]=t()),r(u,{language:"html-vue"},{default:s(()=>e[21]||(e[21]=[t(`
          ...
          <\/script>
        `)])),_:1})])]),e[39]||(e[39]=t()),o("section",null,[o("h2",null,f(l.$t("form.label.customErrorMessageInput")),1),e[26]||(e[26]=t()),o("div",B,[r(n(b),null,{default:s(()=>[r(n(d),{modelValue:n(a).textInput,"onUpdate:modelValue":e[6]||(e[6]=i=>n(a).textInput=i),label:l.$t("form.label.textarea"),"error-messages":T,options:v,placeholder:l.$t("form.placeholder.input")},null,8,["modelValue","label","placeholder"])]),_:1}),e[25]||(e[25]=t()),r(u,{language:"html-vue"},{default:s(()=>e[24]||(e[24]=[t(`
          <Form>
            <TextareaInput 
              v-model="input"
        ...
        `)])),_:1})])]),e[42]||(e[42]=t()),r(E,{"events-data":g,"props-data":V,"props-table-title":l.$t("common.properties",{value:"TextareaInputProperties"})},null,8,["props-table-title"]),e[43]||(e[43]=t()),r(u,{language:"html-vue"},{default:s(()=>e[33]||(e[33]=[t(`
