import{G as c,J as h}from"./DzangolabVue3Form.es-530610db.js";import{d as V,a5 as D,p as I,j as m,K as g,o as p,c as k,w as u,L as s,C as e,M as i,f as r,E as n,a as b,g as v}from"./index-35228b09-3d0d33db.js";import{m as F}from"./index-893c107f.js";import{_ as U}from"./FormPage.vue_vue_type_style_index_0_lang-6e9c6210.js";const z={class:"section-content"},E={key:0,class:"result-date"},S={class:"section-content"},C={key:0,class:"result-date"},w={class:"section-content"},B={key:0,class:"result-date"},N={class:"section-content"},P={key:0,class:"result-date"},A={name:"DaysInput"},K=V({...A,setup(q){const{t:y}=D(),_=F.coerce.number({invalid_type_error:y("form.errors.number.required")}).min(1,{message:y("form.errors.daysInput.invalid")}).max(365,{message:y("form.errors.daysInput.invalid")}),o=I({basic:m(),disabled:m(),label:m(),validationInput:m()});let d=I({basic:m(),disabled:m(30),label:m(),validationInput:m()});return(a,t)=>{const $=g("router-link"),f=g("SshPre");return p(),k(U,{title:a.$t("form.label.daysInput"),class:"demo"},{toolbar:u(()=>[s($,{to:{name:"form"},class:"back"},{default:u(()=>[e(i(a.$t("common.back")),1)]),_:1})]),default:u(()=>[e(),r("section",null,[r("h2",null,i(a.$t("form.label.basicInput")),1),e(),r("div",z,[s(n(c),{modelValue:n(d).basic,"onUpdate:modelValue":t[0]||(t[0]=l=>n(d).basic=l),placeholder:a.$t("form.placeholder.days"),"onUpdate:date":t[1]||(t[1]=l=>o.basic=l)},null,8,["modelValue","placeholder"]),e(),o.basic?(p(),b("div",E,i(o.basic),1)):v("",!0),e(),s(f,{language:"html-vue"},{default:u(()=>[e(`
          <template>
            <DaysInput
              v-model="input"
        ...
        `)]),_:1}),e()])]),e(),r("section",null,[r("h2",null,i(a.$t("form.label.labelInput")),1),e(),r("div",S,[s(n(h),null,{default:u(()=>[s(n(c),{modelValue:n(d).label,"onUpdate:modelValue":t[2]||(t[2]=l=>n(d).label=l),label:a.$t("form.label.arrivalDate"),placeholder:a.$t("form.placeholder.days"),"onUpdate:date":t[3]||(t[3]=l=>o.label=l)},null,8,["modelValue","label","placeholder"])]),_:1}),e(),o.label?(p(),b("div",C,i(o.label),1)):v("",!0),e(),s(f,{language:"html-vue"},{default:u(()=>[e(`
          ...
          const result = ref();
          <\/script>
        `)]),_:1}),e()])]),e(),r("section",null,[r("h2",null,i(a.$t("form.label.disabled")),1),e(),r("div",w,[s(n(h),null,{default:u(()=>[s(n(c),{modelValue:n(d).disabled,"onUpdate:modelValue":t[4]||(t[4]=l=>n(d).disabled=l),label:a.$t("form.label.appointmentDate"),placeholder:a.$t("form.placeholder.days"),disabled:"","onUpdate:date":t[5]||(t[5]=l=>o.disabled=l)},null,8,["modelValue","label","placeholder"])]),_:1}),e(),o.disabled?(p(),b("div",B,i(o.disabled),1)):v("",!0),e(),s(f,{language:"html-vue"},{default:u(()=>[e(`
          <Form>
            <DaysInput
              v-model="input"
              disabled
