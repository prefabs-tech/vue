import{a as c,o as h}from"./DzangolabVue3Form.es-k-Xjvcvt.js";import{d as $,z as V,A as I,r as u,s as D,j as _,o as p,w as i,B as e,e as s,t as m,g as r,a as v,b,u as n,C as z}from"./index-CqimUq5D.js";import{z as k}from"./index-mSkvzYyn.js";import{_ as F}from"./FormPage.vue_vue_type_style_index_0_lang-g4uxL8pa.js";const U={class:"section-content"},C={key:0,class:"result-date"},E={class:"section-content"},S={key:0,class:"result-date"},B={class:"section-content"},w={key:0,class:"result-date"},A={class:"section-content"},N={key:0,class:"result-date"},P={name:"DaysInput"},H=$({...P,setup(q){const{t:y}=V(),g=k.coerce.number({invalid_type_error:y("form.errors.number.required")}).min(1,{message:y("form.errors.daysInput.invalid")}).max(365,{message:y("form.errors.daysInput.invalid")}),o=I({basic:u(),disabled:u(),label:u(),validationInput:u()});let d=I({basic:u(),disabled:u(30),label:u(),validationInput:u()});return(a,t)=>{const f=D("SshPre");return p(),_(F,{title:a.$t("form.label.daysInput"),class:"demo"},{toolbar:i(()=>[r(n(z),{label:a.$t("common.back"),"icon-left":"pi pi-chevron-left",size:"medium",variant:"textOnly",onClick:t[0]||(t[0]=l=>a.$router.push("/form"))},null,8,["label"])]),default:i(()=>[e(),s("section",null,[s("h2",null,m(a.$t("form.label.basicInput")),1),e(),s("div",U,[r(n(c),{modelValue:n(d).basic,"onUpdate:modelValue":t[1]||(t[1]=l=>n(d).basic=l),placeholder:a.$t("form.placeholder.days"),"onUpdate:date":t[2]||(t[2]=l=>o.basic=l)},null,8,["modelValue","placeholder"]),e(),o.basic?(p(),v("div",C,m(o.basic),1)):b("",!0),e(),r(f,{language:"html-vue"},{default:i(()=>[e(`
          <template>
            <DaysInput
              v-model="input"
