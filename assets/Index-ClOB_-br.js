import{d as f,I as v,J as c,e as y,o as w,i as u,f as n,B as s,h as o,t as m,u as i,T as a}from"./index-DpADEPPw.js";import{_ as b}from"./ComponentDocumentation.vue_vue_type_script_setup_true_lang-DmCV2oad.js";import{_ as $}from"./UiPage.vue_vue_type_style_index_0_lang-B1wj6ttl.js";import"./PrefabsTechVue3TanstackTable.es-2c4k5kzO.js";import"./PrefabsTechVue3Form.es-BoUjuj1d.js";const M={class:"section-content"},k={class:"section-content"},D={class:"section-content"},S={class:"section-content"},C={class:"section-content"},I={class:"section-content"},q=f({__name:"Index",setup(N){const{t:r}=v(),p=[{description:r("ui.message.documentation.eventDescription.close"),name:"close",payload:"-"}],g=[{default:"true",description:r("ui.message.documentation.propsDescription.enableClose"),prop:"enableClose",type:"Boolean"},{default:"-",description:r("ui.message.documentation.propsDescription.icon"),prop:"icon",type:"String"},{default:"-",description:r("ui.message.documentation.propsDescription.message"),prop:"message",type:"String | Array<string>"},{default:'"info"',description:r("ui.message.documentation.propsDescription.severity"),prop:"severity",type:'"danger" | "info" | "success" | "tip" | "warning"'},{default:"true",description:r("ui.message.documentation.propsDescription.showIcon"),prop:"showIcon",type:"Boolean"}],d=[{description:r("ui.message.documentation.slotDescription.default"),name:"default"},{description:r("ui.message.documentation.slotDescription.icon"),name:"icon"}];return(t,e)=>{const l=c("SshPre");return w(),y($,{"sub-title":t.$t("ui.message.subtitle"),title:t.$t("ui.message.title"),class:"demo-message"},{default:u(()=>[n("section",null,[n("h2",null,m(t.$t("ui.message.usage.basic")),1),e[6]||(e[6]=s()),n("div",M,[o(i(a),{message:t.$t("ui.message.contents.info"),severity:"info"},null,8,["message"]),e[1]||(e[1]=s()),o(i(a),{message:t.$t("ui.message.contents.success"),severity:"success"},null,8,["message"]),e[2]||(e[2]=s()),o(i(a),{message:t.$t("ui.message.contents.danger"),severity:"danger"},null,8,["message"]),e[3]||(e[3]=s()),o(i(a),{message:t.$t("ui.message.contents.warning"),severity:"warning"},null,8,["message"]),e[4]||(e[4]=s()),o(i(a),{message:t.$t("ui.message.contents.tip"),severity:"tip"},null,8,["message"]),e[5]||(e[5]=s()),o(l,{language:"html-vue"},{default:u(()=>e[0]||(e[0]=[s(`
          <template>
            <Message
        ...
        `)])),_:1})])]),e[27]||(e[27]=s()),n("section",null,[n("h2",null,m(t.$t("ui.message.usage.messageArray")),1),e[22]||(e[22]=s()),n("div",I,[o(i(a),{message:[t.$t("ui.message.contents.content1"),t.$t("ui.message.contents.content2"),t.$t("ui.message.contents.content3"),t.$t("ui.message.contents.content4")]},null,8,["message"]),e[21]||(e[21]=s()),o(l,{language:"html-vue"},{default:u(()=>e[20]||(e[20]=[s(`
          ...
          <script setup lang="ts">
            import { Message } from "@prefabs.tech/vue3-ui";
          <\/script>
        `)])),_:1})])]),e[28]||(e[28]=s()),o(b,{"events-data":p,"props-data":g,"props-table-title":t.$t("common.properties",{value:"MessageProperties"}),"slots-data":d},null,8,["props-table-title"])]),_:1},8,["sub-title","title"])}}});export{q as default};
