import{m as v,o as h,Z as p}from"./DzangolabVue3Form.es-f6c872e7.js";import{d as A,a4 as D,l as L,j as g,G as m,o as T,c as I,w as t,K as a,C as e,S as u,f as o,D as l}from"./index-d658739c-63af44b8.js";import"./index-bc5452e9.js";const V={class:"section-content"},S={class:"section-content"},k={class:"section-content"},$={class:"section-content"},C={class:"section-content"},P={class:"section-content"},q={name:"InputField"},R=A({...q,setup(F){const{t:b}=D(),w=v.string().min(3,{message:b("form.errors.input.min",{length:3})}),d=[{value:"Roslabel",label:"Roslabel - A fragrant flower often associated with romance"},{value:"Tulip",label:"Tulip - A bright, cup-shaped flower popular in spring"},{value:"Daisy",label:"Daisy - A simple, white flower with a yellow center"},{value:"Sunflower",label:"Sunflower - A tall plant with a large, yellow flower head"},{value:"Lily",label:"Lily - An elegant flower often used in bouquets"},{value:"Orchid",label:"Orchid - An exotic flower with a unique shape"},{value:"Marigold",label:"Marigold - A vibrant, orange or yellow flower"},{value:"Lavender",label:"Lavender - A fragrant flower known for its calming scent"},{value:"Peony",label:"Peony - A lush, full flower often used in weddings"},{value:"Chrysanthemum",label:"Chrysanthemum - A hardy flower with a variety of colors"},{value:"Daffodil",label:"Daffodil - A bright, yellow flower that blooms in spring"},{value:"Hydrangea",label:"Hydrangea - A large, cluster-like flower that changes color"}];let r=L({disabled:g("Lily"),input:g(),inputWithValidation:g(),noLabelInput:g()});return(n,i)=>{const c=m("router-link"),f=m("SshPre"),y=m("Page");return T(),I(y,{title:n.$t("form.label.typeahead"),class:"demo"},{toolbar:t(()=>[a(c,{to:{name:"form"},class:"back"},{default:t(()=>[e(u(n.$t("common.back")),1)]),_:1})]),default:t(()=>[e(),o("section",null,[o("h2",null,u(n.$t("form.label.basicInput")),1),e(),o("div",V,[a(f,{language:"html-vue"},{default:t(()=>[e(`
          <Form>
            <Typeahead
              v-model="input"
          ...
          <\/script>
        `)]),_:1}),e(),a(l(p),null,{default:t(()=>[a(l(h),{modelValue:l(r).noLabelInput,"onUpdate:modelValue":i[0]||(i[0]=s=>l(r).noLabelInput=s),placeholder:n.$t("form.placeholder.input"),suggestions:d},null,8,["modelValue","placeholder"])]),_:1})])]),e(),o("section",null,[o("h2",null,u(n.$t("form.label.labelInput")),1),e(),o("div",S,[a(f,{language:"html-vue"},{default:t(()=>[e(`
          <Form>
            <Typeahead
              v-model="input"
              :suggestions="suggestionItems"
