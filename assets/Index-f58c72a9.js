import{d as b,r as c,o as p,c as m,w as i,a as l,t as d,f as e,g as n,h as t,a4 as s,a0 as h,a1 as v,_}from"./index-0cbafccc.js";const g=u=>(h("data-v-17a427e8"),u=u(),v(),u),f={class:"section-content"},B={class:"section-content"},y={class:"section-content"},$={class:"section-content"},k={class:"section-content"},w={class:"container"},I={class:"section-content"},z={class:"container"},S={class:"section-content"},W={class:"container"},C={class:"section-content"},N={class:"container"},P=g(()=>l("i",{class:"pi pi-check"},null,-1)),L=g(()=>l("i",{class:"pi pi-times"},null,-1)),R={class:"section-content"},V=b({__name:"Index",setup(u){return(a,D)=>{const o=c("SshPre"),r=c("Page");return p(),m(r,{title:a.$t("ui.badge.title"),class:"demo-badge"},{default:i(()=>[l("section",null,[l("h2",null,d(a.$t("ui.badge.usage.basic")),1),e(),l("div",f,[n(o,{language:"html-vue"},{default:i(()=>[e(`
          <template>
            <Badge label="Basic" /> 
          </template>
        ...
        `)]),_:1}),e(),l("div",W,[n(t(s),{label:a.$t("ui.badge.label.locked"),"icon-left":"pi pi-lock"},null,8,["label"]),e(),n(t(s),{label:a.$t("ui.badge.label.unLocked"),"icon-right":"pi pi-lock-open",severity:"success"},null,8,["label"])])])]),e(),l("section",null,[l("h2",null,d(a.$t("ui.badge.usage.iconElement")),1),e(),l("div",C,[n(o,{language:"html-vue"},{default:i(()=>[e(`
          ...
          <script setup lang="ts">
            import { Badge } from "@dzangolab/vue3-ui";
          <\/script>
        `)]),_:1}),e(),l("div",N,[n(t(s),{label:a.$t("ui.badge.label.correct"),"icon-left":"true"},{iconLeft:i(()=>[P]),_:1},8,["label"]),e(),n(t(s),{label:a.$t("ui.badge.label.wrong"),severity:"danger","icon-right":"true"},{iconRight:i(()=>[L]),_:1},8,["label"])])])]),e(),l("section",null,[l("h2",null,d(a.$t("ui.badge.usage.customStyle")),1),e(),l("div",R,[n(o,{language:"html-vue"},{default:i(()=>[e(`
          <template>
