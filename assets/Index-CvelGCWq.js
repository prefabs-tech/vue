import{d as g,s as p,j as b,o as m,w as s,A as e,e as l,t as d,g as a,u as t,M as i,B as v,O as h,P as f,_ as B}from"./index-j9ugvOHR.js";import{_}from"./UiPage.vue_vue_type_style_index_0_lang-BeVgrYUm.js";const r=u=>(h("data-v-6f4cd0b3"),u=u(),f(),u),y={class:"section-content"},$={class:"section-content"},k={class:"section-content"},I={class:"section-content"},w={class:"container"},z={class:"section-content"},S={class:"container"},L={class:"section-content"},C={class:"container"},P={class:"section-content"},A={class:"container"},N={class:"section-content"},R={class:"container"},V=r(()=>l("i",{class:"pi pi-check"},null,-1)),D=r(()=>l("i",{class:"pi pi-times"},null,-1)),O=g({__name:"Index",setup(u){return(n,c)=>{const o=p("SshPre");return m(),b(_,{title:n.$t("ui.badge.title"),class:"demo-badge"},{toolbar:s(()=>[a(t(v),{label:n.$t("common.back"),"icon-left":"pi pi-chevron-left",size:"medium",variant:"textOnly",onClick:c[0]||(c[0]=U=>n.$router.push("/ui"))},null,8,["label"])]),default:s(()=>[e(),l("section",null,[l("h2",null,d(n.$t("ui.badge.usage.basic")),1),e(),l("div",y,[a(t(i),{label:n.$t("ui.badge.label.basic")},null,8,["label"]),e(),a(o,{language:"html-vue"},{default:s(()=>[e(`
          <template>
            <Badge label="Basic" /> 
          </template>
        ...
        `)]),_:1}),e()])]),e(),l("section",null,[l("h2",null,d(n.$t("ui.badge.usage.iconPackage")),1),e(),l("div",L,[l("div",C,[a(t(i),{label:n.$t("ui.badge.label.locked"),"icon-left":"pi pi-lock"},null,8,["label"]),e(),a(t(i),{label:n.$t("ui.badge.label.unLocked"),"icon-right":"fa-solid fa-lock-open",severity:"success"},null,8,["label"])]),e(),a(o,{language:"html-vue"},{default:s(()=>[e(`
          ...
          <script setup lang="ts">
            import { Badge } from "@dzangolab/vue3-ui";
          <\/script>
        `)]),_:1}),e()])]),e(),l("section",null,[l("h2",null,d(n.$t("ui.badge.usage.iconAndLabel")),1),e(),l("div",P,[l("div",A,[a(t(i),{label:n.$t("ui.badge.label.locked"),"icon-left":"pi pi-lock"},null,8,["label"]),e(),a(t(i),{label:n.$t("ui.badge.label.unLocked"),"icon-right":"pi pi-lock-open",severity:"success"},null,8,["label"])]),e(),a(o,{language:"html-vue"},{default:s(()=>[e(`
          <template>
            <Badge label="Locked" icon-left="pi pi-lock" />
          ...
          <script setup lang="ts">
            import { Badge } from "@dzangolab/vue3-ui";
          <\/script>
        `)]),_:1}),e()])]),e(),l("section",null,[l("h2",null,d(n.$t("ui.badge.usage.iconElement")),1),e(),l("div",N,[l("div",R,[a(t(i),{label:n.$t("ui.badge.label.correct")},{iconLeft:s(()=>[V]),_:1},8,["label"]),e(),a(t(i),{label:n.$t("ui.badge.label.wrong"),severity:"danger"},{iconRight:s(()=>[D]),_:1},8,["label"])]),e(),a(o,{language:"html-vue"},{default:s(()=>[e(`
          <template>
            <Badge label="Correct">
              <template #iconLeft>
                <i class="pi pi-check" >
