import{h as p,k as y}from"./PrefabsTechVue3Form.es-Ch3nVnvi.js";import{d as P,L as V,N as M,O as $,r as f,M as w,o as B,e as O,f as s,h as l,t as d,z as t,a as o,u as n}from"./index-He64vdhC.js";import{_ as U}from"./ComponentDocumentation.vue_vue_type_script_setup_true_lang-CdAQ3dS8.js";import{_ as A}from"./FormPage.vue_vue_type_style_index_0_lang-C5drZROO.js";import"./PrefabsTechVue3TanstackTable.es-CunFClEE.js";const S={class:"section-content"},I={class:"section-content"},R={class:"section-content"},Y={class:"section-content"},T={class:"section-content"},j={class:"section-content"},z={class:"section-content"},F={class:"section-content"},C={class:"section-content"},H={class:"section-content"},L={class:"section-content"},N={class:"section-content"},W={class:"section-content"},J={class:"section-content"},Z={name:"DatePickerInput"},h=P({...Z,setup(q){const{t:u}=V(),v=M.date({invalid_type_error:u("form.errors.datePicker.invalid")}).max(new Date,{message:u("form.errors.datePicker.invalid")}),D=new Date,b=D,g=[{description:u("form.documentation.eventDescription.input.modelValue"),name:"update:modelValue",payload:"date: string | string[] | number | number[] | Date | Date[] | MonthPickerValue"}],k=[{default:"true",description:u("form.documentation.propsDescription.datePicker.autoApply"),prop:"autoApply",type:"Boolean"},{default:"false",description:u("form.documentation.propsDescription.input.disabled"),prop:"disabled",type:"Boolean"},{default:"false",description:u("form.documentation.propsDescription.datePicker.enableTimePicker"),prop:"enableTimePicker",type:"Boolean"},{default:"-",description:u("form.documentation.propsDescription.datePicker.format"),prop:"format",type:"String"},{default:"-",description:u("form.documentation.propsDescription.input.label"),prop:"label",type:"String"},{default:"-",description:u("form.documentation.propsDescription.input.modelValue"),prop:"modelValue",type:"Date | Date[] | MonthPickerValue | number | number[] | string | string[] | null"},{default:'"date"',description:u("form.documentation.propsDescription.input.name"),prop:"name",type:"String"},{default:"-",description:u("form.documentation.propsDescription.input.placeholder"),prop:"placeholder",type:"String"},{default:"-",description:u("form.documentation.propsDescription.input.schema"),prop:"schema",type:"Object (z.ZodType)"},{default:"-",description:u("form.documentation.propsDescription.datePicker.teleport"),prop:"teleport",type:"Boolean | String"}];let r=$({appointmentDate:f(D),arrivalDate:f(),availableDatetime:f([D,new Date(b.setDate(b.getDate()+7))]),dateOfBirth:f(D),dateRange:f([D,new Date(b.setDate(b.getDate()+7))]),joinedDate:f(),month:f(),monthAndYear:f(),noLabelInput:f(),presentationDate:f(D),reportDate:f([D,new Date(b.setDate(b.getDate()+7))]),time:f(),year:f(D.getFullYear())});return(a,e)=>{const m=w("SshPre");return B(),O(A,{subtitle:a.$t("form.subtitle.datePicker"),title:a.$t("form.label.datePicker"),class:"demo"},{default:s(()=>[l("section",null,[l("h2",null,d(a.$t("form.label.basicInput")),1),e[16]||(e[16]=t()),l("div",S,[o(n(p),{modelValue:n(r).noLabelInput,"onUpdate:modelValue":e[0]||(e[0]=i=>n(r).noLabelInput=i),placeholder:"MM/dd/yyyy"},null,8,["modelValue"]),e[15]||(e[15]=t()),o(m,{language:"html-vue"},{default:s(()=>[...e[14]||(e[14]=[t(`
        ...
        `,-1)])]),_:1})])]),e[60]||(e[60]=t()),l("section",null,[l("h2",null,d(a.$t("form.label.customFormat")),1),e[31]||(e[31]=t()),l("div",j,[o(n(p),{modelValue:n(r).dateOfBirth,"onUpdate:modelValue":e[5]||(e[5]=i=>n(r).dateOfBirth=i),format:"yyyy/MM/dd",label:a.$t("form.label.dateOfBirth")},null,8,["modelValue","label"]),e[30]||(e[30]=t()),o(m,{language:"html-vue"},{default:s(()=>[...e[29]||(e[29]=[t(`
          ...
          const dateOfBirth = ref(new Date());
          <\/script>
        `,-1)])]),_:1})])]),e[61]||(e[61]=t()),l("section",null,[l("h2",null,d(a.$t("form.label.dateRange")),1),e[34]||(e[34]=t()),l("div",z,[o(n(p),{modelValue:n(r).dateRange,"onUpdate:modelValue":e[6]||(e[6]=i=>n(r).dateRange=i),label:a.$t("form.label.dateRange"),range:""},null,8,["modelValue","label"]),e[33]||(e[33]=t()),o(m,{language:"html-vue"},{default:s(()=>[...e[32]||(e[32]=[t(`
          <template>
            <DatePicker 
              v-model="dateRange"
              label="Date range"
          ...
          <\/script>
        `,-1)])]),_:1})])]),e[62]||(e[62]=t()),l("section",null,[l("h2",null,d(a.$t("form.label.multiCalendars")),1),e[37]||(e[37]=t()),l("div",F,[o(n(p),{modelValue:n(r).reportDate,"onUpdate:modelValue":e[7]||(e[7]=i=>n(r).reportDate=i),label:a.$t("form.label.reportDate"),"multi-calendars":"",range:""},null,8,["modelValue","label"]),e[36]||(e[36]=t()),o(m,{language:"html-vue"},{default:s(()=>[...e[35]||(e[35]=[t(`
          <template>
            <DatePicker 
              v-model="reportDate"
              label="Report date"
