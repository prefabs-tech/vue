import{w as y}from"./PrefabsTechVue3Form.es-DdaTeD37.js";import{d as b,r as v,H as k,e as C,o as $,j as n,B as t,f as s,t as r,h as o,u as a,a2 as f,v as p,N as c}from"./index-Bl6M8CLo.js";import{_ as g}from"./LayoutPage.vue_vue_type_style_index_0_lang-CDZyl_3D.js";const F={class:"section-content"},S={class:"section-content"},B={name:"StickyCollapsibleFooter"},N=b({...B,setup(w){const u=v(),m=e=>{e&&alert(e)};return(e,l)=>{const d=k("SshPre");return $(),C(g,{title:e.$t("layout.label.stickyCollapsibleFooter"),class:"demo sticky-collapsible-footer"},{toolbar:n(()=>[o(a(p),{label:e.$t("common.back"),"icon-left":"pi pi-chevron-left",size:"medium",variant:"textOnly",onClick:l[0]||(l[0]=i=>e.$router.push("/layout"))},null,8,["label"])]),default:n(()=>[l[12]||(l[12]=t()),s("section",null,[s("h2",null,r(e.$t("layout.label.footerFixed")),1),l[8]||(l[8]=t()),s("div",F,[o(a(f),null,{default:n(()=>[o(a(y),{modelValue:u.value,"onUpdate:modelValue":l[1]||(l[1]=i=>u.value=i),placeholder:e.$t("layout.placeholder.input")},null,8,["modelValue","placeholder"]),l[4]||(l[4]=t()),o(a(p),{label:e.$t("layout.label.submit"),size:"small",onClick:l[2]||(l[2]=i=>m(u.value))},null,8,["label"]),l[5]||(l[5]=t()),o(a(p),{label:e.$t("layout.label.cancel"),severity:"secondary",size:"small",variant:"outlined",onClick:l[3]||(l[3]=i=>m(e.$t("layout.label.cancelled")))},null,8,["label"])]),_:1}),l[7]||(l[7]=t()),o(d,{language:"html-vue"},{default:n(()=>l[6]||(l[6]=[t(`
          <template>
