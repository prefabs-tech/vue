import{w as u,$ as v}from"./PrefabsTechVue3Form.es-DdaTeD37.js";import{d as g,E as I,I as V,L as $,r as d,H as w,e as y,o as h,j as p,B as l,f as o,t as i,h as s,u as t,v as U}from"./index-Bl6M8CLo.js";import{_ as E}from"./FormPage.vue_vue_type_style_index_0_lang-BpPB7a64.js";const S={class:"section-content"},z={class:"section-content"},T={class:"section-content"},W={class:"section-content"},k={class:"section-content"},B={class:"section-content"},C={name:"InputField"},D=g({...C,setup(F){const{t:f}=I(),b=V.string().min(3,{message:f("form.errors.input.min",{length:3})});let a=$({disabled:d("monorepo@gmail.com"),input:d(),inputWithValidation:d(),noLabelInput:d(),passwordInput:d()});return(n,e)=>{const m=w("SshPre");return h(),y(E,{title:n.$t("form.label.input"),class:"demo"},{toolbar:p(()=>[s(t(U),{label:n.$t("common.back"),"icon-left":"pi pi-chevron-left",size:"medium",variant:"textOnly",onClick:e[0]||(e[0]=r=>n.$router.push("/form"))},null,8,["label"])]),default:p(()=>[e[25]||(e[25]=l()),o("section",null,[o("h2",null,i(n.$t("form.label.basicInput")),1),e[9]||(e[9]=l()),o("div",S,[s(t(u),{modelValue:t(a).noLabelInput,"onUpdate:modelValue":e[1]||(e[1]=r=>t(a).noLabelInput=r),placeholder:n.$t("form.placeholder.username"),type:"text"},null,8,["modelValue","placeholder"]),e[8]||(e[8]=l()),s(m,{language:"html-vue"},{default:p(()=>e[7]||(e[7]=[l(`
          <template>
            <Input 
              v-model="username"
