import{d as E,e as d,r as $,o as L,c as z,w as i,g as l,f as e,t as r,a as o,h as s,a5 as u,Y as f,Z as v,a7 as c}from"./index-146b4921.js";const D={class:"section-content"},O={class:"container"},I={class:"section-content"},P={class:"container"},S={class:"section-content"},T={class:"container"},N={class:"section-content"},U={class:"container"},V={class:"section-content"},H={class:"container"},A={class:"section-content"},Y={class:"container"},q=E({__name:"Index",setup(Z){const p=d(void 0),b=d(!1),M=d(!1),w=d(!1),h=d(!1),C=d(!1),g=d(!1),y=()=>{p.value=new Date,g.value=!1};return(t,n)=>{const B=$("router-link"),m=$("SshPre"),k=$("Page");return L(),z(k,{title:t.$t("ui.confirmationModal.title"),class:"demo"},{toolbar:i(()=>[l(B,{to:{name:"ui"},class:"back"},{default:i(()=>[e(r(t.$t("common.back")),1)]),_:1})]),default:i(()=>[e(),o("section",null,[o("h2",null,r(t.$t("ui.confirmationModal.usage.basic")),1),e(),o("div",D,[l(m,{language:"html-vue"},{default:i(()=>[e(`
          <template>
            <div>
              <ButtonElement
                label="Confirm"
