import{X as b}from"./DzangolabVue3TanstackTable.es-Cs7AfVxX.js";import{d as T,r as D,D as C,e as k,o as g,w as s,B as a,f as n,t as d,i as o,u as l,a as w,b as $,W as z,p as f}from"./index-cBKKDCP1.js";import{d as m}from"./data-C1SmRPuO.js";import{_ as A}from"./TablePage.vue_vue_type_style_index_0_lang-Crq0Wc9X.js";import"./DzangolabVue3Form.es-CUdsX3QP.js";const K={class:"section-content"},S={class:"section-content"},E={class:"section-content"},M={class:"section-content"},B={class:"section-content"},O={class:"section-content"},V={class:"section-content"},N={class:"section-content"},P={class:"section-content"},j={key:0},q={class:"section-content"},J={class:"section-content"},W={class:"section-content"},Y={class:"section-content"},F={name:"SortableTable"},H=T({...F,setup(R){const u=[{accessorKey:"email",header:"Email"},{accessorKey:"name",header:"Full name"},{align:"right",accessorKey:"age",header:"Age"},{accessorKey:"city",header:"City"}],p=D(!1),c=u.map(e=>({...e,enableSorting:!0})),y=["right","top","bottom","left"],v=u.map((e,t)=>({...e,tooltip:!0,tooltipOptions:{position:y[t]}}));return(e,t)=>{const r=C("SshPre");return g(),k(A,{title:e.$t("table.title"),class:"demo data-table"},{toolbar:s(()=>[o(l(f),{label:e.$t("common.back"),"icon-left":"pi pi-chevron-left",size:"medium",variant:"textOnly",onClick:t[0]||(t[0]=i=>e.$router.push("/table"))},null,8,["label"])]),default:s(()=>[t[46]||(t[46]=a()),n("section",null,[n("h2",null,d(e.$t("table.usage.basic")),1),t[8]||(t[8]=a()),n("div",K,[o(l(b),{"columns-data":u,data:l(m).slice(0,15),paginated:!1},null,8,["data"]),t[7]||(t[7]=a()),o(r,{language:"html-vue"},{default:s(()=>t[6]||(t[6]=[a(`
          <template>
            <Table
