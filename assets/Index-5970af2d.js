import{e as m,n as u}from"./DzangolabVue3Form.es-4dbe21ec.js";import{d as P,a7 as V,p as $,j as c,K as b,o as _,c as I,w as a,L as n,C as e,M as i,f as l,E as o,e as F}from"./index-137faed7-55cf5996.js";import{m as z}from"./index-6cf04a93.js";import{_ as S}from"./FormPage.vue_vue_type_style_index_0_lang-0d3aebfc.js";const y={class:"section-content"},U={class:"section-content"},L={class:"section-content"},E={class:"section-content"},O={class:"section-content"},k={class:"section-content"},q={class:"section-content"},M={class:"section-content"},W={name:"PasswordInputField"},D=P({...W,setup(C){const{t:f}=V(),h=z.string({invalid_type_error:f("form.errors.password.invalid"),required_error:f("form.errors.input.required")}).min(8,{message:f("form.errors.password.min",{length:8})}).regex(/^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)(?=.*[\W_]).+$/,f("form.errors.password.invalid")),g={required:f("form.errors.input.required"),weak:f("form.errors.password.invalid")},w={minLength:10,minLowercase:1,minUppercase:1,minSymbols:1};let t=$({customValidationInput:c(),disabled:c("P@ssw0rd"),input:c(),inputWithValidation:c(),noLabelInput:c(),passwordInput:c()});return(s,d)=>{const v=b("router-link"),p=b("SshPre");return _(),I(S,{title:s.$t("form.label.password"),class:"demo"},{toolbar:a(()=>[n(v,{to:{name:"form"},class:"back"},{default:a(()=>[e(i(s.$t("common.back")),1)]),_:1})]),default:a(()=>[e(),l("section",null,[l("h2",null,i(s.$t("form.label.basicInput")),1),e(),l("div",y,[n(p,{language:"html-vue"},{default:a(()=>[e(`
          <From>
            <Password 
              v-model="input"
