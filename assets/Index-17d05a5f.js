import{l as d,J as v}from"./DzangolabVue3Form.es-9b4072fb.js";import{d as g,a5 as w,p as V,j as p,J as c,o as I,c as S,w as u,K as a,W as e,L as m,f as l,D as t}from"./index-729398ab-7d472bf5.js";import{m as _}from"./index-8bccc1c0.js";import{_ as $}from"./FormPage.vue_vue_type_style_index_0_lang-b9988225.js";const z={class:"section-content"},k={class:"section-content"},F={class:"section-content"},U={class:"section-content"},W={class:"section-content"},D={name:"SwitchInput"},P=g({...D,setup(L){const{t:f}=w(),b=_.coerce.boolean().refine(n=>n===!0,{message:f("form.errors.switch.invalid")});let o=V({disabled:p(!0),input:p(),inputWithValidation:p(!1),noLabelInput:p()});return(n,s)=>{const h=c("router-link"),r=c("SshPre");return I(),S($,{title:n.$t("form.label.switch"),class:"demo"},{toolbar:u(()=>[a(h,{to:{name:"form"},class:"back"},{default:u(()=>[e(m(n.$t("common.back")),1)]),_:1})]),default:u(()=>[e(),l("section",null,[l("h2",null,m(n.$t("form.label.basicInput")),1),e(),l("div",z,[a(t(d),{modelValue:t(o).noLabelInput,"onUpdate:modelValue":s[0]||(s[0]=i=>t(o).noLabelInput=i)},null,8,["modelValue"]),e(),a(r,{language:"html-vue"},{default:u(()=>[e(`
          <template>
