import{F as p,o as b}from"./DzangolabVue3Form.es-k-Xjvcvt.js";import{d as h,z as g,A as v,r as d,s as I,j as V,o as $,w as m,B as e,e as t,t as i,g as o,u as l,C as w}from"./index-CqimUq5D.js";import{z}from"./index-mSkvzYyn.js";import{_ as y}from"./FormPage.vue_vue_type_style_index_0_lang-g4uxL8pa.js";const U={class:"section-content"},F={class:"section-content"},S={class:"section-content"},C={class:"section-content"},E={class:"section-content"},T={class:"section-content"},W={name:"InputField"},D=h({...W,setup(k){const{t:f}=g(),c=z.string().min(3,{message:f("form.errors.input.min",{length:3})});let s=v({disabled:d("monorepo@gmail.com"),input:d(),inputWithValidation:d(),noLabelInput:d(),passwordInput:d()});return(n,a)=>{const u=I("SshPre");return $(),V(y,{title:n.$t("form.label.input"),class:"demo"},{toolbar:m(()=>[o(l(w),{label:n.$t("common.back"),"icon-left":"pi pi-chevron-left",size:"medium",variant:"textOnly",onClick:a[0]||(a[0]=r=>n.$router.push("/form"))},null,8,["label"])]),default:m(()=>[e(),t("section",null,[t("h2",null,i(n.$t("form.label.basicInput")),1),e(),t("div",U,[o(l(p),{modelValue:l(s).noLabelInput,"onUpdate:modelValue":a[1]||(a[1]=r=>l(s).noLabelInput=r),placeholder:n.$t("form.placeholder.username"),type:"text"},null,8,["modelValue","placeholder"]),e(),o(u,{language:"html-vue"},{default:m(()=>[e(`
          <template>
            <Input 
              v-model="username"
