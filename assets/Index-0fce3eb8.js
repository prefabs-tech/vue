import{o as r,a as v,ap as h,aq as f,f as i,d,c as p,w as l,X as e,K as n,r as b,D as o,as as g,ao as q,L as t}from"./index-729398ab-f7824fe4.js";import{_ as $}from"./index-9966f943.js";import{_ as A}from"./UiPage.vue_vue_type_style_index_0_lang-a00b0a2a.js";const I={name:"TestComponent"};const S=u=>(h("data-v-aeb7ff3f"),u=u(),f(),u),w={class:"test"},C=S(()=>i("p",null,"This is a test component",-1)),D=[C];function N(u,s,c,_,W,Y){return r(),v("div",w,D)}const z=$(I,[["render",N],["__scopeId","data-v-aeb7ff3f"]]),k=i("div",{title:"Sagittis a curabitur"},[i("p",null,`
      ...
      `,-1),F=["icon"],H=i("p",null,`
        ...
        aliquam egestas scelerisque porttitor nullam ad a elementum dignissim
        pulvinar.
      `,-1),J=i("ul",{role:"list"},[i("li",null,"Vestibulum parturient"),e(),i("li",null,"Ullamcorper orci condimentum"),e(),i("li",null,"Sodales scelerisque ultrices")],-1),M={name:"DemoAccordion"},m=d({...M,setup(u){return(s,c)=>(r(),p(o(g),null,{default:l(()=>[i("div",{icon:o(B),title:"Sagittis a curabitur"},[G,e(),K],8,E),e(),i("div",{icon:o(L),title:"Diam mus id per posuere vivamus"},[X,e(),j],8,O),e(),i("div",{icon:o(U),title:"Diam a parturient sociosque"},[H,e(),J],8,F)]),_:1}))}});const Q=i("div",null,[i("p",null,`
