import{q as a}from"./PrefabsTechVue3TanstackTable.es-4Bbo1BmD.js";import{d as F,u as I,r as S,o as y,h as w,w as p,a as n,t as l,b as t,e as s,f as m,m as g}from"./index-CS8lVMEF.js";import{_ as D}from"./ComponentDocumentation.vue_vue_type_script_setup_true_lang-CodqleA_.js";import{_ as $}from"./FormPage.vue_vue_type_style_index_0_lang-CHIuJwhc.js";const x={class:"section-content"},B={class:"section-content"},j={class:"section-content"},M={class:"section-content"},P={class:"section-content"},L={class:"section-content"},h={class:"section-content"},E={class:"section-content"},O=["src"],k={class:"image-details"},C={name:"FileInputDemo"},K=F({...C,setup(U){const{t:i}=I(),u={accept:["image/jpeg","image/png"],maxFiles:2,maxSize:1048576,minSize:10240},b=g(()=>[{description:i("form.documentation.eventDescription.fileInput.filesUpdate"),name:"on:filesUpdate",payload:"files: FileExtended[]"}]),c=g(()=>[{default:"-",description:i("form.documentation.propsDescription.fileInput.addDescriptionLabel"),prop:"addDescriptionLabel",type:"String"},{default:'"Select"',description:i("form.documentation.propsDescription.fileInput.buttonLabel"),prop:"buttonLabel",type:"String"},{default:'"Selected"',description:i("form.documentation.propsDescription.fileInput.buttonLabelSelected"),prop:"buttonLabelSelected",type:"String"},{default:"-",description:i("form.documentation.propsDescription.fileInput.buttonProps"),prop:"buttonProps",type:"Object"},{default:"-",description:i("form.documentation.propsDescription.fileInput.descriptionPlaceholder"),prop:"descriptionPlaceholder",type:"String"},{default:'"Drag and drop or click"',description:i("form.documentation.propsDescription.fileInput.dropzoneMessage"),prop:"dropzoneMessage",type:"String"},{default:"-",description:i("form.documentation.propsDescription.fileInput.dropzoneOptions"),prop:"dropzoneOptions",type:"Object"},{default:"false",description:i("form.documentation.propsDescription.fileInput.enableDescription"),prop:"enableDescription",type:"Boolean"},{default:"-",description:i("form.documentation.propsDescription.fileInput.errorMessages"),prop:"errorMessages",type:"FileErrorMessages"},{default:'"button"',description:i("form.documentation.propsDescription.fileInput.inputMethod"),prop:"inputMethod",type:'"button" | "dropzone"'},{default:"-",description:i("form.documentation.propsDescription.input.label"),prop:"label",type:"String"},{default:'"update"',description:i("form.documentation.propsDescription.fileInput.mode"),prop:"mode",type:'"append" | "update"'},{default:"false",description:i("form.documentation.propsDescription.fileInput.multiple"),prop:"multiple",type:"Boolean"},{default:'"file"',description:i("form.documentation.propsDescription.input.name"),prop:"name",type:"String"},{default:"false",description:i("form.documentation.propsDescription.fileInput.showErrorMessage"),prop:"showErrorMessage",type:"Boolean"}]),v=g(()=>[{description:i("form.documentation.slotDescription.fileInput.details"),name:"details",props:"{ file: FileExtended, index: number }"},{description:i("form.documentation.slotDescription.fileInput.preview"),name:"preview",props:"{ file: FileExtended }"}]),f=o=>{const e=Number((o/1024).toFixed(2));return e>=1024?`${(e/1024).toFixed(2)} MB`:`${e} KB`},z=o=>URL?.createObjectURL(o);return(o,e)=>{const r=S("SshPre");return y(),w($,{subtitle:o.$t("form.subtitle.fileInput"),title:o.$t("form.label.fileInput"),class:"demo"},{default:p(()=>[n("section",null,[n("h2",null,l(o.$t("form.label.basicInput")),1),e[2]||(e[2]=t()),n("div",x,[s(m(a)),e[1]||(e[1]=t()),s(r,{language:"html-vue"},{default:p(()=>[...e[0]||(e[0]=[t(`
        ...
        `,-1)])]),_:1})])]),e[31]||(e[31]=t()),n("section",null,[n("h2",null,l(o.$t("form.label.append")),1),e[20]||(e[20]=t()),n("div",h,[s(m(a),{"enable-description":"","input-method":"dropzone",mode:"append",multiple:"",name:"files","show-error-message":""}),e[19]||(e[19]=t()),s(r,{language:"html-vue"},{default:p(()=>[...e[18]||(e[18]=[t(`
          ...
          import { FileInput } from "@prefabs.tech/vue3-form";
          <\/script>
        `,-1)])]),_:1})])]),e[32]||(e[32]=t()),n("section",null,[n("h2",null,l(o.$t("form.label.customRender")),1),e[24]||(e[24]=t()),n("div",E,[s(m(a),{"dropzone-options":{accept:["image/jpeg","image/png"],maxFiles:5},"input-method":"dropzone",multiple:"",name:"custom-file-input","show-error-message":""},{preview:p(({file:d})=>[n("img",{src:z(d),alt:"uploaded-file",class:"image-preview"},null,8,O)]),details:p(({file:d})=>[n("span",k,l(`${d.name} (${f(d.size)})`),1)]),_:1}),e[23]||(e[23]=t()),s(r,{language:"html-vue"},{default:p(()=>[...e[22]||(e[22]=[t(`
          <template>
            <FileInput
              :dropzone-options="{
                accept: ['image/jpeg', 'image/png'],
        ...
        `,-1)])]),_:1})])]),e[33]||(e[33]=t()),s(D,{"events-data":b.value,"props-data":c.value,"props-table-title":o.$t("common.properties",{value:"FileInputProperties"}),"slots-data":v.value},null,8,["events-data","props-data","props-table-title","slots-data"]),e[34]||(e[34]=t()),s(r,{language:"html-vue"},{default:p(()=>[...e[25]||(e[25]=[t(`
