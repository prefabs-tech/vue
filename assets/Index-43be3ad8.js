import{d as _,j as p,G as v,o as y,c as B,w as o,K as n,C as t,S as u,f as e,D as a,ao as i,aj as E,ak as $}from"./index-d658739c-63af44b8.js";import{_ as z}from"./UiPage.vue_vue_type_style_index_0_lang-d476e23e.js";import{_ as k}from"./index-bc5452e9.js";const d=r=>(E("data-v-69273c80"),r=r(),$(),r),O={class:"section-content"},S={class:"container"},C={class:"section-content"},I={class:"container"},w={class:"section-content"},D={class:"container"},L={class:"section-content"},T={class:"container"},N={class:"section-content"},P={class:"container"},R={class:"section-content"},M={class:"container"},V={class:"section-content"},j={class:"container"},A={class:"section-content"},H={className:"container"},W={class:"section-content"},G={className:"container"},K=d(()=>e("i",{class:"pi pi-user"},null,-1)),q=d(()=>e("i",{class:"pi pi-user"},null,-1)),F=d(()=>e("i",{class:"pi pi-user"},null,-1)),J={class:"section-content"},Q={class:"container"},U={class:"section-content"},X={class:"container"},Y={class:"container"},Z={class:"section-content"},x={class:"container"},tt=_({__name:"Index",setup(r){const m=p(void 0),c=p(!1),g=()=>{m.value=new Date},h=()=>{c.value=!0,setTimeout(()=>{c.value=!1},5e3)};return(l,b)=>{const f=v("router-link"),s=v("SshPre");return y(),B(z,{title:l.$t("ui.button.title"),class:"demo-button"},{toolbar:o(()=>[n(f,{to:{name:"ui"},class:"back"},{default:o(()=>[t(u(l.$t("common.back")),1)]),_:1})]),default:o(()=>[t(),e("section",null,[e("h2",null,u(l.$t("ui.button.usage.basic")),1),t(),e("div",O,[n(s,{language:"html-vue"},{default:o(()=>[t(`
          <template> 
        ...
        `)]),_:1}),t(),e("div",M,[n(a(i),{size:"small",label:l.$t("ui.button.label.small")},null,8,["label"]),t(),n(a(i),{size:"medium",label:l.$t("ui.button.label.medium")},null,8,["label"]),t(),n(a(i),{size:"large",label:l.$t("ui.button.label.large")},null,8,["label"])])])]),t(),e("section",null,[e("h2",null,u(l.$t("ui.button.usage.variant")),1),t(),e("div",V,[n(s,{language:"html-vue"},{default:o(()=>[t(`
          ...
          <script setup lang="ts"> 
            import { ButtonElement } from "@dzangolab/vue3-ui"; 
          <\/script>
        `)]),_:1}),t(),e("div",j,[n(a(i),{size:"medium",label:l.$t("ui.button.label.textOnly"),variant:"textOnly"},null,8,["label"]),t(),n(a(i),{size:"medium",label:l.$t("ui.button.label.outlined"),variant:"outlined"},null,8,["label"]),t(),n(a(i),{size:"medium",label:l.$t("ui.button.label.default")},null,8,["label"])])])]),t(),e("section",null,[e("h2",null,u(l.$t("ui.button.usage.icons.icon")),1),t(),e("div",A,[n(s,{language:"html-vue"},{default:o(()=>[t(`
          <template> 
          ...
          <script setup lang="ts"> 
            import { ButtonElement } from "@dzangolab/vue3-ui"; 
          <\/script>
        `)]),_:1}),t(),e("div",H,[n(a(i),{variant:"textOnly",severity:"secondary","icon-left":"pi pi-user"}),t(),n(a(i),{variant:"outlined",severity:"secondary","icon-left":"pi pi-user"}),t(),n(a(i),{variant:"filled","icon-left":"pi pi-user"})])])]),t(),e("section",null,[e("h2",null,u(l.$t("ui.button.usage.icons.iconElement")),1),t(),e("div",W,[n(s,{language:"html-vue"},{default:o(()=>[t(`
          <template> 
