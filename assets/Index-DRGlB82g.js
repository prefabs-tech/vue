import{_ as d,w as b}from"./PrefabsTechVue3Form.es-Be_J869o.js";import{d as T,L as x,N as D,M as y,o as h,e as F,f as s,h as o,t as m,z as e,a as p,u as n,O as S,r as f}from"./index-RPvtGx3x.js";import{_ as q}from"./ComponentDocumentation.vue_vue_type_script_setup_true_lang-BU4nLuL1.js";import{_ as w}from"./FormPage.vue_vue_type_style_index_0_lang-CShZ86aY.js";import"./PrefabsTechVue3TanstackTable.es-Dqi5F_Wh.js";const M={class:"section-content"},E={class:"section-content"},z={class:"section-content"},O={class:"section-content"},U={class:"section-content"},B={class:"section-content"},L={class:"section-content"},N={name:"TextInputField"},A=T({...N,setup(P){const{t:a}=x(),v=[{description:a("form.documentation.eventDescription.input.modelValue"),name:"update:modelValue",payload:"string | null | undefined"}],I=D.string().length(5,{message:a("form.errors.input.length",{length:5})}),V=[{default:"false",description:a("form.documentation.propsDescription.input.disabled"),prop:"disabled",type:"Boolean"},{default:'{ invalid: "Please provide a valid input data", required: "The field is required", }',description:a("form.documentation.propsDescription.input.errorMessages"),prop:"errorMessages",type:"TextErrorMessages"},{default:"-",description:a("form.documentation.propsDescription.input.label"),prop:"label",type:"String"},{default:"-",description:a("form.documentation.propsDescription.input.modelValue"),prop:"modelValue",type:"String | null | undefined"},{default:'"text_input"',description:a("form.documentation.propsDescription.input.name"),prop:"name",type:"String"},{default:"-",description:a("form.documentation.propsDescription.input.options"),prop:"options",type:"Object"},{default:"-",description:a("form.documentation.propsDescription.input.placeholder"),prop:"placeholder",type:"String"},{default:"-",description:a("form.documentation.propsDescription.input.schema"),prop:"schema",type:"z.ZodType<string | number | object>"}],$={required:a("form.errors.input.required")},g={ignore_whitespace:!0,required:!0};let i=S({customValidationInput:f(),disabled:f("dzangolab"),input:f(),inputWithValidation:f(),noLabelInput:f(),textInput:f()});return(l,t)=>{const u=y("SshPre");return h(),F(w,{subtitle:n(a)("form.subtitle.text"),title:l.$t("form.label.textInput"),class:"demo"},{default:s(()=>[o("section",null,[o("h2",null,m(l.$t("form.label.basicInput")),1),t[9]||(t[9]=e()),o("div",M,[p(n(d),{modelValue:n(i).noLabelInput,"onUpdate:modelValue":t[0]||(t[0]=r=>n(i).noLabelInput=r),placeholder:l.$t("form.placeholder.input")},null,8,["modelValue","placeholder"]),t[8]||(t[8]=e()),p(u,{language:"html-vue"},{default:s(()=>[...t[7]||(t[7]=[e(`
          ...
          <\/script>
        `,-1)])]),_:1})])]),t[29]||(t[29]=e()),o("section",null,[o("h2",null,m(l.$t("form.label.labelInput")),1),t[12]||(t[12]=e()),o("div",E,[p(n(d),{modelValue:n(i).input,"onUpdate:modelValue":t[1]||(t[1]=r=>n(i).input=r),label:l.$t("form.label.textInput"),placeholder:l.$t("form.placeholder.textInput"),name:"label-input"},null,8,["modelValue","label","placeholder"]),t[11]||(t[11]=e()),p(u,{language:"html-vue"},{default:s(()=>[...t[10]||(t[10]=[e(`
          <template>
            <TextInput 
              v-model="input"
              label="Input"
