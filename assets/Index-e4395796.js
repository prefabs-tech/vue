import{m as V,e as d,Z as p}from"./DzangolabVue3Form.es-dfaaf9a3.js";import{d as N,a3 as _,l as $,j as b,E as v,o as F,c as z,w as r,J as l,C as n,Z as s,f as t,N as e}from"./index-66214709-7b57635f.js";import{_ as E}from"./FormPage.vue_vue_type_style_index_0_lang-2c538954.js";import"./index-2f944215.js";const O={class:"section-content"},w={class:"section-content"},U={class:"section-content"},k={class:"section-content"},M={class:"section-content"},S={class:"section-content"},y={class:"section-content"},q={name:"NumberInputField"},Z=N({...q,setup(C){const{t:f}=_(),h=V.coerce.number({invalid_type_error:f("form.errors.number.invalid")}).gte(1,f("form.errors.number.invalid")).lte(100,f("form.errors.number.invalid")),g={invalid:f("form.errors.number.invalid"),required:f("form.errors.number.required")},c={min:1,max:100,allow_leading_zeroes:!1};let a=$({customValidationInput:b(),disabled:b(100),input:b(),inputWithValidation:b(),noLabelInput:b(),textInput:b()});return(o,u)=>{const I=v("router-link"),i=v("SshPre");return F(),z(E,{title:o.$t("form.label.number"),class:"demo"},{toolbar:r(()=>[l(I,{to:{name:"form"},class:"back"},{default:r(()=>[n(s(o.$t("common.back")),1)]),_:1})]),default:r(()=>[n(),t("section",null,[t("h2",null,s(o.$t("form.label.basicInput")),1),n(),t("div",O,[l(i,{language:"html-vue"},{default:r(()=>[n(`
          <Form>
            <NumberInput 
              v-model="input"
        ...
        `)]),_:1}),n(),l(e(p),null,{default:r(()=>[l(e(d),{modelValue:e(a).input,"onUpdate:modelValue":u[1]||(u[1]=m=>e(a).input=m),label:o.$t("form.label.number"),placeholder:o.$t("form.placeholder.number")},null,8,["modelValue","label","placeholder"])]),_:1})])]),n(),t("section",null,[t("h2",null,s(o.$t("form.label.disabled")),1),n(),t("div",U,[l(i,{language:"html-vue"},{default:r(()=>[n(`
          ...
          import { NumberInput } from "@dzangolab/vue3-form";
          <\/script>
        `)]),_:1}),n(),l(e(p),null,{default:r(()=>[l(e(d),{modelValue:e(a).disabled,"onUpdate:modelValue":u[2]||(u[2]=m=>e(a).disabled=m),label:o.$t("form.label.number"),disabled:""},null,8,["modelValue","label"])]),_:1})])]),n(),t("section",null,[t("h2",null,s(o.$t("form.label.withI18n")),1),n(),t("div",k,[l(i,{language:"html-vue"},{default:r(()=>[n(`
          <Form>
            <NumberInput 
              v-model="input"
        ...
        `)]),_:1}),n(),l(e(p),null,{default:r(()=>[l(e(d),{modelValue:e(a).textInput,"onUpdate:modelValue":u[5]||(u[5]=m=>e(a).textInput=m),label:o.$t("form.label.number"),"error-messages":e(g),options:e(c),placeholder:o.$t("form.placeholder.number")},null,8,["modelValue","label","error-messages","options","placeholder"])]),_:1})])]),n(),t("section",null,[t("h2",null,s(o.$t("form.label.customValidationInput")),1),n(),t("div",y,[l(i,{language:"html-vue"},{default:r(()=>[n(`
          ...
          <\/script>
        `)]),_:1}),n(),l(e(p),null,{default:r(()=>[l(e(d),{modelValue:e(a).customValidationInput,"onUpdate:modelValue":u[6]||(u[6]=m=>e(a).customValidationInput=m),label:o.$t("form.label.number"),placeholder:o.$t("form.placeholder.number"),schema:e(h),name:"number"},null,8,["modelValue","label","placeholder","schema"])]),_:1})])])]),_:1},8,["title"])}}});export{Z as default};
