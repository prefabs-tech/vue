import{d as r,J as u,o as d,c as g,w as e,K as l,W as t,L as i,f as n,D as s,aH as p,aq as m}from"./index-35228b09-d816765e.js";import{_ as h}from"./UiPage.vue_vue_type_style_index_0_lang-cf7055b1.js";const v={class:"section-content"},_={class:"section-content"},f={class:"trigger"},T={class:"section-content"},b={class:"trigger"},$={class:"section-content"},y={class:"trigger"},k={class:"section-content"},z={class:"trigger"},B={class:"section-content"},C={class:"trigger"},w={class:"section-content"},D={class:"trigger"},I=r({__name:"Index",setup(N){return(o,S)=>{const c=u("router-link"),a=u("SshPre");return d(),g(h,{title:o.$t("ui.tooltip.title"),class:"demo"},{toolbar:e(()=>[l(c,{to:{name:"ui"},class:"back"},{default:e(()=>[t(i(o.$t("common.back")),1)]),_:1})]),default:e(()=>[t(),n("section",null,[n("h2",null,i(o.$t("ui.tooltip.usage.basic")),1),t(),n("div",v,[l(s(p),null,{content:e(()=>[t(i(o.$t("ui.tooltip.content")),1)]),default:e(()=>[l(s(m),{label:o.$t("ui.tooltip.label.button"),severity:"success"},null,8,["label"]),t()]),_:1}),t(),l(a,{language:"html-vue"},{default:e(()=>[t(`
          <template>
            <Tooltip>
              <ButtonElement
                :label="Tooltip"
        ...
        `)]),_:1}),t()])]),t(),n("section",null,[n("h2",null,i(o.$t("ui.tooltip.usage.clickable")),1),t(),n("div",B,[l(s(p),{clickable:""},{content:e(()=>[t(i(o.$t("ui.tooltip.content")),1)]),default:e(()=>[n("div",C,i(o.$t("ui.tooltip.label.button")),1),t()]),_:1}),t(),l(a,{language:"html-vue"},{default:e(()=>[t(`
          ...
          import { Tooltip } from "@dzangolab/vue3-ui";
          <\/script>
        `)]),_:1}),t()])]),t(),n("section",null,[n("h2",null,i(o.$t("ui.tooltip.usage.delay")),1),t(),n("div",w,[l(s(p),{delay:1e3},{content:e(()=>[t(i(o.$t("ui.tooltip.content")),1)]),default:e(()=>[n("div",D,i(o.$t("ui.tooltip.label.delay")),1),t()]),_:1}),t(),l(a,{language:"html-vue"},{default:e(()=>[t(`
          <template>
            <Tooltip :delay="1000">
              <div class="trigger">
                Delay
          ...
          import { Tooltip } from "@dzangolab/vue3-ui";
          <\/script>
        `)]),_:1}),t()])])]),_:1},8,["title"])}}});export{I as default};
