import{$ as y,M as S,C as V,O as A}from"./PrefabsTechVue3Form.es-rRJjF8ru.js";import{d as F,E as I,L as N,r as d,H as h,e as T,o as B,j as i,B as o,f as n,h as t,t as u,u as a,v as m,a7 as p,a as U,F as j,y as H}from"./index-C5BbvOHh.js";import{_ as K}from"./ComponentDocumentation.vue_vue_type_script_setup_true_lang-BA4K1GCY.js";import{_ as q}from"./UiPage.vue_vue_type_style_index_0_lang-DsOPVMgL.js";import"./PrefabsTechVue3TanstackTable.es-D6oPcbZu.js";const G={class:"section-content"},J={class:"container"},Q={class:"section-content"},R={class:"container"},W={class:"label"},X={class:"value"},Y={class:"section-content"},Z={class:"container"},c={class:"section-content"},x={class:"container"},_={class:"section-content"},ll={class:"container"},ol={role:"heading"},ul=F({__name:"Index",setup(el){const{t:r}=I(),E=[{description:r("ui.modal.documentation.eventDescription.close"),name:"on:close",payload:"-"}],C=[{label:"Name",value:"Acer Nitro 5"},{label:"Category",value:"Laptop"},{label:"Color",value:"Black"}],L=[{default:"true",description:r("ui.modal.documentation.propsDescription.dismissOnClickOut"),prop:"dismissOnClickOut",type:"Boolean"},{default:"false",description:r("ui.modal.documentation.propsDescription.show"),prop:"show",type:"Boolean"},{default:"medium",description:r("ui.modal.documentation.propsDescription.size"),prop:"size",type:'"medium" | "large" | "auto"'},{default:"-",description:r("ui.modal.documentation.propsDescription.title"),prop:"title",type:"String"}],O=[{description:r("ui.modal.documentation.slotDescription.default"),name:"default"},{description:r("ui.modal.documentation.slotDescription.footer"),name:"footer"},{description:r("ui.modal.documentation.slotDescription.header"),name:"header"}],v=N({email:d(),password:d()}),b=d(!1),M=d(!1),$=d(!1),g=d(!1),k=d(!1),w=d(!1),D=d(!1);return(e,l)=>{const f=h("SshPre"),z=h("router-link");return B(),T(q,{"sub-title":e.$t("ui.modal.subtitle"),title:e.$t("ui.modal.title"),class:"demo-modal"},{toolbar:i(()=>[t(a(m),{label:e.$t("common.back"),"icon-left":"pi pi-chevron-left",size:"medium",variant:"textOnly",onClick:l[0]||(l[0]=s=>e.$router.push("/ui"))},null,8,["label"])]),default:i(()=>[l[47]||(l[47]=o()),n("section",null,[n("h2",null,u(e.$t("ui.modal.usage.basic")),1),l[21]||(l[21]=o()),n("div",G,[n("div",J,[t(a(m),{label:e.$t("ui.modal.label.show"),onClick:l[1]||(l[1]=s=>D.value=!0)},null,8,["label"])]),l[19]||(l[19]=o()),t(a(p),{show:D.value,title:e.$t("ui.modal.header.productDetail"),"onOn:close":l[2]||(l[2]=s=>D.value=!1)},{default:i(()=>[o(u(e.$t("ui.modal.content")),1)]),_:1},8,["show","title"]),l[20]||(l[20]=o()),t(f,{language:"html-vue"},{default:i(()=>l[18]||(l[18]=[o(`
          <template>
            <ButtonElement
              label="Show"
        ...
        `)])),_:1})])]),l[51]||(l[51]=o()),n("section",null,[n("h2",null,u(e.$t("ui.confirmationModal.usage.slots")),1),l[46]||(l[46]=o()),n("div",_,[n("div",ll,[t(a(m),{label:e.$t("ui.modal.label.login"),"icon-left":"pi pi-user",onClick:l[13]||(l[13]=s=>w.value=!0)},null,8,["label"])]),l[44]||(l[44]=o()),t(a(p),{show:w.value,"onOn:close":l[17]||(l[17]=s=>w.value=!1)},{header:i(()=>[n("span",ol,u(e.$t("ui.modal.label.login")),1)]),footer:i(()=>[t(z,{to:"/form/password-input"},{default:i(()=>[o(u(e.$t("ui.modal.label.forgotPassword")),1)]),_:1})]),default:i(()=>[l[41]||(l[41]=o()),t(a(y),{class:"login-form"},{default:i(()=>[t(a(S),{modelValue:v.email,"onUpdate:modelValue":l[14]||(l[14]=s=>v.email=s),label:e.$t("form.label.email"),placeholder:e.$t("form.placeholder.email")},null,8,["modelValue","label","placeholder"]),l[39]||(l[39]=o()),t(a(V),{modelValue:v.password,"onUpdate:modelValue":l[15]||(l[15]=s=>v.password=s),label:e.$t("form.label.password"),placeholder:e.$t("form.placeholder.password")},null,8,["modelValue","label","placeholder"]),l[40]||(l[40]=o()),t(a(A),{"submit-label":e.$t("ui.modal.label.login"),alignment:"filled",class:"login-actions",onCancel:l[16]||(l[16]=s=>w.value=!1)},null,8,["submit-label"])]),_:1}),l[42]||(l[42]=o())]),_:1},8,["show"]),l[45]||(l[45]=o()),t(f,{language:"html-vue"},{default:i(()=>l[43]||(l[43]=[o(`
          ...
          const showModal = ref(false);
          <\/script>
        `)])),_:1})])]),l[52]||(l[52]=o()),t(K,{"events-data":E,"props-data":L,"props-table-title":e.$t("common.properties",{value:"ModalProperties"}),"slots-data":O},null,8,["props-table-title"])]),_:1},8,["sub-title","title"])}}});export{ul as default};
