import{a as p,W as f}from"./PrefabsTechVue3TanstackTable.es-4Bbo1BmD.js";import{d as $,u as y,l as D,r as E,o as M,h as O,w as s,a as o,t as d,b as n,e as r,f as t,i as F,j as b}from"./index-CS8lVMEF.js";import{_ as S}from"./ComponentDocumentation.vue_vue_type_script_setup_true_lang-CodqleA_.js";import{_ as w}from"./FormPage.vue_vue_type_style_index_0_lang-CHIuJwhc.js";const q={class:"section-content"},z={class:"section-content"},U={class:"section-content"},P={class:"section-content"},W={class:"section-content"},h={class:"section-content"},B={class:"section-content"},T={name:"NumberInputDemo"},Z=$({...T,setup(C){const{t:i}=y(),g=[{description:i("form.documentation.eventDescription.input.modelValue"),name:"update:modelValue",payload:"number | undefined"}],I=D.number({invalid_type_error:i("form.errors.number.invalid")}).gte(1,i("form.errors.number.invalid")).lte(100,i("form.errors.number.invalid")),V=[{default:"false",description:i("form.documentation.propsDescription.input.disabled"),prop:"disabled",type:"Boolean"},{default:'{ required: "The field is required", invalid: "Please provide a valid integer field" }',description:i("form.documentation.propsDescription.input.errorMessages"),prop:"errorMessages",type:"NumberErrorMessages"},{default:"-",description:i("form.documentation.propsDescription.input.label"),prop:"label",type:"String"},{default:"undefined",description:i("form.documentation.propsDescription.input.modelValue"),prop:"modelValue",type:"number | null | undefined"},{default:'"number"',description:i("form.documentation.propsDescription.input.name"),prop:"name",type:"String"},{default:"-",description:i("form.documentation.propsDescription.input.options"),prop:"options",type:"IsIntOptions"},{default:"-",description:i("form.documentation.propsDescription.input.placeholder"),prop:"placeholder",type:"String"},{default:"-",description:i("form.documentation.propsDescription.input.schema"),prop:"schema",type:"z.ZodType<string | number>"}],N={invalid:i("form.errors.number.invalid"),required:i("form.errors.number.required")},v={allow_leading_zeroes:!1,max:100,min:1};let a=F({customValidationInput:b(),disabled:b(100),i18nInput:b(),input:b(),inputWithValidation:b(),noLabelInput:b(),textInput:b()});return(l,e)=>{const m=E("SshPre");return M(),O(w,{subtitle:t(i)("form.subtitle.number"),title:l.$t("form.label.number"),class:"demo"},{default:s(()=>[o("section",null,[o("h2",null,d(l.$t("form.label.basicInput")),1),e[9]||(e[9]=n()),o("div",q,[r(t(p),{modelValue:t(a).noLabelInput,"onUpdate:modelValue":e[0]||(e[0]=u=>t(a).noLabelInput=u),placeholder:l.$t("form.placeholder.number")},null,8,["modelValue","placeholder"]),e[8]||(e[8]=n()),r(m,{language:"html-vue"},{default:s(()=>[...e[7]||(e[7]=[n(`
          <template>
            <NumberInput 
              v-model="input"
          ...
          <\/script>
        `,-1)])]),_:1})])]),e[29]||(e[29]=n()),o("section",null,[o("h2",null,d(l.$t("form.label.labelInput")),1),e[12]||(e[12]=n()),o("div",z,[r(t(p),{modelValue:t(a).input,"onUpdate:modelValue":e[1]||(e[1]=u=>t(a).input=u),label:l.$t("form.label.number"),placeholder:l.$t("form.placeholder.number"),name:"label-input"},null,8,["modelValue","label","placeholder"]),e[11]||(e[11]=n()),r(m,{language:"html-vue"},{default:s(()=>[...e[10]||(e[10]=[n(`
          <template>
            <NumberInput 
              v-model="input"
              label="Number"
