import{e as d,r as p}from"./DzangolabVue3Form.es-4fb0bebc.js";import{d as g,a7 as w,p as V,j as c,K as f,o as I,c as S,w as a,L as n,C as e,M as r,f as t,E as l}from"./index-137faed7-55cf5996.js";import{m as _}from"./index-782bd33e.js";import{_ as $}from"./FormPage.vue_vue_type_style_index_0_lang-443f6bba.js";const F={class:"section-content"},z={class:"section-content"},k={class:"section-content"},U={class:"section-content"},C={class:"section-content"},L={name:"SwitchInput"},j=g({...L,setup(W){const{t:b}=w(),h=_.coerce.boolean().refine(o=>o===!0,{message:b("form.errors.switch.invalid")});let s=V({disabled:c(!0),input:c(),inputWithValidation:c(!1),noLabelInput:c()});return(o,i)=>{const v=f("router-link"),m=f("SshPre");return I(),S($,{title:o.$t("form.label.switch"),class:"demo"},{toolbar:a(()=>[n(v,{to:{name:"form"},class:"back"},{default:a(()=>[e(r(o.$t("common.back")),1)]),_:1})]),default:a(()=>[e(),t("section",null,[t("h2",null,r(o.$t("form.label.basicInput")),1),e(),t("div",F,[n(m,{language:"html-vue"},{default:a(()=>[e(`
          <Form>
            <SwitchInput
              v-model="input"
            />
