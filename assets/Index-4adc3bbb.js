import{r as b,e as y}from"./DzangolabVue3Form.es-0701fb76.js";import{d as S,l as V,j as c,G as h,o as B,c as C,w as n,K as l,C as e,S as i,f as o,D as p,aw as d,W as _}from"./index-c6712957-bca2c2d1.js";import{_ as D}from"./UiPage.vue_vue_type_style_index_0_lang-e2e81d25.js";import"./index-df8ece6b.js";const k={class:"section-content"},w={class:"section-content"},I={class:"section-content"},F=S({__name:"Index",setup(N){const f=_(),a=V({name:null,phone:null,price:"$50"}),v=c({iconRight:"pi pi-chevron-right",label:"Next",severity:"primary",variant:"filled"}),P=c({iconLeft:"pi pi-chevron-left",label:"Back",severity:"secondary",variant:"filled"}),u=c([{content:"Please enter personal details",label:"Personal",step:1},{content:"Please enter contact details",label:"Contact",step:2},{content:"Please enter payment details",label:"Payment",step:3},{content:"Do you wish to continue?",label:"Confirmation",step:4}]),g=()=>{f.push("/ui")};return(t,s)=>{const $=h("router-link"),m=h("SshPre");return B(),C(D,{title:t.$t("ui.stepper.title"),class:"demo"},{toolbar:n(()=>[l($,{to:{name:"ui"},class:"back"},{default:n(()=>[e(i(t.$t("common.back")),1)]),_:1})]),default:n(()=>[e(),o("section",null,[o("h2",null,i(t.$t("ui.stepper.usage.basic")),1),e(),o("div",k,[l(m,{language:"html-vue"},{default:n(()=>[e(`
          ...
          <\/script>
        `)]),_:1}),e(),l(p(d),{steps:u.value,onComplete:g},null,8,["steps"])])]),e(),o("section",null,[o("h2",null,i(t.$t("ui.stepper.usage.buttonProperties")),1),e(),o("div",w,[l(m,{language:"html-vue"},{default:n(()=>[e(`
          <template>
            <Stepper
          ...
          <\/script>
        `)]),_:1}),e(),l(p(d),{"next-button-properties":v.value,"previous-button-properties":P.value,steps:u.value},null,8,["next-button-properties","previous-button-properties","steps"])])]),e(),o("section",null,[o("h2",null,i(t.$t("ui.stepper.usage.withSlot")),1),e(),o("div",I,[l(m,{language:"html-vue"},{default:n(()=>[e(`
          <template>
            <Stepper :steps="steps">
