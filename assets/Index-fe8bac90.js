import{m as V,G as i,Q as d}from"./DzangolabVue3Form.es-347f0944.js";import{d as N,u as _,b as $,e as b,r as v,o as F,c as y,w as a,a as l,t as p,f as n,g as o,h as e}from"./index-96711986.js";const z={class:"section-content"},E={class:"section-content"},S={class:"section-content"},w={class:"section-content"},O={class:"section-content"},U={class:"section-content"},M={class:"section-content"},P={class:"section-content"},q={name:"NumberInputField"},L=N({...q,setup(W){const{t:f}=_(),g=V.coerce.number({invalid_type_error:f("form.errors.number.invalid")}).gte(1,f("form.errors.number.invalid")).lte(100,f("form.errors.number.invalid")),h={invalid:f("form.errors.number.invalid"),required:f("form.errors.number.required")},c={min:1,max:100,allow_leading_zeroes:!1};let r=$({customStyleInput:b(),customValidationInput:b(),disabled:b(100),input:b(),inputWithValidation:b(),noLabelInput:b(),textInput:b()});return(t,u)=>{const s=v("SshPre"),I=v("Page");return F(),y(I,{title:t.$t("form.label.number"),class:"demo"},{default:a(()=>[l("section",null,[l("h2",null,p(t.$t("form.label.basicInput")),1),n(),l("div",z,[o(s,{language:"html-vue"},{default:a(()=>[n(`
          <Form>
            <NumberInput 
              v-model="input"
