import{U as v,G as g}from"./DzangolabVue3Form.es-DhvwW6mt.js";import{d as D,J as U,L as k,M as $,r as i,I as z,e as F,o as p,i as u,E as n,f as o,t as m,g as r,a as b,b as y,u as l,x as E}from"./index-CS6scmA6.js";import{_ as S}from"./FormPage.vue_vue_type_style_index_0_lang-BT0-Gq40.js";const C={class:"section-content"},B={key:0,class:"result-date"},N={class:"section-content"},P={key:0,class:"result-date"},w={class:"section-content"},A={key:0,class:"result-date"},q={class:"section-content"},G={key:0,class:"result-date"},T={name:"DaysInput"},j=D({...T,setup(J){const{t:I}=U(),V=k.coerce.number({invalid_type_error:I("form.errors.number.required")}).min(1,{message:I("form.errors.daysInput.invalid")}).max(365,{message:I("form.errors.daysInput.invalid")}),s=$({basic:i(),disabled:i(),label:i(),validationInput:i()});let d=$({basic:i(),disabled:i(30),label:i(),validationInput:i()});return(a,e)=>{const f=z("SshPre");return p(),F(S,{title:a.$t("form.label.daysInput"),class:"demo"},{toolbar:u(()=>[r(l(E),{label:a.$t("common.back"),"icon-left":"pi pi-chevron-left",size:"medium",variant:"textOnly",onClick:e[0]||(e[0]=t=>a.$router.push("/form"))},null,8,["label"])]),default:u(()=>[e[25]||(e[25]=n()),o("section",null,[o("h2",null,m(a.$t("form.label.basicInput")),1),e[12]||(e[12]=n()),o("div",C,[r(l(v),{modelValue:l(d).basic,"onUpdate:modelValue":e[1]||(e[1]=t=>l(d).basic=t),placeholder:a.$t("form.placeholder.days"),"onUpdate:date":e[2]||(e[2]=t=>s.basic=t)},null,8,["modelValue","placeholder"]),e[10]||(e[10]=n()),s.basic?(p(),b("div",B,m(s.basic),1)):y("",!0),e[11]||(e[11]=n()),r(f,{language:"html-vue"},{default:u(()=>e[9]||(e[9]=[n(`
          <template>
            <DaysInput
              v-model="input"
