import{m as P,t as m,Z as u}from"./DzangolabVue3Form.es-fbe46c9a.js";import{d as V,a3 as $,l as _,j as c,E as b,o as I,c as F,w as a,J as l,C as e,Z as i,f as n,N as o,e as z}from"./index-66214709-97e5bbe8.js";import{_ as S}from"./FormPage.vue_vue_type_style_index_0_lang-3d8d022e.js";import"./index-4c95a663.js";const y={class:"section-content"},U={class:"section-content"},E={class:"section-content"},L={class:"section-content"},O={class:"section-content"},k={class:"section-content"},q={class:"section-content"},M={class:"section-content"},W={name:"PasswordInputField"},A=V({...W,setup(C){const{t:f}=$(),h=P.string({invalid_type_error:f("form.errors.password.invalid"),required_error:f("form.errors.input.required")}).min(8,{message:f("form.errors.password.min",{length:8})}).regex(/^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)(?=.*[\W_]).+$/,f("form.errors.password.invalid")),g={required:f("form.errors.input.required"),weak:f("form.errors.password.invalid")},w={minLength:10,minLowercase:1,minUppercase:1,minSymbols:1};let t=_({customValidationInput:c(),disabled:c("P@ssw0rd"),input:c(),inputWithValidation:c(),noLabelInput:c(),passwordInput:c()});return(s,d)=>{const v=b("router-link"),p=b("SshPre");return I(),F(S,{title:s.$t("form.label.password"),class:"demo"},{toolbar:a(()=>[l(v,{to:{name:"form"},class:"back"},{default:a(()=>[e(i(s.$t("common.back")),1)]),_:1})]),default:a(()=>[e(),n("section",null,[n("h2",null,i(s.$t("form.label.basicInput")),1),e(),n("div",y,[l(p,{language:"html-vue"},{default:a(()=>[e(`
          <From>
            <Password 
              v-model="input"
