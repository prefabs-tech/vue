import{d as f,r as p,s as y,j as B,o as E,w as o,C as e,e as t,t as u,g as n,u as a,D as i,P as _,Q as $,_ as z}from"./index-CVjUtB44.js";import{_ as k}from"./UiPage.vue_vue_type_style_index_0_lang-Sn8JrzpY.js";const m=r=>(_("data-v-6abf8185"),r=r(),$(),r),O={class:"section-content"},C={class:"container"},S={class:"section-content"},I={class:"container"},w={class:"section-content"},D={class:"container"},L={class:"section-content"},T={class:"container"},N={class:"section-content"},P={class:"container"},R={class:"section-content"},M={class:"container"},V={class:"section-content"},A={class:"container"},H={class:"section-content"},W={className:"container"},j={class:"section-content"},Q={className:"container"},q=m(()=>t("i",{class:"pi pi-user"},null,-1)),F=m(()=>t("i",{class:"pi pi-user"},null,-1)),G=m(()=>t("i",{class:"pi pi-user"},null,-1)),J={class:"section-content"},K={class:"container"},U={class:"section-content"},X={class:"container"},Y={class:"container"},Z={class:"section-content"},x={class:"container"},ee=f({__name:"Index",setup(r){const b=p(void 0),d=p(!1),v=()=>{b.value=new Date},g=()=>{d.value=!0,setTimeout(()=>{d.value=!1},5e3)};return(l,c)=>{const s=y("SshPre");return E(),B(k,{title:l.$t("ui.button.title"),class:"demo-button"},{toolbar:o(()=>[n(a(i),{label:l.$t("common.back"),"icon-left":"pi pi-chevron-left",size:"medium",variant:"textOnly",onClick:c[0]||(c[0]=h=>l.$router.push("/ui"))},null,8,["label"])]),default:o(()=>[e(),t("section",null,[t("h2",null,u(l.$t("ui.button.usage.basic")),1),e(),t("div",O,[t("div",C,[n(a(i),{label:l.$t("ui.button.label.clickMe"),onClick:c[1]||(c[1]=h=>v())},null,8,["label"]),e(),t("span",null,u(b.value),1)]),e(),n(s,{language:"html-vue"},{default:o(()=>[e(`
          <template> 
      ...
      `)]),_:1}),e()]),e(),t("section",null,[t("h2",null,u(l.$t("ui.button.usage.loading")),1),e(),t("div",w,[t("div",D,[n(a(i),{label:l.$t("ui.button.label.submit"),loading:d.value,onClick:g},null,8,["label","loading"])]),e(),n(s,{language:"html-vue"},{default:o(()=>[e(`
        ...
        `)]),_:1}),e()])]),e(),t("section",null,[t("h2",null,u(l.$t("ui.button.usage.icons.icon")),1),e(),t("div",H,[t("div",W,[n(a(i),{variant:"textOnly",severity:"secondary","icon-left":"pi pi-user"}),e(),n(a(i),{variant:"outlined",severity:"secondary","icon-left":"pi pi-user"}),e(),n(a(i),{variant:"filled","icon-left":"pi pi-user"})]),e(),n(s,{language:"html-vue"},{default:o(()=>[e(`
          ...
          <script setup lang="ts"> 
            import { ButtonElement } from "@dzangolab/vue3-ui"; 
          <\/script>
        `)]),_:1}),e()])]),e(),t("section",null,[t("h2",null,u(l.$t("ui.button.usage.icons.iconElement")),1),e(),t("div",j,[t("div",Q,[n(a(i),{rounded:"",variant:"textOnly",severity:"secondary"},{iconLeft:o(()=>[q]),_:1}),e(),n(a(i),{rounded:"",severity:"secondary",variant:"outlined"},{iconRight:o(()=>[F]),_:1}),e(),n(a(i),{rounded:"",variant:"filled"},{iconRight:o(()=>[G]),_:1})]),e(),n(s,{language:"html-vue"},{default:o(()=>[e(`
          <template> 
          ...
          <script setup lang="ts"> 
            import { ButtonElement } from "@dzangolab/vue3-ui"; 
          <\/script>
        `)]),_:1}),e()])]),e(),t("section",null,[t("h2",null,u(l.$t("ui.button.usage.icons.iconPackage")),1),e(),t("div",J,[t("div",K,[n(a(i),{label:l.$t("ui.button.label.home"),"icon-left":"pi pi-home",variant:"outlined"},null,8,["label"]),e(),n(a(i),{label:l.$t("ui.button.label.home"),"icon-left":"fa-solid fa-house",variant:"outlined"},null,8,["label"])]),e(),n(s,{language:"html-vue"},{default:o(()=>[e(`
          <template> 
            <ButtonElement
              label="Home"
