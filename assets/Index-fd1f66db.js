import{d as E,e as d,r as y,o as k,c as L,w as r,a as o,t as i,f as e,g as l,h as s,a5 as u,Y as f,Z as v,a7 as c}from"./index-bdeedbb5.js";const z={class:"section-content"},D={class:"container"},O={class:"section-content"},I={class:"container"},P={class:"section-content"},S={class:"container"},T={class:"section-content"},N={class:"container"},U={class:"section-content"},V={class:"container"},H={class:"section-content"},A={class:"container"},j=E({__name:"Index",setup(Y){const p=d(void 0),b=d(!1),M=d(!1),w=d(!1),h=d(!1),C=d(!1),g=d(!1),$=()=>{p.value=new Date,g.value=!1};return(t,n)=>{const m=y("SshPre"),B=y("Page");return k(),L(B,{title:t.$t("ui.confirmationModal.title"),class:"demo"},{default:r(()=>[o("section",null,[o("h2",null,i(t.$t("ui.confirmationModal.usage.basic")),1),e(),o("div",z,[l(m,{language:"html-vue"},{default:r(()=>[e(`
          <template>
            <div>
              <ButtonElement
                label="Confirm"
