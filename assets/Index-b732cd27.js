import{d as V,u as x,b as _,e as p,o as $,c as T,w as u,a as s,t as m,f as e,g as l,h as t,r as b}from"./index-cd13e62b.js";import{m as y,g as d,a as f}from"./DzangolabVue3Form.es-eff9732e.js";const w={class:"demo-section"},z={class:"demo-section"},F={class:"demo-section"},S={class:"demo-section"},E={class:"demo-section"},U={class:"demo-section"},C={class:"demo-section"},q={class:"demo-section"},O={name:"TextareaInputField"},R=V({...O,setup(D){const{t:c}=x(),g=y.string().min(15,{message:c("form.errors.input.min",{length:15})}),I={required:c("form.errors.input.required")},h={ignore_whitespace:!0,required:!0};let a=_({customRowsColsInput:p(),customStyleInput:p(),customValidationInput:p(),disabled:p("Disabled textarea input"),input:p(),inputWithValidation:p(),noLabelInput:p(),textInput:p()});return(n,o)=>{const i=b("SshPre"),v=b("Page");return $(),T(v,{title:n.$t("form.label.textarea")},{default:u(()=>[s("section",w,[s("h3",null,m(n.$t("form.label.basicInput")),1),e(),l(i,{language:"html-vue"},{default:u(()=>[e(`
        <template>
          <TextareaInput 
            v-model="input"
        ...
        <\/script>
      `)]),_:1}),e(),l(t(d),{modelValue:t(a).noLabelInput,"onUpdate:modelValue":o[0]||(o[0]=r=>t(a).noLabelInput=r),placeholder:n.$t("form.placeholder.input"),class:"form-field"},null,8,["modelValue","placeholder"])]),e(),s("section",z,[s("h3",null,m(n.$t("form.label.labelInput")),1),e(),l(i,{language:"html-vue"},{default:u(()=>[e(`
        <template>
          <TextareaInput 
            v-model="input"
            label="Input"
        ...
        import { TextareaInput } from "@dzangolab/vue3-form";
        <\/script>
      `)]),_:1}),e(),l(t(d),{modelValue:t(a).input,"onUpdate:modelValue":o[1]||(o[1]=r=>t(a).input=r),label:n.$t("form.label.textarea"),placeholder:n.$t("form.placeholder.textarea"),class:"form-field"},null,8,["modelValue","label","placeholder"])]),e(),s("section",F,[s("h3",null,m(n.$t("form.label.disabled")),1),e(),l(i,{language:"html-vue"},{default:u(()=>[e(`
        <template>
          <TextareaInput 
            v-model="input"
            label="Disabled"
        ...
        <\/script>
      `)]),_:1}),e(),l(t(d),{modelValue:t(a).disabled,"onUpdate:modelValue":o[2]||(o[2]=r=>t(a).disabled=r),label:n.$t("form.label.disabled"),class:"form-field",disabled:""},null,8,["modelValue","label"])]),e(),s("section",S,[s("h3",null,m(n.$t("form.label.inputWithValidation")),1),e(),l(i,{language:"html-vue"},{default:u(()=>[e(`
        <template>
          <Form>
            <TextareaInput 
              v-model="input"
      ...
      `)]),_:1}),e(),l(t(d),{modelValue:t(a).customStyleInput,"onUpdate:modelValue":o[7]||(o[7]=r=>t(a).customStyleInput=r),label:n.$t("form.label.textarea"),placeholder:n.$t("form.placeholder.input"),class:"form-field custom-style-input"},null,8,["modelValue","label","placeholder"])])]),_:1},8,["title"])}}});export{R as default};
