import{Y as T}from"./DzangolabVue3Form.es-C3zGftW_.js";import{d as S,L as K,k as u,C as P,r as $,v as f,K as q,f as w,o as R,i as s,D as n,g as r,t as c,h as i,u as o}from"./index-DXneQVVY.js";import{j as d}from"./DzangolabVue3TanstackTable.es-CMgAuuTF.js";import{c as k,d as b,f as z}from"./data-BbDBEIKR.js";import{_ as I}from"./TablePage.vue_vue_type_style_index_0_lang-Nybkipc5.js";const E={class:"section-content"},O={class:"section-content"},x={class:"section-content"},U={class:"section-content"},A={name:"TableFilters"},Q=S({...A,setup(N){const{t:l}=K(),p=[{accessorKey:"email",enableColumnFilter:!0,enableSorting:!0,filterPlaceholder:"Search by email...",header:"Email"},{accessorKey:"name",enableColumnFilter:!0,enableSorting:!0,filterPlaceholder:l("table.placeholder.search"),header:"Full name"},{accessorKey:"age",align:"right",enableColumnFilter:!0,enableSorting:!0,filterPlaceholder:`${l("table.placeholder.min")},${l("table.placeholder.max")}`,header:"Age",meta:{filterVariant:"range"}},{accessorKey:"city",enableColumnFilter:!0,enableSorting:!0,filterPlaceholder:l("table.placeholder.city"),header:"City",meta:{filterVariant:"multiselect",filterOptions:k}}],F=[...p.map(t=>t.accessorKey==="email"?{...t,customFilterComponent:e=>u(P,{debounceTime:200,modelValue:e.getFilterValue(),placeholder:l("table.label.customFilter"),"onUpdate:modelValue":a=>{e.setFilterValue(a)}}),meta:{serverFilterFn:"contains"}}:t.accessorKey==="age"?{...t,meta:{filterVariant:"range",serverFilterFn:"between"}}:t)],y=[{accessorKey:"description",enableColumnFilter:!0,enableSorting:!0,filterFn:"customEqualStringFilter",filterPlaceholder:l("table.label.matchDescription"),header:"Description"},{accessorKey:"quantity",dataType:"number",enableColumnFilter:!0,enableSorting:!0,filterPlaceholder:`${l("table.placeholder.min")},${l("table.placeholder.max")}`,header:()=>"Quantity",meta:{filterVariant:"range"},numberOptions:{locale:"en-IN"}},{accessorKey:"amount",dataType:"currency",enableColumnFilter:!0,enableSorting:!0,filterPlaceholder:`${l("table.placeholder.min")},${l("table.placeholder.max")}`,header:"Amount",meta:{filterVariant:"range"},numberOptions:{formatOptions:{currency:"EUR"},locale:"en-US"}},{accessorKey:"date",customFilterComponent:t=>u("div",{class:"filter-date"},[u(T,{modelValue:g.value,multiCalendars:!0,name:"date-range",placeholder:l("table.label.dateRange"),range:!0,"onUpdate:modelValue":e=>{g.value=e,t.setFilterValue(e)}})]),dataType:"date",enableColumnFilter:!0,enableSorting:!0,filterFn:"inDateRangeFilter",filterPlaceholder:l("table.placeholder.dateRange"),header:"Date"},{accessorKey:"action",cell:()=>u(f,{iconLeft:"pi pi-eye",rounded:!0,variant:"textOnly"}),dataType:"other",header:()=>u("i",{class:"pi pi-cog"})}],h=[...p.map(t=>t.accessorKey==="email"?{...t,meta:{serverFilterFn:"equals"}}:t.accessorKey==="age"?{...t,meta:{filterVariant:"range",serverFilterFn:"between"}}:t)],g=$([]),v=(t,e,a)=>!!a.includes(t.getValue(e)),D=(t,e,a)=>{if(!a||!a[0]||!a[1])return!0;const m=t.getValue(e)?new Date(t.getValue(e)):null,C=new Date(a[1]),V=new Date(a[0]);return!!(m&&V.getTime()<=m.getTime()&&m.getTime()<C.getTime())};return(t,e)=>{const a=q("SshPre");return R(),w(I,{title:t.$t("table.title"),class:"demo data-table"},{toolbar:s(()=>[i(o(f),{label:t.$t("common.back"),"icon-left":"pi pi-chevron-left",size:"medium",variant:"textOnly",onClick:e[0]||(e[0]=m=>t.$router.push("/table"))},null,8,["label"])]),default:s(()=>[e[13]||(e[13]=n()),r("section",null,[r("h2",null,c(t.$t("table.usage.filterableColumn")),1),e[3]||(e[3]=n()),r("div",E,[i(o(d),{"columns-data":p,data:o(b)},null,8,["data"]),e[2]||(e[2]=n()),i(a,{language:"html-vue"},{default:s(()=>e[1]||(e[1]=[n(`
        ...
        `)])),_:1})])]),e[14]||(e[14]=n()),r("section",null,[r("h2",null,c(t.$t("table.usage.customStaticFilter")),1),e[6]||(e[6]=n()),r("div",O,[i(o(d),{"columns-data":y,data:o(z),"initial-sorting":[{id:"quantity",desc:!0}],paginated:!1,"table-options":{filterFns:{customEqualStringFilter:v,inDateRangeFilter:D}},class:"custom-static-filter-table"},null,8,["data","table-options"]),e[5]||(e[5]=n()),i(a,{language:"html-vue"},{default:s(()=>e[4]||(e[4]=[n(`
          ...
          <\/script>
        `)])),_:1})])]),e[15]||(e[15]=n()),r("section",null,[r("h2",null,c(t.$t("table.usage.customFilter")),1),e[9]||(e[9]=n()),r("div",x,[i(o(d),{"columns-data":F,data:o(b).slice(10,15),"initial-sorting":[{id:"email",desc:!1}],"is-server-table":""},null,8,["data"]),e[8]||(e[8]=n()),i(a,{language:"html-vue"},{default:s(()=>e[7]||(e[7]=[n(`
          <template>
            <Table
