import{d as S,z as E,r as m,s as z,j as D,o as k,w as i,C as n,e as o,t as v,g as t,u as a,D as u,T as p,M as P}from"./index-CVjUtB44.js";import{_ as B}from"./UserPage.vue_vue_type_style_index_0_lang-DliMCuiO.js";const R={class:"section-content"},A={class:"section-content"},U={class:"section-content"},C={class:"section-content"},N={class:"section-content"},O={class:"section-content"},T={class:"section-content"},j=S({__name:"InvitationModal",setup(F){const{t:y}=E(),f=m(!1),b=m(!1),w=m(!1),h=m(!1),M=m(!1),c=m(!1),g=m(!1),I=[{id:1,name:"ADMIN"},{id:2,name:"SUPERADMIN"},{id:3,name:"USER"}],$=[{id:1,name:"Admin",origin:"admin-origin",supportedRoles:[{id:1,name:"ADMIN"},{id:2,name:"SUPERADMIN"}]},{id:2,name:"User",origin:"user-origin",supportedRoles:[{id:3,name:"USER"}]}],r=l=>{P({text:y("user.message.invitation.success",{user:l.email}),type:"success"}),f.value=!1,b.value=!1,w.value=!1,h.value=!1,M.value=!1,c.value=!1,g.value=!1};return(l,e)=>{const d=z("SshPre");return k(),D(B,{title:l.$t("user.label.invitationModal"),class:"demo-invitation-modal"},{toolbar:i(()=>[t(a(u),{label:l.$t("common.back"),"icon-left":"pi pi-chevron-left",size:"medium",variant:"textOnly",onClick:e[0]||(e[0]=s=>l.$router.push("/user"))},null,8,["label"])]),default:i(()=>[n(),o("section",null,[o("h2",null,v(l.$t("user.label.basic")),1),n(),o("div",R,[t(a(u),{label:l.$t("user.label.invite"),onClick:e[1]||(e[1]=s=>M.value=!0)},null,8,["label"]),n(),t(a(p),{show:M.value,"onOn:close":e[2]||(e[2]=s=>M.value=!1),onSubmit:r},null,8,["show"]),n(),t(d,{language:"html-vue"},{default:i(()=>[n(`
          <template>
            <ButtonElement
              label="Invite"
