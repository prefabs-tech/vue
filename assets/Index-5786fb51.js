import{d as b,a7 as g,K as d,o as f,c as I,w as a,L as e,C as n,M as i,f as t,E as l}from"./index-137faed7-55cf5996.js";import{R as m,A as y}from"./index-6cf04a93.js";import{_}from"./UserPage.vue_vue_type_style_index_0_lang-3ccca3f2.js";const h={class:"section-content"},S={class:"section-content"},D={class:"section-content"},P={class:"section-content"},R={class:"section-content"},U=b({__name:"Index",setup(F){const{t:p}=g(),u=[{id:1,name:"ADMIN"},{id:2,name:"SUPERADMIN"},{id:3,name:"USER"}],c=[{id:1,name:"Admin",origin:"admin-origin",supportedRoles:[{id:1,name:"ADMIN"},{id:2,name:"SUPERADMIN"}]},{id:2,name:"User",origin:"user-origin",supportedRoles:[{id:3,name:"USER"}]}],s=o=>{y({text:p("user.message.invitation.success",{user:o.email}),type:"success"})};return(o,A)=>{const v=d("router-link"),r=d("SshPre");return f(),I(_,{title:o.$t("user.label.invitationForm"),class:"demo-invitation-form"},{toolbar:a(()=>[e(v,{to:{name:"user"},class:"back"},{default:a(()=>[n(i(o.$t("common.back")),1)]),_:1})]),default:a(()=>[n(),t("section",null,[t("h2",null,i(o.$t("user.label.basic")),1),n(),t("div",h,[e(r,{language:"html-vue"},{default:a(()=>[n(`
          <template>
        ...
        `)]),_:1}),n(),e(l(m),{roles:u,onSubmit:s})])]),n(),t("section",null,[t("h2",null,i(o.$t("user.label.withExpiryDate")),1),n(),t("div",P,[e(r,{language:"html-vue"},{default:a(()=>[n(`
          ...
          <\/script>
        `)]),_:1}),n(),e(l(m),{roles:u,"expiry-mode":"calendar",onSubmit:s})])]),n(),t("section",null,[t("h2",null,i(o.$t("user.label.withExpiryDays")),1),n(),t("div",R,[e(r,{language:"html-vue"},{default:a(()=>[n(`
          <template>
            <InvitationForm
              :roles="roles"
              expiry-mode="days"
