import{m as p}from"./PrefabsTechVue3TanstackTable.es-DsgrF1fh.js";import{d as u,H as m,e as w,o as c,j as n,B as o,f as a,t as r,h as i,u as l,v as f}from"./index-B2kpz5D5.js";import{_ as A}from"./TablePage.vue_vue_type_style_index_0_lang-DefllfX3.js";import"./PrefabsTechVue3Form.es-Cp66sc_V.js";const g={class:"section-content"},v={class:"section-content"},D={name:"FilesPresentation"},h=u({...D,setup(N){const d=[{description:"File description",downloadCount:5,id:1,lastDownloadedAt:Date.now(),originalFileName:"file1.png",size:100,uploadedAt:Date.now(),uploadedBy:{givenName:"Manish",lastName:"Aryal"}},{description:"File description",downloadCount:5,id:2,lastDownloadedAt:Date.now(),originalFileName:"document.pdf",uploadedAt:Date.now(),uploadedBy:{givenName:"Gaurav",lastName:"Sapkota"}},{description:"File description",downloadCount:5,id:3,lastDownloadedAt:Date.now(),originalFileName:"photo.jpeg",uploadedAt:Date.now(),uploadedBy:{givenName:"Deepak",lastName:"Aryal"}},{description:"File description",downloadCount:5,id:4,lastDownloadedAt:Date.now(),originalFileName:"manish.png",uploadedAt:Date.now(),uploadedBy:{givenName:"Lamdiki",lastName:"Sherpa"}}];return(t,e)=>{const s=m("SshPre");return c(),w(A,{title:t.$t("table.label.filesPresentation"),class:"demo"},{toolbar:n(()=>[i(l(f),{label:t.$t("common.back"),"icon-left":"pi pi-chevron-left",size:"medium",variant:"textOnly",onClick:e[0]||(e[0]=F=>t.$router.push("/table"))},null,8,["label"])]),default:n(()=>[e[7]||(e[7]=o()),a("section",null,[a("h2",null,r(t.$t("table.usage.tableMode")),1),e[3]||(e[3]=o()),a("div",g,[i(l(p),{files:d,"visible-file-details":["originalFileName","description","size","uploadedBy","uploadedAt","downloadCount","lastDownloadedAt","actions"],presentation:"table","onAction:archive":()=>{},"onAction:delete":()=>{},"onAction:download":()=>{},"onAction:edit":()=>{},"onAction:share":()=>{},"onAction:view":()=>{}}),e[2]||(e[2]=o()),i(s,{language:"html-vue"},{default:n(()=>e[1]||(e[1]=[o(`
          <template>
            <FilesPresentation
              :files="files"
