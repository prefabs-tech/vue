import{I as b,T as B}from"./PrefabsTechVue3Form.es-tpySeI4B.js";import{d as D,I as S,T as V,M as C,J as I,e as N,o as T,j as s,C as t,f as p,h as o,t as m,u as l,V as c,v as k}from"./index-BNFnUDdE.js";import{_ as w}from"./ComponentDocumentation.vue_vue_type_script_setup_true_lang-KeGqZsO_.js";import{_ as R}from"./UiPage.vue_vue_type_style_index_0_lang-SQPidsC3.js";import"./PrefabsTechVue3TanstackTable.es-CCmcQvvp.js";const x={class:"section-content"},A={class:"section-content"},F={class:"section-content"},O=D({__name:"Index",setup(L){const{t:a}=S(),f=V(),r=C({name:null,phone:null,price:"$50"}),v=[{description:a("ui.stepper.documentation.eventDescription.complete"),name:"complete",payload:"-"}],P={iconRight:"pi pi-chevron-right",label:"Next",severity:"primary",variant:"filled"},g={iconLeft:"pi pi-chevron-left",label:"Back",severity:"secondary",variant:"filled"},h=[{default:"-",description:a("ui.stepper.documentation.propsDescription.nextButton"),prop:"nextButtonProperties",type:"ActionButtonProperties"},{default:"-",description:a("ui.stepper.documentation.propsDescription.PreviousButton"),prop:"previousButtonProperties",type:"ActionButtonProperties"},{default:"-",description:a("ui.stepper.documentation.propsDescription.steps"),prop:"steps",type:"Array<StepProperties>"}],y=[{description:a("ui.stepper.documentation.slotDescription.step"),name:"{step}"}],d=[{content:"Please enter personal details",label:"Personal",step:1},{content:"Please enter contact details",label:"Contact",step:2},{content:"Please enter payment details",label:"Payment",step:3},{content:"Do you wish to continue?",label:"Confirmation",step:4}],$=()=>{f.push("/ui")};return(n,e)=>{const u=I("SshPre");return T(),N(R,{"sub-title":n.$t("ui.stepper.subtitle"),title:n.$t("ui.stepper.title"),class:"demo-stepper"},{toolbar:s(()=>[o(l(k),{label:n.$t("common.back"),"icon-left":"pi pi-chevron-left",size:"medium",variant:"textOnly",onClick:e[0]||(e[0]=i=>n.$router.push("/ui"))},null,8,["label"])]),default:s(()=>[e[17]||(e[17]=t()),p("section",null,[p("h2",null,m(n.$t("ui.stepper.usage.basic")),1),e[6]||(e[6]=t()),p("div",x,[o(l(c),{steps:d,onComplete:$}),e[5]||(e[5]=t()),o(u,{language:"html-vue"},{default:s(()=>e[4]||(e[4]=[t(`
          <template>
