import{M as d,O as b}from"./DzangolabVue3Form.es-DymaP3TR.js";import{d as V,J as z,L as $,M as I,r as p,I as F,e as O,o as w,i as s,D as n,f as o,t as u,g as t,u as e,v as y}from"./index-DGEdpNlT.js";import{_ as M}from"./FormPage.vue_vue_type_style_index_0_lang-DTIZPzrS.js";const U={class:"section-content"},W={class:"section-content"},q={class:"section-content"},S={class:"section-content"},k={class:"section-content"},C={class:"section-content"},L={class:"section-content"},P={class:"section-content"},B={name:"EmailInputField"},J=V({...B,setup(D){const{t:f}=z(),v=$.string().email({message:f("form.errors.email.invalid")}),E={required:f("form.errors.input.required"),invalid:f("form.errors.email.invalid",{list:"(dzangolab.com, dzango.com, gmail.com)"})},g={allow_display_name:!1,allow_utf8_local_part:!0,host_whitelist:["dzangolab.com","dzango.com","gmail.com"],require_display_name:!1};let i=I({customValidationInput:p(),disabled:p("monorepo@dzangolab.com"),input:p(),inputWithValidation:p(),noLabelInput:p(),textInput:p()});return(a,l)=>{const r=F("SshPre");return w(),O(M,{title:a.$t("form.label.email"),class:"demo"},{toolbar:s(()=>[t(e(y),{label:a.$t("common.back"),"icon-left":"pi pi-chevron-left",size:"medium",variant:"textOnly",onClick:l[0]||(l[0]=m=>a.$router.push("/form"))},null,8,["label"])]),default:s(()=>[l[33]||(l[33]=n()),o("section",null,[o("h2",null,u(a.$t("form.label.basicInput")),1),l[11]||(l[11]=n()),o("div",U,[t(e(d),{modelValue:e(i).noLabelInput,"onUpdate:modelValue":l[1]||(l[1]=m=>e(i).noLabelInput=m),placeholder:a.$t("form.placeholder.email")},null,8,["modelValue","placeholder"]),l[10]||(l[10]=n()),t(r,{language:"html-vue"},{default:s(()=>l[9]||(l[9]=[n(`
          <template>
            <Email 
              v-model="input"
