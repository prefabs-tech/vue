import{d as u,M as m,o as c,e as f,f as i,h as a,a as n,u as g,U as w,z as t}from"./index-CNYYxeCo.js";import{_ as b}from"./ComponentDocumentation.vue_vue_type_script_setup_true_lang-B3tqDFC6.js";import{_ as y}from"./UiPage.vue_vue_type_style_index_0_lang-Dlo4JoJZ.js";import"./PrefabsTechVue3TanstackTable.es-Bja1zcm5.js";import"./PrefabsTechVue3Form.es-CNTcCXbR.js";const v={class:"section-content"},h={name:"FilesListDemo"},j=u({...h,setup(D){const d=[{description:"Emitted when archive action is triggered",name:"action:archive",payload:"IFile object"},{description:"Emitted when delete action is triggered",name:"action:delete",payload:"IFile object"},{description:"Emitted when download action is triggered",name:"action:download",payload:"IFile object"},{description:"Emitted when edit description is triggered",name:"action:edit",payload:"IFile object"},{description:"Emitted when share action is triggered",name:"action:share",payload:"IFile object"},{description:"Emitted when view action is triggered",name:"action:view",payload:"IFile object"}],s=[{downloadCount:5,id:1,lastDownloadedAt:Date.now(),originalFileName:"file1.png",uploadedAt:Date.now(),uploadedBy:{givenName:"Manish",lastName:"Aryal"}},{downloadCount:5,id:2,lastDownloadedAt:Date.now(),originalFileName:"document.pdf",uploadedAt:Date.now(),uploadedBy:{givenName:"Gaurav",lastName:"Sapkota"}},{downloadCount:5,id:3,lastDownloadedAt:Date.now(),originalFileName:"photo.jpeg",uploadedAt:Date.now(),uploadedBy:{givenName:"Deepak",lastName:"Aryal"}},{downloadCount:5,id:4,lastDownloadedAt:Date.now(),originalFileName:"manish.png",uploadedAt:Date.now(),uploadedBy:{givenName:"Lamdiki",lastName:"Sherpa"}}],r=[{default:`{
      ...
      uploadedAt: true,
      uploadedBy: true
    }`,description:"Controls visibility of file details for all files",prop:"fileDetailVisibility",type:"Object"}],p=[{description:"Slot to customize thumbnail for all files",name:"thumbnail"}];return(o,e)=>{const l=m("SshPre");return c(),f(y,{subtitle:o.$t("ui.filesList.subtitle"),title:o.$t("ui.filesList.title"),class:"demo-files-list"},{default:i(()=>[a("section",null,[a("div",v,[n(g(w),{"action-buttons-visibility":{download:!0,view:!0},files:s}),e[1]||(e[1]=t()),n(l,{language:"html-vue"},{default:i(()=>[...e[0]||(e[0]=[t(`
          <template>
            <FilesList
          ...
          <\/script>
        `,-1)])]),_:1})])]),e[3]||(e[3]=t()),n(b,{"events-data":d,"props-data":r,"props-table-title":o.$t("common.properties",{value:"FilesListProperties"}),"slots-data":p},null,8,["props-table-title"]),e[4]||(e[4]=t()),a("section",null,[n(l,{language:"html-vue"},{default:i(()=>[...e[2]||(e[2]=[t(`
        interface IFile {
          id: number | string;
