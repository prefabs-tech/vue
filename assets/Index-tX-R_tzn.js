import{d as h,J as C,e as A,o as B,j as s,C as t,f as n,h as i,t as d,u as r,P as u,v as F}from"./index-DcjgAK9n.js";import{_ as P}from"./ComponentDocumentation.vue_vue_type_script_setup_true_lang-CdLcuhE8.js";import{_ as D}from"./UiPage.vue_vue_type_style_index_0_lang-sf8Em065.js";import"./PrefabsTechVue3TanstackTable.es-D9QS2TX2.js";import"./PrefabsTechVue3Form.es-Dm1vBmAc.js";const H={class:"section-content"},z={class:"section-content"},j={class:"section-content"},N={class:"section-content"},T=h({__name:"Index",setup(I){const p={severity:"warning",size:"medium",variant:"outlined"},m={severity:"danger",size:"medium",variant:"outlined"},f={severity:"primary",size:"medium",variant:"outlined"},c=[{description:"Emitted when edit description button is clicked",name:"click:editDescription",payload:"-"},{description:"Emitted when archive action is confirmed",name:"on:archive",payload:"File object"},{description:"Emitted when delete action is confirmed",name:"on:delete",payload:"File object"},{description:"Emitted when download button is clicked",name:"on:download",payload:"File object"},{description:"Emitted when share button is clicked",name:"on:share",payload:"File object"},{description:"Emitted when view button is clicked",name:"on:view",payload:"File object"}],v=[{description:"Slot for custom thumbnail content",name:"thumbnail"}],l={description:"This is a file",downloadCount:0,id:1,lastDownloadedAt:Date.now(),originalFileName:"file.png",size:4,uploadedBy:{givenName:"Test",lastName:"user"},uploadedAt:Date.now()},b={archiveAction:"Archive file",archiveConfirmationHeader:"Confirm archive?",archiveConfirmationMessage:"Are you sure to archive this file?",deleteAction:"Delete file",deleteConfirmationHeader:"Confirm delete?",deleteConfirmationMessage:"Are you sure to delete this file?",downloadAction:"Download file",downloadCountHeader:"Download count:",lastDownloadedAtHeader:"Last downloaded date:",shareAction:"Share file",uploadedAtHeader:"Uploaded date:",uploadedByHeader:"Uploaded by:",viewAction:"View file"},w=[{default:`{
      ...
      uploadedAt: true,
      uploadedBy: true
    }`,description:"Controls visibility of file details",prop:"visibilityDetail",type:"Object"}],g={severity:"alternate",size:"medium",variant:"outlined"},y={severity:"secondary",size:"medium",variant:"outlined"};return(o,e)=>{const a=C("SshPre");return B(),A(D,{"sub-title":o.$t("ui.fileCard.subtitle"),title:o.$t("ui.fileCard.title"),class:"demo-file-card"},{toolbar:s(()=>[i(r(F),{label:o.$t("common.back"),"icon-left":"pi pi-chevron-left",size:"medium",variant:"textOnly",onClick:e[0]||(e[0]=$=>o.$router.push("/ui"))},null,8,["label"])]),default:s(()=>[e[14]||(e[14]=t()),n("section",null,[n("h2",null,d(o.$t("ui.fileCard.usage.basic")),1),e[3]||(e[3]=t()),n("div",H,[i(r(u),{file:l}),e[2]||(e[2]=t()),i(a,{language:"html-vue"},{default:s(()=>e[1]||(e[1]=[t(`
          <template>
            <FileCard :file="file" />
          </template>
          ...
          <\/script>
        `)])),_:1})])]),e[15]||(e[15]=t()),n("section",null,[n("h2",null,d(o.$t("ui.fileCard.usage.messages")),1),e[6]||(e[6]=t()),n("div",z,[i(r(u),{file:l,messages:b}),e[5]||(e[5]=t()),i(a,{language:"html-vue"},{default:s(()=>e[4]||(e[4]=[t(`
          <template>
          ...
          <\/script>
        `)])),_:1})])]),e[16]||(e[16]=t()),n("section",null,[n("h2",null,d(o.$t("ui.fileCard.usage.buttonProps")),1),e[9]||(e[9]=t()),n("div",j,[i(r(u),{"archive-button-props":p,"delete-button-props":m,"download-button-props":f,file:l,"share-button-props":g,"view-button-props":y}),e[8]||(e[8]=t()),i(a,{language:"html-vue"},{default:s(()=>e[7]||(e[7]=[t(`
          <template>
            <FileCard
        ...
        `)])),_:1})])]),e[18]||(e[18]=t()),i(P,{"events-data":c,"props-data":w,"props-table-title":o.$t("common.properties",{value:"FileCardProperties"}),"slots-data":v},null,8,["props-table-title"]),e[19]||(e[19]=t()),n("section",null,[i(a,{language:"html-vue"},{default:s(()=>e[13]||(e[13]=[t(`
        interface IFile {
          id: number | string;
