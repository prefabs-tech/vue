import{e as p,o as m}from"./DzangolabVue3Form.es-4fb0bebc.js";import{d as V,a7 as _,p as $,j as c,K as h,o as T,c as x,w as o,L as n,C as e,M as i,f as a,E as t}from"./index-137faed7-55cf5996.js";import{m as F}from"./index-782bd33e.js";import{_ as w}from"./FormPage.vue_vue_type_style_index_0_lang-443f6bba.js";const z={class:"section-content"},C={class:"section-content"},E={class:"section-content"},U={class:"section-content"},k={class:"section-content"},q={class:"section-content"},y={class:"section-content"},S={class:"section-content"},M={name:"TextareaInputField"},B=V({...M,setup(O){const{t:f}=_(),g=F.string().min(15,{message:f("form.errors.input.min",{length:15})}),v={required:f("form.errors.input.required")},b={ignore_whitespace:!0,required:!0};let r=$({customRowsColsInput:c(),customValidationInput:c(),disabled:c("Disabled textarea input"),input:c(),inputWithValidation:c(),noLabelInput:c(),textInput:c()});return(l,u)=>{const I=h("router-link"),d=h("SshPre");return T(),x(w,{title:l.$t("form.label.textarea"),class:"demo"},{toolbar:o(()=>[n(I,{to:{name:"form"},class:"back"},{default:o(()=>[e(i(l.$t("common.back")),1)]),_:1})]),default:o(()=>[e(),a("section",null,[a("h2",null,i(l.$t("form.label.basicInput")),1),e(),a("div",z,[n(d,{language:"html-vue"},{default:o(()=>[e(`
          <Form>
            <TextareaInput 
              v-model="input"
