import{d as r,D as g,e as b,o as p,h as o,B as l,f as n,t as u,g as i,u as s,a1 as a,q as m,_ as v}from"./index-DfLKm71s.js";import{_ as f}from"./UiPage.vue_vue_type_style_index_0_lang-Dui4P9Ue.js";const B={class:"section-content"},y={class:"section-content"},$={class:"section-content"},k={class:"section-content"},z={class:"container"},w={class:"section-content"},I={class:"container"},L={class:"section-content"},C={class:"container"},S={class:"section-content"},P={class:"container"},D={class:"section-content"},N={class:"container"},R=r({__name:"Index",setup(V){return(t,e)=>{const d=g("SshPre");return p(),b(f,{title:t.$t("ui.badge.title"),class:"demo-badge"},{toolbar:o(()=>[i(s(m),{label:t.$t("common.back"),"icon-left":"pi pi-chevron-left",size:"medium",variant:"textOnly",onClick:e[0]||(e[0]=A=>t.$router.push("/ui"))},null,8,["label"])]),default:o(()=>[e[36]||(e[36]=l()),n("section",null,[n("h2",null,u(t.$t("ui.badge.usage.basic")),1),e[3]||(e[3]=l()),n("div",B,[i(s(a),{label:t.$t("ui.badge.label.basic")},null,8,["label"]),e[2]||(e[2]=l()),i(d,{language:"html-vue"},{default:o(()=>e[1]||(e[1]=[l(`
          <template>
            <Badge label="Basic" /> 
          </template>
        ...
        `)])),_:1})])]),e[40]||(e[40]=l()),n("section",null,[n("h2",null,u(t.$t("ui.badge.usage.icon")),1),e[21]||(e[21]=l()),n("div",w,[n("div",I,[i(s(a),{"icon-left":"pi pi-thumbs-up"}),e[18]||(e[18]=l()),i(s(a),{"icon-right":"pi pi-thumbs-down"})]),e[20]||(e[20]=l()),i(d,{language:"html-vue"},{default:o(()=>e[19]||(e[19]=[l(`
          ...
          <script setup lang="ts">
            import { Badge } from "@dzangolab/vue3-ui";
          <\/script>
        `)])),_:1})])]),e[41]||(e[41]=l()),n("section",null,[n("h2",null,u(t.$t("ui.badge.usage.iconPackage")),1),e[25]||(e[25]=l()),n("div",L,[n("div",C,[i(s(a),{label:t.$t("ui.badge.label.locked"),"icon-left":"pi pi-lock"},null,8,["label"]),e[22]||(e[22]=l()),i(s(a),{label:t.$t("ui.badge.label.unLocked"),"icon-right":"fa-solid fa-lock-open",severity:"success"},null,8,["label"])]),e[24]||(e[24]=l()),i(d,{language:"html-vue"},{default:o(()=>e[23]||(e[23]=[l(`
          <template>
          ...
          <script setup lang="ts">
            import { Badge } from "@dzangolab/vue3-ui";
          <\/script>
        `)])),_:1})])]),e[42]||(e[42]=l()),n("section",null,[n("h2",null,u(t.$t("ui.badge.usage.iconAndLabel")),1),e[29]||(e[29]=l()),n("div",S,[n("div",P,[i(s(a),{label:t.$t("ui.badge.label.locked"),"icon-left":"pi pi-lock"},null,8,["label"]),e[26]||(e[26]=l()),i(s(a),{label:t.$t("ui.badge.label.unLocked"),"icon-right":"pi pi-lock-open",severity:"success"},null,8,["label"])]),e[28]||(e[28]=l()),i(d,{language:"html-vue"},{default:o(()=>e[27]||(e[27]=[l(`
          <template>
            <Badge label="Locked" icon-left="pi pi-lock" />
        ...
        `)])),_:1})])]),e[43]||(e[43]=l()),n("section",null,[n("h2",null,u(t.$t("ui.badge.usage.iconElement")),1),e[35]||(e[35]=l()),n("div",D,[n("div",N,[i(s(a),{label:t.$t("ui.badge.label.correct")},{iconLeft:o(()=>e[30]||(e[30]=[n("i",{class:"pi pi-check"},null,-1)])),_:1},8,["label"]),e[32]||(e[32]=l()),i(s(a),{label:t.$t("ui.badge.label.wrong"),severity:"danger"},{iconRight:o(()=>e[31]||(e[31]=[n("i",{class:"pi pi-times"},null,-1)])),_:1},8,["label"])]),e[34]||(e[34]=l()),i(d,{language:"html-vue"},{default:o(()=>e[33]||(e[33]=[l(`
          ...
          <script setup lang="ts">
            import { Badge } from "@dzangolab/vue3-ui";
          <\/script>
        `)])),_:1})])])]),_:1},8,["title"])}}}),q=v(R,[["__scopeId","data-v-6f4cd0b3"]]);export{q as default};
