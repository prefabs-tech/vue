import{u as d,o as g}from"./DzangolabVue3Form.es-k-Xjvcvt.js";import{d as V,z as I,A as k,r as m,s as z,j as $,o as O,w as s,B as e,e as l,t as b,g as a,u as n,C as v}from"./index-CqimUq5D.js";import{z as _}from"./index-mSkvzYyn.js";import{_ as R}from"./FormPage.vue_vue_type_style_index_0_lang-g4uxL8pa.js";const B={class:"section-content"},S={class:"section-content"},C={class:"section-content"},F={class:"section-content"},U={name:"RadioInput"},y=V({...U,setup(W){const{t:u}=I(),h=_.string({required_error:u("form.errors.radio.required")});let i=k({disabled:m("car"),i18nInput:m(),input:m(),inputWithValidation:m(),noLabelInput:m()});const c=[{label:u("form.label.male"),value:"male"},{label:u("form.label.female"),value:"female"}],f=[{label:u("form.label.bike"),value:"bike"},{label:u("form.label.car"),value:"car"},{label:u("form.label.truck"),value:"truck"}];return(t,o)=>{const p=z("SshPre");return O(),$(R,{title:t.$t("form.label.radio"),class:"demo"},{toolbar:s(()=>[a(n(v),{label:t.$t("common.back"),"icon-left":"pi pi-chevron-left",size:"medium",variant:"textOnly",onClick:o[0]||(o[0]=r=>t.$router.push("/form"))},null,8,["label"])]),default:s(()=>[e(),l("section",null,[l("h2",null,b(t.$t("form.label.basicInput")),1),e(),l("div",B,[a(n(d),{modelValue:n(i).input,"onUpdate:modelValue":o[1]||(o[1]=r=>n(i).input=r),label:t.$t("form.label.gender"),options:c,direction:"horizontal",name:"label-input"},null,8,["modelValue","label"]),e(),a(p,{language:"html-vue"},{default:s(()=>[e(`
          <template>
            <RadioInput
              v-model="input"
