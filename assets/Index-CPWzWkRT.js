import{U as m,W as g}from"./PrefabsTechVue3TanstackTable.es-CCWGft_y.js";import{d as S,u as I,r as $,o as h,h as y,w as u,a as o,t as d,b as e,e as i,f as l,i as D,j as f,m as b,l as L}from"./index-CL6G4kQC.js";import{_ as c}from"./ComponentDocumentation.vue_vue_type_script_setup_true_lang-DYh4lDNV.js";import{_ as U}from"./FormPage.vue_vue_type_style_index_0_lang-BrBSJbsh.js";const F={class:"section-content"},W={class:"section-content"},B={class:"section-content"},O={class:"section-content"},N={class:"section-content"},k={class:"section-content"},C={name:"SwitchInputDemo"},Z=S({...C,setup(P){const{t:p}=I();let s=D({disabled:f(!0),input:f(),inputWithValidation:f(!1),noLabelInput:f(),onOffLabel:f()});const v=b(()=>[{description:p("form.documentation.eventDescription.input.modelValue"),name:"update:modelValue",payload:"value: boolean"}]),w=b(()=>L.boolean().refine(n=>n===!0,{message:p("form.errors.switch.invalid")})),V=b(()=>[{default:"false",description:p("form.documentation.propsDescription.input.disabled"),prop:"disabled",type:"Boolean"},{default:"-",description:p("form.documentation.propsDescription.input.label"),prop:"label",type:"String"},{default:"false",description:p("form.documentation.propsDescription.input.modelValue"),prop:"modelValue",type:"Boolean"},{default:'"switch"',description:p("form.documentation.propsDescription.input.name"),prop:"name",type:"String"},{default:"-",description:p("form.documentation.propsDescription.switch.offLabel"),prop:"offLabel",type:"String"},{default:"-",description:p("form.documentation.propsDescription.switch.onLabel"),prop:"onLabel",type:"String"},{default:"-",description:p("form.documentation.propsDescription.input.schema"),prop:"schema",type:"z.ZodType<string | number | boolean>"}]);return(n,t)=>{const r=$("SshPre");return h(),y(U,{subtitle:n.$t("form.subtitle.switch"),title:n.$t("form.label.switch"),class:"demo"},{default:u(()=>[o("section",null,[o("h2",null,d(n.$t("form.label.basicInput")),1),t[8]||(t[8]=e()),o("div",F,[i(l(m),{modelValue:l(s).noLabelInput,"onUpdate:modelValue":t[0]||(t[0]=a=>l(s).noLabelInput=a)},null,8,["modelValue"]),t[7]||(t[7]=e()),i(r,{language:"html-vue"},{default:u(()=>[...t[6]||(t[6]=[e(`
          <template>
