import{T as i,$ as f}from"./PrefabsTechVue3Form.es-Cp66sc_V.js";import{d as V,G as N,I as $,L as E,r as p,H as F,e as O,o as z,j as m,B as n,f as o,t as d,h as r,u as l,v as w}from"./index-B2kpz5D5.js";import{_ as U}from"./FormPage.vue_vue_type_style_index_0_lang-DxHfEpv_.js";const y={class:"section-content"},M={class:"section-content"},S={class:"section-content"},h={class:"section-content"},k={class:"section-content"},q={class:"section-content"},B={class:"section-content"},C={name:"NumberInputField"},D=V({...C,setup(L){const{t:b}=N(),I=$.coerce.number({invalid_type_error:b("form.errors.number.invalid")}).gte(1,b("form.errors.number.invalid")).lte(100,b("form.errors.number.invalid")),g={invalid:b("form.errors.number.invalid"),required:b("form.errors.number.required")},v={min:1,max:100,allow_leading_zeroes:!1};let u=E({customValidationInput:p(),disabled:p(100),i18nInput:p(),input:p(),inputWithValidation:p(),noLabelInput:p(),textInput:p()});return(t,e)=>{const s=F("SshPre");return z(),O(U,{title:t.$t("form.label.number"),class:"demo"},{toolbar:m(()=>[r(l(w),{label:t.$t("common.back"),"icon-left":"pi pi-chevron-left",size:"medium",variant:"textOnly",onClick:e[0]||(e[0]=a=>t.$router.push("/form"))},null,8,["label"])]),default:m(()=>[e[29]||(e[29]=n()),o("section",null,[o("h2",null,d(t.$t("form.label.basicInput")),1),e[10]||(e[10]=n()),o("div",y,[r(l(i),{modelValue:l(u).noLabelInput,"onUpdate:modelValue":e[1]||(e[1]=a=>l(u).noLabelInput=a),placeholder:t.$t("form.placeholder.number")},null,8,["modelValue","placeholder"]),e[9]||(e[9]=n()),r(s,{language:"html-vue"},{default:m(()=>e[8]||(e[8]=[n(`
          <template>
            <NumberInput 
              v-model="input"
