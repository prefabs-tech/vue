import{U as u,J as h}from"./DzangolabVue3Form.es-de8eb488.js";import{d as k,a5 as V,p as P,j as p,J as b,o as $,c as y,w as i,K as a,W as e,L as s,f as n,D as t}from"./index-729398ab-c88618b2.js";import{m as w}from"./index-9744a5b9.js";import{_ as z}from"./FormPage.vue_vue_type_style_index_0_lang-84beb670.js";const U={class:"section-content"},B={class:"section-content"},M={class:"section-content"},O={class:"section-content"},I={class:"section-content"},_={class:"section-content"},A={class:"section-content"},R={class:"section-content"},Y={class:"section-content"},j={class:"section-content"},F={class:"section-content"},S={class:"section-content"},C={class:"section-content"},J={class:"section-content"},L={name:"DatePickerInput"},E=k({...L,setup(T){const{t:D}=V(),v=w.date({invalid_type_error:D("form.errors.datePicker.invalid")}).max(new Date,{message:D("form.errors.datePicker.invalid")}),f=new Date,c=f;let o=P({appointmentDate:p(f),arrivalDate:p(),availableDatetime:p([f,new Date(c.setDate(c.getDate()+7))]),dateOfBirth:p(f),dateRange:p([f,new Date(c.setDate(c.getDate()+7))]),joinedDate:p(),month:p(),monthAndYear:p(),noLabelInput:p(),presentationDate:p(f),reportDate:p([f,new Date(c.setDate(c.getDate()+7))]),time:p(),year:p(f.getFullYear())});return(l,r)=>{const g=b("router-link"),d=b("SshPre");return $(),y(z,{title:l.$t("form.label.datePicker"),class:"demo"},{toolbar:i(()=>[a(g,{to:{name:"form"},class:"back"},{default:i(()=>[e(s(l.$t("common.back")),1)]),_:1})]),default:i(()=>[e(),n("section",null,[n("h2",null,s(l.$t("form.label.basicInput")),1),e(),n("div",U,[a(t(u),{modelValue:t(o).noLabelInput,"onUpdate:modelValue":r[0]||(r[0]=m=>t(o).noLabelInput=m)},null,8,["modelValue"]),e(),a(d,{language:"html-vue"},{default:i(()=>[e(`
          <template>
            <DatePicker 
              v-model="input"
            />
          ...
          <\/script>
        `)]),_:1}),e()])]),e(),n("section",null,[n("h2",null,s(l.$t("form.label.labelInput")),1),e(),n("div",B,[a(t(u),{modelValue:t(o).arrivalDate,"onUpdate:modelValue":r[1]||(r[1]=m=>t(o).arrivalDate=m),label:l.$t("form.label.arrivalDate")},null,8,["modelValue","label"]),e(),a(d,{language:"html-vue"},{default:i(()=>[e(`
          <template>
            <DatePicker 
              v-model="arrivalDate"
              label="Arrival date"
        ...
        `)]),_:1}),e()])]),e(),n("section",null,[n("h2",null,s(l.$t("form.label.dateTimePicker")),1),e(),n("div",Y,[a(t(u),{modelValue:t(o).availableDatetime,"onUpdate:modelValue":r[8]||(r[8]=m=>t(o).availableDatetime=m),label:l.$t("form.label.availableDatetime"),"enable-time-picker":"","multi-calendars":"",range:""},null,8,["modelValue","label"]),e(),a(d,{language:"html-vue"},{default:i(()=>[e(`
          ...
          <\/script>
        `)]),_:1}),e()])]),e(),n("section",null,[n("h2",null,s(l.$t("form.label.monthPicker")),1),e(),n("div",j,[a(t(u),{modelValue:t(o).month,"onUpdate:modelValue":r[9]||(r[9]=m=>t(o).month=m),label:l.$t("form.label.month"),format:"MMM","month-picker":""},null,8,["modelValue","label"]),e(),a(d,{language:"html-vue"},{default:i(()=>[e(`
          <template>
            <DatePicker 
              v-model="month"
              format="MMM"
          ...
          const month = ref();
          <\/script>
        `)]),_:1}),e()])]),e(),n("section",null,[n("h2",null,s(l.$t("form.label.monthAndYearPicker")),1),e(),n("div",F,[a(t(u),{modelValue:t(o).month,"onUpdate:modelValue":r[10]||(r[10]=m=>t(o).month=m),label:l.$t("form.label.monthAndYear"),"month-picker":""},null,8,["modelValue","label"]),e(),a(d,{language:"html-vue"},{default:i(()=>[e(`
          <template>
            <DatePicker 
          ...
          <\/script>
        `)]),_:1}),e()])]),e(),n("section",null,[n("h2",null,s(l.$t("form.label.yearPicker")),1),e(),n("div",S,[a(t(u),{modelValue:t(o).year,"onUpdate:modelValue":r[11]||(r[11]=m=>t(o).year=m),label:l.$t("form.label.year"),"year-picker":""},null,8,["modelValue","label"]),e(),a(d,{language:"html-vue"},{default:i(()=>[e(`
          <template>
            <DatePicker 
              v-model="year"
              label="Year"
          ...
          <\/script>
        `)]),_:1}),e()])]),e(),n("section",null,[n("h2",null,s(l.$t("form.label.timePicker")),1),e(),n("div",C,[a(t(u),{modelValue:t(o).time,"onUpdate:modelValue":r[12]||(r[12]=m=>t(o).time=m),label:l.$t("form.label.appointmentTime"),"time-picker":""},null,8,["modelValue","label"]),e(),a(d,{language:"html-vue"},{default:i(()=>[e(`
          <template>
            <DatePicker 
          ...
          import { DatePicker } from "@dzangolab/vue3-form";
          <\/script>
        `)]),_:1}),e()])]),e(),n("section",null,[n("h2",null,s(l.$t("form.label.inputWithValidation")),1),e(),n("div",J,[a(t(h),null,{default:i(()=>[a(t(u),{modelValue:t(o).joinedDate,"onUpdate:modelValue":r[13]||(r[13]=m=>t(o).joinedDate=m),label:l.$t("form.label.joinedDate"),schema:t(v)},null,8,["modelValue","label","schema"])]),_:1}),e(),a(d,{language:"html-vue"},{default:i(()=>[e(`
          <Form>
            <DatePicker 
              v-model="joinedDate"
              :schema="inputSchema"
