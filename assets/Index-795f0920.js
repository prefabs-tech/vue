import{d as _,j as u,K as d,o as c,c as g,w as l,L as o,C as e,M as s,f as n,E as p,ay as m,a as b,F as w,g as h}from"./index-35228b09-3d0d33db.js";import{_ as $}from"./UiPage.vue_vue_type_style_index_0_lang-e48c8db4.js";const P={class:"section-content"},k={class:"email"},C={class:"label"},y={class:"value"},S={class:"name"},D={class:"label"},N={class:"value"},z={class:"section-content"},B=n("div",{class:"trigger"},"...",-1),M=_({__name:"Index",setup(V){const t=u([{disabled:!0,label:"Change password",value:"password"},{label:"Profile",value:"profile"}]),r=u(!1),v=a=>{a===t.value[1].value&&(r.value=!0)};return(a,E)=>{const f=d("router-link"),i=d("SshPre");return c(),g($,{title:a.$t("ui.dropdown.title"),class:"demo"},{toolbar:l(()=>[o(f,{to:{name:"ui"},class:"back"},{default:l(()=>[e(s(a.$t("common.back")),1)]),_:1})]),default:l(()=>[e(),n("section",null,[n("h2",null,s(a.$t("ui.dropdown.usage.basic")),1),e(),n("div",P,[o(p(m),{label:a.$t("ui.dropdown.label.user"),menu:t.value,onSelect:v},null,8,["label","menu"]),e(),r.value?(c(),b(w,{key:0},[n("div",k,[n("span",C,s(a.$t("ui.dropdown.label.email")),1),e(),n("span",y,s(": "+a.$t("ui.dropdown.usage.email")),1)]),e(),n("div",S,[n("span",D,s(a.$t("ui.dropdown.label.name")),1),e(),n("span",N,s(": "+a.$t("ui.dropdown.usage.name")),1)])],64)):h("",!0),e(),o(i,{language:"html-vue"},{default:l(()=>[e(`
          <template>
            <Dropdown 
              :menu="menu"
              label="User"
