import{d as E,u as V,b as z,e as d,o as I,c as y,w as s,a as i,t as p,f as e,g as n,h as l,r as g}from"./index-1af78c85.js";import{m as $,H as u,z as c}from"./DzangolabVue3Form.es-9e841985.js";const w={class:"demo-section"},F={class:"demo-section"},S={class:"demo-section"},O={class:"demo-section"},U={class:"demo-section"},q={class:"demo-section"},M={class:"demo-section"},P={name:"EmailInputField"},D=E({...P,setup(W){const{t:f}=V(),h=$.string().email({message:f("form.errors.email.invalid")}),v={required:f("form.errors.input.required"),invalid:f("form.errors.email.invalid",{list:"(dzangolab.com, dzango.com, gmail.com)"})},b={allow_display_name:!1,allow_utf8_local_part:!0,host_whitelist:["dzangolab.com","dzango.com","gmail.com"],require_display_name:!1};let o=z({customStyleInput:d(),customValidationInput:d(),disabled:d("monorepo@dzangolab.com"),input:d(),inputWithValidation:d(),noLabelInput:d(),textInput:d()});return(a,t)=>{const r=g("SshPre"),_=g("Page");return I(),y(_,{title:a.$t("form.label.email")},{default:s(()=>[i("section",w,[i("h3",null,p(a.$t("form.label.basicInput")),1),e(),n(r,{language:"html-vue"},{default:s(()=>[e(`
        <template>
          <Email 
            v-model="input"
