import{g as b,U as v}from"./DzangolabVue3Form.es-Cuu7qoW_.js";import{d as S,L as h,M as V,N as I,r as p,K as $,f as L,o as z,i as s,E as e,g as a,t as d,h as u,u as n,l as F,A as c,x as N}from"./index-CN0dyNvH.js";import{_ as U}from"./FormPage.vue_vue_type_style_index_0_lang-D9J1Kd4H.js";const D={class:"section-content"},M={class:"section-content"},G={class:"section-content"},H={class:"section-content"},W={class:"section-content"},y={class:"section-content"},k={class:"section-content"},C={class:"section-content"},P={class:"section-content"},w={class:"section-content"},B={class:"section-content"},A={class:"section-content"},E={name:"SelectInputField"},J=S({...E,setup(K){const{t:f}=h(),g=V.string({invalid_type_error:f("form.errors.multiselect.invalid")}).array().min(1,{message:f("form.errors.multiselect.invalid")});let i=I({customLabelSelect:p(),disabled:p("de"),disabledMultiselect:p(["be","de"]),disabledSortInput:p(),i18nSelect:p(),input:p(),inputWithMinMax:p([]),inputWithValidation:p([]),multiselect:p(),multiselectSearch:p(),noLabelInput:p(),selectWithSearch:p()});const r=p([{label:f("form.label.french"),value:"fr"},{label:f("form.label.german"),value:"de"},{disabled:!0,label:f("form.label.dutch"),value:"be"},{label:f("form.label.nepali"),value:"np"},{label:f("form.label.hindi"),value:"hi"}]);return(t,l)=>{const m=$("SshPre");return z(),L(U,{title:t.$t("form.label.select"),class:"demo"},{toolbar:s(()=>[u(n(N),{label:t.$t("common.back"),"icon-left":"pi pi-chevron-left",size:"medium",variant:"textOnly",onClick:l[0]||(l[0]=o=>t.$router.push("/form"))},null,8,["label"])]),default:s(()=>[l[50]||(l[50]=e()),a("section",null,[a("h2",null,d(t.$t("form.label.basicInput")),1),l[15]||(l[15]=e()),a("div",D,[u(n(b),{modelValue:n(i).noLabelInput,"onUpdate:modelValue":l[1]||(l[1]=o=>n(i).noLabelInput=o),options:r.value,placeholder:t.$t("form.placeholder.language")},null,8,["modelValue","options","placeholder"]),l[14]||(l[14]=e()),u(m,{language:"html-vue"},{default:s(()=>l[13]||(l[13]=[e(`
          <template>
            <SelectInput
              v-model="input"
              :options="options"
        ...
        `)])),_:1})])]),l[53]||(l[53]=e()),a("section",null,[a("h2",null,d(t.$t("form.label.withSearch")),1),l[24]||(l[24]=e()),a("div",H,[u(n(b),{modelValue:n(i).selectWithSearch,"onUpdate:modelValue":l[4]||(l[4]=o=>n(i).selectWithSearch=o),label:t.$t("form.label.language"),options:r.value,placeholder:t.$t("form.placeholder.language"),"search-placeholder":t.$t("form.placeholder.search"),"enable-search":""},null,8,["modelValue","label","options","placeholder","search-placeholder"]),l[23]||(l[23]=e()),u(m,{language:"html-vue"},{default:s(()=>l[22]||(l[22]=[e(`
          ...
          <\/script>
        `)])),_:1})])]),l[54]||(l[54]=e()),a("section",null,[a("h2",null,d(t.$t("form.label.disableSort")),1),l[27]||(l[27]=e()),a("div",W,[u(n(b),{modelValue:n(i).disabledSortInput,"onUpdate:modelValue":l[5]||(l[5]=o=>n(i).disabledSortInput=o),"has-sorted-options":!1,label:t.$t("form.label.language"),options:r.value,placeholder:t.$t("form.placeholder.language")},null,8,["modelValue","label","options","placeholder"]),l[26]||(l[26]=e()),u(m,{language:"html-vue"},{default:s(()=>l[25]||(l[25]=[e(`
          <template>
            <SelectInput 
              v-model="input"
