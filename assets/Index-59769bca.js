import{K as i}from"./DzangolabVue3Form.es-b51db7e8.js";import{_ as u}from"./FormPage.vue_vue_type_style_index_0_lang-61bbebf7.js";import{d as c,J as r,o as d,c as f,w as o,K as n,W as e,L as s,f as t,D as p}from"./index-729398ab-c88618b2.js";import"./index-7eca6f7f.js";const g={class:"section-content"},h={class:"section-content"},b={class:"section-content"},_={class:"section-content"},z={class:"section-content"},v={class:"section-content"},F={name:"FileInputDemo"},j=c({...F,setup(I){return(l,w)=>{const m=r("router-link"),a=r("SshPre");return d(),f(u,{title:l.$t("form.label.fileInput"),class:"demo"},{toolbar:o(()=>[n(m,{to:{name:"form"},class:"back"},{default:o(()=>[e(s(l.$t("common.back")),1)]),_:1})]),default:o(()=>[e(),t("section",null,[t("h2",null,s(l.$t("form.label.basicInput")),1),e(),t("div",g,[n(p(i)),e(),n(a,{language:"html-vue"},{default:o(()=>[e(`
          <template>
            <FileInput />
          </template>
