import{d as m,J as r,o as d,c as b,w as n,K as p,D as l,ao as u,W as t,f as o,L as s,aD as a}from"./index-729398ab-b294403d.js";import{_ as g}from"./UiPage.vue_vue_type_style_index_0_lang-ae0d4afa.js";const h={class:"section-content"},v={class:"popup-title"},f={class:"popup-body"},$={class:"section-content"},P={class:"section-content"},_={class:"section-content"},y={class:"section-content"},B={class:"section-content"},C=m({__name:"Index",setup(E){return(e,c)=>{const i=r("SshPre");return d(),b(g,{title:e.$t("ui.popup.title"),class:"demo"},{toolbar:n(()=>[p(l(u),{label:e.$t("common.back"),"icon-left":"pi pi-chevron-left",size:"medium",variant:"textOnly",onClick:c[0]||(c[0]=z=>e.$router.push("/ui"))},null,8,["label"])]),default:n(()=>[t(),o("section",null,[o("h2",null,s(e.$t("ui.popup.usage.basic")),1),t(),o("div",h,[p(l(a),null,{content:n(()=>[o("h3",v,s(e.$t("ui.popup.title")),1),t(),o("div",f,s(e.$t("ui.popup.content")),1)]),default:n(()=>[p(l(u),{label:e.$t("ui.popup.label.button"),severity:"success"},null,8,["label"]),t()]),_:1}),t(),p(i,{language:"html-vue"},{default:n(()=>[t(`
          <template>
            <Popup>
              <ButtonElement
                :label="Click me"
