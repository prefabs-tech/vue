import{O as m,C as f}from"./PrefabsTechVue3Form.es-DchXesOb.js";import{d as $,H as y,J as E,L as D,r as d,I as O,e as F,o as M,j as a,C as n,f as o,h as r,t as b,u as t,v as z}from"./index-BU6iKU0F.js";import{_ as S}from"./ComponentDocumentation.vue_vue_type_script_setup_true_lang-CVfcli2c.js";import{_ as q}from"./FormPage.vue_vue_type_style_index_0_lang-1YuQwfrR.js";import"./PrefabsTechVue3TanstackTable.es-aLEdQvle.js";const w={class:"section-content"},C={class:"section-content"},U={class:"section-content"},P={class:"section-content"},h={class:"section-content"},k={class:"section-content"},B={class:"section-content"},L={name:"NumberInputField"},A=$({...L,setup(T){const{t:i}=y(),g=[{description:i("form.documentation.eventDescription.input.modelValue"),name:"update:modelValue",payload:"number | undefined"}],I=E.coerce.number({invalid_type_error:i("form.errors.number.invalid")}).gte(1,i("form.errors.number.invalid")).lte(100,i("form.errors.number.invalid")),V=[{default:"false",description:i("form.documentation.propsDescription.input.disabled"),prop:"disabled",type:"Boolean"},{default:'{ required: "The field is required", invalid: "Please provide a valid integer field" }',description:i("form.documentation.propsDescription.input.errorMessages"),prop:"errorMessages",type:"NumberErrorMessages"},{default:"-",description:i("form.documentation.propsDescription.input.label"),prop:"label",type:"String"},{default:"undefined",description:i("form.documentation.propsDescription.input.modelValue"),prop:"modelValue",type:"number | null | undefined"},{default:'"number"',description:i("form.documentation.propsDescription.input.name"),prop:"name",type:"String"},{default:"-",description:i("form.documentation.propsDescription.input.options"),prop:"options",type:"IsIntOptions"},{default:"-",description:i("form.documentation.propsDescription.input.placeholder"),prop:"placeholder",type:"String"},{default:"-",description:i("form.documentation.propsDescription.input.schema"),prop:"schema",type:"z.ZodType<string | number>"}],N={invalid:i("form.errors.number.invalid"),required:i("form.errors.number.required")},v={min:1,max:100,allow_leading_zeroes:!1};let u=D({customValidationInput:d(),disabled:d(100),i18nInput:d(),input:d(),inputWithValidation:d(),noLabelInput:d(),textInput:d()});return(l,e)=>{const p=O("SshPre");return M(),F(q,{subtitle:t(i)("form.subtitle.number"),title:l.$t("form.label.number"),class:"demo"},{toolbar:a(()=>[r(t(z),{label:l.$t("common.back"),"icon-left":"pi pi-chevron-left",size:"medium",variant:"textOnly",onClick:e[0]||(e[0]=s=>l.$router.push("/form"))},null,8,["label"])]),default:a(()=>[e[30]||(e[30]=n()),o("section",null,[o("h2",null,b(l.$t("form.label.basicInput")),1),e[10]||(e[10]=n()),o("div",w,[r(t(m),{modelValue:t(u).noLabelInput,"onUpdate:modelValue":e[1]||(e[1]=s=>t(u).noLabelInput=s),placeholder:l.$t("form.placeholder.number")},null,8,["modelValue","placeholder"]),e[9]||(e[9]=n()),r(p,{language:"html-vue"},{default:a(()=>e[8]||(e[8]=[n(`
          <template>
            <NumberInput 
              v-model="input"
          ...
          <\/script>
        `)])),_:1})])]),e[31]||(e[31]=n()),o("section",null,[o("h2",null,b(l.$t("form.label.labelInput")),1),e[13]||(e[13]=n()),o("div",C,[r(t(m),{modelValue:t(u).input,"onUpdate:modelValue":e[2]||(e[2]=s=>t(u).input=s),label:l.$t("form.label.number"),placeholder:l.$t("form.placeholder.number")},null,8,["modelValue","label","placeholder"]),e[12]||(e[12]=n()),r(p,{language:"html-vue"},{default:a(()=>e[11]||(e[11]=[n(`
          <template>
            <NumberInput 
              v-model="input"
              label="Number"
        ...
        `)])),_:1})])]),e[32]||(e[32]=n()),o("section",null,[o("h2",null,b(l.$t("form.label.disabled")),1),e[16]||(e[16]=n()),o("div",U,[r(t(m),{modelValue:t(u).disabled,"onUpdate:modelValue":e[3]||(e[3]=s=>t(u).disabled=s),label:l.$t("form.label.number"),disabled:""},null,8,["modelValue","label"]),e[15]||(e[15]=n()),r(p,{language:"html-vue"},{default:a(()=>e[14]||(e[14]=[n(`
          ...
          import { NumberInput } from "@prefabs.tech/vue3-form";
          <\/script>
        `)])),_:1})])]),e[33]||(e[33]=n()),o("section",null,[o("h2",null,b(l.$t("form.label.withI18n")),1),e[19]||(e[19]=n()),o("div",P,[r(t(m),{modelValue:t(u).i18nInput,"onUpdate:modelValue":e[4]||(e[4]=s=>t(u).i18nInput=s),label:l.$t("form.label.number"),placeholder:l.$t("form.placeholder.number")},null,8,["modelValue","label","placeholder"]),e[18]||(e[18]=n()),r(p,{language:"html-vue"},{default:a(()=>e[17]||(e[17]=[n(`
          <template>
            <NumberInput 
              v-model="input"
