import{b as D,g as B,k as C,w as V}from"./DzangolabVue3Form.es-a9e38822.js";import{d as F,p as L,j as d,K as M,o as $,c as P,w as s,L as a,C as l,M as u,f as n,E as i,aq as p,X as f,a as S,F as z,b as I}from"./index-137faed7-eb3bdd72.js";import{_ as y}from"./UiPage.vue_vue_type_style_index_0_lang-2b5d74bc.js";import"./index-d57f7faa.js";const O={class:"section-content"},N={class:"section-content"},A={class:"section-content"},T={class:"label"},U={class:"value"},j={class:"section-content"},q={class:"section-content"},K={role:"heading"},R=F({__name:"Index",setup(X){const v=L({email:d(),password:d()}),k=[{label:"Name",value:"Acer Nitro 5"},{label:"Category",value:"Laptop"},{label:"Color",value:"Black"}],c=d(!1),w=d(!1),b=d(!1),r=d(!1),h=d(!1);return(o,e)=>{const g=M("router-link"),m=M("SshPre");return $(),P(y,{title:o.$t("ui.modal.title"),class:"demo"},{toolbar:s(()=>[a(g,{to:{name:"ui"},class:"back"},{default:s(()=>[l(u(o.$t("common.back")),1)]),_:1})]),default:s(()=>[l(),n("section",null,[n("h2",null,u(o.$t("ui.modal.usage.basic")),1),l(),n("div",O,[a(m,{language:"html-vue"},{default:s(()=>[l(`
          <template>
            <ButtonElement
              label="Open"
        ...
        `)]),_:1}),l(),a(i(p),{label:o.$t("ui.modal.label.show"),onClick:e[2]||(e[2]=t=>h.value=!0)},null,8,["label"]),l(),a(i(f),{show:h.value,title:o.$t("ui.modal.header.productDetail"),"onOn:close":e[3]||(e[3]=t=>h.value=!1)},{default:s(()=>[l(u(o.$t("ui.modal.content")),1)]),_:1},8,["show","title"])])]),l(),n("section",null,[n("h2",null,u(o.$t("ui.modal.usage.disableDismiss")),1),l(),n("div",A,[a(m,{language:"html-vue"},{default:s(()=>[l(`
          ...
          const showModal = ref(false);
          <\/script>
        `)]),_:1}),l(),a(i(p),{label:o.$t("ui.modal.label.viewDetail"),onClick:e[4]||(e[4]=t=>c.value=!0)},null,8,["label"]),l(),a(i(f),{"dismiss-on-click-out":!1,show:c.value,title:o.$t("ui.modal.header.productDetail"),"onOn:close":e[5]||(e[5]=t=>c.value=!1)},{default:s(()=>[($(),S(z,null,I(k,(t,E)=>n("div",{key:E+"-"+t,class:"info"},[n("span",T,u(t.label),1),l(),n("span",U,u(" : "+t.value),1)])),64))]),_:1},8,["show","title"])])]),l(),n("section",null,[n("h2",null,u(o.$t("ui.confirmationModal.usage.withI18n")),1),l(),n("div",j,[a(m,{language:"html-vue"},{default:s(()=>[l(`
          <template>
            <ButtonElement
