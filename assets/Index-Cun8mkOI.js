import{d as u,J as m,e as c,o as f,i,f as a,B as t,h as n,u as g,U as w}from"./index-DpADEPPw.js";import{_ as b}from"./ComponentDocumentation.vue_vue_type_script_setup_true_lang-DmCV2oad.js";import{_ as y}from"./UiPage.vue_vue_type_style_index_0_lang-B1wj6ttl.js";import"./PrefabsTechVue3TanstackTable.es-2c4k5kzO.js";import"./PrefabsTechVue3Form.es-BoUjuj1d.js";const v={class:"section-content"},C=u({__name:"Index",setup(h){const l=[{description:"Emitted when archive action is triggered",name:"action:archive",payload:"IFile object"},{description:"Emitted when delete action is triggered",name:"action:delete",payload:"IFile object"},{description:"Emitted when download action is triggered",name:"action:download",payload:"IFile object"},{description:"Emitted when edit description is triggered",name:"action:edit",payload:"IFile object"},{description:"Emitted when share action is triggered",name:"action:share",payload:"IFile object"},{description:"Emitted when view action is triggered",name:"action:view",payload:"IFile object"}],s=[{downloadCount:5,id:1,lastDownloadedAt:Date.now(),originalFileName:"file1.png",uploadedAt:Date.now(),uploadedBy:{givenName:"Manish",lastName:"Aryal"}},{downloadCount:5,id:2,lastDownloadedAt:Date.now(),originalFileName:"document.pdf",uploadedAt:Date.now(),uploadedBy:{givenName:"Gaurav",lastName:"Sapkota"}},{downloadCount:5,id:3,lastDownloadedAt:Date.now(),originalFileName:"photo.jpeg",uploadedAt:Date.now(),uploadedBy:{givenName:"Deepak",lastName:"Aryal"}},{downloadCount:5,id:4,lastDownloadedAt:Date.now(),originalFileName:"manish.png",uploadedAt:Date.now(),uploadedBy:{givenName:"Lamdiki",lastName:"Sherpa"}}],r=[{default:`{
      ...
      uploadedAt: true,
      uploadedBy: true
    }`,description:"Controls visibility of file details for all files",prop:"fileDetailVisibility",type:"Object"}],p=[{description:"Slot to customize thumbnail for all files",name:"thumbnail"}];return(o,e)=>{const d=m("SshPre");return f(),c(y,{"sub-title":o.$t("ui.filesList.subtitle"),title:o.$t("ui.filesList.title"),class:"demo-files-list"},{default:i(()=>[a("section",null,[a("div",v,[n(g(w),{"action-buttons-visibility":{download:!0,view:!0},files:s}),e[1]||(e[1]=t()),n(d,{language:"html-vue"},{default:i(()=>e[0]||(e[0]=[t(`
          <template>
            <FilesList
          ...
          <\/script>
        `)])),_:1})])]),e[3]||(e[3]=t()),n(b,{"events-data":l,"props-data":r,"props-table-title":o.$t("common.properties",{value:"FilesListProperties"}),"slots-data":p},null,8,["props-table-title"]),e[4]||(e[4]=t()),a("section",null,[n(d,{language:"html-vue"},{default:i(()=>e[2]||(e[2]=[t(`
        interface IFile {
          id: number | string;
      ...
      `)])),_:1})])]),_:1},8,["sub-title","title"])}}});export{C as default};
