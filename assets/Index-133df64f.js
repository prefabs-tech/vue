import{Z as d,J as f}from"./DzangolabVue3Form.es-b047fed9.js";import{d as v,a5 as E,p as V,j as u,J as _,o as z,c as $,w as s,K as o,D as e,ao as I,W as l,f as a,L as p}from"./index-729398ab-97e0bd19.js";import{m as F}from"./index-10489b7d.js";import{_ as w}from"./FormPage.vue_vue_type_style_index_0_lang-0e434bf3.js";const y={class:"section-content"},O={class:"section-content"},U={class:"section-content"},W={class:"section-content"},q={class:"section-content"},M={class:"section-content"},S={class:"section-content"},k={class:"section-content"},C={name:"EmailInputField"},N=v({...C,setup(L){const{t:c}=E(),g=F.string().email({message:c("form.errors.email.invalid")}),h={required:c("form.errors.input.required"),invalid:c("form.errors.email.invalid",{list:"(dzangolab.com, dzango.com, gmail.com)"})},b={allow_display_name:!1,allow_utf8_local_part:!0,host_whitelist:["dzangolab.com","dzango.com","gmail.com"],require_display_name:!1};let i=V({customValidationInput:u(),disabled:u("monorepo@dzangolab.com"),input:u(),inputWithValidation:u(),noLabelInput:u(),textInput:u()});return(n,t)=>{const r=_("SshPre");return z(),$(w,{title:n.$t("form.label.email"),class:"demo"},{toolbar:s(()=>[o(e(I),{label:n.$t("common.back"),"icon-left":"pi pi-chevron-left",size:"medium",variant:"textOnly",onClick:t[0]||(t[0]=m=>n.$router.push("/form"))},null,8,["label"])]),default:s(()=>[l(),a("section",null,[a("h2",null,p(n.$t("form.label.basicInput")),1),l(),a("div",y,[o(e(d),{modelValue:e(i).noLabelInput,"onUpdate:modelValue":t[1]||(t[1]=m=>e(i).noLabelInput=m),placeholder:n.$t("form.placeholder.email")},null,8,["modelValue","placeholder"]),l(),o(r,{language:"html-vue"},{default:s(()=>[l(`
          <template>
            <Email 
              v-model="input"
          ...
          <\/script>
        `)]),_:1}),l()])]),l(),a("section",null,[a("h2",null,p(n.$t("form.label.labelInput")),1),l(),a("div",O,[o(e(d),{modelValue:e(i).input,"onUpdate:modelValue":t[2]||(t[2]=m=>e(i).input=m),label:n.$t("form.label.email"),placeholder:n.$t("form.placeholder.email")},null,8,["modelValue","label","placeholder"]),l(),o(r,{language:"html-vue"},{default:s(()=>[l(`
          <template>
            <Email 
              v-model="input"
              label="Email"
          ...
          import { Email } from "@dzangolab/vue3-form";
          <\/script>
        `)]),_:1}),l()])]),l(),a("section",null,[a("h2",null,p(n.$t("form.label.disabled")),1),l(),a("div",U,[o(e(d),{modelValue:e(i).disabled,"onUpdate:modelValue":t[3]||(t[3]=m=>e(i).disabled=m),label:n.$t("form.label.email"),disabled:""},null,8,["modelValue","label"]),l(),o(r,{language:"html-vue"},{default:s(()=>[l(`
          <template>
            <Email 
              v-model="input"
              label="Email"
          ...
          <\/script>
        `)]),_:1}),l()])]),l(),a("section",null,[a("h2",null,p(n.$t("form.label.withI18n")),1),l(),a("div",W,[o(e(d),{modelValue:e(i).input,"onUpdate:modelValue":t[4]||(t[4]=m=>e(i).input=m),label:e(c)("form.label.email"),placeholder:e(c)("form.placeholder.email")},null,8,["modelValue","label","placeholder"]),l(),o(r,{language:"html-vue"},{default:s(()=>[l(`
          <template>
            <Email 
              v-model="input"
