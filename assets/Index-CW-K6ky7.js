import{S as v,P as $}from"./PrefabsTechVue3Form.es-seLFyOMU.js";import{d as D,G as k,I as F,L as g,r as i,H as S,e as U,o as p,j as u,B as t,f as r,t as m,h as o,a as b,b as y,u as n,v as E}from"./index-DACAZjT2.js";import{_ as P}from"./FormPage.vue_vue_type_style_index_0_lang-BU-G6ifo.js";const z={class:"section-content"},B={key:0,class:"result-date"},C={class:"section-content"},N={key:0,class:"result-date"},w={class:"section-content"},A={key:0,class:"result-date"},q={class:"section-content"},T={key:0,class:"result-date"},j={name:"DaysInput"},J=D({...j,setup(G){const{t:I}=k(),V=F.coerce.number({invalid_type_error:I("form.errors.number.required")}).min(1,{message:I("form.errors.daysInput.invalid")}).max(365,{message:I("form.errors.daysInput.invalid")}),a=g({basic:i(),disabled:i(),label:i(),validationInput:i()});let d=g({basic:i(),disabled:i(30),label:i(),validationInput:i()});return(s,e)=>{const f=S("SshPre");return p(),U(P,{title:s.$t("form.label.daysInput"),class:"demo"},{toolbar:u(()=>[o(n(E),{label:s.$t("common.back"),"icon-left":"pi pi-chevron-left",size:"medium",variant:"textOnly",onClick:e[0]||(e[0]=l=>s.$router.push("/form"))},null,8,["label"])]),default:u(()=>[e[25]||(e[25]=t()),r("section",null,[r("h2",null,m(s.$t("form.label.basicInput")),1),e[12]||(e[12]=t()),r("div",z,[o(n(v),{modelValue:n(d).basic,"onUpdate:modelValue":e[1]||(e[1]=l=>n(d).basic=l),placeholder:s.$t("form.placeholder.days"),"onUpdate:date":e[2]||(e[2]=l=>a.basic=l)},null,8,["modelValue","placeholder"]),e[10]||(e[10]=t()),a.basic?(p(),b("div",B,m(a.basic),1)):y("",!0),e[11]||(e[11]=t()),o(f,{language:"html-vue"},{default:u(()=>e[9]||(e[9]=[t(`
          <template>
            <DaysInput
              v-model="input"
          ...
          const result = ref();
          <\/script>
        `)])),_:1})])]),e[26]||(e[26]=t()),r("section",null,[r("h2",null,m(s.$t("form.label.labelInput")),1),e[16]||(e[16]=t()),r("div",C,[o(n($),null,{default:u(()=>[o(n(v),{modelValue:n(d).label,"onUpdate:modelValue":e[3]||(e[3]=l=>n(d).label=l),label:s.$t("form.label.arrivalDate"),placeholder:s.$t("form.placeholder.days"),"onUpdate:date":e[4]||(e[4]=l=>a.label=l)},null,8,["modelValue","label","placeholder"])]),_:1}),e[14]||(e[14]=t()),a.label?(p(),b("div",N,m(a.label),1)):y("",!0),e[15]||(e[15]=t()),o(f,{language:"html-vue"},{default:u(()=>e[13]||(e[13]=[t(`
          <Form>
            <DaysInput
              v-model="input"
              label="Arrival date"
