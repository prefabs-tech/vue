import{m as w,n as d,Z as c}from"./DzangolabVue3Form.es-613b07ef.js";import{d as _,u as I,b as V,e as p,r as f,o as S,c as y,w as a,f as t,g as n,t as r,a as l,h as e}from"./index-577793d9.js";const $={class:"section-content"},F={class:"section-content"},k={class:"section-content"},z={class:"section-content"},U={class:"section-content"},P={class:"section-content"},W={name:"SwitchInput"},L=_({...W,setup(B){const{t:b}=I(),h=w.coerce.boolean().refine(o=>o===!0,{message:b("form.errors.switch.invalid")});let s=V({customStyleInput:p(),disabled:p(!0),input:p(),inputWithValidation:p(!1),noLabelInput:p()});return(o,u)=>{const g=f("router-link"),m=f("SshPre"),v=f("Page");return S(),y(v,{title:o.$t("form.label.switch"),class:"demo"},{toolbar:a(()=>[t(g,{to:{name:"form"},class:"back"},{default:a(()=>[n(r(o.$t("common.back")),1)]),_:1})]),default:a(()=>[n(),l("section",null,[l("h2",null,r(o.$t("form.label.basicInput")),1),n(),l("div",$,[t(m,{language:"html-vue"},{default:a(()=>[n(`
          <Form>
            <SwitchInput
              v-model="input"
            />
