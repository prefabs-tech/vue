import{e as p,o as m}from"./DzangolabVue3Form.es-aff8d000.js";import{d as V,a6 as _,p as $,j as c,K as h,o as T,c as x,w as o,L as n,C as e,N as i,f as a,E as t}from"./index-66214709-32602281.js";import{m as F}from"./index-f20d41ca.js";import{_ as w}from"./FormPage.vue_vue_type_style_index_0_lang-8b4f287c.js";const z={class:"section-content"},C={class:"section-content"},E={class:"section-content"},U={class:"section-content"},k={class:"section-content"},q={class:"section-content"},y={class:"section-content"},S={class:"section-content"},O={name:"TextareaInputField"},W=V({...O,setup(D){const{t:f}=_(),g=F.string().min(15,{message:f("form.errors.input.min",{length:15})}),v={required:f("form.errors.input.required")},b={ignore_whitespace:!0,required:!0};let r=$({customRowsColsInput:c(),customValidationInput:c(),disabled:c("Disabled textarea input"),input:c(),inputWithValidation:c(),noLabelInput:c(),textInput:c()});return(l,u)=>{const I=h("router-link"),d=h("SshPre");return T(),x(w,{title:l.$t("form.label.textarea"),class:"demo"},{toolbar:o(()=>[n(I,{to:{name:"form"},class:"back"},{default:o(()=>[e(i(l.$t("common.back")),1)]),_:1})]),default:o(()=>[e(),a("section",null,[a("h2",null,i(l.$t("form.label.basicInput")),1),e(),a("div",z,[n(d,{language:"html-vue"},{default:o(()=>[e(`
          <Form>
            <TextareaInput 
              v-model="input"
        ...
        `)]),_:1}),e(),n(t(p),null,{default:o(()=>[n(t(m),{modelValue:t(r).customRowsColsInput,"onUpdate:modelValue":u[7]||(u[7]=s=>t(r).customRowsColsInput=s),cols:100,label:l.$t("form.label.textarea"),placeholder:l.$t("form.placeholder.input"),rows:10,class:"textarea-field"},null,8,["modelValue","label","placeholder"])]),_:1})])])]),_:1},8,["title"])}}});export{W as default};
