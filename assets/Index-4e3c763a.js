import{I as D,N as B,Y as C,L}from"./DzangolabVue3Form.es-01f89041.js";import{d as V,p as F,j as d,K as M,o as $,c as I,w as s,L as a,C as l,M as u,f as n,E as i,aq as m,X as p,a as P,F as z,b as N}from"./index-8e1c3ab6-85243c9d.js";import{_ as y}from"./UiPage.vue_vue_type_style_index_0_lang-701df655.js";import"./index-13628828.js";const O={class:"section-content"},S={class:"section-content"},A={class:"section-content"},T={class:"label"},U={class:"value"},Y={class:"section-content"},_={class:"section-content"},j={role:"heading"},H=V({__name:"Index",setup(q){const f=F({email:d(),password:d()}),k=[{label:"Name",value:"Acer Nitro 5"},{label:"Category",value:"Laptop"},{label:"Color",value:"Black"}],v=d(!1),w=d(!1),b=d(!1),c=d(!1),h=d(!1);return(o,e)=>{const g=M("router-link"),r=M("SshPre");return $(),I(y,{title:o.$t("ui.modal.title"),class:"demo"},{toolbar:s(()=>[a(g,{to:{name:"ui"},class:"back"},{default:s(()=>[l(u(o.$t("common.back")),1)]),_:1})]),default:s(()=>[l(),n("section",null,[n("h2",null,u(o.$t("ui.modal.usage.basic")),1),l(),n("div",O,[a(i(m),{label:o.$t("ui.modal.label.open"),onClick:e[0]||(e[0]=t=>b.value=!0)},null,8,["label"]),l(),a(i(p),{show:b.value,"onOn:close":e[1]||(e[1]=t=>b.value=!1)},{default:s(()=>[l(u(o.$t("ui.modal.content")),1)]),_:1},8,["show"]),l(),a(r,{language:"html-vue"},{default:s(()=>[l(`
          <template>
            <ButtonElement
              label="Open"
        ...
        `)]),_:1}),l()])]),l(),n("section",null,[n("h2",null,u(o.$t("ui.modal.usage.withTitle")),1),l(),n("div",S,[a(i(m),{label:o.$t("ui.modal.label.show"),onClick:e[2]||(e[2]=t=>h.value=!0)},null,8,["label"]),l(),a(i(p),{show:h.value,title:o.$t("ui.modal.header.productDetail"),"onOn:close":e[3]||(e[3]=t=>h.value=!1)},{default:s(()=>[l(u(o.$t("ui.modal.content")),1)]),_:1},8,["show","title"]),l(),a(r,{language:"html-vue"},{default:s(()=>[l(`
          ...
          const showModal = ref(false);
          <\/script>
        `)]),_:1}),l()])]),l(),n("section",null,[n("h2",null,u(o.$t("ui.modal.usage.disableDismiss")),1),l(),n("div",A,[a(i(m),{label:o.$t("ui.modal.label.viewDetail"),onClick:e[4]||(e[4]=t=>v.value=!0)},null,8,["label"]),l(),a(i(p),{"dismiss-on-click-out":!1,show:v.value,title:o.$t("ui.modal.header.productDetail"),"onOn:close":e[5]||(e[5]=t=>v.value=!1)},{default:s(()=>[($(),P(z,null,N(k,(t,E)=>n("div",{key:E+"-"+t,class:"info"},[n("span",T,u(t.label),1),l(),n("span",U,u(" : "+t.value),1)])),64))]),_:1},8,["show","title"]),l(),a(r,{language:"html-vue"},{default:s(()=>[l(`
          <template>
            <ButtonElement
              label="View detail"
              @click="showModal = true"
