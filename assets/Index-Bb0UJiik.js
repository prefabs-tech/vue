import{M as m,D as v}from"./PrefabsTechVue3Form.es-Cni582VJ.js";import{d as w,I as V,L as I,M as g,r as d,J as S,e as $,o as h,i as u,f as n,B as t,t as p,h as s,u as e}from"./index-CTAJGeeo.js";import{_ as L}from"./FormPage.vue_vue_type_style_index_0_lang-CjU1P2I5.js";const F={class:"section-content"},U={class:"section-content"},y={class:"section-content"},D={class:"section-content"},O={class:"section-content"},B={class:"section-content"},N={name:"SwitchInput"},z=w({...N,setup(W){const{t:f}=V(),b=I.coerce.boolean().refine(o=>o===!0,{message:f("form.errors.switch.invalid")});let i=g({disabled:d(!0),input:d(),inputWithValidation:d(!1),noLabelInput:d(),onOffLabel:d()});return(o,l)=>{const r=S("SshPre");return h(),$(L,{title:o.$t("form.label.switch"),class:"demo"},{default:u(()=>[n("section",null,[n("h2",null,p(o.$t("form.label.basicInput")),1),l[8]||(l[8]=t()),n("div",F,[s(e(m),{modelValue:e(i).noLabelInput,"onUpdate:modelValue":l[0]||(l[0]=a=>e(i).noLabelInput=a)},null,8,["modelValue"]),l[7]||(l[7]=t()),s(r,{language:"html-vue"},{default:u(()=>l[6]||(l[6]=[t(`
          <template>
        ...
        `)])),_:1})])]),l[27]||(l[27]=t()),n("section",null,[n("h2",null,p(o.$t("form.label.withI18n")),1),l[20]||(l[20]=t()),n("div",O,[s(e(m),{modelValue:e(i).input,"onUpdate:modelValue":l[4]||(l[4]=a=>e(i).input=a),label:o.$t("form.label.switch")},null,8,["modelValue","label"]),l[19]||(l[19]=t()),s(r,{language:"html-vue"},{default:u(()=>l[18]||(l[18]=[t(`
          <template>
            <SwitchInput 
              v-model="input"
              :label="t('form.label.switch')"
          ...
          const { t } = useI18n();
          <\/script>
        `)])),_:1})])]),l[28]||(l[28]=t()),n("section",null,[n("h2",null,p(o.$t("form.label.inputWithValidation")),1),l[23]||(l[23]=t()),n("div",B,[s(e(v),null,{default:u(()=>[s(e(m),{modelValue:e(i).inputWithValidation,"onUpdate:modelValue":l[5]||(l[5]=a=>e(i).inputWithValidation=a),label:o.$t("form.label.switch"),schema:e(b)},null,8,["modelValue","label","schema"])]),_:1}),l[22]||(l[22]=t()),s(r,{language:"html-vue"},{default:u(()=>l[21]||(l[21]=[t(`
          <Form>
            <SwitchInput 
              v-model="disabled"
              :schema="inputSchema"
