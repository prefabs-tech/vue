import{e as i}from"./DzangolabVue3Form.es-5cddabd8.js";import{d as m,J as u,o as c,c as d,w as l,K as n,D as s,ao as f,X as e,f as t,L as p}from"./index-729398ab-f7824fe4.js";import{_ as g}from"./FormPage.vue_vue_type_style_index_0_lang-2120d4bb.js";import"./index-9966f943.js";const h={class:"section-content"},b={class:"section-content"},z={class:"section-content"},v={class:"section-content"},_={class:"section-content"},F={class:"section-content"},I={name:"FileInputDemo"},y=m({...I,setup($){return(o,r)=>{const a=u("SshPre");return c(),d(g,{title:o.$t("form.label.fileInput"),class:"demo"},{toolbar:l(()=>[n(s(f),{label:o.$t("common.back"),"icon-left":"pi pi-chevron-left",size:"medium",variant:"textOnly",onClick:r[0]||(r[0]=w=>o.$router.push("/form"))},null,8,["label"])]),default:l(()=>[e(),t("section",null,[t("h2",null,p(o.$t("form.label.basicInput")),1),e(),t("div",h,[n(s(i)),e(),n(a,{language:"html-vue"},{default:l(()=>[e(`
          <template>
            <FileInput />
          </template>
