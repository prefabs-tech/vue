import{e as u,Z as p}from"./DzangolabVue3Form.es-aff8d000.js";import{d as k,a6 as V,p as P,j as f,K as b,o as F,c as $,w as l,L as n,C as e,N as s,f as a,E as t}from"./index-66214709-32602281.js";import{m as w}from"./index-f20d41ca.js";import{_ as y}from"./FormPage.vue_vue_type_style_index_0_lang-8b4f287c.js";const _={class:"section-content"},z={class:"section-content"},B={class:"section-content"},U={class:"section-content"},M={class:"section-content"},O={class:"section-content"},I={class:"section-content"},A={class:"section-content"},R={class:"section-content"},Y={class:"section-content"},j={class:"section-content"},S={class:"section-content"},C={class:"section-content"},L={class:"section-content"},N={name:"DatePickerInput"},K=k({...N,setup(T){const{t:g}=V(),v=w.coerce.date().max(new Date,{message:g("form.errors.datePicker.invalid")}),c=new Date,D=c;let r=P({appointmentDate:f(c),arrivalDate:f(),availableDatetime:f([c,new Date(D.setDate(D.getDate()+7))]),dateOfBirth:f(c),dateRange:f([c,new Date(D.setDate(D.getDate()+7))]),joinedDate:f(),month:f(),monthAndYear:f(),noLabelInput:f(),presentationDate:f(c),reportDate:f([c,new Date(D.setDate(D.getDate()+7))]),time:f(),year:f(c.getFullYear())});return(o,m)=>{const h=b("router-link"),d=b("SshPre");return F(),$(y,{title:o.$t("form.label.datePicker"),class:"demo"},{toolbar:l(()=>[n(h,{to:{name:"form"},class:"back"},{default:l(()=>[e(s(o.$t("common.back")),1)]),_:1})]),default:l(()=>[e(),a("section",null,[a("h2",null,s(o.$t("form.label.basicInput")),1),e(),a("div",_,[n(d,{language:"html-vue"},{default:l(()=>[e(`
          <Form>
            <DatePicker 
              v-model="input"
            />
        ...
        `)]),_:1}),e(),n(t(u),null,{default:l(()=>[n(t(p),{modelValue:t(r).time,"onUpdate:modelValue":m[12]||(m[12]=i=>t(r).time=i),label:o.$t("form.label.appointmentTime"),"time-picker":""},null,8,["modelValue","label"])]),_:1})])]),e(),a("section",null,[a("h2",null,s(o.$t("form.label.inputWithValidation")),1),e(),a("div",L,[n(d,{language:"html-vue"},{default:l(()=>[e(`
          ...
          <\/script>
        `)]),_:1}),e(),n(t(u),null,{default:l(()=>[n(t(p),{modelValue:t(r).joinedDate,"onUpdate:modelValue":m[13]||(m[13]=i=>t(r).joinedDate=i),label:o.$t("form.label.joinedDate"),schema:t(v)},null,8,["modelValue","label","schema"])]),_:1})])])]),_:1},8,["title"])}}});export{K as default};
