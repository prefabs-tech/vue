import{d as k,j as d,G as y,o as E,c as D,w as i,K as l,C as e,S as r,f as o,D as s,ao as u,a1 as f,a2 as v,aq as c}from"./index-96491301-e3ed59ee.js";import{_ as L}from"./UiPage.vue_vue_type_style_index_0_lang-421b321d.js";const O={class:"section-content"},z={class:"container"},I={class:"section-content"},S={class:"container"},T={class:"section-content"},N={class:"container"},U={class:"section-content"},V={class:"container"},H={class:"section-content"},P={class:"container"},j={class:"section-content"},q={class:"container"},Y=k({__name:"Index",setup(A){const p=d(void 0),b=d(!1),M=d(!1),w=d(!1),h=d(!1),C=d(!1),$=d(!1),g=()=>{p.value=new Date,$.value=!1};return(t,n)=>{const B=y("router-link"),m=y("SshPre");return E(),D(L,{title:t.$t("ui.confirmationModal.title"),class:"demo"},{toolbar:i(()=>[l(B,{to:{name:"ui"},class:"back"},{default:i(()=>[e(r(t.$t("common.back")),1)]),_:1})]),default:i(()=>[e(),o("section",null,[o("h2",null,r(t.$t("ui.confirmationModal.usage.basic")),1),e(),o("div",O,[l(m,{language:"html-vue"},{default:i(()=>[e(`
          <template>
            <div>
              <ButtonElement
                label="Confirm"
