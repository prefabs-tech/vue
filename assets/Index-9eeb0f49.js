import{V as d,$ as v}from"./DzangolabVue3Form.es-e6467f04.js";import{d as g,a7 as V,p as w,j as p,K as c,o as I,c as S,w as u,L as a,C as e,M as m,f as l,E as t}from"./index-8e1c3ab6-d459558c.js";import{m as _}from"./index-55edaaac.js";import{_ as $}from"./FormPage.vue_vue_type_style_index_0_lang-a26aea77.js";const z={class:"section-content"},k={class:"section-content"},F={class:"section-content"},U={class:"section-content"},C={class:"section-content"},L={name:"SwitchInput"},j=g({...L,setup(W){const{t:f}=V(),b=_.coerce.boolean().refine(n=>n===!0,{message:f("form.errors.switch.invalid")});let o=w({disabled:p(!0),input:p(),inputWithValidation:p(!1),noLabelInput:p()});return(n,s)=>{const h=c("router-link"),r=c("SshPre");return I(),S($,{title:n.$t("form.label.switch"),class:"demo"},{toolbar:u(()=>[a(h,{to:{name:"form"},class:"back"},{default:u(()=>[e(m(n.$t("common.back")),1)]),_:1})]),default:u(()=>[e(),l("section",null,[l("h2",null,m(n.$t("form.label.basicInput")),1),e(),l("div",z,[a(t(d),{modelValue:t(o).noLabelInput,"onUpdate:modelValue":s[0]||(s[0]=i=>t(o).noLabelInput=i)},null,8,["modelValue"]),e(),a(r,{language:"html-vue"},{default:u(()=>[e(`
          <template>
