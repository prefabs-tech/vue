import{$ as p,S as w}from"./DzangolabVue3Form.es-ByH_DYOt.js";import{d as P,J as V,L as $,M as I,r as f,I as z,e as S,o as y,i as d,E as l,f as s,t as m,g as t,u as n,B as U,x as F}from"./index-pg879in7.js";import{_ as L}from"./FormPage.vue_vue_type_style_index_0_lang-CcX4MMZ5.js";const O={class:"section-content"},E={class:"section-content"},q={class:"section-content"},M={class:"section-content"},k={class:"section-content"},W={class:"section-content"},C={class:"section-content"},h={class:"section-content"},B={name:"PasswordInputField"},Z=P({...B,setup(N){const{t:u}=V(),g=$.string({invalid_type_error:u("form.errors.password.invalid"),required_error:u("form.errors.input.required")}).min(8,{message:u("form.errors.password.min",{length:8})}).regex(/^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)(?=.*[\W_]).+$/,u("form.errors.password.invalid")),v={required:u("form.errors.input.required"),weak:u("form.errors.password.invalid")},b={minLength:10,minLowercase:1,minUppercase:1,minSymbols:1};let a=I({customValidationInput:f(),disabled:f("P@ssw0rd"),input:f(),inputWithValidation:f(),noLabelInput:f(),passwordInput:f()});return(e,o)=>{const i=z("SshPre");return y(),S(L,{title:e.$t("form.label.password"),class:"demo"},{toolbar:d(()=>[t(n(F),{label:e.$t("common.back"),"icon-left":"pi pi-chevron-left",size:"medium",variant:"textOnly",onClick:o[0]||(o[0]=r=>e.$router.push("/form"))},null,8,["label"])]),default:d(()=>[o[33]||(o[33]=l()),s("section",null,[s("h2",null,m(e.$t("form.label.basicInput")),1),o[11]||(o[11]=l()),s("div",O,[t(n(p),{modelValue:n(a).noLabelInput,"onUpdate:modelValue":o[1]||(o[1]=r=>n(a).noLabelInput=r),placeholder:e.$t("form.placeholder.password")},null,8,["modelValue","placeholder"]),o[10]||(o[10]=l()),t(i,{language:"html-vue"},{default:d(()=>o[9]||(o[9]=[l(`
          <template>
            <Password 
              v-model="input"
