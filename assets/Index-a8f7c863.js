import{$ as p,l as b}from"./DzangolabVue3Form.es-8e0b21c7.js";import{d as h,a5 as g,p as v,j as d,J as I,o as V,c as $,w as m,K as o,D as l,ao as w,W as e,f as t,L as i}from"./index-729398ab-b294403d.js";import{m as y}from"./index-2f56db22.js";import{_ as z}from"./FormPage.vue_vue_type_style_index_0_lang-c07c697e.js";const U={class:"section-content"},S={class:"section-content"},W={class:"section-content"},E={class:"section-content"},T={class:"section-content"},k={class:"section-content"},C={name:"InputField"},P=h({...C,setup(F){const{t:f}=g(),c=y.string().min(3,{message:f("form.errors.input.min",{length:3})});let s=v({disabled:d("monorepo@gmail.com"),input:d(),inputWithValidation:d(),noLabelInput:d(),passwordInput:d()});return(n,a)=>{const u=I("SshPre");return V(),$(z,{title:n.$t("form.label.input"),class:"demo"},{toolbar:m(()=>[o(l(w),{label:n.$t("common.back"),"icon-left":"pi pi-chevron-left",size:"medium",variant:"textOnly",onClick:a[0]||(a[0]=r=>n.$router.push("/form"))},null,8,["label"])]),default:m(()=>[e(),t("section",null,[t("h2",null,i(n.$t("form.label.basicInput")),1),e(),t("div",U,[o(l(p),{modelValue:l(s).noLabelInput,"onUpdate:modelValue":a[1]||(a[1]=r=>l(s).noLabelInput=r),placeholder:n.$t("form.placeholder.username"),type:"text"},null,8,["modelValue","placeholder"]),e(),o(u,{language:"html-vue"},{default:m(()=>[e(`
          <template>
            <Input 
              v-model="username"
