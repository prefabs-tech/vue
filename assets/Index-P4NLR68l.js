import{d as g,s as p,j as b,o as m,w as s,B as e,e as l,t as d,g as a,u as t,N as i,C as v,O as h,P as f,_ as B}from"./index-CqimUq5D.js";import{_}from"./UiPage.vue_vue_type_style_index_0_lang-BhMX9ucW.js";const r=u=>(h("data-v-6f4cd0b3"),u=u(),f(),u),y={class:"section-content"},$={class:"section-content"},k={class:"section-content"},I={class:"section-content"},w={class:"container"},z={class:"section-content"},S={class:"container"},L={class:"section-content"},C={class:"container"},P={class:"section-content"},N={class:"container"},R={class:"section-content"},V={class:"container"},A=r(()=>l("i",{class:"pi pi-check"},null,-1)),D=r(()=>l("i",{class:"pi pi-times"},null,-1)),O=g({__name:"Index",setup(u){return(n,c)=>{const o=p("SshPre");return m(),b(_,{title:n.$t("ui.badge.title"),class:"demo-badge"},{toolbar:s(()=>[a(t(v),{label:n.$t("common.back"),"icon-left":"pi pi-chevron-left",size:"medium",variant:"textOnly",onClick:c[0]||(c[0]=U=>n.$router.push("/ui"))},null,8,["label"])]),default:s(()=>[e(),l("section",null,[l("h2",null,d(n.$t("ui.badge.usage.basic")),1),e(),l("div",y,[a(t(i),{label:n.$t("ui.badge.label.basic")},null,8,["label"]),e(),a(o,{language:"html-vue"},{default:s(()=>[e(`
          <template>
            <Badge label="Basic" /> 
          </template>
