import{Y as d,E as b}from"./PrefabsTechVue3Form.es-DX6ju7BC.js";import{d as T,I as y,L as D,M as h,r as f,J as x,e as q,o as E,i as s,B as e,f as o,h as p,t as m,u as n,q as F}from"./index-BuTEJgD9.js";import{_ as S}from"./ComponentDocumentation.vue_vue_type_script_setup_true_lang-DvNb017_.js";import{_ as M}from"./FormPage.vue_vue_type_style_index_0_lang-CnPPeOKf.js";import"./PrefabsTechVue3TanstackTable.es-CBdbzMUX.js";const z={class:"section-content"},O={class:"section-content"},U={class:"section-content"},w={class:"section-content"},B={class:"section-content"},k={class:"section-content"},C={class:"section-content"},L={name:"TextInputField"},Z=T({...L,setup(P){const{t:u}=y(),v=[{description:u("form.documentation.eventDescription.input.modelValue"),name:"update:modelValue",payload:"string | null | undefined"}],I=D.string().length(5,{message:u("form.errors.input.length",{length:5})}),V=[{default:"false",description:u("form.documentation.propsDescription.input.disabled"),prop:"disabled",type:"Boolean"},{default:'{ invalid: "Please provide a valid input data", required: "The field is required", }',description:u("form.documentation.propsDescription.input.errorMessages"),prop:"errorMessages",type:"TextErrorMessages"},{default:"-",description:u("form.documentation.propsDescription.input.label"),prop:"label",type:"String"},{default:"-",description:u("form.documentation.propsDescription.input.modelValue"),prop:"modelValue",type:"String | null | undefined"},{default:'"text_input"',description:u("form.documentation.propsDescription.input.name"),prop:"name",type:"String"},{default:"-",description:u("form.documentation.propsDescription.input.options"),prop:"options",type:"Object"},{default:"-",description:u("form.documentation.propsDescription.input.placeholder"),prop:"placeholder",type:"String"},{default:"-",description:u("form.documentation.propsDescription.input.schema"),prop:"schema",type:"z.ZodType<string | number | object>"}],$={required:u("form.errors.input.required")},g={ignore_whitespace:!0,required:!0};let i=h({customValidationInput:f(),disabled:f("dzangolab"),input:f(),inputWithValidation:f(),noLabelInput:f(),textInput:f()});return(l,t)=>{const a=x("SshPre");return E(),q(M,{subtitle:n(u)("form.subtitle.text"),title:l.$t("form.label.textInput"),class:"demo"},{toolbar:s(()=>[p(n(F),{label:l.$t("common.back"),"icon-left":"pi pi-chevron-left",size:"medium",variant:"textOnly",onClick:t[0]||(t[0]=r=>l.$router.push("/form"))},null,8,["label"])]),default:s(()=>[t[30]||(t[30]=e()),o("section",null,[o("h2",null,m(l.$t("form.label.basicInput")),1),t[10]||(t[10]=e()),o("div",z,[p(n(d),{modelValue:n(i).noLabelInput,"onUpdate:modelValue":t[1]||(t[1]=r=>n(i).noLabelInput=r),placeholder:l.$t("form.placeholder.input")},null,8,["modelValue","placeholder"]),t[9]||(t[9]=e()),p(a,{language:"html-vue"},{default:s(()=>t[8]||(t[8]=[e(`
        ...
        `)])),_:1})])]),t[33]||(t[33]=e()),o("section",null,[o("h2",null,m(l.$t("form.label.withI18n")),1),t[19]||(t[19]=e()),o("div",w,[p(n(d),{modelValue:n(i).input,"onUpdate:modelValue":t[4]||(t[4]=r=>n(i).input=r),label:l.$t("form.label.textInput"),placeholder:l.$t("form.placeholder.textInput")},null,8,["modelValue","label","placeholder"]),t[18]||(t[18]=e()),p(a,{language:"html-vue"},{default:s(()=>t[17]||(t[17]=[e(`
          ...
          const { t } = useI18n();
          <\/script>
        `)])),_:1})])]),t[34]||(t[34]=e()),o("section",null,[o("h2",null,m(l.$t("form.label.inputWithValidation")),1),t[22]||(t[22]=e()),o("div",B,[p(n(b),null,{default:s(()=>[p(n(d),{modelValue:n(i).inputWithValidation,"onUpdate:modelValue":t[5]||(t[5]=r=>n(i).inputWithValidation=r),label:l.$t("form.label.input"),options:g,placeholder:l.$t("form.placeholder.input")},null,8,["modelValue","label","placeholder"])]),_:1}),t[21]||(t[21]=e()),p(a,{language:"html-vue"},{default:s(()=>t[20]||(t[20]=[e(`
          <Form>
            <TextInput 
              v-model="input"
