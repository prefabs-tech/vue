import{I as r,$ as f}from"./DzangolabVue3Form.es-WWxDZ8iF.js";import{d as V,J as $,L as T,M as z,r as m,I as F,e as x,o as U,i as s,C as t,f as o,t as d,g as u,u as l,v as q}from"./index-B3ldsAXT.js";import{_ as E}from"./FormPage.vue_vue_type_style_index_0_lang-BLkrXDuT.js";const O={class:"section-content"},S={class:"section-content"},w={class:"section-content"},C={class:"section-content"},M={class:"section-content"},h={class:"section-content"},k={class:"section-content"},y={name:"TextInputField"},N=V({...y,setup(L){const{t:b}=$(),I=T.string().length(5,{message:b("form.errors.input.length",{length:5})}),v={required:b("form.errors.input.required")},g={ignore_whitespace:!0,required:!0};let a=z({customValidationInput:m(),disabled:m("dzangolab"),input:m(),inputWithValidation:m(),noLabelInput:m(),textInput:m()});return(e,n)=>{const p=F("SshPre");return U(),x(E,{title:e.$t("form.label.textInput"),class:"demo"},{toolbar:s(()=>[u(l(q),{label:e.$t("common.back"),"icon-left":"pi pi-chevron-left",size:"medium",variant:"textOnly",onClick:n[0]||(n[0]=i=>e.$router.push("/form"))},null,8,["label"])]),default:s(()=>[n[29]||(n[29]=t()),o("section",null,[o("h2",null,d(e.$t("form.label.basicInput")),1),n[10]||(n[10]=t()),o("div",O,[u(l(r),{modelValue:l(a).noLabelInput,"onUpdate:modelValue":n[1]||(n[1]=i=>l(a).noLabelInput=i),placeholder:e.$t("form.placeholder.input")},null,8,["modelValue","placeholder"]),n[9]||(n[9]=t()),u(p,{language:"html-vue"},{default:s(()=>n[8]||(n[8]=[t(`
          <template>
            <TextInput 
              v-model="input"
