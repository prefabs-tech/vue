import{c as r,o as c}from"./DzangolabVue3Form.es-IsnEOczk.js";import{d as h,z as v,A as w,r as p,s as g,j as V,o as I,w as u,B as e,e as n,t as d,g as a,u as l,C as S}from"./index-Cc4iPlXT.js";import{z as $}from"./index-mSkvzYyn.js";import{_ as z}from"./FormPage.vue_vue_type_style_index_0_lang-BZlBAyks.js";const F={class:"section-content"},L={class:"section-content"},y={class:"section-content"},O={class:"section-content"},U={class:"section-content"},_={class:"section-content"},k={name:"SwitchInput"},P=h({...k,setup(C){const{t:f}=v(),b=$.coerce.boolean().refine(t=>t===!0,{message:f("form.errors.switch.invalid")});let i=w({disabled:p(!0),input:p(),inputWithValidation:p(!1),noLabelInput:p(),onOffLabel:p()});return(t,o)=>{const m=g("SshPre");return I(),V(z,{title:t.$t("form.label.switch"),class:"demo"},{toolbar:u(()=>[a(l(S),{label:t.$t("common.back"),"icon-left":"pi pi-chevron-left",size:"medium",variant:"textOnly",onClick:o[0]||(o[0]=s=>t.$router.push("/form"))},null,8,["label"])]),default:u(()=>[e(),n("section",null,[n("h2",null,d(t.$t("form.label.basicInput")),1),e(),n("div",F,[a(l(r),{modelValue:l(i).noLabelInput,"onUpdate:modelValue":o[1]||(o[1]=s=>l(i).noLabelInput=s)},null,8,["modelValue"]),e(),a(m,{language:"html-vue"},{default:u(()=>[e(`
          <template>
