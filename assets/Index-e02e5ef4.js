import{d as r,e as g,r as l,o as _,c as m,w as s,a as e,t as p,f as n,g as o,h as i,a5 as f,a9 as v}from"./index-d19d1a72.js";const h={class:"section-content"},b={class:"container"},B=r({__name:"Index",setup(k){const a=g(!1),c=()=>{a.value=!0,setTimeout(()=>{a.value=!1},5e3)};return(t,L)=>{const u=l("SshPre"),d=l("Page");return _(),m(d,{title:t.$t("ui.loading.title"),class:"demo-loading"},{default:s(()=>[e("section",null,[e("h2",null,p(t.$t("ui.loading.usage.basic")),1),n(),e("div",h,[o(u,{language:"html-vue"},{default:s(()=>[n(`
          <template>
