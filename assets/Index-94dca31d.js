import{m as g,n as d,Z as p}from"./DzangolabVue3Form.es-dfaaf9a3.js";import{d as w,a3 as V,l as I,j as c,E as f,o as S,c as _,w as a,J as e,C as l,Z as r,f as t,N as n}from"./index-66214709-7b57635f.js";import{_ as $}from"./FormPage.vue_vue_type_style_index_0_lang-2c538954.js";import"./index-2f944215.js";const F={class:"section-content"},z={class:"section-content"},k={class:"section-content"},U={class:"section-content"},C={class:"section-content"},N={name:"SwitchInput"},P=w({...N,setup(W){const{t:b}=V(),h=g.coerce.boolean().refine(o=>o===!0,{message:b("form.errors.switch.invalid")});let s=I({disabled:c(!0),input:c(),inputWithValidation:c(!1),noLabelInput:c()});return(o,i)=>{const v=f("router-link"),m=f("SshPre");return S(),_($,{title:o.$t("form.label.switch"),class:"demo"},{toolbar:a(()=>[e(v,{to:{name:"form"},class:"back"},{default:a(()=>[l(r(o.$t("common.back")),1)]),_:1})]),default:a(()=>[l(),t("section",null,[t("h2",null,r(o.$t("form.label.basicInput")),1),l(),t("div",F,[e(m,{language:"html-vue"},{default:a(()=>[l(`
          <Form>
            <SwitchInput
              v-model="input"
            />
        ...
        `)]),_:1}),l(),e(n(p),null,{default:a(()=>[e(n(d),{modelValue:n(s).input,"onUpdate:modelValue":i[3]||(i[3]=u=>n(s).input=u),label:o.$t("form.label.switch")},null,8,["modelValue","label"])]),_:1})])]),l(),t("section",null,[t("h2",null,r(o.$t("form.label.inputWithValidation")),1),l(),t("div",C,[e(m,{language:"html-vue"},{default:a(()=>[l(`
          ...
          <\/script>
        `)]),_:1}),l(),e(n(p),null,{default:a(()=>[e(n(d),{modelValue:n(s).inputWithValidation,"onUpdate:modelValue":i[4]||(i[4]=u=>n(s).inputWithValidation=u),label:o.$t("form.label.switch"),schema:n(h)},null,8,["modelValue","label","schema"])]),_:1})])])]),_:1},8,["title"])}}});export{P as default};
