import{d as m,I as f,e as g,o as v,i as s,D as e,f as n,g as i,t as l,u as r,N as d,v as C}from"./index-BfHf9_CU.js";import{_ as $}from"./ComponentDocumentation.vue_vue_type_script_setup_true_lang-DcEkCfT_.js";import{_ as b}from"./UiPage.vue_vue_type_style_index_0_lang-DEeUb_pU.js";import"./DzangolabVue3TanstackTable.es-atVZzQmh.js";import"./DzangolabVue3Form.es-CQgBzZxD.js";const c={class:"section-content"},h={class:"content"},z={class:"section-content"},I={class:"content"},S={class:"section-content"},y={class:"content"},D={class:"section-content"},k={class:"title"},N={class:"content"},w={class:"footer"},q=m({__name:"Index",setup(B){const u=[{default:"-",description:"Title text displayed in the card header. Ignored if header slot is provided.",prop:"title",type:"String"}],p=[{description:"Default slot for the main body content of the card.",name:"default"},{description:"Slot for custom footer content, rendered at the bottom of the card.",name:"footer"},{description:"Slot for custom header content, replaces the default title if provided.",name:"header"}];return(o,t)=>{const a=f("SshPre");return v(),g(b,{"sub-title":o.$t("ui.card.subtitle"),title:o.$t("ui.card.title"),class:"demo"},{toolbar:s(()=>[i(r(C),{label:o.$t("common.back"),"icon-left":"pi pi-chevron-left",size:"medium",variant:"textOnly",onClick:t[0]||(t[0]=P=>o.$router.push("/ui"))},null,8,["label"])]),default:s(()=>[t[15]||(t[15]=e()),n("section",null,[n("h2",null,l(o.$t("ui.card.usage.basic")),1),t[3]||(t[3]=e()),n("div",c,[i(r(d),null,{default:s(()=>[n("p",h,l(o.$t("ui.card.content")),1)]),_:1}),t[2]||(t[2]=e()),i(a,{language:"html-vue"},{default:s(()=>t[1]||(t[1]=[e(`
        ...
        `)])),_:1})])]),t[17]||(t[17]=e()),n("section",null,[n("h2",null,l(o.$t("ui.card.usage.withI18n")),1),t[9]||(t[9]=e()),n("div",S,[i(r(d),{title:o.$t("ui.card.headerContent")},{default:s(()=>[n("p",y,l(o.$t("ui.card.content")),1)]),_:1},8,["title"]),t[8]||(t[8]=e()),i(a,{language:"html-vue"},{default:s(()=>t[7]||(t[7]=[e(`
          ...
          const { t } = useI18n();
          <\/script>
        `)])),_:1})])]),t[18]||(t[18]=e()),n("section",null,[n("h2",null,l(o.$t("ui.card.usage.slots")),1),t[14]||(t[14]=e()),n("div",D,[i(r(d),null,{header:s(()=>[n("h3",k,l(o.$t("ui.card.headerContent")),1)]),footer:s(()=>[n("div",w,l(o.$t("ui.card.footerContent")),1)]),default:s(()=>[t[10]||(t[10]=e()),n("p",N,l(o.$t("ui.card.content")),1),t[11]||(t[11]=e())]),_:1}),t[13]||(t[13]=e()),i(a,{language:"html-vue"},{default:s(()=>t[12]||(t[12]=[e(`
          <template>
            <Card>
              <template #header>
                <h3>Lorem ipsum</h3>
          ...
          import { Card } from "@dzangolab/vue3-ui";
          <\/script>
        `)])),_:1})])]),t[19]||(t[19]=e()),i($,{"props-data":u,"props-table-title":o.$t("common.properties",{value:"CardProperties"}),"slots-data":p},null,8,["props-table-title"])]),_:1},8,["sub-title","title"])}}});export{q as default};
