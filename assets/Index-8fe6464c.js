import{r as b,e as y}from"./DzangolabVue3Form.es-dfaaf9a3.js";import{d as S,l as B,j as c,E as h,o as V,c as C,w as n,J as l,C as e,Z as i,f as o,N as p,aB as d,S as _}from"./index-66214709-7b57635f.js";import{_ as D}from"./UiPage.vue_vue_type_style_index_0_lang-e3062105.js";import"./index-2f944215.js";const k={class:"section-content"},I={class:"section-content"},N={class:"section-content"},F=S({__name:"Index",setup(w){const f=_(),a=B({name:null,phone:null,price:"$50"}),v=c({iconRight:"pi pi-chevron-right",label:"Next",severity:"primary",variant:"filled"}),P=c({iconLeft:"pi pi-chevron-left",label:"Back",severity:"secondary",variant:"filled"}),u=c([{content:"Please enter personal details",label:"Personal",step:1},{content:"Please enter contact details",label:"Contact",step:2},{content:"Please enter payment details",label:"Payment",step:3},{content:"Do you wish to continue?",label:"Confirmation",step:4}]),g=()=>{f.push("/ui")};return(t,s)=>{const $=h("router-link"),m=h("SshPre");return V(),C(D,{title:t.$t("ui.stepper.title"),class:"demo"},{toolbar:n(()=>[l($,{to:{name:"ui"},class:"back"},{default:n(()=>[e(i(t.$t("common.back")),1)]),_:1})]),default:n(()=>[e(),o("section",null,[o("h2",null,i(t.$t("ui.stepper.usage.basic")),1),e(),o("div",k,[l(m,{language:"html-vue"},{default:n(()=>[e(`
          <template>
