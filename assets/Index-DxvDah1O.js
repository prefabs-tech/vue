import{d as u,J as m,b as c,o as g,h as i,e as a,y as t,g as n,u as f,U as w}from"./index-CcgkNhek.js";import{_ as b}from"./ComponentDocumentation.vue_vue_type_script_setup_true_lang-3HTF-xmp.js";import{_ as y}from"./UiPage.vue_vue_type_style_index_0_lang-mZqaI-tE.js";import"./PrefabsTechVue3TanstackTable.es-CMugsYiG.js";import"./PrefabsTechVue3Form.es-CviYuyTJ.js";const v={class:"section-content"},C=u({__name:"Index",setup(h){const l=[{description:"Emitted when archive action is triggered",name:"action:archive",payload:"IFile object"},{description:"Emitted when delete action is triggered",name:"action:delete",payload:"IFile object"},{description:"Emitted when download action is triggered",name:"action:download",payload:"IFile object"},{description:"Emitted when edit description is triggered",name:"action:edit",payload:"IFile object"},{description:"Emitted when share action is triggered",name:"action:share",payload:"IFile object"},{description:"Emitted when view action is triggered",name:"action:view",payload:"IFile object"}],s=[{downloadCount:5,id:1,lastDownloadedAt:Date.now(),originalFileName:"file1.png",uploadedAt:Date.now(),uploadedBy:{givenName:"Manish",lastName:"Aryal"}},{downloadCount:5,id:2,lastDownloadedAt:Date.now(),originalFileName:"document.pdf",uploadedAt:Date.now(),uploadedBy:{givenName:"Gaurav",lastName:"Sapkota"}},{downloadCount:5,id:3,lastDownloadedAt:Date.now(),originalFileName:"photo.jpeg",uploadedAt:Date.now(),uploadedBy:{givenName:"Deepak",lastName:"Aryal"}},{downloadCount:5,id:4,lastDownloadedAt:Date.now(),originalFileName:"manish.png",uploadedAt:Date.now(),uploadedBy:{givenName:"Lamdiki",lastName:"Sherpa"}}],r=[{default:`{
      ...
      uploadedAt: true,
      uploadedBy: true
    }`,description:"Controls visibility of file details for all files",prop:"fileDetailVisibility",type:"Object"}],p=[{description:"Slot to customize thumbnail for all files",name:"thumbnail"}];return(o,e)=>{const d=m("SshPre");return g(),c(y,{subtitle:o.$t("ui.filesList.subtitle"),title:o.$t("ui.filesList.title"),class:"demo-files-list"},{default:i(()=>[a("section",null,[a("div",v,[n(f(w),{"action-buttons-visibility":{download:!0,view:!0},files:s}),e[1]||(e[1]=t()),n(d,{language:"html-vue"},{default:i(()=>[...e[0]||(e[0]=[t(`
          <template>
            <FilesList
