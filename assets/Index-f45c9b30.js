import{d as u,J as c,o as p,c as m,w as a,K as s,D as l,ao as h,W as t,f as e,L as o,ae as r}from"./index-729398ab-97e0bd19.js";import{_ as f}from"./UiPage.vue_vue_type_style_index_0_lang-e133bb3e.js";const _={class:"section-content"},g={class:"content"},C={class:"section-content"},v={class:"content"},$={class:"section-content"},b={class:"content"},z={class:"section-content"},k={class:"title"},w={class:"content"},I={class:"footer"},V=u({__name:"Index",setup(B){return(n,d)=>{const i=c("SshPre");return p(),m(f,{title:n.$t("ui.card.title"),class:"demo"},{toolbar:a(()=>[s(l(h),{label:n.$t("common.back"),"icon-left":"pi pi-chevron-left",size:"medium",variant:"textOnly",onClick:d[0]||(d[0]=L=>n.$router.push("/ui"))},null,8,["label"])]),default:a(()=>[t(),e("section",null,[e("h2",null,o(n.$t("ui.card.usage.basic")),1),t(),e("div",_,[s(l(r),null,{default:a(()=>[e("p",g,o(n.$t("ui.card.content")),1)]),_:1}),t(),s(i,{language:"html-vue"},{default:a(()=>[t(`
          <template>
            <Card>
              <p>
                ...
