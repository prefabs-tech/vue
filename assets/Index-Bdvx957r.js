import{d as E,I as H,r as d,J as M,e as C,o as g,i as r,f as t,B as i,h as a,t as b,u as s,a9 as p,q as T,a as O,F as U,y as F,b as I,H as R}from"./index-B3jtg5sl.js";import{_ as q}from"./ComponentDocumentation.vue_vue_type_script_setup_true_lang-DQVHRU-7.js";import{_ as J}from"./UiPage.vue_vue_type_style_index_0_lang-CMWzvoQ7.js";import"./PrefabsTechVue3TanstackTable.es-BOIAIETu.js";import"./PrefabsTechVue3Form.es-5Fb9V8XB.js";const j={class:"section-content"},G={class:"section-content"},Q={class:"section-content"},W={class:"section-content"},X={class:"section-content"},Y={class:"section-content"},Z={class:"tab-button-group"},x={class:"section-content"},_={class:"section-content"},ee={class:"section-content"},ie={class:"section-content"},te={class:"section-content"},be=E({__name:"Index",setup(ne){const{t:l}=H(),k=d("1"),V=d(),h=d(),f=d("1"),D=d(),y=d(!1),m=d(!1),v=d(["1"]),P=[{description:l("ui.tabView.documentation.eventDescription.beforeTabChange"),name:"beforeTabChange",payload:"key"},{description:l("ui.tabView.documentation.eventDescription.beforeTabClose"),name:"beforeTabClose",payload:"key"},{description:l("ui.tabView.documentation.eventDescription.updateActiveKey"),name:"update:activeKey",payload:"key"},{description:l("ui.tabView.documentation.eventDescription.updateVisibleTabs"),name:"update:visibleTabs",payload:"key[]"}],K=[{children:"Description",key:"tab1",label:"Description"},{children:"Reviews",key:"tab2",label:"Reviews"},{children:"Specifications",key:"tab3",label:"Specifications"},{children:"Pricing",key:"tab4",label:"Pricing"},{children:"Installation Instructions",key:"tab5",label:"Installation"},{children:"Certifications",key:"tab6",label:"Certifications"}],$=[{default:"-",description:l("ui.tabView.documentation.propsDescription.activeKey"),prop:"activeKey",type:"string"},{default:"false",description:l("ui.tabView.documentation.propsDescription.enableHashRouting"),prop:"enableHashRouting",type:"boolean"},{default:"-",description:l("ui.tabView.documentation.propsDescription.id"),prop:"id",type:"string"},{default:"false",description:l("ui.tabView.documentation.propsDescription.interceptTabChange"),prop:"interceptTabChange",type:"boolean"},{default:"false",description:l("ui.tabView.documentation.propsDescription.interceptTabClose"),prop:"interceptTabClose",type:"boolean"},{default:"true",description:l("ui.tabView.documentation.propsDescription.lazy"),prop:"lazy",type:"boolean"},{default:"true",description:l("ui.tabView.documentation.propsDescription.persistState"),prop:"persistState",type:"boolean"},{default:"localStorage",description:l("ui.tabView.documentation.propsDescription.persistStateStorage"),prop:"persistStateStorage",type:'"localStorage" | "sessionStorage"'},{default:"top",description:l("ui.tabView.documentation.propsDescription.position"),prop:"position",type:'"top" | "left" | "bottom" | "right"'},{default:"-",description:l("ui.tabView.documentation.propsDescription.tabs"),prop:"tabs",type:"Tab[]"},{default:"-",description:l("ui.tabView.documentation.propsDescription.visibleTabs"),prop:"visibleTabs",type:"string[]"}],B=[{description:l("ui.tabView.documentation.slotDescription.default"),name:"default"}],S=[{key:"description",label:"Description"},{key:"review",label:"Reviews"},{key:"specifications",label:"Specifications"},{key:"pricing",label:"Pricing"},{key:"installation",label:"Installation"},{key:"certifications",label:"Certifications"}],u=[{children:"Description",key:"1",label:"Description"},{children:"Reviews",closable:!0,key:"2",label:"Reviews"},{children:"Specifications",closable:!0,key:"3",label:"Specifications"},{children:"Pricing",closable:!0,key:"4",label:"Pricing"},{children:"Installation Instructions",key:"5",label:"Installation"},{children:"Certifications",key:"6",label:"Certifications"}],w=n=>{v.value.includes(n)||(v.value=[...v.value,n]),k.value=n},A=n=>{m.value=!0,D.value=n},z=n=>{y.value=!0,V.value=n},L=()=>{f.value=D.value||f.value,m.value=!1},N=()=>{var n;(n=h.value)==null||n.closeTab(V.value),y.value=!1};return(n,e)=>{const c=M("SshPre");return g(),C(J,{subtitle:n.$t("ui.tabView.subtitle"),title:n.$t("ui.tabView.title"),class:"tab-view"},{default:r(()=>[t("section",null,[t("h2",null,b(n.$t("ui.tabView.usage.basic")),1),e[10]||(e[10]=i()),t("div",j,[a(s(p),{id:"tab-view",tabs:u,"active-key":"1"}),e[9]||(e[9]=i()),a(c,{language:"html-vue"},{default:r(()=>e[8]||(e[8]=[i(`
          ...
          <\/script>
        `)])),_:1})])]),e[46]||(e[46]=i()),t("section",null,[t("h2",null,b(n.$t("ui.tabView.usage.disableTabState.title")),1),e[14]||(e[14]=i()),t("div",G,[t("p",null,b(n.$t("ui.tabView.usage.disableTabState.subtitle")),1),e[12]||(e[12]=i()),a(s(p),{"persist-state":!1,tabs:u,"visible-tabs":["1","5","6"],"active-key":"1"}),e[13]||(e[13]=i()),a(c,{language:"html-vue"},{default:r(()=>e[11]||(e[11]=[i(`
          <template>
            <TabView
              :persist-state="false"
              :tabs="tabs"    
          ...
          <\/script>
        `)])),_:1})])]),e[47]||(e[47]=i()),t("section",null,[t("h2",null,b(n.$t("ui.tabView.usage.positionBottom")),1),e[17]||(e[17]=i()),t("div",Q,[a(s(p),{id:"tab-view-bottom",tabs:u,"visible-tabs":["1","5","6"],"active-key":"1",position:"bottom"}),e[16]||(e[16]=i()),a(c,{language:"html-vue"},{default:r(()=>e[15]||(e[15]=[i(`
          <template>
            <TabView
              id="tab-view-bottom"
              :tabs="tabs"    
          ...
          <\/script>
        `)])),_:1})])]),e[48]||(e[48]=i()),t("section",null,[t("h2",null,b(n.$t("ui.tabView.usage.positionLeft")),1),e[20]||(e[20]=i()),t("div",W,[a(s(p),{id:"tab-view-left",tabs:u,"visible-tabs":["1","5","6"],"active-key":"1",position:"left"}),e[19]||(e[19]=i()),a(c,{language:"html-vue"},{default:r(()=>e[18]||(e[18]=[i(`
          <template>
            <TabView
              id="tab-view-left"
              :tabs="tabs"    
          ...
          <\/script>
        `)])),_:1})])]),e[49]||(e[49]=i()),t("section",null,[t("h2",null,b(n.$t("ui.tabView.usage.positionRight")),1),e[23]||(e[23]=i()),t("div",X,[a(s(p),{id:"tab-view-right",tabs:u,"visible-tabs":["1","5","6"],"active-key":"1",position:"right"}),e[22]||(e[22]=i()),a(c,{language:"html-vue"},{default:r(()=>e[21]||(e[21]=[i(`
          <template>
            <TabView
              id="tab-view-right"
              :tabs="tabs"    
          ...
          <\/script>
        `)])),_:1})])]),e[50]||(e[50]=i()),t("section",null,[t("h2",null,b(n.$t("ui.tabView.usage.closableTab")),1),e[29]||(e[29]=i()),t("div",Y,[t("div",Z,[a(s(T),{label:"Add specifications tab",onClick:e[0]||(e[0]=o=>w("3"))}),e[24]||(e[24]=i()),a(s(T),{label:"Add reviews tab",onClick:e[1]||(e[1]=o=>w("2"))}),e[25]||(e[25]=i()),a(s(T),{label:"Add pricing tab",onClick:e[2]||(e[2]=o=>w("4"))})]),e[27]||(e[27]=i()),a(s(p),{id:"tab-view-closable","active-key":k.value,"onUpdate:activeKey":e[3]||(e[3]=o=>k.value=o),"visible-tabs":v.value,"onUpdate:visibleTabs":e[4]||(e[4]=o=>v.value=o),tabs:u},null,8,["active-key","visible-tabs"]),e[28]||(e[28]=i()),a(c,{language:"html-vue"},{default:r(()=>e[26]||(e[26]=[i(`
          <template>
          ...
          <\/script>
        `)])),_:1})])]),e[51]||(e[51]=i()),t("section",null,[t("h2",null,b(n.$t("ui.tabView.usage.withSlot")),1),e[32]||(e[32]=i()),t("div",x,[a(s(p),{id:"tab-view-slot",tabs:S,"visible-tabs":["description","installation","certifications"],"active-key":"description"},{default:r(()=>[(g(),O(U,null,F(S,o=>t("p",{key:o.key},b(o.label),1)),64))]),_:1}),e[31]||(e[31]=i()),a(c,{language:"html-vue"},{default:r(()=>e[30]||(e[30]=[i(`
          <template>
            <TabView
              id="tab-view-slot"
              :tabs="tabList"    
        ...
        `)])),_:1})])]),e[52]||(e[52]=i()),t("section",null,[t("h2",null,b(n.$t("ui.tabView.usage.interceptTabChange")),1),e[36]||(e[36]=i()),t("div",_,[a(s(p),{id:"tab-view-interception","active-key":f.value,"onUpdate:activeKey":e[5]||(e[5]=o=>f.value=o),tabs:u,"visible-tabs":["1","5","6"],"intercept-tab-change":"",onBeforeTabChange:A},null,8,["active-key"]),e[34]||(e[34]=i()),m.value?(g(),C(s(R),{key:0,"onOn:close":e[6]||(e[6]=o=>m.value=!1),"onOn:confirm":L})):I("",!0),e[35]||(e[35]=i()),a(c,{language:"html-vue"},{default:r(()=>e[33]||(e[33]=[i(`
          ...
          <\/script>
        `)])),_:1})])]),e[53]||(e[53]=i()),t("section",null,[t("h2",null,b(n.$t("ui.tabView.usage.interceptTabClose")),1),e[40]||(e[40]=i()),t("div",ee,[a(s(p),{id:"tab-view-interception-close",ref_key:"dzangolabVueTabView",ref:h,tabs:u,"active-key":"1","intercept-tab-close":"",onBeforeTabClose:z},null,512),e[38]||(e[38]=i()),y.value?(g(),C(s(R),{key:0,"onOn:close":e[7]||(e[7]=o=>y.value=!1),"onOn:confirm":N})):I("",!0),e[39]||(e[39]=i()),a(c,{language:"html-vue"},{default:r(()=>e[37]||(e[37]=[i(`
          <template>
            <TabView
          ...
          <\/script>
        `)])),_:1})])]),e[54]||(e[54]=i()),t("section",null,[t("h2",null,b(n.$t("ui.tabView.usage.withHashRouting")),1),e[43]||(e[43]=i()),t("div",ie,[a(s(p),{id:"tab-view-hash-routing",tabs:K,"active-key":"tab1","enable-hash-routing":""}),e[42]||(e[42]=i()),a(c,{language:"html-vue"},{default:r(()=>e[41]||(e[41]=[i(`
          <template>
          ...
          <\/script>
        `)])),_:1})])]),e[55]||(e[55]=i()),a(q,{"events-data":P,"props-data":$,"props-table-title":n.$t("common.properties",{value:"TabViewProperties"}),"slots-data":B},null,8,["props-table-title"]),e[56]||(e[56]=i()),t("section",null,[t("h2",null,b(n.$t("common.type")),1),e[45]||(e[45]=i()),t("div",te,[a(c,{language:"html-vue"},{default:r(()=>e[44]||(e[44]=[i(`
            type Tab = {
          ...
          `)])),_:1})])])]),_:1},8,["subtitle","title"])}}});export{be as default};
