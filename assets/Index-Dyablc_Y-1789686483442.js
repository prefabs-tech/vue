import{D as e,E as t,On as n,St as r,_ as i,gn as a,k as o,mt as s,qt as c,tr as l,v as u,vn as d}from"./runtime-core.esm-bundler-BKdLzFmX-1789686483442.js";import{u as f}from"./vee-validate-CWqgYTs--1789686483442.js";import{T as p}from"./PrefabsTechVue3Layout.es-C5ax8HAu-1789686483442.js";import{t as m}from"./FormPage-DnRQ8QHm-1789686483442.js";import{b as h,c as g}from"./PrefabsTechVue3TanstackTable.es-CtHTf-Qm-1789686483442.js";import{t as _}from"./ComponentDocumentation-DZaLbJ1Z-1789686483442.js";var v={class:`section-content`},y={class:`section-content`},b={class:`section-content`},x={class:`section-content`},S={class:`section-content`},C={class:`section-content`},w={class:`section-content`},T=o({name:`NumberInputDemo`,setup(o){let{t:T}=p(),E=[{description:T(`form.documentation.eventDescription.input.modelValue`),name:`update:modelValue`,payload:`number | undefined`}],D=f.number({invalid_type_error:T(`form.errors.number.invalid`)}).gte(1,T(`form.errors.number.invalid`)).lte(100,T(`form.errors.number.invalid`)),O=[{default:`false`,description:T(`form.documentation.propsDescription.input.disabled`),prop:`disabled`,type:`Boolean`},{default:`{ required: "The field is required", invalid: "Please provide a valid integer field" }`,description:T(`form.documentation.propsDescription.input.errorMessages`),prop:`errorMessages`,type:`NumberErrorMessages`},{default:`-`,description:T(`form.documentation.propsDescription.input.label`),prop:`label`,type:`String`},{default:`undefined`,description:T(`form.documentation.propsDescription.input.modelValue`),prop:`modelValue`,type:`number | null | undefined`},{default:`"number"`,description:T(`form.documentation.propsDescription.input.name`),prop:`name`,type:`String`},{default:`-`,description:T(`form.documentation.propsDescription.input.options`),prop:`options`,type:`IsIntOptions`},{default:`-`,description:T(`form.documentation.propsDescription.input.placeholder`),prop:`placeholder`,type:`String`},{default:`-`,description:T(`form.documentation.propsDescription.input.schema`),prop:`schema`,type:`z.ZodType<string | number>`}],k={invalid:T(`form.errors.number.invalid`),required:T(`form.errors.number.required`)},A={allow_leading_zeroes:!1,max:100,min:1},j=a({customValidationInput:d(),disabled:d(100),i18nInput:d(),input:d(),inputWithValidation:d(),noLabelInput:d(),textInput:d()});return(a,o)=>{let d=r(`SshPre`);return s(),u(m,{subtitle:n(T)(`form.subtitle.number`),title:a.$t(`form.label.number`),class:`demo`},{default:c(()=>[i(`section`,null,[i(`h2`,null,l(a.$t(`form.label.basicInput`)),1),o[9]||=t(),i(`div`,v,[e(n(h),{modelValue:n(j).noLabelInput,"onUpdate:modelValue":o[0]||=e=>n(j).noLabelInput=e,placeholder:a.$t(`form.placeholder.number`)},null,8,[`modelValue`,`placeholder`]),o[8]||=t(),e(d,{language:`html-vue`},{default:c(()=>[...o[7]||=[t(`
          <template>
            <NumberInput 
              v-model="input"
        ...
        `,-1)]]),_:1})])]),o[29]||=t(),i(`section`,null,[i(`h2`,null,l(a.$t(`form.label.labelInput`)),1),o[12]||=t(),i(`div`,y,[e(n(h),{modelValue:n(j).input,"onUpdate:modelValue":o[1]||=e=>n(j).input=e,label:a.$t(`form.label.number`),placeholder:a.$t(`form.placeholder.number`),name:`label-input`},null,8,[`modelValue`,`label`,`placeholder`]),o[11]||=t(),e(d,{language:`html-vue`},{default:c(()=>[...o[10]||=[t(`
          ...
          import { NumberInput } from "@prefabs.tech/vue3-form";
          <\/script>
        `,-1)]]),_:1})])]),o[30]||=t(),i(`section`,null,[i(`h2`,null,l(a.$t(`form.label.disabled`)),1),o[15]||=t(),i(`div`,b,[e(n(h),{modelValue:n(j).disabled,"onUpdate:modelValue":o[2]||=e=>n(j).disabled=e,label:a.$t(`form.label.number`),disabled:``,name:`disabled-input`},null,8,[`modelValue`,`label`]),o[14]||=t(),e(d,{language:`html-vue`},{default:c(()=>[...o[13]||=[t(`
          <template>
            <NumberInput 
              v-model="input"
              disabled
