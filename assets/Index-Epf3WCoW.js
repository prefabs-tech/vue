import{b as d,C as b}from"./PrefabsTechVue3Form.es-CvBW0pAr.js";import{d as $,I as x,M as y,N as D,r as m,L as w,e as F,o as C,j as s,C as t,f as o,h as r,t as f,u as n,v as E}from"./index-Bs8kt_YR.js";import{_ as h}from"./ComponentDocumentation.vue_vue_type_script_setup_true_lang-DepqjIJY.js";import{_ as q}from"./FormPage.vue_vue_type_style_index_0_lang-BTBPoM6O.js";import"./PrefabsTechVue3TanstackTable.es-BWy_mAUE.js";const M={class:"section-content"},S={class:"section-content"},U={class:"section-content"},O={class:"section-content"},z={class:"section-content"},k={class:"section-content"},B={class:"section-content"},L={class:"section-content"},N={name:"TextareaInputField"},G=$({...N,setup(P){const{t:p}=x(),g=[{description:p("form.documentation.eventDescription.input.modelValue"),name:"update:modelValue",payload:"string | number | string[] | undefined"}],I=y.string().min(15,{message:p("form.errors.input.min",{length:15})}),V=[{default:"-",description:p("form.documentation.propsDescription.textarea.cols"),prop:"cols",type:"number | undefined"},{default:"false",description:p("form.documentation.propsDescription.input.disabled"),prop:"disabled",type:"Boolean"},{default:'{ required: "The field is required", invalid: "Please provide a valid input data" }',description:p("form.documentation.propsDescription.input.errorMessages"),prop:"errorMessages",type:"TextErrorMessages"},{default:"-",description:p("form.documentation.propsDescription.input.label"),prop:"label",type:"String"},{default:"-",description:p("form.documentation.propsDescription.input.modelValue"),prop:"modelValue",type:"string | number | string[] | undefined"},{default:'"text"',description:p("form.documentation.propsDescription.input.name"),prop:"name",type:"String"},{default:"-",description:p("form.documentation.propsDescription.input.options"),prop:"options",type:"IsTextOptions"},{default:"-",description:p("form.documentation.propsDescription.input.placeholder"),prop:"placeholder",type:"String"},{default:"-",description:p("form.documentation.propsDescription.textarea.rows"),prop:"rows",type:"number | undefined"},{default:"-",description:p("form.documentation.propsDescription.input.schema"),prop:"schema",type:"z.ZodType<string | number>"}],T={required:p("form.errors.input.required")},v={ignore_whitespace:!0,required:!0};let a=D({customRowsColsInput:m(),customValidationInput:m(),disabled:m("Disabled textarea input"),i18nInput:m(),input:m(),inputWithValidation:m(),noLabelInput:m(),textInput:m()});return(l,e)=>{const u=w("SshPre");return C(),F(q,{subtitle:n(p)("form.subtitle.textarea"),title:l.$t("form.label.textarea"),class:"demo"},{toolbar:s(()=>[r(n(E),{label:l.$t("common.back"),"icon-left":"pi pi-chevron-left",size:"medium",variant:"textOnly",onClick:e[0]||(e[0]=i=>l.$router.push("/form"))},null,8,["label"])]),default:s(()=>[e[34]||(e[34]=t()),o("section",null,[o("h2",null,f(l.$t("form.label.basicInput")),1),e[11]||(e[11]=t()),o("div",M,[r(n(d),{modelValue:n(a).noLabelInput,"onUpdate:modelValue":e[1]||(e[1]=i=>n(a).noLabelInput=i),placeholder:l.$t("form.placeholder.input")},null,8,["modelValue","placeholder"]),e[10]||(e[10]=t()),r(u,{language:"html-vue"},{default:s(()=>e[9]||(e[9]=[t(`
        ...
        `)])),_:1})])]),e[42]||(e[42]=t()),r(h,{"events-data":g,"props-data":V,"props-table-title":l.$t("common.properties",{value:"TextareaInputProperties"})},null,8,["props-table-title"]),e[43]||(e[43]=t()),r(u,{language:"html-vue"},{default:s(()=>e[33]||(e[33]=[t(`
