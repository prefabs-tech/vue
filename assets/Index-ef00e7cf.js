import{d as V,u as N,b as _,e as i,o as $,c as y,w as s,a as r,t as d,f as n,g as t,h as e,r as g}from"./index-b83a8589.js";import{m as z,Q as p,z as f}from"./DzangolabVue3Form.es-a01771a8.js";const E={class:"demo-section"},F={class:"demo-section"},S={class:"demo-section"},O={class:"demo-section"},w={class:"demo-section"},U={class:"demo-section"},M={class:"demo-section"},P={name:"NumberInputField"},C=V({...P,setup(q){const{t:b}=N(),v=z.coerce.number({invalid_type_error:b("form.errors.number.invalid")}).gte(1,b("form.errors.number.invalid")).lte(100,b("form.errors.number.invalid")),h={invalid:b("form.errors.number.invalid"),required:b("form.errors.number.required")},c={min:1,max:100,allow_leading_zeroes:!1};let o=_({customStyleInput:i(),customValidationInput:i(),disabled:i(100),input:i(),inputWithValidation:i(),noLabelInput:i(),textInput:i()});return(l,a)=>{const u=g("SshPre"),I=g("Page");return $(),y(I,{title:l.$t("form.label.number")},{default:s(()=>[r("section",E,[r("h3",null,d(l.$t("form.label.basicInput")),1),n(),t(u,{language:"html-vue"},{default:s(()=>[n(`
        <template>
          <NumberInput 
            v-model="input"
