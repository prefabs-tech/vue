import{A as d,$ as I}from"./PrefabsTechVue3Form.es-DkZwwYlu.js";import{d as k,E as $,I as h,L as O,r as m,H as R,e as z,o as B,j as u,B as n,f as t,t as b,h as a,u as l,v as g}from"./index-7DYOETMS.js";import{_ as S}from"./FormPage.vue_vue_type_style_index_0_lang-CvhChv8p.js";const C={class:"section-content"},F={class:"section-content"},c={class:"section-content"},U={class:"section-content"},W={name:"RadioInput"},w=k({...W,setup(q){const{t:s}=$(),V=h.string({required_error:s("form.errors.radio.required")});let i=O({disabled:m("car"),i18nInput:m(),input:m(),inputWithValidation:m(),noLabelInput:m()});const f=[{label:s("form.label.male"),value:"male"},{label:s("form.label.female"),value:"female"}],v=[{label:s("form.label.bike"),value:"bike"},{label:s("form.label.car"),value:"car"},{label:s("form.label.truck"),value:"truck"}];return(o,e)=>{const p=R("SshPre");return B(),z(S,{title:o.$t("form.label.radio"),class:"demo"},{toolbar:u(()=>[a(l(g),{label:o.$t("common.back"),"icon-left":"pi pi-chevron-left",size:"medium",variant:"textOnly",onClick:e[0]||(e[0]=r=>o.$router.push("/form"))},null,8,["label"])]),default:u(()=>[e[18]||(e[18]=n()),t("section",null,[t("h2",null,b(o.$t("form.label.basicInput")),1),e[7]||(e[7]=n()),t("div",C,[a(l(d),{modelValue:l(i).input,"onUpdate:modelValue":e[1]||(e[1]=r=>l(i).input=r),label:o.$t("form.label.gender"),options:f,direction:"horizontal",name:"label-input"},null,8,["modelValue","label"]),e[6]||(e[6]=n()),a(p,{language:"html-vue"},{default:u(()=>e[5]||(e[5]=[n(`
          <template>
            <RadioInput
              v-model="input"
