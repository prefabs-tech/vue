import{f as d,_ as g}from"./DzangolabVue3Form.es-k-Xjvcvt.js";import{d as P,H as $,A as y,s as B,j as C,o as S,w as l,B as e,e as o,t as i,g as n,u as s,I as c,C as V}from"./index-CqimUq5D.js";import{_ as D}from"./UiPage.vue_vue_type_style_index_0_lang-BhMX9ucW.js";const I={class:"section-content"},w={class:"section-content"},N={class:"section-content"},x=P({__name:"Index",setup(k){const b=$(),p=y({name:null,phone:null,price:"$50"}),h={iconRight:"pi pi-chevron-right",label:"Next",severity:"primary",variant:"filled"},f={iconLeft:"pi pi-chevron-left",label:"Back",severity:"secondary",variant:"filled"},u=[{content:"Please enter personal details",label:"Personal",step:1},{content:"Please enter contact details",label:"Contact",step:2},{content:"Please enter payment details",label:"Payment",step:3},{content:"Do you wish to continue?",label:"Confirmation",step:4}],v=()=>{b.push("/ui")};return(t,a)=>{const m=B("SshPre");return S(),C(D,{title:t.$t("ui.stepper.title"),class:"demo"},{toolbar:l(()=>[n(s(V),{label:t.$t("common.back"),"icon-left":"pi pi-chevron-left",size:"medium",variant:"textOnly",onClick:a[0]||(a[0]=r=>t.$router.push("/ui"))},null,8,["label"])]),default:l(()=>[e(),o("section",null,[o("h2",null,i(t.$t("ui.stepper.usage.basic")),1),e(),o("div",I,[n(s(c),{steps:u,onComplete:v}),e(),n(m,{language:"html-vue"},{default:l(()=>[e(`
          <template>
