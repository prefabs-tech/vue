import{t as h,G as S}from"./DzangolabVue3Form.es-35a331c6.js";import{d as V,b as B,e as m,r as d,o as C,c as _,w as n,g as o,f as e,t as i,a as l,h as p,ad as b,ae as D}from"./index-146b4921.js";const k={class:"section-content"},I={class:"section-content"},w={class:"section-content"},R=V({__name:"Index",setup(N){const f=D(),a=B({name:null,phone:null,price:"$50"}),v=m({iconRight:"pi pi-chevron-right",label:"Next",severity:"primary",variant:"filled"}),g=m({iconLeft:"pi pi-chevron-left",label:"Back",severity:"secondary",variant:"filled"}),u=m([{content:"Please enter personal details",label:"Personal",step:1},{content:"Please enter contact details",label:"Contact",step:2},{content:"Please enter payment details",label:"Payment",step:3},{content:"Do you wish to continue?",label:"Confirmation",step:4}]),P=()=>{f.push("/ui")};return(t,s)=>{const y=d("router-link"),c=d("SshPre"),$=d("Page");return C(),_($,{title:t.$t("ui.stepper.title"),class:"demo"},{toolbar:n(()=>[o(y,{to:{name:"ui"},class:"back"},{default:n(()=>[e(i(t.$t("common.back")),1)]),_:1})]),default:n(()=>[e(),l("section",null,[l("h2",null,i(t.$t("ui.stepper.usage.basic")),1),e(),l("div",k,[o(c,{language:"html-vue"},{default:n(()=>[e(`
          <template>
        ...
        `)]),_:1}),e(),o(p(b),{steps:u.value,onComplete:P},null,8,["steps"])])]),e(),l("section",null,[l("h2",null,i(t.$t("ui.stepper.usage.buttonProperties")),1),e(),l("div",I,[o(c,{language:"html-vue"},{default:n(()=>[e(`
          ...
          <\/script>
        `)]),_:1}),e(),o(p(b),{"next-button-properties":v.value,"previous-button-properties":g.value,steps:u.value},null,8,["next-button-properties","previous-button-properties","steps"])])]),e(),l("section",null,[l("h2",null,i(t.$t("ui.stepper.usage.withSlot")),1),e(),l("div",w,[o(c,{language:"html-vue"},{default:n(()=>[e(`
          <template>
            <Stepper :steps="steps">
