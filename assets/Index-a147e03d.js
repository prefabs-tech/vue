import{d as _,u as b,e as u,r,o as c,c as f,w as a,g as l,f as e,t as o,a as n,h,ac as L,D as k,E as y}from"./index-9530d6e2.js";const S={class:"section-content"},D={key:0,class:"most-favourite"},C=_({__name:"Index",setup(B){const{t:s}=b(),d=u([{id:1,data:s("ui.sortableList.games.basketball")},{id:2,data:s("ui.sortableList.games.cricket")},{id:3,data:s("ui.sortableList.games.football")},{id:4,data:s("ui.sortableList.games.hockey")},{id:5,data:s("ui.sortableList.games.volleyball")}]),i=u(),m=t=>{i.value=t[0].data};return(t,F)=>{const v=r("router-link"),g=r("SshPre"),p=r("Page");return c(),f(p,{title:t.$t("ui.sortableList.title"),class:"demo-sortable-list"},{toolbar:a(()=>[l(v,{to:{name:"ui"},class:"back"},{default:a(()=>[e(o(t.$t("common.back")),1)]),_:1})]),default:a(()=>[e(),n("section",null,[n("h2",null,o(t.$t("ui.sortableList.usage.basic")),1),e(),n("div",S,[l(g,{language:"html-vue"},{default:a(()=>[e(`
          <template>
