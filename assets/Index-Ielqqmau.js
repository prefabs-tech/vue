import{w as y,g as S,D as V,k as A}from"./PrefabsTechVue3Form.es-DZTCjbbV.js";import{d as F,I,M as N,r as u,J as B,e as J,o as h,i,f as n,B as o,h as t,t as d,u as a,q as m,a5 as p,a as T,F as U,y as q}from"./index-BPTdnMQV.js";import{_ as j}from"./ComponentDocumentation.vue_vue_type_script_setup_true_lang-DtuMFFjT.js";import{_ as G}from"./UiPage.vue_vue_type_style_index_0_lang-CmL74Pur.js";import"./PrefabsTechVue3TanstackTable.es-CmAD8rqL.js";const H={class:"section-content"},K={class:"container"},Q={class:"section-content"},R={class:"container"},W={class:"label"},X={class:"value"},Y={class:"section-content"},Z={class:"container"},c={class:"section-content"},x={class:"container"},_={class:"section-content"},ll={class:"container"},ol={role:"heading"},dl=F({__name:"Index",setup(el){const{t:r}=I(),E=[{description:r("ui.modal.documentation.eventDescription.close"),name:"on:close",payload:"-"}],C=[{label:"Name",value:"Acer Nitro 5"},{label:"Category",value:"Laptop"},{label:"Color",value:"Black"}],L=[{default:"false",description:r("ui.modal.documentation.propsDescription.dismissOnClickOut"),prop:"dismissOnClickOut",type:"Boolean"},{default:"false",description:r("ui.modal.documentation.propsDescription.show"),prop:"show",type:"Boolean"},{default:"medium",description:r("ui.modal.documentation.propsDescription.size"),prop:"size",type:'"medium" | "large" | "auto"'},{default:"-",description:r("ui.modal.documentation.propsDescription.title"),prop:"title",type:"String"}],z=[{description:r("ui.modal.documentation.slotDescription.default"),name:"default"},{description:r("ui.modal.documentation.slotDescription.footer"),name:"footer"},{description:r("ui.modal.documentation.slotDescription.header"),name:"header"}],w=N({email:u(),password:u()}),b=u(!1),M=u(!1),g=u(!1),$=u(!1),D=u(!1),v=u(!1),k=u(!1);return(e,l)=>{const f=B("SshPre"),P=B("router-link");return h(),J(G,{subtitle:e.$t("ui.modal.subtitle"),title:e.$t("ui.modal.title"),class:"demo-modal"},{default:i(()=>[n("section",null,[n("h2",null,d(e.$t("ui.modal.usage.basic")),1),l[20]||(l[20]=o()),n("div",H,[n("div",K,[t(a(m),{label:e.$t("ui.modal.label.show"),onClick:l[0]||(l[0]=s=>k.value=!0)},null,8,["label"])]),l[18]||(l[18]=o()),t(a(p),{show:k.value,title:e.$t("ui.modal.header.productDetail"),"onOn:close":l[1]||(l[1]=s=>k.value=!1)},{default:i(()=>[o(d(e.$t("ui.modal.content")),1)]),_:1},8,["show","title"]),l[19]||(l[19]=o()),t(f,{language:"html-vue"},{default:i(()=>l[17]||(l[17]=[o(`
          <template>
            <ButtonElement
              label="Show"
