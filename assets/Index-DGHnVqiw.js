import{$ as y,M as P,C as V,O as z}from"./DzangolabVue3Form.es-Q4CvOA23.js";import{d as F,M as L,r as d,J as $,e as S,o as k,i as s,D as o,f as a,g as t,t as r,u as i,v as u,a7 as p,a as I,F as N,z as T}from"./index-BLLu7sZz.js";import{_ as A}from"./ComponentDocumentation.vue_vue_type_script_setup_true_lang-BHGsT5Km.js";import{_ as J}from"./UiPage.vue_vue_type_style_index_0_lang-CTdadv5J.js";import"./DzangolabVue3TanstackTable.es-By0FH77m.js";const U={class:"section-content"},q={class:"section-content"},j={class:"section-content"},G={class:"label"},H={class:"value"},K={class:"section-content"},Q={class:"section-content"},R={role:"heading"},_=F({__name:"Index",setup(W){const D=[{description:"Emitted when the modal is requested to close (via close icon or outside click).",name:"on:close",payload:"-"}],C=[{label:"Name",value:"Acer Nitro 5"},{label:"Category",value:"Laptop"},{label:"Color",value:"Black"}],h=[{default:"true",description:"Closes the modal when clicking outside the modal content.",prop:"dismissOnClickOut",type:"Boolean"},{default:"false",description:"Controls the visibility of the modal.",prop:"show",type:"Boolean"},{default:"-",description:"Title for the modal. Override by `header` slot if provided.",prop:"title",type:"String"}],B=[{description:"Main content of the modal body.",name:"default"},{description:"Footer section of the modal. Placed below the content.",name:"footer"},{description:"Custom header content. Overrides `title` if provided.",name:"header"}],f=L({email:d(),password:d()}),w=d(!1),b=d(!1),g=d(!1),v=d(!1),M=d(!1);return(e,l)=>{const m=$("SshPre"),E=$("router-link");return k(),S(J,{"sub-title":e.$t("ui.modal.subtitle"),title:e.$t("ui.modal.title"),class:"demo"},{toolbar:s(()=>[t(i(u),{label:e.$t("common.back"),"icon-left":"pi pi-chevron-left",size:"medium",variant:"textOnly",onClick:l[0]||(l[0]=n=>e.$router.push("/ui"))},null,8,["label"])]),default:s(()=>[l[39]||(l[39]=o()),a("section",null,[a("h2",null,r(e.$t("ui.modal.usage.basic")),1),l[17]||(l[17]=o()),a("div",U,[t(i(u),{label:e.$t("ui.modal.label.open"),onClick:l[1]||(l[1]=n=>g.value=!0)},null,8,["label"]),l[15]||(l[15]=o()),t(i(p),{show:g.value,"onOn:close":l[2]||(l[2]=n=>g.value=!1)},{default:s(()=>[o(r(e.$t("ui.modal.content")),1)]),_:1},8,["show"]),l[16]||(l[16]=o()),t(m,{language:"html-vue"},{default:s(()=>l[14]||(l[14]=[o(`
          <template>
            <ButtonElement
              label="Open"
