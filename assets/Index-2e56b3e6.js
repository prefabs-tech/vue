import{m as w,n as d,Z as p}from"./DzangolabVue3Form.es-264401b9.js";import{d as V,u as I,b as S,e as c,r as f,o as _,c as $,w as a,f as l,g as e,t as r,a as t,h as n}from"./index-a50c4f8e.js";const F={class:"section-content"},z={class:"section-content"},k={class:"section-content"},U={class:"section-content"},P={class:"section-content"},W={name:"SwitchInput"},L=V({...W,setup(B){const{t:b}=I(),h=w.coerce.boolean().refine(o=>o===!0,{message:b("form.errors.switch.invalid")});let s=S({disabled:c(!0),input:c(),inputWithValidation:c(!1),noLabelInput:c()});return(o,u)=>{const v=f("router-link"),m=f("SshPre"),g=f("Page");return _(),$(g,{title:o.$t("form.label.switch"),class:"demo"},{toolbar:a(()=>[l(v,{to:{name:"form"},class:"back"},{default:a(()=>[e(r(o.$t("common.back")),1)]),_:1})]),default:a(()=>[e(),t("section",null,[t("h2",null,r(o.$t("form.label.basicInput")),1),e(),t("div",F,[l(m,{language:"html-vue"},{default:a(()=>[e(`
          <Form>
            <SwitchInput
              v-model="input"
            />
