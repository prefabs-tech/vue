import{m as v,U as p,Q as d}from"./DzangolabVue3Form.es-d92eeb15.js";import{d as I,u as V,b as y,e as c,r as f,o as _,c as $,w as a,a as n,t as i,f as l,g as t,h as e}from"./index-fdd64217.js";const F={class:"section-content"},w={class:"section-content"},z={class:"section-content"},U={class:"section-content"},S={class:"section-content"},E={class:"section-content"},P={class:"section-content"},T={name:"InputField"},C=I({...T,setup(W){const{t:b}=V(),h=v.string().min(3,{message:b("form.errors.input.min",{length:3})});let u=y({disabled:c("monorepo@gmail.com"),input:c(),inputWithValidation:c(),noLabelInput:c(),numberInput:c(),passwordInput:c()});return(o,s)=>{const m=f("SshPre"),g=f("Page");return _(),$(g,{title:o.$t("form.label.input"),class:"demo"},{default:a(()=>[n("section",null,[n("h2",null,i(o.$t("form.label.basicInput")),1),l(),n("div",F,[t(m,{language:"html-vue"},{default:a(()=>[l(`
          <Form>
            <Input 
              v-model="username"
