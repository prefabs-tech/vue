import{d as u,G as c,o as p,c as m,w as a,K as s,C as t,S as o,f as e,D as i,ap as r}from"./index-d658739c-0fec2303.js";import{_ as h}from"./UiPage.vue_vue_type_style_index_0_lang-88ffecad.js";const _={class:"section-content"},f={class:"content"},g={class:"section-content"},C={class:"content"},v={class:"section-content"},$={class:"content"},b={class:"section-content"},k={class:"title"},z={class:"content"},w={class:"footer"},V=u({__name:"Index",setup(I){return(n,S)=>{const d=c("router-link"),l=c("SshPre");return p(),m(h,{title:n.$t("ui.card.title"),class:"demo"},{toolbar:a(()=>[s(d,{to:{name:"ui"},class:"back"},{default:a(()=>[t(o(n.$t("common.back")),1)]),_:1})]),default:a(()=>[t(),e("section",null,[e("h2",null,o(n.$t("ui.card.usage.basic")),1),t(),e("div",_,[s(l,{language:"html-vue"},{default:a(()=>[t(`
          <template>
            <Card>
              <p>
                ...
