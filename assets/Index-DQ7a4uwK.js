import{B as r}from"./DzangolabVue3Form.es-Dyrme8oV.js";import{d as a,K as u,f as d,o as f,i as s,D as t,g as n,t as m,h as o,u as i,v as g}from"./index-CyAY2HLe.js";import{_ as b}from"./FormPage.vue_vue_type_style_index_0_lang-CdoGm4Lm.js";const v={class:"section-content"},z={class:"section-content"},F={class:"section-content"},I={class:"section-content"},$={class:"section-content"},w={class:"section-content"},C={name:"FileInputDemo"},D=a({...C,setup(S){return(l,e)=>{const p=u("SshPre");return f(),d(b,{title:l.$t("form.label.fileInput"),class:"demo"},{toolbar:s(()=>[o(i(g),{label:l.$t("common.back"),"icon-left":"pi pi-chevron-left",size:"medium",variant:"textOnly",onClick:e[0]||(e[0]=B=>l.$router.push("/form"))},null,8,["label"])]),default:s(()=>[e[19]||(e[19]=t()),n("section",null,[n("h2",null,m(l.$t("form.label.basicInput")),1),e[3]||(e[3]=t()),n("div",v,[o(i(r)),e[2]||(e[2]=t()),o(p,{language:"html-vue"},{default:s(()=>e[1]||(e[1]=[t(`
          <template>
            <FileInput />
          </template>
