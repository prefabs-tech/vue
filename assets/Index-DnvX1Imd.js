import{E as b,S as B}from"./PrefabsTechVue3Form.es-DJ5_BaFE.js";import{d as S,I as D,S as C,M as V,J as I,e as N,o as k,j as s,C as t,f as p,h as o,t as m,u as l,T as c,v as w}from"./index-D08y5JVx.js";import{_ as R}from"./ComponentDocumentation.vue_vue_type_script_setup_true_lang-B5R-fh0E.js";import{_ as T}from"./UiPage.vue_vue_type_style_index_0_lang-B02jOlJm.js";import"./PrefabsTechVue3TanstackTable.es-BiNoLSD8.js";const x={class:"section-content"},A={class:"section-content"},F={class:"section-content"},M=S({__name:"Index",setup(L){const{t:a}=D(),f=C(),r=V({name:null,phone:null,price:"$50"}),v=[{description:a("ui.stepper.documentation.eventDescription.complete"),name:"complete",payload:"-"}],P={iconRight:"pi pi-chevron-right",label:"Next",severity:"primary",variant:"filled"},g={iconLeft:"pi pi-chevron-left",label:"Back",severity:"secondary",variant:"filled"},h=[{default:"-",description:a("ui.stepper.documentation.propsDescription.nextButton"),prop:"nextButtonProperties",type:"ActionButtonProperties"},{default:"-",description:a("ui.stepper.documentation.propsDescription.PreviousButton"),prop:"previousButtonProperties",type:"ActionButtonProperties"},{default:"-",description:a("ui.stepper.documentation.propsDescription.steps"),prop:"steps",type:"Array<StepProperties>"}],y=[{description:a("ui.stepper.documentation.slotDescription.step"),name:"{step}"}],d=[{content:"Please enter personal details",label:"Personal",step:1},{content:"Please enter contact details",label:"Contact",step:2},{content:"Please enter payment details",label:"Payment",step:3},{content:"Do you wish to continue?",label:"Confirmation",step:4}],$=()=>{f.push("/ui")};return(n,e)=>{const u=I("SshPre");return k(),N(T,{"sub-title":n.$t("ui.stepper.subtitle"),title:n.$t("ui.stepper.title"),class:"demo-stepper"},{toolbar:s(()=>[o(l(w),{label:n.$t("common.back"),"icon-left":"pi pi-chevron-left",size:"medium",variant:"textOnly",onClick:e[0]||(e[0]=i=>n.$router.push("/ui"))},null,8,["label"])]),default:s(()=>[e[17]||(e[17]=t()),p("section",null,[p("h2",null,m(n.$t("ui.stepper.usage.basic")),1),e[6]||(e[6]=t()),p("div",x,[o(l(c),{steps:d,onComplete:$}),e[5]||(e[5]=t()),o(u,{language:"html-vue"},{default:s(()=>e[4]||(e[4]=[t(`
          <template>
        ...
        `)])),_:1})])]),e[19]||(e[19]=t()),p("section",null,[p("h2",null,m(n.$t("ui.stepper.usage.withSlot")),1),e[15]||(e[15]=t()),p("div",F,[o(l(c),{steps:d},{1:s(()=>[o(l(b),{modelValue:r.name,"onUpdate:modelValue":e[1]||(e[1]=i=>r.name=i),label:n.$t("ui.stepper.label.name"),placeholder:n.$t("ui.stepper.placeholder.name"),name:"name"},null,8,["modelValue","label","placeholder"])]),2:s(()=>[o(l(B),{modelValue:r.phone,"onUpdate:modelValue":e[2]||(e[2]=i=>r.phone=i),label:n.$t("ui.stepper.label.phone"),placeholder:n.$t("ui.stepper.placeholder.phone"),name:"phone"},null,8,["modelValue","label","placeholder"])]),3:s(()=>[o(l(b),{modelValue:r.price,"onUpdate:modelValue":e[3]||(e[3]=i=>r.price=i),label:n.$t("ui.stepper.label.price"),disabled:"",name:"price"},null,8,["modelValue","label"])]),4:s(()=>[t(m(n.$t("ui.stepper.usage.complete")),1)]),_:1}),e[14]||(e[14]=t()),o(u,{language:"html-vue"},{default:s(()=>e[13]||(e[13]=[t(`
          ...
          <\/script>
        `)])),_:1})])]),e[20]||(e[20]=t()),o(R,{"events-data":v,"props-data":h,"props-table-title":n.$t("common.properties",{value:"StepperProperties"}),"slots-data":y},null,8,["props-table-title"]),e[21]||(e[21]=t()),o(u,{language:"html-vue"},{default:s(()=>e[16]||(e[16]=[t(`
    ...
    `)])),_:1})]),_:1},8,["sub-title","title"])}}});export{M as default};
