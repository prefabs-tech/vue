import{V as m,E as v}from"./PrefabsTechVue3Form.es-BoUjuj1d.js";import{d as w,I as V,L as I,M as g,r as d,J as S,e as $,o as h,i as u,f as n,B as t,t as p,h as s,u as e}from"./index-DpADEPPw.js";import{_ as L}from"./FormPage.vue_vue_type_style_index_0_lang-CsFxIGFH.js";const F={class:"section-content"},U={class:"section-content"},y={class:"section-content"},O={class:"section-content"},B={class:"section-content"},N={class:"section-content"},W={name:"SwitchInput"},E=w({...W,setup(k){const{t:f}=V(),b=I.coerce.boolean().refine(o=>o===!0,{message:f("form.errors.switch.invalid")});let i=g({disabled:d(!0),input:d(),inputWithValidation:d(!1),noLabelInput:d(),onOffLabel:d()});return(o,l)=>{const r=S("SshPre");return h(),$(L,{title:o.$t("form.label.switch"),class:"demo"},{default:u(()=>[n("section",null,[n("h2",null,p(o.$t("form.label.basicInput")),1),l[8]||(l[8]=t()),n("div",F,[s(e(m),{modelValue:e(i).noLabelInput,"onUpdate:modelValue":l[0]||(l[0]=a=>e(i).noLabelInput=a)},null,8,["modelValue"]),l[7]||(l[7]=t()),s(r,{language:"html-vue"},{default:u(()=>l[6]||(l[6]=[t(`
          <template>
