import{m as k,j as d,Q as u}from"./DzangolabVue3Form.es-9f2a8a40.js";import{d as V,u as P,b as y,e as c,r as b,o as F,c as $,w as l,a as t,t as p,f as n,g as a,h as e}from"./index-d32261a6.js";const _={class:"section-content"},z={class:"section-content"},w={class:"section-content"},B={class:"section-content"},U={class:"section-content"},I={class:"section-content"},M={class:"section-content"},O={class:"section-content"},A={class:"section-content"},R={class:"section-content"},Y={class:"section-content"},j={class:"section-content"},S={class:"section-content"},C={class:"section-content"},T={class:"section-content"},L={name:"DatePickerInput"},J=V({...L,setup(N){const{t:g}=P(),v=k.coerce.date().max(new Date,{message:g("form.errors.datePicker.invalid")}),f=new Date,D=f;let o=y({appointmentDate:c(f),arrivalDate:c(),availableDatetime:c([f,new Date(D.setDate(D.getDate()+7))]),dateOfBirth:c(f),dateRange:c([f,new Date(D.setDate(D.getDate()+7))]),joinedDate:c(),month:c(),monthAndYear:c(),noLabelInput:c(),pickupDate:c(),presentationDate:c(f),reportDate:c([f,new Date(D.setDate(D.getDate()+7))]),time:c(),year:c(f.getFullYear())});return(r,m)=>{const s=b("SshPre"),h=b("Page");return F(),$(h,{title:r.$t("form.label.datePicker"),class:"demo"},{default:l(()=>[t("section",null,[t("h2",null,p(r.$t("form.label.basicInput")),1),n(),t("div",_,[a(s,{language:"html-vue"},{default:l(()=>[n(`
        ...
        `)]),_:1}),n(),a(e(u),null,{default:l(()=>[a(e(d),{modelValue:e(o).month,"onUpdate:modelValue":m[9]||(m[9]=i=>e(o).month=i),format:"MMM",label:r.$t("form.label.month"),"month-picker":""},null,8,["modelValue","label"])]),_:1})])]),n(),t("section",null,[t("h2",null,p(r.$t("form.label.monthAndYearPicker")),1),n(),t("div",Y,[a(s,{language:"html-vue"},{default:l(()=>[n(`
          ...
          <\/script>
        `)]),_:1}),n(),a(e(u),null,{default:l(()=>[a(e(d),{modelValue:e(o).month,"onUpdate:modelValue":m[10]||(m[10]=i=>e(o).month=i),label:r.$t("form.label.monthAndYear"),"month-picker":""},null,8,["modelValue","label"])]),_:1})])]),n(),t("section",null,[t("h2",null,p(r.$t("form.label.yearPicker")),1),n(),t("div",j,[a(s,{language:"html-vue"},{default:l(()=>[n(`
          <Form>
            <DatePicker 
              v-model="year"
              label="Year"
          ...
          <\/script>
        `)]),_:1}),n(),a(e(u),null,{default:l(()=>[a(e(d),{modelValue:e(o).year,"onUpdate:modelValue":m[11]||(m[11]=i=>e(o).year=i),label:r.$t("form.label.year"),"year-picker":""},null,8,["modelValue","label"])]),_:1})])]),n(),t("section",null,[t("h2",null,p(r.$t("form.label.timePicker")),1),n(),t("div",S,[a(s,{language:"html-vue"},{default:l(()=>[n(`
          <Form>
            <DatePicker 
