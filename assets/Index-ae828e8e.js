import{m as _,l as d,Z as m}from"./DzangolabVue3Form.es-8d7c7642.js";import{d as $,u as x,b as T,e as c,r as f,o as F,c as y,w as o,f as t,g as e,t as i,a,h as n}from"./index-17339f3a.js";const w={class:"section-content"},z={class:"section-content"},S={class:"section-content"},U={class:"section-content"},E={class:"section-content"},C={class:"section-content"},k={class:"section-content"},q={class:"section-content"},O={class:"section-content"},D={name:"TextareaInputField"},W=$({...D,setup(M){const{t:b}=x(),g=_.string().min(15,{message:b("form.errors.input.min",{length:15})}),v={required:b("form.errors.input.required")},h={ignore_whitespace:!0,required:!0};let u=T({customRowsColsInput:c(),customStyleInput:c(),customValidationInput:c(),disabled:c("Disabled textarea input"),input:c(),inputWithValidation:c(),noLabelInput:c(),textInput:c()});return(l,r)=>{const I=f("router-link"),p=f("SshPre"),V=f("Page");return F(),y(V,{title:l.$t("form.label.textarea"),class:"demo"},{toolbar:o(()=>[t(I,{to:{name:"form"},class:"back"},{default:o(()=>[e(i(l.$t("common.back")),1)]),_:1})]),default:o(()=>[e(),a("section",null,[a("h2",null,i(l.$t("form.label.basicInput")),1),e(),a("div",w,[t(p,{language:"html-vue"},{default:o(()=>[e(`
          <Form>
            <TextareaInput 
              v-model="input"
