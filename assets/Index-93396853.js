import{b as d,J as f}from"./DzangolabVue3Form.es-ae9e23e3.js";import{d as V,a5 as N,p as $,j as p,J as v,o as _,c as z,w as u,K as t,W as e,L as s,f as o,D as n}from"./index-729398ab-c88618b2.js";import{m as E}from"./index-8fc5d489.js";import{_ as F}from"./FormPage.vue_vue_type_style_index_0_lang-df90fcad.js";const O={class:"section-content"},w={class:"section-content"},U={class:"section-content"},k={class:"section-content"},M={class:"section-content"},S={class:"section-content"},y={class:"section-content"},W={name:"NumberInputField"},D=V({...W,setup(q){const{t:b}=N(),h=E.coerce.number({invalid_type_error:b("form.errors.number.invalid")}).gte(1,b("form.errors.number.invalid")).lte(100,b("form.errors.number.invalid")),g={invalid:b("form.errors.number.invalid"),required:b("form.errors.number.required")},c={min:1,max:100,allow_leading_zeroes:!1};let a=$({customValidationInput:p(),disabled:p(100),input:p(),inputWithValidation:p(),noLabelInput:p(),textInput:p()});return(l,r)=>{const I=v("router-link"),i=v("SshPre");return _(),z(F,{title:l.$t("form.label.number"),class:"demo"},{toolbar:u(()=>[t(I,{to:{name:"form"},class:"back"},{default:u(()=>[e(s(l.$t("common.back")),1)]),_:1})]),default:u(()=>[e(),o("section",null,[o("h2",null,s(l.$t("form.label.basicInput")),1),e(),o("div",O,[t(n(d),{modelValue:n(a).noLabelInput,"onUpdate:modelValue":r[0]||(r[0]=m=>n(a).noLabelInput=m),placeholder:l.$t("form.placeholder.number")},null,8,["modelValue","placeholder"]),e(),t(i,{language:"html-vue"},{default:u(()=>[e(`
          <template>
            <NumberInput 
              v-model="input"
