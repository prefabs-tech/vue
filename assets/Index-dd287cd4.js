import{m as g,n as d,Z as p}from"./DzangolabVue3Form.es-2fe01ceb.js";import{d as w,a2 as V,l as I,j as c,G as f,o as S,c as _,w as a,K as e,C as l,Z as r,f as t,D as n}from"./index-708e0d96-63bf851d.js";import{_ as $}from"./FormPage.vue_vue_type_style_index_0_lang-019015b3.js";import"./index-f59c4d44.js";const F={class:"section-content"},z={class:"section-content"},k={class:"section-content"},U={class:"section-content"},C={class:"section-content"},D={name:"SwitchInput"},P=w({...D,setup(W){const{t:b}=V(),h=g.coerce.boolean().refine(o=>o===!0,{message:b("form.errors.switch.invalid")});let s=I({disabled:c(!0),input:c(),inputWithValidation:c(!1),noLabelInput:c()});return(o,i)=>{const v=f("router-link"),m=f("SshPre");return S(),_($,{title:o.$t("form.label.switch"),class:"demo"},{toolbar:a(()=>[e(v,{to:{name:"form"},class:"back"},{default:a(()=>[l(r(o.$t("common.back")),1)]),_:1})]),default:a(()=>[l(),t("section",null,[t("h2",null,r(o.$t("form.label.basicInput")),1),l(),t("div",F,[e(m,{language:"html-vue"},{default:a(()=>[l(`
          <Form>
            <SwitchInput
              v-model="input"
            />
