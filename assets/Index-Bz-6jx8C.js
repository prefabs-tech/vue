import{e as b,o as v}from"./DzangolabVue3Form.es-IsnEOczk.js";import{d as k,z as g,A as C,r as c,s as y,j as I,o as V,w as u,B as e,e as a,t as p,g as i,u as l,C as x}from"./index-Cc4iPlXT.js";import{z as $}from"./index-mSkvzYyn.js";import{_ as z}from"./FormPage.vue_vue_type_style_index_0_lang-BZlBAyks.js";const S={class:"section-content"},O={class:"section-content"},_={class:"section-content"},B={class:"section-content"},L={name:"CheckboxInput"},N=k({...L,setup(w){const{t:n}=g(),f=$.string().array().min(6,{message:n("form.errors.checkbox.min",{min:6})});let r=C({disabled:c(["car"]),inputWithValidation:c(),multiCheckbox:c([]),noLabelInput:c()});const h=[{label:n("form.label.title"),value:1},{label:n("form.label.solutions"),value:2},{label:n("form.label.deliverableList"),value:3},{label:n("form.label.workInProgress"),value:4},{label:n("form.label.summary"),value:5},{label:n("form.label.next"),value:6},{label:n("form.label.assumptions"),value:7},{label:n("form.label.generalQuestions"),value:8},{label:n("form.label.consequences"),value:9},{label:n("form.label.other"),value:10}],d=[{label:n("form.label.bike"),value:"bike"},{label:n("form.label.car"),value:"car"},{label:n("form.label.truck"),value:"truck"}];return(o,t)=>{const m=y("SshPre");return V(),I(z,{title:o.$t("form.label.checkbox"),class:"demo"},{toolbar:u(()=>[i(l(x),{label:o.$t("common.back"),"icon-left":"pi pi-chevron-left",size:"medium",variant:"textOnly",onClick:t[0]||(t[0]=s=>o.$router.push("/form"))},null,8,["label"])]),default:u(()=>[e(),a("section",null,[a("h2",null,p(o.$t("form.label.basicInput")),1),e(),a("div",S,[i(l(b),{checked:l(r).noLabelInput,"onUpdate:checked":t[1]||(t[1]=s=>l(r).noLabelInput=s),"input-label":o.$t("form.label.accept"),name:"basic"},null,8,["checked","input-label"]),e(),i(m,{language:"html-vue"},{default:u(()=>[e(`
          <template>
            <CheckboxInput
