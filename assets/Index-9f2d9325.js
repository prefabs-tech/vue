import{m as P,t as p,Z as u}from"./DzangolabVue3Form.es-77391d6b.js";import{d as V,u as $,b as _,e as f,r as b,o as I,c as y,w as a,a as l,t as m,f as o,g as n,h as e,H as F}from"./index-e1b2c696.js";const z={class:"section-content"},S={class:"section-content"},U={class:"section-content"},E={class:"section-content"},L={class:"section-content"},O={class:"section-content"},q={class:"section-content"},M={class:"section-content"},W={class:"section-content"},k={name:"PasswordInputField"},N=V({...k,setup(C){const{t:c}=$(),g=P.string({invalid_type_error:c("form.errors.password.invalid"),required_error:c("form.errors.input.required")}).min(8,{message:c("form.errors.password.min",{length:8})}).regex(/^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)(?=.*[\W_]).+$/,c("form.errors.password.invalid")),h={required:c("form.errors.input.required"),weak:c("form.errors.password.invalid")},w={minLength:10,minLowercase:1,minUppercase:1,minSymbols:1};let r=_({customStyleInput:f(),customValidationInput:f(),disabled:f("P@ssw0rd"),input:f(),inputWithValidation:f(),noLabelInput:f(),passwordInput:f()});return(s,d)=>{const i=b("SshPre"),v=b("Page");return I(),y(v,{title:s.$t("form.label.password"),class:"demo"},{default:a(()=>[l("section",null,[l("h2",null,m(s.$t("form.label.basicInput")),1),o(),l("div",z,[n(i,{language:"html-vue"},{default:a(()=>[o(`
          <From>
            <Password 
              v-model="input"
