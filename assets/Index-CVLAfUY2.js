import{d as g,I as f,e as v,o as $,i as p,E as n,f as o,g as l,t as s,u,z as r,x as i}from"./index-DBPDEvuK.js";import{_ as P}from"./ComponentDocumentation.vue_vue_type_script_setup_true_lang-CgOyndWM.js";import{_ as y}from"./UiPage.vue_vue_type_style_index_0_lang-CzX1JeJ0.js";import"./DzangolabVue3TanstackTable.es-85Hmg7nS.js";import"./DzangolabVue3Form.es-Cubaro3U.js";const B={class:"section-content"},E={class:"popup-title"},w={class:"popup-body"},S={class:"section-content"},z={class:"section-content"},k={class:"section-content"},C={class:"section-content"},T={class:"section-content"},j=g({__name:"Index",setup(I){const m=[{description:"Emitted when the user clicks outside the popup.",name:"onClickOutside",payload:"-"}],d=[{default:'"popup"',description:"Aria label for accessibility, used on the trigger element.",prop:"ariaLabel",type:"String"},{default:"10",description:"Spacing in pixels between the trigger element and popup content.",prop:"offset",type:"Number"},{default:"-",description:"Supported position of the popup (`top`, `bottom`, `left`, or `right`).",prop:"position",type:"String"}],b=[{description:"Content to be shown in the popup.",name:"content"},{description:"The trigger element that opens the popup.",name:"default"}];return(e,t)=>{const a=f("SshPre");return $(),v(y,{"sub-title":e.$t("ui.popup.subtitle"),title:e.$t("ui.popup.title"),class:"demo"},{toolbar:p(()=>[l(u(i),{label:e.$t("common.back"),"icon-left":"pi pi-chevron-left",size:"medium",variant:"textOnly",onClick:t[0]||(t[0]=D=>e.$router.push("/ui"))},null,8,["label"])]),default:p(()=>[t[26]||(t[26]=n()),o("section",null,[o("h2",null,s(e.$t("ui.popup.usage.basic")),1),t[5]||(t[5]=n()),o("div",B,[l(u(r),null,{content:p(()=>[o("h3",E,s(e.$t("ui.popup.title")),1),t[1]||(t[1]=n()),o("div",w,s(e.$t("ui.popup.content")),1)]),default:p(()=>[l(u(i),{label:e.$t("ui.popup.label.button"),severity:"success"},null,8,["label"]),t[2]||(t[2]=n())]),_:1}),t[4]||(t[4]=n()),l(a,{language:"html-vue"},{default:p(()=>t[3]||(t[3]=[n(`
          <template>
            <Popup>
              <ButtonElement
                :label="Click me"
