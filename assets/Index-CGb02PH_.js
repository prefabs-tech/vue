import{b as v,E as $}from"./PrefabsTechVue3Form.es-DV1FRZxy.js";import{d as D,I as k,M as F,N as g,r as i,L as E,e as U,o as p,j as u,C as t,f as r,t as m,h as o,a as b,b as y,u as l,v as C}from"./index-STrZF6Wn.js";import{_ as S}from"./FormPage.vue_vue_type_style_index_0_lang-B08UBD6i.js";const z={class:"section-content"},N={key:0,class:"result-date"},B={class:"section-content"},P={key:0,class:"result-date"},w={class:"section-content"},A={key:0,class:"result-date"},q={class:"section-content"},O={key:0,class:"result-date"},T={name:"DaysInput"},H=D({...T,setup(j){const{t:I}=k(),V=F.coerce.number({invalid_type_error:I("form.errors.number.required")}).min(1,{message:I("form.errors.daysInput.invalid")}).max(365,{message:I("form.errors.daysInput.invalid")}),a=g({basic:i(),disabled:i(),label:i(),validationInput:i()});let d=g({basic:i(),disabled:i(30),label:i(),validationInput:i()});return(s,e)=>{const f=E("SshPre");return p(),U(S,{title:s.$t("form.label.daysInput"),class:"demo"},{toolbar:u(()=>[o(l(C),{label:s.$t("common.back"),"icon-left":"pi pi-chevron-left",size:"medium",variant:"textOnly",onClick:e[0]||(e[0]=n=>s.$router.push("/form"))},null,8,["label"])]),default:u(()=>[e[25]||(e[25]=t()),r("section",null,[r("h2",null,m(s.$t("form.label.basicInput")),1),e[12]||(e[12]=t()),r("div",z,[o(l(v),{modelValue:l(d).basic,"onUpdate:modelValue":e[1]||(e[1]=n=>l(d).basic=n),placeholder:s.$t("form.placeholder.days"),"onUpdate:date":e[2]||(e[2]=n=>a.basic=n)},null,8,["modelValue","placeholder"]),e[10]||(e[10]=t()),a.basic?(p(),b("div",N,m(a.basic),1)):y("",!0),e[11]||(e[11]=t()),o(f,{language:"html-vue"},{default:u(()=>e[9]||(e[9]=[t(`
          <template>
            <DaysInput
              v-model="input"
