import{d as C,u as A,r as F,o as B,h as P,w as s,a as n,t as u,b as t,e as i,f as o,P as p}from"./index-B97-Idj8.js";import{_ as D}from"./ComponentDocumentation.vue_vue_type_script_setup_true_lang-C12yRNST.js";import{_ as I}from"./UiPage.vue_vue_type_style_index_0_lang-DRO8GWg_.js";import"./PrefabsTechVue3TanstackTable.es-D738rBfg.js";const H={class:"section-content"},z={class:"section-content"},j={class:"section-content"},S={class:"section-content"},N={name:"FileCardDemo"},T=C({...N,setup(M){const{locale:l}=A(),c={severity:"warning",size:"medium",variant:"outlined"},m={severity:"danger",size:"medium",variant:"outlined"},f={severity:"primary",size:"medium",variant:"outlined"},v=[{description:"Emitted when edit description button is clicked",name:"click:editDescription",payload:"-"},{description:"Emitted when archive action is confirmed",name:"on:archive",payload:"File object"},{description:"Emitted when delete action is confirmed",name:"on:delete",payload:"File object"},{description:"Emitted when download button is clicked",name:"on:download",payload:"File object"},{description:"Emitted when share button is clicked",name:"on:share",payload:"File object"},{description:"Emitted when view button is clicked",name:"on:view",payload:"File object"}],g=[{description:"Slot for custom thumbnail content",name:"thumbnail"}],d={description:"This is a file",downloadCount:0,id:1,lastDownloadedAt:Date.now(),originalFileName:"file.png",size:4,uploadedAt:Date.now(),uploadedBy:{givenName:"Test",lastName:"user"}},b={archiveAction:"Archive file",archiveConfirmationHeader:"Confirm archive?",archiveConfirmationMessage:"Are you sure to archive this file?",deleteAction:"Delete file",deleteConfirmationHeader:"Confirm delete?",deleteConfirmationMessage:"Are you sure to delete this file?",downloadAction:"Download file",downloadCountHeader:"Download count:",lastDownloadedAtHeader:"Last downloaded date:",shareAction:"Share file",uploadedAtHeader:"Uploaded date:",uploadedByHeader:"Uploaded by:",viewAction:"View file"},w=[{default:`{
      ...
      uploadedAt: true,
      uploadedBy: true
    }`,description:"Controls visibility of file details",prop:"visibilityDetail",type:"Object"}],h={severity:"alternate",size:"medium",variant:"outlined"},y={severity:"secondary",size:"medium",variant:"outlined"};return(a,e)=>{const r=F("SshPre");return B(),P(I,{subtitle:a.$t("ui.fileCard.subtitle"),title:a.$t("ui.fileCard.title"),class:"demo-file-card"},{default:s(()=>[n("section",null,[n("h2",null,u(a.$t("ui.fileCard.usage.basic")),1),e[2]||(e[2]=t()),n("div",H,[i(o(p),{file:d,locale:String(o(l))},null,8,["locale"]),e[1]||(e[1]=t()),i(r,{language:"html-vue"},{default:s(()=>[...e[0]||(e[0]=[t(`
          <template>
          ...
          <\/script>
        `,-1)])]),_:1})])]),e[13]||(e[13]=t()),n("section",null,[n("h2",null,u(a.$t("ui.fileCard.usage.messages")),1),e[5]||(e[5]=t()),n("div",z,[i(o(p),{file:d,locale:String(o(l)),messages:b},null,8,["locale"]),e[4]||(e[4]=t()),i(r,{language:"html-vue"},{default:s(()=>[...e[3]||(e[3]=[t(`
          <template>
        ...
        `,-1)])]),_:1})])]),e[16]||(e[16]=t()),i(D,{"events-data":v,"props-data":w,"props-table-title":a.$t("common.properties",{value:"FileCardProperties"}),"slots-data":g},null,8,["props-table-title"]),e[17]||(e[17]=t()),n("section",null,[i(r,{language:"html-vue"},{default:s(()=>[...e[12]||(e[12]=[t(`
        interface IFile {
          id: number | string;
