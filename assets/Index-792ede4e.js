import{m as g,n as d,Z as p}from"./DzangolabVue3Form.es-7f58d222.js";import{d as w,a4 as V,l as I,j as c,G as f,o as S,c as _,w as a,K as e,C as l,S as r,f as t,D as n}from"./index-9834d213-2ba3e299.js";import{_ as $}from"./FormPage.vue_vue_type_style_index_0_lang-4e776d59.js";import"./index-6ea00a05.js";const F={class:"section-content"},z={class:"section-content"},k={class:"section-content"},U={class:"section-content"},C={class:"section-content"},D={name:"SwitchInput"},Z=w({...D,setup(W){const{t:b}=V(),h=g.coerce.boolean().refine(o=>o===!0,{message:b("form.errors.switch.invalid")});let s=I({disabled:c(!0),input:c(),inputWithValidation:c(!1),noLabelInput:c()});return(o,i)=>{const v=f("router-link"),m=f("SshPre");return S(),_($,{title:o.$t("form.label.switch"),class:"demo"},{toolbar:a(()=>[e(v,{to:{name:"form"},class:"back"},{default:a(()=>[l(r(o.$t("common.back")),1)]),_:1})]),default:a(()=>[l(),t("section",null,[t("h2",null,r(o.$t("form.label.basicInput")),1),l(),t("div",F,[e(m,{language:"html-vue"},{default:a(()=>[l(`
          <Form>
            <SwitchInput
              v-model="input"
            />
