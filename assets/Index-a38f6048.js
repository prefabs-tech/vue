import{m as V,l as p,Z as m}from"./DzangolabVue3Form.es-18082267.js";import{d as _,a4 as $,l as T,j as c,G as h,o as x,c as F,w as o,K as t,C as e,S as i,f as a,D as l}from"./index-d658739c-0fec2303.js";import{_ as w}from"./FormPage.vue_vue_type_style_index_0_lang-0a641472.js";import"./index-2117dc0f.js";const z={class:"section-content"},C={class:"section-content"},U={class:"section-content"},E={class:"section-content"},S={class:"section-content"},k={class:"section-content"},q={class:"section-content"},y={class:"section-content"},D={name:"TextareaInputField"},L=_({...D,setup(O){const{t:f}=$(),g=V.string().min(15,{message:f("form.errors.input.min",{length:15})}),v={required:f("form.errors.input.required")},b={ignore_whitespace:!0,required:!0};let r=T({customRowsColsInput:c(),customValidationInput:c(),disabled:c("Disabled textarea input"),input:c(),inputWithValidation:c(),noLabelInput:c(),textInput:c()});return(n,u)=>{const I=h("router-link"),d=h("SshPre");return x(),F(w,{title:n.$t("form.label.textarea"),class:"demo"},{toolbar:o(()=>[t(I,{to:{name:"form"},class:"back"},{default:o(()=>[e(i(n.$t("common.back")),1)]),_:1})]),default:o(()=>[e(),a("section",null,[a("h2",null,i(n.$t("form.label.basicInput")),1),e(),a("div",z,[t(d,{language:"html-vue"},{default:o(()=>[e(`
          <Form>
            <TextareaInput 
              v-model="input"
