import{W as b,B as g}from"./DzangolabVue3Form.es-CAxlRzL1.js";import{d as S,I as h,L as V,M as I,r as p,H as $,e as c,o as L,h as s,B as e,f as t,t as d,g as u,u as n,k as z,x as F,q as N}from"./index-v8URLa41.js";import{_ as D}from"./FormPage.vue_vue_type_style_index_0_lang-BAlsSTeb.js";const H={class:"section-content"},U={class:"section-content"},G={class:"section-content"},W={class:"section-content"},y={class:"section-content"},B={class:"section-content"},k={class:"section-content"},M={class:"section-content"},C={class:"section-content"},P={class:"section-content"},w={class:"section-content"},q={name:"SelectInputField"},J=S({...q,setup(O){const{t:f}=h(),v=V.string({invalid_type_error:f("form.errors.multiselect.invalid")}).array().min(1,{message:f("form.errors.multiselect.invalid")});let i=I({customLabelSelect:p(),disabled:p("de"),disabledMultiselect:p(["be","de"]),disabledSortInput:p(),i18nSelect:p(),input:p(),inputWithValidation:p([]),multiselect:p(),multiselectSearch:p(),noLabelInput:p(),selectWithSearch:p()});const r=p([{label:f("form.label.french"),value:"fr"},{label:f("form.label.german"),value:"de"},{disabled:!0,label:f("form.label.dutch"),value:"be"},{label:f("form.label.nepali"),value:"np"},{label:f("form.label.hindi"),value:"hi"}]);return(a,l)=>{const m=$("SshPre");return L(),c(D,{title:a.$t("form.label.select"),class:"demo"},{toolbar:s(()=>[u(n(N),{label:a.$t("common.back"),"icon-left":"pi pi-chevron-left",size:"medium",variant:"textOnly",onClick:l[0]||(l[0]=o=>a.$router.push("/form"))},null,8,["label"])]),default:s(()=>[l[46]||(l[46]=e()),t("section",null,[t("h2",null,d(a.$t("form.label.basicInput")),1),l[14]||(l[14]=e()),t("div",H,[u(n(b),{modelValue:n(i).noLabelInput,"onUpdate:modelValue":l[1]||(l[1]=o=>n(i).noLabelInput=o),options:r.value,placeholder:a.$t("form.placeholder.language")},null,8,["modelValue","options","placeholder"]),l[13]||(l[13]=e()),u(m,{language:"html-vue"},{default:s(()=>l[12]||(l[12]=[e(`
          <template>
            <SelectInput
              v-model="input"
              :options="options"
