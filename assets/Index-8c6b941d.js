import{e as g,u as I,f as V,g as r,o as y,c as v,w as u,a as s,t as d,d as e,b as t,h as n,r as f}from"./index-90527b34.js";import{m as $,y as i,b as _}from"./DzangolabVue3Form.es-0779da48.js";const w={class:"demo-section"},z={class:"demo-section"},S={class:"demo-section"},U={class:"demo-section"},W={class:"demo-section"},E={class:"demo-section"},P={name:"InputField"},C=g({...P,setup(F){const{t:c}=I(),b=$.string().min(3,{message:c("form.errors.input.min",{length:3})});let a=V({disabled:r("monorepo@gmail.com"),input:r(),inputWithValidation:r(),noLabelInput:r(),numberInput:r(),passwordInput:r()});return(l,o)=>{const m=f("SshPre"),h=f("Page");return y(),v(h,{title:l.$t("form.label.input")},{default:u(()=>[s("section",w,[s("h3",null,d(l.$t("form.label.basicInput")),1),e(),t(m,{language:"html-vue"},{default:u(()=>[e(`
        <template>
          <Input 
            v-model="input"
