import{N as K}from"./DzangolabVue3Form.es-1KEYK8mX.js";import{d as V,L as S,k as s,C as q,r as k,v as f,K as R,f as w,o as z,i as o,D as a,g as l,t as m,h as r,u as i}from"./index-Dgng_P6w.js";import{H as c}from"./DzangolabVue3TanstackTable.es-Cps0sxez.js";import{d as g,f as I}from"./data-G7xVDYni.js";import{_ as E}from"./TablePage.vue_vue_type_style_index_0_lang-zObcUaAG.js";const O={class:"section-content"},A={class:"section-content"},P={class:"section-content"},$={class:"section-content"},B={name:"TableFilters"},J=V({...B,setup(N){const{t:d}=S(),p=[{accessorKey:"email",enableColumnFilter:!0,enableSorting:!0,filterPlaceholder:"Search by email...",header:"Email"},{accessorKey:"name",header:"Full name"},{accessorKey:"age",align:"right",header:"Age"},{accessorKey:"city",enableColumnFilter:!0,filterPlaceholder:"Select city",header:"City",meta:{filterVariant:"multiselect",filterOptions:[{label:"Atlanta",value:"Atlanta"},{label:"Chicago",value:"Chicago"},{label:"Boston",value:"Boston"},{label:"Denver",value:"Denver"}]}}],y=[...p.map(t=>t.accessorKey==="email"?{...t,customFilterComponent:e=>s(q,{debounceTime:200,modelValue:e.getFilterValue(),placeholder:d("table.label.customFilter"),"onUpdate:modelValue":n=>{e.setFilterValue(n)}}),meta:{serverFilterFn:"contains"}}:t.accessorKey==="city"?{accessorKey:"city",header:"City"}:t)],v=[{accessorKey:"description",enableColumnFilter:!0,filterFn:"customEqualStringFilter",filterPlaceholder:d("table.label.matchDescription"),header:"Description"},{accessorKey:"quantity",dataType:"number",enableSorting:!0,header:"Quantity",numberOptions:{locale:"en-IN"}},{accessorKey:"amount",dataType:"currency",header:"Amount",numberOptions:{locale:"en-US",formatOptions:{currency:"EUR"}}},{accessorKey:"date",customFilterComponent:t=>s("div",{class:"filter-date"},[s(K,{modelValue:b.value,multiCalendars:!0,name:"date-range",placeholder:d("table.label.dateRange"),range:!0,"onUpdate:modelValue":e=>{b.value=e,t.setFilterValue(e)}})]),dataType:"date",enableColumnFilter:!0,filterFn:"inDateRangeFilter",header:"Date"},{accessorKey:"action",cell:()=>s(f,{iconLeft:"pi pi-eye",rounded:!0,variant:"textOnly"}),dataType:"other",header:()=>s("i",{class:"pi pi-cog"})}],F=[...p.map(t=>t.accessorKey==="email"?{...t,meta:{serverFilterFn:"equals"}}:t.accessorKey==="city"?{accessorKey:"city",header:"City"}:t)],b=k([]),D=(t,e,n)=>!!n.includes(t.getValue(e)),h=(t,e,n)=>{if(!n||!n[0]||!n[1])return!0;const u=t.getValue(e)?new Date(t.getValue(e)):null,C=new Date(n[1]),T=new Date(n[0]);return!!(u&&T.getTime()<=u.getTime()&&u.getTime()<C.getTime())};return(t,e)=>{const n=R("SshPre");return z(),w(E,{title:t.$t("table.title"),class:"demo data-table"},{toolbar:o(()=>[r(i(f),{label:t.$t("common.back"),"icon-left":"pi pi-chevron-left",size:"medium",variant:"textOnly",onClick:e[0]||(e[0]=u=>t.$router.push("/table"))},null,8,["label"])]),default:o(()=>[e[13]||(e[13]=a()),l("section",null,[l("h2",null,m(t.$t("table.usage.filterableColumn")),1),e[3]||(e[3]=a()),l("div",O,[r(i(c),{"columns-data":p,data:i(g)},null,8,["data"]),e[2]||(e[2]=a()),r(n,{language:"html-vue"},{default:o(()=>e[1]||(e[1]=[a(`
        ...
        `)])),_:1})])]),e[15]||(e[15]=a()),l("section",null,[l("h2",null,m(t.$t("table.usage.customFilter")),1),e[9]||(e[9]=a()),l("div",P,[r(i(c),{"columns-data":y,data:i(g).slice(10,15),"initial-sorting":[{id:"email",desc:!1}],"is-server-table":""},null,8,["data"]),e[8]||(e[8]=a()),r(n,{language:"html-vue"},{default:o(()=>e[7]||(e[7]=[a(`
          ...
          <\/script>
        `)])),_:1})])]),e[16]||(e[16]=a()),l("section",null,[l("h2",null,m(t.$t("table.usage.equalServerFilter")),1),e[12]||(e[12]=a()),l("div",$,[r(i(c),{"columns-data":F,data:i(g).slice(10,15),"initial-sorting":[{id:"email",desc:!1}],"is-server-table":""},null,8,["data"]),e[11]||(e[11]=a()),r(n,{language:"html-vue"},{default:o(()=>e[10]||(e[10]=[a(`
          <template>
            <Table
