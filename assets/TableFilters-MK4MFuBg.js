import{V as S,r as c}from"./PrefabsTechVue3TanstackTable.es-D738rBfg.js";import{d as T,u as K,N as s,Q as q,v as P,j as $,r as R,o as w,h as I,w as u,a as r,t as m,b as n,e as o,f as i}from"./index-B97-Idj8.js";import{c as k,d as f,f as E}from"./data-BzblxAWu.js";import{_ as O}from"./TablePage.vue_vue_type_style_index_0_lang-BZiFltGP.js";const x={class:"section-content"},U={class:"section-content"},N={class:"section-content"},A={class:"section-content"},B={name:"TableFiltersDemo"},Y=T({...B,setup(j){const{locale:g,t:l}=K(),d=[{accessorKey:"email",enableColumnFilter:!0,enableSorting:!0,filterPlaceholder:"Search by email...",header:"Email"},{accessorKey:"name",enableColumnFilter:!0,enableSorting:!0,filterPlaceholder:l("table.placeholder.search"),header:"Full name"},{accessorKey:"age",align:"right",enableColumnFilter:!0,enableSorting:!0,filterPlaceholder:`${l("table.placeholder.min")},${l("table.placeholder.max")}`,header:"Age",meta:{filterVariant:"range"}},{accessorKey:"city",enableColumnFilter:!0,enableSorting:!0,filterPlaceholder:l("table.placeholder.city"),header:"City",meta:{filterOptions:k,filterVariant:"multiselect"}}],h=d.map(t=>t.accessorKey==="email"?{...t,customFilterComponent:e=>s(q,{debounceTime:200,modelValue:e.getFilterValue(),"onUpdate:modelValue":a=>{e.setFilterValue(a)},placeholder:l("table.label.customFilter")}),meta:{serverFilterFn:"contains"}}:t.accessorKey==="age"?{...t,meta:{filterVariant:"range"}}:t),y=[{accessorKey:"description",enableColumnFilter:!0,enableSorting:!0,filterFn:"customEqualStringFilter",filterPlaceholder:l("table.label.matchDescription"),header:"Description"},{accessorKey:"quantity",dataType:"number",enableColumnFilter:!0,enableSorting:!0,filterPlaceholder:`${l("table.placeholder.min")},${l("table.placeholder.max")}`,header:()=>"Quantity",meta:{filterVariant:"range"},numberOptions:{locale:"en-IN"}},{accessorKey:"amount",dataType:"currency",enableColumnFilter:!0,enableSorting:!0,filterPlaceholder:`${l("table.placeholder.min")},${l("table.placeholder.max")}`,header:"Amount",meta:{filterVariant:"range"},numberOptions:{formatOptions:{currency:"EUR"},locale:"en-US"}},{accessorKey:"date",customFilterComponent:t=>s("div",{class:"filter-date"},[s(S,{modelValue:b.value,multiCalendars:!0,name:"date-range","onUpdate:modelValue":e=>{b.value=e,t.setFilterValue(e)},placeholder:l("table.label.dateRange"),range:!0,teleport:!0})]),dataType:"date",enableColumnFilter:!0,enableSorting:!0,filterFn:"inDateRangeFilter",filterPlaceholder:l("table.placeholder.dateRange"),header:"Date"},{accessorKey:"action",cell:()=>s(P,{iconLeft:"pi pi-eye",rounded:!0,variant:"textOnly"}),dataType:"other",header:()=>s("i",{class:"pi pi-cog"})}],F=d.map(t=>t.accessorKey==="email"?{...t,meta:{serverFilterFn:"equals"}}:t.accessorKey==="age"?{...t,meta:{filterVariant:"range"}}:t),b=$([]),v=(t,e,a)=>!!a.includes(t.getValue(e)),D=(t,e,a)=>{if(!a||!a[0]||!a[1])return!0;const p=t.getValue(e)?new Date(t.getValue(e)):null,C=new Date(a[1]),V=new Date(a[0]);return!!(p&&V.getTime()<=p.getTime()&&p.getTime()<C.getTime())};return(t,e)=>{const a=R("SshPre");return w(),I(O,{title:t.$t("table.title"),class:"demo data-table"},{default:u(()=>[r("section",null,[r("h2",null,m(t.$t("table.usage.filterableColumn")),1),e[2]||(e[2]=n()),r("div",x,[o(i(c),{id:"filterable-column","columns-data":d,data:i(f)},null,8,["data"]),e[1]||(e[1]=n()),o(a,{language:"html-vue"},{default:u(()=>[...e[0]||(e[0]=[n(`
          ...
          <\/script>
        `,-1)])]),_:1})])]),e[12]||(e[12]=n()),r("section",null,[r("h2",null,m(t.$t("table.usage.customStaticFilter")),1),e[5]||(e[5]=n()),r("div",U,[o(i(c),{id:"custom-static-filter","columns-data":y,data:i(E),"initial-sorting":[{id:"quantity",desc:!0}],locale:String(i(g)),paginated:!1,"table-options":{filterFns:{customEqualStringFilter:v,inDateRangeFilter:D}},class:"custom-static-filter-table"},null,8,["data","locale","table-options"]),e[4]||(e[4]=n()),o(a,{language:"html-vue"},{default:u(()=>[...e[3]||(e[3]=[n(`
          <template>
            <Table
          ...
          <\/script>
        `,-1)])]),_:1})])]),e[13]||(e[13]=n()),r("section",null,[r("h2",null,m(t.$t("table.usage.customFilter")),1),e[8]||(e[8]=n()),r("div",N,[o(i(c),{id:"custom-filter","columns-data":i(h),data:i(f).slice(10,15),"initial-sorting":[{id:"email",desc:!1}],"is-server-table":""},null,8,["columns-data","data"]),e[7]||(e[7]=n()),o(a,{language:"html-vue"},{default:u(()=>[...e[6]||(e[6]=[n(`
          <template>
            <Table
              id="custom-filter"
          ...
          <\/script>
        `,-1)])]),_:1})])]),e[14]||(e[14]=n()),r("section",null,[r("h2",null,m(t.$t("table.usage.equalServerFilter")),1),e[11]||(e[11]=n()),r("div",A,[o(i(c),{id:"equal-server-filter","columns-data":i(F),data:i(f).slice(10,15),"initial-sorting":[{id:"email",desc:!1}],"is-server-table":""},null,8,["columns-data","data"]),e[10]||(e[10]=n()),o(a,{language:"html-vue"},{default:u(()=>[...e[9]||(e[9]=[n(`
          <template>
            <Table
