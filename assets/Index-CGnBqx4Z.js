import{_ as f,b as w}from"./PrefabsTechVue3Form.es-BWc4QQ6k.js";import{d as h,M as y,O as v,N as A,o as c,e as L,f as s,h as o,t as p,A as l,a as t,u as n,P as D,r as g}from"./index-BOKL-xq7.js";import{_ as T}from"./FormPage.vue_vue_type_style_index_0_lang-CQCsF5L0.js";const I={class:"section-content"},V={class:"section-content"},S={class:"section-content"},$={class:"section-content"},C={class:"section-content"},P={class:"section-content"},k={name:"InputField"},R=h({...k,setup(M){const{t:b}=y(),m=v.string().min(3,{message:b("form.errors.input.min",{length:3})}),u=[{value:"Roslabel",label:"Roslabel - A fragrant flower often associated with romance"},{value:"Tulip",label:"Tulip - A bright, cup-shaped flower popular in spring"},{value:"Daisy",label:"Daisy - A simple, white flower with a yellow center"},{value:"Sunflower",label:"Sunflower - A tall plant with a large, yellow flower head"},{value:"Lily",label:"Lily - An elegant flower often used in bouquets"},{value:"Orchid",label:"Orchid - An exotic flower with a unique shape"},{value:"Marigold",label:"Marigold - A vibrant, orange or yellow flower"},{value:"Lavender",label:"Lavender - A fragrant flower known for its calming scent"},{value:"Peony",label:"Peony - A lush, full flower often used in weddings"},{value:"Chrysanthemum",label:"Chrysanthemum - A hardy flower with a variety of colors"},{value:"Daffodil",label:"Daffodil - A bright, yellow flower that blooms in spring"},{value:"Hydrangea",label:"Hydrangea - A large, cluster-like flower that changes color"}];let r=D({disabled:g("Lily"),input:g(),inputWithValidation:g(),noLabelInput:g()});return(a,e)=>{const d=A("SshPre");return c(),L(T,{title:a.$t("form.label.typeahead"),class:"demo"},{default:s(()=>[o("section",null,[o("h2",null,p(a.$t("form.label.basicInput")),1),e[8]||(e[8]=l()),o("div",I,[t(n(f),{modelValue:n(r).noLabelInput,"onUpdate:modelValue":e[0]||(e[0]=i=>n(r).noLabelInput=i),placeholder:a.$t("form.placeholder.input"),suggestions:u},null,8,["modelValue","placeholder"]),e[7]||(e[7]=l()),t(d,{language:"html-vue"},{default:s(()=>[...e[6]||(e[6]=[l(`
          <template>
            <Typeahead
              v-model="input"
        ...
        `,-1)])]),_:1})])]),e[27]||(e[27]=l()),o("section",null,[o("h2",null,p(a.$t("form.label.debouncedTypeahead")),1),e[20]||(e[20]=l()),o("div",C,[t(n(f),{modelValue:n(r).input,"onUpdate:modelValue":e[4]||(e[4]=i=>n(r).input=i),"debounce-time":1e3,label:a.$t("form.label.typeahead"),placeholder:a.$t("form.placeholder.input"),suggestions:u},null,8,["modelValue","label","placeholder"]),e[19]||(e[19]=l()),t(d,{language:"html-vue"},{default:s(()=>[...e[18]||(e[18]=[l(`
          ...
          <\/script>
        `,-1)])]),_:1})])]),e[28]||(e[28]=l()),o("section",null,[o("h2",null,p(a.$t("form.label.inputWithValidation")),1),e[23]||(e[23]=l()),o("div",P,[t(n(w),null,{default:s(()=>[t(n(f),{modelValue:n(r).inputWithValidation,"onUpdate:modelValue":e[5]||(e[5]=i=>n(r).inputWithValidation=i),label:a.$t("form.label.typeahead"),name:a.$t("form.label.typeahead"),placeholder:a.$t("form.placeholder.input"),schema:n(m),suggestions:u,type:"text"},null,8,["modelValue","label","name","placeholder","schema"])]),_:1}),e[22]||(e[22]=l()),t(d,{language:"html-vue"},{default:s(()=>[...e[21]||(e[21]=[l(`
          <Form>
            <Typeahead
