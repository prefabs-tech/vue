import{m as I,J as d,Z as i}from"./DzangolabVue3Form.es-66293d03.js";import{d as V,u as $,b as F,e as c,r as f,o as w,c as _,w as o,f as n,g as e,t as m,a,h as l}from"./index-d455476b.js";const y={class:"section-content"},z={class:"section-content"},U={class:"section-content"},k={class:"section-content"},S={class:"section-content"},E={class:"section-content"},P={name:"InputField"},C=V({...P,setup(T){const{t:b}=$(),h=I.string().min(3,{message:b("form.errors.input.min",{length:3})});let r=F({disabled:c("monorepo@gmail.com"),input:c(),inputWithValidation:c(),noLabelInput:c(),passwordInput:c()});return(t,s)=>{const g=f("router-link"),p=f("SshPre"),v=f("Page");return w(),_(v,{title:t.$t("form.label.input"),class:"demo"},{toolbar:o(()=>[n(g,{to:{name:"form"},class:"back"},{default:o(()=>[e(m(t.$t("common.back")),1)]),_:1})]),default:o(()=>[e(),a("section",null,[a("h2",null,m(t.$t("form.label.basicInput")),1),e(),a("div",y,[n(p,{language:"html-vue"},{default:o(()=>[e(`
          <Form>
            <Input 
              v-model="username"
