import{y as b,W as v}from"./DzangolabVue3Form.es-DS2SbmIR.js";import{d as V,L as I,M as $,N as y,r,K as h,f as L,o as z,i as s,E as e,g as t,t as p,h as u,u as n,l as F,A as k,x as M}from"./index--1kJlkFk.js";import{_ as N}from"./FormPage.vue_vue_type_style_index_0_lang-cScZeIHC.js";const U={class:"section-content"},D={class:"section-content"},K={class:"section-content"},W={class:"section-content"},G={class:"section-content"},H={class:"section-content"},c={class:"section-content"},C={class:"section-content"},P={class:"section-content"},w={class:"section-content"},B={class:"section-content"},O={class:"section-content"},A={name:"SelectInputField"},Q=V({...A,setup(E){const{t:d}=I(),S=$.string({invalid_type_error:d("form.errors.multiselect.invalid")}).array().min(1,{message:d("form.errors.multiselect.invalid")});let i=y({customLabelSelect:r(),disabled:r("de"),disabledMultiselect:r(["be","de"]),disabledSortInput:r(),i18nSelect:r(),input:r(),inputWithMinMax:r([]),inputWithValidation:r([]),labelValueKeyInput:r(),multiselect:r(),multiselectKeysInput:r([]),noLabelInput:r()});const g=r([{label:d("form.label.french"),value:"fr"},{label:d("form.label.german"),value:"de"},{disabled:!0,label:d("form.label.dutch"),value:"be"},{label:d("form.label.nepali"),value:"np"},{label:d("form.label.hindi"),value:"hi"}]),f=r([{code:"fr",language:d("form.label.french")},{code:"de",language:d("form.label.german")},{code:"be",disabled:!0,language:d("form.label.dutch")},{code:"np",language:d("form.label.nepali")},{code:"hi",language:d("form.label.hindi")}]);return(a,l)=>{const m=h("SshPre");return z(),L(N,{title:a.$t("form.label.select"),class:"demo"},{toolbar:s(()=>[u(n(M),{label:a.$t("common.back"),"icon-left":"pi pi-chevron-left",size:"medium",variant:"textOnly",onClick:l[0]||(l[0]=o=>a.$router.push("/form"))},null,8,["label"])]),default:s(()=>[l[50]||(l[50]=e()),t("section",null,[t("h2",null,p(a.$t("form.label.basicInput")),1),l[15]||(l[15]=e()),t("div",U,[u(n(b),{modelValue:n(i).noLabelInput,"onUpdate:modelValue":l[1]||(l[1]=o=>n(i).noLabelInput=o),options:g.value,placeholder:a.$t("form.placeholder.language")},null,8,["modelValue","options","placeholder"]),l[14]||(l[14]=e()),u(m,{language:"html-vue"},{default:s(()=>l[13]||(l[13]=[e(`
          <template>
            <SelectInput
              v-model="input"
              :options="options"
        ...
        `)])),_:1})])]),l[52]||(l[52]=e()),t("section",null,[t("h2",null,p(a.$t("form.label.disabled")),1),l[21]||(l[21]=e()),t("div",K,[u(n(b),{modelValue:n(i).disabled,"onUpdate:modelValue":l[3]||(l[3]=o=>n(i).disabled=o),label:a.$t("form.label.language"),options:g.value,disabled:""},null,8,["modelValue","label","options"]),l[20]||(l[20]=e()),u(m,{language:"html-vue"},{default:s(()=>l[19]||(l[19]=[e(`
          ...
          <\/script>
        `)])),_:1})])]),l[53]||(l[53]=e()),t("section",null,[t("h2",null,p(a.$t("form.label.disableSort")),1),l[24]||(l[24]=e()),t("div",W,[u(n(b),{modelValue:n(i).disabledSortInput,"onUpdate:modelValue":l[4]||(l[4]=o=>n(i).disabledSortInput=o),"has-sorted-options":!1,label:a.$t("form.label.language"),options:g.value,placeholder:a.$t("form.placeholder.language")},null,8,["modelValue","label","options","placeholder"]),l[23]||(l[23]=e()),u(m,{language:"html-vue"},{default:s(()=>l[22]||(l[22]=[e(`
          <template>
            <SelectInput 
              v-model="input"
