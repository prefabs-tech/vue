import{d as v,u as P,b as V,e as d,o as h,c as y,w as i,a as r,t as u,f as e,g as n,h as t,r as b}from"./index-378880eb.js";import{m as _,B as p,z}from"./DzangolabVue3Form.es-9bf5e5df.js";const $={class:"demo-section"},I={class:"demo-section"},w={class:"demo-section"},S={class:"demo-section"},U={class:"demo-section"},R={class:"demo-section"},C={class:"demo-section"},B={class:"demo-section"},F={class:"demo-section"},W={class:"demo-section"},L={name:"DatePickerInput"},M=v({...L,setup(N){const{t:g}=P(),D=_.coerce.date().min(new Date,{message:g("form.errors.datePicker.invalid")}),c=new Date,f=c;let l=V({customStyleInput:d(),dateRange:d([c,new Date(f.setDate(f.getDate()+7))]),disabled:d(c),input:d(),inputWithValidation:d(),month:d(),multiCalendarsInput:d([c,new Date(f.setDate(f.getDate()+7))]),noLabelInput:d(),time:d(),year:d(c.getFullYear())});return(a,o)=>{const m=b("SshPre"),k=b("Page");return h(),y(k,{title:a.$t("form.label.textInput")},{default:i(()=>[r("section",$,[r("h3",null,u(a.$t("form.label.basicInput")),1),e(),n(m,{language:"html-vue"},{default:i(()=>[e(`
        <template>
          <DatePicker 
            v-model="input"
          />
