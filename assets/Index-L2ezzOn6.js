import{S as v,P as $}from"./PrefabsTechVue3Form.es-AW7XjjcA.js";import{d as D,I as k,L as F,M as g,r as i,J as S,e as U,o as p,j as u,C as t,f as r,t as m,h as o,a as b,b as y,u as n,v as C}from"./index-CcONflj6.js";import{_ as E}from"./FormPage.vue_vue_type_style_index_0_lang-Dmadt9ZM.js";const P={class:"section-content"},z={key:0,class:"result-date"},B={class:"section-content"},N={key:0,class:"result-date"},w={class:"section-content"},A={key:0,class:"result-date"},q={class:"section-content"},T={key:0,class:"result-date"},j={name:"DaysInput"},G=D({...j,setup(J){const{t:I}=k(),V=F.coerce.number({invalid_type_error:I("form.errors.number.required")}).min(1,{message:I("form.errors.daysInput.invalid")}).max(365,{message:I("form.errors.daysInput.invalid")}),a=g({basic:i(),disabled:i(),label:i(),validationInput:i()});let d=g({basic:i(),disabled:i(30),label:i(),validationInput:i()});return(s,e)=>{const f=S("SshPre");return p(),U(E,{title:s.$t("form.label.daysInput"),class:"demo"},{toolbar:u(()=>[o(n(C),{label:s.$t("common.back"),"icon-left":"pi pi-chevron-left",size:"medium",variant:"textOnly",onClick:e[0]||(e[0]=l=>s.$router.push("/form"))},null,8,["label"])]),default:u(()=>[e[25]||(e[25]=t()),r("section",null,[r("h2",null,m(s.$t("form.label.basicInput")),1),e[12]||(e[12]=t()),r("div",P,[o(n(v),{modelValue:n(d).basic,"onUpdate:modelValue":e[1]||(e[1]=l=>n(d).basic=l),placeholder:s.$t("form.placeholder.days"),"onUpdate:date":e[2]||(e[2]=l=>a.basic=l)},null,8,["modelValue","placeholder"]),e[10]||(e[10]=t()),a.basic?(p(),b("div",z,m(a.basic),1)):y("",!0),e[11]||(e[11]=t()),o(f,{language:"html-vue"},{default:u(()=>e[9]||(e[9]=[t(`
          <template>
            <DaysInput
              v-model="input"
