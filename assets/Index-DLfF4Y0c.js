import{b as p,S as f}from"./DzangolabVue3Form.es-ByH_DYOt.js";import{d as V,J as $,L as T,M as x,r as m,I as z,e as w,o as F,i as u,E as t,f as o,t as d,g as a,u as l,x as C}from"./index-pg879in7.js";import{_ as E}from"./FormPage.vue_vue_type_style_index_0_lang-CcX4MMZ5.js";const S={class:"section-content"},U={class:"section-content"},q={class:"section-content"},O={class:"section-content"},y={class:"section-content"},M={class:"section-content"},k={class:"section-content"},D={class:"section-content"},L={name:"TextareaInputField"},P=V({...L,setup(R){const{t:b}=$(),v=T.string().min(15,{message:b("form.errors.input.min",{length:15})}),I={required:b("form.errors.input.required")},g={ignore_whitespace:!0,required:!0};let r=x({customRowsColsInput:m(),customValidationInput:m(),disabled:m("Disabled textarea input"),input:m(),inputWithValidation:m(),noLabelInput:m(),textInput:m()});return(n,e)=>{const i=z("SshPre");return F(),w(E,{title:n.$t("form.label.textarea"),class:"demo"},{toolbar:u(()=>[a(l(C),{label:n.$t("common.back"),"icon-left":"pi pi-chevron-left",size:"medium",variant:"textOnly",onClick:e[0]||(e[0]=s=>n.$router.push("/form"))},null,8,["label"])]),default:u(()=>[e[33]||(e[33]=t()),o("section",null,[o("h2",null,d(n.$t("form.label.basicInput")),1),e[11]||(e[11]=t()),o("div",S,[a(l(p),{modelValue:l(r).noLabelInput,"onUpdate:modelValue":e[1]||(e[1]=s=>l(r).noLabelInput=s),placeholder:n.$t("form.placeholder.input")},null,8,["modelValue","placeholder"]),e[10]||(e[10]=t()),a(i,{language:"html-vue"},{default:u(()=>e[9]||(e[9]=[t(`
          <template>
            <TextareaInput 
              v-model="input"
