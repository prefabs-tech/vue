import{m as d,y as p}from"./DzangolabVue3Form.es-b2d0a90f.js";import{d as g,a7 as w,p as V,j as c,K as f,o as I,c as S,w as a,L as n,C as l,M as m,f as t,E as e}from"./index-137faed7-295202b8.js";import{m as _}from"./index-1622bca7.js";import{_ as $}from"./FormPage.vue_vue_type_style_index_0_lang-1e05dc9c.js";const F={class:"section-content"},z={class:"section-content"},k={class:"section-content"},U={class:"section-content"},C={class:"section-content"},L={name:"SwitchInput"},P=g({...L,setup(W){const{t:b}=w(),h=_.coerce.boolean().refine(o=>o===!0,{message:b("form.errors.switch.invalid")});let s=V({disabled:c(!0),input:c(),inputWithValidation:c(!1),noLabelInput:c()});return(o,i)=>{const v=f("router-link"),r=f("SshPre");return I(),S($,{title:o.$t("form.label.switch"),class:"demo"},{toolbar:a(()=>[n(v,{to:{name:"form"},class:"back"},{default:a(()=>[l(m(o.$t("common.back")),1)]),_:1})]),default:a(()=>[l(),t("section",null,[t("h2",null,m(o.$t("form.label.basicInput")),1),l(),t("div",F,[n(r,{language:"html-vue"},{default:a(()=>[l(`
          <Form>
            <SwitchInput
              v-model="input"
            />
