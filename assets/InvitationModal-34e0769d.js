import{d as S,a5 as E,j as m,J as D,o as z,c as k,w as i,K as t,D as a,ao as u,W as n,f as o,L as v}from"./index-729398ab-b294403d.js";import{U as p,A as P}from"./index-2f56db22.js";import{_ as B}from"./UserPage.vue_vue_type_style_index_0_lang-d4ecfef6.js";const R={class:"section-content"},U={class:"section-content"},A={class:"section-content"},C={class:"section-content"},N={class:"section-content"},O={class:"section-content"},F={class:"section-content"},J=S({__name:"InvitationModal",setup(T){const{t:y}=E(),f=m(!1),b=m(!1),w=m(!1),h=m(!1),M=m(!1),c=m(!1),g=m(!1),I=[{id:1,name:"ADMIN"},{id:2,name:"SUPERADMIN"},{id:3,name:"USER"}],$=[{id:1,name:"Admin",origin:"admin-origin",supportedRoles:[{id:1,name:"ADMIN"},{id:2,name:"SUPERADMIN"}]},{id:2,name:"User",origin:"user-origin",supportedRoles:[{id:3,name:"USER"}]}],r=l=>{P({text:y("user.message.invitation.success",{user:l.email}),type:"success"}),f.value=!1,b.value=!1,w.value=!1,h.value=!1,M.value=!1,c.value=!1,g.value=!1};return(l,e)=>{const d=D("SshPre");return z(),k(B,{title:l.$t("user.label.invitationModal"),class:"demo-invitation-modal"},{toolbar:i(()=>[t(a(u),{label:l.$t("common.back"),"icon-left":"pi pi-chevron-left",size:"medium",variant:"textOnly",onClick:e[0]||(e[0]=s=>l.$router.push("/user"))},null,8,["label"])]),default:i(()=>[n(),o("section",null,[o("h2",null,v(l.$t("user.label.basic")),1),n(),o("div",R,[t(a(u),{label:l.$t("user.label.invite"),onClick:e[1]||(e[1]=s=>M.value=!0)},null,8,["label"]),n(),t(a(p),{show:M.value,"onOn:close":e[2]||(e[2]=s=>M.value=!1),onSubmit:r},null,8,["show"]),n(),t(d,{language:"html-vue"},{default:i(()=>[n(`
          ...
          <\/script>
        `)]),_:1}),n()])]),n(),o("section",null,[o("h2",null,v(l.$t("user.label.withTitle")),1),n(),o("div",U,[t(a(u),{label:l.$t("user.label.send"),onClick:e[3]||(e[3]=s=>g.value=!0)},null,8,["label"]),n(),t(a(p),{show:g.value,title:l.$t("user.label.invite"),"onOn:close":e[4]||(e[4]=s=>g.value=!1),onSubmit:r},null,8,["show","title"]),n(),t(d,{language:"html-vue"},{default:i(()=>[n(`
          <template>
            <ButtonElement
              label="Send"
              @click="showModal = true"
