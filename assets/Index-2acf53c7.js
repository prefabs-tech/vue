import{A as d,W as p}from"./DzangolabVue3Form.es-579aa137.js";import{d as V,a7 as N,p as _,j as b,K as v,o as $,c as F,w as r,L as l,C as n,M as s,f as t,E as e}from"./index-8e1c3ab6-8617714e.js";import{m as z}from"./index-eb14ec17.js";import{_ as E}from"./FormPage.vue_vue_type_style_index_0_lang-cebf9516.js";const O={class:"section-content"},w={class:"section-content"},M={class:"section-content"},U={class:"section-content"},k={class:"section-content"},S={class:"section-content"},W={class:"section-content"},y={name:"NumberInputField"},A=V({...y,setup(q){const{t:f}=N(),h=z.coerce.number({invalid_type_error:f("form.errors.number.invalid")}).gte(1,f("form.errors.number.invalid")).lte(100,f("form.errors.number.invalid")),g={invalid:f("form.errors.number.invalid"),required:f("form.errors.number.required")},c={min:1,max:100,allow_leading_zeroes:!1};let a=_({customValidationInput:b(),disabled:b(100),input:b(),inputWithValidation:b(),noLabelInput:b(),textInput:b()});return(o,u)=>{const I=v("router-link"),i=v("SshPre");return $(),F(E,{title:o.$t("form.label.number"),class:"demo"},{toolbar:r(()=>[l(I,{to:{name:"form"},class:"back"},{default:r(()=>[n(s(o.$t("common.back")),1)]),_:1})]),default:r(()=>[n(),t("section",null,[t("h2",null,s(o.$t("form.label.basicInput")),1),n(),t("div",O,[l(i,{language:"html-vue"},{default:r(()=>[n(`
          <Form>
            <NumberInput 
              v-model="input"
        ...
        `)]),_:1}),n(),l(e(d),null,{default:r(()=>[l(e(p),{modelValue:e(a).textInput,"onUpdate:modelValue":u[5]||(u[5]=m=>e(a).textInput=m),label:o.$t("form.label.number"),"error-messages":e(g),options:e(c),placeholder:o.$t("form.placeholder.number")},null,8,["modelValue","label","error-messages","options","placeholder"])]),_:1})])]),n(),t("section",null,[t("h2",null,s(o.$t("form.label.customValidationInput")),1),n(),t("div",W,[l(i,{language:"html-vue"},{default:r(()=>[n(`
          ...
          <\/script>
        `)]),_:1}),n(),l(e(d),null,{default:r(()=>[l(e(p),{modelValue:e(a).customValidationInput,"onUpdate:modelValue":u[6]||(u[6]=m=>e(a).customValidationInput=m),label:o.$t("form.label.number"),placeholder:o.$t("form.placeholder.number"),schema:e(h),name:"number"},null,8,["modelValue","label","placeholder","schema"])]),_:1})])])]),_:1},8,["title"])}}});export{A as default};
