  ...
  <div class="editable-content">
    <Card>
      ...
      <div v-else class="content">
        <component :is="contentElement">{{ modelValue }}</component>

        <span
          :class="['toggle-icon', { disabled: !allowEdit }]"
...
.editable-content > .card .content > .toggle-icon {
  cursor: pointer;
}

.editable-content > .card .content > .toggle-icon.disabled {
  cursor: default;
  opacity: 0.4;
}
</style>
