import{W as p,J as c}from"./DzangolabVue3Form.es-b047fed9.js";import{d as v,a5 as I,p as V,j as m,J as $,o as T,c as x,w as u,K as a,D as t,ao as _,W as e,f as n,L as d}from"./index-729398ab-97e0bd19.js";import{m as w}from"./index-10489b7d.js";import{_ as z}from"./FormPage.vue_vue_type_style_index_0_lang-0e434bf3.js";const F={class:"section-content"},C={class:"section-content"},U={class:"section-content"},y={class:"section-content"},E={class:"section-content"},W={class:"section-content"},q={class:"section-content"},O={class:"section-content"},S={name:"TextareaInputField"},B=v({...S,setup(D){const{t:f}=I(),h=w.string().min(15,{message:f("form.errors.input.min",{length:15})}),g={required:f("form.errors.input.required")},b={ignore_whitespace:!0,required:!0};let r=V({customRowsColsInput:m(),customValidationInput:m(),disabled:m("Disabled textarea input"),input:m(),inputWithValidation:m(),noLabelInput:m(),textInput:m()});return(l,o)=>{const i=$("SshPre");return T(),x(z,{title:l.$t("form.label.textarea"),class:"demo"},{toolbar:u(()=>[a(t(_),{label:l.$t("common.back"),"icon-left":"pi pi-chevron-left",size:"medium",variant:"textOnly",onClick:o[0]||(o[0]=s=>l.$router.push("/form"))},null,8,["label"])]),default:u(()=>[e(),n("section",null,[n("h2",null,d(l.$t("form.label.basicInput")),1),e(),n("div",F,[a(t(p),{modelValue:t(r).noLabelInput,"onUpdate:modelValue":o[1]||(o[1]=s=>t(r).noLabelInput=s),placeholder:l.$t("form.placeholder.input")},null,8,["modelValue","placeholder"]),e(),a(i,{language:"html-vue"},{default:u(()=>[e(`
          <template>
            <TextareaInput 
              v-model="input"
        ...
        `)]),_:1}),e()])]),e(),n("section",null,[n("h2",null,d(l.$t("form.label.inputWithValidation")),1),e(),n("div",E,[a(t(c),null,{default:u(()=>[a(t(p),{modelValue:t(r).inputWithValidation,"onUpdate:modelValue":o[5]||(o[5]=s=>t(r).inputWithValidation=s),label:l.$t("form.label.textarea"),options:b,placeholder:l.$t("form.placeholder.input")},null,8,["modelValue","label","placeholder"])]),_:1}),e(),a(i,{language:"html-vue"},{default:u(()=>[e(`
          ...
          <\/script>
        `)]),_:1}),e()])]),e(),n("section",null,[n("h2",null,d(l.$t("form.label.customErrorMessageInput")),1),e(),n("div",W,[a(t(c),null,{default:u(()=>[a(t(p),{modelValue:t(r).textInput,"onUpdate:modelValue":o[6]||(o[6]=s=>t(r).textInput=s),label:l.$t("form.label.textarea"),"error-messages":g,options:b,placeholder:l.$t("form.placeholder.input")},null,8,["modelValue","label","placeholder"])]),_:1}),e(),a(i,{language:"html-vue"},{default:u(()=>[e(`
          <Form>
            <TextareaInput 
              v-model="input"
        ...
        `)]),_:1}),e()])]),e(),n("section",null,[n("h2",null,d(l.$t("form.label.customValidationInput")),1),e(),n("div",q,[a(t(c),null,{default:u(()=>[a(t(p),{modelValue:t(r).customValidationInput,"onUpdate:modelValue":o[7]||(o[7]=s=>t(r).customValidationInput=s),label:l.$t("form.label.textarea"),placeholder:l.$t("form.placeholder.input"),schema:t(h),name:"custom_input"},null,8,["modelValue","label","placeholder","schema"])]),_:1}),e(),a(i,{language:"html-vue"},{default:u(()=>[e(`
          ...
          <\/script>
        `)]),_:1}),e()])]),e(),n("section",null,[n("h2",null,d(l.$t("form.label.customColsRowsInput")),1),e(),n("div",O,[a(t(c),null,{default:u(()=>[a(t(p),{modelValue:t(r).customRowsColsInput,"onUpdate:modelValue":o[8]||(o[8]=s=>t(r).customRowsColsInput=s),cols:100,label:l.$t("form.label.textarea"),placeholder:l.$t("form.placeholder.input"),rows:5,class:"textarea-field"},null,8,["modelValue","label","placeholder"])]),_:1}),e(),a(i,{language:"html-vue"},{default:u(()=>[e(`
          <Form>
            <TextareaInput 
              v-model="input"
