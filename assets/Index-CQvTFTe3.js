import{b as p,O as f}from"./PrefabsTechVue3Form.es-BuEZVNq1.js";import{d as V,I as $,L as T,M as x,r as m,J as w,e as F,o as C,j as u,C as t,f as o,t as d,h as a,u as l,v as h}from"./index-BtKzF4F8.js";import{_ as O}from"./FormPage.vue_vue_type_style_index_0_lang-Bx8dIQMj.js";const U={class:"section-content"},E={class:"section-content"},q={class:"section-content"},S={class:"section-content"},y={class:"section-content"},z={class:"section-content"},M={class:"section-content"},k={class:"section-content"},D={name:"TextareaInputField"},N=V({...D,setup(L){const{t:b}=$(),I=T.string().min(15,{message:b("form.errors.input.min",{length:15})}),g={required:b("form.errors.input.required")},v={ignore_whitespace:!0,required:!0};let r=x({customRowsColsInput:m(),customValidationInput:m(),disabled:m("Disabled textarea input"),i18nInput:m(),input:m(),inputWithValidation:m(),noLabelInput:m(),textInput:m()});return(n,e)=>{const i=w("SshPre");return C(),F(O,{title:n.$t("form.label.textarea"),class:"demo"},{toolbar:u(()=>[a(l(h),{label:n.$t("common.back"),"icon-left":"pi pi-chevron-left",size:"medium",variant:"textOnly",onClick:e[0]||(e[0]=s=>n.$router.push("/form"))},null,8,["label"])]),default:u(()=>[e[33]||(e[33]=t()),o("section",null,[o("h2",null,d(n.$t("form.label.basicInput")),1),e[11]||(e[11]=t()),o("div",U,[a(l(p),{modelValue:l(r).noLabelInput,"onUpdate:modelValue":e[1]||(e[1]=s=>l(r).noLabelInput=s),placeholder:n.$t("form.placeholder.input")},null,8,["modelValue","placeholder"]),e[10]||(e[10]=t()),a(i,{language:"html-vue"},{default:u(()=>e[9]||(e[9]=[t(`
          <template>
            <TextareaInput 
              v-model="input"
        ...
        `)])),_:1})])]),e[34]||(e[34]=t()),o("section",null,[o("h2",null,d(n.$t("form.label.labelInput")),1),e[14]||(e[14]=t()),o("div",E,[a(l(p),{modelValue:l(r).input,"onUpdate:modelValue":e[2]||(e[2]=s=>l(r).input=s),label:n.$t("form.label.textarea"),placeholder:n.$t("form.placeholder.textarea")},null,8,["modelValue","label","placeholder"]),e[13]||(e[13]=t()),a(i,{language:"html-vue"},{default:u(()=>e[12]||(e[12]=[t(`
          ...
          import { TextareaInput } from "@prefabs.tech/vue3-form";
          <\/script>
        `)])),_:1})])]),e[35]||(e[35]=t()),o("section",null,[o("h2",null,d(n.$t("form.label.disabled")),1),e[17]||(e[17]=t()),o("div",q,[a(l(p),{modelValue:l(r).disabled,"onUpdate:modelValue":e[3]||(e[3]=s=>l(r).disabled=s),label:n.$t("form.label.disabled"),disabled:""},null,8,["modelValue","label"]),e[16]||(e[16]=t()),a(i,{language:"html-vue"},{default:u(()=>e[15]||(e[15]=[t(`
          <template>
            <TextareaInput 
              v-model="input"
              label="Disabled"
