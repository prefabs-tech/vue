import{d as c,u as y,b as v,e as h,o as A,c as L,w as i,a as r,t as f,f as e,g as a,h as l,r as g}from"./index-4f538d53.js";import{m as D,J as p,z as T}from"./DzangolabVue3Form.es-700da16e.js";const I={class:"demo-section"},V={class:"demo-section"},S={class:"demo-section"},P={class:"demo-section"},$={class:"demo-section"},C={class:"demo-section"},_={name:"InputField"},M=c({..._,setup(k){const{t:m}=y(),b=D.string().min(3,{message:m("form.errors.input.min",{length:3})}),u=[{value:"Roslabel",label:"Roslabel - A fragrant flower often associated with romance"},{value:"Tulip",label:"Tulip - A bright, cup-shaped flower popular in spring"},{value:"Daisy",label:"Daisy - A simple, white flower with a yellow center"},{value:"Sunflower",label:"Sunflower - A tall plant with a large, yellow flower head"},{value:"Lily",label:"Lily - An elegant flower often used in bouquets"},{value:"Orchid",label:"Orchid - An exotic flower with a unique shape"},{value:"Marigold",label:"Marigold - A vibrant, orange or yellow flower"},{value:"Lavender",label:"Lavender - A fragrant flower known for its calming scent"},{value:"Peony",label:"Peony - A lush, full flower often used in weddings"},{value:"Chrysanthemum",label:"Chrysanthemum - A hardy flower with a variety of colors"},{value:"Daffodil",label:"Daffodil - A bright, yellow flower that blooms in spring"},{value:"Hydrangea",label:"Hydrangea - A large, cluster-like flower that changes color"}];let o=v({disabled:h("Lily"),input:h(),inputWithValidation:h(),noLabelInput:h()});return(n,t)=>{const d=g("SshPre"),w=g("Page");return A(),L(w,{title:n.$t("form.label.typeahead")},{default:i(()=>[r("section",I,[r("h3",null,f(n.$t("form.label.basicInput")),1),e(),a(d,{language:"html-vue"},{default:i(()=>[e(`
      ...
      `)]),_:1}),e(),a(l(p),{modelValue:l(o).input,"onUpdate:modelValue":t[1]||(t[1]=s=>l(o).input=s),label:n.$t("form.label.typeahead"),placeholder:n.$t("form.placeholder.input"),suggestions:u,class:"form-field"},null,8,["modelValue","label","placeholder"])]),e(),r("section",S,[r("h3",null,f(n.$t("form.label.disabled")),1),e(),a(d,{language:"html-vue"},{default:i(()=>[e(`
        ...
        <\/script>
      `)]),_:1}),e(),a(l(p),{modelValue:l(o).disabled,"onUpdate:modelValue":t[2]||(t[2]=s=>l(o).disabled=s),label:n.$t("form.label.disabled"),suggestions:u,class:"form-field",type:"text",disabled:""},null,8,["modelValue","label"])]),e(),r("section",P,[r("h3",null,f(n.$t("form.label.debouncedTypeahead")),1),e(),a(d,{language:"html-vue"},{default:i(()=>[e(`
        <template>
          <Typeahead
            v-model="input"
            :debounce-time="1000"
