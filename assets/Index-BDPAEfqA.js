import{j as f}from"./DzangolabVue3TanstackTable.es-CO5qvLH6.js";import{d as I,r as m,K as D,f as P,o as k,i as o,D as t,g as i,t as n,h as l,u as a,a8 as d,v as u,a as $,F as h,y as R}from"./index-B_ky1w5h.js";import{_ as K}from"./UiPage.vue_vue_type_style_index_0_lang-fApRu-gA.js";import"./DzangolabVue3Form.es-BZGdmjZO.js";const A={class:"section-content"},z={class:"section-content"},B={class:"section-content"},L={class:"section-content"},N={class:"section-content"},E={class:"section-content"},j={class:"tab-button-group"},F={class:"section-content"},U={class:"section-content"},O={class:"section-content"},q={class:"section-content"},G={class:"section-content"},X=I({__name:"Index",setup(H){const v=m("1"),c=m(["1"]),w=[{accessorKey:"name",header:"Name"},{accessorKey:"description",header:"Description"}],T=[{description:"Triggers before tab actually change",id:1,name:"beforeTabChange"},{description:"Triggers on active key change",id:2,name:"update:activeKey"},{description:"Triggers on visible tabs change",id:3,name:"update:visibleTabs"}],S=[{accessorKey:"prop",header:"Property"},{accessorKey:"type",header:"Type"},{accessorKey:"default",header:"Default"},{accessorKey:"description",header:"Description"}],V=[{default:"-",description:"Active key of TabView.",id:1,prop:"activeKey",type:"string"},{default:"-",description:"Id of tab to save the state. Should provide 'id' in case of tab state persistence.",id:2,prop:"id",type:"string"},{default:"false",description:"Enable event emitting before tab actually change.",id:3,prop:"interceptTabChange",type:"boolean"},{default:"true",description:"If true, tab state is saved either in localStorage or sessionStorage.",id:4,prop:"persistState",type:"boolean"},{default:"localStorage",id:5,description:"Storage to save tab state.",prop:"persistStateStorage",type:'"localStorage" | "sessionStorage"'},{default:"top",id:6,description:"Position of the tab panel header relative to its content.",prop:"position",type:'"top" | "left" | "bottom" | "right"'},{default:"-",id:7,description:"Array of tab object.",prop:"tabs",type:"Tab[]"},{default:"-",description:"Array of visible tabs.",id:8,prop:"visibleTabs",type:"string[]"}],C=[{accessorKey:"name",header:"Name"},{accessorKey:"description",header:"Description"}],g=[{key:"description",label:"Description"},{key:"review",label:"Reviews"},{key:"specifications",label:"Specifications"},{key:"pricing",label:"Pricing"},{key:"installation",label:"Installation"},{key:"certifications",label:"Certifications"}],p=[{children:"Description",key:"1",label:"Description"},{children:"Reviews",closable:!0,key:"2",label:"Reviews"},{children:"Specifications",closable:!0,key:"3",label:"Specifications"},{children:"Pricing",closable:!0,key:"4",label:"Pricing"},{children:"Installation Instructions",key:"5",label:"Installation"},{children:"Certifications",key:"6",label:"Certifications"}],y=s=>{c.value.includes(s)||(c.value=[...c.value,s]),v.value=s};return(s,e)=>{const b=D("SshPre");return k(),P(K,{title:s.$t("ui.tabView.title"),class:"tab-view"},{toolbar:o(()=>[l(a(u),{label:s.$t("common.back"),"icon-left":"pi pi-chevron-left",size:"medium",variant:"textOnly",onClick:e[0]||(e[0]=r=>s.$router.push("/ui"))},null,8,["label"])]),default:o(()=>[e[36]||(e[36]=t()),i("section",null,[i("h2",null,n(s.$t("ui.tabView.usage.basic")),1),e[8]||(e[8]=t()),i("div",A,[l(a(d),{id:"tab-view",tabs:p,"active-key":"1"}),e[7]||(e[7]=t()),l(b,{language:"html-vue"},{default:o(()=>e[6]||(e[6]=[t(`
          <template>
          ...
          <\/script>
        `)])),_:1})])]),e[37]||(e[37]=t()),i("section",null,[i("h2",null,n(s.$t("ui.tabView.usage.disableTabState.title")),1),e[12]||(e[12]=t()),i("div",z,[i("p",null,n(s.$t("ui.tabView.usage.disableTabState.subtitle")),1),e[10]||(e[10]=t()),l(a(d),{"persist-state":!1,tabs:p,"visible-tabs":["1","5","6"],"active-key":"1"}),e[11]||(e[11]=t()),l(b,{language:"html-vue"},{default:o(()=>e[9]||(e[9]=[t(`
          <template>
            <TabView
              :persist-state="false"
              :tabs="tabs"    
