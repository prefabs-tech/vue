import{m as P,t as m,Z as u}from"./DzangolabVue3Form.es-e605564e.js";import{d as V,a4 as $,l as _,j as c,G as b,o as I,c as F,w as a,K as l,C as e,S as i,f as n,D as o,e as z}from"./index-9834d213-45de56a4.js";import{_ as S}from"./FormPage.vue_vue_type_style_index_0_lang-ab5ae344.js";import"./index-3d10c2c3.js";const y={class:"section-content"},U={class:"section-content"},L={class:"section-content"},O={class:"section-content"},k={class:"section-content"},E={class:"section-content"},q={class:"section-content"},M={class:"section-content"},W={name:"PasswordInputField"},T=V({...W,setup(C){const{t:f}=$(),h=P.string({invalid_type_error:f("form.errors.password.invalid"),required_error:f("form.errors.input.required")}).min(8,{message:f("form.errors.password.min",{length:8})}).regex(/^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)(?=.*[\W_]).+$/,f("form.errors.password.invalid")),g={required:f("form.errors.input.required"),weak:f("form.errors.password.invalid")},w={minLength:10,minLowercase:1,minUppercase:1,minSymbols:1};let t=_({customValidationInput:c(),disabled:c("P@ssw0rd"),input:c(),inputWithValidation:c(),noLabelInput:c(),passwordInput:c()});return(s,d)=>{const v=b("router-link"),p=b("SshPre");return I(),F(S,{title:s.$t("form.label.password"),class:"demo"},{toolbar:a(()=>[l(v,{to:{name:"form"},class:"back"},{default:a(()=>[e(i(s.$t("common.back")),1)]),_:1})]),default:a(()=>[e(),n("section",null,[n("h2",null,i(s.$t("form.label.basicInput")),1),e(),n("div",y,[l(p,{language:"html-vue"},{default:a(()=>[e(`
          <From>
            <Password 
              v-model="input"
