import{m as E,G as u,Z as p}from"./DzangolabVue3Form.es-dfaaf9a3.js";import{d as V,a3 as z,l as I,j as c,E as g,o as $,c as F,w as t,J as a,C as e,Z as r,f as n,N as l}from"./index-66214709-7b57635f.js";import{_ as w}from"./FormPage.vue_vue_type_style_index_0_lang-2c538954.js";import"./index-2f944215.js";const y={class:"section-content"},O={class:"section-content"},U={class:"section-content"},k={class:"section-content"},q={class:"section-content"},M={class:"section-content"},S={class:"section-content"},C={name:"EmailInputField"},Z=V({...C,setup(N){const{t:f}=z(),h=E.string().email({message:f("form.errors.email.invalid")}),v={required:f("form.errors.input.required"),invalid:f("form.errors.email.invalid",{list:"(dzangolab.com, dzango.com, gmail.com)"})},b={allow_display_name:!1,allow_utf8_local_part:!0,host_whitelist:["dzangolab.com","dzango.com","gmail.com"],require_display_name:!1};let i=I({customValidationInput:c(),disabled:c("monorepo@dzangolab.com"),input:c(),inputWithValidation:c(),noLabelInput:c(),textInput:c()});return(o,m)=>{const _=g("router-link"),d=g("SshPre");return $(),F(w,{title:o.$t("form.label.email"),class:"demo"},{toolbar:t(()=>[a(_,{to:{name:"form"},class:"back"},{default:t(()=>[e(r(o.$t("common.back")),1)]),_:1})]),default:t(()=>[e(),n("section",null,[n("h2",null,r(o.$t("form.label.basicInput")),1),e(),n("div",y,[a(d,{language:"html-vue"},{default:t(()=>[e(`
        ...
        `)]),_:1}),e(),a(l(p),null,{default:t(()=>[a(l(u),{modelValue:l(i).textInput,"onUpdate:modelValue":m[5]||(m[5]=s=>l(i).textInput=s),label:o.$t("form.label.email"),"error-messages":l(v),options:l(b),placeholder:o.$t("form.placeholder.email")},null,8,["modelValue","label","error-messages","options","placeholder"])]),_:1})])]),e(),n("section",null,[n("h2",null,r(o.$t("form.label.customValidationInput")),1),e(),n("div",S,[a(d,{language:"html-vue"},{default:t(()=>[e(`
          ...
          <\/script>
        `)]),_:1}),e(),a(l(p),null,{default:t(()=>[a(l(u),{modelValue:l(i).customValidationInput,"onUpdate:modelValue":m[6]||(m[6]=s=>l(i).customValidationInput=s),label:o.$t("form.label.email"),placeholder:o.$t("form.placeholder.email"),schema:l(h),name:"custom_input"},null,8,["modelValue","label","placeholder","schema"])]),_:1})])])]),_:1},8,["title"])}}});export{Z as default};
