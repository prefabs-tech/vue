import{d as r,r as u,o as d,c as g,w as e,a as n,t as i,f as t,g as l,h as s,a5 as m,ah as p}from"./index-64e5f877.js";const h={class:"section-content"},v={class:"section-content"},_={class:"trigger"},f={class:"section-content"},T={class:"trigger"},b={class:"section-content"},$={class:"trigger"},y={class:"section-content"},z={class:"trigger"},k={class:"section-content"},B={class:"trigger"},C={class:"section-content"},P={class:"trigger"},V=r({__name:"Index",setup(w){return(o,N)=>{const a=u("SshPre"),c=u("Page");return d(),g(c,{title:o.$t("ui.tooltip.title"),class:"demo"},{default:e(()=>[n("section",null,[n("h2",null,i(o.$t("ui.tooltip.usage.basic")),1),t(),n("div",h,[l(a,{language:"html-vue"},{default:e(()=>[t(`
          <template>
            <Tooltip>
              <ButtonElement
                :label="Tooltip"
