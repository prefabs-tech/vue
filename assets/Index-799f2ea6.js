import{d as _,e as u,o as w,c as h,w as c,a as e,t as l,f as o,g as i,h as f,a5 as b,Y as M,Z as g,a6 as C,r as d,_ as x}from"./index-ca83194b.js";const $={class:"section-content"},k={class:"container"},y=_({__name:"Index",setup(B){const a=u(void 0),t=u(!1);function m(){a.value=new Date,t.value=!1}return(s,n)=>{const v=d("SshPre"),p=d("Page");return w(),h(p,{title:s.$t("ui.confirmationModal.title"),class:"demo"},{default:c(()=>[e("section",null,[e("h2",null,l(s.$t("ui.confirmationModal.usage.basic")),1),o(),e("div",$,[i(v,{language:"html-vue"},{default:c(()=>[o(`
          <template>
            <div>
              <ButtonElement
                label="Confirm"
