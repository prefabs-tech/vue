import{M as d,P as b}from"./PrefabsTechVue3Form.es-C3-yZ6Wf.js";import{d as $,I as y,L as z,M as O,r as u,J as D,e as F,o as M,j as m,C as e,f as t,h as a,t as f,u as n,v as h}from"./index-DO1TBNbP.js";import{_ as w}from"./ComponentDocumentation.vue_vue_type_script_setup_true_lang-CqQcwUQC.js";import{_ as S}from"./FormPage.vue_vue_type_style_index_0_lang-xMw1OhOp.js";import"./PrefabsTechVue3TanstackTable.es-B2DwPya4.js";const q={class:"section-content"},P={class:"section-content"},U={class:"section-content"},C={class:"section-content"},W={class:"section-content"},k={class:"section-content"},B={class:"section-content"},L={class:"section-content"},N={name:"EmailInputField"},G=$({...N,setup(T){const{t:s}=y(),g=[{description:s("form.documentation.eventDescription.input.modelValue"),name:"update:modelValue",payload:"string | null | undefined"}],E=z.string().email({message:s("form.errors.email.invalid")}),V=[{default:"false",description:s("form.documentation.propsDescription.input.disabled"),prop:"disabled",type:"Boolean"},{default:'{ required: "Email address is required", invalid: "Please provide a valid email address" }',description:s("form.documentation.propsDescription.input.errorMessages"),prop:"errorMessages",type:"EmailErrorMessages"},{default:"-",description:s("form.documentation.propsDescription.input.label"),prop:"label",type:"String"},{default:"-",description:s("form.documentation.propsDescription.input.modelValue"),prop:"modelValue",type:"String | null | undefined"},{default:'"email"',description:s("form.documentation.propsDescription.input.name"),prop:"name",type:"String"},{default:"-",description:s("form.documentation.propsDescription.input.options"),prop:"options",type:"IsEmailOptions"},{default:"-",description:s("form.documentation.propsDescription.input.placeholder"),prop:"placeholder",type:"String"},{default:"-",description:s("form.documentation.propsDescription.input.schema"),prop:"schema",type:"z.ZodType<string | number | object>"}],I={required:s("form.errors.input.required"),invalid:s("form.errors.email.invalid",{list:"(dzangolab.com, dzango.com, gmail.com)"})},v={allow_display_name:!1,allow_utf8_local_part:!0,host_whitelist:["dzangolab.com","dzango.com","gmail.com"],require_display_name:!1};let i=O({customValidationInput:u(),disabled:u("monorepo@prefabs.tech.com"),i18nInput:u(),input:u(),inputWithValidation:u(),noLabelInput:u(),textInput:u(),validationOptionInput:u()});return(o,l)=>{const p=D("SshPre");return M(),F(S,{subtitle:n(s)("form.subtitle.email"),title:o.$t("form.label.email"),class:"demo"},{toolbar:m(()=>[a(n(h),{label:o.$t("common.back"),"icon-left":"pi pi-chevron-left",size:"medium",variant:"textOnly",onClick:l[0]||(l[0]=r=>o.$router.push("/form"))},null,8,["label"])]),default:m(()=>[l[34]||(l[34]=e()),t("section",null,[t("h2",null,f(o.$t("form.label.basicInput")),1),l[11]||(l[11]=e()),t("div",q,[a(n(d),{modelValue:n(i).noLabelInput,"onUpdate:modelValue":l[1]||(l[1]=r=>n(i).noLabelInput=r),placeholder:o.$t("form.placeholder.email")},null,8,["modelValue","placeholder"]),l[10]||(l[10]=e()),a(p,{language:"html-vue"},{default:m(()=>l[9]||(l[9]=[e(`
          ...
          <\/script>
        `)])),_:1})])]),l[35]||(l[35]=e()),t("section",null,[t("h2",null,f(o.$t("form.label.labelInput")),1),l[14]||(l[14]=e()),t("div",P,[a(n(d),{modelValue:n(i).input,"onUpdate:modelValue":l[2]||(l[2]=r=>n(i).input=r),label:o.$t("form.label.email"),placeholder:o.$t("form.placeholder.email")},null,8,["modelValue","label","placeholder"]),l[13]||(l[13]=e()),a(p,{language:"html-vue"},{default:m(()=>l[12]||(l[12]=[e(`
          <template>
            <Email 
              v-model="input"
              label="Email"
          ...
          import { Email } from "@prefabs.tech/vue3-form";
          <\/script>
        `)])),_:1})])]),l[36]||(l[36]=e()),t("section",null,[t("h2",null,f(o.$t("form.label.disabled")),1),l[17]||(l[17]=e()),t("div",U,[a(n(d),{modelValue:n(i).disabled,"onUpdate:modelValue":l[3]||(l[3]=r=>n(i).disabled=r),label:o.$t("form.label.email"),disabled:""},null,8,["modelValue","label"]),l[16]||(l[16]=e()),a(p,{language:"html-vue"},{default:m(()=>l[15]||(l[15]=[e(`
          <template>
            <Email 
              v-model="input"
              label="Email"
