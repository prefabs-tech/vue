import{P as c,$ as h}from"./DzangolabVue3Form.es-0950df2a.js";import{d as V,a7 as D,p as I,j as m,K as g,o as p,c as k,w as u,L as s,C as e,M as i,f as r,E as n,a as b,g as v}from"./index-8e1c3ab6-475a9ed5.js";import{m as F}from"./index-00a59c05.js";import{_ as U}from"./FormPage.vue_vue_type_style_index_0_lang-01c0d475.js";const z={class:"section-content"},E={key:0,class:"result-date"},P={class:"section-content"},S={key:0,class:"result-date"},C={class:"section-content"},w={key:0,class:"result-date"},B={class:"section-content"},N={key:0,class:"result-date"},A={name:"DaysInput"},M=V({...A,setup(q){const{t:y}=D(),$=F.coerce.number({invalid_type_error:y("form.errors.number.required")}).min(1,{message:y("form.errors.daysInput.invalid")}).max(365,{message:y("form.errors.daysInput.invalid")}),o=I({basic:m(),disabled:m(),label:m(),validationInput:m()});let d=I({basic:m(),disabled:m(30),label:m(),validationInput:m()});return(a,t)=>{const _=g("router-link"),f=g("SshPre");return p(),k(U,{title:a.$t("form.label.daysInput"),class:"demo"},{toolbar:u(()=>[s(_,{to:{name:"form"},class:"back"},{default:u(()=>[e(i(a.$t("common.back")),1)]),_:1})]),default:u(()=>[e(),r("section",null,[r("h2",null,i(a.$t("form.label.basicInput")),1),e(),r("div",z,[s(n(c),{modelValue:n(d).basic,"onUpdate:modelValue":t[0]||(t[0]=l=>n(d).basic=l),placeholder:a.$t("form.placeholder.days"),"onUpdate:date":t[1]||(t[1]=l=>o.basic=l)},null,8,["modelValue","placeholder"]),e(),o.basic?(p(),b("div",E,i(o.basic),1)):v("",!0),e(),s(f,{language:"html-vue"},{default:u(()=>[e(`
          <template>
            <DaysInput
              v-model="input"
