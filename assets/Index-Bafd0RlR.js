import{h as v,w as D}from"./PrefabsTechVue3Form.es-Be_J869o.js";import{d as F,L as S,N as U,M as k,o as f,e as w,f as p,h as s,t as u,z as t,a as r,u as n,c as y,b as I,O as g,r as m}from"./index-RPvtGx3x.js";import{_ as z}from"./ComponentDocumentation.vue_vue_type_script_setup_true_lang-BU4nLuL1.js";import{_ as N}from"./FormPage.vue_vue_type_style_index_0_lang-CShZ86aY.js";import"./PrefabsTechVue3TanstackTable.es-Dqi5F_Wh.js";const E={class:"section-content"},B={key:0,class:"result-date"},P={class:"section-content"},C={key:0,class:"result-date"},A={class:"section-content"},T={key:0,class:"result-date"},q={class:"section-content"},L={key:0,class:"result-date"},M={name:"DaysInput"},J=F({...M,setup(O){const{t:i}=S(),V=U.coerce.number({invalid_type_error:i("form.errors.number.required")}).min(1,{message:i("form.errors.daysInput.invalid")}).max(365,{message:i("form.errors.daysInput.invalid")}),c=[{description:i("form.documentation.eventDescription.daysInput.date"),name:"update:date",payload:"date: string"},{description:i("form.documentation.eventDescription.input.modelValue"),name:"update:modelValue",payload:"value: number"}],$=[{default:"false",description:i("form.documentation.propsDescription.input.disabled"),prop:"disabled",type:"Boolean"},{default:"-",description:i("form.documentation.propsDescription.input.label"),prop:"label",type:"String"},{default:"-",description:i("form.documentation.propsDescription.input.modelValue"),prop:"modelValue",type:"Number | Null | Undefined"},{default:'"days-input"',description:i("form.documentation.propsDescription.input.name"),prop:"name",type:"String"},{default:"-",description:i("form.documentation.propsDescription.input.placeholder"),prop:"placeholder",type:"String"},{default:"z.coerce.number().optional()",description:i("form.documentation.propsDescription.input.schema"),prop:"schema",type:"z.ZodType<string | number>"}],a=g({basic:m(),disabled:m(),label:m(),validationInput:m()});let d=g({basic:m(),disabled:m(30),label:m(),validationInput:m()});return(o,e)=>{const b=k("SshPre");return f(),w(N,{subtitle:o.$t("form.subtitle.daysInput"),title:o.$t("form.label.daysInput"),class:"demo"},{default:p(()=>[s("section",null,[s("h2",null,u(o.$t("form.label.basicInput")),1),e[11]||(e[11]=t()),s("div",E,[r(n(v),{modelValue:n(d).basic,"onUpdate:modelValue":e[0]||(e[0]=l=>n(d).basic=l),placeholder:o.$t("form.placeholder.days"),"onUpdate:date":e[1]||(e[1]=l=>a.basic=l)},null,8,["modelValue","placeholder"]),e[9]||(e[9]=t()),a.basic?(f(),y("div",B,u(a.basic),1)):I("",!0),e[10]||(e[10]=t()),r(b,{language:"html-vue"},{default:p(()=>[...e[8]||(e[8]=[t(`
          <template>
            <DaysInput
              v-model="input"
          ...
          const result = ref();
          <\/script>
        `,-1)])]),_:1})])]),e[24]||(e[24]=t()),s("section",null,[s("h2",null,u(o.$t("form.label.labelInput")),1),e[15]||(e[15]=t()),s("div",P,[r(n(D),null,{default:p(()=>[r(n(v),{modelValue:n(d).label,"onUpdate:modelValue":e[2]||(e[2]=l=>n(d).label=l),label:o.$t("form.label.arrivalDate"),placeholder:o.$t("form.placeholder.days"),name:"label-input","onUpdate:date":e[3]||(e[3]=l=>a.label=l)},null,8,["modelValue","label","placeholder"])]),_:1}),e[13]||(e[13]=t()),a.label?(f(),y("div",C,u(a.label),1)):I("",!0),e[14]||(e[14]=t()),r(b,{language:"html-vue"},{default:p(()=>[...e[12]||(e[12]=[t(`
          <Form>
            <DaysInput
              v-model="input"
              label="Arrival date"
        ...
        `,-1)])]),_:1})])]),e[26]||(e[26]=t()),s("section",null,[s("h2",null,u(o.$t("form.label.customValidationInput")),1),e[23]||(e[23]=t()),s("div",q,[r(n(D),null,{default:p(()=>[r(n(v),{modelValue:n(d).validationInput,"onUpdate:modelValue":e[6]||(e[6]=l=>n(d).validationInput=l),label:o.$t("form.label.expiresAfter"),placeholder:o.$t("form.placeholder.days"),schema:n(V),name:"validation-input","onUpdate:date":e[7]||(e[7]=l=>a.validationInput=l)},null,8,["modelValue","label","placeholder","schema"])]),_:1}),e[21]||(e[21]=t()),a.validationInput&&n(d).validationInput>0&&n(d).validationInput<=365?(f(),y("div",L,u(a.validationInput),1)):I("",!0),e[22]||(e[22]=t()),r(b,{language:"html-vue"},{default:p(()=>[...e[20]||(e[20]=[t(`
          ...
          <\/script>
        `,-1)])]),_:1})])]),e[27]||(e[27]=t()),r(z,{"events-data":c,"props-data":$,"props-table-title":o.$t("common.properties",{value:"DaysInputProperties"})},null,8,["props-table-title"])]),_:1},8,["subtitle","title"])}}});export{J as default};
