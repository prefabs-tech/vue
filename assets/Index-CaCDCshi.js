import{Y as v,B as g}from"./DzangolabVue3Form.es-ybitm5cg.js";import{d as D,I as k,J as z,K as $,r as i,H as F,e as U,o as p,h as u,C as n,f as o,t as m,g as r,a as b,b as y,u as l,p as B}from"./index-DdKKv4d1.js";import{_ as C}from"./FormPage.vue_vue_type_style_index_0_lang-DTy6mm1W.js";const E={class:"section-content"},S={key:0,class:"result-date"},N={class:"section-content"},P={key:0,class:"result-date"},w={class:"section-content"},A={key:0,class:"result-date"},q={class:"section-content"},T={key:0,class:"result-date"},Y={name:"DaysInput"},j=D({...Y,setup(H){const{t:I}=k(),V=z.coerce.number({invalid_type_error:I("form.errors.number.required")}).min(1,{message:I("form.errors.daysInput.invalid")}).max(365,{message:I("form.errors.daysInput.invalid")}),s=$({basic:i(),disabled:i(),label:i(),validationInput:i()});let d=$({basic:i(),disabled:i(30),label:i(),validationInput:i()});return(a,e)=>{const f=F("SshPre");return p(),U(C,{title:a.$t("form.label.daysInput"),class:"demo"},{toolbar:u(()=>[r(l(B),{label:a.$t("common.back"),"icon-left":"pi pi-chevron-left",size:"medium",variant:"textOnly",onClick:e[0]||(e[0]=t=>a.$router.push("/form"))},null,8,["label"])]),default:u(()=>[e[25]||(e[25]=n()),o("section",null,[o("h2",null,m(a.$t("form.label.basicInput")),1),e[12]||(e[12]=n()),o("div",E,[r(l(v),{modelValue:l(d).basic,"onUpdate:modelValue":e[1]||(e[1]=t=>l(d).basic=t),placeholder:a.$t("form.placeholder.days"),"onUpdate:date":e[2]||(e[2]=t=>s.basic=t)},null,8,["modelValue","placeholder"]),e[10]||(e[10]=n()),s.basic?(p(),b("div",S,m(s.basic),1)):y("",!0),e[11]||(e[11]=n()),r(f,{language:"html-vue"},{default:u(()=>e[9]||(e[9]=[n(`
          <template>
            <DaysInput
              v-model="input"
