import{K as p,r as f}from"./PrefabsTechVue3Form.es-CMSC9DV6.js";import{d as $,L as y,N as D,M as E,o as M,e as O,f as s,h as o,t as d,z as n,a as r,u as t,O as z,r as b}from"./index-DkcL5sjS.js";import{_ as F}from"./ComponentDocumentation.vue_vue_type_script_setup_true_lang-B69u6IsK.js";import{_ as S}from"./FormPage.vue_vue_type_style_index_0_lang-IKKNfsOz.js";import"./PrefabsTechVue3TanstackTable.es-BptiQ22o.js";const q={class:"section-content"},w={class:"section-content"},U={class:"section-content"},P={class:"section-content"},h={class:"section-content"},B={class:"section-content"},L={class:"section-content"},T={name:"NumberInputDemo"},A=$({...T,setup(W){const{t:i}=y(),g=[{description:i("form.documentation.eventDescription.input.modelValue"),name:"update:modelValue",payload:"number | undefined"}],I=D.coerce.number({invalid_type_error:i("form.errors.number.invalid")}).gte(1,i("form.errors.number.invalid")).lte(100,i("form.errors.number.invalid")),V=[{default:"false",description:i("form.documentation.propsDescription.input.disabled"),prop:"disabled",type:"Boolean"},{default:'{ required: "The field is required", invalid: "Please provide a valid integer field" }',description:i("form.documentation.propsDescription.input.errorMessages"),prop:"errorMessages",type:"NumberErrorMessages"},{default:"-",description:i("form.documentation.propsDescription.input.label"),prop:"label",type:"String"},{default:"undefined",description:i("form.documentation.propsDescription.input.modelValue"),prop:"modelValue",type:"number | null | undefined"},{default:'"number"',description:i("form.documentation.propsDescription.input.name"),prop:"name",type:"String"},{default:"-",description:i("form.documentation.propsDescription.input.options"),prop:"options",type:"IsIntOptions"},{default:"-",description:i("form.documentation.propsDescription.input.placeholder"),prop:"placeholder",type:"String"},{default:"-",description:i("form.documentation.propsDescription.input.schema"),prop:"schema",type:"z.ZodType<string | number>"}],N={invalid:i("form.errors.number.invalid"),required:i("form.errors.number.required")},v={min:1,max:100,allow_leading_zeroes:!1};let a=z({customValidationInput:b(),disabled:b(100),i18nInput:b(),input:b(),inputWithValidation:b(),noLabelInput:b(),textInput:b()});return(l,e)=>{const m=E("SshPre");return M(),O(S,{subtitle:t(i)("form.subtitle.number"),title:l.$t("form.label.number"),class:"demo"},{default:s(()=>[o("section",null,[o("h2",null,d(l.$t("form.label.basicInput")),1),e[9]||(e[9]=n()),o("div",q,[r(t(p),{modelValue:t(a).noLabelInput,"onUpdate:modelValue":e[0]||(e[0]=u=>t(a).noLabelInput=u),placeholder:l.$t("form.placeholder.number")},null,8,["modelValue","placeholder"]),e[8]||(e[8]=n()),r(m,{language:"html-vue"},{default:s(()=>[...e[7]||(e[7]=[n(`
          ...
          <\/script>
        `,-1)])]),_:1})])]),e[29]||(e[29]=n()),o("section",null,[o("h2",null,d(l.$t("form.label.labelInput")),1),e[12]||(e[12]=n()),o("div",w,[r(t(p),{modelValue:t(a).input,"onUpdate:modelValue":e[1]||(e[1]=u=>t(a).input=u),label:l.$t("form.label.number"),placeholder:l.$t("form.placeholder.number"),name:"label-input"},null,8,["modelValue","label","placeholder"]),e[11]||(e[11]=n()),r(m,{language:"html-vue"},{default:s(()=>[...e[10]||(e[10]=[n(`
          <template>
            <NumberInput 
              v-model="input"
              label="Number"
