import{l as d,t as V}from"./DzangolabVue3Form.es-2a2aab70.js";import{d as k,a7 as _,p as O,j as b,K as v,o as z,c as $,w as s,L as t,C as e,M as m,f as l,E as n,as as R}from"./index-4dbfb8c7-0110dc13.js";import{m as S}from"./index-13d5f27c.js";import{_ as B}from"./FormPage.vue_vue_type_style_index_0_lang-328842f1.js";const w={class:"section-content"},C={class:"section-content"},F={class:"section-content"},U={class:"section-content"},L={class:"section-content"},T={name:"RadioInput"},P=k({...T,setup(W){const{t:o}=_(),h=S.string({required_error:o("form.errors.radio.required")}),g=[{label:o("form.label.one"),value:1},{label:o("form.label.two"),value:2},{label:o("form.label.three"),value:3}];let i=O({disabled:b("car"),i18nInput:b(),input:b(),inputWithValidation:b(),noLabelInput:b()});const c=[{label:o("form.label.male"),value:"male"},{label:o("form.label.female"),value:"female"}],f=[{label:o("form.label.bike"),value:"bike"},{label:o("form.label.car"),value:"car"},{label:o("form.label.truck"),value:"truck"}];return(a,u)=>{const I=v("router-link"),p=v("SshPre");return z(),$(B,{title:a.$t("form.label.radio"),class:"demo"},{toolbar:s(()=>[t(I,{to:{name:"form"},class:"back"},{default:s(()=>[e(m(a.$t("common.back")),1)]),_:1})]),default:s(()=>[e(),l("section",null,[l("h2",null,m(a.$t("form.label.basicInput")),1),e(),l("div",w,[t(n(d),{modelValue:n(i).noLabelInput,"onUpdate:modelValue":u[0]||(u[0]=r=>n(i).noLabelInput=r),options:g,name:"basic"},null,8,["modelValue"]),e(),t(p,{language:"html-vue"},{default:s(()=>[e(`
        ...
        `)]),_:1}),e()])]),e(),l("section",null,[l("h2",null,m(a.$t("form.label.withI18n")),1),e(),l("div",U,[t(n(d),{modelValue:n(i).i18nInput,"onUpdate:modelValue":u[3]||(u[3]=r=>n(i).i18nInput=r),label:a.$t("form.label.vehicle"),options:f,direction:"horizontal",name:"i18n-input"},null,8,["modelValue","label"]),e(),t(p,{language:"html-vue"},{default:s(()=>[e(`
          ...
          <\/script>
        `)]),_:1}),e()])]),e(),l("section",null,[l("h2",null,m(a.$t("form.label.inputWithValidation")),1),e(),l("div",L,[t(n(V),null,{default:s(()=>[t(n(d),{modelValue:n(i).inputWithValidation,"onUpdate:modelValue":u[4]||(u[4]=r=>n(i).inputWithValidation=r),label:a.$t("form.label.gender"),options:c,schema:n(h)},null,8,["modelValue","label","schema"]),e(),t(n(R),{label:n(o)("form.label.submit")},null,8,["label"])]),_:1}),e(),t(p,{language:"html-vue"},{default:s(()=>[e(`
          <template>
            <Form>
              <RadioInput 
                v-model="input"
