import{U as r,B as f}from"./DzangolabVue3Form.es-ybitm5cg.js";import{d as V,I as $,J as T,K as z,r as m,H as F,e as U,o as x,h as i,C as t,f as o,t as d,g as u,u as l,p as q}from"./index-DdKKv4d1.js";import{_ as E}from"./FormPage.vue_vue_type_style_index_0_lang-DTy6mm1W.js";const O={class:"section-content"},S={class:"section-content"},w={class:"section-content"},B={class:"section-content"},C={class:"section-content"},k={class:"section-content"},y={class:"section-content"},M={name:"TextInputField"},h=V({...M,setup(W){const{t:b}=$(),I=T.string().length(5,{message:b("form.errors.input.length",{length:5})}),v={required:b("form.errors.input.required")},g={ignore_whitespace:!0,required:!0};let a=z({customValidationInput:m(),disabled:m("dzangolab"),input:m(),inputWithValidation:m(),noLabelInput:m(),textInput:m()});return(e,n)=>{const s=F("SshPre");return x(),U(E,{title:e.$t("form.label.textInput"),class:"demo"},{toolbar:i(()=>[u(l(q),{label:e.$t("common.back"),"icon-left":"pi pi-chevron-left",size:"medium",variant:"textOnly",onClick:n[0]||(n[0]=p=>e.$router.push("/form"))},null,8,["label"])]),default:i(()=>[n[29]||(n[29]=t()),o("section",null,[o("h2",null,d(e.$t("form.label.basicInput")),1),n[10]||(n[10]=t()),o("div",O,[u(l(r),{modelValue:l(a).noLabelInput,"onUpdate:modelValue":n[1]||(n[1]=p=>l(a).noLabelInput=p),placeholder:e.$t("form.placeholder.input")},null,8,["modelValue","placeholder"]),n[9]||(n[9]=t()),u(s,{language:"html-vue"},{default:i(()=>n[8]||(n[8]=[t(`
          <template>
            <TextInput 
              v-model="input"
        ...
        `)])),_:1})])]),n[31]||(n[31]=t()),o("section",null,[o("h2",null,d(e.$t("form.label.disabled")),1),n[16]||(n[16]=t()),o("div",w,[u(l(r),{modelValue:l(a).disabled,"onUpdate:modelValue":n[3]||(n[3]=p=>l(a).disabled=p),label:e.$t("form.label.disabled"),disabled:""},null,8,["modelValue","label"]),n[15]||(n[15]=t()),u(s,{language:"html-vue"},{default:i(()=>n[14]||(n[14]=[t(`
          ...
          <\/script>
        `)])),_:1})])]),n[32]||(n[32]=t()),o("section",null,[o("h2",null,d(e.$t("form.label.withI18n")),1),n[19]||(n[19]=t()),o("div",B,[u(l(r),{modelValue:l(a).input,"onUpdate:modelValue":n[4]||(n[4]=p=>l(a).input=p),label:e.$t("form.label.textInput"),placeholder:e.$t("form.placeholder.textInput")},null,8,["modelValue","label","placeholder"]),n[18]||(n[18]=t()),u(s,{language:"html-vue"},{default:i(()=>n[17]||(n[17]=[t(`
          <template>
            <TextInput 
              v-model="input"
