import{e as d,a as i}from"./DzangolabVue3Form.es-beab3102.js";import{d as v,a7 as I,p as V,j as f,K as c,o as $,c as F,w as o,L as n,C as e,M as m,f as a,E as l}from"./index-66214709-ea91fece.js";import{m as _}from"./index-796c1423.js";import{_ as w}from"./FormPage.vue_vue_type_style_index_0_lang-96715164.js";const y={class:"section-content"},z={class:"section-content"},U={class:"section-content"},k={class:"section-content"},E={class:"section-content"},S={class:"section-content"},T={name:"InputField"},P=v({...T,setup(W){const{t:b}=I(),h=_.string().min(3,{message:b("form.errors.input.min",{length:3})});let r=V({disabled:f("monorepo@gmail.com"),input:f(),inputWithValidation:f(),noLabelInput:f(),passwordInput:f()});return(t,s)=>{const g=c("router-link"),p=c("SshPre");return $(),F(w,{title:t.$t("form.label.input"),class:"demo"},{toolbar:o(()=>[n(g,{to:{name:"form"},class:"back"},{default:o(()=>[e(m(t.$t("common.back")),1)]),_:1})]),default:o(()=>[e(),a("section",null,[a("h2",null,m(t.$t("form.label.basicInput")),1),e(),a("div",y,[n(p,{language:"html-vue"},{default:o(()=>[e(`
          <Form>
            <Input 
              v-model="username"
