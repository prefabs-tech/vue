import{m as P,a as p,s as u}from"./DzangolabVue3Form.es-849f8011.js";import{d as V,u as _,b as $,e as c,o as I,c as y,w as a,a as o,t as m,f as n,g as l,h as e,r as b}from"./index-80461679.js";const F={class:"section-content"},S={class:"section-content"},z={class:"section-content"},U={class:"section-content"},E={class:"section-content"},L={class:"section-content"},O={class:"section-content"},q={class:"section-content"},M={name:"PasswordInputField"},C=V({...M,setup(W){const{t:f}=_(),g=P.string({invalid_type_error:f("form.errors.password.invalid"),required_error:f("form.errors.input.required")}).min(8,{message:f("form.errors.password.min",{length:8})}).regex(/^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)(?=.*[\W_]).+$/,f("form.errors.password.invalid")),h={required:f("form.errors.input.required"),weak:f("form.errors.password.invalid")},w={minLength:10,minLowercase:1,minUppercase:1,minSymbols:1};let t=$({customStyleInput:c(),customValidationInput:c(),disabled:c("P@ssw0rd"),input:c(),inputWithValidation:c(),noLabelInput:c(),passwordInput:c()});return(s,r)=>{const i=b("SshPre"),v=b("Page");return I(),y(v,{title:s.$t("form.label.password"),class:"demo"},{default:a(()=>[o("section",null,[o("h2",null,m(s.$t("form.label.basicInput")),1),n(),o("div",F,[l(i,{language:"html-vue"},{default:a(()=>[n(`
          <From>
            <Password 
              v-model="input"
