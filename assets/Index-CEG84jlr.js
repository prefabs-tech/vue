import{K as f,W as c}from"./PrefabsTechVue3TanstackTable.es-BMoUSgxk.js";import{d as A,u as D,r as T,o as L,h as V,w as u,a as t,t as m,b as l,e as o,f as a,i as I,j as g,k as b,z as S}from"./index-BDuKhqbt.js";import{_ as $}from"./ComponentDocumentation.vue_vue_type_script_setup_true_lang-BlrSq73H.js";import{_ as k}from"./FormPage.vue_vue_type_style_index_0_lang-BdLXtGEG.js";const C={class:"section-content"},P={class:"section-content"},q={class:"section-content"},R={class:"section-content"},H={class:"section-content"},M={class:"section-content"},O={name:"TypeaheadDemo"},E=A({...O,setup(W){const{t:r}=D();let i=I({disabled:g("Lily"),input:g(),inputWithValidation:g(),noLabelInput:g()});const p=[{label:"Roslabel - A fragrant flower often associated with romance",value:"Roslabel"},{label:"Tulip - A bright, cup-shaped flower popular in spring",value:"Tulip"},{label:"Daisy - A simple, white flower with a yellow center",value:"Daisy"},{label:"Sunflower - A tall plant with a large, yellow flower head",value:"Sunflower"},{label:"Lily - An elegant flower often used in bouquets",value:"Lily"},{label:"Orchid - An exotic flower with a unique shape",value:"Orchid"},{label:"Marigold - A vibrant, orange or yellow flower",value:"Marigold"},{label:"Lavender - A fragrant flower known for its calming scent",value:"Lavender"},{label:"Peony - A lush, full flower often used in weddings",value:"Peony"},{label:"Chrysanthemum - A hardy flower with a variety of colors",value:"Chrysanthemum"},{label:"Daffodil - A bright, yellow flower that blooms in spring",value:"Daffodil"},{label:"Hydrangea - A large, cluster-like flower that changes color",value:"Hydrangea"}],h=b(()=>[{description:r("form.documentation.eventDescription.input.modelValue"),name:"update:modelValue",payload:"value: string | number"}]),w=b(()=>S.string().min(3,{message:r("form.errors.input.min",{length:3})})),y=b(()=>[{default:"500",description:r("form.documentation.propsDescription.typeahead.debounceTime"),prop:"debounceTime",type:"Number"},{default:"false",description:r("form.documentation.propsDescription.input.disabled"),prop:"disabled",type:"Boolean"},{default:"-",description:r("form.documentation.propsDescription.input.label"),prop:"label",type:"String"},{default:"-",description:r("form.documentation.propsDescription.input.modelValue"),prop:"modelValue",type:"String | Number | null | undefined"},{default:"-",description:r("form.documentation.propsDescription.input.name"),prop:"name",type:"String"},{default:"-",description:r("form.documentation.propsDescription.input.placeholder"),prop:"placeholder",type:"String"},{default:"-",description:r("form.documentation.propsDescription.input.schema"),prop:"schema",type:"z.ZodType<string | number | object>"},{default:"-",description:r("form.documentation.propsDescription.typeahead.suggestions",{required:!0}),prop:"suggestions",type:"{label?: string; value?: string | number;}"},{default:'"text"',description:r("form.documentation.propsDescription.input.type"),prop:"type",type:"String"}]),v=b(()=>[{description:r("form.documentation.slotDescription.typeahead.suggestion"),name:"suggestion",props:"{ suggestion: {label?: string; value?: string | number;} }"}]);return(n,e)=>{const d=T("SshPre");return L(),V(k,{subtitle:n.$t("form.subtitle.typeahead"),title:n.$t("form.label.typeahead"),class:"demo"},{default:u(()=>[t("section",null,[t("h2",null,m(n.$t("form.label.basicInput")),1),e[8]||(e[8]=l()),t("div",C,[o(a(f),{modelValue:a(i).noLabelInput,"onUpdate:modelValue":e[0]||(e[0]=s=>a(i).noLabelInput=s),placeholder:n.$t("form.placeholder.input"),suggestions:p},null,8,["modelValue","placeholder"]),e[7]||(e[7]=l()),o(d,{language:"html-vue"},{default:u(()=>[...e[6]||(e[6]=[l(`
        ...
        `,-1)])]),_:1})])]),e[28]||(e[28]=l()),t("section",null,[t("h2",null,m(n.$t("form.label.inputWithValidation")),1),e[23]||(e[23]=l()),t("div",M,[o(a(c),null,{default:u(()=>[o(a(f),{modelValue:a(i).inputWithValidation,"onUpdate:modelValue":e[5]||(e[5]=s=>a(i).inputWithValidation=s),label:n.$t("form.label.typeahead"),name:n.$t("form.label.typeahead"),placeholder:n.$t("form.placeholder.input"),schema:w.value,suggestions:p,type:"text"},null,8,["modelValue","label","name","placeholder","schema"])]),_:1}),e[22]||(e[22]=l()),o(d,{language:"html-vue"},{default:u(()=>[...e[21]||(e[21]=[l(`
          ...
          <\/script>
        `,-1)])]),_:1})])]),e[29]||(e[29]=l()),o($,{"events-data":h.value,"props-data":y.value,"props-table-title":n.$t("common.properties",{value:"TypeaheadProperties"}),"slots-data":v.value},null,8,["events-data","props-data","props-table-title","slots-data"])]),_:1},8,["subtitle","title"])}}});export{E as default};
