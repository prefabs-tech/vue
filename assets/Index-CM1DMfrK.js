import{H as b,q as g}from"./DzangolabVue3Form.es-C3zGftW_.js";import{d as S,L as h,M as V,N as I,r as p,K as $,f as c,o as z,i as s,D as e,g as t,t as d,h as u,u as n,l as L,z as F,v as N}from"./index-DXneQVVY.js";import{_ as D}from"./FormPage.vue_vue_type_style_index_0_lang-BwqRb7Md.js";const H={class:"section-content"},U={class:"section-content"},G={class:"section-content"},W={class:"section-content"},y={class:"section-content"},M={class:"section-content"},k={class:"section-content"},C={class:"section-content"},P={class:"section-content"},w={class:"section-content"},B={class:"section-content"},q={name:"SelectInputField"},E=S({...q,setup(K){const{t:f}=h(),v=V.string({invalid_type_error:f("form.errors.multiselect.invalid")}).array().min(1,{message:f("form.errors.multiselect.invalid")});let i=I({customLabelSelect:p(),disabled:p("de"),disabledMultiselect:p(["be","de"]),disabledSortInput:p(),i18nSelect:p(),input:p(),inputWithValidation:p([]),multiselect:p(),multiselectSearch:p(),noLabelInput:p(),selectWithSearch:p()});const r=p([{label:f("form.label.french"),value:"fr"},{label:f("form.label.german"),value:"de"},{disabled:!0,label:f("form.label.dutch"),value:"be"},{label:f("form.label.nepali"),value:"np"},{label:f("form.label.hindi"),value:"hi"}]);return(a,l)=>{const m=$("SshPre");return z(),c(D,{title:a.$t("form.label.select"),class:"demo"},{toolbar:s(()=>[u(n(N),{label:a.$t("common.back"),"icon-left":"pi pi-chevron-left",size:"medium",variant:"textOnly",onClick:l[0]||(l[0]=o=>a.$router.push("/form"))},null,8,["label"])]),default:s(()=>[l[46]||(l[46]=e()),t("section",null,[t("h2",null,d(a.$t("form.label.basicInput")),1),l[14]||(l[14]=e()),t("div",H,[u(n(b),{modelValue:n(i).noLabelInput,"onUpdate:modelValue":l[1]||(l[1]=o=>n(i).noLabelInput=o),options:r.value,placeholder:a.$t("form.placeholder.language")},null,8,["modelValue","options","placeholder"]),l[13]||(l[13]=e()),u(m,{language:"html-vue"},{default:s(()=>l[12]||(l[12]=[e(`
          <template>
            <SelectInput
              v-model="input"
              :options="options"
        ...
        `)])),_:1})])]),l[54]||(l[54]=e()),t("section",null,[t("h2",null,d(a.$t("form.label.multiselectSearch")),1),l[38]||(l[38]=e()),t("div",P,[u(n(b),{modelValue:n(i).multiselectSearch,"onUpdate:modelValue":l[9]||(l[9]=o=>n(i).multiselectSearch=o),label:a.$t("form.label.language"),options:r.value,placeholder:a.$t("form.placeholder.languages"),"search-placeholder":a.$t("form.placeholder.search"),"enable-search":"",multiple:""},null,8,["modelValue","label","options","placeholder","search-placeholder"]),l[37]||(l[37]=e()),u(m,{language:"html-vue"},{default:s(()=>l[36]||(l[36]=[e(`
          ...
          <\/script>
        `)])),_:1})])]),l[55]||(l[55]=e()),t("section",null,[t("h2",null,d(a.$t("form.label.customLabel")),1),l[42]||(l[42]=e()),t("div",w,[u(n(b),{modelValue:n(i).customLabelSelect,"onUpdate:modelValue":l[10]||(l[10]=o=>n(i).customLabelSelect=o),label:a.$t("form.label.language"),options:r.value,placeholder:a.$t("form.placeholder.language"),multiple:""},L({_:2},[F(r.value,(o,O)=>({name:o.value,fn:s(()=>[t("span",null,[l[39]||(l[39]=t("i",{class:"pi pi-user"},null,-1)),e(" "+d(o.label),1)])])}))]),1032,["modelValue","label","options","placeholder"]),l[41]||(l[41]=e()),u(m,{language:"html-vue"},{default:s(()=>l[40]||(l[40]=[e(`
          <template>
            <SelectInput 
              v-model="input"
              :options="options"
