import{d as g,e as h,o as f,c as _,w as o,a as e,t as u,f as t,g as n,h as i,a5 as a,r as m,a0 as y,a1 as B,_ as E}from"./index-45a747cd.js";const c=r=>(y("data-v-b01658bc"),r=r(),B(),r),$={class:"section-content"},z={class:"container"},O={class:"section-content"},C={class:"container"},k={class:"section-content"},I={class:"container"},S={class:"section-content"},w={class:"container"},D={class:"section-content"},N={class:"container"},T={class:"section-content"},P={class:"container"},L={class:"section-content"},R={className:"container"},W={class:"section-content"},M={className:"container"},V=c(()=>e("i",{class:"pi pi-user"},null,-1)),A=c(()=>e("i",{class:"pi pi-user"},null,-1)),j=c(()=>e("i",{class:"pi pi-user"},null,-1)),q={class:"section-content"},F={class:"container"},G={class:"container"},H={class:"section-content"},J={class:"container"},K=c(()=>e("h2",null,"Custom style",-1)),Q={class:"section-content"},U={class:"container"},X=g({__name:"Index",setup(r){const d=h(void 0);function p(){d.value=new Date}return(l,b)=>{const s=m("SshPre"),v=m("Page");return f(),_(v,{title:l.$t("ui.button.title"),class:"demo-button"},{default:o(()=>[e("section",null,[e("h2",null,u(l.$t("ui.button.usage.basic")),1),t(),e("div",$,[n(s,{language:"html-vue"},{default:o(()=>[t(`
          <template> 
        ...
        `)]),_:1}),t(),e("div",P,[n(i(a),{size:"medium",label:l.$t("ui.button.label.textOnly"),variant:"textOnly"},null,8,["label"]),t(),n(i(a),{size:"medium",label:l.$t("ui.button.label.outlined"),variant:"outlined"},null,8,["label"]),t(),n(i(a),{size:"medium",label:l.$t("ui.button.label.default")},null,8,["label"])])])]),t(),e("section",null,[e("h2",null,u(l.$t("ui.button.usage.icons.iconName")),1),t(),e("div",L,[n(s,{language:"html-vue"},{default:o(()=>[t(`
          ...
          <script setup lang="ts"> 
            import { ButtonElement } from "@dzangolab/vue3-ui"; 
          <\/script>
        `)]),_:1}),t(),e("div",R,[n(i(a),{variant:"textOnly",severity:"secondary","icon-left":"pi pi-user"}),t(),n(i(a),{variant:"outlined",severity:"secondary","icon-left":"pi pi-user"}),t(),n(i(a),{variant:"filled","icon-left":"pi pi-user"})])])]),t(),e("section",null,[e("h2",null,u(l.$t("ui.button.usage.icons.iconElement")),1),t(),e("div",W,[n(s,{language:"html-vue"},{default:o(()=>[t(`
          <template> 
          ...
          <script setup lang="ts"> 
            import { ButtonElement } from "@dzangolab/vue3-ui"; 
          <\/script>
        `)]),_:1}),t(),e("div",M,[n(i(a),{variant:"textOnly",severity:"secondary","icon-left":"true",rounded:""},{iconLeft:o(()=>[V]),_:1}),t(),n(i(a),{severity:"secondary",variant:"outlined","icon-right":"true",rounded:""},{iconRight:o(()=>[A]),_:1}),t(),n(i(a),{"icon-right":"true",variant:"filled",rounded:""},{iconRight:o(()=>[j]),_:1})])])]),t(),e("section",null,[e("h2",null,u(l.$t("ui.button.usage.icons.iconWithText")),1),t(),e("div",q,[n(s,{language:"html-vue"},{default:o(()=>[t(`
          <template> 
          ...
          <script setup lang="ts"> 
            import { ButtonElement } from "@dzangolab/vue3-ui"; 
          <\/script>
        `)]),_:1}),t(),e("div",F,[n(i(a),{label:l.$t("ui.button.label.textOnly"),"icon-left":"pi pi-user",variant:"textOnly"},null,8,["label"]),t(),n(i(a),{label:l.$t("ui.button.label.outlined"),"icon-left":"pi pi-user",variant:"outlined"},null,8,["label"]),t(),n(i(a),{label:l.$t("ui.button.label.default"),"icon-left":"pi pi-user",variant:"filled"},null,8,["label"])]),t(),e("div",G,[n(i(a),{label:l.$t("ui.button.label.textOnly"),"icon-right":"pi pi-user",rounded:"",variant:"textOnly"},null,8,["label"]),t(),n(i(a),{label:l.$t("ui.button.label.outlined"),"icon-right":"pi pi-user",rounded:"",variant:"outlined"},null,8,["label"]),t(),n(i(a),{label:l.$t("ui.button.label.default"),"icon-right":"pi pi-user",rounded:"",variant:"filled"},null,8,["label"])])])]),t(),e("section",null,[e("h2",null,u(l.$t("ui.button.usage.redirect")),1),t(),e("div",H,[n(s,{language:"html-vue"},{default:o(()=>[t(`
          <template> 
