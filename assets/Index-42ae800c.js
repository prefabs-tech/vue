import{I as i,t as g}from"./DzangolabVue3Form.es-2a2aab70.js";import{d as v,a7 as I,p as V,j as d,K as c,o as $,c as w,w as m,L as a,C as e,M as u,f as t,E as l}from"./index-4dbfb8c7-0110dc13.js";import{m as y}from"./index-13d5f27c.js";import{_ as z}from"./FormPage.vue_vue_type_style_index_0_lang-328842f1.js";const _={class:"section-content"},U={class:"section-content"},k={class:"section-content"},E={class:"section-content"},S={class:"section-content"},T={class:"section-content"},W={name:"InputField"},P=v({...W,setup(C){const{t:f}=I(),b=y.string().min(3,{message:f("form.errors.input.min",{length:3})});let o=V({disabled:d("monorepo@gmail.com"),input:d(),inputWithValidation:d(),noLabelInput:d(),passwordInput:d()});return(n,s)=>{const h=c("router-link"),p=c("SshPre");return $(),w(z,{title:n.$t("form.label.input"),class:"demo"},{toolbar:m(()=>[a(h,{to:{name:"form"},class:"back"},{default:m(()=>[e(u(n.$t("common.back")),1)]),_:1})]),default:m(()=>[e(),t("section",null,[t("h2",null,u(n.$t("form.label.basicInput")),1),e(),t("div",_,[a(l(i),{modelValue:l(o).noLabelInput,"onUpdate:modelValue":s[0]||(s[0]=r=>l(o).noLabelInput=r),placeholder:n.$t("form.placeholder.username"),type:"text"},null,8,["modelValue","placeholder"]),e(),a(p,{language:"html-vue"},{default:m(()=>[e(`
          <template>
            <Input 
              v-model="username"
        ...
        `)]),_:1}),e()])]),e(),t("section",null,[t("h2",null,u(n.$t("form.label.inputWithType")),1),e(),t("div",k,[a(l(i),{modelValue:l(o).passwordInput,"onUpdate:modelValue":s[2]||(s[2]=r=>l(o).passwordInput=r),label:n.$t("form.label.password"),placeholder:n.$t("form.placeholder.password"),type:"password"},null,8,["modelValue","label","placeholder"]),e(),a(p,{language:"html-vue"},{default:m(()=>[e(`
          ...
          import { Input } from "@dzangolab/vue3-form";
          <\/script>
        `)]),_:1}),e()])]),e(),t("section",null,[t("h2",null,u(n.$t("form.label.disabled")),1),e(),t("div",E,[a(l(i),{modelValue:l(o).disabled,"onUpdate:modelValue":s[3]||(s[3]=r=>l(o).disabled=r),label:n.$t("form.label.email"),type:"email",disabled:""},null,8,["modelValue","label"]),e(),a(p,{language:"html-vue"},{default:m(()=>[e(`
          <template>
            <Input 
              v-model="email"
              label="Email"
