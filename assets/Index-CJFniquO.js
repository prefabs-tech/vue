import{h as v,w as g}from"./PrefabsTechVue3Form.es-DZTCjbbV.js";import{d as D,I as F,L as U,M as V,r as u,J as k,e as w,o as m,i,f as r,B as t,t as p,h as o,a as b,b as y,u as n}from"./index-BPTdnMQV.js";import{_ as E}from"./FormPage.vue_vue_type_style_index_0_lang-BsJ4Vj9c.js";const S={class:"section-content"},B={key:0,class:"result-date"},z={class:"section-content"},C={key:0,class:"result-date"},N={class:"section-content"},P={key:0,class:"result-date"},A={class:"section-content"},q={key:0,class:"result-date"},T={name:"DaysInput"},G=D({...T,setup(J){const{t:I}=F(),$=U.coerce.number({invalid_type_error:I("form.errors.number.required")}).min(1,{message:I("form.errors.daysInput.invalid")}).max(365,{message:I("form.errors.daysInput.invalid")}),s=V({basic:u(),disabled:u(),label:u(),validationInput:u()});let d=V({basic:u(),disabled:u(30),label:u(),validationInput:u()});return(a,e)=>{const f=k("SshPre");return m(),w(E,{title:a.$t("form.label.daysInput"),class:"demo"},{default:i(()=>[r("section",null,[r("h2",null,p(a.$t("form.label.basicInput")),1),e[11]||(e[11]=t()),r("div",S,[o(n(v),{modelValue:n(d).basic,"onUpdate:modelValue":e[0]||(e[0]=l=>n(d).basic=l),placeholder:a.$t("form.placeholder.days"),"onUpdate:date":e[1]||(e[1]=l=>s.basic=l)},null,8,["modelValue","placeholder"]),e[9]||(e[9]=t()),s.basic?(m(),b("div",B,p(s.basic),1)):y("",!0),e[10]||(e[10]=t()),o(f,{language:"html-vue"},{default:i(()=>e[8]||(e[8]=[t(`
          <template>
            <DaysInput
              v-model="input"
