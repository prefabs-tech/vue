import{d as g,J as p,o as b,c as m,w as s,K as a,D as t,ao as v,W as e,f as l,L as d,at as i,ap as h,aq as f}from"./index-729398ab-b294403d.js";import{_}from"./UiPage.vue_vue_type_style_index_0_lang-ae0d4afa.js";import{_ as y}from"./index-2f56db22.js";const r=u=>(h("data-v-6f4cd0b3"),u=u(),f(),u),B={class:"section-content"},$={class:"section-content"},k={class:"section-content"},I={class:"section-content"},w={class:"container"},z={class:"section-content"},L={class:"container"},S={class:"section-content"},C={class:"container"},P={class:"section-content"},D={class:"container"},N={class:"section-content"},R={class:"container"},U=r(()=>l("i",{class:"pi pi-check"},null,-1)),V=r(()=>l("i",{class:"pi pi-times"},null,-1)),W=g({__name:"Index",setup(u){return(n,c)=>{const o=p("SshPre");return b(),m(_,{title:n.$t("ui.badge.title"),class:"demo-badge"},{toolbar:s(()=>[a(t(v),{label:n.$t("common.back"),"icon-left":"pi pi-chevron-left",size:"medium",variant:"textOnly",onClick:c[0]||(c[0]=A=>n.$router.push("/ui"))},null,8,["label"])]),default:s(()=>[e(),l("section",null,[l("h2",null,d(n.$t("ui.badge.usage.basic")),1),e(),l("div",B,[a(t(i),{label:n.$t("ui.badge.label.basic")},null,8,["label"]),e(),a(o,{language:"html-vue"},{default:s(()=>[e(`
          <template>
            <Badge label="Basic" /> 
          </template>
