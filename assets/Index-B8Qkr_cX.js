import{d as p,K as r,f as g,o as b,i as a,D as n,g as l,t as u,h as o,u as i,a1 as s,v as m,_ as v}from"./index-CSsCuN9S.js";import{_ as f}from"./UiPage.vue_vue_type_style_index_0_lang-D8MPKkjX.js";const C={class:"section-content"},B={class:"section-content"},y={class:"section-content"},$={class:"section-content"},k={class:"container"},z={class:"section-content"},w={class:"container"},I={class:"section-content"},L={class:"container"},S={class:"section-content"},P={class:"container"},D={class:"section-content"},N={class:"container"},R=p({__name:"Index",setup(V){return(t,e)=>{const d=r("SshPre");return b(),g(f,{title:t.$t("ui.badge.title"),class:"demo-badge"},{toolbar:a(()=>[o(i(m),{label:t.$t("common.back"),"icon-left":"pi pi-chevron-left",size:"medium",variant:"textOnly",onClick:e[0]||(e[0]=A=>t.$router.push("/ui"))},null,8,["label"])]),default:a(()=>[e[36]||(e[36]=n()),l("section",null,[l("h2",null,u(t.$t("ui.badge.usage.basic")),1),e[3]||(e[3]=n()),l("div",C,[o(i(s),{label:t.$t("ui.badge.label.basic")},null,8,["label"]),e[2]||(e[2]=n()),o(d,{language:"html-vue"},{default:a(()=>e[1]||(e[1]=[n(`
          <template>
        ...
        `)])),_:1})])]),e[43]||(e[43]=n()),l("section",null,[l("h2",null,u(t.$t("ui.badge.usage.iconElement")),1),e[35]||(e[35]=n()),l("div",D,[l("div",N,[o(i(s),{label:t.$t("ui.badge.label.correct")},{iconLeft:a(()=>e[30]||(e[30]=[l("i",{class:"pi pi-check"},null,-1)])),_:1},8,["label"]),e[32]||(e[32]=n()),o(i(s),{label:t.$t("ui.badge.label.wrong"),severity:"danger"},{iconRight:a(()=>e[31]||(e[31]=[l("i",{class:"pi pi-times"},null,-1)])),_:1},8,["label"])]),e[34]||(e[34]=n()),o(d,{language:"html-vue"},{default:a(()=>e[33]||(e[33]=[n(`
          ...
          import { BadgeComponent } from "@dzangolab/vue3-ui";
          <\/script>
        `)])),_:1})])])]),_:1},8,["title"])}}}),E=v(R,[["__scopeId","data-v-ae3e574d"]]);export{E as default};
