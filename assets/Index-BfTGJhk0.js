import{_ as s,S as f}from"./DzangolabVue3Form.es-ByH_DYOt.js";import{d as V,J as N,L as $,M as z,r as d,I as E,e as F,o as O,i as m,E as e,f as o,t as p,g as r,u as l,x as S}from"./index-pg879in7.js";import{_ as w}from"./FormPage.vue_vue_type_style_index_0_lang-CcX4MMZ5.js";const M={class:"section-content"},U={class:"section-content"},y={class:"section-content"},k={class:"section-content"},q={class:"section-content"},C={class:"section-content"},L={class:"section-content"},P={name:"NumberInputField"},J=V({...P,setup(W){const{t:b}=N(),g=$.coerce.number({invalid_type_error:b("form.errors.number.invalid")}).gte(1,b("form.errors.number.invalid")).lte(100,b("form.errors.number.invalid")),I={invalid:b("form.errors.number.invalid"),required:b("form.errors.number.required")},v={min:1,max:100,allow_leading_zeroes:!1};let a=z({customValidationInput:d(),disabled:d(100),i18nInput:d(),input:d(),inputWithValidation:d(),noLabelInput:d(),textInput:d()});return(t,n)=>{const i=E("SshPre");return O(),F(w,{title:t.$t("form.label.number"),class:"demo"},{toolbar:m(()=>[r(l(S),{label:t.$t("common.back"),"icon-left":"pi pi-chevron-left",size:"medium",variant:"textOnly",onClick:n[0]||(n[0]=u=>t.$router.push("/form"))},null,8,["label"])]),default:m(()=>[n[29]||(n[29]=e()),o("section",null,[o("h2",null,p(t.$t("form.label.basicInput")),1),n[10]||(n[10]=e()),o("div",M,[r(l(s),{modelValue:l(a).noLabelInput,"onUpdate:modelValue":n[1]||(n[1]=u=>l(a).noLabelInput=u),placeholder:t.$t("form.placeholder.number")},null,8,["modelValue","placeholder"]),n[9]||(n[9]=e()),r(i,{language:"html-vue"},{default:m(()=>n[8]||(n[8]=[e(`
          <template>
            <NumberInput 
              v-model="input"
          ...
          <\/script>
        `)])),_:1})])]),n[30]||(n[30]=e()),o("section",null,[o("h2",null,p(t.$t("form.label.labelInput")),1),n[13]||(n[13]=e()),o("div",U,[r(l(s),{modelValue:l(a).input,"onUpdate:modelValue":n[2]||(n[2]=u=>l(a).input=u),label:t.$t("form.label.number"),placeholder:t.$t("form.placeholder.number")},null,8,["modelValue","label","placeholder"]),n[12]||(n[12]=e()),r(i,{language:"html-vue"},{default:m(()=>n[11]||(n[11]=[e(`
          <template>
            <NumberInput 
              v-model="input"
              label="Number"
          ...
          import { NumberInput } from "@dzangolab/vue3-form";
          <\/script>
        `)])),_:1})])]),n[31]||(n[31]=e()),o("section",null,[o("h2",null,p(t.$t("form.label.disabled")),1),n[16]||(n[16]=e()),o("div",y,[r(l(s),{modelValue:l(a).disabled,"onUpdate:modelValue":n[3]||(n[3]=u=>l(a).disabled=u),label:t.$t("form.label.number"),disabled:""},null,8,["modelValue","label"]),n[15]||(n[15]=e()),r(i,{language:"html-vue"},{default:m(()=>n[14]||(n[14]=[e(`
          <template>
            <NumberInput 
              v-model="input"
              label="Number"
