import{Y as y,O as R}from"./PrefabsTechVue3Form.es-DV1FRZxy.js";import{d as F,I as A,a7 as z,r as x,N as E,L,e as T,o as O,j as r,C as t,f as o,h as s,t as p,u as i,a8 as c,v as b,a4 as U}from"./index-STrZF6Wn.js";import{_ as Y}from"./ComponentDocumentation.vue_vue_type_script_setup_true_lang-Dl_YUsvn.js";import{_ as j}from"./UiPage.vue_vue_type_style_index_0_lang-DcWhYAEI.js";import"./PrefabsTechVue3TanstackTable.es-BN3dqrFI.js";const W={class:"section-content"},q={class:"section-content"},G={class:"section-content"},H={class:"section-content"},J={class:"demo-stepper-content-wrapper"},K={class:"demo-stepper-buttons-wrapper"},M={class:"section-content"},Q={class:"demo-stepper-wrapper"},X={class:"demo-stepper-content-actions"},Z={class:"demo-stepper-content-wrapper"},_={class:"demo-stepper-buttons-wrapper"},re=F({__name:"Index",setup(ee){const{t:l}=A(),I=z(),a=x(0),u=x(0),d=E({name:null,phone:null,price:"$50"}),C=[{description:l("ui.stepper.documentation.eventDescription.complete"),name:"complete",payload:"-"},{description:l("ui.stepper.documentation.eventDescription.updateActiveIndex"),name:"update:activeIndex",payload:"activeIndex: number"}],P=[{label:"Personal"},{label:"Children"},{label:"Payment"},{label:"Confirmation"}],$={iconRight:"pi pi-chevron-right",label:"Next",severity:"primary",variant:"filled"},h={iconLeft:"pi pi-chevron-left",label:"Back",severity:"secondary",variant:"filled"},S=[{default:"-",description:l("ui.stepper.documentation.propsDescription.activeIndex"),prop:"activeIndex",type:"Number"},{default:"start",description:l("ui.stepper.documentation.propsDescription.start"),prop:"align",type:"start | center | end"},{default:"horizontal",description:l("ui.stepper.documentation.propsDescription.direction"),prop:"direction",type:"horizontal | vertical"},{default:"false",description:l("ui.stepper.documentation.propsDescription.hideButtons"),prop:"hideButtons",type:"Boolean"},{default:"-",description:l("ui.stepper.documentation.propsDescription.nextButton"),prop:"nextButtonProperties",type:"ActionButtonProperties"},{default:"-",description:l("ui.stepper.documentation.propsDescription.previousButton"),prop:"previousButtonProperties",type:"ActionButtonProperties"},{default:"-",description:l("ui.stepper.documentation.propsDescription.steps"),prop:"steps",type:"Array<StepProperties>"}],B=[{description:l("ui.stepper.documentation.slotDescription.step"),name:"{step}"}],f=[{content:"Please enter your personal details",label:"Personal",step:1,subtitle:"Personal information"},{content:"Please enter your contact details",label:"Contact",step:2,subtitle:"Contact information"},{content:"Please enter your payment details",label:"Payment",step:3,subtitle:"Payment information"},{content:"Confirm your details",label:"Confirmation",step:4,subtitle:"Confirm your details"}],D=()=>{I.push("/ui")},N=()=>{a.value<P.length-1&&a.value++},w=()=>{a.value>0&&a.value--},k=()=>{u.value<P.length-1&&u.value++},V=()=>{u.value>0&&u.value--},g=n=>{switch(n){case 0:return"Personal details";case 1:return"Family details";case 2:return"Payment details";case 3:return"Confirm submit"}};return(n,e)=>{const m=L("SshPre");return O(),T(j,{"sub-title":n.$t("ui.stepper.subtitle"),title:n.$t("ui.stepper.title"),class:"demo-stepper"},{toolbar:r(()=>[s(i(b),{label:n.$t("common.back"),"icon-left":"pi pi-chevron-left",size:"medium",variant:"textOnly",onClick:e[0]||(e[0]=v=>n.$router.push("/ui"))},null,8,["label"])]),default:r(()=>[e[30]||(e[30]=t()),o("section",null,[o("h2",null,p(n.$t("ui.stepper.usage.basic")),1),e[6]||(e[6]=t()),o("div",W,[s(i(c),{steps:f,onComplete:D}),e[5]||(e[5]=t()),s(m,{language:"html-vue"},{default:r(()=>e[4]||(e[4]=[t(`
          ...
          <\/script>
        `)])),_:1})])]),e[31]||(e[31]=t()),o("section",null,[o("h2",null,p(n.$t("ui.stepper.usage.vertical")),1),e[9]||(e[9]=t()),o("div",q,[s(i(c),{direction:"vertical",steps:f}),e[8]||(e[8]=t()),s(m,{language:"html-vue"},{default:r(()=>e[7]||(e[7]=[t(`
          <template>
        ...
        `)])),_:1})])]),e[34]||(e[34]=t()),o("section",null,[o("h2",null,p(n.$t("ui.stepper.usage.verticalControlled")),1),e[28]||(e[28]=t()),o("div",M,[o("div",Q,[s(i(c),{"active-index":u.value,steps:f,direction:"vertical","hide-buttons":""},null,8,["active-index"]),e[24]||(e[24]=t()),s(i(U),{orientation:"vertical"}),e[25]||(e[25]=t()),o("div",X,[o("div",Z,[o("h3",null,p(g(u.value)),1)]),e[23]||(e[23]=t()),o("div",_,[s(i(b),{disabled:u.value===0,label:n.$t("ui.stepper.label.previous"),variant:"outlined",onClick:V},null,8,["disabled","label"]),e[22]||(e[22]=t()),s(i(b),{label:n.$t("ui.stepper.label.next"),onClick:k},null,8,["label"])])])]),e[27]||(e[27]=t()),s(m,{language:"html-vue"},{default:r(()=>e[26]||(e[26]=[t(`
          ...
          <\/script>
        `)])),_:1})])]),e[35]||(e[35]=t()),s(Y,{"events-data":C,"props-data":S,"props-table-title":n.$t("common.properties",{value:"StepperProperties"}),"slots-data":B},null,8,["props-table-title"]),e[36]||(e[36]=t()),s(m,{language:"html-vue"},{default:r(()=>e[29]||(e[29]=[t(`
