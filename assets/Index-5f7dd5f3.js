import{d as O,e as d,o as L,c as z,w as i,a as o,t as r,f as e,g as l,h as s,a5 as u,Y as f,Z as v,a7 as c,r as B}from"./index-ca7167fa.js";const D={class:"section-content"},I={class:"container"},S={class:"section-content"},P={class:"container"},T={class:"section-content"},N={class:"container"},U={class:"section-content"},V={class:"container"},F={class:"section-content"},H={class:"container"},A={class:"section-content"},G={class:"container"},Y={class:"section-content"},Z={class:"container"},j=o("h2",null,"Custom style",-1),q={class:"section-content"},J={class:"container"},R=O({__name:"Index",setup(K){const b=d(void 0),p=d(!1),M=d(!1),w=d(!1),h=d(!1),g=d(!1),C=d(!1),$=d(!1),y=d(!1);function k(){b.value=new Date,y.value=!1}return(t,n)=>{const m=B("SshPre"),E=B("Page");return L(),z(E,{title:t.$t("ui.confirmationModal.title"),class:"demo"},{default:i(()=>[o("section",null,[o("h2",null,r(t.$t("ui.confirmationModal.usage.basic")),1),e(),o("div",D,[l(m,{language:"html-vue"},{default:i(()=>[e(`
          <template>
            <div>
              <ButtonElement
                label="Confirm"
          ...
          <\/script>
        `,1)]),_:1}),e(),o("div",I,[l(s(u),{label:t.$t("ui.confirmationModal.buttonLabel.confirm"),severity:"success",onClick:n[0]||(n[0]=a=>y.value=!0)},null,8,["label"]),e(),o("span",null,r(b.value),1)]),e(),f(l(s(c),{"onOn:close":n[1]||(n[1]=a=>y.value=!1),"onOn:confirm":n[2]||(n[2]=a=>k())},null,512),[[v,y.value]])])]),e(),o("section",null,[o("h2",null,r(t.$t("ui.confirmationModal.usage.withBorder")),1),e(),o("div",S,[l(m,{language:"html-vue"},{default:i(()=>[e(`
          <template>
            <div>
              <ButtonElement
                label="Confirm"
        ...
        `)]),_:1}),e(),o("div",G,[l(s(u),{label:t.$t("ui.confirmationModal.buttonLabel.confirm"),severity:"success",onClick:n[15]||(n[15]=a=>M.value=!0)},null,8,["label"]),e(),o("span",null,r(b.value),1)]),e(),f(l(s(c),{"onOn:close":n[16]||(n[16]=a=>M.value=!1),"onOn:confirm":n[17]||(n[17]=a=>M.value=!1)},{header:i(()=>[o("span",null,r(t.$t("ui.confirmationModal.headerContent.deleteUser")),1)]),body:i(()=>[o("p",null,r(t.$t("ui.confirmationModal.bodyContent.confirmDelete")),1)]),footer:i(()=>[l(s(u),{size:"small",label:t.$t("ui.confirmationModal.buttonLabel.cancel"),severity:"secondary"},null,8,["label"]),e(),l(s(u),{size:"small",label:t.$t("ui.confirmationModal.buttonLabel.delete"),severity:"danger"},null,8,["label"])]),_:1},512),[[v,M.value]])])]),e(),o("section",null,[o("h2",null,r(t.$t("ui.confirmationModal.usage.withI18n")),1),e(),o("div",Y,[l(m,{language:"html-vue"},{default:i(()=>[e(`
          ...
          <script setup lang="ts">
            ...
            const { t } = useI18n();
          <\/script>
        `)]),_:1}),e(),o("div",Z,[l(s(u),{label:t.$t("ui.confirmationModal.buttonLabel.confirm"),severity:"success",onClick:n[18]||(n[18]=a=>$.value=!0)},null,8,["label"]),e(),o("span",null,r(b.value),1)]),e(),f(l(s(c),{"onOn:close":n[19]||(n[19]=a=>$.value=!1),"onOn:confirm":n[20]||(n[20]=a=>$.value=!1)},{header:i(()=>[o("span",null,r(t.$t("ui.confirmationModal.headerContent.deleteUser")),1)]),body:i(()=>[o("p",null,r(t.$t("ui.confirmationModal.bodyContent.confirmDelete")),1)]),footer:i(()=>[l(s(u),{size:"small",label:t.$t("ui.confirmationModal.buttonLabel.cancel"),severity:"secondary"},null,8,["label"]),e(),l(s(u),{size:"small",label:t.$t("ui.confirmationModal.buttonLabel.delete"),severity:"danger"},null,8,["label"])]),_:1},512),[[v,$.value]])])]),e(),o("section",null,[j,e(),o("div",q,[l(m,{language:"html-vue"},{default:i(()=>[e(`
          <template>
            <div>
              <ButtonElement
                label="Confirm"
        ...
        `)]),_:1}),e(),o("div",J,[l(s(u),{label:t.$t("ui.confirmationModal.buttonLabel.confirm"),severity:"success",onClick:n[21]||(n[21]=a=>w.value=!0)},null,8,["label"])]),e(),f(l(s(c),{class:"custom-modal","onOn:close":n[22]||(n[22]=a=>w.value=!1),"onOn:confirm":n[23]||(n[23]=a=>w.value=!1)},null,512),[[v,w.value]])])])]),_:1},8,["title"])}}});export{R as default};
