import{m as v,J as m,Q as d}from"./DzangolabVue3Form.es-f1aff063.js";import{d as w,u as _,b as I,e as p,r as f,o as V,c as S,w as a,a as l,t as c,f as e,g as t,h as n}from"./index-18749d74.js";const y={class:"section-content"},F={class:"section-content"},$={class:"section-content"},z={class:"section-content"},k={class:"section-content"},U={class:"section-content"},P={name:"SwitchInput"},D=w({...P,setup(W){const{t:b}=_(),h=v.coerce.boolean().refine(o=>o===!0,{message:b("form.errors.switch.invalid")});let s=I({customStyleInput:p(),disabled:p(!0),input:p(),inputWithValidation:p(!1),noLabelInput:p()});return(o,u)=>{const r=f("SshPre"),g=f("Page");return V(),S(g,{title:o.$t("form.label.switch"),class:"demo"},{default:a(()=>[l("section",null,[l("h2",null,c(o.$t("form.label.basicInput")),1),e(),l("div",y,[t(r,{language:"html-vue"},{default:a(()=>[e(`
          <Form>
            <SwitchInput
              v-model="input"
            />
