import{d as p,N as m,o as g,e as f,f as s,h as o,t as c,A as n,a,u as i,l as v,S as b,r as L}from"./index-B9ZmqYta.js";import{_}from"./ComponentDocumentation.vue_vue_type_script_setup_true_lang-C2ZcW6A4.js";import{_ as $}from"./UiPage.vue_vue_type_style_index_0_lang-BcFeViHD.js";import"./PrefabsTechVue3TanstackTable.es-ReUmQKMM.js";import"./PrefabsTechVue3Form.es-BveMBhI2.js";const k={class:"section-content"},B={class:"container"},T=p({__name:"Index",setup(C){const l=L(!1),r=[{default:"false",description:"Controls the visibility of the loading overlay.",prop:"loading",type:"Boolean"}],u=()=>{l.value=!0,setTimeout(()=>{l.value=!1},5e3)};return(e,t)=>{const d=m("SshPre");return g(),f($,{subtitle:e.$t("ui.loading.subtitle"),title:e.$t("ui.loading.title"),class:"demo-loading"},{default:s(()=>[o("section",null,[o("h2",null,c(e.$t("ui.loading.usage.basic")),1),t[3]||(t[3]=n()),o("div",k,[o("div",B,[a(i(v),{label:e.$t("ui.loading.buttonLabel.clickMe"),onClick:u},null,8,["label"]),t[0]||(t[0]=n()),a(i(b),{loading:l.value},null,8,["loading"])]),t[2]||(t[2]=n()),a(d,{language:"html-vue"},{default:s(()=>[...t[1]||(t[1]=[n(`
          <template>
