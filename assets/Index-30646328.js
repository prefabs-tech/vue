import{d,r as u,o as g,c as m,w as o,f as l,g as t,t as i,a as n,h as s,a5 as h,ah as p}from"./index-a50c4f8e.js";const v={class:"section-content"},_={class:"section-content"},f={class:"trigger"},T={class:"section-content"},b={class:"trigger"},$={class:"section-content"},y={class:"trigger"},k={class:"section-content"},z={class:"trigger"},B={class:"section-content"},C={class:"trigger"},P={class:"section-content"},w={class:"trigger"},D=d({__name:"Index",setup(N){return(e,S)=>{const c=u("router-link"),a=u("SshPre"),r=u("Page");return g(),m(r,{title:e.$t("ui.tooltip.title"),class:"demo"},{toolbar:o(()=>[l(c,{to:{name:"ui"},class:"back"},{default:o(()=>[t(i(e.$t("common.back")),1)]),_:1})]),default:o(()=>[t(),n("section",null,[n("h2",null,i(e.$t("ui.tooltip.usage.basic")),1),t(),n("div",v,[l(a,{language:"html-vue"},{default:o(()=>[t(`
          <template>
            <Tooltip>
              <ButtonElement
                :label="Tooltip"
