import{m as k,X as d,Z as u}from"./DzangolabVue3Form.es-77391d6b.js";import{d as V,u as P,b as y,e as c,r as b,o as F,c as $,w as l,a as t,t as p,f as n,g as a,h as e}from"./index-e1b2c696.js";const _={class:"section-content"},z={class:"section-content"},w={class:"section-content"},B={class:"section-content"},U={class:"section-content"},I={class:"section-content"},M={class:"section-content"},O={class:"section-content"},A={class:"section-content"},R={class:"section-content"},Y={class:"section-content"},S={class:"section-content"},j={class:"section-content"},C={class:"section-content"},T={class:"section-content"},L={name:"DatePickerInput"},Z=V({...L,setup(N){const{t:g}=P(),v=k.coerce.date().max(new Date,{message:g("form.errors.datePicker.invalid")}),f=new Date,D=f;let o=y({appointmentDate:c(f),arrivalDate:c(),availableDatetime:c([f,new Date(D.setDate(D.getDate()+7))]),dateOfBirth:c(f),dateRange:c([f,new Date(D.setDate(D.getDate()+7))]),joinedDate:c(),month:c(),monthAndYear:c(),noLabelInput:c(),pickupDate:c(),presentationDate:c(f),reportDate:c([f,new Date(D.setDate(D.getDate()+7))]),time:c(),year:c(f.getFullYear())});return(r,m)=>{const s=b("SshPre"),h=b("Page");return F(),$(h,{title:r.$t("form.label.datePicker"),class:"demo"},{default:l(()=>[t("section",null,[t("h2",null,p(r.$t("form.label.basicInput")),1),n(),t("div",_,[a(s,{language:"html-vue"},{default:l(()=>[n(`
          <Form>
            <DatePicker 
              v-model="input"
            />
        ...
        `)]),_:1}),n(),a(e(u),null,{default:l(()=>[a(e(d),{modelValue:e(o).pickupDate,"onUpdate:modelValue":m[14]||(m[14]=i=>e(o).pickupDate=i),label:r.$t("form.label.pickupDate"),class:"custom-style-input"},null,8,["modelValue","label"])]),_:1})])])]),_:1},8,["title"])}}});export{Z as default};
