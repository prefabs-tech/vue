import{d as A,I as F,r as P,k as p,a4 as K,v as f,J as V,e as O,o as y,j as r,C as t,f as a,t as u,h as i,u as l,a as E,b as R,X as q}from"./index-CMtleJwi.js";import{Q as m}from"./PrefabsTechVue3TanstackTable.es-fTlbAKE0.js";import{c as h,d as b,f as v}from"./data-gOxi8Wva.js";import{_ as B}from"./TablePage.vue_vue_type_style_index_0_lang-BGBbqMuN.js";import"./PrefabsTechVue3Form.es-BU3NEoOO.js";const M={class:"section-content"},N={class:"section-content"},z={class:"section-content"},L={class:"section-content"},Q={class:"section-content"},j={class:"section-content"},J={class:"section-content"},U={class:"section-content"},I={class:"section-content"},Y=["colspan"],W={class:"section-content"},X={class:"section-content"},H={class:"section-content"},G={key:0},Z={class:"section-content"},x={class:"section-content"},_={class:"section-content"},ee={class:"section-content"},te={class:"section-content"},ae={class:"section-content"},ne={class:"section-content"},le={name:"SortableTable"},me=A({...le,setup(ie){const{t:o}=F(),T=[{accessorKey:"email",align:"left",enableColumnFilter:!0,enableSorting:!0,filterPlaceholder:o("table.placeholder.search"),header:"Email"},{accessorKey:"name",enableColumnFilter:!0,enableSorting:!0,filterPlaceholder:o("table.placeholder.search"),header:"Full name"},{accessorKey:"age",align:"right",enableColumnFilter:!0,enableSorting:!0,filterPlaceholder:`${o("table.placeholder.min")},${o("table.placeholder.max")}`,header:"Age",meta:{filterVariant:"range"}},{accessorKey:"city",align:"center",enableColumnFilter:!0,enableSorting:!0,filterPlaceholder:o("table.placeholder.city"),header:"City",meta:{filterVariant:"multiselect",filterOptions:h}}],c=[{accessorKey:"email",enableColumnFilter:!0,enableSorting:!0,filterPlaceholder:o("table.placeholder.search"),header:"Email"},{accessorKey:"name",enableColumnFilter:!0,enableSorting:!0,filterPlaceholder:o("table.placeholder.search"),header:"Full name"},{align:"right",accessorKey:"age",enableColumnFilter:!0,enableSorting:!0,filterPlaceholder:`${o("table.placeholder.min")},${o("table.placeholder.max")}`,header:"Age",meta:{filterVariant:"range"}},{accessorKey:"city",enableColumnFilter:!0,enableSorting:!0,filterPlaceholder:o("table.placeholder.city"),header:"City",meta:{filterVariant:"multiselect",filterOptions:h}}],g=P(!1),C=c.map(n=>({...n,enableSorting:!0})),D=["right","top","bottom","left"],$=[...c,{accessorKey:"disabled",align:"center",cell:({row:n})=>{var e,s;return p(K,{label:(e=n.original)!=null&&e.disabled?o("table.label.disabled"):o("table.label.enabled"),severity:(s=n.original)!=null&&s.disabled?"danger":"success"})},enableColumnFilter:!0,enableSorting:!0,filterPlaceholder:o("table.placeholder.status"),header:"Status",meta:{filterVariant:"select",filterOptions:[{label:o("table.label.enabled"),value:!1},{label:o("table.label.disabled"),value:!0}]}}],w=c.map((n,e)=>({...n,tooltip:!0,tooltipOptions:{position:D[e]}})),S=[{accessorKey:"description",enableColumnFilter:!0,enableSorting:!0,filterPlaceholder:o("table.placeholder.search"),header:"Description"},{accessorKey:"quantity",dataType:"number",enableColumnFilter:!0,enableSorting:!0,filterPlaceholder:`${o("table.placeholder.min")},${o("table.placeholder.max")}`,header:()=>"Quantity",meta:{filterVariant:"range"}},{accessorKey:"amount",dataType:"currency",enableColumnFilter:!0,enableSorting:!0,filterPlaceholder:`${o("table.placeholder.min")},${o("table.placeholder.max")}`,header:"Amount",meta:{filterVariant:"range"}},{accessorKey:"date",dataType:"date",enableColumnFilter:!0,enableSorting:!0,filterPlaceholder:o("table.placeholder.dateRange"),header:"Date",meta:{filterVariant:"dateRange"}},{id:"action",cell:()=>p(f,{iconLeft:"pi pi-eye",variant:"textOnly",rounded:!0}),dataType:"other",header:()=>p("i",{class:"pi pi-cog"})}],k=[{accessorKey:"description",enableColumnFilter:!0,enableSorting:!0,filterPlaceholder:o("table.placeholder.search"),header:"Description"},{accessorKey:"quantity",dataType:"number",enableColumnFilter:!0,enableSorting:!0,filterPlaceholder:`${o("table.placeholder.min")},${o("table.placeholder.max")}`,header:()=>"Quantity",meta:{filterVariant:"range"},numberOptions:{locale:"en-IN"}},{accessorKey:"amount",dataType:"currency",enableColumnFilter:!0,enableSorting:!0,filterPlaceholder:`${o("table.placeholder.min")},${o("table.placeholder.max")}`,header:"Amount",meta:{filterVariant:"range"},numberOptions:{formatOptions:{currency:"EUR"},locale:"en-US"}},{accessorKey:"date",dataType:"date",enableColumnFilter:!0,enableSorting:!0,filterPlaceholder:o("table.placeholder.dateRange"),header:"Date",meta:{filterVariant:"dateRange"}},{accessorKey:"datetime",enableColumnFilter:!0,enableSorting:!0,filterPlaceholder:o("table.placeholder.dateRange"),header:"Datetime",dataType:"datetime",meta:{filterVariant:"dateRange"}},{id:"action",cell:()=>p(f,{iconLeft:"pi pi-eye",variant:"textOnly",rounded:!0}),dataType:"other",header:()=>p("i",{class:"pi pi-cog"})}];return(n,e)=>{const s=V("SshPre");return y(),O(B,{title:n.$t("table.title"),class:"demo data-table"},{toolbar:r(()=>[i(l(f),{label:n.$t("common.back"),"icon-left":"pi pi-chevron-left",size:"medium",variant:"textOnly",onClick:e[0]||(e[0]=d=>n.$router.push("/table"))},null,8,["label"])]),default:r(()=>[e[64]||(e[64]=t()),a("section",null,[a("h2",null,u(n.$t("table.usage.basic")),1),e[8]||(e[8]=t()),a("div",M,[i(l(m),{"columns-data":c,data:l(b).slice(0,15),paginated:!1},null,8,["data"]),e[7]||(e[7]=t()),i(s,{language:"html-vue"},{default:r(()=>e[6]||(e[6]=[t(`
        ...
        `)])),_:1})])]),e[71]||(e[71]=t()),a("section",null,[a("h2",null,u(n.$t("table.usage.title")),1),e[29]||(e[29]=t()),a("div",U,[i(l(m),{"columns-data":c,data:l(b).slice(0,5),"title-info":{text:n.$t("table.label.users"),align:"left"}},null,8,["data","title-info"]),e[28]||(e[28]=t()),i(s,{language:"html-vue"},{default:r(()=>e[27]||(e[27]=[t(`
          ...
          <\/script>
        `)])),_:1})])]),e[72]||(e[72]=t()),a("section",null,[a("h2",null,u(n.$t("table.usage.footer")),1),e[32]||(e[32]=t()),a("div",I,[i(l(m),{"columns-data":c,data:l(b)},{footer:r(()=>[a("tr",null,[a("td",{colspan:c.length},u(`${n.$t("table.label.totalRecords")}: ${l(b).length??"0"}`),9,Y)])]),_:1},8,["data"]),e[31]||(e[31]=t()),i(s,{language:"html-vue"},{default:r(()=>e[30]||(e[30]=[t(`
          <template>
            <Table :columns-data="columns" :data="data">
              <template #footer>
                <tr>
        ...
        `)])),_:1})])]),e[79]||(e[79]=t()),a("section",null,[a("h2",null,u(n.$t("table.usage.singleActionMenu")),1),e[54]||(e[54]=t()),a("div",ee,[i(l(m),{"columns-data":c,data:l(b).slice(10,15),"data-action-menu":[{label:n.$t("table.label.view")}],"initial-sorting":[{id:"email",desc:!1}],"single-action-mode":"menu","onAction:select":e[5]||(e[5]=d=>{})},null,8,["data","data-action-menu"]),e[53]||(e[53]=t()),i(s,{language:"html-vue"},{default:r(()=>e[52]||(e[52]=[t(`
          ...
          <\/script>
        `)])),_:1})])]),e[80]||(e[80]=t()),a("section",null,[a("h2",null,u(n.$t("table.usage.cellDataFormatting")),1),e[57]||(e[57]=t()),a("div",te,[i(l(m),{"columns-data":k,data:l(v),"initial-sorting":[{id:"quantity",desc:!0}],paginated:!1},null,8,["data"]),e[56]||(e[56]=t()),i(s,{language:"html-vue"},{default:r(()=>e[55]||(e[55]=[t(`
          <template>
            <Table
              :columns-data="columns"
              :data="data"
        ...
        `)])),_:1})])]),e[81]||(e[81]=t()),a("section",null,[a("h2",null,u(n.$t("table.usage.customCellDataFormatting")),1),e[60]||(e[60]=t()),a("div",ae,[i(l(m),{"columns-data":S,"custom-formatters":{currency:d=>`$${d}`,number:d=>`~${d}`},data:l(v),"initial-sorting":[{id:"quantity",desc:!0}],paginated:!1},null,8,["custom-formatters","data"]),e[59]||(e[59]=t()),i(s,{language:"html-vue"},{default:r(()=>e[58]||(e[58]=[t(`
          ...
          <\/script>
        `)])),_:1})])]),e[82]||(e[82]=t()),a("section",null,[a("h2",null,u(n.$t("table.usage.centeredAlignedTable")),1),e[63]||(e[63]=t()),a("div",ne,[i(l(m),{"columns-data":$,data:l(b).slice(10,15),"initial-sorting":[{id:"email",desc:!1}],class:"center-aligned-content-table"},null,8,["data"]),e[62]||(e[62]=t()),i(s,{language:"html-vue"},{default:r(()=>e[61]||(e[61]=[t(`
          <template>
            <Table
