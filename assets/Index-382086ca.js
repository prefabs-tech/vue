import{d as r,o as g,c as d,w as n,a as o,t as p,f as t,g as l,h as u,a5 as a,aa as i,r as c}from"./index-9392f0ee.js";const b={class:"section-content"},v={class:"section-content"},h={class:"section-content"},f={class:"section-content"},_={class:"section-content"},P={class:"section-content"},$={class:"section-content"},z=r({__name:"Index",setup(y){return(e,B)=>{const s=c("SshPre"),m=c("Page");return g(),d(m,{title:e.$t("ui.popup.title"),class:"demo"},{default:n(()=>[o("section",null,[o("h2",null,p(e.$t("ui.popup.usage.basic")),1),t(),o("div",b,[l(s,{language:"html-vue"},{default:n(()=>[t(`
          <template>
            <Popup>
              <ButtonElement
                :label="Click me"
