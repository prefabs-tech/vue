import{H as b,q as v}from"./DzangolabVue3Form.es-BK79XLN0.js";import{d as S,L as h,M as V,N as I,r as p,K as $,f as z,o as L,i as s,D as e,g as a,t as d,h as u,u as n,l as F,z as c,v as N}from"./index-CSsCuN9S.js";import{_ as D}from"./FormPage.vue_vue_type_style_index_0_lang-DXvl0hgH.js";const H={class:"section-content"},M={class:"section-content"},U={class:"section-content"},G={class:"section-content"},W={class:"section-content"},y={class:"section-content"},k={class:"section-content"},C={class:"section-content"},P={class:"section-content"},w={class:"section-content"},B={class:"section-content"},q={class:"section-content"},K={name:"SelectInputField"},J=S({...K,setup(O){const{t:f}=h(),g=V.string({invalid_type_error:f("form.errors.multiselect.invalid")}).array().min(1,{message:f("form.errors.multiselect.invalid")});let i=I({customLabelSelect:p(),disabled:p("de"),disabledMultiselect:p(["be","de"]),disabledSortInput:p(),i18nSelect:p(),input:p(),inputWithMinMax:p([]),inputWithValidation:p([]),multiselect:p(),multiselectSearch:p(),noLabelInput:p(),selectWithSearch:p()});const r=p([{label:f("form.label.french"),value:"fr"},{label:f("form.label.german"),value:"de"},{disabled:!0,label:f("form.label.dutch"),value:"be"},{label:f("form.label.nepali"),value:"np"},{label:f("form.label.hindi"),value:"hi"}]);return(t,l)=>{const m=$("SshPre");return L(),z(D,{title:t.$t("form.label.select"),class:"demo"},{toolbar:s(()=>[u(n(N),{label:t.$t("common.back"),"icon-left":"pi pi-chevron-left",size:"medium",variant:"textOnly",onClick:l[0]||(l[0]=o=>t.$router.push("/form"))},null,8,["label"])]),default:s(()=>[l[50]||(l[50]=e()),a("section",null,[a("h2",null,d(t.$t("form.label.basicInput")),1),l[15]||(l[15]=e()),a("div",H,[u(n(b),{modelValue:n(i).noLabelInput,"onUpdate:modelValue":l[1]||(l[1]=o=>n(i).noLabelInput=o),options:r.value,placeholder:t.$t("form.placeholder.language")},null,8,["modelValue","options","placeholder"]),l[14]||(l[14]=e()),u(m,{language:"html-vue"},{default:s(()=>l[13]||(l[13]=[e(`
          <template>
            <SelectInput
              v-model="input"
              :options="options"
