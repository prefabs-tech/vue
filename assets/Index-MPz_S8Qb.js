import{T as m}from"./PrefabsTechVue3Form.es-CqDGYAwZ.js";import{d as f,N as c,L as v,e as b,o as y,j as a,C as n,f as o,t as p,h as l,u as i,v as C}from"./index-Xk6NHMaT.js";import{_ as P}from"./FormPage.vue_vue_type_style_index_0_lang-DLb5vr8u.js";const V={class:"section-content"},g={class:"section-content"},k={class:"section-content"},T=f({__name:"Index",setup($){const r=c({basic:void 0,multiselect:[],custom:[]}),d=[{code:"US",i18n:{en:"United States of America",fr:"États-Unis",th:"สหรัฐอเมริกา"}},{code:"FR",i18n:{th:"France override"}},{code:"JP",i18n:{en:"Japan (overwritten)",fr:"Japon",th:"ญี่ปุ่น"}},{code:"XX",i18n:{en:"Testland",fr:"Pays Test",th:"ประเทศทดสอบ"}}];return(t,e)=>{const u=v("SshPre");return y(),b(P,{title:t.$t("form.label.countryPicker")},{toolbar:a(()=>[l(i(C),{label:t.$t("common.back"),"icon-left":"pi pi-chevron-left",size:"medium",variant:"textOnly",onClick:e[0]||(e[0]=s=>t.$router.push("/form"))},null,8,["label"])]),default:a(()=>[e[13]||(e[13]=n()),o("section",null,[o("h2",null,p(t.$t("form.label.basicInput")),1),e[6]||(e[6]=n()),o("div",V,[l(i(m),{modelValue:r.basic,"onUpdate:modelValue":e[1]||(e[1]=s=>r.basic=s),placeholder:t.$t("form.placeholder.country")},null,8,["modelValue","placeholder"]),e[5]||(e[5]=n()),l(u,{language:"html-vue"},{default:a(()=>e[4]||(e[4]=[n(`
         <template>
            <CountryPicker
              v-model="input"
