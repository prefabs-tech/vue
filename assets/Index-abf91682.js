import{d as E,j as d,G as g,o as m,c as f,w as i,K as a,C as e,S as r,f as o,D as s,ao as u,aq as c,g as p}from"./index-c6712957-bca2c2d1.js";import{_ as L}from"./UiPage.vue_vue_type_style_index_0_lang-e2e81d25.js";const D={class:"section-content"},O={class:"container"},z={class:"section-content"},I={class:"container"},N={class:"section-content"},S={class:"container"},T={class:"section-content"},V={class:"container"},U={class:"section-content"},H={class:"container"},P={class:"section-content"},j={class:"container"},K=E({__name:"Index",setup(q){const b=d(void 0),M=d(!1),y=d(!1),w=d(!1),C=d(!1),$=d(!1),h=d(!1),k=()=>{b.value=new Date,h.value=!1};return(l,n)=>{const B=g("router-link"),v=g("SshPre");return m(),f(L,{title:l.$t("ui.confirmationModal.title"),class:"demo"},{toolbar:i(()=>[a(B,{to:{name:"ui"},class:"back"},{default:i(()=>[e(r(l.$t("common.back")),1)]),_:1})]),default:i(()=>[e(),o("section",null,[o("h2",null,r(l.$t("ui.confirmationModal.usage.basic")),1),e(),o("div",D,[a(v,{language:"html-vue"},{default:i(()=>[e(`
          <template>
            <div>
              <ButtonElement
                label="Confirm"
