import{e as d,l as c}from"./DzangolabVue3Form.es-aff8d000.js";import{d as g,a6 as I,p as F,j as b,K as f,o as V,c as D,w as o,L as n,C as l,N as r,f as t,E as e}from"./index-66214709-32602281.js";import{m as E}from"./index-f20d41ca.js";import{_ as $}from"./FormPage.vue_vue_type_style_index_0_lang-8b4f287c.js";const N={class:"section-content"},_={class:"section-content"},H={class:"section-content"},B={class:"section-content"},P={class:"section-content"},z={class:"section-content"},G={class:"section-content"},R={name:"SelectInputField"},M=g({...R,setup(U){const{t:v}=I(),h=E.string({invalid_type_error:v("form.errors.multiSelect.invalid")}).array().min(1,{message:v("form.errors.multiSelect.invalid")});let u=F({disabled:b("DE"),disabledMultiSelect:b(["BE","DE"]),input:b(),inputWithValidation:b(),multiSelect:b(),noLabelInput:b()});const p=b([{value:"FR",label:"French"},{value:"DE",label:"German"},{value:"BE",label:"Dutch"},{value:"NP",label:"Nepali"},{value:"HI",label:"Hindi"}]);return(a,i)=>{const S=f("router-link"),m=f("SshPre");return V(),D($,{title:a.$t("form.label.select"),class:"demo"},{toolbar:o(()=>[n(S,{to:{name:"form"},class:"back"},{default:o(()=>[l(r(a.$t("common.back")),1)]),_:1})]),default:o(()=>[l(),t("section",null,[t("h2",null,r(a.$t("form.label.basicInput")),1),l(),t("div",N,[n(m,{language:"html-vue"},{default:o(()=>[l(`
          <Form>
            <SelectInput
              v-model="input"
              :options="options"
        ...
        `)]),_:1}),l(),n(e(d),null,{default:o(()=>[n(e(c),{modelValue:e(u).disabledMultiSelect,"onUpdate:modelValue":i[5]||(i[5]=s=>e(u).disabledMultiSelect=s),label:a.$t("form.label.disabled"),options:p.value,disabled:"",multiple:""},null,8,["modelValue","label","options"])]),_:1})])]),l(),t("section",null,[t("h2",null,r(a.$t("form.label.inputWithValidation")),1),l(),t("div",G,[n(m,{language:"html-vue"},{default:o(()=>[l(`
          ...
          <\/script>
        `)]),_:1}),l(),n(e(d),null,{default:o(()=>[n(e(c),{modelValue:e(u).inputWithValidation,"onUpdate:modelValue":i[6]||(i[6]=s=>e(u).inputWithValidation=s),label:a.$t("form.label.select"),options:p.value,placeholder:a.$t("form.placeholder.multiSelect"),schema:e(h),multiple:""},null,8,["modelValue","label","options","placeholder","schema"])]),_:1})])])]),_:1},8,["title"])}}});export{M as default};
