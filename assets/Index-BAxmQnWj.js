import{I as b,T as B}from"./PrefabsTechVue3Form.es-DceiuSry.js";import{d as D,I as S,R as C,M as I,J as V,e as N,o as R,i as s,C as t,f as p,g as o,t as m,u as l,S as c,v as k}from"./index-B9AZRdEG.js";import{_ as w}from"./ComponentDocumentation.vue_vue_type_script_setup_true_lang-Dt5YWwdh.js";import{_ as T}from"./UiPage.vue_vue_type_style_index_0_lang-BNR9-AuJ.js";import"./PrefabsTechVue3TanstackTable.es-DFgNjZel.js";const x={class:"section-content"},A={class:"section-content"},F={class:"section-content"},j=D({__name:"Index",setup(L){const{t:a}=S(),f=C(),r=I({name:null,phone:null,price:"$50"}),v=[{description:a("ui.stepper.documentation.eventDescription.complete"),name:"complete",payload:"-"}],P={iconRight:"pi pi-chevron-right",label:"Next",severity:"primary",variant:"filled"},g={iconLeft:"pi pi-chevron-left",label:"Back",severity:"secondary",variant:"filled"},h=[{default:"-",description:a("ui.stepper.documentation.propsDescription.nextButton"),prop:"nextButtonProperties",type:"ActionButtonProperties"},{default:"-",description:a("ui.stepper.documentation.propsDescription.PreviousButton"),prop:"previousButtonProperties",type:"ActionButtonProperties"},{default:"-",description:a("ui.stepper.documentation.propsDescription.steps"),prop:"steps",type:"Array<StepProperties>"}],y=[{description:a("ui.stepper.documentation.slotDescription.step"),name:"{step}"}],d=[{content:"Please enter personal details",label:"Personal",step:1},{content:"Please enter contact details",label:"Contact",step:2},{content:"Please enter payment details",label:"Payment",step:3},{content:"Do you wish to continue?",label:"Confirmation",step:4}],$=()=>{f.push("/ui")};return(n,e)=>{const u=V("SshPre");return R(),N(T,{"sub-title":n.$t("ui.stepper.subtitle"),title:n.$t("ui.stepper.title"),class:"demo-stepper"},{toolbar:s(()=>[o(l(k),{label:n.$t("common.back"),"icon-left":"pi pi-chevron-left",size:"medium",variant:"textOnly",onClick:e[0]||(e[0]=i=>n.$router.push("/ui"))},null,8,["label"])]),default:s(()=>[e[17]||(e[17]=t()),p("section",null,[p("h2",null,m(n.$t("ui.stepper.usage.basic")),1),e[6]||(e[6]=t()),p("div",x,[o(l(c),{steps:d,onComplete:$}),e[5]||(e[5]=t()),o(u,{language:"html-vue"},{default:s(()=>e[4]||(e[4]=[t(`
          <template>
