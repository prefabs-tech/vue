import{z as d,U as $}from"./DzangolabVue3Form.es-01f89041.js";import{d as y,Z as S,p as V,K as b,o as B,c as C,w as n,L as o,C as e,M as i,f as l,E as p,aF as c}from"./index-8e1c3ab6-85243c9d.js";import{_}from"./UiPage.vue_vue_type_style_index_0_lang-701df655.js";import"./index-13628828.js";const D={class:"section-content"},k={class:"section-content"},I={class:"section-content"},x=y({__name:"Index",setup(w){const h=S(),a=V({name:null,phone:null,price:"$50"}),f={iconRight:"pi pi-chevron-right",label:"Next",severity:"primary",variant:"filled"},v={iconLeft:"pi pi-chevron-left",label:"Back",severity:"secondary",variant:"filled"},u=[{content:"Please enter personal details",label:"Personal",step:1},{content:"Please enter contact details",label:"Contact",step:2},{content:"Please enter payment details",label:"Payment",step:3},{content:"Do you wish to continue?",label:"Confirmation",step:4}],P=()=>{h.push("/ui")};return(t,s)=>{const g=b("router-link"),m=b("SshPre");return B(),C(_,{title:t.$t("ui.stepper.title"),class:"demo"},{toolbar:n(()=>[o(g,{to:{name:"ui"},class:"back"},{default:n(()=>[e(i(t.$t("common.back")),1)]),_:1})]),default:n(()=>[e(),l("section",null,[l("h2",null,i(t.$t("ui.stepper.usage.basic")),1),e(),l("div",D,[o(p(c),{steps:u,onComplete:P}),e(),o(m,{language:"html-vue"},{default:n(()=>[e(`
          <template>
