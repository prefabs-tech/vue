import{m as v,J as d,Z as i}from"./DzangolabVue3Form.es-85a085bb.js";import{d as I,a4 as V,l as $,j as f,G as c,o as F,c as _,w as o,K as n,C as e,S as m,f as a,D as l}from"./index-d658739c-0fec2303.js";import{_ as w}from"./FormPage.vue_vue_type_style_index_0_lang-e7bf03d2.js";import"./index-d4113c16.js";const y={class:"section-content"},z={class:"section-content"},S={class:"section-content"},U={class:"section-content"},k={class:"section-content"},E={class:"section-content"},T={name:"InputField"},N=I({...T,setup(W){const{t:b}=V(),h=v.string().min(3,{message:b("form.errors.input.min",{length:3})});let r=$({disabled:f("monorepo@gmail.com"),input:f(),inputWithValidation:f(),noLabelInput:f(),passwordInput:f()});return(t,s)=>{const g=c("router-link"),p=c("SshPre");return F(),_(w,{title:t.$t("form.label.input"),class:"demo"},{toolbar:o(()=>[n(g,{to:{name:"form"},class:"back"},{default:o(()=>[e(m(t.$t("common.back")),1)]),_:1})]),default:o(()=>[e(),a("section",null,[a("h2",null,m(t.$t("form.label.basicInput")),1),e(),a("div",y,[n(p,{language:"html-vue"},{default:o(()=>[e(`
          <Form>
            <Input 
              v-model="username"
