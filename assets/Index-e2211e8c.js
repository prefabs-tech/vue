import{d as E,e as d,r as $,o as L,c as D,w as i,f as l,g as e,t as r,a as o,h as s,a5 as u,Y as f,Z as v,a7 as c}from"./index-d455476b.js";const O={class:"section-content"},z={class:"container"},I={class:"section-content"},P={class:"container"},S={class:"section-content"},T={class:"container"},N={class:"section-content"},U={class:"container"},V={class:"section-content"},H={class:"container"},Y={class:"section-content"},A={class:"container"},q=E({__name:"Index",setup(Z){const p=d(void 0),b=d(!1),M=d(!1),w=d(!1),h=d(!1),C=d(!1),g=d(!1),y=()=>{p.value=new Date,g.value=!1};return(t,n)=>{const B=$("router-link"),m=$("SshPre"),k=$("Page");return L(),D(k,{title:t.$t("ui.confirmationModal.title"),class:"demo"},{toolbar:i(()=>[l(B,{to:{name:"ui"},class:"back"},{default:i(()=>[e(r(t.$t("common.back")),1)]),_:1})]),default:i(()=>[e(),o("section",null,[o("h2",null,r(t.$t("ui.confirmationModal.usage.basic")),1),e(),o("div",O,[l(m,{language:"html-vue"},{default:i(()=>[e(`
          <template>
            <div>
              <ButtonElement
                label="Confirm"
          ...
          <\/script>
        `,1)]),_:1}),e(),o("div",z,[l(s(u),{label:t.$t("ui.confirmationModal.buttonLabel.confirm"),severity:"success",onClick:n[0]||(n[0]=a=>g.value=!0)},null,8,["label"]),e(),o("span",null,r(p.value),1)]),e(),f(l(s(c),{"onOn:close":n[1]||(n[1]=a=>g.value=!1),"onOn:confirm":n[2]||(n[2]=a=>y())},null,512),[[v,g.value]])])]),e(),o("section",null,[o("h2",null,r(t.$t("ui.confirmationModal.usage.withDivider")),1),e(),o("div",I,[l(m,{language:"html-vue"},{default:i(()=>[e(`
          <template>
            <div>
              <ButtonElement
                label="Confirm"
        ...
        `)]),_:1}),e(),o("div",H,[l(s(u),{label:t.$t("ui.confirmationModal.buttonLabel.confirm"),severity:"success",onClick:n[12]||(n[12]=a=>M.value=!0)},null,8,["label"]),e(),o("span",null,r(p.value),1)]),e(),f(l(s(c),{"onOn:close":n[13]||(n[13]=a=>M.value=!1),"onOn:confirm":n[14]||(n[14]=a=>M.value=!1)},{header:i(()=>[o("span",null,r(t.$t("ui.confirmationModal.headerContent.deleteUser")),1)]),body:i(()=>[o("p",null,r(t.$t("ui.confirmationModal.bodyContent.confirmDelete")),1)]),footer:i(()=>[l(s(u),{size:"small",label:t.$t("ui.confirmationModal.buttonLabel.cancel"),severity:"secondary"},null,8,["label"]),e(),l(s(u),{size:"small",label:t.$t("ui.confirmationModal.buttonLabel.delete"),severity:"danger"},null,8,["label"])]),_:1},512),[[v,M.value]])])]),e(),o("section",null,[o("h2",null,r(t.$t("ui.confirmationModal.usage.withI18n")),1),e(),o("div",Y,[l(m,{language:"html-vue"},{default:i(()=>[e(`
          ...
          <script setup lang="ts">
            ...
            const { t } = useI18n();
          <\/script>
        `)]),_:1}),e(),o("div",A,[l(s(u),{label:t.$t("ui.confirmationModal.buttonLabel.confirm"),severity:"success",onClick:n[15]||(n[15]=a=>C.value=!0)},null,8,["label"]),e(),o("span",null,r(p.value),1)]),e(),f(l(s(c),{"onOn:close":n[16]||(n[16]=a=>C.value=!1),"onOn:confirm":n[17]||(n[17]=a=>C.value=!1)},{header:i(()=>[o("span",null,r(t.$t("ui.confirmationModal.headerContent.deleteUser")),1)]),body:i(()=>[o("p",null,r(t.$t("ui.confirmationModal.bodyContent.confirmDelete")),1)]),footer:i(()=>[l(s(u),{size:"small",label:t.$t("ui.confirmationModal.buttonLabel.cancel"),severity:"secondary"},null,8,["label"]),e(),l(s(u),{size:"small",label:t.$t("ui.confirmationModal.buttonLabel.delete"),severity:"danger"},null,8,["label"])]),_:1},512),[[v,C.value]])])])]),_:1},8,["title"])}}});export{q as default};
