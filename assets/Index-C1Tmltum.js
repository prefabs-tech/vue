import{d as b,J as g,I as f,e as I,o as y,i as s,E as t,f as o,t as m,g as i,u as a,T as u,x as S,V as D}from"./index-BTiWyi3W.js";import{_ as P}from"./UserPage.vue_vue_type_style_index_0_lang-5gmZIU3f.js";const F={class:"section-content"},R={class:"section-content"},z={class:"section-content"},E={class:"section-content"},A={class:"section-content"},x=b({__name:"Index",setup(N){const{t:p}=g(),d=[{id:1,name:"ADMIN"},{id:2,name:"SUPERADMIN"},{id:3,name:"USER"}],v=[{id:1,name:"Admin",origin:"admin-origin",supportedRoles:[{id:1,name:"ADMIN"},{id:2,name:"SUPERADMIN"}]},{id:2,name:"User",origin:"user-origin",supportedRoles:[{id:3,name:"USER"}]}],l=e=>{D({text:p("user.message.invitation.success",{user:e.email}),type:"success"})};return(e,n)=>{const r=f("SshPre");return y(),I(P,{title:e.$t("user.label.invitationForm"),class:"demo-invitation-form"},{toolbar:s(()=>[i(a(S),{label:e.$t("common.back"),"icon-left":"pi pi-chevron-left",size:"medium",variant:"textOnly",onClick:n[0]||(n[0]=U=>e.$router.push("/user"))},null,8,["label"])]),default:s(()=>[n[16]||(n[16]=t()),o("section",null,[o("h2",null,m(e.$t("user.label.basic")),1),n[3]||(n[3]=t()),o("div",F,[i(a(u),{onSubmit:l}),n[2]||(n[2]=t()),i(r,{language:"html-vue"},{default:s(()=>n[1]||(n[1]=[t(`
          <template>
