import{b as d,T as m}from"./DzangolabVue3Form.es-a9e38822.js";import{d as V,a7 as $,p as F,j as c,K as h,o as T,c as _,w as a,L as t,C as e,M as i,f as o,E as n}from"./index-137faed7-eb3bdd72.js";import{m as z}from"./index-d57f7faa.js";import{_ as x}from"./FormPage.vue_vue_type_style_index_0_lang-fddeb79a.js";const E={class:"section-content"},U={class:"section-content"},k={class:"section-content"},q={class:"section-content"},w={class:"section-content"},S={class:"section-content"},M={class:"section-content"},O={name:"TextInputField"},D=V({...O,setup(C){const{t:f}=$(),g=z.string().length(5,{message:f("form.errors.input.length",{length:5})}),I={required:f("form.errors.input.required")},b={ignore_whitespace:!0,required:!0};let u=F({customValidationInput:c(),disabled:c("dzangolab"),input:c(),inputWithValidation:c(),noLabelInput:c(),textInput:c()});return(l,r)=>{const v=h("router-link"),p=h("SshPre");return T(),_(x,{title:l.$t("form.label.textInput"),class:"demo"},{toolbar:a(()=>[t(v,{to:{name:"form"},class:"back"},{default:a(()=>[e(i(l.$t("common.back")),1)]),_:1})]),default:a(()=>[e(),o("section",null,[o("h2",null,i(l.$t("form.label.basicInput")),1),e(),o("div",E,[t(p,{language:"html-vue"},{default:a(()=>[e(`
          <Form>
            <TextInput 
              v-model="input"
