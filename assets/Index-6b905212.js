import{d as E,j as d,K as g,o as m,c as f,w as i,L as a,C as e,M as r,f as o,E as s,aq as u,av as c,g as p}from"./index-8e1c3ab6-8617714e.js";import{_ as L}from"./UiPage.vue_vue_type_style_index_0_lang-773e1d70.js";const O={class:"section-content"},z={class:"container"},D={class:"section-content"},I={class:"container"},N={class:"section-content"},T={class:"container"},V={class:"section-content"},S={class:"container"},U={class:"section-content"},H={class:"container"},P={class:"section-content"},j={class:"container"},F=E({__name:"Index",setup(q){const b=d(void 0),M=d(!1),y=d(!1),w=d(!1),C=d(!1),$=d(!1),h=d(!1),k=()=>{b.value=new Date,h.value=!1};return(l,n)=>{const B=g("router-link"),v=g("SshPre");return m(),f(L,{title:l.$t("ui.confirmationModal.title"),class:"demo"},{toolbar:i(()=>[a(B,{to:{name:"ui"},class:"back"},{default:i(()=>[e(r(l.$t("common.back")),1)]),_:1})]),default:i(()=>[e(),o("section",null,[o("h2",null,r(l.$t("ui.confirmationModal.usage.basic")),1),e(),o("div",O,[a(v,{language:"html-vue"},{default:i(()=>[e(`
          <template>
            <div>
              <ButtonElement
                label="Confirm"
