import{W as p,J as c}from"./DzangolabVue3Form.es-81449376.js";import{d as v,a5 as I,p as V,j as m,J as $,o as T,c as x,w as u,K as a,D as t,ao as _,W as e,f as n,L as d}from"./index-729398ab-97e0bd19.js";import{m as w}from"./index-4c2549d2.js";import{_ as z}from"./FormPage.vue_vue_type_style_index_0_lang-ebb70898.js";const F={class:"section-content"},C={class:"section-content"},U={class:"section-content"},y={class:"section-content"},E={class:"section-content"},W={class:"section-content"},q={class:"section-content"},O={class:"section-content"},S={name:"TextareaInputField"},B=v({...S,setup(D){const{t:f}=I(),h=w.string().min(15,{message:f("form.errors.input.min",{length:15})}),g={required:f("form.errors.input.required")},b={ignore_whitespace:!0,required:!0};let r=V({customRowsColsInput:m(),customValidationInput:m(),disabled:m("Disabled textarea input"),input:m(),inputWithValidation:m(),noLabelInput:m(),textInput:m()});return(l,o)=>{const i=$("SshPre");return T(),x(z,{title:l.$t("form.label.textarea"),class:"demo"},{toolbar:u(()=>[a(t(_),{label:l.$t("common.back"),"icon-left":"pi pi-chevron-left",size:"medium",variant:"textOnly",onClick:o[0]||(o[0]=s=>l.$router.push("/form"))},null,8,["label"])]),default:u(()=>[e(),n("section",null,[n("h2",null,d(l.$t("form.label.basicInput")),1),e(),n("div",F,[a(t(p),{modelValue:t(r).noLabelInput,"onUpdate:modelValue":o[1]||(o[1]=s=>t(r).noLabelInput=s),placeholder:l.$t("form.placeholder.input")},null,8,["modelValue","placeholder"]),e(),a(i,{language:"html-vue"},{default:u(()=>[e(`
          <template>
            <TextareaInput 
              v-model="input"
